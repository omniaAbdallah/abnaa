                ...
                <table class="table example table-bordered table-striped table-hover">
                    ...
                    foreach ($morfqat as $morfaq){
                       ...
                       //  $Destination = 'uploads/archive/deals/1bec9894697603bd9a45630d73230be5.jpg';
                        $Destination = 'uploads/gam3ia_omomia_attach/'.$morfaq->file;
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <img src="<?= base_url().'uploads/gam3ia_omomia_attach/'.$morfaq->file?>"
                                                         width="100%" alt="">
                                                </div>
                                        ...
                                        <div class="modal fade" id="myModal-pdf-<?= $morfaq->id ?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                    <iframe src="<?=base_url()."gam3ia_omomia/Gam3ia_omomia/read_file/".$morfaq->file?>" style="width: 100%; height:  640px;" frameborder="0"></iframe>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-default" data-dismiss="modal">
                                                            إغلاق
...
closeOnConfirm: false
    ...
    if(error == '') {
        $.ajax({
            url:"<?php echo base_url(); ?>gam3ia_omomia/Gam3ia_omomia/upload_img", //base_url() return http://localhost/tutorial/codeigniter/
            method:"POST",
            data:form_data,
            contentType:false,
            cache:false,
...
function(isConfirm) {
  if (isConfirm) {
    $.ajax({
      type: 'post',
      url: '<?php echo base_url() ?>gam3ia_omomia/Gam3ia_omomia/delete_morfq',
      data: {id: id,row:row},
      dataType: 'html',
      cache: false,
...
function get_details() {
   // $('#pop_rkm').text(rkm);
    $.ajax({
        ...
        url: "<?php echo base_url();?>gam3ia_omomia/Gam3ia_omomia/load",
        beforeSend: function () {
            $('#morfaq_result').html('<div class=\'loader-img\'><div class=\'bar1\'></div><div class=\'bar2\'></div><div class=\'bar3\'></div><div class=\'bar4\'></div><div class=\'bar5\'></div><div class=\'bar6\'></div></div>');
        },
        success: function (d) {
