            ...
            <div class="background-white content_page">
                <div class="inner-omomia">
                   <div class="text-center">
                    <h2 class="box-title"> محاضر إجتماعات  مجلس الإدارة</h2>
                  </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 padding-10" id="row_<?= $z ?>">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body" style=" height: 200px;overflow: hidden;">
                                ...
                                src="<?= base_url().'uploads/md/md_all_glasat_morfaq/'. $row->file?>"
...
<script>
    ...
    function get_table_qrar(glsa_rkm,text) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>gam3ia_omomia/Gam3ia_omomia/get_table_qrar_magles_edara',
            data: {glsa_rkm: glsa_rkm},
            dataType: 'html',
            cache: false,
            beforeSend: function () {
