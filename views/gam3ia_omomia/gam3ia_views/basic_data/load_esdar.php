                        ...
                        if (!empty($dest_card)) { ?>
                            ...
                            <table id="example22" class=" example table table-bordered table-striped" role="table">
                                ...
                                <tr class="greentd">
                                    ...
                                    <th class="text-center">جهه الاصدار</th>
...
onclick="getTitle_esdar('<?php echo $value->title_setting; ?>','<?php echo $value->id_setting; ?>')"><?= $x ?>
</a>
</td>
                                        <td><a data-title="<?= $value->id_setting ?>"
                                                   ...
                                                   onclick="getTitle_esdar('<?php echo $value->title_setting; ?>','<?php echo $value->id_setting; ?>')">
                                                   <?= $value->title_setting ?>
                                                   </a>
