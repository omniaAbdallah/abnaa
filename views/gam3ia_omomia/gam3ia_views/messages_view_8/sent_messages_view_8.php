    ...
    <div class="inbox-body">
        <div class="mail-option">
            ...
            <div class="btn-group hidden-phone"><a class="btn mini blue" data-toggle="dropdown"
                ...
                <ul class="dropdown-menu">
                    <li onclick="get_select_check_box(4,2)"><a><i class="fa fa-star"></i> رسائل هامة</a></li>
                    <li onclick="get_select_check_box(2,2)"><a><i class="fa fa-ban"></i> ارشفة</a></li>
                    <li class="divider"></li>
                    <li onclick="get_select_check_box(3,2)"><a><i class="fa fa-trash-o"></i> حذف</a></li>
                </ul>
            </div>
        </div>
                ...
                if (isset($message) && !empty($message)) {
                    foreach ($message as $row) {
                        ...
                        <tr class="" title="<?= $row->to_name; ?> - <?= $row->title; ?>"
                            ...
                            <td class="inbox-small-cells" onclick="make_star(<?= $row->id ?>,2)"><i
                                    id="satr_<?= $row->id ?>"
