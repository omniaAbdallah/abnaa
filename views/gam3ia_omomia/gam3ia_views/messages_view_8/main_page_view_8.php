        ...
        <div class="mail-box">
            <aside class="sm-side">
                    ...
                    <a class="inbox-avatar" href="javascript:;">
                        <img width="64" hieght="60"
                             src="<?php if (isset($_SESSION['mem_img']) && $_SESSION['mem_img'] != null) {
                                 echo "https://abnaa-sa.org/" . 'uploads/md/gam3ia_omomia_members/' . $_SESSION['mem_img'];
                             } else {
                                 echo "https://abnaa-sa.org/" . 'asisst/admin_asset/img/avatar5.png';
                             }
                             ?>"/>
                    </a>
                    <div class="user-name">
                ...
                <ul class="inbox-nav inbox-divider">
                    <li>
                        <a onclick="get_my_messages('page_content','ward_messages')">
                            <i class="fa fa-inbox"></i> البريد الوارد </a>
                    </li>
                    <li>
                        <a onclick="get_my_messages('page_content','sent_messages')">
                            <i class="fa fa-envelope-o"></i> البريد المرسل</a>
                    </li>
                    <li>
                        <a onclick="get_my_messages('page_content','my_messages_start')">
                            <i class="fa fa-star-o"></i> الرسائل الهامة</a>
                    </li>

                    <li>
                        <a onclick="get_my_messages('page_content','my_deleted_messages')">
                            <i class=" fa fa-trash-o"></i>سلة المهملات</a>
                    </li>
                </ul>
            ...
            success: function (d) {
                ...
                for (var i = 0; i < members.length; i++) {
                    if (type_member == 1) {
                        ...
                        name = members[i].laqab + '/ ' + members[i].emp_name;
...
<script>
    function send_message() {
        ...
        var serializedData = $('#send_message_form').serializeArray();
