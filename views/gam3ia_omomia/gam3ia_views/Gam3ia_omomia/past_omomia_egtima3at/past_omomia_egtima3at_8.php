...
echo $open_galesa[0]->time_start;
   ...
   <th style=""><span class="badge bg-green">الذهاب لمتاقشة الجلسة</span> </th>
                    </tr>
   ...
   width: 80% !important;" >
    <thead>
    <tr>
    <th style="background: #737373;color: white;" colspan="2">محاور الجلسة </th>
    </tr>
      <tr>
    ...
    if(isset($open_galesa[0]->mehwr_details) and $open_galesa[0]->mehwr_details != ''){
        $x=0;
        foreach($open_galesa[0]->mehwr_details as $mehwar){
$x++;
        ?>
        
        <tr>
          <td><?=$x?></td>
        <td><?=$mehwar->mehwar_title ?></td>
