...
<div class="box box-primary">
            ...
            <div class="box-body box-profile">
              ...
              src="<?php if(isset($_SESSION['mem_img'])&&!empty($_SESSION['mem_img']))
                                    {
...
echo $da3wat->mawdo3;
              ...
              <?php if($da3wat->action_dawa==NULL ||$da3wat->action_dawa=='' ){?>
...
<input type="text" id="reason"  class="form-control" name="reason">
              ...
              <a  onclick="confirm(<?=$da3wat->id?>,'accept')" class="btn btn-success btn-block"><b>قبول </b></a>

              </div>

               <div class="col-md-4">

              <a onclick="confirm(<?=$da3wat->id?>,'refuse')" class="btn btn-danger btn-block"><b>رفض </b></a>

                </div>
                <div class="col-md-4">

<a onclick="confirm(<?=$da3wat->id?>,'wait')" class="btn btn-warning btn-block"><b>تأجيل   </b></a>
...

{
                ...
                <tr>
                 ...
                 <td><?php if($row->action_dawa=='accept') echo '<span class="badge bg-green">قبل الدعوة</span>'; 

                 elseif($row->action_dawa=='refuse') echo '<span class="badge bg-red">رفض الدعوة</span>';
                 elseif($row->action_dawa=='wait') echo '<span class="badge bg-orange">تأجيل الرد علي الدعوة</span>';
