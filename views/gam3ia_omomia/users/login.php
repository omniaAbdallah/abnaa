                ...
                <div class="login-area  ">
                    <div class="panel panel-bd panel-custom" style="margin-top: -60px !important; ">
                        <div class="panel-body">
                            ...
                            <h5 class="text-green text-center">تسجيل دخول اعضاء الجمعية العمومية</h5>
                            <?php echo form_open('gam3ia_omomia/Login_gam3ia_omomia/check_login', array('role' => 'form')) ?>
                            <div class="form-group">
                                ...
                                <div class="input-stylish">
                                    ...
                                    <input style="font-size: 20px !important;" type="text" placeholder="برجاء إدخال إسم المستخدم الخاص بك "
                            ...
                            <div class="form-group ">
                                <div class="input-stylish ">
                                    <i class="fa fa-key"></i>
                                    <input style="font-size: 20px !important;" type="password" title="برجاء إدخال كلمة المرور الخاص بك "
