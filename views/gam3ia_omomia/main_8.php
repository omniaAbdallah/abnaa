...
بداية الإشتراك</b> <span class="pull-right label label-primary"><?php echo date('Y-m-d', $odwia_data->from_date); ?></span>
                </li>
                <li class="list-group-item">
                  <b><i class="fa fa-calendar" aria-hidden="true"></i>
نهاية الإشتراك</b> <span class="pull-right label label-danger">  <?php echo date('Y-m-d', $odwia_data->to_date); ?></span>
                </li>
                <li class="list-group-item">
                  <b><i class="fa fa-calendar" aria-hidden="true"></i>
تاريخ التحديث</b> <span class="pull-right label label-success"> <?php echo $odwia_data->update_date_m; ?></span>
                </li>
              </ul>
              </div>
              <!-- /.row -->
...
<ul class="list-group">
  ...
  <div class="progress-bar progress-bar-green" style="width:<?if(isset($percentage_pos)&&!empty($percentage_pos))echo$percentage_pos; else echo 0;?>%"><?if(isset($percentage_pos)&&!empty($percentage_pos))echo$percentage_pos; else echo 0;?>%</div>
</div> <br>

<div class="w3-light-grey">
<?php echo $current_vote->vote_option2;?>
  <div class="progress-bar progress-bar-red" style="width:<?if(isset($percentage_neg)&&!empty($percentage_neg))echo$percentage_neg; else echo 0;?>%"><?if(isset($percentage_neg)&&!empty($percentage_neg))echo$percentage_neg ; else echo 0;?>%</div>
</div><br>
...
if(isset($employees)&&!empty($employees))
{
    ...
    {
        ?>
 <img  class="img_emp" title="<?=$row->employee?>"
 <?php
 if(!empty($row->personal_photo))
 {?>
    src="https://abnaa-sa.org/uploads/human_resources/emp_photo/thumbs/<?=$row->personal_photo?>"
 <?php }else{?>
 
    src="https://abnaa-sa.org/asisst/admin_asset/img/avatar5.png"
 <?php }?>
 alt="" class="margin">
