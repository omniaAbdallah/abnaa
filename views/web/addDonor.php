...
?>
              ...
              $readonly3 = 'readonly';
              $required3 = '';
                  echo form_open_multipart('Web/addDonor');
              ?>
            ...
            <div id="">
               <div  style="margin-bottom: 21px;">
                   ...
                   foreach ($donor_type as $key => $value) {
                       ?>
                       &nbsp;&nbsp;&nbsp;
                       <input type="radio" name="donor_type" onclick="getRadioType($(this).val())" data-validation="required" value="<?=$key?>" > <?=$value?>
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <?php } ?>
              </div>
        ...
        <div class="col-sm-4 padding-30 white_background">
            <div id="">
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control col-xs-6 no-padding half" placeholder="الإسم" id="name"  class="form-control" data-validation="required">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" placeholder="البريد الإلكتروني" id="email"  class="form-control col-xs-6 no-padding" autocomplete="false">
                </div>
        ...
        <div class="col-sm-4 padding-30 white_background">
            <div id="">
                ...
                <div class="form-group">
                    ...
                    <textarea name="note" class="col-xs-6 no-padding" placeholder="ملاحظات" ><?php if(isset($donor)) echo $donor['note'] ?></textarea>
                </div>

            </div>
        </div>
       
       <div class="form-group col-sm-4 " style="margin-left: 50px;">
            <div class="" >
