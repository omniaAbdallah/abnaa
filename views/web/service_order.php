                        ...
                        <div class="bs-callout bs-callout-danger">
                            <div class="col-lg-12 col-xs-12 no-padding">
                                ...
                                <div class="col-sm-6 col-md-2 padding-4">
                                    ...
                                    <input type="text" value="<?php if(!empty($data['nasebElfard']['f2a']->title)){
                                        echo $data['nasebElfard']['f2a']->title;
                                    }else{ echo "أ"; }  ?>" name=""
                                           class="form-control input-style" placeholder=" " data-validation="required"
                                           readonly>
                                </div>
                            ...
                            <div class="col-md-12 col-xs-12 no-padding">
                                ...
                                <div class="col-sm-6 col-md-5 padding-4">
                                    ...
                                    <select class="form-control" name="ser_order"
                                            onchange="getf2at(this,'cat_ser','getf2at_service','cat_name');append_taple(this);">
                                ...
                                <div class="col-sm-6 col-md-3 padding-4 text-center">
                                    <button class="btn btn-warning md-trigger" style=" margin-top: 22px;"
