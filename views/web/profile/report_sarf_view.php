                ...
                <div class="profile-sidebar">
                    ...
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseSide2" class="panel-collapse collapse" role="tabpanel"
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseSide3" class="panel-collapse collapse in" role="tabpanel"
                                 aria-labelledby="sidebar-heading3">
                                <div class="panel-body">
                                    <ul class="nav nav-pills nav-stacked nav-email mb-20 rounded shadow">
                                        <li class="active"><a href="<?php echo base_url() . 'Web/report_sarf' ?>"> <i
                ...
                <div class="panel panel-success ">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-6 col-md-3 padding-4">
                            ...
                            <button type="submit" onclick="show_sarf_table(document.getElementById('help_typ'))" class="btn btn-success" style="margin-top: 24px;width: 100px;">بحث</button>
                        </div>
                    </div>
                    </div>
