...
<div class="tab-content col-md-10">
    ...
    <div class="panel-pody">
        ...
        <form  id="mother_form" action="<?php echo base_url();?>Mother_data/mother/<?php echo $this->uri->segment(3);?>" method="post"<?php if(isset($mother)&&!empty($mother)){ ?> style="display: none;" <?php } ?>>
            ...
            <div class="form-group col-sm-4 col-xs-12 padding-4">
                ...
                <input type="text" name="nationality_other" id="nationality_other"   value="<?= $nationality_other ?>"  class="form-control half input-style" <?php if($m_nationality!=0){?> disabled="disabled"<?php }?>/>
            </div>
            <div class="form-group col-sm-4 col-xs-12 padding-4">
    ...
    border-radius: 7px;"> 10 ارقام فقط</span></label>
                    <input type="text" onkeypress="validate_number(event)" maxlength="10" minlength="10" name="m_mob" id="m_mob"   onkeyup="check_len($(this).val(),'m_mob_span');"  value="<?php  echo $m_mob;?>"  class="form-control half input-style" data-validation="required" />
            ...
            <div class="col-md-12">
            <div class="form-group col-sm-4 col-xs-12 padding-4" >
                <label class="label label-green main-label  half" style="padding-left: 0;">رقم جوال اخر     <span class="pull-right" style="    background-color: #fff;
    color: #008996;
    padding: 0 6px;
    border-radius: 7px;"> 10 ارقام فقط</span></label>
