    ...
    <div class="panel-body sakn_form"<?php if(isset($check_data)&&!empty($check_data)){?>style="display:none;"   <?php } ?> ><br>
        ...
        <div class="col-sm-12 ">
            ...
            <div class="form-group col-sm-4 col-xs-12 padding-4">
                ...
                <input  placeholder="إدخل البيانات "  type="text"  onkeypress="validate_number(event);" <?=$dis?> name="h_loan_restoration_remain" value="<?php echo $result['h_loan_restoration_remain']?>" class=" form-control half input-style" placeholder="القيمة المتبقية" style="width: 25%;" id="fix-cost" >
            </div>
            </div>
