    ...
    <div class="panel-body">
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">الصوره الشخصيه</h4>
                        </div>
        ...
        <div class="col-sm-12 ">
            ...
            <div class="form-group col-sm-4 col-xs-12 padding-4">
                ...
                <input type="text" name="member_month_money"<?php if($member_job==0){?> disabled="disabled" <?php } ?>class="form-control half" onkeypress="validate_number(event);"  id="profession"   data-validation="required" value="<?php echo$member_month_money;?>"
                />
            </div>
        </div>
        <div class="col-sm-12 ">
            <div class="form-group col-sm-4 col-xs-12 padding-4">
                ...
                <input type="text" name="member_job_place"  class="form-control half" placeholder="مكان العمل" id="member_job_place"  <?php if($member_job == 0){ echo 'disabled=""';}?> data-validation="required" value="<?php echo$member_job_place;?>"  />
            </div>
            <div class="form-group col-sm-4 col-xs-12 padding-4">
                <label class="label label-green main-label  half"> النشاط </label>
                <select class="form-control half  "  data-show-subtext="true" data-live-search="true"   name="member_activity_type"  id="activity_type"  <?php if($member_job == 0){ echo 'disabled=""';}?>    data-validation="required"  aria-required="true">
                    <option value="">اختر</option>
