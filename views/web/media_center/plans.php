                            ...
                            <div class="col-md-4 mbottom-20">
                                <div class="report_item">
                                    ...
                                    <div class="download-btn-text"> 
                                        <a href="<?= base_url()."Web/download_new/".$record->file?>" class="pull-left" download><i class="fa fa-download"></i> التحميل</a>
                                        <a target="_blank" href="<?= base_url()."Web/read_file_new/".$record->file?>" class="pull-right"><i class="fa fa-eye"></i> معاينة</a>
                                    </div>
                                </div>
                            </div>
                            <?php
