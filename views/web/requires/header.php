...
<header>
    <div class="top_nav" data-spy="affix" data-offset-top="50">
        <div class="th-topinfo">
            ...
            <div class="col-md-7" >
                    ...
                    <ul class="list-unstyled left-nav-menu">
                        ...
                        <li class="search-adsa"><a href="#"><img src="<?php echo base_url() . 'asisst/web_asset/img/heade-icons/loupe.png'  ?>" /> </a></li>
                    </ul>
...
//                        $h_logo= base_url() . 'asisst/web_asset/img/sympol2.png' ;
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            ...
                            <li><a href="<?php echo base_url(); ?>Login">دخول الموظفين</a></li>
                               <li class="dropdown-submenu">
                                <a tabindex="-1" href="#">خدمات الأسر <span class="fa fa-chevron-left"
                                                                            style="float: left;"></span></a>
                                <ul class="dropdown-menu dropdown-submenu-hover">
                                    <li><a tabindex="-1" href="<?= base_url() . 'registration/Family/family_login' ?>">دخول
                                            المستفيدين</a></li>
                                    <li><a tabindex="-1" href="<?= base_url() . 'registration/Family/family_register' ?>">تسجيل أسرة</a>
                                    </li>
                                </ul>
                            </li>
             ...
             <li class=""><a target="_blank" href="https://store.abna.sa/">المتجر </a></li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                   ...
                   <!-- <li class=""><a href="<?= base_url() . 'Cards' ?>">cards </a></li>-->
...
<div class="sidebar-quick-links-fixed hidden-xs">
    ...
    <ul>
        ...
        <li>
            <a href="<?php echo base_url(); ?>gam3ia_omomia/Login_gam3ia_omomia">
                <i class="fa fa-home"></i>
...
<!--
<div class="fabMenu">
	<div class="fabMenu-btn open-bttn is-active pulsed" title="الدردشة والوصول المباشر">
		<span class="icon chatbtn">
			<i class="fa fa-comments"></i>
		</span>
	</div>
	<div class="fabMenu-btn close-bttn" title="الدردشة والوصول المباشر">
		<span class="icon chatbtn">
			<i class="fa fa-times-circle"></i>
		</span>
	</div>
	<div class="fabMenu-circle fabAR">
		<a class="fabMen-item locat" href="<?= base_url() . 'Web/contact' ?>">
			<span class="icon">
				<i class="fa fa-envelope-o"></i>
			</span>
			<span class="fabMen-item-text ">اتصل بنا</span>
		</a>
		<a class="fabMen-item callCenter" href="tel:0553851919">
			<span class="icon">
				<i class="fa fa-mobile"></i>
			</span>
			<span class="fabMen-item-text">0553851919</span>
		</a>
		<a class="fabMen-item whatsApp" href="#" data-toggle="modal" data-target="#whatsModal">
			<span class="icon">
				<i class="fa fa-whatsapp"></i>
			</span>
			<span class="fabMen-item-text"> تواصل على الواتس اب</span>
		</a>



		<a class="fabMen-item liveChat" href=" ">
			<span class="icon">
				<i class="fa fa-comment-o"></i>
			</span>
			<span class="fabMen-item-text ">محادثة مباشرة</span>
		</a>
	</div>
