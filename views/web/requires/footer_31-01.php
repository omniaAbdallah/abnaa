                ...
                <div id="block-footer1">
                    <div class="footer-widget about-column">
                        <figure class="footer-logo text-center">
                            <a href="index.html">
                                <img src="<?=base_url().'asisst/web_asset/'?>img/logo_footer.png" alt="">
                            </a>
                        </figure>
                        <ul class="contact-info list-unstyled">
                            <li><i class="fa fa-globe"></i> بريدة, المملكة العربية السعودية</li>
                            <li><i class="fa fa-phone"></i> الهاتف : <span> 966163851919+</span></li>
                            <li><i class="fa fa-mobile"></i> الجــوال : <span> 966553851919+</span></li>

                            <li><i class="fa fa-envelope-o"></i> البريد الالكتروني : <span>abnaa.bu@gmail.com</span></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-md-5 col-sm-6 col-xs-12">
                <div id="block-footer4">
                    <div class="footer-widget contact-column">
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d4250.26205247819!2d43.958243388492235!3d26.350845477606896!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x9167c434b0db3aa7!2z2KfZhNis2YXYudmK2Kkg2KfZhNiu2YrYsdmK2Kkg2YTYsdi52KfZitipINin2YTYo9mK2KrYp9mF!5e1!3m2!1sar!2seg!4v1548256649356" width="100%" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
...
<div class="copyright">
    <div class="container">
        <p class="">
             <a href="wwww.alatheertech.html">تصميم وتطوير شركة الأثير تك لتكنولوجيا المعلومات</a>.© جميع الحقوق محفوظة <span style="font-family: arial">2019</span>.
        </p>
    </div>
</div>
<!-- End Copyright Bar -->
...
<!-- SLIDER REVOLUTION 5.0 EXTENSIONS  
      ...
      <script type="text/javascript" src="<?=base_url().'asisst/web_asset/'?>plugin/revolution-slider/js/extensions/revolution.extension.actions.min.js"></script> 
      <script type="text/javascript" src="<?=base_url().'asisst/web_asset/'?>plugin/revolution-slider/js/extensions/revolution.extension.carousel.min.js"></script> 
      <script type="text/javascript" src="<?=base_url().'asisst/web_asset/'?>plugin/revolution-slider/js/extensions/revolution.extension.kenburn.min.js"></script> 
      <script type="text/javascript" src="<?=base_url().'asisst/web_asset/'?>plugin/revolution-slider/js/extensions/revolution.extension.layeranimation.min.js"></script> 
      <script type="text/javascript" src="<?=base_url().'asisst/web_asset/'?>plugin/revolution-slider/js/extensions/revolution.extension.migration.min.js"></script> 
      <script type="text/javascript" src="<?=base_url().'asisst/web_asset/'?>plugin/revolution-slider/js/extensions/revolution.extension.navigation.min.js"></script> 
      <script type="text/javascript" src="<?=base_url().'asisst/web_asset/'?>plugin/revolution-slider/js/extensions/revolution.extension.parallax.min.js"></script> 
      <script type="text/javascript" src="<?=base_url().'asisst/web_asset/'?>plugin/revolution-slider/js/extensions/revolution.extension.slideanims.min.js"></script> 
      <script type="text/javascript" src="<?=base_url().'asisst/web_asset/'?>plugin/revolution-slider/js/extensions/revolution.extension.video.min.js"></script>
