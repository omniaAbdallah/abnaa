...
<section class="banner_page" style="margin-top: -120px; ">
    <div class="container">
        <ol class="breadcrumb">
        <li><a href="#">الرئيسية</a></li>
            <li class="active"><a href="#">  تواصل مع موظفين الجمعيه</a></li>
        </ol>
    </div>
</section>
...
style="border-radius: 50%;height: 50px;width: 50px;margin-top: -70px;"/>
                  <div class="box-tools pull-right">
                    <span data-toggle="" title="Clear Chat" class="ClearChat"><i class="fa fa-comments"></i></span>
...
<script src="<?=base_url('public/family_chat/chat.js');?>"></script> 
        ...
        $("img").each(function () {
            ...
            $.ajax({
                ...
                error: function (response) {
                    ...
                    var replace_src = "<?=base_url()?>asisst/fav/apple-icon-120x120.png";
