...
<div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
    ...
    <?php //echo form_open_multipart('Web/add_wakel'); ?>
    <?php echo form_open_multipart('registration/Family/add_wakel',array('id'=>'wakel_form','class'=>'wakel_form')); ?>
                        ...
                        <tr>
                            <td style="width: 30px;">
                                ...
                                <a onclick=' swal({
                                        ...
                                        setTimeout(function(){window.location="<?= base_url() . 'Web/DeleteImage/' . $id . '/' . $mother_num ?>";}, 500);
                                        });'>
...
<script>
    ...
    function save_wakel() {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>registration/Family/add_wakel',
            data: form_data,
            cache: false,
            contentType: false,
            processData: false,
