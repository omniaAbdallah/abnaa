    ...
    <div class="panel-body" style="height: 100px;">
        <div class="col-sm-12 col-xs-12">
            ...
            <div class=" form-group col-md-2 col-sm-2 padding-4">
                ...
                <input  data-validation="required" type="password" name="user_password" onkeyup="valid_pass_length();" id="user_password" class="form-control"  />
                <span  id="validate_length" class="span-validation"> </span>
            </div>
            <div class=" form-group col-md-2 col-sm-2 padding-4">
                <label class="label label-green  ">تأكيد كلمة المرور <strong></strong> </label>
                <input  data-validation="required" type="password"   id="user_password_copy" onkeyup="return valid_pass_copy();" class="form-control"  />
