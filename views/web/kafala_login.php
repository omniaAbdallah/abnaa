                        ...
                        <div class="panel-heading">
                            <div class="view-header">
                                ...
                                <div class="header-title">
                                    <h4>تسجيل دخول كافل </h4>
                                </div>
                            </div>
                        </div>
                        <?php echo form_open_multipart(base_url().'Web/kafala_login')?>
                        <div class="panel-body" style="padding: 30px;">


                                <div class="form-group">
                                    <label class="control-label" for="user_name">إسم المستخدم</label>
                                    <input type="text" placeholder="برجاء إدخال إسم المستخدم الخاص بك " title="برجاء إدخال إسم المستخدم الخاص بك"
                                           data-validation="required"  value="" name="user_name" id="user_name" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label class="control-label" for="password">كلمة المرور</label>
                                    <input type="password" title="برجاء إدخال كلمة المرور الخاص بك " placeholder="برجاء إدخال كلمة المرور الخاص بك"
                                           data-validation="required"   value="" name="password" id="password" class="form-control">
                                </div>
                            <?php if ((isset($massege)) &&(!empty($massege))){
                                ?>
                                <span style="color:red;" class="error-text "><?=$massege?></span>
                                <?php
                            } ?>
                                <div class="text-center">

                                    <button class="btn btn-add btn-success"  value="1" onclick="setlogin()" name="login" type="submit" style="font-size:20px">الدخول</button>
                                </div>
