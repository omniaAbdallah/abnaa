            ...
            <div class="col-xs-6">
               <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="tele" class="form-control col-xs-4 no-padding" data-validation="required" >
                </div>
                
            <div class="form-group text-center">
                <div class="padding-30">
                    <input  type="submit" name="send" value="دخول" class="btn btn-default tbra"/>
                     <input  type="submit" name="send" value="تسجيل" class="btn btn-default tbra"/>
                </div>
