...
<div class="form-group col-sm-12 col-xs-12">
    ...
    <div class="form-group col-sm-2 col-xs-12 padding-4">
        <label class="label ">   السجل المدني <span class="label" id="checkUnique" ></span></label>
    ...
    <div class="form-group col-sm-2 col-xs-12 padding-4">
        ...
        <select id="current_forsa_fk" name="current_forsa_fk" class="form-control selectpicker" data-validation="required"
            ...
            if (isset($foras) && (!empty($foras))) {
                foreach ($foras as $key) {
                    ...
                    if (isset($volunteer['current_forsa_fk']) && (!empty($volunteer['current_forsa_fk']))) {
                        if ($key->id==$volunteer['current_forsa_fk']) {
                            $select = 'selected';
                        }
                    }
                    ?>
    ...
    <div class="form-group col-sm-2 col-xs-12 padding-4">
        ...
        <select id="skills" name="skills[]" multiple title="يمكنك إختيار أكثر من خبرةو مهارة "
...
<script>
    function show_pop(input_num, type, on_chang, text) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>tataw3/Tataw3_c/show_table',
            data: {
                input_num: input_num,
                type: type
            },
...
<script>
    ...
    function GetDiv(div) {
        ...
        var oTable_usergroup = $('#js_table_members').DataTable({
            dom: 'Bfrtip',
            "ajax": '<?php echo base_url(); ?>tataw3/Tataw3_c/getConnection',
            aoColumns: [
                {"bSortable": true},
                {"bSortable": true},
                {"bSortable": true}
