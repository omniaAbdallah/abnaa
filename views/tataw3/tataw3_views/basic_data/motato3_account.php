    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body" >
                             ...
                             //   echo '<pre>'; print_r($result);
                                if (isset($result) && !empty($result)) {
                                  ...
                                  //  $out['form'] = 'gam3ia_omomia/Gam3ia_omomia/update_gam3ia_member/' . $result->id;                            
                                    ...
                                    $user_password='';
                                    $suspend='';
                                    echo form_open_multipart('tataw3/Tataw3_c/update_motatw3_account', array('class' => 'Electronic_form'));
                ...
                <div class="form-group col-md-3 padding-4">
                    ...
                    <input type="password" name="user_password"   data-validation="required" onkeyup="valid_pass_length();" id="user_password" class="form-control  " value="<?= $user_password;?>" >
                    <span id="validate_length" class="span-validation"> </span>
                </div>
                <div class="form-group col-md-3 padding-4">
                    <label class="label   ">تاكيد كلمة المرور <strong></strong> </label>
                    <input type="password" id="user_password_copy"   data-validation="required"  onkeyup="return valid_pass_copy();" class="form-control  " >
...
function update_Electronic(id) {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url() ?>tataw3/Tataw3_c/update_motatw3_account',
            data: form_data,
            cache: false,
            contentType: false,
            processData: false,
