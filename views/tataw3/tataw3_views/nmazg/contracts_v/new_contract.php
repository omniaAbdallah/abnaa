...
if($this->uri->segment(6) == ""){
    echo form_open_multipart('human_resources/tataw3/nmazg/contracts/Contracts/new_contract'); 
  
    $action="حفظ";
}
else{
	echo form_open_multipart('human_resources/tataw3/nmazg/contracts/Contracts/edit_contract/'.$this->uri->segment(6)); 
    $action="تعديل";
...
<div class="col-sm-12 col-md-12 col-xs-12 padding-4">
	<div class="col-sm-2 col-md-2 col-xs-2">
		<button type="button" class="btn btn-success w-md m-b-5 " onclick="window.location.href = '<?=base_url()?>human_resources/tataw3/nmazg/contracts/Contracts';"><i class="fa fa-reply"></i> رجوع  </button>
	</div>
</div>
...
<script>
    function get_details() {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>human_resources/tataw3/nmazg/contracts/Contracts/get_detalis',
            data: dataString,
            dataType: 'html',
            cache: false,
...
<script>
        ...
        function get_mot3en() {
            ...
            $.ajax({
                type: 'post',
                url: "<?php echo base_url();?>human_resources/tataw3/nmazg/contracts/Contracts/get_mot3en",
                data: dataString,
    ...
    function get_moto3() {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>human_resources/tataw3/nmazg/contracts/Contracts/get_moto3',
            data: dataString,
            dataType: 'html',
            cache: false,
