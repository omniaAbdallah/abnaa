        ...
        <div class="panel panel-bd lobidisable lobipanel  lobipanel-sortable ">
            ...
            <div class="panel-body">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="form-group col-md-3 ">
                        <button type="button" class="btn btn-info "  data-toggle="modal" style="margin-top: 21px;"
                          data-target="#myModal">أعضاء الجلسة</button>
                ...
                <div class="col-sm-12">
                    ...
                    <button type="button"  onclick="check_button()" class="btn-success btn-labeled btn" name="btn" value="1">
