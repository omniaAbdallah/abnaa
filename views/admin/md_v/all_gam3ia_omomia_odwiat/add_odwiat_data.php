...
{
    $no3_odwia_fk = $result->no3_odwia_fk;
//    if ($no3_odwia_fk==102){
//        $rkm_odwia_full='/ع' ;
//    }
...
//    }
    ...
    if (isset($result->rkm_odwia) ){
        if ($no3_odwia_fk==102 || $no3_odwia_fk==103){
            $rkm_odiwa = $result->rkm_odwia_full;
        }
        else{
            $rkm_odiwa = $result->rkm_odwia;
        }

       // $rkm_odiwa = $result->rkm_odwia .$rkm_odwia_full;
    }
//    else{
//        $rkm_odiwa = $odwia_rkm +1 . $rkm_odwia_full ;
//    }


    $qrar_rkm = $result->qrar_rkm;
    $subs_value = $result->subs_value;
    $pay_method_fk = $result->pay_method_fk ;
    $bank_id_fk = $result->bank_id_fk ;
    $rkm_hesab = $result->rkm_hesab ;
    $odwia_status_fk = $result->odwia_status_fk ;
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group col-md-3 col-sm-6 padding-4">
                        ...
                        <select name="no3_odwia_fk" id="no3_odwia_fk"
                                ...
                                aria-required="true" onchange="changeOdwia()" >
...
-->
                    ...
                    <div class="form-group col-md-3 col-sm-6 padding-4">
                        ...
                        <div id="cal-1" style="width: 50%;float: left;">
                            <input id="date-Miladi" name="qrar_date_m" class="form-control bottom-input  "
                                   value="<?php  if(!empty($result->qrar_date_m)){ echo $result->qrar_date_m; }?>"
                    ...
                    <div class="form-group col-md-3 col-sm-6 padding-4">
                        ...
                        <div id="cal-end-2" style="width: 50%;float: right;">
                            <input id="date-Hijri-end" name="subs_from_date_h" class="form-control bottom-input "
                                   type="text"  onfocus="showCalEnd2();" value="<?php  if(!empty($result->subs_from_date_h)){ echo $result->subs_from_date_h; }?>"
                                   style=" width: 100%;float: right"/>
                        </div>
                        <div id="cal-end-1" style="width: 50%;float: left;">
                            <input id="date-Miladi-end" name="subs_from_date_m" class="form-control bottom-input  "
                                   value="<?php  if(!empty($result->subs_from_date_m)){ echo $result->subs_from_date_m; }?>"
                    ...
                    <div class="form-group col-md-3 col-sm-6 padding-4">
                        ...
                        <div id="cal-ch-2" style="width: 50%;float: right;">
                            <input id="date-Hijri-ch" name="subs_to_date_h" class="form-control bottom-input "
                                   type="text"  onfocus="showCalch2();" value="<?php  if(!empty($result->subs_to_date_h)){ echo $result->subs_to_date_h; }?>"
                                   style=" width: 100%;float: right"/>
                        </div>
                        <div id="cal-ch-1" style="width: 50%;float: left;">
                            <input id="date-Miladi-ch" name="subs_to_date_m" class="form-control bottom-input  "
                                   value="<?php  if(!empty($result->subs_to_date_m)){ echo $result->subs_to_date_m; }?>"
                    ...
                    <div class="form-group col-md-3 col-sm-6 padding-4">
                        ...
                        <div id="cal-up-2" style="width: 50%;float: right;">
                            <input id="date-Hijri-up" name="update_date_h" class="form-control bottom-input "
                                   type="text"  onfocus="showCalup2()" value="<?php  if(!empty($result->update_date_h)){ echo $result->update_date_h; }?>"
                                   style=" width: 100%;float: right"/>
                        </div>
                        <div id="cal-up-1" style="width: 50%;float: left;">
                            <input id="date-Miladi-up" name="update_date_m" class="form-control bottom-input  "
                                   value="<?php  if(!empty($result->update_date_h)){ echo $result->update_date_h; }?>"
                    ...
                    <div class="form-group col-sm-3 col-xs-12 padding-4">
                     ...
                     <div class="form-group col-md-3 col-sm-6 padding-4">
                        ...
                        <select name="odwia_status_fk" id="membership_status" class="form-control"
                                aria-required="true">
                            <option value="">إختر</option>
...
var rkm='<?php echo $result->rkm_odwia;?>';
