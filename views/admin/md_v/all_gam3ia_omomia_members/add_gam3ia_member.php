...
if(isset($result)&&!empty($result))
{
    ...
    $card_num=$result->members->card_num;
    $gns=$result->members->gns;
    $laqb_fk=$result->members->laqb_fk;
    $gnsia_fk =$result->members->gnsia_fk;
    $hala_egtma3ia_fk=$result->members->hala_egtma3ia_fk;
    $geha_esdar_fk=$result->members->geha_esdar_fk;
  //  $esdar_date=$result->esdar_date;
    $birth_date_m=$result->members->birth_date_m;
    $jwal=$result->members->jwal;
    $jwal_another=$result->members->jwal_another;
    $madina_fk=$result->members->madina_fk;
    $hai_fk=$result->members->hai_fk;
    $street_name=$result->members->street_name;
    $enwan_watni=$result->members->enwan_watni;
    $email=$result->members->email;
    $daraga_3elmia_fk=$result->members->daraga_3elmia_fk;
    $moahel_3elmi_fk=$result->members->moahel_3elmi_fk;
    $hya_3elmia_fk=$result->members->hya_3elmia_fk;
    $mehna_fk=$result->members->mehna_fk;
    $geha_amal=$result->members->geha_amal;
    $enwan_amal=$result->members->enwan_amal;
    $hatf_amal=$result->members->hatf_amal;
    $map_google_lng=$result->members->map_google_lng;
    $map_google_lat=$result->members->map_google_lat;
    $mem_img =$result->members->mem_img ;
    $esdar_date_h=$result->members->esdar_date_h;
    $birth_date_h=$result->members->birth_date_h;
    ...
    $out['form']='md/all_gam3ia_omomia_members/Gam3ia_omomia_members/update_gam3ia_member/'.$this->uri->segment(5);$card_img = $result->members->card_img;
                ...
                <div class="pull-left">
                    <?php if(isset($result) && !empty($result)){
                      //  if($result->suspend ==1){
                            ...
                            $data_load["id"]=$result->members->id ;
                    ...
                    <div class="form-group col-md-3 col-sm-6 padding-4">
                        ...
                        <div id="cal-2" style="width: 50%;float: right;">
                            <input id="date-Hijri" name="esdar_date_h" class="form-control "
                                   type="text"  onfocus="showCal2();" value="<?php  if(!empty($result->members->esdar_date_h)){ echo $result->members->esdar_date_h; }?>"
                                   style=" width: 100%;float: right"/>
                        </div>
                        <div id="cal-1" style="width: 50%;float: left;">
                            <input id="date-Miladi" name="esdar_date_m" class="form-control  "
                                   value="<?php  if(!empty($result->members->esdar_date_m)){ echo $result->members->esdar_date_m; }?>"
                    ...
                    <div class="form-group col-md-3 col-sm-6 padding-4">
                        ...
                        <div id="cal-end-2"  style="width: 50%;float: right;">
                            <input id="date-Hijri-end"  name="birth_date_h" class="form-control " type="text"
                                   onfocus="showCalEnd2();" value="<?php  if(!empty($result->members->birth_date_h)){ echo $result->members->birth_date_h; }?>"   onblur="getAge($(this).val());"  style=" width: 100%;float: right"/>
                        </div>
                        <div id="cal-end-1" style="width: 50%;float: left;">
                            <input id="date-Miladi-end"  name="birth_date_m"  value="<?php  if(!empty($result->members->birth_date_m)){ echo $result->members->birth_date_m; }?>" class="form-control  birth_date"
