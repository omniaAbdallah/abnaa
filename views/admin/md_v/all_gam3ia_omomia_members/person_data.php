            ...
            <div class="col-md-12 no-padding">
                <div class="user-widget list-group">
                    <div class="list-group-item heading">
                        ...
                        $user_img="";
                        if(isset($result)){
                            $user_img=  $result->members->mem_img ;
                        }?>
                    ...
                    <td><?php if(isset($result)){  echo $result->members->name;}?></td>
                    </tr>
                    
                    
                     <tr>
                    <th><strong class="text-danger ">رقم العضوية </strong></th>
                    <td><?php if(isset($result->rkm_odwia)){ echo $result->rkm_odwia;}?></td>
                    </tr>
                    
                     <tr>
                    <th><strong class="text-danger ">رقم الجوال</strong></th>
                    <td><?php if(isset($result)){ echo $result->members->jwal;}?></td>
                    </tr>
                    
                     <tr>
                    <th><strong class="text-danger ">رقم الهوية</strong></th>
                    <td> <?php if(isset($result)){ echo  $result->members->card_num;}?></td>
                    </tr>
                    
                     <tr>
                    <th><strong class="text-danger ">رقم قرار المجلس</strong></th>
                    <td><?php  if(isset($result)){ echo  $result->qrar_rkm;}?></td>
                    </tr;
                    </tbody>
                    </table>
                </div>
