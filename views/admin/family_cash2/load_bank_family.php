...
<div class="col-xs-12">
    <div class="form-group col-sm-6 col-xs-12">
        <div class="form-group col-sm-12">
            <label class="label label-green  half">إسم الجهة/المستفيد   </label>
            <select name="person_id_fk" class="form-control half"  onchange="get_other_person(this.value);pass_person_name($('option:selected',this).text());" data-validation="required" aria-required="true" tabindex="-1" aria-hidden="true">
        ...
        <div class="form-group col-sm-12">
            <label class="label label-green  half">إسم أخر  </label>
            <input type="text" id="other_person"   name="other_person"  onkeyup="pass_person_name(this.value);" class="form-control half input-style" readonly="" >
        </div>
    </div>
    <div class="form-group col-sm-6 col-xs-12">
     ...
     <!--   <div class="form-group col-sm-12">
            <label class="label label-green  half">إضافة مرفق  </label>
            <input type="file"   name="bank_attachment" class="form-control half input-style"  >
        </div>-->
    </div>
...
<?php   }elseif($member_type == 1 && $sarf_type == 2){    //     sarf_type = 2       member_type == 1    ?>
    <div class="col-xs-12">
        <div class="form-group col-sm-6 col-xs-12">
            <div class="form-group col-sm-12">
                <label class="label label-green  half">إسم الجهة/المستفيد   </label>
                <select  name="person_id_fk" class="form-control half" onchange="get_other_person(this.value);" data-validation="required" aria-required="true" tabindex="-1" aria-hidden="true">
                    <option value="">إختر</option>
                    <?php if(isset($all_mother_family) && !empty($all_mother_family)){
                        foreach ($all_mother_family as $row_m){  ?>
                            <option value="<?=$row_m->mother_national_num_fk?>"><?=$row_m->full_name?></option>
            ...
            <div class="form-group col-sm-12">
                <label class="label label-green  half">إسم أخر  </label>
                <input type="text" id="other_person"   name="other_person"  class="form-control half input-style" readonly="" >
            </div>
        </div>
        <div class="form-group col-sm-6 col-xs-12">
...
<?php   }elseif($member_type == 1 && $sarf_type == 3){    //     sarf_type = 3       member_type == 1    ?>
    <div class="col-xs-12">
        ...
        <div class="form-group col-sm-6 col-xs-12">
           ...
           <!-- <div class="form-group col-sm-12">
                <label class="label label-green  half">إضافة مرفق  </label>
                <input type="file" id=""  name="bank_attachment" class="form-control half input-style"  >
            </div>-->
        </div>
