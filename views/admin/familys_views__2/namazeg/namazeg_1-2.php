...
<div class="col-sm-12 no-padding">
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
        ...
        <div class="panel-body">
            ...
            if (!empty($result)) {
                echo form_open_multipart('family_controllers/namazegs/Namazeg/update', array('id' => 'myform'));
                ...
                echo form_open_multipart('family_controllers/namazegs/Namazeg/insert', array('id' => 'myform'));
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="AttachTable">
                    ...
                    <?php
                    echo form_open_multipart('family_controllers/namazegs/Namazeg/add_morfaq');
                    ?>
                        ...
                        <tr>
                         ...
                         <span style="font-size: 12px; color: white !important; font-weight: normal;width: 141px;"
                            ...
                            <td>
                                ...
                                <a href="<?php echo base_url() . 'family_controllers/namazegs/Namazeg/edit/' . $value->letter_rkm ?>"
...
<?php } ?>
                                   ...
                                   <a href="<?php echo base_url() . 'family_controllers/namazegs/Namazeg/printNamazeg/' . $value->letter_rkm ?>"
...
<script>
    ...
    function load_table() {
        ...
        var oTable_usergroup = $('#my_table').DataTable({
            dom: 'Bfrtip',
            "ajax": '<?php echo base_url(); ?>family_controllers/namazegs/Namazeg/getFamilyTable',
...
<script>
    ...
    function GetNamozegDiv(value) {
        ...
        if (value != 0 && value != '') {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo base_url() ?>family_controllers/namazegs/Namazeg/getNamozegDetails',
                data: dataString,
                dataType: 'html',
                cache: false,
...
<script>
    function Delete_namozeg(value) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                window.location.href = "<?php echo base_url();?>family_controllers/namazegs/Namazeg/Delete_namozeg/" + value;
...
<script>
    ...
    function details(value) {
        ...
        if (value != 0 && value != '') {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo base_url() ?>family_controllers/namazegs/Namazeg/getDetailsDiv',
                data: dataString,
                dataType: 'html',
                cache: false,
                success: function (html) {
        ...
        $('#update').on('click',function () {
            ...
            $.ajax({
                ...
                success: function (html) {
                  ...
                  setTimeout(function(){  window.location="<?= base_url()?>family_controllers/namazegs/Namazeg"; }, 4000);

                  //  $('#myModalInfo').modal('hide');
                 //   window.location="<?= base_url()?>family_controllers/namazegs/Namazeg";
...
<script>
    function get_family_mumber(file_num) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>family_controllers/namazegs/Namazeg/family_member',
