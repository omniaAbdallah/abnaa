...
<div class="col-sm-12 col-md-12 col-xs-12  " style="padding: 0;">
        ...
        <div class="panel-body">
            <div class="form-group col-sm-12 col-xs-12 no-padding">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#tab1" data-toggle="tab">الطلبات الواردة</a></li>
                    <li><a href="#tab2" data-toggle="tab"> الطلبات الصادرة </a></li>
                </ul>
                <!-- Tab panels -->
            ...
            if (!empty($result)) {
                echo form_open_multipart('family_controllers/namazegs/Namazeg/update______', array('id' => 'myform'));
                ...
                echo form_open_multipart('family_controllers/namazegs/Namazeg/insert___________', array('id' => 'myform'));
  ...
  <div class="col-sm-3  col-md-3 padding-4 ">
                ...
                <div class="col-sm-3  col-md-2 padding-4 ">
                    <label class="label label-green  ">الطلبات </label>
