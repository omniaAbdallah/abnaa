   ...
   <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td class="text-center">
                                <h5 style="font-weight: bold;" ><?=$sarf_details_rows ?></h5>
                            </td>
                            <td class="text-center">
                                <h5 style="font-weight: bold;" >أيتام </h5>
                            </td>
                            <td class="text-center" >
                                <h5 style="font-weight: bold;" ><?php echo  $all_aytam_num ?></h5>
                            </td>
                            <td class="text-center">
                                <h5 style="font-weight: bold;" ><?php echo $record['value_yatem'] ?></h5>
                            </td>
                            <td class="text-center">
                                <h5 style="font-weight: bold;" ><?php echo $record['total_value'] ?></h5>
                            </td>
