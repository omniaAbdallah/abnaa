...
<div class="row" style="    height: 40px;">
 ...
 <input type="hidden" id="row" name="row" value="<?= $sarf_num_fk; ?>">
 <div class="col-md-6 col-sm-4  ">
    ...
    <div class="col-md-2 col-sm-4 padding-4">
                      ...
                      <input type="file" name="file[]" id="filee" multiple class="form-control" data-validation="reuqired">
     </div>
     
                 <div class="col-xs-2 text-center" style="margin-top: 29px;">
      <button type="button"
                    class="btn btn-labeled btn-success "  onclick="upload_img(<?=$sarf_num_fk; ?>)"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php
                                        ...
                                        ?>
                                        <!-- <a target="_blank" href="<?=base_url()."family_controllers/FamilyCashing/read_file/".$morfaq->file?>">
                        ...
                        <div class="modal fade" id="myModal-pdf-<?= $morfaq->id ?>" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                             <iframe src="<?=base_url()."family_controllers/FamilyCashing/read_file/".$morfaq->file?>" style="width: 100%; height:  640px;" frameborder="0">
                                               </iframe>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-default" data-dismiss="modal">
...
?>
                                ...
                                <td>
                                    ...
                                    <i class="fa fa-trash" style="cursor: pointer"
                                       onclick="delete_morfq(<?= $morfaq->id ?>,<?= $morfaq->sarf_num_fk ?>)"></i>
                                </td>
                            </tr>
                        <?php
                        }
...
<script>
    ...
    closeOnConfirm: false
        ...
        if(error == '') {
            $.ajax({
                url:"<?php echo base_url(); ?>family_controllers/FamilyCashing/upload_img", //base_url() return http://localhost/tutorial/codeigniter/
                method:"POST",
                data:form_data,
                contentType:false,
                cache:false,
...
function(isConfirm) {
  if (isConfirm) {
      $.ajax({
          type: 'post',
          url: '<?php echo base_url() ?>family_controllers/FamilyCashing/delete_morfq',
          data: {id: id},
          dataType: 'html',
          cache: false,
    ...
    function get_details(id) {
       // $('#pop_rkm').text(rkm);
        $.ajax({
            type: 'post',
            data: {id: id},
            url: "<?php echo base_url();?>family_controllers/FamilyCashing/load",
            beforeSend: function () {
