    ...
    <table id="" class="display table table-bordered   responsive nowrap dataTable no-footer dtr-inline"  >
        ...
        <?php $count=1 ;for($x=1;$x<=$madeen_num;$x++){ ?>
            ...
            <tr>
                ...
                <td><input type="number" step="any"  name="madeen_value[]" class="form-control cl_madeen" onkeyup="get_calcolate('cl_madeen','span_madeen');"  data-validation="required"/>
        ...
        <?php for($y=1;$y<=$dayen_num;$y++){ ?>
            <tr>
                <td><?php echo $count++ ?></td>
                <td><input type="number"  step="any"    name="dayen_value[]" class="form-control cl_dayen" onkeyup="get_calcolate('cl_dayen','span_dayen');"  data-validation="required"/>
