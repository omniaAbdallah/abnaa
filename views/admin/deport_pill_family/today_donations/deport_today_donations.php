                           ...
                           <?php if(isset($pay_1) && !empty($pay_1) && $pay_1 !=null){?>
                               <table class="table table-bordered table-hover table-striped hidden-print" style="direction: rtl;">
                                   ...
                                   <tr>
                                       ...
                                       <td><?php if($row->donate_type_id_fk == 1) {
                                               echo $row->donors_name;
                                           }elseif($row->donate_type_id_fk == 2){
                                           echo $row->name;
                                           }else{ echo $row->sponsors_name;
                           ...
                           <?php if(isset($pay_6) && !empty($pay_6) && $pay_6 !=null){?>
                               <table class="table table-bordered table-hover table-striped hidden-print" style="direction: rtl;">
                                   ...
                                   <tr>
                                       ...
                                       <td><?php if($row->donate_type_id_fk == 1){echo "متبرع";}elseif($row->donate_type_id_fk == 2){echo "فاعل خير";}elseif($row->donate_type_id_fk == 3){ echo "كفيل";}?></td>
                                       <td><?=$row->value?></td>
                                       <td><?=$row->title?></td>
                                       <td><?=$row->program_name?></td>
                                   </tr>
...
<div class="modal fade modal-primary" id="modal-lg" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <?php echo  form_open_multipart('DeportPillForFamily/DeportQuedTodayDonations') ?>
...
<script>
    ...
    function deport(name_form){
        ...
        $.ajax({
            type:'post',
            url: '<?php echo base_url() ?>DeportPillForFamily/DeportTodayDonations',
            data:dataString,
            dataType: 'html',
            cache:false,
