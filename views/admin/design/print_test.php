...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url() ?>asisst/admin_asset/css/font-awesome.min.css">
		<link rel="stylesheet" href="<?php echo base_url() ?>asisst/admin_asset/admin/css/stylecrm.css">
	<link rel="stylesheet" href="<?php echo base_url() ?>asisst/admin_asset/admin/css/style.css">
								...
								<div class="print_forma  col-xs-12">
									...
									<div class="piece-box" style="margin-top: 10px">
												...
												<thead >
													<tr class="graytd">
														<th class="text-center" style="text-align: center;">
															<i class="fa fa-circle"></i> عن طريق المصرف /البنك      
														</th>
														<th class="text-center" style="text-align: center;">
															<i class="fa fa-circle-o"></i> عن طريق الأونلاين            
										...
										<div class="col-xs-12">
											...
											<h5> نرجوا من سعادتكم الموافقة على التحويل من الحسابات الفرعية بـــ/مصرف الراجحي إلى الحساب الرئيسي وفقا للجدول التالي :-    </h5>
										</div>
										<div class="col-xs-12">
											<table class="table table-bordered">
												<thead >
												...
												<tfoot>
													<th class="gray_background" style="text-align: center;">الغرض من التحويل</th>
													<th colspan="2">تغطية مصروفات الجمعية</th>
												</tfoot>
											</table>
										</div>
										<div class="col-xs-12">

											<h5>	المندوب المفوض/ -----------رقم الهوية/--------- التوقيع/-------التاريخ:17/07/2019 م</h5>
