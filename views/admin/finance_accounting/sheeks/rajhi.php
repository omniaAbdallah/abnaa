    ...
    width: 100%;
		...
		.top-backs{
			padding: 0 5px;
			background: url(<?php echo base_url(); ?>asisst/admin_asset/img/sheek_imgs/raghi_back.png);
			...
			<div class="top-backs">
				<div class="bond-header">
					...
					<div class="col-xs-4 pad-2">
						<div class="logo">
							<img src="<?php echo base_url(); ?>asisst/admin_asset/img/sheek_imgs/elraghy.png"/>
							<h3 >فرع السادة بريدة</h3>
							<h3 style="font-weight: bold;">AL-SADAH BR BURAIDAH </h3>
						</div>
					</div>
					...
					<div class="col-xs-12 pad-2">
						...
						<div class="col-xs-9 no-padding">
							...
							<div class="name-charity">
								<h5>الجمعية الخيرية لرعاية الأيتام ببريدة</h5>
								<h5>بريدة</h5>
							</div>
						</div>
					</div>
