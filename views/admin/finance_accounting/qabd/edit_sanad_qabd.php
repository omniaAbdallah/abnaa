...
<div class="col-sm-12  wow" >
  ...
  <a href="<?php echo base_url() ?>admin/Finance_accounting/all_sand_qabd" class="btn btn-success">الرجوع للسندات </a>
                             ...
                             <div class="col-xs-4 inner-side r-data" <?php if($type==1){?>style="display: block";<?php }else{?> style="display: none" <?php } ?>>
                                ...
                                <div class="col-xs-6 r-input">
                                    <select name=""  id="box_name" disabled="true">
                                        ...
                                        <option value="<?php echo $one_box->code?>"<?php if($all_vouchers[0]->maden==$one_box->code) {   ?> selected="selected"<?php }?> >  <?php echo $one_box->name?></option>
                             ...
                             <div class="col-xs-4 inner-side r-data" <?php if($type==2||$type==3){?>style="display: block";<?php }else{?> style="display: none" <?php } ?>>
                                ...
                                <div class="col-xs-6 r-input">
                                    <select name="bank_name"  id="bank_name" disabled="true" >
                                        <option value=""> - اختر - </option>
                                        <option value="3"> - البنك - </option>
                                      <?php if(isset($banks) && $banks !=null):
                                        foreach($banks as $one_bank): ?>
                                        <option value="<?php echo $one_bank->code?>"<?php if($all_vouchers[0]->maden==$one_bank->code) {   ?> selected="selected"<?php }?>>  <?php echo $one_bank->name?></option>
                                        <?php endforeach; endif;?>
                                    </select>
                                </div>
                            </div>
...
<div class="alert alert-danger  emptybasket" style="display: none;">
  <strong>نجاح!</strong> تم حذف التعديلات
    ...
    <tr>
      ...
      <td class="text-center" style="width: 20% !important;"> حساب المدين</td>
