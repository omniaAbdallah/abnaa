                ...
                <table  class="table table-striped table-bordered" style="width:100%">
                    ...
                    <?php $x=1; foreach($records as $row ):?>
                        <tr class="">
                            ...
                            <td> <a href="<?php echo base_url('admin/Finance_accounting/sand_qabd_edit').'/'.$row->vouch_num.'/'.$row->vouch_type?>">
                            ...
                            <div class="modal-dialog " role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <form action="<?php echo base_url('admin/Finance_accounting/sand_qabd_delete').'/'. $row->vouch_num ?>">
