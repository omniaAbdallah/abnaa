                        ...
                        <div class="col-xs-12 r-inner-details">
                            <div class="col-xs-12 inner-side r-data">
                                ...
                                <div class="col-xs-6 r-input">
                                    <input type="number" class="r-inner-h4 " id="vouch_num" name="vouch_num" placeholder=" رقم السند "/>
                                </div>
                            </div>
                            <div class="col-xs-12 inner-side r-data">
                                <div class="col-xs-6">
                                ...
                                <div class="col-xs-6 r-input ">
                                    <div class="docs-datepicker">
                                        <div class="input-group">
                                            <input type="date" name="recive_date_other"  id="recive_date" class="form-control "  placeholder="شهر / يوم / سنة "/>
                                        </div>
                                    </div>
                                </div>
                            </div>
