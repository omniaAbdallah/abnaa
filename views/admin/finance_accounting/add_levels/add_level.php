                ...
                <div class="col-md-6 r-sanad-col-md">
                    <div class="col-xs-12 ">
                        <div class="col-xs-12 inner-side r-data" id="optionearea4">
                            ...
                            <div class="col-xs-6 r-input">
                                <select name="from_id" id="from_id" onchange="get_code($('#from_id').val(),'add_level')"  class="selectpicker form-control" data-show-subtext="true" data-live-search="true" data-validation="required" aria-required="true">
                                    <option data-subtext="" value=""> قم باختيار الحساب الرئيسى</option>
                        ...
                        <div class="col-xs-12 inner-side r-data">
                            ...
                            <div class="col-xs-6 r-input">
                                <input type="text" id="name" name="name" class="r-inner-h4 "  value="" data-validation="required"/>
                            </div>
                        </div>
                        <div class="col-xs-12 inner-side r-data">
                            <div class="col-xs-6">
                            ...
                            <div class="col-xs-6 r-input">
                                <select name="branch" id="branch" class="form-control"  onchange="get_rased($('#branch').val(),'<?php echo $this->uri->segment(3)?>')"  data-validation="required" aria-required="true">
