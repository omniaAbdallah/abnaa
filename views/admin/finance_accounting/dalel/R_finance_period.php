    ...
    <form id="myform">
        <div class="col-md-12 no-padding">
            <div class="form-group col-md-3 col-sm-6 padding-4 text-center">
                ...
                <?php  $x=0;foreach ($array as  $key=>$value){ $x++; ?>
                <div class="radio-content">
                   <input <?php if($key ==1){echo'checked'; }?>
                                class="status_value" type="radio" value="<?php echo $key;?>"
                                onclick="view_function(<?php echo $value;?>)"
                                name="status" id="status_value<?php echo $key;?>">
                                
                 <label class="radio-label" for="status_value<?php echo $key;?>"><?php echo $value;?> </label>  
         ...
         <div class="form-group col-md-3 col-sm-6 " id="zero_account" >
            
                     <div class="check-style"  style="margin-top: 23px;">
                         <input tabindex="9" name="zero" id="square-checkbox-1" type="checkbox" id="zero" checked >
...
<script>
   ...
   function SearchTable() {
        ...
        var zero_account = $('input[name=zero]:checked').val();


        if(zero_account ==='on') {
        var zero_account = 'on';
         }else{
            var zero_account = 'off';
        }
//alert(zero_account); return;
