    ...
    <div class="panel panel-bd lobidrag">
        ...
        <div class="panel-body">
            ...
            function buildTreeTable($tree, $count=1)
            {
                ...
                foreach ($tree as $record) {
                    ...
                    <tr class="text-center">
                        ...
                        }else{ echo 0; }?>" data-number="0">0.00</td>
            ...
            <div class="table-wrap" id="printMe">
                ...
                <table id="scrollingtable" class="table table-bordered  scrollingtable my_table" border="1" cellpadding="3" role="table" style="table-layout: fixed" >
            ...
            /*
                        ...
                        for (var i = 0; i < cls1.length; i++) {
                            if (cls1[i].className == "td1") {
                                sum1 += isNaN(cls1[i].innerHTML) ? 0 : parseFloat(cls1[i].innerHTML);
                            }
                        ...
                        for (var i = 0; i < cls2.length; i++) {
                            if (cls2[i].className == "td2") {
                                sum2 += isNaN(cls2[i].innerHTML) ? 0 : parseFloat(cls2[i].innerHTML);
                            }

                        }
                        for (var i = 0; i < cls3.length; i++) {
                            if (cls3[i].className == "td3") {
                                sum3 += isNaN(cls3[i].innerHTML) ? 0 : parseFloat(cls3[i].innerHTML);
                            }
                        ...
                        for (var i = 0; i < cls4.length; i++) {
                            if (cls4[i].className == "td4") {
                                sum4 += isNaN(cls4[i].innerHTML) ? 0 : parseFloat(cls4[i].innerHTML);
                            }

                        }
                        for (var i = 0; i < cls5.length; i++) {
                            if (cls5[i].className == "td5") {
                                cls5[i].innerHTML = (parseFloat(cls1[i].innerHTML) + parseFloat(cls3[i].innerHTML));
                                sum5 += isNaN(cls5[i].innerHTML) ? 0 : parseFloat(cls5[i].innerHTML);
                            }

                        }
                        for (var i = 0; i < cls6.length; i++) {
                            if (cls6[i].className == "td6") {
                                cls6[i].innerHTML = (parseFloat(cls2[i].innerHTML) + parseFloat(cls4[i].innerHTML));
                                sum6 += isNaN(cls6[i].innerHTML) ? 0 : parseFloat(cls6[i].innerHTML);
                            }

                        }
                        for (var i = 0; i < cls7.length; i++) {
                            if (cls7[i].className == "td7") {
                                sum7 += isNaN(cls7[i].innerHTML) ? 0 : parseFloat(cls7[i].innerHTML);
                            }

                        }
                        for (var i = 0; i < cls8.length; i++) {
                            if (cls8[i].className == "td8") {
                                sum8 += isNaN(cls8[i].innerHTML) ? 0 : parseFloat(cls8[i].innerHTML);
                            }
                        ...
                        $(".result5").text(sum5.toLocaleString('us', {minimumFractionDigits: 2, maximumFractionDigits: 2}));
                        $(".result6").text(sum6.toLocaleString('us', {minimumFractionDigits: 2, maximumFractionDigits: 2}));
                        $(".result7").text(sum7.toLocaleString('us', {minimumFractionDigits: 2, maximumFractionDigits: 2}));
                        $(".result8").text(sum8.toLocaleString('us', {minimumFractionDigits: 2, maximumFractionDigits: 2}));
