...
//total_sabeq
        ...
        <?php if (empty($record['children'])) {
            ...
            if ($_POST['zero_account'] === 'on') {
                if (in_array($record['code'], $arr)) {
                    continue;
                }
            } ?>
            <tr class="text-center">
                <td class="requirementRight" style="text-align: right;width: 500px;"><span
                            style="width: 100px;text-align: left;display: inline-block;"><?= $record['code'] ?> </span>
                    <span style="width: 200px;float: left;display: inline-block;"> - <?= $record['name'] ?> </span></td>
                <td style="display: none" class="td1" data-type="<?php if (isset($record['children'])) {
                    echo 1;
                } else {
                    echo 0;
                } ?>" data-number="<?= $rased_sabek_madeen ?>"><?php echo number_format($rased_sabek_madeen, 2); ?></td>
                <td style="display: none" class="td2" data-type="<?php if (isset($record['children'])) {
                    echo 1;
                } else {
                    echo 0;
                } ?>" data-number="<?= $rased_sabek_dayen ?>"><?php echo number_format($rased_sabek_dayen, 2); ?></td>
                <td style="display: none" class="td3" data-type="<?php if (isset($record['children'])) {
                    echo 1;
                } else {
                    echo 0;
                } ?>" data-number="<?= $maden ?>"><?php echo number_format($maden, 2); ?></td>
                <td style="display: none" class="td4" data-type="<?php if (isset($record['children'])) {
                    echo 1;
                } else {
                    echo 0;
                } ?>" data-number="<?= $dayen ?>"><?php echo number_format($dayen, 2); ?></td>
                <td style="display: none" class="td5" data-type="<?php if (isset($record['children'])) {
                    echo 1;
                } else {
                    echo 0;
                } ?>"
                    data-number="<?php echo($rased_sabek_madeen + $maden); ?>"><?php echo number_format($maden + $rased_sabek_madeen, 2); ?></td>
                <td style="display: none" class="td6" data-type="<?php if (isset($record['children'])) {
                    echo 1;
                } else {
                    echo 0;
                } ?>"
                    data-number="<?php echo($rased_sabek_dayen + $dayen); ?>"><?php echo number_format($dayen + $rased_sabek_dayen, 2); ?></td>
                <td class="td7" data-type="<?php if (isset($record['children'])) {
                    echo 1;
                } else {
                    echo 0;
                } ?>" data-number="<?= $rased_madeen ?>"><?php echo number_format($rased_madeen, 2); ?></td>
                <td class="td8" data-type="<?php if (isset($record['children'])) {
                    echo 1;
                } else {
                    echo 0;
                } ?>" data-number="<?= $rased_dayen ?>"><?php echo number_format($rased_dayen, 2); ?></td>
            </tr>
        <?php } ?>
...
if (isset($records) && !empty($records)) {
    ...
    <div class="table-wrap" id="printMe">
        ...
        <table id="" class=" table table-bordered scrollingtable my_table" role="table"
            ...
            <tr class="greentd text-center">
                ...
                <th style="width: 500px;">إسم الحساب</th>
                <th style="text-align: center;display: none" class="text-center">رصيد سابق مدين</th>
                <th style="text-align: center;display: none" class="text-center">رصيد سابق دائن</th>
                <th style="text-align: center;display: none" class="text-center">حركة مدين</th>
                <th style="text-align: center;display: none" class="text-center">حركة دائن</th>
                <th style="text-align: center;display: none" class="text-center">إجمالى مدين</th>
                <th style="text-align: center;display: none" class="text-center">إجمالى دائن</th>
                ...
                <th style="text-align: center;" class="text-center"> الأصول</th>
                <th style="text-align: center;" class="text-center">الخصوم</th>
            </tr>
            ...
            <tfoot>
            <tr class="orangetd">
                <td style="color: #000;text-align: center;background-color:#fcb632; border-left: 0;font-size:20px;">
                    الإجمالي
                </td>

                <td style="color: #000;display: none" class="result1">0</td>
                <td style="color: #000;display: none" class="result2">0</td>
                <td style="color: #000;display: none" class="result3">0</td>
                <td style="color: #000;display: none" class="result4">0</td>
                <td style="color: #000;display: none" class="result5">0</td>
                <td style="color: #000;display: none" class="result6">0</td>
