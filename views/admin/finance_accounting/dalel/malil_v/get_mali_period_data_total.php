        ...
        if ($_POST['zero_account'] === 'on') {
            if (in_array($record['code'], $arr)) {
                ...
                <tr class="text-center">
                    <td class="requirementRight" style="text-align: right;"><span
                    ...
                    <td style="display: none" class="td1" data-type="<?php if (isset($record['children'])) {
                        ...
                        data-number="<?= $all_total_sabeq_maden ?>"><?php echo number_format($all_total_sabeq_maden, 2); ?></td>
                    <td style="display: none" class="td2" data-type="<?php if (isset($record['children'])) {
                        echo 1;
                    } else {
                        echo 0;
                    } ?>"
                        data-number="<?= $all_total_sabeq_dayen ?>"><?php echo number_format($all_total_sabeq_dayen, 2); ?></td>
                    ...
                    <td style="display: none" class="td5" data-type="<?php if (isset($record['children'])) {
                        ...
                        data-number="<?php echo($all_total_sabeq_maden + $maden); ?>"><?php echo number_format($all_total_sabeq_maden + $maden, 2); ?></td>
                    <td style="display: none" class="td6" data-type="<?php if (isset($record['children'])) {
                        echo 1;
                    } else {
                        echo 0;
                    } ?>"
                        data-number="<?php echo($all_total_sabeq_dayen + $dayen); ?>"><?php echo number_format($all_total_sabeq_dayen + $dayen, 2); ?></td>
            ...
            <tr class="text-center">
                <td class="requirementRight" style="text-align: right;"><span
                            style="width: 100px;text-align: left;display: inline-block;"><?= $record['code'] ?></span>
                    <span style="width: 280px;float: left;display: inline-block;"> - <?= $record['name'] ?> </span></td>
                <td style="display: none" class="td1" data-type="<?php if (isset($record['children'])) {
                    echo 1;
                } else {
                    echo 0;
    ...
    <div class="table-wrap" id="printMe">
        ...
        <table id="" class=" table table-bordered scrollingtable my_table" role="table" style="table-layout: fixed">
            ...
            <tr class="greentd text-center">
                ...
                <th style="width: 600px;">إسم الحساب</th>
