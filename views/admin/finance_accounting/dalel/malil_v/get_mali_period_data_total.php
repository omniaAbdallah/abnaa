...
*/
        ...
        <?php
            ...
            if($_POST['zero_account'] ==='on'){
                if(in_array($record['code'],$arr)){ }else{?>

            <tr class="text-center">
                <td class="requirementRight" style="text-align: right;"><span style="width: 100px;text-align: left;display: inline-block;"><?=$record['code'] ?></span> 
                <span style="width: 280px;float: left;display: inline-block;">- <?=$record['name']?> </span> </td>
                <td  style="display: none" class="td1" data-type="<?php if (isset($record['children'])) { echo 1;
                }else{ echo 0; }?>" data-number="<?=$all_total_sabeq_maden?>"><?php echo number_format($all_total_sabeq_maden,2); ?></td>
                <td style="display: none"class="td2" data-type="<?php if (isset($record['children'])) { echo 1;
                }else{ echo 0; }?>" data-number="<?=$all_total_sabeq_dayen?>"><?php echo number_format($all_total_sabeq_dayen,2); ?></td>
                <td style="display: none"class="td3" data-type="<?php if (isset($record['children'])) { echo 1;
                }else{ echo 0; }?>" data-number="<?=$maden?>"><?php echo number_format($maden,2);?></td>
                <td style="display: none"class="td4" data-type="<?php if (isset($record['children'])) { echo 1;
                }else{ echo 0; }?>" data-number="<?=$dayen?>"><?php echo number_format($dayen,2);?></td>
                <td style="display: none"class="td5" data-type="<?php if (isset($record['children'])) { echo 1;
                }else{ echo 0; }?>" data-number="<?php echo ($all_total_sabeq_maden+ $maden);?>"><?php echo number_format($all_total_sabeq_maden+ $maden,2);?></td>
                <td style="display: none"class="td6" data-type="<?php if (isset($record['children'])) { echo 1;
