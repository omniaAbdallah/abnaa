    ...
    foreach ($tree as $record) {
        ...
        if($_POST['zero_account'] ==1){
            if( $rased_sabek_madeen == 0 && $rased_sabek_madeen ==0.00
                ...
                $record['all_madeen'] ==0 && $record['all_madeen'] == 0.00
...
//total_sabeq
        ...
        <tr class="text-center">
            <td><?=$record['code'] ?></td>
            <td><?=$record['name']?> </td>
            <td class="td1"><?php echo$rased_sabek_madeen; ?></td>
            <td class="td2"><?php echo$rased_sabek_dayen; ?></td>
            <td class="td3"><?php echo sprintf("%.2f", ($maden));?></td>
            <td class="td4"><?php echo sprintf("%.2f", ($dayen));?></td>
            <td class="td5">0</td>
            <td class="td6">0</td>
            <td class="td7"><?php //$rased_madeen?></td>
            <td class="td8"><?php //$rased_dayen?></td>
        </tr>
        <?php
