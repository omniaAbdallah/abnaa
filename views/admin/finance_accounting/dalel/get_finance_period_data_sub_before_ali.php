        ...
        ?>
            ...
            if($_POST['zero_account'] ==='on'){
                ...
                <tr class="text-center">
                    ...
                    }else{ echo 0; }?>" data-number="<?php echo ($rased_sabek_madeen+ $maden);?>"><?php echo number_format($maden+$rased_sabek_madeen);?></td>
                    <td class="td6" data-type="<?php if (isset($record['children'])) { echo 1;
                    }else{ echo 0; }?>" data-number="<?php echo ($rased_sabek_dayen+ $dayen);?>"><?php echo number_format($dayen+$rased_sabek_dayen);?></td>
        ...
        buttons: [
...

            {
                ...
                customize: function (win) {
                    ...
                    $(win.document.body).find('.tablearea tbody')
                    .after('<tfoot><tr>'+
                    '<td style="color: #fff;text-align: center;background-color:#09704e !important; border-left: 0;">الإجمالي</td>'+
                    '<td></td>'+
                    '<td class="result1">0</td>'+
                    '<td class="result2">0</td>'+
                    '<td class="result3">0</td>'+
                    ...
                    $(win.document.body).find('thead tr:last-child th:nth-child(1)').css("width", "70px");
                    $(win.document.body).find('thead tr:last-child th:nth-child(2)').css("width", "130px");
                },
                exportOptions: {
                    modifier: {
                        page: 'current'
