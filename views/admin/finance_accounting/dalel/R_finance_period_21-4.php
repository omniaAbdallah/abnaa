        ...
        <div class="col-md-12 no-padding">
            <div class="form-group col-md-3 col-sm-6 padding-4 text-center">
                ...
                <?php foreach ($array as  $key=>$value){ ?>
                    <label class="radio-inline"><input <?php if($key ==1){echo'checked'; }?> type="radio" value="<?php echo $key;?>" onclick="view_function($(this).val())" name="status"><?php echo $value;?></label>
...
<script>
    ...
    function SearchTable() {
        ...
        var dataString = 'from=' + from + '&to=' + to  + '&zero_account=' + zero_account;
       // alert(dataString)
            //return;
        $.ajax({
            type: 'post',
