        ...
        buttons: [
...

            {
                ...
                customize: function (win) {
                    $(win.document.body).append("<style> body{  background-color: #fff;} @page{size:landscape;margin:20px}</style>")
                    ...
                    $(win.document.body).find('thead th:nth-child(1)').css("width", "120px");
                    $(win.document.body).find('thead th:nth-child(2)').css("width", "200px");
                },
                exportOptions: {
                    modifier: {
                        page: 'current'
