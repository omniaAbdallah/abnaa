        ...
        ?>
            ...
            <?php  if (empty($record['children'])) { ?>
                <tr class="text-center">
                    ...
                    }else{ echo 0; }?>" data-number="<?php echo ($rased_sabek_madeen+ $maden);?>">0</td>
                    <td class="td6" data-type="<?php if (isset($record['children'])) { echo 1;
                    }else{ echo 0; }?>" data-number="<?php echo ($rased_sabek_dayen+ $dayen);?>">0</td>
        ...
        buttons: [
...

            {
                ...
                customize: function (win) {
                    $(win.document.body).append("<style> body{background-color: #fff;} @page{size: 210mm 297mm;margin:0 10px 35 10px;}</style>");
...
<script>
    ...
    for (var i = 0; i < cls5.length; i++) {
        if (cls5[i].className == "td5") {
           ///// cls5[i].innerHTML = formatMoney(parseInt(cls1[i].innerHTML) + parseInt(cls3[i].innerHTML));
    ...
    for (var i = 0; i < cls6.length; i++) {
        ...
        ////   cls6[i].innerHTML = formatMoney(parseInt(cls2[i].innerHTML) + parseInt(cls4[i].innerHTML));
