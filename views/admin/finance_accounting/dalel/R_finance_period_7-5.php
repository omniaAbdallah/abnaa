            ...
            <div class="form-group col-md-3 col-sm-6 padding-4 text-center">
                ...
                <?php foreach ($array as  $key=>$value){ ?>
                   <div class="radio-content">
                    <input <?php if($key ==1){echo'checked'; }?> type="radio" value="<?php echo $key;?>" onclick="view_function($(this).val())" name="status" id="status_value<?php echo $key;?>" class="status_value">
