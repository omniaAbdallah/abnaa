            ...
            <div class="form-group col-sm-12 col-xs-12 no-padding">
                ...
                <fieldset>
                    <?php if (!empty($parent['name'])) { ?>
                        <legend style="float: left;margin-top: -46px;"> الحساب العام: <?= $parent['name'] ?></legend>
                    <?php } ?>
                ...
                <div class="col-xs-12 text-center">
                    ...
                    <?php if (isset($method) && ($method == 1)) { ?>
                        ...
                        <button type="button" class="btn btn-labeled btn-success" name="save" value="save"
                                ...
                                id="myBtn" onclick="save_account(1)">
                        ...
                        <button type="button" class="btn btn-labeled btn-success" name="save" value="save"
                                ...
                                id="myBtn" onclick="save_account(2)">

                            <span class="btn-label"><i class="glyphicon glyphicon-floppy-disk"></i></span>حفظ واستمرار
                        </button>
