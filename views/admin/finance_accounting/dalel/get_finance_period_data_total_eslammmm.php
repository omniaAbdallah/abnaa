...

            {
                ...
                customize: function (win) {
                    ...
                    var headerfatra= '<div class="col-xs-12" style="margin-top: -16px;"> '+
                        ...
                        '<div class="col-xs-5 no-padding"><h5 class="span_font" style="margin-right: 20px; padding: 2px 0;"><b>نوع التقرير:</b><span class="border-box span_font"> إجمالي تفصيلي </span></h5></div> '+
