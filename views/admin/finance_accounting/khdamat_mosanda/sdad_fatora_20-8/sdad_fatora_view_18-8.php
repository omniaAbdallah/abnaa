...
<!--                    </select>-->
               ...
               <br>
                <table class="table table-striped table-bordered"   style="" id="mytable">
                    ...
                    <?php if(isset($rows[0]->details) && !empty($rows[0]->details)){
                        ...
                        ?>
                            <tr id="<?=$y?>">
                                ...
                                <td><input type="text" data-validation="required" onkeyup="put_total();" style="width: 80px;"  onkeypress="validate_number(event);" value="<?php echo $row->f_value;?>" class="form-control valu f_value"  name="f_value[]"></td>
                                ...
                                <td> <input type="text" value="<?php echo $row->rkm_fatora;?>" onkeypress="validate_number(event);" name="rkm_fatora[]" style="width: 100px;" class="form-control rkm_fatora"/> </td>
                    ...
                    <?php $y++;  } } else { ?>
                    <tr id="1">
                        <td><input type="text" data-validation="required" onkeyup="put_total();" style="width: 80px;"  onkeypress="validate_number(event);" class="form-control valu f_value" value="" name="f_value[]"></td>
                        ...
                        <td> <input type="text" onkeypress="validate_number(event);" name="rkm_fatora[]" style="width: 100px;" class="form-control rkm_fatora"/> </td>
