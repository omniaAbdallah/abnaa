            ...
            <div class="col-sm-12 form-group">
                <div class="col-sm-3  col-md-3 padding-4 ">
                    ...
                    <input type="text" name="geha_name" id="geha_name" readonly value="<?php echo $geha_name; ?>"
                           class="form-control " style="width: 86%;float: right">
                ...
                <div class="col-sm-3  col-md-3 padding-4 ">
                    ...
                    <input type="text" name="subscriber_name" id="subscriber_name" readonly value="<?php echo $subscriber_name; ?>"
                           class="form-control " style="width: 86%;float: right">
                    <button type="button" data-toggle="modal"
                ...
                <div class="col-sm-3  col-md-2 padding-4 ">
                  ...
                  <div class="col-sm-3  col-md-2 padding-4 ">
                    <label class="label ">تاريخ اصدار الفاتورة </label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="col-sm-12 no-padding form-group">
                        ...
                        <div id="subscriber_input" style="display: none">
                            ...
                            <div class="col-sm-3  col-md-2 padding-4" id="div_add_sub" style="display: none;">
                                <button type="button" onclick="add_subscription_members( )" style="    margin-top: 27px;"
                                        class="btn btn-labeled btn-success" name="save" value="save">
                                    <span class="btn-label"><i class="glyphicon glyphicon-floppy-disk"></i></span>حفظ
                                </button>
                            </div>
                ...
                <div id="myDiv_sub"><br><br>
                    <?php if (!empty($subscription_members)) { ?>
                        <table id="" class=" example table table-bordered table-striped" role="table">
                            <thead>
                            <tr class="greentd">
                                <th width="2%">#</th>
                            ...
                            <?php
                            $x = 1;
                            foreach ($subscription_members as $value) {
                                ?>
                                <tr>
                                    <td><input type="radio" name="radio" data-title="<?= $value->title ?>"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="AttachTable">
                    <?php
                    echo form_open_multipart('finance_accounting/khdamat_mosanda/add_fatora/Add_fatora/add_morfaq', array('id' => 'formAttach'));
                    ?>
                    <div class="col-sm-12 form-group">
                        ...
                        <div class="col-sm-4  col-md-4 padding-4 ">
                            <div class="col-sm-2  col-md-2 padding-4 "></div>
...
<script>
    ...
    function add_subscription_members() {
        $('#div_update_sub').hide();
        $('#div_add_sub').show();
        //  alert(value);
        ...
        if (title != 0 && title != '' && mob != ' ' && address != ' ') {
            var dataString = 'title=' + title + '&mob=' + mob + '&address=' + address;
            $.ajax({
                type: 'post',
                url: '<?php echo base_url() ?>finance_accounting/khdamat_mosanda/add_fatora/Add_fatora/insert_subscription_members_ajax',
                data: dataString,
                dataType: 'html',
                cache: false,
    ...
    function delte_subscription_members(id) {
    ...
    function update_subscription_members(id) {
        var id = id;
        ...
        $.ajax({
            url :"<?php echo base_url() ?>finance_accounting/khdamat_mosanda/add_fatora/Add_fatora/getById_subscription_members",
            type : "Post",
            dataType : "html",
            data: {id:id},
        ...
        $('#update_sub').on('click',function() {
            ...
            $.ajax({
                url :"<?php echo base_url() ?>finance_accounting/khdamat_mosanda/add_fatora/Add_fatora/update_subscription_members",
                type : "Post",
                dataType : "html",
                data: {title:title,address:address,mob:mob,id:person_id},
                success: function (html) {
                    //  alert('hh');
                    $('#person_title').val(' ');
                    $('#person_address').val(' ');
