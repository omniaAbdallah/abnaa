...
<input type="hidden" name="no3_elsdad" value="<?=$_POST['no3_elsdad']?>">
	...
	<div class="print_forma  col-xs-12 no-padding">
		...
		<div class="piece-box" style="margin-top: 10px">
         ...
         <?php } } ?>
					...
					<td class="text-center" colspan="5">مبلغا وقدره:<?php if(!empty($_POST['total_value_arabic'])){ echo $_POST['total_value_arabic']; }?></td>
			...
			<div class="col-xs-12 form-group">
				<input name="t_foot" style="width:100%" value="نأمل التكرم لمن يلزمه الامر بعمل اللازم" />
			</div>
