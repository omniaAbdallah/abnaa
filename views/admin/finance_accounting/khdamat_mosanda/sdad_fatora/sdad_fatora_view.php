...
<!--                    </select>-->
                ...
                <table class="table table-striped table-bordered"   style="" id="mytable">
                    ...
                    <tr class="info">
                        ...
                        <th style="width: 140px;">رقم الفاتورة / الحساب</th>
                    ...
                    <?php if(isset($rows[0]->details) && !empty($rows[0]->details)){
                        ...
                        ?>
                            <tr id="<?=$y?>">
                                ...
                                <td><input type="text" data-validation="required" onkeyup="put_total();"   onkeypress="validate_number(event);" value="<?php echo $row->f_value;?>" class="form-control valu f_value" id="f_value<?=$y;?>"  name="f_value[]" ></td>
                                <td><input type="date"  id="date<?=$y?>"data-validation="required"  class="form-control " value="<?php echo $row->date_ar;?>"/> </td>
                                <td>
                                    <input type="hidden" value="<?php echo $row->f_geha_id_fk;?>"  class="f_geha_id_fk" id="geha_id_fk<?=$y;?>"/>

                                    <input type="text" class="form-control"   value=" <?php echo $row->f_geha_name ;?>" data-validation="required"  id="geha_name<?=$y;?>" readonly 
                                ...
                                <td> <input type="text" value="<?php echo $row->rkm_fatora;?>" onkeypress="validate_number(event);"  id="rkm_fatora<?=$y;?>" class="form-control rkm_fatora"/> </td>
                                <td><input type="text " value="<?php echo $row->byan;?>" class="form-control byan" name="byan[]" id="byan<?=$y;?>"></td>
                                <td>
                                    <select  id="markz<?=$y;?>"
                    ...
                    <tr>
                        ...
                        <!--<button type="button" onclick="add_row()"
                                     class="btn btn-success btn-next"/><i class="fa fa-plus"></i>  
                                     </button> -->
                                     </td>
