...
<?php $x=1; foreach($vouchers as $row ):?>
 <tr class="">
     ...
     <td> 
     <a href="<?php echo base_url().'admin/Finance_accounting/deports_vouchers/'.$row->vouch_num.'/1/'.$process."/".$controller?>">
...
<?php $x=1; foreach($all_vouchers as $row ):?>
 <tr class="">
   ...
   <td><center> 
     ...
     <td>   <a href="<?php echo base_url().'admin/Finance_accounting/deports_vouchers/'.$row->vouch_num.'/0/'.$process."/".$controller?>">
