...
<link rel="stylesheet" href="<?php echo base_url()?>asisst/admin_asset/css/style.css">
    ...
    <style type="text/css">
        body{
            background: url(<?php echo base_url()?>asisst/admin_asset/img/ezn/sarf-bckground.jpg) ;
...
<div style="margin-top: 130px;">
    ...
    <div class="print_forma  col-xs-12 ">
                ...
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="col-xs-10 no-padding">
                        <h3 style="font-weight: bold;">سعادة مدير عام الجمعية     
                           <span style="float: left;">سلمه الله</span></h3>
                    </div>
                    <div class="col-xs-1"></div>
                </div>
                <div class="col-xs-12">
        ...
        <div class="piece-box no-border">
            <div class="piece-body">
                <div class="col-xs-12">
                    <h4 class="text-center"><span style="border-bottom:1px solid #000;font-weight: 600 ">إفادة الشئؤون المالية</span></h4>
                    <table class="table table-bordered" style="table-layout: fixed">
                        <tbody>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <h5 class="text-center" style="margin: 4px">
                                    <?php if(!empty($result->sarf_method)){
                                    if($result->sarf_method==1){?>
                                    <span> <i class="fa fa-circle"></i> نقداً </span>&nbsp&nbsp&nbsp
                                    <?php } ?>
                                    <?php
                                    if($result->sarf_method==2){?>
                                        <span> <i class="fa fa-circle"></i> اصدار شيك </span>&nbsp&nbsp&nbsp
                                    <?php } ?>
                                    <?php
                                    if($result->sarf_method==3){?>
                                        <span> <i class="fa fa-circle"></i> تحويل </span>&nbsp&nbsp&nbsp
                                    <?php }} else{ ?>
                                        <span> <i class="fa fa-circle-o"></i> نقداً </span>&nbsp&nbsp&nbsp
                                        <span> <i class="fa fa-circle-o"></i> اصدار شيك </span>&nbsp&nbsp&nbsp
                                        <span> <i class="fa fa-circle-o"></i> تحويل </span>&nbsp&nbsp&nbsp
                ...
                <div class="col-xs-12">
                    <h4 class="text-center"><span style="border-bottom:1px solid #000;font-weight: 600 ">توجيه المدير العام</span></h4>
                    <div class="col-xs-4 ">
                        ...
                        <?php } ?>
                        <?php if(empty($result->twgeh_moder_3am)){?>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-4 text-center">
                        ...
                        <h5 style="font-weight: bold">سلطان بن محمد الجاسر</h5>
                    </div>
                    <div class="clearfix"></div>
                    <hr>
                    <h4 class="text-center"><span style="border-bottom:1px solid #000;font-weight: 600 ">إعتماد أمين الصندوق-عضو مجلس الإدارة</span></h4>
                    <div class="col-xs-8 "></div>
                    <div class="col-xs-4 text-center">
                        <br>
                        <h5 style="font-weight: bold">أمـــــــــــــــين   الصنـــــــــــــــــــدوق</h5><br>
                        <h5 style="font-weight: bold">عبدالله بن عبدالعزيز الصبيحي</h5>
                    </div>
