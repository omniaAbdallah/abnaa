...
<div class="col-md-8 no-padding">
 <div class="panel panel-default">
    <div class="panel-heading">تفاصيل سند الصرف</div>
...
<div class="col-md-4 no-padding">
 ...
 <form action="<?=site_url('finance_accounting/box/ezn_sarf/Ezn_sarf/process_transform')?>" method="post">
 ...
 <input type="hidden" name="level" value="<?=$eznInfo['level']?>" />
  ...
  <tbody>
      ...
      <td>
       ...
       <div class="radio">
  <label style="color: green;"><input type="radio" value="accept" name="option_choosed" >موافق</label>
</div>
<div class="radio">
  <label style="color: red;"><input type="radio" value="refuse" name="option_choosed">غير موافق</label>
</div>
      ...
      <td>
<div class="form-group">
    <label for="exampleFormControlTextarea1">الأسباب - الملاحظات</label>
...
if($eznInfo['level'] >= 0) { ?>
  <!--  
 <div class="panel panel-default">
    <div class="panel-heading">تحويل إذن الصرف إلي المدير المباشر</div>
    <div class="panel-body">
