...
<table class="table table-striped table-bordered"  style="table-layout: fixed">
    ...
    <tr>
        ...
        <td> <span class=""  ><?php echo$records[0]->rqm_sanad?></span></td>
        <td class="closed_green">تاريخ السند </td>
        <td><span class=" " ><?php echo$records[0]->date_sanad_ar?></span></td>
    </tr>
    <tr>
        <td class="closed_green">إستلمت من  </td>
        <td colspan="3"><span class="" ><?php echo$records[0]->recived_from?></span></td>
    </tr>
    <tr>
        <td class="closed_green">عبارة عن </td>
        <td colspan="3"> <span class="" ><?php echo$records[0]->about?></span></td>
    </tr>
...
<table class="table table-striped table-bordered" style="table-layout: fixed;" id="mytable">
    ...
    <tbody>
    <?php
    if(!empty($records[0]->delails)){
        foreach ($records[0]->delails as $row_detail){
            ?>
            <tr>
                <td>
...
<table class="table table-striped table-bordered"  style="table-layout: fixed">
    ...
    <tr>
        ...
        <td> <span class=""  ><?php echo $records[0]->rqm_sanad?></span></td>
        <td class="closed_green">تاريخ السند </td>
        <td><span class=" " ><?php echo date('Y-m-d',$records[0]->date_sanad)?></span></td>
    </tr>
    <tr>
        <td class="closed_green">إدفعوا لأمر  </td>
        <td colspan="3"><span class="" ><?php echo$records[0]->person_name?></span></td>
    </tr>
    <tr>
        <td class="closed_green">عبارة عن </td>
        <td colspan="3"> <span class="" ><?php echo$records[0]->about?></span></td>
