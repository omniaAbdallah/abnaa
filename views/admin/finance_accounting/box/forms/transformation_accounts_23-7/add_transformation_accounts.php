        ...
        <div class="panel-body">
            ...
            <div class="col-sm-12 form-group">
              ...
              <div class="col-sm-4 col-md-4 padding-4">
                    <label class="label label-green  ">إختر </label>
                    <input tabindex="11" type="radio"  style="width:20px" id="square-radio-1" name="method_type" value="1"

            <?php if(!empty($result->method_type)){  if ($result->method_type ==1) {
                 echo "checked";
            }} ?>
                    >
                     <label for="square-radio-1">عن طريق المصرف/ البنك</label>
                     <input tabindex="11" type="radio"   style="width:20px" id="square-radio-1" name="method_type" value="2"

                     <?php if(!empty($result->method_type)){  if ($result->method_type ==2) {
                          echo "checked";
                     }} ?>>
                     <label for="square-radio-1">عن طريق الأونلاين</label>
                ...
                <div class="col-sm-3  col-md-1 padding-4 ">
                                    <label class="label label-green  ">رقم العملية</label>
                ...
                <div class="col-sm-3  col-md-2 padding-4 ">
                                ...
                                <div class="col-sm-1  col-md-2 padding-4 ">
                                    <label class="label label-green  ">بداية اللقب </label>
                                ...
                                <div class="col-sm-3  col-md-3 padding-4 ">
                                    ...
                                    <input type="text" name="geha_name" id="geha_name" readonly value="<?php echo $geha_name; ?>"
                                           class="form-control input-style" style="width: 86%;float: right">
                                ...
                                <div class="col-sm-3  col-md-3 padding-4 ">
                                                  <label class="label label-green  ">إسم الموظف</label>
                                                  <input type="text" class="form-control input-style" name="emp_name"
                                                        id="emp_name" style="width: 86%;float: right"
                                              ...
                                              <div class="col-sm-2  col-md-2 padding-4 ">
                                                  <label class="label label-green  ">المصرف </label>
                                                  <select name="bank_id" id="bank_id"
                                                      ...
                                                      <?php if(!empty($all_banks)){  foreach($all_banks as $bank){ ?>
                                                          <option value="<?php echo$bank->bank_id_fk; ?>"
                                                              ...
                                                              <?php if(!empty($result->bank_id)){ if($result->bank_id ==$bank->bank_id_fk){
                                                                  echo'selected';
                                                              }}?>
                                              ...
                                              <div class="col-sm-4  col-md-4 padding-4 ">
                                                  <label class="label label-green  ">الغرض من التحويل </label>
                                                  <textarea name="reason"  class=" form-control "  data-validation="required"  >
