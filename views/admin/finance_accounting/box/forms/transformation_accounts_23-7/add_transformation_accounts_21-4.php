    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
        ...
        <div class="panel-body">
            ...
            <div class="col-md-12 no-padding">
                ...
                <div class="col_md_25 col-sm-6 padding-4">
                    <div class="col-md-5 col-sm-6 no-padding">
                        <h6 class="label_title_2 ">إسم الجهة </h6>
                    </div>
            ...
            <div class="col-md-12 no-padding">
                <div class="col_md_25 col-sm-6 padding-4">
                    <div class="col-md-5 col-sm-6 no-padding">
                        <h6 class="label_title_2 ">إسم الموظف</h6>
                    </div>
                    <div class="col-md-6 col-sm-6 no-padding">
                ...
                <div class="col_md_25 col-sm-6 padding-4">
                    <div class="col-md-5 col-sm-6 no-padding">
                        <h6 class="label_title_2 ">رقم الهوية</h6>
                    </div>
                    <div class="col-md-6 col-sm-6 no-padding">
                            ...
                            foreach ($result->attaches as $row_img) { ?>
                                <tr class="<?php echo $x ?>">
                                    <td><input type="input" name="title[]" readonly id="title"
                                               value="<?php echo $row_img->title ?>" class="form-control  "
                                               data-validation="reuqired"></td>
                                    <td><img id="img_view<?php echo $x ?>"
