                          ...
                          <div class="col-xs-12">
                              <div class="personality">
                                  ...
                                  <div class="col-xs-7 ahwal_style">
                                      <h4 class=""
                                          style="font-weight: bold !important;font-size: 20px !important;">سعادة/مدير عام الجمعية </h4>
                                  </div>
                                  <div class="col-xs-3">
                                      <h4 class=""
                                          style="font-weight: bold !important;font-size: 20px !important;">حفظه الله</h4>
                                  </div>
                                  ...
                                  <div class="col-xs-12 no-padding">
                                      ...
                                      <div class="col-md-12 no-padding">
                                          <?php $counter =1; if(!empty($result_details)){ ?>
                                          <table class="table table-striped table-bordered" style="table-layout: fixed;" id="mytable">
                                              <thead>
                                              <tr class="info">
                                                  <th style="width: 30px; text-align:center; background-color: #428bca;"></th>
