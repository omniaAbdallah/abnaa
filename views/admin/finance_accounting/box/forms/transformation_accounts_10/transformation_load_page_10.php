        ...
        <div class="col-sm-12 no-padding" id="MohasebDiv">
            <div class="form-group col-md-6 col-sm-6 padding-4">
                ...
                <select data-validation="required" name="job_title" id="job_title"
                    ...
                    <?php if(!empty($all_egraat)){  foreach ($all_egraat as $row){ ?>

                        <option value="<?php echo $row->job_title_code_fk;?>"
                        <?php if($row->job_title_code_fk==502){ echo'selected'; }?>
          ...
          <div class="form-group col-md-6 col-sm-6 padding-4">
            ...
            <select data-validation="required" name="current_to_id" id="current_to_mohaseb" class="form-control" data-validation="required" aria-required="true" onchange="
              ...
              <option value="<?= $row->emp_id ?>" data-img="<?= $row->person_img ?>" data-name="<?= $row->person_private_name ?>" data-job="<?= $row->job_title ?>"><?= $row->person_private_name ?></option>
              <?php }?>
          ...
          <div class="form-group col-md-6 col-sm-6 padding-4">
              ...
              <select data-validation="required" name="job_title" id="job_title"
                  ...
                  <?php if(!empty($all_egraat)){  foreach ($all_egraat as $row){ ?>
                      ...
                      <option value="<?php echo $row->job_title_code_fk;?>"
                          <?php if($row->job_title_code_fk==501){ echo'selected'; }?>
                      ><?php echo $row->job_title;?></option>
          ...
          <div class="form-group col-md-6 col-sm-6 padding-4">
              ...
              <select data-validation="required" name="job_title" id="job_title"
                  ...
                  <?php if(!empty($all_egraat)){  foreach ($all_egraat as $row){ ?>
                      ...
                      <option value="<?php echo $row->job_title_code_fk;?>"
                          <?php if($row->job_title_code_fk==101){ echo'selected'; }?>
                      ><?php echo $row->job_title;?></option>
...
<?php }elseif ($transformation_data->level == 3) {?>
  <button type="button" style="float: right;" onclick="manager_approved()" class="btn btn-success btn-labeled"><span class="btn-label"><i class="glyphicon glyphicon-floppy-disk"></i></span>حفظ
  </button>
<?php } ?>
