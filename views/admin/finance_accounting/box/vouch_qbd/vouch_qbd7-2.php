...
<input type="radio"  name="pay_method" style="margin-right: 8px; width: 20px; height: 20px;"  onclick="$('#pay_method_span').html('سند قبض نقدى');$('.tr').hide();"
<?php if($pay_method != 2){?> checked <?php } ?>
data-validation="required" value="1"/> <label class="no-margin no-padding"> نقدي</label>
</div>
<div class="col-md-6 col-sm-6 no-padding">
<input type="radio"  name="pay_method" style="width: 18px; height: 18px;" onclick="$('#pay_method_span').html('سند قبض شيك'); $('.tr').show();"
           ...
           <div class="col-md-12 no-padding">
                    <div class="col_md_70 col-sm-6 padding-4">
                        ...
                        <div class="col-md-10 col-sm-6 no-padding">
                            <input  list="pepople_arr" autocomplete="off" style="width:90%; float: right;"
                ...
                <div class="col-md-12 no-padding">
                   ...
                   id="mytable">
                            ...
                            foreach ($details as $row_detail){
                                ...
                                <tr id="<?=$row_detail->id?>">
                                    ...
                                    <td id="TD<?=$row_detail->id?>">
                                        ...
                                        <a class="pull-right"  id="deleteRow<?=$row_detail->id?>" href="#" onclick="deleteRow(this); getVouchQbdSum();"><i class="fa fa-trash" aria-hidden="true"></i>
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <table class="table table-striped table-bordered tr"  style="table-layout: fixed;<?php if(empty($result->delails_cheque)){?> display: none; <?php } ?>" id="chequeTable">
...
<div class="modal fade" id="detailsModal<?=$value->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    if( isset($value->delails_cheque)&&!empty($value->delails_cheque)){?>
                <table class="table table-striped table-bordered" style="table-layout: fixed; width: 80%;">
