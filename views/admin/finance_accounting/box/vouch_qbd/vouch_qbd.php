             ...
             <div class="col-sm-9 no-padding">
                ...
                if(isset($result) && !empty($result)) {
                    ...
                    $details = $result->delails;
                       ...
                       //osama
                     $type = $result->type;
                     $person_name = $result->recived_from;//$result->person_name;
  ...
  echo form_open_multipart('finance_accounting/box/vouch_qbd/Vouch_qbd/update/'.$result->id.'/'.$result->rqm_sanad.'/'.$result->qued_rkm_id_fk);
               ...
               // return;
                ...
                <div class="col-md-12 no-padding">
                    <div class="col_md_30 col-sm-6 padding-4">
                            ...
                            <div class="radio-content">
                                <input type="radio"  name="pay_method"   onclick="$('#pay_method_span').html('سند قبض نقدى');$('.tr').hide();" id="pay_method1"
                                <?php if($pay_method != 2){?> checked <?php } ?>
                                data-validation="required" value="1"/> 
                                <label class="radio-label" for="pay_method1"> نقدي</label>
                            </div>
                            
                            
                            <div class="radio-content">
                                <input type="radio"  name="pay_method"  onclick="$('#pay_method_span').html('سند قبض شيك'); $('.tr').show();" id="pay_method2"
                                <?php if(!empty($pay_method) && $pay_method == 2){ ?> checked <?php } ?>
                                data-validation="required" value="2" /> 
                                <label class="radio-label" for="pay_method2"> شيك</label>
                            </div>
                ...
                <div class="col-md-12 no-padding">
                 ...
                 <div class="col_md_65 col-sm-6 padding-4">
                                ...
                                <h6 class="label_title_2" style="padding-right: 0px;">حساب الصندوق (مدين)</h6>
                     ...
                     <div class="col_md_35 col-sm-6 padding-4">
                                ...
                                <input type="text" name="rased" style="color: red !important;" id="rased"  data-validation="required"
                                 class="form-control input_style_2 error"
                                      value=<?php if(!empty($pay_method) && $pay_method != 2){ echo ( $all_qabd_naqdi  - $all_sarf_naqdi); } else {echo ( $all_qabd_sheek  - $all_sarf_sheek);} ?>" data-validation-has-keyup-event="true" disabled="">
           ...
           <div class="col-md-12 no-padding">
                    <div class="col-md-5 col-sm-6 padding-4">
                            ...
                            <input  list="pepople_arr" autocomplete="off" style="width:87%; float: right;"
                                    type="text" name="person_name" id="person_name"
                                    class="form-control input_style_2 list inputclass"
                ...
                <div class="col-md-12 no-padding">
                    <table class="table table-striped table-bordered mblgh-tb" style="table-layout: fixed;margin-top: 5px;"
                   id="mytable">
                        <thead>
                        <tr class="info">
                        ...
                        <?php $counter =1; if(!empty($details)){
                            foreach ($details as $row_detail){
                                ...
                                <tr id="<?=$row_detail->id?>">
                                    ...
                                    <td id="TD<?=$row_detail->id?>">
                                        ...
                                        <a  id="deleteRow<?=$row_detail->id?>" href="#" onclick="deleteRow(this); getVouchQbdSum();"><i class="fa fa-trash" aria-hidden="true"></i>
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <tr id="<?=$counter?>">
                                ...
                                <td id="TD<?=$counter?>">
                                    ...
                                    <a  style="display: none;" id="deleteRow<?=$counter?>" href="#" onclick="$('#<?=$counter?>').remove(); getVouchQbdSum();"><i class="fa fa-trash" aria-hidden="true"></i>
                                    </a>
                                </td>
                            </tr>
                        <?php } ?>
                    ...
                    <table class="table table-striped table-bordered tr mblgh-tb"  style="table-layout: fixed;<?php if(empty($result->delails_cheque)){?> display: none; <?php } ?>" id="chequeTable">
                        ...
                        <tbody>
                        <?php if(empty($result->delails_cheque)){?>
                            <tr class="tr" style="display: none;">
                                ...
                                <td><a readonly type="button" id="delPOIbutton" value="" onclick="deleteRow(this)" ><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                            </tr>
                        <?php } ?>
                        <?php if(isset($result->delails_cheque) && !empty($result->delails_cheque) &&$pay_method==2){
                            foreach($result->delails_cheque as $row){
                                ?>
                                <tr>
...
<!--
  ...
  <button type="button" class="btn btn-labeled btn-yellow "  id="search_button" data-target="#searchModal"  data-toggle="modal" >
...
<div class="col-sm-12 col-md-12 col-xs-12  " style="padding: 0;">
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
        <div class="panel-heading">
                ...
                <h3 class="panel-title">السندات</h3>
           
        </div>
        <div class="panel-body">
            <div class="form-group col-sm-12 col-xs-12">
                <table id="example" class="table table-bordered table-striped" role="table" style="table-layout: fixed;">
                    <thead>
                    <tr class="info">
                        <th style="width: 40px;">م</th>
                        <th style="width: 100px;" class="text-left">نوع السند</th>
                        <th style="width: 80px;" class="text-left">رقم السند</th>
                        
                        <th style="width: 100px;" class="text-left">تاريخ السند</th>
                          <th style="width: 80px;" class="text-left">رقم القيد</th>
                    ...
                    if (isset($records) && $records != null) {
                        ...
                        foreach ($records as $value) {
                            ...
                            ?></td>
                                ...
                                <td>
                                    <button title="تفاصيل سند القبض رقم <?php echo $value->rqm_sanad;  ?>" type="button" class="btn btn-sm btn-labeled btn-add" data-toggle="modal" data-target="#detailsModal<?=$value->id?>">
...
-->
<a onclick="printSanedQbd(<?= $value->id ?>)" title="طباعة سند القبض رقم <?php echo $value->rqm_sanad;  ?>"><i
                                            class="fa fa-print"></i></a>



   <a href="<?=base_url()."finance_accounting/box/vouch_qbd/Vouch_qbd/updateView/".$value->id?>" title="تعديل سند القبض رقم <?php echo $value->rqm_sanad;  ?>"><i class="fa fa-pencil"></i></a>

    <a onclick="$('#adele').attr('href', '<?=base_url()."finance_accounting/box/vouch_qbd/Vouch_qbd/deleteVouchQbd/".$value->id.'/'.$value->rqm_sanad?>');" data-toggle="modal" data-target="#modal-delete" title="حذف سند القبض رقم <?php echo $value->rqm_sanad;  ?>"><i class="fa fa-trash"></i></a>
    </td>
                            </tr>
                            <?php
                        }
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body" id="div_search" >
                                    ...
                                    <div class="col_md_30 col-sm-6 padding-4 input_search_id2" style="display:none; margin-left: 0;">
                                        ...
                                        <div class="col-md-8 col-sm-6  no-padding">
                                            <?php            $pay_method_arr =array(1=>'نقدي',2=>'شيك'); ?>
                                          ...
                                          <button type="button"  onclick="searchResults()" class="btn btn-labeled btn-success " id="" style="margin-top: 27px;">
                                                <span class="btn-label"><i class="fa fa-search-plus"></i></span>بحث
                                            </button>
                                   <br><br>
                                   <div style="height: 500px;overflow-y:scroll ;">
                                        <table  id="table"  class="table example  table-striped table-bordered " style="display: none;">
                                            ...
                                            <tr class="info myTable">
                                                ...
                                                <th class="text-center myclass" > إستلمنا منه </th>
                        ...
                        <?php if(!empty($result->attaches)){ ?>
                            <?php $x=1;foreach ($result->attaches as $row_img){ ?>
                                <tr class="<?=$x?>">
                                    ...
                                    <td><img id="img_view<?=$x?>" src="<?php  echo base_url().'uploads/images/finance_accounting/box/vouch_qbd/'.$row_img->file_attached?>"  width="150px" height="150px" /></td>
                                    <td>

                                        <!--   <a  onclick="$('#adele').attr('href', '<?php echo  base_url().'all_Finance_resource/all_pills/AllPills/deletePillImg/'.$row_img->id.'/'.$row_img->rqm_sanad_id_fk?>');" data-toggle="modal" data-target="#modal-delete" title="حذف"><i class="fa fa-trash"></i></a>-->


                                        <a href="<?php echo  base_url().'finance_accounting/box/vouch_qbd/Vouch_qbd/delete_vouch_qbd_Img/'.$row_img->id.'/'.$row_img->rqm_sanad_id_fk?>"  onclick="DeleteRowImg('<?/*=$x*/?>')"> <i class="fa fa-trash" ></i> </a></td>
                                </tr>
                                <?php  $x++; } }  ?>
                        </tbody>
                    </table>
    ...
    <div class="modal-dialog" role="document" style="width: 70%">
        <div class="modal-content">
            ...
            <div class="modal-body ">
                ...
                <?php
    if( isset($value->delails_cheque)&&!empty($value->delails_cheque)){?>
                <table class="table table-striped table-bordered" style="table-layout: fixed; ">

                    <thead>
                    <tr class="info">
                        <th style="width: 70px;">رقم الشيك</th>
                        <th style="width: 95px;">تاريخ الشيك</th>
                        <th style="width: 21%;">البنك </th>

                    </tr>
                    </thead>
                    <tbody>
                    <?php
                    if(!empty($value->delails_cheque)){
                        foreach ($value->delails_cheque as $row){
                            ?>
                            <tr>
                                <td><input type="text" disabled name="sheek_num[]" value="<?php echo $row->sheek_num ;?>" class="form-control input_style_2 bank" data-validation="" data-validation-has-keyup-event="true">
                                </td>
                                <td><input type="date" disabled  name="sheek_date[]" data-validation="" id="day_date" value="<?php echo $row->sheek_date_ar ;?>"   class="form-control input_style_2 bank" data-validation-has-keyup-event="true">
                                </td>
                                <td><select id="pill_type" disabled  name="bank_id_fk[]" class="form-control input_style_2 bank"
                                            onchange="$('#bank_name_hidden').val($('option:selected',this).text());" data-validation="" aria-required="true">
                                        <option value="">إختر</option>
                                        <?php if(isset($banks) && !empty($banks)){
                                            foreach ($banks as $bank){?>
...
function addVouchQbdRow(){
    ...
    var html = `<tr id="`+id+`">\
                        ...
                        <td id="TD`+id+`">\
                            <a href="#" onclick="addVouchQbdRow(); $(this).remove(); $('#deleteRow`+id+`').show(); "><i class="fa fa-plus sspan"></i></a>\
                            <a  id="deleteRow`+id+`" href="#" onclick="addVouchQbdPlusButton(`+id+`); getVouchQbdSum();"> <i class="fa fa-trash" aria-hidden="true"></i>
                            </a>\
                        </td>\
                    </tr>`;
...
<script>
    function deleteRow(row) {
        ...
        document.getElementById('chequeTable').deleteRow(i);
        ...
        $("#myModal_attach .close").click();
                    ...
                    <script>
                        ...
                        function searchResults()
                        {
                            ...
                            $.ajax({
                                type: 'post',
                                url: "<?php echo base_url();?>finance_accounting/box/vouch_qbd/Vouch_qbd/get_search_pills",
...
<script>
   ...
   var geha_title=$('#geha_title').val();
        ...
        if (value != 0 && value != '' ) {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo base_url() ?>finance_accounting/box/vouch_qbd/Vouch_qbd/insert_geha_ajax',
                data: dataString,
                dataType: 'html',
                cache: false,
...
<script>
    ...
    function update_geha(id) {
        ...
        $.ajax({
            url :"<?php echo base_url() ?>finance_accounting/box/vouch_qbd/Vouch_qbd/getById",
            type : "Post",
            dataType : "html",
            data: {id:id},
        ...
        $('#update').on('click',function() {
            ...
            $.ajax({
                url :"<?php echo base_url() ?>finance_accounting/box/vouch_qbd/Vouch_qbd/update_geha",
                type : "Post",
                dataType : "html",
...
<script>
    function delte_geha(id) {
        ...
        if (r == true) {
            $.ajax({
                type:'post',
                url: '<?php echo base_url() ?>finance_accounting/box/vouch_qbd/Vouch_qbd/delete_geha',
                data:{ id:id},
                dataType: 'html',
                cache:false,
                success: function(html){
...
<script>
    function printSanedQbd(row_id) {
        var request = $.ajax({
            // print_resrv -- print_contract
            url: "<?=base_url() . 'finance_accounting/box/vouch_qbd/Vouch_qbd/printSanedQbd'?>",
            type: "POST",
            data: {row_id: row_id},
        });
