        ...
        <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
            ...
            <div class="panel-body">
                ...
                if(isset($result) && !empty($result)) {
                    ...
                    if(empty($result->box_rqm_hesab) && empty($result->box_name)) {
                        $box_rqm_hesab = $box_date['code'];
                        $box_name = $box_date['name'];
                    }
                    //osama
                ...
                <div class="col-md-12 no-padding">
                    ...
                    <div class="col_md_20 col-sm-6 padding-4 text-center">
                        <div class="col-md-6 col-sm-6 no-padding">
                            <input type="radio"  name="pay_method" style="width: 18px; height: 18px;"  <?php if(!empty($pay_method) && $pay_method == 1){echo 'checked';} ?> data-validation="required" value="1" checked=""> <label class="no-margin no-padding"> نقدي</label>
                        </div>
                        <div class="col-md-6 col-sm-6 no-padding">
                            <input type="radio"  name="pay_method" style="width: 18px; height: 18px;" <?php if(!empty($pay_method) && $pay_method == 2){echo 'checked';} ?> data-validation="required" value="2"> <label class="no-margin no-padding">شيك</label>
                        </div>
                    </div>
           ...
           <div class="col-md-12 no-padding">
                ...
                <div class="col-md-12 no-padding">
                    <!--<div class="col_md_50 col-sm-6 padding-4">
                        ...
                        <div class="col-md-10 col-sm-6 no-padding">
                            <input type="text" name="recived_from" class="form-control input_style_2 arabic_number" data-validation="required" data-validation-has-keyup-event="true" value="<?=$recived_from?>">
                            ...
                            foreach ($details as $row_detail){
                                ...
                                <tr id="<?=$row_detail->id?>">
                                    ...
                                    <td id="TD<?=$row_detail->id?>">
                                        <a href="#" <?php if($counter < sizeof($details)){?> style="display: none;" <?}?> onclick="addVouchQbdRow(); $(this).remove(); $('#deleteRow<?=$row_detail->id?>').show();"><i class="fa fa-plus sspan"></i></a>
            ...
            <div class="modal-body ">
               <!-- <div class="col-md-12 no-padding">
                    <div class="col_md_25 col-sm-6 padding-4">
                        ...
                        <div class="col-md-7 col-sm-6 no-padding">
                            <span class="form-control input_style_2"  ><?=$value->rqm_sanad?></span>
                        </div>
                    </div>
                    ...
                    <div class="col_md_25 col-sm-6 padding-4">
                        ...
                        <div class="col-md-7 col-sm-6 no-padding">
                            <span class="form-control input_style_2" ><?=$value->date_sanad?></span>
                        </div>
                    </div>

                    <div class="col_md_20 col-sm-6 padding-4 text-center">
                        <div class="col-md-6 col-sm-6 no-padding">
                            <span class="form-control input_style_2" ><?=$value->about?></span>
                ...
                <div class="col-md-12 no-padding">
                    <div class="col_md_70 col-sm-6 padding-4">
                        ...
                        <div class="col-md-10 col-sm-6 no-padding">
                            <span class="form-control input_style_2" ><?=$value->recived_from?></span>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function getVouchQbdAccountName(code,id) {
        ...
        $.ajax({
            type:'post',
            url: '<?=base_url()?>finance_accounting/box/vouch_qbd/Vouch_qbd/getVouchQbdAccountName',
            data:dataString,
            cache:false,
            success: function(result){
