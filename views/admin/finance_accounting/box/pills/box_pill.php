   ...
   $pay_method_arr = array('إختر', 1 => 'نقدي', 2 => 'شيك', 3 => 'شبكة', 4 => 'إيداع نقدي', 5 => 'إيداع شيك', 6 => 'تحويل', 7 => 'أمر مستديم',8=>'متجر الكتروني');
                ...
                if (isset($all_pills_inbox) && !empty($all_pills_inbox)) {
                    ...
                    foreach ($all_pills_inbox as $row) {
                        ...
                        <tr>
                            ...
                            <td><?= $row->band_title ?><?php if (!empty($row->band_title2)) {
        ...
        <div class="col-md-12" style="margin-top: 10px;">
            <div class="form-group col-sm-3 col-xs-12 padding-4">
                ...
                <select id="publisher" name="publisher" class="form-control  input-style" onchange="filter_table()">
                ...
                if (isset($method_arr) && !empty($method_arr)) {
                    foreach ($method_arr as $key => $value) {
                        ...
                        <div class="radio-content">
                            <input type="radio" class="pay_method" name="pay_method"
                                   onchange="get_more($(this).val());filter_table();"
                                   id="inlineRadio<?php echo $key ?>" value="<?php echo $key; ?>">
           ...
           // $multi_pays = array(3 => 'شبكه', 4 => 'إيداع نقدي', 5 => 'إيداع شيك', 6 => 'تحويل', 7 => 'أمر مستديم');
            $multi_pays = array(3 => 'شبكه', 4 => 'إيداع نقدي', 5 => 'إيداع شيك', 6 => 'تحويل', 7 => 'أمر مستديم',8=>'متجر الكتروني'); 
            ?>
            ...
            <div class="form-group col-sm-4 col-xs-12 padding-4 multi_sel" style="display: none;">
                ...
                <?php if (isset($arra) && !empty($arra) && $arra != null) {
                    for ($a = 1; $a < sizeof($arra); $a++) { ?>
                        ...
                        <div class="radio-content">
                            <input type="radio" onchange="get_val($(this).val());filter_table()" class="pay_method dep"
                                   name="qued"
            ...
            <div class="form-group  col-sm-2 col-xs-12 padding-4 qued_num" style="display: none;">
                ...
                <input type="text" readonly ondblclick="get_qued();filter_table()" style="" id="qued_num"
                       class="form-control">
            ...
            <div class="col-md-1">
                <button type="button" onclick="estlam();" data-toggle="modal" data-target="#myModalInfo2"
                        class="btn btn-success btn-labeled btn-next" style="margin-top: 32px;">
...
<script>
   function t3amel() {
        ...
        var rkm_quod=$("input[name=rkm_quod]").val();
        if (rkm_quod != 0) {
          last_quod=rkm_quod;
        }
...
<script>
    ...
    function filter_table() {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>finance_accounting/box/pills/Pill/filter_table",
            data: {
                publisher: publisher,
                pay_method: pay_method,
                date_to: date_to,
