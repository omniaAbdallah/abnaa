...
$_POST['array_search_id'] === 'qued_date'
  ...
  $search_title =$_POST['array_search_id'];
...
<table   class="table search_table  table-striped table-bordered" style="table-layout: fixed">
 ...
 ?> <tr>
    ...
    <td><a type="button" onclick="getDetails(<?= $row->id ?>)"
       class="btn btn-sm btn-info" data-toggle="modal" data-target="#detailsModal2" style="padding: 3px 5px;line-height: 1;">
          <i class="glyphicon glyphicon-list"></i> التفاصيل
        </a>

      <!--  <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#detailsModalz">
          Launch demo modal
        </button>-->
      </td>
    </tr>
