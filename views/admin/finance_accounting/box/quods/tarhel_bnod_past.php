     ...
     $total_count =0;
               ...
               $tddd = '<a class="pull-right" style="" id="deleteRow`' . $counter . '`"  onclick="$(`#' . $counter . '`).remove(); getTableSum();"><i class="fa fa-trash" aria-hidden="true"></i>';
                            ...
                            ?>
                             ...
                             <!------------------------------------------------------------->
                             <?php  if($value->bnod_help_fk ==1){

                                 $total_band1 =0;
                                 for ($z=0;$z<=2;$z++){
									   $byan_title = 'تحويل صرف مساعدة'.$value->band_name.'' .$arr_num[$z] . ' لشهر ' . $month[$value->mon_melady] . ' سنة ' . date("Y", $value->sarf_date);
                          ...
                          /*           echo'<pre>';
                                     ...
                                     <tr id="_band<?= $z ?>">
                                         <td>
                                             <input type="text" onkeypress="return validate_number(event);"
                                                    ...
                                                    name="maden_value[]" value="<?= ($arr_value[$z]) ?>" data-validation="required"
                                                    aria-required="true"
                                                    onkeyup="getTableSum();GetZeroFunction('accountdayen_band<?= $z ?>');">
                                         </td>
                                         <td>
                                             <input value="<?= $valueDayen ?>" type="text"
                                                    onkeypress="return validate_number(event);" id="accountdayen_band<?= $z ?>"
                                         ...
                                         <td>
                                             <input value="<?= $arr_rkm[$z] ?>" type="text" class="form-control testButton inputclass"
                                                    name="rkm_hesab[]" id="account_num<?= $z ?>" data-validation="required"
                                         ...
                                         <td>
                                             <input value="<?= $arr_name[$z] ?>" type="text" class="form-control inputclass"
                             ...
                             <?php }  $total_value = $total_band1; }else{ ?>
