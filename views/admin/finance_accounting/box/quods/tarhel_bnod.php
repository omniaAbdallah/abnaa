...
<div class="col-sm-12 no-padding">
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
        ...
        <div class="panel-body">
                ...
                <div class="col_md_25 col-sm-6 padding-4">
                    ...
                    <div class="col-md-7 col-sm-6 no-padding">
                        ...
                        <select name="no3_qued" class="form-control inputclass" data-validation="required"
                                aria-required="true">
                            <option value="قيد يومية-2">قيد يومية</option>
            ...
            <div class="col-md-12 no-padding">
                <table class="table tablegray table-bordered tb-table" style="table-layout: fixed;
                        " id="mytable">
                    <thead>
                    <tr class="info">
                        ...
                        <th style="width: 55px;text-align: center;"> المرجع</th>
...
echo "<pre>";
                    ...
                    if (!empty($all_data)) {
                       ...
                       $Total_num_family = $value->num_family;
                            ...
                            } /*elseif ($value->bnod_help_fk == 4) {
                                $total_value = $value->total_value;
                                $valueMadeen = $total_value;
                                $valueDayen = 0;
                                $hesab = $value->rkm_hesab;
                                $name = $value->rkm_hesab_name;
                            } elseif ($value->bnod_help_fk == 5) {
                            ...
                            if ($value->bnod_help_fk == 1) {
                                    ...
                                    <tr id="_band<?= $z ?>">
                                        ...
                                        <td>
                                            <input value="<?= $valueDayen ?>" type="text"
                                                   ...
                                                   onkeyup="getTableSum();GetZeroFunction('accountmaden_band<?= $z ?>');">
                                        </td>

                                        <td>
                                            <input value="<?= $arr_rkm[$z] ?>" type="text"
                                                   class="form-control testButton inputclass"
                                                   name="rkm_hesab[]" id="account_num<?= $z ?>"
                                                   data-validation="required"
                                        ...
                                        <td>
                                            <input value="<?= $arr_name[$z] ?>" type="text"
                                                   class="form-control inputclass"
                                                   name="hesab_name[]" id="account<?= $z ?>" data-validation="required"
                                                   aria-required="true" readonly=""
                               ...
                               // $byan_title = 'تغذية بطاقات الأسر لعدد'.$count_value.'-'.$month_title;
                            $byan_title = 'تغذية بطاقات الأسر لعدد'.$Total_num_family.'-'.$month_title;
                                ...
                                <tr id="<?= $counter ?>">
                                    <td>
                                        <input type="text" onkeypress="return validate_number(event);"
                                               ...
                                               class="form-control accountmaden all_total inputclass" step="any"
                                               name="maden_value[]" value="<?= ($valueMadeen) ?>"
                                               data-validation="required"
                                               aria-required="true"
                                    ...
                                    <td>
                                        <input value="<?= $hesab ?>" type="text"
                                               class="form-control testButton inputclass"
                                               name="rkm_hesab[]" id="account_num<?= $counter ?>"
                                               data-validation="required"
                                               aria-required="true" readonly=""
                                    ...
                                    <td>
                                        <input value="<?= $name ?>" type="text" class="form-control inputclass"
                                               name="hesab_name[]" id="account<?= $counter ?>"
                                               data-validation="required"
                                               aria-required="true" readonly=""
                        ...
                        <tr id="<?= $counter ?>">
                            <td>
                                <input type="text" onkeypress="return validate_number(event);"
                                       id="accountmaden<?= $counter ?>"
                                       class="form-control accountmaden all_total inputclass" step="any"
                                       name="maden_value[]" value="0" data-validation="required"
                                       aria-required="true"
                                       onkeyup="getTableSum();GetZeroFunction('accountdayen<?= $counter ?>');">
                            </td>
                            <td>
                                <input value="<?= $total_count ?>" type="text"
                    ...
                    <tr>
                        ...
                        <td colspan="5" style=" text-align:center;font-size:16px;font-weight:bold;color: #002542">
                            الإجمـــــالي
                        </td>
                    ...
                    <tr>
                        <td colspan="2" id="qued_percent"
                            style=" text-align:center;font-size:16px;font-weight:bold;color: #002542"><?= $total_value ?> </td>
                        <input type="hidden" class="total" name="total_value" value="<?= $total_value ?>">
                        <td colspan="6" style=" text-align:right;font-size:16px;font-weight:bold;color: #002542">الفرق
                            بين الجانبين
                        </td>
