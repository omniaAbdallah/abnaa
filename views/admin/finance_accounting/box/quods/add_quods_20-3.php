                ...
                <table class="table table-striped table-bordered tb-table" style="table-layout: fixed;
                        ...
                        foreach ($result->details as $row_detail) {
                            ...
                            <tr id="<?= $row_detail->id ?>">
                                ...
                                <td id="TD<?= $row_detail->id ?>">
                                    <?php  /*if ($counter == sizeof($result->details)) { ?>
                                    <a   id="PlusButton<?= $counter ?>"
                  ...
                  */
                    ...
                    <tr>
                        ...
                        <td style=" text-align:center;font-size:16px;font-weight:bold;color: #002542">الإجمـــــالي</td>
                        <td colspan="4" style="text-align:right;font-size:16px;font-weight:bold;color: #002542"
                            id="total_value_arabic">
