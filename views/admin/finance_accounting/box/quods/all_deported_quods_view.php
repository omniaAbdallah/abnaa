            ...
            <div class="form-group col-sm-12 col-xs-12 no-padding">
                <div class="tab-content">
                    <div class="tab-pane fade in active" id="tab1">
                        <div class="panel-body">
                            <table id="all_deported_quods_json" class="table tablegray table-bordered table-striped"
                                   role="table">
                                <thead>
                                <tr class="info">
                                    <th width="2%">م</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        var oTable_usergroup = $('#all_deported_quods_json').DataTable({
            dom: 'Bfrtip',
            "ajax":"<?php echo base_url(); ?>finance_accounting/box/quods/Quods/all_deported_quodss",
            "initComplete":function( settings, json){
           
                /*  $('#all_deported_quods_json').find('.checkbox_toggle').bootstrapToggle({
                    on: 'نشط',
                    off: 'غير نشط'
                });*/
