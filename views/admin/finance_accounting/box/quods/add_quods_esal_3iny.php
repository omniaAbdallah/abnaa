<style type="text/css">
    ...
    /*********************************************/
    .classtd {
        background-color: #4eb9e6 !important;
    }
    ...
    #mytable tr.classtd td .form-control {
        background-color: #4eb9e6 !important;
    }
</style>
<div class="col-sm-12 no-padding">
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
        ...
        <div class="panel-body">
            ...
            $button1 = '';
            $print_action = '';
            $halet_qued_arr = array(2 => 'قيد المراجعة');
            $form_action = 'finance_accounting/box/quods/Quods/add_quods_esal';
                ...
                <div class="col_md_25 col-sm-6 padding-4">
                    ...
                    <div class="col-md-7 col-sm-6 no-padding">
                        <input type="text" name="rkm" id="rkm"
                               ...
                               class="form-control input_style_2 text-center"
                            <?php echo $style; ?> data-validation-has-keyup-event="true">
                        <?php if (!empty($id_esalat)) {
                            if (is_array($id_esalat)) {
                                foreach ($id_esalat as $item) {
                                    ?>
                                    <input type="hidden" name="id_esalat[]" value="<?= $item ?>">

                                <?php }
                            } else { ?>
                                <input type="hidden" name="id_esalat[]" value="<?= $id_esalat ?>">
                ...
                <div class="col_md_25 col-sm-6 padding-4">
                    ...
                    <div class="col-md-7 col-sm-6 no-padding">
                        <input type="date" name="qued_date" data-validation="required"
                               ...
                               class="form-control input_style_2 text-center" data-validation-has-keyup-event="true">
                    </div>
                </div>
            </div>
            <div class="col-md-12 no-padding">
                <div id="table-scroll" class="table-scroll">
                    ...
                    <div class="table-wrap">
                        <div class="tbl-header">
                            <table class="table tablegray table-bordered tb-table main-table " style="  width:100%;table-layout: fixed; margin-bottom:0
                        " id="mytable" cellpadding="0" cellspacing="0">
                                <thead>
                                <tr class="info">
                                    <th style="width: 105px;text-align: center;">مدين</th>
                                    <th style="width: 105px;text-align: center;">دائن</th>
                                    <th style="width: 100px;text-align: center;">رقم الحساب</th>
                                    <th style="width: 300px;text-align: center;">إسم الحساب</th>
                                    <th style="width: 100px;text-align: center;"> مركز التكلفة</th>
                                    <th style="width: 100px;text-align: center;"> المرجع</th>
                                    <!--<th style="width: 100px;text-align: center;"> العملية</th>-->
                                    <th style="text-align: center;">البيــــــــــان</th>
                                    <th style="width: 58px;text-align: center;">الإجراء</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
                        <div class="tbl-content">
                            <table class="table tablegray table-bordered tb-table main-table " style="table-layout: fixed;  width:100%;
                        " id="mytable" cellpadding="0" cellspacing="0">
                                <tbody id="QuodresultTable">
                                <?php
                                $counter = 1;
                                /* if ($counter <= 1 && $bond == '') {*/
                                if (isset($da2n) && (!empty($da2n))) {
                                    foreach ($da2n as $item) {
                                        ?>
                                        <tr id="<?= $counter++ ?>">
                                            <td style="width: 105px;">
                                                <input type="text" onkeypress="return validate_number(event);"
                                                       id="accountmaden<?= $counter ?>" value="0"
                                                       class="form-control accountmaden all_total inputclass"
                                                       step="any"
                                                       name="maden_value[]" data-validation="required"
                                                       aria-required="true"
                                            ...
                                            <td style="width: 100px;" id="markz_id<?= $counter ?>">
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="byan[]"
                                                       aria-required="true">
                                            </td>
                                            <td id="TD<?= $counter ?>" style="width: 58px;">
                                                <a class="pull-right" style="display: none;"
                                                   id="deleteRow<?= $counter ?>"
                                                   onclick="$('#<?= $counter ?>').remove(); getTableSum();"><i
                                                            class="fa fa-trash"
                                                            aria-hidden="true"></i>
                                                </a>
                                            </td>
                                ...
                                /* if (isset($da2n) && (!empty($da2n))) {
                                     if (!empty($da2n['bnd_type1'])) {
                                         ...
                                         <tr id="<?= $counter++ ?>">
                                             ...
                                             <td style="width: 100px;">
                                                 <input type="text" class="form-control testButton inputclass"
                                                        name="rkm_hesab[]" value="<?= $da2n['bnd_type1'] ?>"
                                                        id="account_num<?= $counter ?>" data-validation="required"
                                                        aria-required="true"
                                                        readonly=""
                                                        onclick="$('#modalID').val(<?= $counter ?>); $(this).removeAttr('readonly');"
                                     ...
                                     if (!empty($da2n['bnd_type2'])) {
                                         ...
                                         <tr id="<?= $counter++ ?>">
                                             ...
                                             <td style="width: 100px;">
                                                 <input type="text" class="form-control testButton inputclass"
                                                        name="rkm_hesab[]" value="<?= $da2n['bnd_type2'] ?>"
                                                        id="account_num<?= $counter ?>" data-validation="required"
                                                        aria-required="true"
                                                        readonly=""
                                                        onclick="$('#modalID').val(<?= $counter ?>); $(this).removeAttr('readonly');"
                                     ...
                                     if (!empty($da2n['bnd_type3'])) {
                                         ...
                                         <tr id="<?= $counter++ ?>">
                                             ...
                                             <td style="width: 100px;">
                                                 <input type="text" class="form-control testButton inputclass"
                                                        name="rkm_hesab[]" value="<?= $da2n['bnd_type3'] ?>"
                                                        id="account_num<?= $counter ?>" data-validation="required"
                                                        aria-required="true"
                                                        readonly=""
                                                        onclick="$('#modalID').val(<?= $counter ?>); $(this).removeAttr('readonly');"
                                     ...
                                     if (!empty($da2n['bnd_type4'])) {
                                         ...
                                         <tr id="<?= $counter++ ?>">
                                             ...
                                             <td style="width: 100px;">
                                                 <input type="text" class="form-control testButton inputclass"
                                                        name="rkm_hesab[]" value="<?= $da2n['bnd_type4'] ?>"
                                                        id="account_num<?= $counter ?>" data-validation="required"
                                                        aria-required="true"
                                                        readonly=""
                                                        onclick="$('#modalID').val(<?= $counter ?>); $(this).removeAttr('readonly');"
                                ...
                                if (isset($maden) && (!empty($maden))) {
                                    foreach ($maden as $item) {
                                        ?>
                                        <tr id="<?= $counter++ ?>">
                                            <td style="width: 105px;">
                                                <input type="text" onkeypress="return validate_number(event);"
                                         ...
                                         <tr id="<?= $counter++ ?>">
                                             ...
                                             <td style="width: 105px;">
                                                 <input type="text" onkeypress="return validate_number(event);"
                                                        ...
                                                        value="0"
                                                        class="form-control accountdayen all_total inputclass"
                                                        step="any"  value="<?= $maden['maden4']['rkm_hesab'] ?>"
                                                        name="dayen_value[]" data-validation="required"
                                                        aria-required="true"
                                                        onkeyup="getTableSum();GetZeroFunction('accountmaden<?= $counter ?>');">
                                             </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5"
                                        style=" text-align:center;font-size:16px;font-weight:bold;color: #002542">
                                        الإجمـــــالي
                                    </td>
                                    <td><a onclick="addNewRow(); "><i class="fa fa-plus sspan"></i></a></td>
                                </tr>
                                <tr>
                                    <td colspan="2" id="qued_percent"
                                        style=" text-align:center;font-size:16px;font-weight:bold;color: #002542"><?= $total_value ?> </td>
                                    <input type="hidden" class="total" name="total_value" value="<?= $total_value ?>">
                                    <td colspan="5"
                                        style=" text-align:right;font-size:16px;font-weight:bold;color: #002542">الفرق
                                        بين الجانبين
                                    </td>
                                    </td>
                                </tr>
            ...
            <div class="col-xs-12 text-center">
                ...
                <button type="button" class="btn btn-labeled btn-purple" <?= $print_action ?>>
                ...
                <button type="button" class="btn btn-labeled btn-info" data-target="#myModal_search"
                        data-toggle="modal">
                    ...
                    function buildTreeTable($tree, $count = 1)
                    {
                        ...
                        foreach ($tree as $record) {
                            ...
                            if ($record->hesab_no3 == 2) {
                                ...
                                $onclick = "$('#account_num'+$('#modalID').val()).val(" . $record->code . "); $('#account'+$('#modalID').val()).val('" . $record->name . "'); get_marakz_taklefa(" . $record->code . "); $('#myModal').modal('hide');";
                                ?>
            ...
            <div class="modal-body" id="div_search">
                <div class="col_md_3">
                    <div class="col-md-2 col-sm-6  no-padding">
                        ...
                        ?>
                        <select id="array_search_id" class="form-control  input_style_2 " aria-required="true"
                                onchange="check_val($(this).val())">
                            <option value="">إختر</option>
    ...
    function addEditRow(div) {
        ...
        var html = `<tr id="` + id + `">\
                        ...
                        <input type="text" class="form-control" name="hesab_name[]" id="account` + id + `" data-validation="required" aria-required="true" readonly="" >\
                         ...
                         <td style="width: 100px;" id="markz_id` + id + `">\
                            <input type="text" class="form-control" step="any" name="markz_name[]" value="" readonly="">\
                            <input type="hidden" name="markz_id[]" value="">\
                        </td>\
                        <td>\
...
//parseInt(qued_percent) == 0  &&
        if (parseFloat((total).toFixed(2)) == parseFloat((total2).toFixed(2))) {
            ...
            $('#qued_percent').attr('style', 'background-color:#c0ff9f;font-size:16px;font-weight:bold;text-align:center');
            $('#total').attr('style', 'background-color:#c0ff9f;font-size:16px;font-weight:bold;text-align:center');
            $('#total2').attr('style', 'background-color:#c0ff9f;font-size:16px;font-weight:bold;text-align:center');
            $(".myBtnInsert").attr('onclick', "save_me()");
            $('.myBtn').prop('type', 'submit');
        } else {
            $('#qued_percent').attr('style', 'background-color:#ffaeae;font-size:16px;font-weight:bold;text-align:center');
            $('#total').attr('style', 'background-color:#ffaeae;font-size:16px;font-weight:bold;text-align:center');
            $('#total2').attr('style', 'background-color:#ffaeae;font-size:16px;font-weight:bold;text-align:center');
...
<script>
    function get_marakz_taklefa(account_code) {
        console.warn("account_code ::" + account_code);
        var modalID = $('#modalID').val();
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>finance_accounting/box/quods/Quods/get_marakz_taklefa',
            data: {account_code: account_code, counter: modalID},
            cache: false,
            beforeSend: function () {
            },
            success: function (html) {
                $("#markz_id" + modalID).html(html);
            }
        });
    }
</script>
