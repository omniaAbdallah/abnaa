    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
        ...
        <div class="panel-body">
            ...
            <div class="col-md-12 no-padding">
                <table class="table table-striped table-bordered" style="table-layout: fixed;
                    ...
                    <tr class="info">
                        ...
                        <th style="width: 5%;" >رقم المرجع</th>
                    ...
                    $counter =1; if(!empty($result->details)){
                        foreach ($result->details as $row_detail){
                            ...
                            <tr id="<?=$row_detail->id?>">
                                ...
                                <td>
                                    <input type="text" value="<?=$row_detail->hesab_name?>" class="form-control" name="hesab_name[]" id="account<?=$row_detail->id?>" data-validation="required" aria-required="true" readonly="" >
                                </td>
                                <td>
                        ...
                        <tr id="<?=$counter?>">
                            <td>
                                <input type="text" onkeypress="return validate_number(event);" class="form-control accountmaden all_total inputclass"   step="any" name="maden_value[]" data-validation="required" aria-required="true" onkeyup="getTableSum();">
                            </td>
                            <td>
                                <input type="text" onkeypress="return validate_number(event);" class="form-control accountdayen all_total inputclass"   step="any" name="dayen_value[]" data-validation="required" aria-required="true" onkeyup="getTableSum();">
                            </td>
                            ...
                            <td>
                                <input type="text" class="form-control inputclass" name="hesab_name[]" id="account<?=$counter?>" data-validation="required" aria-required="true" readonly="" >
                            </td>
                            <td>
                        ...
                        <tr id="<?=$counter+1?>">
                            ...
                            <td>
                                <input type="text" class="form-control inputclass" name="hesab_name[]" id="account<?=$counter+1?>" data-validation="required" aria-required="true" readonly="" >
                            </td>
                            <td>
                                <input type="text"  class="form-control " step="any"  onkeypress="return validate_number(event);" name="marg3[]">
                            </td>
                    ...
                    <tfoot>
                    <tr>
                        <td id="total" style="background-color:red;"><?=$total_value?>
                        </td>
                        <td id="total2" style="background-color:red;"><?=$total_value?>
                        </td>
            ...
            <div class="col-xs-12 text-center">
                ...
                <button type="submit" class="btn btn-labeled btn-success" name="action" value="action" id="myBtn">
        ...
        <div class="panel-body">
            <div class="form-group col-sm-12 col-xs-12">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#tab1" data-toggle="tab"> القيود المرحلة</a></li>
                    <li><a href="#tab2" data-toggle="tab"> القيود الغير مرحلة</a></li>
                </ul>
                <!-- Tab panels -->
...
<script>
    ...
    function addNewRow(){
        ...
        var html = `<tr id="`+id+`">\
                        <td>\
                            <input type="text"   onkeypress="return validate_number(event);" class="form-control accountmaden all_total" step="any" name="maden_value[]" data-validation="required" aria-required="true"  onkeyup="getTableSum();">\
                        </td>\
                        <td>\
                            <input type="text"  onkeypress="return validate_number(event);" class="form-control accountdayen all_total" step="any" name="dayen_value[]" data-validation="required" aria-required="true"   onkeyup="getTableSum();">\
                        </td>\
