							...
							<div class="col-md-6 no-padding">
								...
								<div class="form-group">
									...
									<div class="col-xs-8 pad-2">
										<input type="file" name="fileupload" value="fileupload" id="fileupload" style="height: 34px;">
									</div>
								</div>
								<div class="form-group">
									<div class="col-xs-4 no-padding">
									...
									<div class="col-xs-8 pad-2 text-center">
										<input class="jscolor" value="a96a61" style="height: 34px; width: 100%">
									</div>
								</div>
								<div class="form-group">
									<div class="col-xs-4 no-padding">
									...
									<div class="col-xs-8 pad-2 text-center">
                                        ...
                                        <button type="button" class="btn btn-default fzbold">Bold</button>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-md-4 col-xs-12 no-padding">
						...
						<div class="col-md-12 col-xs-12 no-padding">
							<div class="form-group ">
								...
								<div class="col-xs-8">
									<input type="date" name="sheek_date" value="<?=$sheek_date?>" class="form-control" data-validation="required" onchange="$('#data-block1').html($(this).val()); $('#data-block9').html($(this).val())">
								</div>
							</div>
						</div>
						<div class="col-md-12 col-xs-12 no-padding">
						...
						<div class="" id="cheque" data-src="path/to/image" data-caching-key="userImage">
									...
									<div class="top-backs">
										<div class="bond-header">
											<div class="col-xs-6 pad-2">
												<div  class="rightbond-header">	
													<p style="margin-right: <?=$sheek_date_right?>px; margin-top: <?=$sheek_date_top?>px;" class="line" id="data-block1"><?=$sheek_date?></p>
													<p style="margin-right: <?=$sheek_horer_right?>px; margin-top: <?=$sheek_horer_top?>px;" class="line" id="data-block2"><?=$horer_in?></p>
												</div>
											</div>
											<div class="col-xs-6 pad-2">
										...
										<div class="bond-body"  id="updateDiv">
											<div class="col-xs-12 pad-2">
												<p style="margin-right: <?=$sheek_benifit_right?>px; margin-top: <?=$sheek_benifit_top?>px;" class="line line-pay" id="data-block3"><?=$benefit_name?></p>
											</div>
											<div class="col-xs-12 pad-2">
												<div class="col-xs-3 pad-2">
												...
												<div class="col-xs-9 no-padding">
													<p style="margin-right: <?=$sheek_text_right?>px; margin-top: <?=$sheek_text_top?>px;" class="line" id="data-block5"><?=$value_text?></p>
													<p class="line" id="data-block6"><?=$byan?></p>

												</div>
											</div>
											<div class="col-xs-12 pad-2">
												<div class="col-xs-3 pad-2">
													<p style="margin-right: <?=$sheek_byan_right?>px; margin-top: <?=$sheek_byan_top?>px;" class="line" id="data-block7"> </p>
												</div>
												<div class="col-xs-9 no-padding">
							...
							<div class="kaab no-padding" id="secondDiv">
								<div class="bond-sidebar">
									...
									<p style="margin-right: <?=$ka3b_date_right?>px; margin-top: <?=$ka3b_date_top?>px;" class="line line-pay" id="data-block9"><?=$sheek_date?></p>
									<p style="margin-right: <?=$ka3b_to_right?>px; margin-top: <?=$ka3b_date_top?>px;" class="line line-pay" id="data-block10"><?=$benefit_name?></p>
									<p style="margin-right: <?=$ka3b_value_right?>px; margin-top: <?=$ka3b_value_top?>px;" class="line line-pay" id="data-block11"><?=$value_num?></p>
