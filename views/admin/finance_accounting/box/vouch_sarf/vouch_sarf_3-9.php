...
echo 'checked';
   ...
   <label class="radio-label pay_method_sarf" for="pay_method_sarf4">تحويل بنكي / سداد مدفوعات</label>
</div                           
                    ...
                    <div class="col_md_65 col-sm-6 padding-4">
                        ...
                        <div class="col_md_45 col-sm-6 padding-4">
                                <input type="text" placeholder="إسم الحساب" name="box_name" readonly="" id="name_hesab"
                                       ...
                                       data-validation="required" data-validation-has-keyup-event="true" value="">
                                        ...
                                        <select name="bank_account_num" id="bank_account_num_eda3" onchange="GetByArray(this.value,'GetAccountCode','eda3');"  class="form-control   accoun_num_id_fk empty "
                                            ...
                                            <?php if(!empty($hesab_data)){  foreach($hesab_data as $row){ ?>
                                                <option value="<?php echo$row->account_num; ?>"
                                                    <?php if(!empty($result->bank_account_num)){ if($result->bank_account_num ==$row->account_num){
                                                        echo'selected';
                    ...
                    " id="mytable">
                        ...
                        if (!empty($details)) {
                            foreach ($details as $row_detail) {
                                ...
                                <tr id="<?= $row_detail->id ?>">
                                    ...
                                    <td>
                                        <input type="text" value="<?= $row_detail->byan ?>" class="form-control byan_title"
                        ...
                        if ($counter <= 1) {
                            ...
                            <tr id="<?= $counter ?>">
                                ...
                                <td>
                                    <input type="text" class="form-control byan_title" name="byan[]" data-validation="required"
...
<!--
                                    <a title="طباعة السند" id="ptrintSanadButton<?= $value->id ?>"
                                       ...
                                       -->
   <a onclick="printSanedSarf(<?= $value->id ?>)" title="طباعة سند الصرف رقم <?php echo $value->rqm_sanad;  ?>"><i
               ...
               <span class="btn-label"> <i class="fa fa-search-plus"></i>  </span>بحث</button><br><br>
                ...
                <table id="table" class="table example table-striped table-bordered" style="display: none;">
                    ...
                    <tr class="info myTable">
                        ...
                        <th class="text-center myclass"> طريقة الدفع</th>
