...
<div class="col-sm-12 no-padding">
    ...
    <div class="col-md-5 col-sm-6  no-padding ">
        ...
        <div class="col-md-7 col-sm-6 no-padding">
            <input type="text" name="rased" id="rased"  data-validation="required" class="form-control input_style_2 error"
                  value="" data-validation-has-keyup-event="true" disabled="">
        </div>
