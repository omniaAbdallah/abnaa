            ...
            <div class="panel-body">
                        ...
                        <div class="col-md-9 col-sm-6 no-padding">
                            <div class="col-md-4 col-sm-6 no-padding">
                                <input type="radio" name="pay_method_sarf"
                                       ...
                                       data-name="نقددي"
                                       style="margin-right: 8px; width: 20px; height: 20px;" <?php if (!empty($pay_method) && $pay_method == 1) {
                                    echo 'checked';
                                } ?> data-rqamHesab="<?= ($box != null) ? $box['نقدي']->rqm_hesab : '' ?>"
                                       data-hesabName="<?= ($box != null) ? $box['نقدي']->name_hesab : '' ?>"
                                       data-validation="required" value="1" checked=""> <label
                                        class="no-margin no-padding pay_method_sarf"> نقدي</label>
                            </div>
                            <div class="col-md-4 col-sm-6 no-padding">
                                ...
                                $('.divBankInput').attr('data-validation','required');" data-name="شيك من الصندوق"
                                       style="width: 20px; height: 20px;" <?php if (!empty($pay_method) && $pay_method == 2) {
                                    echo 'checked';
                                } ?> data-rqamHesab="<?= ($box != null) ? $box['شيك']->rqm_hesab : '' ?>"
                                       data-hesabName="<?= ($box != null) ? $box['شيك']->name_hesab : '' ?>"
                                       data-validation="required" value="2"> <label
                                        class="no-margin no-padding pay_method_sarf">شيك من الصندوق</label>
                            </div>
                            <div class="col-md-4 col-sm-6 no-padding">
                                <input type="radio" name="pay_method_sarf"
                                       onclick="$('#pay_method_value').val($(this).val()); $('.divBankInput').removeAttr('data-validation');"
                                       data-name="شيك من البنك"
                                       style="width: 20px; height: 20px;" <?php if (!empty($pay_method) && $pay_method == 3) {
                                    echo 'checked';
                                } ?> data-rqamHesab="<?= ($box != null) ? $box['شيك']->rqm_hesab : '' ?>"
                                       data-hesabName="<?= ($box != null) ? $box['شيك']->name_hesab : '' ?>"
                                       data-validation="required" value="3"> <label
                                        class="no-margin no-padding pay_method_sarf">شيك من البنك</label>
                            </div>
                ...
                <div class="col-md-12 no-padding bank_dd" <?= ($pay_method == 3) ? 'style="display: block"' : 'style="display: none"'; ?>>
                    ...
                    <div class="col-md-12 no-padding">
                        ...
                        <div class="col_md_30 col-sm-6 padding-4">
                            <div class="col-md-5 col-sm-6 no-padding">
                                <h6 style="background-color: #003665 !important;     border: 2px solid #003665;"
                                    class="label_title_2">رصيد الحساب </h6>
                            </div>
                            <div class="col-md-7 col-sm-6 no-padding">
                        ...
                        <div class="col_md_35 col-sm-6 padding-4">
                            <div class="col-md-4 col-sm-6 no-padding">
                                <h6 style="background-color: #003665 !important;     border: 2px solid #003665;"
                                    class="label_title_2">رقم الشيك</h6>
                            </div>
                            <div class="col-md-8 col-sm-6 no-padding">
                ...
                <div class="col-md-12 no-padding">
                    <div class="col_md_70 col-sm-6 padding-4">
                        ...
                        <div class="col-md-10 col-sm-6 no-padding">
                            <input list="pepople_arr" autocomplete="off" style="width:91%; float: right;" type="text"
                                   ...
                                   onkeyup="$('#person_name_div').html($(this).val());" data-validation="required"/>
                    ...
                    " id="mytable">
                                ...
                                <tr id="<?= $row_detail->id ?>">
                                    <td>
                                        <input type="text" value="<?= $row_detail->value ?>"
                                               ...
                                               class="form-control accountValue" step="any" name="value[]"
                                    ...
                                    <td id="TD<?= $row_detail->id ?>">
                                        ...
                                        <a class="pull-right" id="deleteRow<?= $row_detail->id ?>" href="#"
                                           onclick="$('#<?= $row_detail->id ?>').remove(); $('#trcheque<?= $counter ?>').remove(); getSum();"><i
                        ...
                        if ($counter <= 1) {
                            ...
                            <tr id="<?= $counter ?>">
                                ...
                                <td>
                                    <input type="text" class="form-control" name="byan[]" data-validation="required"
                                           aria-required="true">
                                </td>
                                <td id="TD<?= $counter ?>">
                                    <a href="#"
                                       onclick="addRow(); $(this).remove(); $('#deleteRow<?= $counter ?>').show();"><i
                                                class="fa fa-plus sspan"></i></a>
                                    <a class="pull-right" style="display: none;" id="deleteRow<?= $counter ?>" href="#"
                                       onclick="$('#<?= $counter ?>').remove(); $('#trcheque<?= $counter ?>').remove(); getSum();"><i
                                                class="fa fa-trash" aria-hidden="true"></i>
                                    </a>
                                </td>
                            </tr>
                        ...
                        foreach ($result->sheek_data as $row) { ?>
                            <div id="trcheque<?= $x ?>">
                                <div class="col_md_30 col-sm-6 padding-4">
                                        ...
                                        <select id="sheek_num1" name="sheek_num[]"
                                                class="form-control input_style_2 bank selectpicker"
                                                onchange="GetSheekDetails(<?=$x?>)" aria-required="true"
                                                data-show-subtext="true" data-live-search="true">
                                            <option value="">إختر</option>
                                            <?php if (isset($sheeks) && !empty($sheeks)) {
                                                foreach ($sheeks as $sheek) { ?>
                                                    <option data-link="<?php echo $sheek->id . '/' . $sheek->sheek_date_ar . '/' . $sheek->bank_id_fk; ?>"
                                                            value="<?php echo $sheek->sheek_num; ?>"
                                                    <?php if(!empty($row->sheek_num)){  if($row->sheek_num ==$sheek->sheek_num ){  echo'selected'; }} ?>
                                                    ><?php echo $sheek->sheek_num; ?></option>
                                                <?php }
                                            } ?>
                                        </select>
                            ...
                            <div class="col_md_30 col-sm-6 padding-4">
                                    ...
                                    >
                                        ...
                                        <?php if (isset($sheeks) && !empty($sheeks)) {
                                            foreach ($sheeks as $sheek) { ?>
                                                <option data-link="<?php echo $sheek->id . '/' . $sheek->sheek_date_ar . '/' . $sheek->bank_id_fk; ?>"
                                                        value="<?php echo $sheek->sheek_num; ?>"><?php echo $sheek->sheek_num; ?></option>
                                            <?php }
                                        } ?>
                                    </select>
                    ...
                    if (isset($records) && $records != null) {
                        ...
                        foreach ($records as $value) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm btn-labeled btn-add" data-toggle="modal"
                                            data-target="#detailsModal<?= $value->id ?>">
                                        <span class="btn-label"><i class="glyphicon glyphicon-list"></i></span>تفاصيل
                                        السند
                                    </button>
                                </td>
                                ...
                                <td>
                                    ...
                                    <a title="عرض المرفق" id="" href="#" target="_blank"> <i class="fa fa-cloud-upload"
                                                                                             aria-hidden="true"></i>
                                    </a>
