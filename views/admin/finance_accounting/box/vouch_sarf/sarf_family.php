...
<?php function check_value($value)
{
        ...
        <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
            ...
            <div class="panel-body">
                ...
                if (isset($result) && !empty($result)) {
                    ...
                    $arabicValue = $arabicNum;
                    $sheek_bank_id = '';
                    $sheek_bank_name = '';
                    $sheek_rqm_hesab = '';
                    $sheek_num_bank = '';
                    echo form_open_multipart('finance_accounting/box/vouch_sarf/Vouch_sarf/add_sarf_family', array('id' => 'fromVouchSarf'));
                }
                ?>
                    <input type="hidden" name="mahder_id" value="<?php echo $alert['id'];?>">
                <div class="col-md-12 no-padding">
                    <div class="col_md_40 col-sm-6 padding-4">
                            ...
                            <div class="radio-content">
                                <!--<input type="radio" name="pay_method_sarf" disabled="disabled"
                            ...
                            <div class="radio-content">
                               <!-- <input type="radio" disabled="disabled" name="pay_method_sarf" onclick="$('#pay_method_value').val($(this).val());
                    ...
                    <div class="col-md-2 col-sm-6 padding-4" id="type_paid_div"
                        <?php  if($pay_method !=4){?>
                            style="display: none" <?php } ?>>


                        <h6 class=" label_title_2">طريقة الدفع</h6>
                    ...
                    " id="mytable">
                        ...
                        if (!empty($all_data)) {
                            ...
                            foreach ($all_data as $value) {
                                ...
                                $Total_num_family = $value->num_family;
                                $count_value = ($value->value_armal + $value->value_yatem + $value->value_mostafed);
                                $byan = 'تحويل صرف مساعدة' . $value->band_name . '' . $count_value . ' لشهر ' . $month[$value->mon_melady] . ' سنة ' . date("Y", $value->sarf_date);
                                ...
                                if ($value->bnod_help_fk == 1) {

                                    $valueDayen = 0;
                                    $arr_rkm = array($value->rkm_hesab_armal, $value->rkm_hesab_yatem, $value->rkm_hesab_mostafed);
                                    $arr_name = array($value->rkm_hesab_armal_name, $value->rkm_hesab_yatem_name,
                                        $value->rkm_hesab_mostafed_name);
                                    $arr_value = array($value->mother_num_value, $value->young_num_value,
                                        $value->adult_num_value);
                                    //$arr_num = array($value->value_armal, $value->value_yatem, $value->value_mostafed);
                                    $arr_num = array($value->armal_num, $value->yatem_num, $value->mostafed_num);

                                    $arr_title = array(' أرملة', ' يتيم', ' مستفيد');

                                } elseif ($value->bnod_help_fk ==2 || $value->bnod_help_fk == 3 ||
                                    $value->bnod_help_fk == 4 || $value->bnod_help_fk == 5 ||
                                    $value->bnod_help_fk >= 6 ) {
                                    $total_value =  check_value($value->total_value);
                                    $valueMadeen = check_value($total_value);
                                    $valueDayen = 0;
                                    $hesab = check_value($value->rkm_hesab);
                                    $name = check_value($value->rkm_hesab_name);
                                ...
                                $month_title = ' صرف ' . $value->band_name . ' لشهر ' . $month[$value->mon_melady] . ' سنة ' . date("Y", $value->sarf_date);
                                ...
                                if ($value->bnod_help_fk == 1) {
                                    ...
                                    for ($z = 0; $z <= 2; $z++) {
                                        ...
                                        $byan_title = 'تغذية بطاقات الأسر لعدد '.$arr_num[$z].$arr_title[$z].'-'.$month_title;


                                        $tddd = '<a class="pull-right" style="" id="deleteRow`' . $counter . '`"  onclick="$(`#_band' . $z . '`).remove(); getTableSum();"><i class="fa fa-trash" aria-hidden="true"></i>';

                                        $total_band1 += $arr_value[$z];
                                        /*           echo'<pre>';
                                                   print_r($arr_value[$z]);*/
                                        ?>
                                        ...
                                        <tr id="<?= $z ?>">
                                            <td>
                                                <input type="text" value="<?= ($arr_value[$z]) ?>"
                                                       onkeypress="return validate_number(event);"
                                                       class="form-control accountValue" step="any" id="value<?= $z ?>" name="value[]"
                                                       data-validation="required" aria-required="true" onkeyup="getSum();"
                                                       onfocusout="check_val_sheek(this,<?= $z ?>)">
                                            </td>



                                            <td>
                                                <input type="text" value="<?= $arr_rkm[$z] ?>"
                                                       class="form-control testButton" name="rqm_hesab[]"
                                                       id="account_num<?= $z ?>" data-validation="required"
                                                       aria-required="true" readonly=""
                                                       onclick="$('#modalID').val(<?= $z ?>); $(this).removeAttr('readonly');"
                                                       ...
                                                       onkeyup="getAccountName($(this).val(),<?= $z ?>);">
                                            </td>
                                            ...
                                            <td>
                                                <input type="text" value="<?= $arr_name[$z] ?>" class="form-control"
                                                       name="name_hesab[]" id="account<?= $z ?>"
                                            ...
                                            <td>
                                                <input type="text" value="<?= $byan_title ?>" id="byan1" class="form-control byan_title"
                                            ...
                                            <td id="TD<?= $z ?>">
                                                <a href="#" <?php //*if ($counter < sizeof($details)) { */?> style="display: none;" <?php //} ?>
                                                   onclick="addRow(); $(this).remove(); $('#deleteRow<?= $z ?>').show();"><i
                                                            class="fa fa-plus sspan"></i></a>
                                                <a  id="deleteRow<?= $z ?>" href="#"
                                                    onclick=" $('#trcheque<?= $z ?>').remove(); getSum();
                                                            addPlusButton(<?= $z ?>)"><i
                                    ...
                                    <?php }
                                    $total_value = $total_band1;
                                    }else{ ?>


                                    <tr id="1">
                                        <td>
                                            <input type="text" value="<?= ($total_value) ?>"
                                                   onkeypress="return validate_number(event);"
                                                   class="form-control accountValue" step="any" id="value1" name="value[]"
                                                   data-validation="required" aria-required="true" onkeyup="getSum();"
                                                   onfocusout="check_val_sheek(this,1)">
                                        </td>



                                        <td>
                                            <input type="text" value="<?= $hesab ?>"
                                                   class="form-control testButton" name="rqm_hesab[]"
                                                   id="account_num1" data-validation="required"
                                                   aria-required="true" readonly=""
                                        ...
                                        <td>
                                            <input type="text" value="<?= $about ?>" id="byan1" class="form-control byan_title"
                                                   name="byan[]" data-validation="required" aria-required="true">
                                        </td>
                                        ...
                                        <td id="TD1>">
                                            <a href="#" <?php //*if ($counter < sizeof($details)) { */?> style="display: none;" <?php //} ?>
                                               onclick="addRow(); $(this).remove(); $('#deleteRow1').show();"><i
                                                        class="fa fa-plus sspan"></i></a>
                                            <a  id="deleteRow1" href="#"
                                                onclick=" $('#trcheque1').remove(); getSum();
                                                        addPlusButton(1)"><i
                                                        class="fa fa-trash" aria-hidden="true"></i>
                                            </a>
                                        </td>
                        ...
                        <tr>
                            <td>
                                <input type="text" name="total_value" value="<?= $total_count ?>"
...
<script>
    ...
    $("input[name=pay_method_sarf]").click(function () {
        ...
        if ($(this).val() == 4) {
            ...
            $("#bank_id_fk1").removeAttr('data-validation');
