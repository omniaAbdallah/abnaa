    ...
    <div class="col-sm-8">
        <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
            ...
            if(isset($result) && !empty($result)) {
                ...
                $arabicValue         = $arabicNum.' ريال فقط لا غير.';
                echo form_open_multipart('finance_accounting/box/vouch_sarf/Vouch_sarf/update/'.$result->id,array('id'=>'fromVouchSarf'));
            }
            else {
                $submitSave          = '';
                $rqm_sanad           = $last_id;
                ...
                <div class="col-md-12 no-padding bank_dd" <?=($pay_method == 3)? 'style="display: block"' : 'style="display: none"';?>>
                    ...
                    <div class="col_md_30 col-sm-6 padding-4">
                        ...
                        <div class="col-md-8 col-sm-6 no-padding">
                            <input type="text" placeholder="اسم الحساب" readonly="" name="sheek_bank_name" id="sheek_bank_name" class="form-control input_style_2 " value="<?=$sheek_bank_name?>" data-validation="required" data-validation-has-keyup-event="true">
                        </div>
                    </div>
                    ...
                    <div class="col_md_20 col-sm-6 padding-4">
                        ...
                        <div class="col-md-6 col-sm-6 no-padding">
                            <input type="text" placeholder="رقم الشيك" readonly="readonly"  name="sheek_num_bank" id="sheek_num_bank" class="form-control input_style_2" value="<?=$sheek_num_bank?>" data-validation="required" data-validation-has-keyup-event="true">
                        </div>
                    </div>
            ...
            <div class="panel-body">
                <div class="bond-qabd">
                    ...
                    <div class="bond-body">
                        ...
                        <div class="col-xs-12 no-padding">
                            <h5 style="margin-right: 5px;"><span style="border-bottom: 1px solid #000">مبلغاّ وقدره :</span>  <span class="viewArabicValue"><?=$arabicValue?></span> </h5>
                        </div>
                        <div class="col-xs-12 no-padding">
                    ...
                    if (isset($records) && $records != null) {
                        ...
                        foreach ($records as $value) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-labeled btn-info" data-toggle="modal" data-target="#detailsModal<?=$value->id?>">
                                        <span class="btn-label"><i class="glyphicon glyphicon-list"></i></span>التفاصيل
                                    </button>
                                </td>
                                <td>
                                    <a href="<?=base_url()?>finance_accounting/box/vouch_sarf/Vouch_sarf/printSanedSarf/<?=$value->id?>" target="_blank"> <i class="fa fa-print" aria-hidden="true"></i> </a>
                                </td>
                                <td>
