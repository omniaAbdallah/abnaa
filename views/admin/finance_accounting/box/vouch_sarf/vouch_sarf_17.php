...
<div class="col-sm-12 no-padding">
    <div class="col-sm-8">
        <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
            ...
            ?>
                    ...
                    <div class="col_md_75 col-sm-6 padding-4">
                        ...
                        <div class="col-md-9 col-sm-6 no-padding">
                            <div class="col-md-4 col-sm-6 no-padding">
                                <input type="radio" name="pay_method_sarf"  onclick="$('#pay_method_value').val($(this).val()); $('.divBankInput').removeAttr('data-validation');"   data-name="نقددي" style="margin-right: 8px; width: 20px; height: 20px;" <?php if(!empty($pay_method) && $pay_method == 1){echo 'checked';} ?> data-rqamHesab="<?=($box != null)?$box['نقدي']->rqm_hesab:''?>" data-hesabName="<?=($box != null)?$box['نقدي']->name_hesab:''?>" data-validation="required" value="1" checked=""> <label class="no-margin no-padding pay_method_sarf"> نقدي</label>
                            </div>
                            <div class="col-md-4 col-sm-6 no-padding">
                                <input type="radio" name="pay_method_sarf" onclick="$('#pay_method_value').val($(this).val());
                                $('.divBankInput').attr('data-validation','required');"  data-name="شيك من الصندوق" style="width: 20px; height: 20px;" <?php if(!empty($pay_method) && $pay_method == 2){echo 'checked';} ?> data-rqamHesab="<?=($box != null)?$box['شيك']->rqm_hesab:''?>" data-hesabName="<?=($box != null)?$box['شيك']->name_hesab:''?>" data-validation="required" value="2"> <label class="no-margin no-padding pay_method_sarf">شيك من الصندوق</label>
                            </div>
                            <div class="col-md-4 col-sm-6 no-padding">
                                <input type="radio" name="pay_method_sarf" onclick="$('#pay_method_value').val($(this).val()); $('.divBankInput').removeAttr('data-validation');"  data-name="شيك من البنك" style="width: 20px; height: 20px;" <?php if(!empty($pay_method) && $pay_method == 3){echo 'checked';} ?> data-rqamHesab="<?=($box != null)?$box['شيك']->rqm_hesab:''?>" data-hesabName="<?=($box != null)?$box['شيك']->name_hesab:''?>" data-validation="required" value="3"> <label class="no-margin no-padding pay_method_sarf">شيك من البنك</label>
                            </div>

                            <input type="hidden" name="pay_method_value" id="pay_method_value" value="<?=$pay_method?>">
                        </div>
                    </div>
                ...
                <div class="col-md-12 no-padding">
                    ...
                    <div class="col_md_35 col-sm-6 padding-4">
                        ...
                        <div class="col-md-8 col-sm-6 no-padding">
                            <input type="date" name="date_sanad"  data-validation="required" id="date_sanad" value="<?=$date_sanad?>" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])/(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])/(?:30))|(?:(?:0[13578]|1[02])-31))" class="form-control input_style_2" data-validation-has-keyup-event="true">
                        </div>
                    </div>
                    <div class="col_md_35 col-sm-6 padding-4">
                        <div class="col-md-5 col-sm-6  no-padding ">
                ...
                <div class="col-md-12 no-padding hesab_bo" <?=($pay_method != 3)? 'style="display: block"' : 'style="display: none"';?>>
                <div class="col_md_65 col-sm-6 padding-4">     

                    <div class="col_md_55 col-sm-12 no-padding">
                        <div class="col-md-4 col-sm-6 no-padding">
                            <h6 class="label_title_2">ح. الصندوق</h6>
                        </div>
                        <div class="col-md-8 col-sm-6 no-padding">
                            <input type="text"  placeholder="كود الحساب" readonly="" name="box_rqm_hesab" id="rqm_hesab" class="form-control input_style_2 " value="<?=$box_rqm_hesab?>" data-validation="required" data-validation-has-keyup-event="true"
                            value=""/>
                        </div>
                        </div>
                        ...
                        <div class="col-md-12 col-sm-6 padding-4" >
                            <input type="text" placeholder="إسم الحساب"  name="box_name" readonly="" id="name_hesab" class="form-control input_style_2 " value="<?=$box_name?>" data-validation="required" data-validation-has-keyup-event="true" value="">
                        </div>
                        </div>
    ...
    <div class="col-md-5 col-sm-6  no-padding ">
        ...
        <div class="col-md-7 col-sm-6 no-padding">
            <input type="text" name="rased" id="rased" style="color: red !important;" data-validation="required" class="form-control input_style_2 error"
                  value="<?php /*if(isset($all_sarf_naqdi) && isset($all_sarf_naqdi))*/ echo ( $all_qabd_naqdi  - $all_sarf_naqdi);  ?>" data-validation-has-keyup-event="true" disabled="">
        </div>
                ...
                <div class="col-md-12 no-padding bank_dd" <?=($pay_method == 3)? 'style="display: block"' : 'style="display: none"';?>>
                  ...
                  <div class="col-md-12 no-padding">
                    <div class="col_md_30 col-sm-6 padding-4">
                        ...
                        <div class="col-md-7 col-sm-6 no-padding">
                            <select id="sheek_bank_id"  name="sheek_bank_id" onchange="getBankSetting(this.value,this)" class="form-control input_style_2 " data-validation="" aria-required="true">
                                ...
                                <?php if(isset($banks_setting) && !empty($banks_setting)){
                                    foreach ($banks_setting as $bank){
                                        ...
                                        ?>
                                        <option data-code="<?=$bank['code_account_id']?>" <?=$select?> value="<?=$bank['bank_id']?>"><?=$bank['bank_title']?></option>
                                    <?php }} ?>
                            </select>
                        </div>
                    </div>
                    <div class="col_md_45 col-sm-6 padding-4">
                        ...
                        <div class="col-md-9 col-sm-6 no-padding">
                            <input type="text" placeholder="اسم الحساب" readonly="" name="sheek_bank_name" id="sheek_bank_name" class="form-control input_style_2 " value="<?=$sheek_bank_name?>"  data-validation-has-keyup-event="true">
                        </div>
                    </div>
                    <div class="col_md_25 col-sm-6 padding-4">
                        ...
                        <div class="col-md-7 col-sm-6 no-padding">
                            <input type="text" placeholder="كود الحساب" readonly="" name="sheek_rqm_hesab" id="sheek_rqm_hesab" class="form-control input_style_2" value="<?=($box != null)?$box['نقدي']->rqm_hesab:$box_rqm_hesab?>" data-validation="required" data-validation-has-keyup-event="true">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 no-padding">
                      ...
                      <div class="col_md_30 col-sm-6 padding-4">
                        <div class="col-md-5 col-sm-6 no-padding">
                            <h6 style="background-color: #003665 !important;     border: 2px solid #003665;" class="label_title_2">رصيد الحساب </h6>
                        </div>
                        <div class="col-md-7 col-sm-6 no-padding">
                            <input type="text" placeholder="رصيد الحساب " readonly="readonly"  name="rased_hesab_bank" 
                    ...
                    <div class="col_md_35 col-sm-6 padding-4">
                        <div class="col-md-4 col-sm-6 no-padding">
                            <h6 style="background-color: #003665 !important;     border: 2px solid #003665;" class="label_title_2">رقم الشيك</h6>
                        </div>
                        <div class="col-md-8 col-sm-6 no-padding">
                            <input type="text" placeholder="رقم الشيك" readonly="readonly"  name="sheek_num_bank" id="sheek_num_bank" class="form-control input_style_2" value="<?=$sheek_num_bank?>"  data-validation-has-keyup-event="true">
                        </div>
                    </div>
</div>
                </div>
                <div class="col-md-12 no-padding">
                    <div class="col_md_70 col-sm-6 padding-4">
                        ...
                        <div class="col-md-10 col-sm-6 no-padding">
                            <input  list="pepople_arr" autocomplete="off" style="width:91%; float: right;" type="text" name="person_name" id="person_name" class="form-control input_style_2 list" value="<?=$person_name?>" data-validation-has-keyup-event="true" onkeyup="$('#person_name_div').html($(this).val());" data-validation="required" />
                    ...
                    <div class="col_md_30 col-sm-6 padding-4">
                        ...
                        <div class="col-md-8 col-sm-6  no-padding">
                            <input style="font-weight: 600 !important;" type="text" onkeypress="validate_number(event)" name="person_mob" id="person_mob"  value="<?php echo $mob ; ?>" class="form-control input_style_2"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12 no-padding">
                    <div class="col_md_70 col-sm-6 padding-4">
                        ...
                        <div class="col-md-10 col-sm-6 no-padding">
                            <input type="text" id="about" name="about" class="form-control input_style_2" data-validation="required" data-validation-has-keyup-event="true" value="<?=$about?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12 no-padding">
                    ...
                    " id="mytable">
                        ...
                        ?>
                            <tr id="<?=$row_detail->id?>">
                                <td>
                                    <input type="text" value="<?=$row_detail->value?>" onkeypress="return validate_number(event);" class="form-control accountValue" step="any" name="value[]" data-validation="required" aria-required="true" onkeyup="getSum();">
                                </td>
                                <td>
                                ...
                                <td>
                                    <input type="text" value="<?=$row_detail->byan?>" class="form-control" name="byan[]" data-validation="required" aria-required="true">
                                </td>
                                <td id="TD<?=$row_detail->id?>">
                                    <a href="#" <?php if($counter < sizeof($details)){?> style="display: none;" <?php }?> onclick="addRow(); $(this).remove(); $('#deleteRow<?=$row_detail->id?>').show();"><i class="fa fa-plus sspan"></i></a>
                                    <a class="pull-right"  id="deleteRow<?=$row_detail->id?>" href="#" onclick="$('#<?=$row_detail->id?>').remove(); $('#trcheque<?=$counter?>').remove(); getSum();"><i class="fa fa-trash" aria-hidden="true"></i>
                                    </a>
                                </td>
                            </tr>
                        <?php 
                        ...
                        ?>
                            <tr id="<?=$counter?>">
                                ...
                                <td id="TD<?=$counter?>">
                                    ...
                                    <a class="pull-right" style="display: none;" id="deleteRow<?=$counter?>" href="#" onclick="$('#<?=$counter?>').remove(); $('#trcheque<?=$counter?>').remove(); getSum();"><i class="fa fa-trash" aria-hidden="true"></i>
                                    </a>
                                </td>
                            </tr>
                        <?php } ?>
                   ...
                   <div id="sandok_sheek_div">
                       ...
                       <?php  $x=1;foreach ( $result->sheek_data as $row){ ?>
                  <div id="trcheque<?=$x?>">
                               <div class="col_md_30 col-sm-6 padding-4">
                                   ...
                                   <div class="col-md-6 col-sm-6 no-padding">
                                       <input type="number" name="sheek_num[]"  id="sheek_num1" value="<?=$row->sheek_num?>"  class="form-control input_style_2 bank"  data-validation-has-keyup-event="true">
                                   </div>
                               </div>
                               ...
                               <div class="col_md_35 col-sm-6 padding-4">
                                   ...
                                   <div class="col-md-6 col-sm-6 no-padding">
                                       <input type="date"  name="sheek_date[]"  id="day_date1" value="<?=$row->sheek_date_ar?>"  pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])/(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])/(?:30))|(?:(?:0[13578]|1[02])-31))" class="form-control input_style_2 bank" data-validation-has-keyup-event="true">
                                   </div>
                               </div>
                               ...
                               <div class="col_md_35 col-sm-6 padding-4">
                                   ...
                                   <div class="col-md-6 col-sm-6 no-padding">
                                       <select id="pill_type"  name="bank_id_fk[]" id="bank_id_fk1" class="form-control input_style_2 bank "
                                               aria-required="true">
                                           <option value="">إختر</option>
                           ...
                           <?php /*foreach ( $result->sheek_data as $row){ ?>
                       ...
                       <div  id="trcheque1" class="col-md-12 no-padding divBank" <?php if($pay_method !=2){ ?> style="display: none;"<?php } ?>>
                        ...
                        <div class="col_md_30 col-sm-6 padding-4">
                            ...
                            <div class="col-md-6 col-sm-6 no-padding">
                             <!--   <input type="number" name="sheek_num[]" id="sheek_num1"     
                                class="form-control input_style_2 bank divBankInput" data-validation="" 
                                data-validation-has-keyup-event="true">-->
                                <select id="sheek_num1"  name="sheek_num[]"  class="form-control input_style_2 bank selectpicker"
                        ...
                        <div class="col_md_35 col-sm-6 padding-4">
                            ...
                            <div class="col-md-6 col-sm-6 no-padding">
                                <input type="date"  name="sheek_date[]" id="sheek_date1"  class="divBankInput"     pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])/(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])/(?:30))|(?:(?:0[13578]|1[02])-31))" class="form-control input_style_2 bank" data-validation-has-keyup-event="true">
                            </div>
                        </div>
                        ...
                        <div class="col_md_35 col-sm-6 padding-4">
                            ...
                            <div class="col-md-6 col-sm-6 no-padding">
                                <select   name="bank_id_fk[]" id="bank_id_fk1" class="form-control input_style_2 bank divBankInput"
                                        aria-required="true">
                                    <option value="">إختر</option>
                                    <?php if(isset($banks) && !empty($banks)){
                                        foreach ($banks as $bank){
...
-->                        </div>
                ...
                <!--div class="col-md-12 no-padding divBank" <?php if($pay_method !=2){ ?> style="display: none;"<?php } ?>>
                        ...
                        <div class="col_md_30 col-sm-6 padding-4">
                            ...
                            <div class="col-md-6 col-sm-6 no-padding">
                                <input type="number" name="sheek_num[]" id="sheek_num1"     class="form-control input_style_2 bank divBankInput" data-validation="" data-validation-has-keyup-event="true">
                            </div>
                        </div>
                        ...
                        <div class="col_md_35 col-sm-6 padding-4">
                            ...
                            <div class="col-md-6 col-sm-6 no-padding">
                                <input type="date"  name="sheek_date[]" id="day_date1"  class="divBankInput"     pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])/(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])/(?:30))|(?:(?:0[13578]|1[02])-31))" class="form-control input_style_2 bank" data-validation-has-keyup-event="true">
                            </div>
                        </div>
                        ...
                        <div class="col_md_35 col-sm-6 padding-4">
                            ...
                            <div class="col-md-6 col-sm-6 no-padding">
                                <select id="pill_type"  name="bank_id_fk[]" id="bank_id_fk1" class="form-control input_style_2 bank divBankInput"
                                        aria-required="true">
                                    <option value="">إختر</option>
                                    <?php if(isset($banks) && !empty($banks)){
                                        foreach ($banks as $bank){
                ...
                <button type="button"  onclick="add_row_attached()" class="btn btn-success btn-next"/> <i class="fa fa-plus"></i> إضافة </button><br>
                <table  class="table table-striped table-bordered fixed-table mytable ">
                    ...
                    <?php $x=1; foreach ($attached_files as $file){ ?>
                        <tr id="<?=$x?>">
                            ...
                            <td class="text-center">
                                <a href="<?=base_url()."finance_accounting/box/vouch_sarf/Vouch_sarf/deleteVouchSarfFiles/".$file->id .'/'.$result->id?>" > <i class="fa fa-trash" ></i> </a>
                            </td>
                        </tr>

                        <div class="modal fade" id="myModal-view-<?=$file->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <img src="<?=base_url()."uploads/images/finance_accounting/box/vouch_sarf/".$file->file_attached?>" width="100%">
                                    </div>
            ...
            <div class="panel-body">
                <div class="bond-qabd">
                    ...
                    <div class="bond-body">
                        ...
                        <div class="col-xs-12 no-padding">
                            <div class="col-xs-6 no-padding">
                                <div class="col-xs-6 pad-2">
                                    ...
                                    <span class="border-box halalah">  <?php if(isset($val_data[1]) && !empty($val_data[1])){echo $val_data[1];}else{echo'0';}?></span>
                                </div>
                                <div class="col-xs-6 pad-2">
                                    <h5>ريــــــــــــــــال  </h5>
                                    <span class="border-box rial"><?php if(isset($val_data[0]) && !empty($val_data[0])){echo $val_data[0];}else{echo'0';}?></span>
                                </div>
                            </div>
                            <div class="col-xs-6 text-center">
                        ...
                        <div class="col-xs-12 no-padding">
                            <h5 style="margin-right: 5px;"><span style="border-bottom: 1px solid #000">إدفعوا لأمر :</span> <span class="data-person-name"><?=$person_name?></span> </h5>
                        </div>
                        <div class="col-xs-12 no-padding">
                            <h5 style="margin-right: 5px;"><span style="border-bottom: 1px solid #000"></span>  <span class="viewArabicValue"><?=$arabicValue?></span> </h5>
                        </div>
                        <div class="col-xs-12 no-padding">
                            <h5 style="margin-right: 5px;"><span style="border-bottom: 1px solid #000">عبارة عن :</span> <span class="Sarf-about"><?=$about?></span></h5>
                        </div>
                        <div class="col-xs-12 no-padding">
...
<div class="col-sm-12 col-md-12 col-xs-12  " style="padding: 0;">
    ...
    <td>
        <button type="button" class="btn btn-sm btn-labeled btn-add" data-toggle="modal" data-target="#detailsModal<?=$value->id?>">
            <span class="btn-label"><i class="glyphicon glyphicon-list"></i></span>تفاصيل السند
        </button>
    </td>
...
<a title="طباعة السند" id="ptrintSanadButton<?=$value->id?>" href="<?=base_url()?>finance_accounting/box/vouch_sarf/Vouch_sarf/printSanedSarf/<?=$value->id?>" target="_blank"> <i class="fa fa-print" aria-hidden="true"></i> </a>
<?php if ($value->pay_method == 3) { ?>
<a title="طباعة الشيك" id="ptrintSheekButton<?=$value->id?>" href="<?=base_url()?>finance_accounting/box/vouch_sarf/Vouch_sarf/printSheek/<?=$value->id?>/<?=$value->sheek_bank_id?>" target="_blank"> <i class="fa fa-money" aria-hidden="true"></i></a>
<?php } ?>

 
<a title="عرض المرفق"id="" href="#" target="_blank"> <i class="fa fa-cloud-upload" aria-hidden="true"></i> </a>


<a href="<?=base_url()."finance_accounting/box/vouch_sarf/Vouch_sarf/updateView/".$value->id?>" title="تعديل"><i class="fa fa-pencil"></i></a>

<a onclick="$('#adele').attr('href', '<?=base_url()."finance_accounting/box/vouch_sarf/Vouch_sarf/deleteVouchSarf/".$value->id?>');" data-toggle="modal" data-target="#modal-delete" title="حذف"><i class="fa fa-trash"></i></a>
...
<div class="modal fade" id="myModal_attach" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document" style="width: 50%">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="display: inline-block;width: 100%">
                <button type="button" class="btn btn-success" style="display: inline-block;padding: 6px 12px;" onclick="GetAttachTable()" id="saves"  data-dismiss="modal">حفظ</button>
                ...
                <table class="table table-striped table-bordered"  style="table-layout: fixed">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="radio" disabled style="width: 18px; height: 18px;"  <?php if(!empty($value->pay_method) && $value->pay_method == 1){echo 'checked';} ?> > <label class="no-margin no-padding"> نقدي</label><br>
                                <input type="radio" disabled  style="width: 18px; height: 18px;" <?php if(!empty($value->pay_method) && $value->pay_method == 2){echo 'checked';} ?> > <label class="no-margin no-padding"> شيك من الصندوق</label><br>
                                <input type="radio" disabled  style="width: 18px; height: 18px;" <?php if(!empty($value->pay_method) && $value->pay_method == 3){echo 'checked';} ?> > <label class="no-margin no-padding"> شيك من البنك</label>
                            </td>
                        </tr>
                        <tr>
