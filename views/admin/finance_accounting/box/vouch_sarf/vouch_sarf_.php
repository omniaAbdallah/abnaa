            ...
            ?>
                ...
                <div class="col-md-12 no-padding">
                    <div class="col_md_70 col-sm-6 padding-4">
                        ...
                        <div class="col-md-10 col-sm-6 no-padding">
                            <input type="text" name="note" class="form-control input_style_2" data-validation="required" data-validation-has-keyup-event="true" value="<?=$note?>">
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-striped table-bordered"  style="table-layout: fixed">
                    <tbody>
                        <tr>
                            ...
                            <td><span class=" " ><?=$value->date_sanad?></span></td>
                            <td>
