...
<style type="text/css">
	...
	<div class="bond-header">
		...
		<div class="col-xs-4 pad-2">
			<div class="main-bond-title">
				<h3 class="text-center"><span class="border-box">??? ???</span></h3>
			</div>
		</div>
		<div class="col-xs-4 pad-2">
			<div class="left-img">
			...
			<table class="table table-bordered table-devices" style="table-layout: fixed">
				...
				<tr>
					...
					<td><span id=""><?php if(!empty($number_title)){
								echo $number_title; }else{  echo '??? ????';} ?></span></td>
				</tr>
				<tr>
					<th>??? ?????/????????</th>
					<td><span id="">
				...
				<tr>
					...
					echo $result->about; }else{  echo '??? ????';} ?></span></td>
				</tr>
				</tbody>
			</table>
		</div>
			...
			<div class="col-md-4 col-xs-4">
				...
				<span style="color:darkred !important;" >
					<?php if(!empty($result->ezn_date_ar)){
						echo $result->ezn_date_ar; }else{  echo '??? ????';} ?>
				</span>
			</div>
	...
	<div class="bond-footer">
		<h5 class="border-box-h text-center">??????? ??????? ???????? - ?????? - ????? - ?.?821 - ????? 51421 - ???? : 0163851919 - ???? : 0553851919 - ???? : 0163837737</h5>
	</div>
