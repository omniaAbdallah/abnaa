...
?>
                                ...
                                <td>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm" name="to_person_id"
                                                ...
                                                <option value="<?=$eznInfo['emp_id']?>"><?=$eznInfo['emp_name']?></option>
                                            <?php
                                            /* foreach ($amin_sandoks as $amin_sandok) { ?>
                ...
                <?php }elseif($eznInfo['level'] == 4 and $eznInfo['current_to_id'] == $_SESSION['user_id']){ ?>
                              ...
                              <form action="<?= site_url('finance_accounting/box/ezn_sarf/Ezn_sarf_request/process_transform_to_mohaseb') ?>"
                          method="post" id="transform_form">
                        <input type="hidden" name="save" value="save">
                                ...
                                <td>
                                    <div class="form-group">
                                        ...
                                        <div class="radio">
                                            <label style="color: green;">
                                                <input type="radio" value="accept"
                                                       name="option_choosed">تسليم المعاملة للمالية</label>
                                        </div>
                                        <span style="color: red;">لن يتم الإنتهاء من المعاملة إلا بعد تسليمها للمالية كاملة للمستندات اللازمة للصرف</span>
                                    </div>
                                </td>
                ...
                <?php }elseif($eznInfo['level'] == 5 and $eznInfo['current_to_id'] == $_SESSION['user_id']){ ?> 
                       ...
                       <form action="<?= site_url('finance_accounting/box/ezn_sarf/Ezn_sarf_request/process_transform_to_sandok') ?>"
                          method="post" id="transform_form">
                        <input type="hidden" name="save" value="save">
                                ...
                                <td>
                                    <div class="form-group">
                                        ...
                                        <div class="radio">
                                            <label style="color: green;">
                                                <input type="radio" value="accept"
                                                       name="option_choosed">إستلام المعاملة </label>
                                        </div>
