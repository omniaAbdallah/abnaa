...
<div class="col-sm-12  wow" >
    <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            ...
            <div class="col-md-12">
                <div class="form-group col-md-20 col-sm-3 col-xs-12 no-padding ">
                    <div class="col-xs-4 no-padding">
               ...
               <?php
                ...
                ?>
                <div class="form-group col-md-35 col-sm-3 col-xs-12 no-padding multi_sel" style="display: none;" >
                    <div class="col-xs-3 no-padding">
                                ...
                                for($a=1;$a<sizeof($arra);$a++){ ?>
                                    ...
                                    <label class="radio-inline" style="margin-top: 0px;">
                                        <input type="radio" onchange="get_val($(this).val())"
                                         class="pay_method dep" name="qued" 
                                          id="inlineRadio<?php echo $a?>" value="<?php echo $a ;?>">
                                        <span><?php echo $arra[$a] ;?></span>
                                    </label>
                ...
                <div class="form-group col-md-15 col-sm-3 col-xs-12 no-padding qued_num"style="display: none;" >
                    <div class="col-xs-5 no-padding">
                        <h5 class="label-green-h ">رقم القيد </h5>
                    </div>
                    <div class="col-xs-7 no-padding text-center">
                        <input type="text"  style="" id="qued_num" class="form-control">
