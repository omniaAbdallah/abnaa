            ...
            <div class="col-md-12">
                ...
                <div class="form-group col-md-25 col-sm-3 col-xs-12 no-padding" >
                    ...
                    <label class="radio-inline" style="margin-top: 8px;">
                        <input type="radio" class="pay_method" name="pay_method" onchange="get_more($(this).val());" id="inlineRadio<?php echo $key?>" value="<?php echo $key ;?>">  <?php echo $value ;?>
                    </label>
                        <?php
                    }
                    }
              ...
              //  $multi_pays=array('إختر',4=>'إيداع نقدي',5=>'إيداع شيك',6=>'تحويل',7=>'أمر مستديم');
                ...
                ?>
                <div class="form-group col-md-20 col-sm-3 col-xs-12 no-padding multi_sel" style="display: none;">
                    <div class="col-xs-4 no-padding">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer"  style="display: inline-block;width: 100%" >
                        ...
                        <button type="submit" class="btn btn-success"
                                style="float: left;" data-dismiss="modal">حفظ</button>
                    </div>
                </div>
            </div>
        </div>
