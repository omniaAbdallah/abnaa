                ...
                <div class="col-md-12 no-padding">
                    <div class="col_md_50 col-sm-6 padding-4">
                        ...
                        <div class="col-md-10 col-sm-6 no-padding">
                            <input type="text" name="recived_from" onkeyup="estlmna($(this).val())" class="form-control input_style_2 arabic_number" data-validation="required" data-validation-has-keyup-event="true" value="<?=$recived_from?>">
                        <!--
                ...
                <div class="col-md-12 no-padding">
                    ...
                    " id="mytable">
                        ...
                        <tr class="info">
                            ...
                            <th style="width: 100px;">رقم المرجع</th>
                        ...
                        if(!empty($details)){
                            ...
                            foreach ($details as $row_detail){
                                ...
                                if($this->uri->segment(5)=='index'){?>
                                    <td>
                                        <input type="text"  class="form-control testButton" value="<?php if(!empty($row_detail->rkm_esal)) echo $row_detail->rkm_esal;?> " name="marg3[]">                                    </td>
                                    </td>
                                    <?php } else{?>
                                    <td>
                                        <input type="text"  class="form-control testButton" value="<?php if(!empty($row_detail->marg3)) echo $row_detail->marg3;?> " name="marg3[]">                                    </td>
                                    </td>
                                    <?php } ?>
                                    <td>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td></td>
                                <td colspan="3">
                                    <input type="text" id="valueArabic" class="form-control"  data-validation-has-keyup-event="true" readonly>
                                </td>
                            </tr>
                        </tfoot>
                    </table>
                        ...
                        <div class="bond-body">
                            ...
                            <div class="col-xs-12 no-padding">
                                ...
                                <div class="col-xs-6 no-padding">
                                    <h5 style="margin-right: 5px;">التاريخ :&nbsp&nbsp <?=$date_sanad?>   م</h5>
                                </div>
                            ...
                            <div class="col-xs-12 no-padding">
                                <div class="col-xs-6 no-padding">
                                    ...
                                    <div class="col-xs-6 pad-2">
                                        ...
                                        <span class="border-box"><?php if( $this->uri->segment(5)!='index'){echo $total_value; }else{ echo $total_sand_value;  } ?> </span>
                                    </div>
                                </div>
                                <div class="col-xs-6 text-center">
                                    <h5>رقم القيد : &nbsp&nbsp<span class="border-box"><?php   echo $rkm_elqud ;  ?> </span></h5>
                                </div>
                            ...
                            <div class="col-xs-12 no-padding">
                                <h5  style="margin-right: 5px;"><span style="border-bottom: 1px solid #000">استلمنا من :</span> مسعد السيد عبد العزيز  </h5>
                            </div>


                            <div class="col-xs-12 no-padding">
                                <h5  style="margin-right: 5px;"><span style="border-bottom: 1px solid #000">مبلغاّ وقدره :</span>  <?php if( $this->uri->segment(5)!='index'){echo $total_value; }else{ echo $total_sand_value;  } ?> ريال فقط لاغير  </h5>
                            </div>
                            <div class="col-xs-12 no-padding">
...
<script>
    ...
    {
        $('#cheque').text( 'بموجب شيك رقم :' +valu);
    }
