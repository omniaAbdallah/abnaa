                    ...
                    <div class="col-md-12 no-padding">
                      ...
                      <div class="form-group col-md-3 col-sm-6 padding-4">
                            ...
                            <div class="radio-content">
                                <input <?php if ($key == 1) {
                                        echo 'checked';
                                    } ?> type="radio" id="all<?php echo $key; ?>" value="<?php echo $key; ?>"  onclick="view_function($(this).val())" name="status">
                                 <label class="radio-label " for="all<?php echo $key; ?>">  <?php echo $value; ?></label>
                       ...
                       <div class="form-group col-md-2 col-sm-6 padding-4 ">
                        ...
                        <div class="form-group col-xs-12">
                            ...
                            <div class="form-group col-md-4 col-sm-6 padding-4  text-center" >
                                <div class="skin-square" id="zero_account" style="display: none">
                                    <div class="i-check" >
                                        <input tabindex="9" name="zero"  type="checkbox" id="zero" checked value="1">
