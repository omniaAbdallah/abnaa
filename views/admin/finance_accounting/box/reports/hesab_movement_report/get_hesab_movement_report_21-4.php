            ...
            <table id="scrollingtable" class="table table-bordered  scrollingtable" border="1" cellpadding="3" role="table" style="table-layout: fixed;">
                ...
                for ($s=0;$s<sizeof($records);$s++) {
                    ...
                    <tr>
                        ...
                        <td style="text-align: right !important;"><?php echo $records[$s]->byan;?></td>
                ...
                <tr>
                  ...
                  <td></td>
                    ...
                    <td></td>
                    <td></td>-->
                    <td style="text-align: center;  background-color: #fcb632; border-radius:5px;  font-size:17px ; color:black;"><?php echo number_format($total_Rased_sabeq,2);?></td>
                    <td style="text-align: center;background-color: #fcb632;  border-radius:5px; font-size:17px ; color:black;"><?php echo number_format($total_maden, 2); ?></td>
                    <td style="text-align: center;background-color: #fcb632; border-radius:5px;  font-size:17px ; color:black;"><?php echo number_format($total_dayen, 2); ?></td>
                    <td style="text-align: center;background-color: #fcb632; border-radius:5px;  font-size:17px ; color:black;"><?php //echo number_format($total_raseed, 2); ?></td>
                </tr>
                <tr >
                    <td colspan="6" style="color: #fff;text-align: center;background-color:#fcb632; border-left: 0;
                      font-size:17px ; color:black; border-radius:5px;
                   ...
                   <!-- <td style="border-left: 0;border-right: 0;background-color:#fcb632;"></td>
                    ...
                    <td></td>
                    <td></td>-->
                    <td colspan="3" style="text-align: center; background-color: #fcb632; border-radius:5px;  font-size:17px ; color:black; "><? echo number_format($value, 2); ?></td>
                 <td>        <button onclick="printData('scrollingtable')" class="btn btn-success" style="float: left">طباعة</button></td>
                     <!--  <td></td>-->
