    ...
    if (isset($records) && !empty($records)) {
        ...
        for ($z = 0; $z < sizeof($records); $z++) {
            ...
            <table id="" class=" table table-bordered  " role="table"
                   style="table-layout:fixed;width: 100%;border-collapse:separate" border="1">
                <thead>
                <tr class="greentd text-center">
                    <th style="width: 40px;">رقم الحساب</th>
                    <th style="width: 100px" >إسم الحساب</th>
                    <th style="width: 80px" >رصيد إفتتاحي</th>
                    <th style="width: 70px" >رصيد ختامي</th>
                </tr>
                </thead>
                <tbody>
                <tr>
                    <td><?php echo $_POST['rkm_hesab']; ?></td>
                    <td><?php echo $hesab_name; ?></td>
                    <td style="font-weight: bold !important; color: #2217ce !important;"><?php echo number_format($sabeq, 2);
                         ?></td>
                    <td style="font-weight: bold !important; color: #2217ce !important;"><?php echo number_format($value,2);?></td>
                </tr>
                </tbody>
            </table>
            ...
            <table id="" class=" table table-bordered scrollingtable my_table" role="table"
                ...
                for ($s = 0; $s < sizeof($records); $s++) {
                    ...
                    <tr>
                        ...
                        <!--<td><?php if ($a == 1) {
                                echo number_format($Rased_sabeq, 2);
                            } else {
                ...
                <tr>
                    ...
                    <!-- <td style="border-left: 0;border-right: 0;background-color:#fcb632;"></td>
                     ...
                     <td></td>-->
                    <td colspan="2"
                        style="text-align: center; background-color: #fcb632; border-radius:5px;  font-size:20px ; color:black; "><? echo number_format($value, 2); ?></td>
                    <td></td>
                    <!--  <td></td>-->
                    ...
                    $(win.document.body).find('.tablearea tbody tr:last-child')
                        .after('<tr>' +
                            ...
                            '<td class=" text-center" style="background-color: #e8e8e8 !important;"><?php echo number_format($total_dayen, 2); ?></td>' +
                             '<td class=" text-center" style="background-color: #e8e8e8 !important;"><?php echo ''; ?></td>' +
                            '</tr>' +
                            '<tr>' +
                            '<td class="text-center " colspan="6"  style="background-color: #e8e8e8 !important;">رصيد الحساب	</td>' +
                            '<td class=" text-center" colspan="2" style="background-color: #e8e8e8 !important;"><? echo number_format($value, 2); ?></td>' +
