...
<!--<div id="table-scroll" class="table-scroll">
    ...
    <div class="table-wrap" id="printMe">
        ...
        <div class=" col-xs-12 visible-print">
          ...
          <table id="scrollingtable" class="table table-bordered  scrollingtable hidden-print" border="1" cellpadding="3" role="table" style="table-layout: fixed;">
              ...
              <tr class="greentd">
                  ...
                  <th style="width: 88px" class="text-left">رقم المرجع</th>
            ...
            <!--  <tr class="visible-print">
                  <td colspan="6" style="text-align: center;color: red">الإجمالي</td>
                  <td>0</td>
                  <td><?php echo $total_maden; ?></td>
                  <td><?php echo $total_dayen; ?></td>
                  <td><?php echo $total_raseed; ?></td>
              </tr>
              -->
