                        ...
                        <div class="form-group col-md-3 col-sm-6 padding-4 text-center">
                            ...
                            <?php foreach ($array as  $key=>$value){ ?>
                                <div class="radio-content">
                                    <input <?php if($key ==1){echo'checked'; }?> type="radio" value="<?php echo $key;?>" name="status" id="status_value<?php echo $key;?>">
...
-->
                    ...
                    <!--  <div class="form-group col-md-3 col-sm-6 padding-4 text-center">
                      <div style="margin-top: 21px;">
                        ...
                        <div class="form-group col-md-2 col-sm-6 padding-4 text-center">
                        ...
                        <div class="form-group col-md-3 col-sm-6 col-xs-12 padding-4 text-center">
                           
                            
                            <button type="button" class="btn btn-labeled btn-success search" id=""  name="add" onclick="SearchTable();" style="margin-top: 20px;" >
                            <span class="btn-label"><i class="fa fa-search-plus"></i></span>بحث
                        </button>
                        
                       <!-- <button type="button" class="btn btn-labeled btn-purple " id="" name="add" style="margin-top: 20px;">
