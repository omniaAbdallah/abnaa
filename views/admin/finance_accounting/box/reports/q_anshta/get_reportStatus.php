    ...
    foreach ($tree as $record) {
        ...
        <?php   if (empty($record['children'])) { ?>
            <tr style="">
                <td><?= $record['code'] ?></td>
                <td><?= $record['name'] ?></td>
                <td style="color: #1b7e5a !important; font-weight: bold !important;" class="countable1"  data-type="<?php if (isset($record['children'])) { echo 1;
                }else{ echo 0; }?>" data-number="<?= $erad ?>"><?php echo number_format($erad,2); ?></td>
                <td style="color: #b90000 !important; font-weight: bold !important;" class="countable2"  data-type="<?php if (isset($record['children'])) { echo 1;
...
<div id="printMe">
    ...
    <table id="" class=" table table-bordered scrollingtable my_table" role="table" style="width: 100%;border-collapse:separate" border="1">
        ...
        <tr class="orangetd">
            ...
            <td  style="text-align: center;color: green;font-size:20px; font-weight: bold !important;" class="result1">0</td>
            <td  style="text-align: center;color: red;font-size:20px; font-weight: bold !important;" class="result2">0</td>
        </tr>
        <tr class="orangetd">
