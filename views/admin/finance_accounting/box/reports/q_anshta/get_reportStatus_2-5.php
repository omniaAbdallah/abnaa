                ...
                <div class="table-wrap">
                    <table id="scrollingtable" class="table table-bordered  scrollingtable" border="1" cellpadding="3"
                        ...
                        <tr class="hidden-print">
                            ...
                            <!--<td></td>-->
                            <td class="result1" style="width: 280px;text-align: center; color: green; font-size: 16px;
                      font-weight: bold;"><?php echo number_format($total_erad_value, 2); ?></td>
                            <td class="result2" style="width: 280px;color: red; text-align: center;font-size: 16px;
                      font-weight: bold;"><?php echo number_format($total_masrofat_value, 2); ?> </td>
                        </tr>
                        <tr class="hidden-print">
                            <td colspan="2"  style="color: #fff;text-align: center;background-color:#09704e; border-left: 0;"><?php echo $titles . '[' . $symbol . ']'; ?></td>
                            <!--<td></td>-->
                            <td class="specific_style_2" colspan="2" style="text-align: center;width: 280px; font-weight: bold;
                                    color:<?php echo $ccolr; ?>; "><?php echo number_format($values, 2); ?></td>
                        </tr>
                        </tfoot>
                    </table>
