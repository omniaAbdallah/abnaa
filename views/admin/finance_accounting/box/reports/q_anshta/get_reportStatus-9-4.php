...
<div id="table-scroll" class="table-scroll" >
 ...
 <table id="scrollingtable" class="table table-bordered  scrollingtable" border="1" cellpadding="3" role="table" style="table-layout: fixed;">
              ...
              <thead>
              <tr class="info">
                  <th scope="col" style="width: 80px;">م</th>
            
                  <th  scope="col" style="width: 120px;" class="text-left">رقم الحساب</th>
                  <th scope="col" style="width: 500px;" class="text-left">إسم الحساب</th>
