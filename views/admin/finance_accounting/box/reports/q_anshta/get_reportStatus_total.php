          ...
          foreach ($tree as $record) {
              ...
              ?>
                  ...
                  <tr style="">
                      <td><?= $record['code'] ?></td>
                      <td><?= $record['name'] ?></td>
                      <td style="background-color:#98cc8c !important;" class="countable1"  data-type="<?php if (isset($record['children'])) { echo 1;
                      }else{ echo 0; }?>" data-number="<?= $erad ?>"><?php echo number_format($erad,2); ?></td>
                      <td style="background-color: #ff8c8c !important;" class="countable2"  data-type="<?php if (isset($record['children'])) { echo 1;
        ...
        <h6 class="text-center">
            ...
            <table id="scrollingtable" class="table table-bordered scrollingtable my_table" border="1" cellpadding="3" role="table" style="table-layout: fixed;">
                ...
                <tr>
                    ...
                    <td  style="background-color:#98cc8c !important;text-align: center;color: green" class="result1">0</td>
                    <td  style="background-color:#ff8c8c !important;text-align: center;color: red" class="result2">0</td>
                </tr>
                <tr>
...
<script>
    ...
    $(".my_titles_value").html(formatMoney(ConvertToDecimal(values)));
        ...
        buttons: [
...

            {
                ...
                customize: function (win) {
                    ...
                    '</tr>'+
                    '<tr>'+
                    '<td class="text-center my_titles" colspan="2"  style="background-color: #e8e8e8 !important;">'+ titles+'['+ symbol +']' +'</td>'+
