                ...
                <div class="col-md-12 no-padding">
                    <div class="col_md_30 col-sm-6 padding-4">
                        ...
                        <div class="col-md-7 col-sm-6 no-padding">
                            <input type="text"  name="rqm_sanad" value="<?=$rqm_sanad?>" class="form-control input_style_2" 
...
<!--
                    <div class="col_md_40 col-sm-6 padding-4 text-center">
                        <div class="col-md-4 col-sm-6 no-padding">
...
<div class="col-md-12 no-padding sheek_sandoq" <?php if($pay_method !=1){ ?> style="display: none;"<?php } ?>>

 <div class="col_md_25 col-sm-6 padding-4">
        <div class="col-md-5 col-sm-6 no-padding">
            <h6 class="label_title_2 ">اختار البنك </h6>
        </div>
        <div class="col-md-7 col-sm-6 no-padding">
            <input type="text"  name="bank_id_fk"  class="form-control input_style_2 bank" 
            readonly="" data-validation-has-keyup-event="true">
        </div>
</div>
...
<div class="col-md-3 col-sm-6 no-padding">
    <input type="text" placeholder="كود الحساب" readonly="" name="sheek_num" id="sheek_num"
     class="form-control input_style_2 bank"  data-validation="required" data-validation-has-keyup-event="true" 
    value="">
</div>
<div class="col-md-3 col-sm-6" style="padding-left: 0">
    <input type="text" placeholder="إسم الحساب"  name="hesab_code" readonly="" id="hesab_code" 
    class="form-control input_style_2 bank" data-validation="required" data-validation-has-keyup-event="true" value="">
</div>
...
<!--
 <div class="col_md_30 col-sm-6 padding-4">
        ...
        <div class="col-md-7 col-sm-6 no-padding">
            <input type="text"  name="hesab_name"  class="form-control input_style_2 bank" 
            readonly="" data-validation-has-keyup-event="true">
        </div>
</div>
 ...
 <div class="col_md_25 col-sm-6 padding-4">
        ...
        <div class="col-md-7 col-sm-6 no-padding">
            <input type="text"  name="hesab_code"  class="form-control input_style_2 bank" 
            readonly="" data-validation-has-keyup-event="true">
        </div>
</div>
-->
 ...
 <div class="col_md_25 col-sm-6 padding-4">
        ...
        <div class="col-md-6 col-sm-6 no-padding">
            <input type="text"  name="sheek_num"  class="form-control input_style_2 bank" 
            readonly="" data-validation-has-keyup-event="true">
        </div>
</div>
                ...
                <div class="col-md-12 no-padding sandoq_hesab">
                    ...
                    <div class="col_md_70 col-sm-6 padding-4">
                        ...
                        <div class="col-md-4 col-sm-6 no-padding">
                            <input type="text" placeholder="كود الحساب" readonly="" name="box_rqm_hesab" id="rqm_hesab" class="form-control input_style_2" value="<?=($box != null)?$box['نقدي']->rqm_hesab:$box_rqm_hesab?>" data-validation="required" data-validation-has-keyup-event="true" 
                            value="">
                        </div>
                        <div class="col-md-6 col-sm-6" style="padding-left: 0">
                            <input type="text" placeholder="إسم الحساب"  name="box_name" readonly="" id="name_hesab" class="form-control input_style_2" value="<?=($box != null)?$box['نقدي']->name_hesab:$box_name?>" data-validation="required" data-validation-has-keyup-event="true" value="">
                        </div>
                    </div>
                        ...
                        <div class="col-xs-12 no-padding">
                            <div class="col-xs-6 no-padding">
                                <div class="col-xs-6 pad-2">
                                    ...
                                    <span class="border-box halalah">  <?=($total_value != '')?explode('.', $total_value)[1]:''?></span>
                                </div>
                                <div class="col-xs-6 pad-2">
                                    <h5>ريــــــــــــــــال  </h5>
                                    <span class="border-box rial"> <?=($total_value != '')?explode('.', $total_value)[0]:''?></span>
                                </div>
                            </div>
                            <div class="col-xs-6 text-center">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body ">
                <table class="table table-striped table-bordered"  style="table-layout: fixed">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="radio" disabled style="width: 18px; height: 18px;"  <?php if(!empty($value->pay_method) && $value->pay_method == 1){echo 'checked';} ?>  checked=""> <label class="no-margin no-padding"> نقدي</label><br>
                ...
                <table class="table table-striped table-bordered" style="table-layout: fixed;
                    ...
                    <tr>
                        <td><?=$value->total_value?></td>
                        <td colspan="3"><?=$value->total_value?></td>
                    </tr>
                    </tbody>
               </table>
            </div>
