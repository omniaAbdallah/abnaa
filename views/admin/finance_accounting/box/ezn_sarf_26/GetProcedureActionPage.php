					...
					<table class="table table-bordered bor" style="table-layout: fixed">
						...
						<tr>
							...
							<td colspan="3"> 
								...
								<input type="text" name="account" onclick="$('#Accounts').modal('show');"
                                 id="account" style="border: none; width: 100%" data-validation="required"
                                  data-validation-has-keyup-event="true" readonly="" value="<?=$eznInfo['band_code'].' '.$eznInfo['band_name']?>" 
                                    <?php $disabled1?>>	
							</div>
						...
						<tr>
							...
							<td colspan="3">
								<div class="col-md-12 col-sm-6  no-padding">
								<input type="text" name="notes" style="border: none; width: 100%" 
                                data-validation="required" data-validation-has-keyup-event="true"
                                 value="<?=$eznInfo['notes']?>" <?php $disabled1 ?>>
							</div>
							</td>
						</tr>
						<tr>
		...
		<tr>
			...
			<td colspan="3">
				<select class="form-control" name="to_id" data-validation="required"> <option value=""> إختر</option>
					<?php if(!empty($employees) /*&& $_SESSION['emp_code'] == $eznInfo['current_to_id']*/){
