...
<div class="col-sm-12 no-padding " >
   ...
   <div class="col_md_30 col-sm-6 padding-4">
                        ...
                        <div class="col-md-8 col-sm-6  no-padding">
                            ...
                            <input style="font-weight: 600 !important;" type="text" step="any" name="value" 
            ...
            <div class="panel-body">
                <div class="col-md-12 no-padding">
                 ...
                 <div class="col-xs-12 no-padding">
                     <p>سعادة مدير عام الجمعية  &nbsp;&nbsp;&nbsp;&nbsp; <span style="float: left"> سلمه الله </span></p>
                     <p class="text-center"> السلام عليكم ورحمه الله وبركاته ,,,</p>
                     <p>أرجو من سعادتكم التكرم بالتوجيه إلى من يلزم بصرف التالى : -</p>
                     <table class="table table-bordered table-devices" style="table-layout: fixed">
                         <tbody>
                         <tr>
                             <th style="width: 120px">مبلغ وقدره</th>
                             <td><span id="arabic_number_span"></span></td>
                         </tr>
                         <tr>
                             <th>إسم الجهة/المستفيد</th>
                             <td><span id="person_name_div"></span></td>
                         </tr>
                         <tr>
                             <th>عبارة عن</th>
                             <td><span id="about_div"></span></td>
                         </tr>
                         </tbody>
                     </table>
                 </div>
                        ...
                        <div class="col-xs-12 no-padding">
                            ...
                            <div class="col-md-4 col-xs-4">
                                <h6>مدير الإدارة:</h6>
                                <span style="color:darkred !important"> <?php echo $user_department['manager_name']; ?></span>
                            </div>
                            <div class="col-md-4 col-xs-4">
                                <h6>التاريخ :</h6>
                                <span style="color:darkred !important;" id="day_date_span"><?php echo date('Y-m-d'); ?> </span>
                            </div>
                    ...
                    if (isset($records) && $records != null) {
                        ...
                        foreach ($records as $value) {
                            ...
                            if($value->level ==1){
                                ...
                                $action ='finance_accounting/box/ezn_sarf/Ezn_sarf/Transformation_process';
...
<div class="modal fade" id="transferModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document" style="width:70%">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="display: inline-block;width: 100%">
  <button type="submit" name="transfer" value="accept" class="btn btn-labeled  btn-success" 
  style="display: inline-block; padding: 6px 12px;" >حفظ</button>
          <button type="submit" name="transfer" value="refuse" class="btn btn-labeled btn-danger" 
        style="display: inline-block; padding: 6px 12px;" >رفض</button>
                    ...
                    <button type="submit" name="procedure_title_action" name="refuse" class="btn btn-labeled btn-purple">
