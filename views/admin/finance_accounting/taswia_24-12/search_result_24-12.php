...
@page{
   ...
   .bond-qabd{
    ...
    <div class="bond-qabd">
        ...
        <div class="col-xs-12" >
            <h4 class="text-center" style="margin-top: 130px;">    مذكرة التسوية لحساب البنك في <?php if (isset($bank_date) && !empty($bank_date)){
            ...
            <table id="" class="table double-border  table-bordered table-striped table-hover">
                ...
                <tr >
                    ...
                    <td>
                      ...
                      //  $final_rased = number_format($value,2);
                        $final_rased = ($value);
                        ?>
                        <input type="text" class="form-control hidden-print" id="final_rased" value="<?= $final_rased ?>" onkeyup="get_total()">
                        <p class="visible-print" id="p-final_rased" style="display:none;"><?= $final_rased ?></p>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control hidden-print" value="0" id="add1" onkeyup="get_total()">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control hidden-print" value="0" id="add2" onkeyup="get_total()">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control hidden-print" value="0" id="sub1" onkeyup="get_total()">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control hidden-print" value="0" id="sub2" onkeyup="get_total()">
...
<script>
    function get_total() {
        ...
        var final_rased = $('#final_rased').val().replace(",","");
         final_rased = parseFloat(final_rased);
