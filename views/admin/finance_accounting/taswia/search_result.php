   ...
   <!-- <div class="pull-right hidden-print">
    ...
    <table id="" class="table double-border  table-bordered table-striped table-hover">
        ...
        <tr>
            ...
            <td>
                <?php
                 if (isset($sheek_sarf) && !empty($sheek_sarf)){
                     $solmat = $sheek_sarf ;
                 } else{
                     $solmat =0 ;
                 }
                ?>
                <input type="text" name="sheek_solmat" class="form-control hidden-print" value="<?= $solmat?>" id="sub2" onkeyup="get_total();">
                <p class="visible-print" id="p-sub2" style="display:none;"><?= $solmat?></p>
