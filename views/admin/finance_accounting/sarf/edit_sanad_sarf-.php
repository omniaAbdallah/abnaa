                ...
                <div class="col-xs-12 r-inner-details">
                    ...
                    <div class="col-xs-12 inner-side r-data " <?php if($all_vouchers[0]->vouch_type==2){ ?> style="display: block" <?php } else{?> style="display: none;" <?php } ?>>
                        ...
                        <div class="col-xs-6 r-input ">
                            <div class="docs-datepicker">
                                <div class="input-group">
                                    <input type="text" name="recive_date" id="recive_date" class="form-control date_melady" placeholder="شهر / يوم / سنة " />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <table id="colored-bgg" class="table table-bordered success">
                    ...
                    <?php    $all_value=0;  $i=1;for($x = 0 ; $x < count($all_vouchers) ; $x++){ ?>
                        <tr>
                            ...
                            <td>                          <a href="<?php echo  base_url('admin/Finance_accounting/delete_sand_sarf').'/'.$all_vouchers[$x]->id.'/'.$all_vouchers[$x]->vouch_num?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');" >
