                            ...
                            <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                               <!-- <div class="col-xs-12 ">
                                ...
                                <div class="col-xs-12 ">
                                    ...
                                    <div class="col-xs-6 r-input ">
                                    <input type="text" class="form-control docs-date" name="session_date"
                                     value="<? echo $select_all[0]->session_date_ar;?>" placeholder="شهر / يوم / سنة " data-validation="required" >
                                    </div>
                                </div>
                                <div class="col-xs-12">
                                    <div class="col-xs-3">
                        ...
                        <div class="col-xs-12">
                            <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                               <!-- <div class="col-xs-12 ">
                                    ...
                                    <div class="col-xs-6 r-input ">
                                    <input type="text" class="form-control docs-date" name="session_date" placeholder="شهر / يوم / سنة " data-validation="required" >
                                    </div>
                                </div>
                                <div class="col-xs-12">
                                    <div class="col-xs-3">
...
<td> <a href="<?php echo base_url('Directors/Directors/edit_time_table').'/'.$record->id.'/'.$record->council_id_fk ?>"> 
<i class="fa fa-pencil " aria-hidden="true"></i> </a> 
