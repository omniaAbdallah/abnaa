                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            if(isset($record) && !empty($record) && $record!=null){
                                                echo form_open_multipart('Directors/General_assembly_settings/UpdateSitting/'.$id.'/'. $key);
                                            }
                                            else{
                                                echo form_open_multipart('Directors/General_assembly_settings/AddSitting/'. $key);
                                            }
                                            ?>
                                                    ...
                                                    if (isset($all[$key]) && !empty($all[$key]) && $all[$key] !=null){
                                                        foreach ($all[$key] as $value) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="<?php echo base_url().'Directors/General_assembly_settings/UpdateSitting/'.$value->id_setting."/".$key  ?>" title="تعديل">
                                                                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
                                                                    <span> </span>
                                                                    <a href="<?=base_url()."Directors/General_assembly_settings/DeleteSitting/".$value->id_setting."/".$key?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    if(isset($area) && !empty($area) && $area!=null){
                                        echo form_open_multipart('Directors/General_assembly_settings/UpdateSittingAreas/'.$area['id'].'/tab_areas');
                                    }
                                    else{
                                        echo form_open_multipart('Directors/General_assembly_settings/AddSittingAreas/'.'tab_areas/'. 0);
                                    }
                                    ?>
                                        ...
                                        <table class="table table-bordered table-striped table-hover">
                                            ...
                                            foreach ($areas as $key=>$value) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?=$value?></td>
                                                    <td>
                                                        <a href="<?php echo base_url().'Directors/General_assembly_settings/UpdateSittingAreas/'.$key.'/tab_areas' ?>" title="تعديل">
                                                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
                                                        <span> </span>
                                                        <a href="<?=base_url()."Directors/General_assembly_settings/DeleteSittingAreas/tab_areas/".$key?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
                                                            <i class="fa fa-trash" aria-hidden="true"></i></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                        ...
                        <div class="tab-pane fade in <?php if(isset($typee) && !empty($typee)&& $typee === "tab_residential") {echo  'active'; }  ?>" id="tab_residential">
                            <div class="panel-body">
                                ...
                                <div class="table-responsive">
                                    <?php
                                    if(isset($area) && !empty($area) && $area!=null){
                                        echo form_open_multipart('Directors/General_assembly_settings/UpdateSittingAreas/'.$area['id'].'/'. $typee);
                                    }
                                    else{
                                        echo form_open_multipart('Directors/General_assembly_settings/AddSittingAreas/'.'tab_residential/'. 0);
                                    }
                                    ?>
                                    <div class="form-group col-sm-4 col-xs-12">
                                        ...
                                        <table class="table table-bordered table-striped table-hover">
                                            ...
                                            foreach ($residentials as $value) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?=$value->name?></td>
                                                    <td>  <a href="<?php echo base_url().'Directors/General_assembly_settings/UpdateSittingAreas/'.$value->id."/tab_residential"  ?>" title="تعديل" >
                                                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
                                                        <a href="<?=base_url()."Directors/General_assembly_settings/DeleteSittingAreas/tab_residential/".$value->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
                                                            <i class="fa fa-trash" aria-hidden="true"></i></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
