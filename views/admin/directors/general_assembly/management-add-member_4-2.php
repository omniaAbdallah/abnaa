...
<!--                            </div>-->
                            ...
                            <div class="form-group col-sm-4 col-xs-12">
                                ...
                                <input class="textbox2 form-control bottom-input "  value="0" type="text" name="age" id="myage" size="60"  readonly/>
...
<!--                    </div>-->
                    ...
                    <div class="form-group col-sm-4 col-xs-12">
                        <label class="label top-label">العمر<strong class="astric">*</strong><strong></strong> </label>
                        <input class="form-control bottom-input selectpicker " value="0" type="text" name="age" id="myage" size="60" id="wd" readonly  />
                        <input class="textbox2 form-control half hidden" type="number" name="wd" size="60" id="wd" readonly />
                ...
                <div class="col-sm-12 col-xs-12" >
                    ...
                    <div class="form-group col-sm-4 col-xs-12" >
                        <label class="label top-label"> تاريخ الانتهاء<strong></strong> </label>
                        <input type="text" readonly id="expired_date" class="form-control bottom-input " value="" name="expired_date" placeholder=" تاريخ الانتهاء" data-validation="required" >
                    </div>
                </div>
