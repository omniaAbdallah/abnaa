...
if(isset($result)&&!empty($result))
{
    ...
    $out['form']='Directors/General_assembly/update_member_maindata/'.$this->uri->segment(4);$card_img = $result->card_img;
            ...
            <div class="panel-body">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group col-md-2 col-sm-6 padding-4">
                        ...
                        <select id="nationality_id_fk"  class="form-control bottom-input"
                    ...
                    <div class="form-group col-md-3 col-sm-6 padding-4">
                        ...
                        <select name="surname" class="form-control bottom-input" id="surname" >
                ...
                <div class="col-md-12">
                 <div class="form-group col-md-2 col-sm-6 padding-4">
                        ...
                        <select name="social_status_id_fk" class="form-control bottom-input" id="social_status_id_fk" >
                            <option value="">اختر</option>
                            <?php
                    ...
                    <div class="form-group col-md-2 col-sm-6 padding-4">
                        ...
                        <select id="esdar_card_fk" name="esdar_card_fk"  class="form-control bottom-input" >
                            <option value="">إختر</option>
                            <?php
                    ...
                    <div class="form-group col-md-3 col-sm-6 padding-4">
                        ...
                        <div id="cal-2" style="width: 50%;float: right;">
                            <input id="date-Hijri" name="esdar_date_h" class="form-control bottom-input "
                        ...
                        <div id="cal-1" style="width: 50%;float: left;">
                            <input id="date-Miladi" name="esdar_date" class="form-control bottom-input  "
                                   value="<?php  if(!empty($result->esdar_date)){ echo $result->esdar_date; }?>"
                    ...
                    <div class="form-group col-md-3 col-sm-6 padding-4">
                        ...
                        <div id="cal-end-2"  style="width: 50%;float: right;">
                            <input id="date-Hijri-end"  name="birth_date_h" class="form-control bottom-input " type="text"
                        ...
                        <div id="cal-end-1" style="width: 50%;float: left;">
                            <input id="date-Miladi-end"  name="birth_date"  value="<?php  if(!empty($result->birth_date)){ echo $result->birth_date; }?>" class="form-control bottom-input birth_date"
                    ...
                    <div class="form-group col-md-2 col-sm-6 padding-4">
                     ...
                     <div class="form-group col-md-2 col-sm-6 padding-4">
                        <label class="label top-label" title="برجاء الضغط مرتين لتعديل الحي">المدينة</label>
                        <select id="city_id_fk" name="city_id_fk"  onchange="getAhai($(this).val());" ondblclick="getAhai($(this).val());"  class="form-control bottom-input" >
                            <option value="">إختر</option>
                            <?php
                    ...
                    <div class="form-group col-md-2 col-sm-6 padding-4 ">
                        ...
                        <select id="hai_id_fk" name="hai_id_fk"   class="form-control bottom-input nonactive">
                            <option value="">إختر</option>
                  ...
                  <!--  <div class="form-group col-md-2 col-sm-6 padding-4">
                    ...
                    <div class="form-group col-md-3 col-sm-6 padding-4">
                        ...
                        <input type="text" name="street_name"    value="<?php echo $street_name;?>" class="form-control bottom-input" data-validation-has-keyup-event="true">
                    </div>
                    <div class="form-group col-md-3 col-sm-6 padding-4">
                        ...
                        <input type="text" name="national_address" id="national_address"  onkeypress="validate_number(event);"
                                value=" <?php echo $national_address;?>" class="form-control bottom-input">
                    </div>
                    <div class="form-group col-md-3 col-sm-6 padding-4">
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      <?php  }elseif ($record->suspend == 0) {
                                            $class = "danger";?>
                                            <a href="<?php echo base_url(); ?>Directors/General_assembly/ChangeType/<?php  echo $record->id;?>/<?php  echo $record->suspend;?>">
                                      <?php  } ?>
                                    ...
                                    <?php } ?>
                                        ...
                                        <a onclick="$('#adele').attr('href', '<?= base_url() . "Directors/General_assembly/delete_member_maindata/" . $record->id ?>');"
                                           data-toggle="modal" data-target="#modal-delete"
                                           title="حذف"> <i class="fa fa-trash"
                                                           aria-hidden="true"></i> </a>


                                        <a href = "<?php echo base_url('Directors/General_assembly/print_member_details').'/'.$record->id ?>" target = "_blank" >
                                            <i class="fa fa-print" aria-hidden = "true" ></i > </a>

                                        <a  href = "<?php echo base_url('Directors/General_assembly/print_card').'/'.$record->id ?>" target = "_blank" >
