...
<div class="col-xs-12">
            ...
            <div class="details-resorce">
                <div class="col-xs-12 r-inner-details">
                    <?php  echo form_open_multipart('Directors/Directors/add_member')?>
                    <div class="col-xs-12">
                        ...
                        <div class="col-md-4  col-sm-12 col-xs-12 inner-side r-data">
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-6 r-input">
                                    <input type="number" id="mobile" name="mobile" class="form-control" data-validation="required">
                        ...
                        <div class="col-md-4  col-sm-12 col-xs-12 inner-side r-data">
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-6 r-input">
                                    <input type="text" id="address" name="address" class="form-control" data-validation="required" >
                    ...
                    <div class="col-xs-12 ">
                        ...
                        <div class="col-md-4  col-sm-12 col-xs-12 inner-side r-data">
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-6 r-input">
                                    <input type="email" name="email" id="email" class="form-control" data-validation="required" >
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4  col-sm-12 col-xs-12 inner-side r-data">
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-6 r-input">
                                <input type="text" class="form-control date_melady" name="date_of_hiring" placeholder="شهر / يوم / سنة " data-validation="required"  >
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer" style="width: 70%;margin-right: 160px">
                      ...
                      <?php  $serial = 0;
                        ...
                        <tr>
                            ...
                            <td> <a href="<?php echo base_url('Directors/Directors/delete_member').'/'.$record->id ?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');"> <i class="fa fa-trash" aria-hidden="true"></i> </a> <span></td>
                        ...
                        <div class="modal fade" id="myModal<?php echo $record->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="col-sm-3" style="font-size: 16px;">إسم العضو</div>
                                        ...
                                        <br /><br />
                                        <div class="col-sm-3" style="font-size: 16px;">تاريخ التعيين</div>
                                        <div class="col-sm-9"  style="font-size: 16px;">
                                            <?php echo$record->date_of_hiring;?>
                                        </div>
                                        <br />
