...
<div class="details-resorce col-xs-11 r-inner-details" >
    ...
    <?php echo form_open_multipart('BeneficiaryAffairs/update_nationality_settings/'.$result['id'])?>
    ...
    <?php echo form_close()?>
    <?php else: ?>
    <?php echo form_open_multipart('BeneficiaryAffairs/nationality_settings')?>
...
<?php if(isset($records)&&$records!=null):?>
    <div class="col-xs-12">
        ...
        <tr>
            <th width="2%">#</th>
            <th  class="text-center">عنوان الجنسية</th>
        ...
        <?php foreach($records as $record):?>
            <tr>
                ...
                <td data-title="التحكم" class="text-center">
                    <a href="<?php echo base_url().'BeneficiaryAffairs/update_nationality_settings/'.$record->id?>">
                        <i class="fa fa-pencil " aria-hidden="true"></i></a>
                    <a href="<?php echo base_url().'BeneficiaryAffairs/delete_nationality_settings/'.$record->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
