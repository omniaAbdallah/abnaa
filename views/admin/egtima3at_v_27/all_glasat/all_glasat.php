            ...
            if ((isset($one_data['asnaf'])) && (!empty($one_data['asnaf'])) && ($one_data['asnaf'] != 0)) {
                ...
                <tr id="row_1">
                    ...
                    class=" form-control "
                                    ...
                                    <option value="2"  > أمين سر الجلسة</option>
...
///
        ...
        var row = ' <tr id="row_1" >\n' +
            ...
            '                        <td>' + (len + 1) + '</td>\n' +
            '                        <td> <input type="text"  data-validation="required" class="form-control testButton " name="code[]" id="code' + (len + 1) + '" value=""  ondblclick=" GetDiv_sanfe(\'myDiv_sanfe\',' + (len + 1) + ')" readonly/></td>\n' +
            //'                        <td> <input type="text" class="form-control testButton " name="sanf_coade_br[]" id="sanf_coade_br' + (len + 1) + '" value="" readonly/></td>\n' +
            '                        <td> <input type="text"  data-validation="required" class="form-control testButton " name="emp_n[]" id="emp_n' + (len + 1) + '" value="" readonly/></td>\n' +
            ...
            '                        <td><select  name="wazifa_in_galsa[]" id="wazifa_in_galsa' + (len + 1) + '" data-validation="required" class=" form-control "data-show-subtext="true" data-live-search="true" aria-required="true"><option value="">اختر</option><option value="1" >رئيس الجلسة</option><option value="2"  > أمين سر الجلسة</option><option value="3"> عضو بالجلسة</option></select></td>\n' +'\n' +
...
console.log(n);
       ...
       {
        $('#wazifa_in_galsa'+(m)).find('option').remove().end().append('<option selected value="2"> امين سر الجلسة</option><option  value="3">عضو بالجلسة</option>') ;
       }
       if(wazifa_in_galsa.includes("2"))
       {
       ...
       if(wazifa_in_galsa.includes("1") && wazifa_in_galsa.includes("2") )
       {
