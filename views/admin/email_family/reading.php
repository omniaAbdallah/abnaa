...
echo form_open_multipart('Emails_family/inbox',array('class'=>"myform"));
...
?>
                            <div class="col-xs-10 r-message-detail">
                                ...
                                <div class="col-xs-12 r-message-titel">
                                    <?php if(isset($users[$result['email_from']]->user_name)) {?>
                                    ...
                                    <?php }else{ ?>
                                    <div class="col-md-10 col-sm-9 col-xs-7">
                                        <h3><b>من: <?php echo $family[$result['email_from']]->m_first_name.' '.$family[$result['email_from']]->m_family_name ?></b></h3>
                                    </div>
                                    <?php } ?>
                                </div>
                                <div class="col-xs-12">
                                ...
                                if($result['file_attached'] == 1){
                                    ...
                                    foreach($files as $file){
                                        echo '<div class="col-md-2 col-sm-3 col-xs-4">
                                                    ...
                                                    <a href="'.base_url().'Emails_family/downloads/'.$file->file_name.'/'.$result['id'].'">تحميل</a>
                                                </div>';
                                    }
                                     echo '</div>';    
                                } 
                                ?>
                                    ...
                                    <div class="col-xs-12 r-message-textarea">
                                        <p class="p-text-area">
                                            اضغط هنا للرد
                                            <a href="<?php echo base_url().'Emails_family/inbox/reply/'.$result['id'].'' ?>">الرد</a> او
                                            <a href="<?php echo base_url().'Emails_family/inbox/forward/'.$result['id'].'' ?>">إعاده توجية</a>
                                        </p>
                                    </div>
