                    ...
                    <div class="col-xs-12">
                        <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-6 ">
                                    <form class="r-block">
                                        <input type="radio" class="radio2" name="gender"> دواء
                                        <input type="radio" class="radio2 name="gender"> جهاز
                                    </form>
                                </div>
                            </div>
                            <div class="col-xs-12 ">
                                ...
                                <div class="col-xs-6 r-input">
                                    <input type="text" class="r-inner-h4 " name="medicine_device_name">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-6 r-input">
                                    <select name="medicine_device_family_id_fk">
                                        <option> - اختر - </option>
