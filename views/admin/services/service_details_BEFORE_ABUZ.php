   ...
   <!-- <div class="col-xs-12 r-side-table">
    ...
    <div class="col-xs-12 r-bottom">
        <div class="panel-heading">
            <ul class="nav nav-tabs">
                <li ><a href="<?php echo  base_url()."Family"?>"> الاسرة الجديده </a></li>
                <li><a href="<?php echo  base_url()."Family/approved_family"?>">الاسرة المعتمده </a></li>
                <li><a href="<?php echo  base_url()."Family/services_archive"?>">ارشيف الاسر </a></li>
                ...
                <li><a href="<?php echo  base_url()."Family/services_archive"?>">  ارشيف خدمات </a></li>
            </ul>
        </div>
    </div> -->
    <!--  -->
    <div class="details-resorce">
            ...
            <div class="col-xs-12">
                <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-6 r-input">
                            <input type="text" class="r-inner-h4 " value="<?php if(!empty($get_service_name[$sevice_details['service_id_fk']])):
                ...
                <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-6 r-input">
                            ...
                            <?php if($get_service_name[$sevice_details['service_id_fk']][0]->sub_service_name == ''){
                                    $out=$get_service_name[$sevice_details['service_id_fk']][0]->main_service_name;
                                }else{
                                    $out=$get_service_name[$sevice_details['service_id_fk']][0]->sub_service_name;
                                } ?>
                                <input type="text" class="r-inner-h4 " value="<?php echo $out?>" readonly>
        ...
        <div class="col-xs-12 r-inner-details">
                        ...
                        <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-6 ">
                                  ...
                                  <?php  $reatment_card_service =array('','تألف','مفقود','تجديد','تغيير الرقم السري','إصدار');
                ...
                <?php }elseif ($sevice_details['service_id_fk'] == 5){?>
                    <!--not complete   -->

                <?php }elseif ($sevice_details['service_id_fk'] == 6){?>
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-6 ">
                                    <form class="r-block">
                                         <?php if($sevice_details['course_employment_id_fk'] ==1){?>
                                        ...
                                        <?php }elseif($sevice_details['course_employment_id_fk'] ==2){?>
        ...
        <!------------------- endsection2------------------------>
                        ...
                        <div id="modal">
                                        <span class="text-center">  إعتماد الملف
                                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                             <a href="#close" id="close" data-dismiss="modal">&#215;</a></span>
                            <div class="r-form-add">
                               <input type="hidden" name="service_file_to" value="<?php echo $_SESSION['role_id_fk']?>" /> 
                                <div class="row form-group">
                           ...
                           <div class="col-xs-3"></div>
                            <div class="col-xs-6">
                                <input class="btn  center-block" name="operation_service" type="submit" value=" إعتماد" />
                            </div>
                        </div>
                    </div>
                    <?php echo form_close()?>
            ...
            <div>
                <?php if(isset($all_operations) && $all_operations !=null):?>
                    <table id="" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                        ...
                        <?php
                        $x=0;
                        foreach ($all_operations as $records):
                            $x++;
