    ...
    <div class="col-xs-12 r-bottom">
        <div class="panel-heading">
            <ul class="nav nav-tabs">
                ...
                <li ><a href="<?php echo base_url()?>family/family_services" /> خدمات الاسر </a></li>
                <li class="active"><a href="<?php echo  base_url()."Family/certified_services"?>"> خدمات معتمده </a></li>
