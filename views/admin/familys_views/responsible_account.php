...
<div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
    ...
    <div class="panel-body">
        <?php if (empty($records)) { ?>
           ...
           <?php echo form_open_multipart('family_controllers/Family/add_responsible_account/' . $this->uri->segment(4) . '/' . $from_page); ?>
            ...
            <div class="col-md-12">
                <div class="form-group col-sm-4 col-xs-12">
                    ...
                    <select name="person_id_fk" id="person_id_fk" data-validation="required" aria-required="true"
                            onchange="get_responsible($(this).val());put_name(this,'person_name');" class="form-control half">
                        <option value=""> اختر</option>
                        <?php if (isset($name) && !empty($name)) { ?>
                            <option value="<?php echo $name->id . '-1'; ?>" style="color: red;">
                                <?php echo $name->full_name . '(الام)'; ?></option>
                        <?php } ?>
                        <?php
                        if (isset($f_members) && !empty($f_members)) {
                            ...
                            foreach ($f_members as $row) {
                                ...
                                <option  value="<?php echo $row->id . '-2'; ?>">
                                    <?php echo $row->member_full_name . $gender_type ?></option>
                            <?php }
                        }
                        ?>
...
border-radius: 7px;"> 10 ارقام فقط</span> رقم الجوال</label>
                ...
                <div class="form-group col-sm-4 col-xs-12 ">
                    <label class="label label-green  half">إسم البنك<strong></strong>
                    </label>
            ...
            <div class="col-md-12 ">
                ...
                <div class="col-md-4">
                    <label class="label label-green  half">صوره الحساب </label>
                        ...
                        <tr>
                            ...
                            <td>
                                <button data-toggle="modal"
                                        data-target="#modal-attach-<?=$row->id?>"
                                        class="btn btn-sm btn-primary">المرفق
                                </button>
                    ...
                    if (!empty($row->responsible_operations)) {
                        foreach ($row->responsible_operations as $record) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <button data-toggle="modal"
                                            data-target="#modal-attach-sub-<?=$record->id?>"
                                            class="btn btn-sm btn-primary">المرفق
                                    </button>
                                    <a href="<?php echo base_url('family_controllers/Family/print_eqrar') . '/' . $record->operation_id ?>"
                                        target="_blank">
            ...
            <div class="modal-dialog" role="document" style="width: 90%">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">تغيير بيانات مسؤول الحساب</h4>
                    </div>
                    ...
                    <div class="col-md-4 col-md-offset-4  btn btn-success  " style="margin-bottom: 15px;font-size: 18px;">
                            بيانات مسئول الحساب البنكي الحالى
                        </div>
                        ...
                        <div class="col-md-12 no-padding">
                            <div class="form-group col-sm-4 col-xs-12">
                                ...
                                <select name="past_bank_id_fk" id="past_bank_id_fk"
                                        ...
                                        onchange="get_responsible_name_past($(this).val());put_name(this,'past_bank_name');"
                                    ...
                                    <?php if (isset($f_members) && !empty($f_members)) {
                                        foreach ($f_members as $row2) { ?>
                                            <option value="<?php echo $row2->id . '-2'; ?>" <?php if ($row2->id == $row->person_id_fk && $row->type == 2) { ?> selected="" <?php } ?> >
                                                <?php $mem_type = "";
...
شخص اخر                                            </option>
                            ...
                            <div class="form-group col-sm-4 col-xs-12 ">
                                <label class="label label-green  half quart-label">الصلة </label>
                        ...
                        <div class="col-md-12 no-padding">
                            <div class="form-group col-sm-4 col-xs-12">
                                <label class="label label-green  half quart-label">  رقم الهويه <small style="color: red;;">10 ارقام فقط</small></label>
                            ...
                            <div class="form-group col-sm-4 col-xs-12">
                                <label class="label label-green  half quart-label">  رقم الجوال <small style="color: red;;">10 ارقام فقط</small></label>
                            ...
                            <div class="form-group col-sm-4 col-xs-12 ">
                                <label class="label label-green  half quart-label">إسم البنك</label>
                        ...
                        <div class="col-md-12 no-padding">
                            <div class="form-group col-sm-4 col-xs-12 ">
                                <label class="label label-green  half quart-label">رمز البنك </label>
                            ...
                            <div class="form-group col-sm-4 col-xs-12">
                                <label class="label label-green  half quart-label">رقم الحساب <small style="color: red;;">رقم الحساب لابد أن يكون 24 رقم</small> </label>
                        ...
                        <div class="col-md-3 padding-4">
                             <?php if (!empty($row->bank_image)) {
                                ...
                                <label class="label label-green  half quart-label">صوره الحساب
                                </label>
                                <?php if (!empty($row->bank_image)) { ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group col-sm-4 col-xs-12">
                                ...
                                <select name="current_bank_id_fk" id="current_bank_id_fk<?php echo $row->id; ?>"
                                        ...
                                        onchange="get_responsible_name_current($(this).val());put_name(this,'current_bank_name');"
                                        class="form-control half quart-input">
                                    <option value="">إختر</option>
                                    <?php if (isset($name) && !empty($name)) {
                                        ?>
                            ...
                            <div class="form-group col-sm-4 col-xs-12">
                                <label class="label label-green  half quart-label">اسم المسئول</label>
                                <input type="text" name="current_bank_name" id="current_bank_name" disabled="" value=""  class="form-control half input-style quart-input"/>
                            </div>
                            <div class="form-group col-sm-4 col-xs-12 ">
                        ...
                        <div class="col-md-12">
                            ...
                            if (isset($records) && !empty($records)) {
                                ...
                                <table id="" class=" display table table-bordered   responsive nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                    <?php  $x = 1; if (isset($records) && !empty($records)) {
                                        foreach ($records as $row) { ?>
                                            <?php if (!empty($row->responsible_operations)) {
                                                foreach ($row->responsible_operations as $record) {
                                                    ?>
                                                    <tr>
                                                        <td><input type="radio" name="person"
                                                                   onclick="get_responsible_name_current($(this).val());put_data(this,'current_bank_name');"
                                                                   td-data-value="<?php echo $record->person; ?>" select-data-id="<?php echo $row->id; ?>"
                                                                   value="<?=$record->current_bank_id_fk."-".$record->current_type?>" /></td>
                                                        <td><?php echo $x++; ?></td>
                                                        <td><?php echo $record->person; ?></td>
                                                        <td><?php echo $record->relashtion_title; ?></td>
                                                        <td><?php echo $record->bank_name; ?></td>
                                                        <td><?php echo $record->past_bank_code; ?> </td>
                                                    </tr>
                                                    <?php
                    ...
                    <button type="submit"  id="save" class="btn btn-labeled btn-success " name="save" value="حفظ" style="float: right;">
                                    <span class="btn-label"><i class="glyphicon glyphicon-floppy-disk"></i></span>حفظ
                            </button>
                            <button type="button"  class="btn btn-labeled btn-danger " name="" value="إغلاق"  data-dismiss="modal">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body ">
                        <div class="col-md-9 no-padding">
                            <div class="col-md-12 no-padding">
                                <div class="form-group col-sm-4 col-xs-12">
                                    <label class="label label-green  half quart-label" >مسئول الحساب  </label>
                                    <select name="edit_person_id_fk" id="person_id_fk<?php echo $row->id; ?>"
                                            data-validation="required" aria-required="true"
                                            onchange="get_responsible_modal($(this).val(),<?php echo $row->id; ?>);put_name(this,'person_name<?php echo $row->id; ?>')"
                                            class="form-control half quart-input">
                                        <?php if (isset($name) && !empty($name)) { ?>
                                            <option
                    ...
                    <div class="modal-footer" style="display: inline-block; width: 100%;">
                      <!--  <input type="submit" id="buttons<?php echo $row->id; ?>" name="edit"
                       ...
                       <button type="submit"  id="buttons<?php echo $row->id; ?>" class="btn btn-labeled btn-success " name="edit" value="حفظ" style="float: right;">
                            <span class="btn-label"><i class="glyphicon glyphicon-floppy-disk"></i></span>حفظ
                        </button>
                        
                        <button type="button" class="btn btn-labeled btn-danger " data-dismiss="modal" value="إغلاق" >
                            <span class="btn-label"><i class="glyphicon glyphicon-remove"></i></span>إغلاق
                        </button>
        ...
        <?php echo form_close(); ?>
       <!-------------------------------------------------------------------------------------->
        <div id="modal-attach-<?=$row->id?>" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php echo form_open_multipart('family_controllers/Family/UpdateResponsibleAccount/' . $this->uri->segment(4) . ''); ?>
                        <div class="form-group  col-sm-12">
                            <div class="col-sm-8">
                                <label class="label label-green  half" style="width: 25%!important;">المرفق </label>
                                <input type="file" name="attachment" data-validation="required"  class="form-control half input-style"  style="width: 75%!important;">
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group  col-sm-12">
                         <img  src="<?=base_url()."uploads/images/".$row->attachment?>" width="300" height="300"/>
                        </div>
                        <?php }?>
                    </div>
                    <?php echo form_close(); ?>
                    <div class="modal-footer" style="display: inline-block; width: 100%;">
                        <button type="submit"  id="buttons" class="btn btn-labeled btn-success " name="ADD" value="حفظ" style="float: right;">
                                    <span class="btn-label"><i class="glyphicon glyphicon-floppy-disk"></i></span>حفظ
                            </button>
                            <button type="button"  id="buttons" class="btn btn-labeled btn-danger " name="ADD" value="إغلاق" data-dismiss="modal">
                                    <span class="btn-label"><i class="glyphicon glyphicon-remove"></i></span>إغلاق
                            </button>
                    </div>
                </div>
        ...
        <?php   if (!empty($row->responsible_operations)) {
            foreach ($row->responsible_operations as $record) { ?>
                <div id="modal-attach-sub-<?=$record->id?>" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        <!-- Modal content-->
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <?php echo form_open_multipart('family_controllers/Family/UpdateResponsibleAccountOperations/'.$record->bank_responsible_operations_id."/".$this->uri->segment(4)); ?>
                                <div class="form-group  col-sm-12">
                                    <div class="col-sm-8">
                                        <label class="label label-green  half" style="width: 25%!important;">المرفق </label>
                                        <input type="file" name="attachment_operation" data-validation="required"  class="form-control half input-style"  style="width: 75%!important;">
                                    </div>
                                    <div class="col-sm-4">
                                ...
                                <?php if(!empty($record->attachment)){?>
                                    <div class="form-group  col-sm-12">
                                        <img  src="<?=base_url()."uploads/images/".$record->attachment?>" width="300" height="300"/>
                                    </div>
                                <?php }?>
                            </div>
                            <?php echo form_close(); ?>
            ...
            $.ajax({
                ...
                success: function (d) {
                    ...
                    if (type_person == 1) {
                        ...
                        $('#mob').val(obj.m_mob);
                        $('#card_num').val(obj.mother_national_card_new);
...
<script>
    function put_name(this_value,id_input) {
         var person_name =$('option:selected',this_value).text();
         var clear_name =person_name.trim();
         var res = clear_name.split("(");
         $("#"+id_input).val(res[0]);
         $("#"+id_input).removeAttr("disabled");
    }
</script>
<script>
     function put_data(value_this , id_input) {
        var pass_name = $(value_this).attr("td-data-value");
        var pass_id_select = $(value_this).attr("select-data-id");
        var select_value = $(value_this).val();
         $("#"+id_input).val(pass_name);
         $("#"+id_input).removeAttr("disabled");
         $("#current_bank_id_fk"+pass_id_select).val(select_value);
     }
</script>