                        ...
                        <div class="col-xs-12 no-padding">
                            <table class="table table-bordered table-devices" style="table-layout: fixed">
                                ...
                                <tr>
                                    ...
                                    <td><?php if (!empty($national_num_type[$tables['father']->f_national_id_type])) {
                                            echo $national_num_type[$tables['father']->f_national_id_type];
                                        } ?></td>
                                </tr>
                                <tr>
                                    <th> مصدر الهوية</th>
                                ...
                                <tr>
                                    ...
                                    <!--                                osama-->
                                    <th>عدد الذكور</th>
                                    <td><?php if ($tables['father']->f_female_num) {
                                            echo $tables['father']->f_female_num;
                                        } ?></td>
                                    <th>عدد الإناث</th>
                                    <td><?php if ($tables['father']->f_child_num) {
                                            echo $tables['father']->f_child_num;
                                        } ?></td>
                                </tr>
                                <tr>
                                    <th>الجنسية</th>
                                    <td><?php if (!empty($nationality[$tables['father']->f_nationality_id_fk])) {
                                            echo $nationality[$tables['father']->f_nationality_id_fk];
                                        } ?></td>
                                    ...
                                    <td>
                                        <?php
                                        if (!empty($job_titles[$tables['father']->f_job])) {
                                            echo $job_titles[$tables['father']->f_job];
                                        } ?>
                            ...
                            <table class="table table-bordered table-devices" style="table-layout: fixed">
                                ...
                                <tr>
                                    ...
                                    <td><?php if ($tables['mother']->m_birth_date_year > 0) {
                                            echo date('Y') - $tables['mother']->m_birth_date_year;
                                        } else {
                                            echo 0;
                                        } ?></td>
                                    <th>صلة القرابة</th>
                                ...
                                <tr>
                                    ...
                                    <td><?php if (!empty($marital_status_array[$tables['mother']->m_marital_status_id_fk])):
                                            echo $marital_status_array[$tables['mother']->m_marital_status_id_fk];
                                        endif; ?></td>

                                    </td>
                                    <th>الجنسية</th>
                                    <td><?php if (!empty($nationality[$tables['mother']->m_nationality])) {
                                            echo $nationality[$tables['mother']->m_nationality];
                                        } ?></td>
                                    <th> جنسيه اخري</th>
                                ...
                                <tr>
                                    ...
                                    <td><?php if (!empty($living_place_array[$tables['mother']->m_living_place_id_fk])) {
                                            echo $living_place_array[$tables['mother']->m_living_place_id_fk];
                                        } ?>
                                    </td>
                                    <th> محل سكن</th>
                                    <td><?php echo $tables['mother']->m_living_place; ?> </td>
                                    <th>نوع الهوية</th>
                                    <td><?php if (!empty($national_num_type[$tables['mother']->m_national_id_type])) {
                                            echo $national_num_type[$tables['mother']->m_national_id_type];
                                        } ?></td>
                                </tr>
                                <tr>
                                    <th>الحالة الصحية</th>
                                    <td>
                                        ...
                                        foreach ($health_status_array as $row3):
                                            if ($row3->title_setting == $tables['mother']->m_health_status_id_fk) {
                                ...
                                <tr>
                                    ...
                                    <td><?php
                                        ...
                                        if (!empty($arr_work[$tables['mother']->m_want_work])) {
                                            echo $arr_work[$tables['mother']->m_want_work];
                                        } ?></td>
                                    <th> طبيعة الفرد</th>
                                    <td><?php if (!empty($person_type[$tables['mother']->person_type])) {
                                            echo $person_type[$tables['mother']->person_type];
                                        } ?></td>
                                    <th>المهنة</th>
                                    <td><?php
                                        if (!empty($job_titles[$tables['mother']->m_job_id_fk])) {
                                            echo $job_titles[$tables['mother']->m_job_id_fk];
                                        } ?>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        foreach ($arr_ed_state as $row5) {
                                            if ($row5->id_setting == $tables['mother']->m_education_status_id_fk) {
                                                echo $row5->title_setting;
                                            }
                                        } ?>

                                    </td>
                                    <th>ملتحقة بدار نسائية</th>
                                    <td><?php if (!empty($arr_yes_no[$tables['mother']->m_female_house_check])) {
                                            echo $arr_yes_no[$tables['mother']->m_female_house_check];
                                        } ?></td>
                                    <th>إسم الدار</th>
                                ...
                                <tr>
                                    ...
                                    <td><?php if (!empty($arr_yes_no[$tables['mother']->m_hijri])) {
                                            echo $arr_yes_no[$tables['mother']->m_hijri];
                                        } ?></td>
                                    <th>أداء فريضة العمرة</th>
                                    <td><?php if (!empty($arr_yes_no[$tables['mother']->m_ommra])) {
                                            echo $arr_yes_no[$tables['mother']->m_ommra];
                                        } ?></td>
                                    <th>رقم الجوال</th>
                                ...
                                <tr>
                                    <th> مكفول</th>
                                    <td><?php if (!empty($arr_yes_no[$tables['mother']->guaranteed_m])) {
                                            echo $arr_yes_no[$tables['mother']->guaranteed_m];
                                        } ?></td>
                                    <th>هاتف العمل</th>
                                    <td><?php if (!empty($tables['mother']->m_place_mob)) {
                                            echo $tables['mother']->m_place_mob;
                                        } ?> </td>
                                    <th> طبيعة الفرد</th>
                                    <td><?php if (!empty($person_type[$tables['mother']->person_type])) {
                                            echo $person_type[$tables['mother']->person_type];
                                ...
                                <tr>
                                    ...
                                    <td><?php if (!empty($categories[$tables['mother']->categoriey_m])) {
                                            echo $categories[$tables['mother']->categoriey_m];
                                        } ?> </td>
                                    <th> حاله المستفيد</th>
                                    <td><?php if (!empty($member_status[$tables['mother']->halt_elmostafid_m])) {
                                            echo $member_status[$tables['mother']->halt_elmostafid_m];
                                        } ?></td>
                                    <th>الجنس</th>
                                    <?php $gender_arr = array('', 'ذكر', 'أنثى'); ?>
                                    <td><?php if (!empty($gender_arr[$tables['mother']->m_gender])) {
                                            echo $gender_arr[$tables['mother']->m_gender];
                                        } ?> </td>
                                </tr>
                                <?php if ($tables['mother']->m_account == 1) { ?>
                                    <tr>
                                        <th>مسئول الحساب</th>
                                        <td><?php if (!empty($arr_yes_no[$tables['mother']->m_account])) {
                                                echo $arr_yes_no[$tables['mother']->m_account];
                                            } ?></td>
                                    </tr>
                                    <tr>
                                        <th>إسم الحساب</th>
                                        <td><?php if (!empty($banks[$tables['mother']->m_account_id])) {
                                                echo $banks[$tables['mother']->m_account_id];
                                            } ?></td>
                                    </tr>
                                <?php } ?>
                                </tbody>
                ...
                <?php if ($tables['houses'] != '' && $tables['houses'] != null && !empty($tables['houses'])) { ?>
                    <table class="table table-bordered table-devices" style="table-layout: fixed">
                        ...
                        <tr>
                            ...
                            <th>المنطقة</th>
                            <td>
                                <?php if (!empty($area[$tables['houses']->h_area_id_fk])) {
                                    echo $area[$tables['houses']->h_area_id_fk];
                                } ?></td>
                        </tr>
                        <tr>
                            <th>المدينة</th>
                            <td><?php if (!empty($city[$tables['houses']->h_city_id_fk])) {
                                    echo $city[$tables['houses']->h_city_id_fk];
                                } ?></td>
                            <th>الحى</th>
                            <td><?php if (!empty($village[$tables['houses']->h_village_id_fk])) {
                                    echo $village[$tables['houses']->h_village_id_fk];
                                } ?></td>
                        ...
                        <tr>
                            <th>نوع السكن</th>
                            <td><?php if (!empty($arr_type_house[$tables['houses']->h_house_type_id_fk])) {
                                    echo $arr_type_house[$tables['houses']->h_house_type_id_fk];
                                } ?></td>
                            <th>لون المنزل</th>
                            <td><?php echo $tables['houses']->h_house_color; ?></td>
                            <th>اتجاه المنزل</th>
                            <td><?php if (!empty($arr_direct[$tables['houses']->h_house_direction])) {
                                    echo $arr_direct[$tables['houses']->h_house_direction];
                                } ?></td>
                        </tr>
                        <tr>
                            <th>الحالة</th>
                            <td><?php if (!empty($house_state[$tables['houses']->h_house_status_id_fk])) {
                                    echo $house_state[$tables['houses']->h_house_status_id_fk];
                                } ?></td>
                            <th>عدد الغرف</th>
                        ...
                        <tr>
                            ...
                            <th>ملكية السكن</th>
                            <td><?php if (!empty($house_own[$tables['houses']->h_house_owner_id_fk])) {
                                    echo $house_own[$tables['houses']->h_house_owner_id_fk];
                                } ?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            if (isset($tables['family_income_duties'][$income_sources[$a]->id_setting])) {
                                                echo $tables['family_income_duties'][$income_sources[$a]->id_setting]->value;
                                            } else {
                                                echo 0;
                                            }
                                            ?></td>
                                        <td><?php if (isset($tables['family_income_duties'][$income_sources[$a]->id_setting])) {
                                                echo $affect_arr[$tables['family_income_duties'][$income_sources[$a]->id_setting]->affect];
                                            } else {
                                                echo "لا تؤثر";
                                            } ?></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            if (isset($tables['family_income_duties'][$monthly_duties[$a]->id_setting])) {
                                                echo $tables['family_income_duties'][$monthly_duties[$a]->id_setting]->value;
                                            } else {
                                                echo "0";
                                            }
                                            ?></td>
                                        <td><?php if (isset($tables['family_income_duties'][$monthly_duties[$a]->id_setting])) {
                                                echo $affect_arr[$tables['family_income_duties'][$monthly_duties[$a]->id_setting]->affect];
                                            } else {
                                                echo "لا تؤثر";
                                            } ?></td>
                                    </tr>
                                    <?php $d++;
                                    $total1 += (isset($tables['family_income_duties'][$monthly_duties[$a]->id_setting])) ? $tables['family_income_duties'][$monthly_duties[$a]->id_setting]->value : 0;
                                } ?>
                                <tr>
                                    <td width="40%" colspan="2"><label class="label "
                                                                       style="font-size:18px; font-weight: 100;color: #000;">
                        ...
                        <table class="table table-bordered table-devices" style="table-layout: fixed">
                            ...
                            <tr>
                                ...
                                <?php if (isset($result_opinion)) {
                                    echo for_for($arr_in, $result_opinion['is_mother_present']);
                                } else {
                                    echo '<td></td>';
                                } ?>
                            ...
                            <tr>
                                ...
                                <?php if (isset($result_opinion)) {
                                    echo for_for($arr_yes_no, $result_opinion['home_cleaning']);
                                } else {
                                    echo '<td></td>';
                                } ?>
                                <th>الاهتمام بنظافة الابناء</th>
                                <?php if (isset($result_opinion)) {
                                    echo for_for($arr_yes_no, $result_opinion['child_cleanliness']);
                                } else {
                                    echo '<td></td>';
                                } ?>
                            </tr>
