...
?>
        ...
        <section class="main-body">
                    <?php 
/*
$letters=array(1=>'خطاب الاحوال المدنيه',
               2=>'خطاب الجوازات',
               3=>'خطاب التأمينات(الاب)',
               4=>'خطاب التأمينات(الام)',
               5=>'خطاب التقاعد',
               6=>'خطاب الضمان');
               
 */              
 $letters=array(1=>'خطاب الاحوال المدنيه',
               2=>'خطاب التأمينات(الام)',
               3=>'خطاب التقاعد',
               4=>'خطاب الضمان',
               5=>'خطاب التأمينات(الاب)',
               6=>'خطاب الجوازات');              
               
               ?>
          
<!--         
<div class="col-xs-3 padding-4" style="font-weight: 600; float: left;">
   <p class="fhelvetic no-margin">الــــرقـــــم: <?php echo $records[0]->letter_num_fk;?></p>
    <p class="fhelvetic no-margin">تاريخ اليوم: <?php 
    
    $timestamp = strtotime($records[0]->letter_date);
echo $formattedDate = date('d-m-Y', $timestamp);
    
    ?> م</p>
    <p class="fhelvetic no-margin">المرفقـــات: <?php if($records[0]->files==0){echo '-' ;}else {echo $records[0]->files ;} ?></p>
    <p class="fhelvetic no-margin" >الموضـوع : (<?php echo $letters[$letter_type];?> )</p>
</div>-->
<div class="col-xs-9">

</div>
<div class="col-xs-3 text-center" style="font-weight: 600;padding-left: 0; ">
   <p class="fhelvetic no-margin"> <?php echo $records[0]->letter_num_fk;?></p>
    <p class="fhelvetic no-margin"> <?php 
    
    $timestamp = strtotime($records[0]->letter_date);
echo $formattedDate = date('Y/m/d', $timestamp);
    
    ?> م</p>
    <p class="fhelvetic no-margin "> <?php if($records[0]->files==0){echo '-' ;}else {echo $records[0]->files ;} ?></p>
    <p style="margin-top: 8px;" class="fhelvetic no-margin" >(<?php echo $letters[$letter_type];?> )</p>
</div>
                ...
                <div class="print_forma <?php if ($letter_type !=4){ ?> no-border <? } ?>   col-xs-12 allpad-12" <?php if ($letter_type ==4){ ?> style="border-radius: 30px;"<? } ?>>
                   <div class="col-xs-12">
                    <div class="personality">
                        <?php if($letter_type ==1 || $letter_type ==6){ ?>
                            <div class="col-xs-11 col-xs-offset-1 ahwal_style">
                                <h4 class=""  style="font-weight: bold !important;font-size: 20px !important;">سعادة / مدير <?php if($letter_type == 1){?>الأحوال المدنية <?php }else{ ?> الجوازات <?php }?> بالقصيم &nbsp  &nbsp &nbsp   &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp  &nbsp  &nbsp   &nbsp &nbsp &nbsp &nbsp  &nbsp  &nbsp سلمه الله </h4>
                               <br />
                                    ...
                                    foreach ($records as $row){
                                        ...
                                        ?>
                                         ...
                                         <tr >
                                            ...
                                            if($row->person_type == 2){
                                                echo  $row->full_name[0]->full_name;
                                            }elseif($row->person_type == 1){
                                                echo  $row->mother_name;  
                                            }elseif($row->person_type == 3){
                                             echo  $row->full_name[0]->member_full_name;   
                                            }
                                            elseif($row->person_type == 4){
                                                echo  $row->full_name[0]->w_name;   
                                               }
                                            /* if(isset($row->mother_name)){
                                                     echo  $row->mother_name; } 
                                                         else{ echo  $row->full_name[0]->member_full_name;   }*/
                                        ...
                                        <?php } ?>
                                            <td> <?php 
                                              ...
                                              if(isset($row->full_name[0]->dest_card ) and $row->full_name[0]->dest_card != null){
                                                echo $row->full_name[0]->dest_card;
                                              }else{
                                                 echo  $row->m_card_source_name;
                                              }
