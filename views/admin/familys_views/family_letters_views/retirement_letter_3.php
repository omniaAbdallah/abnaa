...
<div class="col-xs-12 " >
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            ...
            <?php if(!empty($result)){ ?>
            <form action="<?php echo base_url();?>family_controllers/Family_letter/update_Retirement_letter/<?php echo $path_method; ?>" method="post">


                <?php }else{ ?>

                <form action="<?php echo base_url();?>family_controllers/Family_letter/Retirement_letter/<?php echo $this->uri->segment(4)."/".$this->uri->segment(5); ?>" method="post">
                    ...
                    <div class="form-group col-sm-4 col-xs-12">
                        ...
                        <input type="text" name=""
                           ...
                           <input type="hidden" name="letter_type_data" value="3"/>
                    </div>
                <div class="form-group col-sm-4 col-xs-12">
                            ...
                            <tr >
                             <!--   <td><?php echo $row->letter_num;?> / <?php echo$this->uri->segment(5);?> </td> -->
                              ...
                              <td><?php echo $row->letter_num;?> / <?php echo$row->num;?> </td>
                                ...
                                <td>
                                    <a  style="line-height: 1.5;font-size: 16px; background-color: #009688;color: #fff; padding: 5px 7px; margin-left: 3px" href="<?php echo base_url().'family_controllers/Family_letter/update_Retirement_letter/'.$row->mother_national_num_fk.'/'.$row->letter_num.'/'.$this->uri->segment(5)?>">
                                                ...
                                                <table class="table table-bordered table-devices">
                                                    ...
                                                    if ((!empty($row->name1)) && (!empty($row->file1))) {
                                                        ...
                                                        <tr id="r1">
                                                            ...
                                                            <td>
                                                                ...
                                                                echo $row->letter_num . '/1/' . $link . '/Retirement_letter' ?>"
                                                    ...
                                                    if ((!empty($row->name2)) && (!empty($row->file2))) {
                                                        ...
                                                        <tr id="r2">
                                                            ...
                                                            <td>
                                                                <a href="<?php echo base_url() ?>family_controllers/Family_letter/delet_img/<?php
                                                                echo $row->letter_num . '/2/' . $link . '/Retirement_letter' ?>"
                                                                   style="line-height: 1.5; background-color: #ff0000;color: #fff; padding: 3px 2px; margin-left: 3px"
                                                                   onclick="return confirm('هل انت متأكد من الحذف')">
                                                                    <i class="fa fa-trash"></i></a>
                                                        ...
                                                        <tr id="r3">
                                                            ...
                                                            <td>
                                                                <img src="<?php echo base_url('uploads/images/' . $row->file3 . ''); ?>"
                                                                     height="100px" width="100px" alt=""></td>
                                                            <td>
                                                                <a href="<?php echo base_url() ?>family_controllers/Family_letter/delet_img/<?php echo $row->letter_num . '/3/' . $link . '/Retirement_letter'  ?>"
                                                                   style="line-height: 1.5; background-color: #ff0000;color: #fff; padding: 3px 2px; margin-left: 3px"
                                                                   onclick="return confirm('هل انت متأكد من الحذف')">
                                                                    <i class="fa fa-trash"></i></a>
