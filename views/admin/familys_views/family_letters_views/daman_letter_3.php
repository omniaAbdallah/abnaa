 ...
 <?php  if(isset($result) && !empty($result)){?>
                ...
                <?php }?>
                 ...
                 <button type="submit" id="saveBtn" class="btn btn-labeled btn-success " name="submit" value="حفظ" 
                  <?php if(isset($result)){}else{ echo 'disabled=""';}?> >
                             ...
                             <!--   <td><?php echo $row->letter_num;?>  / <?php echo$this->uri->segment(5);?> </td>-->
                              ...
                              <td><?php echo $row->letter_num;?> / <?php echo  $row->num;?> </td>
                                ...
                                <td>
                                    ...
                                    <a  style="line-height: 1.5;font-size: 16px; background-color: #009688;color: #fff; padding: 5px 7px; margin-left: 3px" href="<?php echo base_url().'family_controllers/Family_letter/update_daman_letter/'.$row->mother_national_num_fk.'/'.$row->letter_num.'/'.$this->uri->segment(5)?>">
    ...
    <td><button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#myModalfile<?php echo $row->letter_num;?>" style="font-size: 16px;"> <?php echo 'خطاب الضمان'?></button>
                                                ...
                                                <table class="table table-bordered table-devices">
                                                    ...
                                                    if ((!empty($row->name1)) && (!empty($row->file1))) {
                                                        ...
                                                        <tr id="r1">
                                                            ...
                                                            <td>
                                                                ...
                                                                echo $row->letter_num . '/1/' . $link . '/daman_letter' ?>"
                                                    ...
                                                    if ((!empty($row->name2)) && (!empty($row->file2))) {
                                                        ...
                                                        <tr id="r2">
                                                            ...
                                                            <td>
                                                                <a href="<?php echo base_url() ?>family_controllers/Family_letter/delet_img/<?php
                                                                echo $row->letter_num . '/2/' . $link . '/daman_letter' ?>"
                                                                   style="line-height: 1.5; background-color: #ff0000;color: #fff; padding: 3px 2px; margin-left: 3px"
                                                                   onclick="return confirm('هل انت متأكد من الحذف')">
                                                                    <i class="fa fa-trash"></i></a>
                                                        ...
                                                        <tr id="r3">
                                                            ...
                                                            <td>
                                                                <img src="<?php echo base_url('uploads/images/' . $row->file3 . ''); ?>"
                                                                     height="100px" width="100px" alt=""></td>
                                                            <td>
                                                                <a href="<?php echo base_url() ?>family_controllers/Family_letter/delet_img/<?php echo $row->letter_num . '/3/' . $link . '/daman_letter'  ?>"
                                                                   style="line-height: 1.5; background-color: #ff0000;color: #fff; padding: 3px 2px; margin-left: 3px"
                                                                   onclick="return confirm('هل انت متأكد من الحذف')">
                                                                    <i class="fa fa-trash"></i></a>
