...
<?php echo $table_head;?>
 <tr class="tr<?php echo $wakel->w_national_id;?>" >
        <td><input type="hidden"   name="option_select[]"  value="<?php echo $wakel->w_national_id;?>-4"> 
       <?php echo $wakel->w_name;?> (الوكيل)</td>
        <td> <?php echo $wakel->w_national_id;?></td>
        <td> <?php echo $wakel->w_national_id;?></td>
        <td> <?php echo $wakel->dest_card;?></td>
        <td> <button type="button"  class="" onclick="del(<?php echo $wakel->w_national_id ;?>);"><i class="fa fa-trash"></i> </button></td>
