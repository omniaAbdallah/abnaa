...
<div class="col-xs-12 " >
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
           ...
           <?php if(!empty($result)){ ?>
           <?php if(isset($passport) && !empty($passport)){ ?>
            <form action="<?php echo base_url();?>family_controllers/Family_letter/updatePassports/<?php echo $path_method; ?>" method="post">
            <?php  }else{  ?>
                <form action="<?php echo base_url();?>family_controllers/Family_letter/update_Civil_Status/<?php echo $path_method; ?>" method="post">

                <?php  } ?>

            <?php }else{ ?>
            <?php if(isset($passport) && !empty($passport)){ ?>
                <form action="<?php echo base_url();?>family_controllers/Family_letter/Passports/<?php echo $this->uri->segment(4)."/".$this->uri->segment(5); ?>" method="post">

                <?php  }else{  ?>
                    <form action="<?php echo base_url();?>family_controllers/Family_letter/Civil_Status/<?php echo $this->uri->segment(4)."/".$this->uri->segment(5); ?>" method="post">
                ...
                <div class="form-group col-sm-4 col-xs-12">
                    ...
                    <?php if(isset($passport) && !empty($passport)){ ?>
                           <input type="hidden" name="letter_type_data" value="6"/>
                        <?php  }else{  ?>
                           <input type="hidden" name="letter_type_data" value="1"/>
                    <?php  } ?>
                </div>
                <div class="form-group col-sm-4 col-xs-12">
                    <label class="label label-green  half" > إختر الفرد  </label>
                      ...
                      id="member_id" <?php if(!empty($result)){}else{ echo 'data-validation="required"';}?>   aria-required="true" tabindex="-1" aria-hidden="true">
                        ...
                        <option value="4-<?php echo $row->w_national_id;?>"><?php echo $row->w_name;?> (الوكيل)</option>
                        <?php }}?>
                        <!----   ---------------------- ------------>
            ...
            <?php  if(isset($result) && !empty($result)){?>
                           ...
                           <?php   if( in_array($row->w_national_id,$result)){ ?>
                            <tr>
                                <td><input type="hidden"   name="option_select[]"    value="<?php echo $row->w_national_id;?>-4" />
                                    <?php echo $row->w_name;?> (الوكلاء)</td>
               ...
               <!-- <input  type="submit" value="حفظ" <?php if(isset($result)){}else{ echo 'disabled=""';}?> 
                 name="submit" class="btn btn-add">-->
                        ...
                        <tr >
                          <!--  <td><?php echo $row->letter_num;?> / <?php echo$this->uri->segment(5);?></td> -->
                           ...
                           <td><?php echo $row->letter_num;?> / <?php echo $row->num;?> </td>
                            ...
                            <td>
                                <?php if(isset($passport) && !empty($passport)){ ?>
                                    <a style="line-height: 1.5;    font-size: 16px; background-color: #009688;color: #fff; padding: 5px 7px; margin-left: 3px"  href="<?php echo base_url().'family_controllers/Family_letter/updatePassports/'.$row->mother_national_num_fk.'/'.$row->letter_num.'/'.$this->uri->segment(5)?>">
                                    ...
                                    <a  style="line-height: 1.5;    font-size: 16px; background-color: #b30dae;color: #fff; padding: 5px 7px; margin-left: 3px"  target="_blank" href="<?php echo base_url();?>family_controllers/Family_letter/print_letter/<?php echo $basic_family->mother_national_num;?>/<?php echo $row->letter_type;?>/<?php echo $row->letter_num;?>/Civil_Status"><i class="fa fa-print" aria - hidden = "true" ></i >طباعة</a>

                                <?php  }else{  ?>
                                    <a style="line-height: 1.5;    font-size: 16px; background-color: #009688;color: #fff; padding: 5px 7px; margin-left: 3px"  href="<?php echo base_url().'family_controllers/Family_letter/update_Civil_Status/'.$row->mother_national_num_fk.'/'.$row->letter_num.'/'.$this->uri->segment(5)?>">
                                        <i class="fa fa-pencil " aria-hidden="true"></i> تعديل </a>
    ...
    <?php
     ...
     if(isset($passport) && !empty($passport)){ 
          echo 'إرفاق خطاب الجوازات
';  
        
     }else{
            echo 'إرفاق خطاب الاحوال المدنية';       
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <?php if(isset($passport) && !empty($passport)){ ?>
                                            <a id="" href="<?php echo base_url().'family_controllers/Family_letter/deletePassports/'.$row->letter_num.'/'.$link?>"> <button type="button" name="save" value="save" class="btn btn-danger remove" >نعم</button></a>
                                        <?php  }else{  ?>
                                                ...
                                                <table class="table table-bordered table-devices">
                                                    ...
                                                    if ((!empty($row->name1)) && (!empty($row->file1))) {
                                                        ...
                                                        <tr id="r1">
                                                            ...
                                                            <td>
                                                                <a href="<?php echo base_url() ?>family_controllers/Family_letter/delet_img/<?php
                                                                echo $row->letter_num . '/1/' . $link . '/Civil_Status' ?>"
                                                    ...
                                                    if ((!empty($row->name2)) && (!empty($row->file2))) {
                                                        ...
                                                        <tr id="r2">
                                                            ...
                                                            <td>
                                                                <a href="<?php echo base_url() ?>family_controllers/Family_letter/delet_img/<?php
                                                                echo $row->letter_num . '/2/' . $link . '/Civil_Status' ?>"
                                                                   style="line-height: 1.5; background-color: #ff0000;color: #fff; padding: 3px 2px; margin-left: 3px"
                                                                   onclick="return confirm('هل انت متأكد من الحذف')">
                                                                    <i class="fa fa-trash"></i></a>
                                                        ...
                                                        <tr id="r3">
                                                            ...
                                                            <td>
                                                                <img src="<?php echo base_url('uploads/images/' . $row->file3 . ''); ?>"
                                                                     height="100px" width="100px" alt=""></td>
                                                            <td>
                                                                <a href="<?php echo base_url() ?>family_controllers/Family_letter/delet_img/<?php echo $row->letter_num . '/3/' . $link . '/Civil_Status'  ?>"
                                                                   style="line-height: 1.5; background-color: #ff0000;color: #fff; padding: 3px 2px; margin-left: 3px"
                                                                   onclick="return confirm('هل انت متأكد من الحذف')">
                                                                    <i class="fa fa-trash"></i></a>
