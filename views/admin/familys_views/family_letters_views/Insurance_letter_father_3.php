...
<div class="col-xs-12 " >
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            ...
            <?php if(!empty($result)){ ?>
            <form action="<?php echo base_url();?>family_controllers/Family_letter/update_Insurance_letter_father/<?php echo $path_method; ?>" method="post">


                <?php }else{ ?>

                <form action="<?php echo base_url();?>family_controllers/Family_letter/Insurance_letter_father/<?php echo $this->uri->segment(4)."/".$this->uri->segment(5); ?>" method="post">
                    ...
                    <div class="form-group col-sm-4 col-xs-12">
                        ...
                        <input type="hidden" name="letter_type_data" value="5" />
                    </div>
                    <div class="form-group col-sm-4 col-xs-12">
                            ...
                            <?php  if(isset($mother) && !empty($mother)){?>
                                <?php  if(isset($result) && !empty($result)){
                                    if(!in_array($mother->mother_national_card_new,$result)){  ?>
                                        <option value="1-<?php echo $mother->mother_national_card_new;?>"><?php echo $mother->full_name;?> (الزوجه)</option>
                                    <?php } }else{ ?>
                                    <option value="1-<?php echo $mother->mother_national_card_new;?>"><?php echo $mother->full_name;?> (الزوجه)</option>
                                <?php }?>
                            <?php }?>
                             ...
                             <!--   <td><?php echo $row->letter_num;?> / <?php echo$this->uri->segment(5);?> </td> -->
                              <td><?php echo $row->letter_num;?> / <?php echo $row->num;?> </td>
                                ...
                                <td>
                                    ...
                                    <a style="line-height: 1.5;font-size: 16px; background-color: #009688;color: #fff; padding: 5px 7px; margin-left: 3px"  href="<?php echo base_url().'family_controllers/Family_letter/update_Insurance_letter_father/'.$row->mother_national_num_fk.'/'.$row->letter_num.'/'.$this->uri->segment(5)?>">
                                ...
                                <?php echo 'إرفاق خطاب تامينات ( الأب)';?></button>
                            ...
                            <div class="modal-dialog" role="document" style="width: 80%;">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class=" col-sm-12 col-xs-12 ">
                                            <div class="form-group col-sm-4 col-xs-12 ">
                                                <button type="button" class="fa fa-plus  btn "
                                                        onclick="show_input(this.value,<?= $row->letter_num; ?>)"
                                                        value="1"></button>
                                        ...
                                        <div class=" col-sm-12 col-xs-12 ">
                                            <div id="input1<?= $row->letter_num; ?>"
                                                 class="form-group col-sm-4 col-xs-12 " style="visibility: hidden;">
                                                <div class="form-group  col-xs-12">
                                                    <label class="label label-green  half"> اسم المرفق الاول </label>
                                                    <input type="text" name="name1" onchange="make_dir();"
                                                           class="form-control half file">

                                                </div>
                                                <div class="form-group col-xs-12">
                                                    <label class="label label-green  half"> ارفاق الصوره الاولي </label>
                                                    <input type="file" name="file" onchange="make_dir();"
                                                           class="form-control half file">
                                            ...
                                            <div id="input2<?= $row->letter_num; ?>"
                                                 class="form-group col-sm-4 col-xs-12" style="visibility: hidden;">

                                                <div class="form-group  col-xs-12">
                                                    <label class="label label-green  half"> اسم المرفق الثانيه </label>
                                                    <input type="text" name="name2" onchange="make_dir();"
                                                           class="form-control half file">

                                                </div>
                                                <div class="form-group  col-xs-12">
                                                    <label class="label label-green  half"> ارفاق الصوره
                                                        الثانيه </label>
                                                    <input type="file" name="file2" onchange="make_dir();"
                                                           class="form-control half file">

                                                </div>
                                            </div>
                                            <div id="input3<?= $row->letter_num; ?>"
                                                 class="form-group col-sm-4 col-xs-12" style="visibility: hidden;">
                                                <div class="form-group  col-xs-12">
                                                    <label class="label label-green  half"> اسم المرفق الثالته </label>
                                                    <input type="text" name="name3" onchange="make_dir();"
                                                           class="form-control half file">
                                                ...
                                                <div class="form-group  col-xs-12">
                                                    <label class="label label-green  half"> ارفاق الصوره
                                                        الثالته </label>
                                                    <input type="file" name="file3" onchange="make_dir();"
                                                           class="form-control half file">
                                            ...
                                            <div class=" col-sm-12 col-xs-12 ">
                                                ...
                                                <table class="table table-bordered table-devices">
                                                    ...
                                                    <?php
                                                    $x = 0;
                                                    if ((!empty($row->name1)) && (!empty($row->file))) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?= $row->name1 ?></td>
                                                            <td>
                                                                <img src="<?php echo base_url('uploads/images/' . $row->file . ''); ?>"
                                                                     height="100px" width="100px" alt=""></td>
                                                            <td>
                                                                <a href="<?php echo base_url() ?>family_controllers/Family_letter/delet_img/<?
                                                                echo $row->letter_num . '/1/' . $link ?>"
                                                                ...
                                                                <button type="button" class="fa fa-pencil  btn "
                                                                        onclick="show_input(this.value,<?= $row->letter_num; ?>)"
                                                                        value="1"></button>
                                                            </td>
                                    ...
                                    <div class="modal-footer">
                                        <input type="hidden" name="link" value="Insurance_letter_father">
                                        ...
                                        <button type="submit" disabled="disabled" name="add" value="add"
                                                        ...
                                                        <tr id="r1">
                                                            ...
                                                            <td>
                                                                <img src="<?php echo base_url('uploads/images/' . $row->file1 . ''); ?>"
                                                                     height="100px" width="100px" alt=""></td>
                                                            <td>
                                                                <a href="<?php echo base_url() ?>family_controllers/Family_letter/delet_img/<?php echo $row->letter_num . '/1/' . $link . '/Insurance_letter_father' ?>"
                                                                   style="line-height: 1.5; background-color: #ff0000;color: #fff; padding: 3px 2px; margin-left: 3px"
                                                                   onclick="return confirm('هل انت متأكد من الحذف')">
                                                                    <i class="fa fa-trash"></i></a>
                                                        ...
                                                        <tr id="r2">
                                                            ...
                                                            <td>
                                                                <img src="<?php echo base_url('uploads/images/' . $row->file2 . ''); ?>"
                                                                     height="100px" width="100px" alt=""></td>
                                                            <td>
                                                                <a href="<?php echo base_url() ?>family_controllers/Family_letter/delet_img/<?php echo $row->letter_num . '/2/' . $link . '/Insurance_letter_father' ?>"
                                                                   style="line-height: 1.5; background-color: #ff0000;color: #fff; padding: 3px 2px; margin-left: 3px"
                                                                   onclick="return confirm('هل انت متأكد من الحذف')">
                                                                    <i class="fa fa-trash"></i></a>
                                                        ...
                                                        <tr id="r3">
                                                            ...
                                                            <td>
                                                                <img src="<?php echo base_url('uploads/images/' . $row->file3 . ''); ?>"
                                                                     height="100px" width="100px" alt=""></td>
                                                            <td>
                                                                <a href="<?php echo base_url() ?>family_controllers/Family_letter/delet_img/<?php echo $row->letter_num . '/3/' . $link . '/Insurance_letter_father'  ?>"
                                                                   style="line-height: 1.5; background-color: #ff0000;color: #fff; padding: 3px 2px; margin-left: 3px"
                                                                   onclick="return confirm('هل انت متأكد من الحذف')">
                                                                    <i class="fa fa-trash"></i></a>
