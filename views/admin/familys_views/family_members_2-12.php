        ...
        <div class="panel-body">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group col-sm-4 col-xs-12">
                    ...
                    <select name="member_dar_markz_check" onchange="get_dar($(this).val());" id="member_dar_markz_check"
                            class=" no-padding form-control choose-date form-control half " data-validation="required"
                            aria-required="true">
                        <option value="">اختر</option>
                        <?php
            ...
            <div class="col-md-12">
                ...
                <div class="form-group col-sm-4 col-xs-12">
                    ...
                    <select name="member_study_case" id="member_study_case" onchange="get_out_age(this.value);"
                            class="form-control half" data-validation="required" aria-required="true">
                        <option value="">إختر</option>
                        <option value="0"
                ...
                <div class="form-group col-sm-4 col-xs-12">
                    ...
                    <select name="member_education_level" id="member_education_level" class="form-control half"
                            ...
                            aria-required="true" <?php if($member_study_case == 0){echo 'disabled=""'; }?> >
                        <option value="">إختر</option>
            ...
            <div class="col-sm-12">
                ...
                <div class="form-group col-sm-4">
                    ...
                    <select class="form-control half selectpicker " data-show-subtext="true" data-live-search="true"
                            name="member_distracted_mother" data-validation="required" aria-required="true">
                        <option value="">اختر</option>
                ...
                <div class="form-group col-sm-4">
                    ...
                    <select class="form-control half selectpicker " data-show-subtext="true" data-live-search="true"
                            name="member_hij" data-validation="required" aria-required="true">
                        <option value="">اختر</option>
                        <?php for ($a=1;$a<sizeof($yes_no);$a++){
            ...
            <div class="col-md-12">
                <div class="form-group col-sm-4">
                    ...
                    <select class="form-control half selectpicker " data-show-subtext="true" data-live-search="true"
                            name="member_omra" data-validation="required" aria-required="true">
                        <option value="">اختر</option>
                ...
                <div class="form-group col-sm-4">
                    ...
                    <select class="form-control half selectpicker " data-show-subtext="true" data-live-search="true"
                            name="member_home_type" data-validation="required" aria-required="true">
                        <option value="">اختر</option>
                        <?php
            ...
            <div class="col-md-12">
                ...
                <div class="form-group col-sm-4">
                    ...
                    <select class="form-control half selectpicker " data-show-subtext="true" data-live-search="true"
                            name="member_nationality" id="member_nationality" data-validation="required"
                            aria-required="true">
                        <option value="">اختر</option>
            ...
            <div class="col-md-12">
                ...
                <div class="form-group col-sm-4">
                    ...
                    <select name="member_health_type" id="health_state" onchange="check()"
                            data-validation="required" class=" no-padding form-control choose-date form-control half"
                            aria-required="true">
                        <option value="">اختر</option>
