...
<div class="col-xs-12 fadeInUp wow" >
    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
       ...
       <?php echo form_open_multipart("family_controllers/Family/money/".$this->uri->segment(4). '/' . $this->uri->segment(5))?>
                ...
                <?php if(isset($all_records_web)&&!empty($all_records_web)){?>
                    <label class="label">مصادر الدخل والالتزمات من الموقع</label>
      ...
      <td width="30%" class="label-green"> 
         <label class="label "  ><?php echo$income_sources[$a]->title_setting?></label>
                              ...
                              <td style="width: 25%;">
 <?php
if(!empty($all_records_web[$income_sources[$a]->id_setting])){
           echo $all_records_web[$income_sources[$a]->id_setting]->value;
           }else{
...
<?php
if(!empty($all_records_web[$monthly_duties[$s]->id_setting])){ echo $all_records_web[$monthly_duties[$s]->id_setting]->value;}else{ echo 0 ;}
?>
                ...
                <br/>
                <br/>
                <label class="label">اضافه مصادر الدخل والالتزمات  </label>
