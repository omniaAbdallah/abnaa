            ...
            <div class="form-group col-sm-12" >
                <div class="col-sm-6">
                    ...
                    <textarea name="videos_researcher" class="form-control half" rows="5"
                              <?php if($type ==2){?>  data-validation="required"  <?php }else{ ?> data-validation="required" <?php } ?>><?php if(isset($result['videos_researcher'])&& $result['videos_researcher']!=null) {echo $result['videos_researcher'];}?>

                    </textarea>
                </div>
                <div class="col-sm-6">
                    <label class="label label-green  half">مرئيات رئيس قسم شؤون الاسر</label>
                    <textarea name="video_family_leader" class="form-control half" rows="5" <?php if($type ==1){?>  data-validation="required"  <?php }else{ ?> data-validation="required" <?php } ?>><?php if(isset($result['video_family_leader'])&& $result['video_family_leader']!=null){ echo $result['video_family_leader'];}?>
                    </textarea>
                </div>
            </div>
            <div class="form-group col-sm-12" >
