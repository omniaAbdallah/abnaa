        ...
        <div class="stepwizard itab-2">
            ...
            <div class="stepwizard-row setup-panel" data-active="1">
                ...
                <div class="tab tab-2 stepwizard-step col-xs-4 no-padding">
                    <a href="#step-2" type="button" class="btn btn-default obj-tablink" disabled="disabled"> <span><i
                                    class="fa fa-male"></i> بيانات أفراد الأسرة <b class="badge">2</b></span></a>

                </div>
                <div class="tab tab-3 stepwizard-step col-xs-4 no-padding">
                    <a href="#step-3" type="button" class="btn btn-default obj-tablink" disabled="disabled"> <span><i
...
-->
            ...
            <div class="setup-content" id="step-2">
                ...
                if (isset($all) && $all->person_relationship == 41 && empty($mother_added)) {
                    ...
                    <div class="col-sm-6  col-md-1 padding-4 ">
                        ...
                        <select name="member_gender[]" id="member_gender" required="required"
                                class=" form-control">
                ...
                <div class="setup-head col-md-12 no-padding">
                    ...
                    <div class="col-sm-12 no-padding">
                        <?php if (!empty($mother_added)) { ?>
                            ...
                            <div class="col-sm-6  col-md-2 padding-4  form-group">
                                <label class="label label-green  ">الهوية </label>
                                <input type="text" name="member_card_num[]" id=""
                                       required="required"
                                       onkeyup="check_length_num(this,'10','member_card_num_span')" maxlength="10"
                                       onkeypress="validate_number(event)"
                                       class="form-control "/>
                        ...
                        <?php } ?>
                        <?php if (empty($mother_added) && isset($all) && $all->person_relationship != 41) { ?>
                            <div class="col-sm-6  col-md-3 padding-4  form-group">
                                <label class="label label-green  ">الإسم </label>
                                <input type="text" class="form-control" name="member_full_name[]"
                                       id="member_full_name1" required="required">
                            </div>
            ...
            <input type="text"  onfocusout="GetAge(this.value,1)" class="form-control docs-date" id="member_birth_date_hijri1" name="member_birth_date_hijri[]" required="required" >
            </div>  -->
                        <!-- yara -->
                ...
                <!-----------------------------------F_members------------------------------------->
                <div class="setup-foot col-md-12 no-padding text-center">
                    <button type="submit" id="button" class="btn btn-labeled btn-success  save-btn" <?= $disabled ?>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr id="">
                                            ...
                                            <td style="width:15%;text-align: center!important;">
                                                ...
                                                <!-- <input type="text"   value="<?= $member->birth_date_h ?>" onkeyup="GetAge(this.value,<?php echo $member->id; ?>)"  class="form-control docs-date" id="birth_date_h<?= $member->id . 'member' ?>" name="birth_date_h[]" required="required" >-->
                                            </td>
                                    ...
                                    <tr id="">
                                        ...
                                        <td style="width:15%;text-align: center!important;">
                                            <input type="text" value="<?= $mother_data->m_birth_date_hijri ?>"
                                                   ...
                                                   name="birth_date_h" required="required"></td>
                                        <td style="width:15%;text-align: center!important;">
                                            <?php if (!empty($mother_data->m_birth_date_hijri)) {
                                                $hijri_date = explode('/', $mother_data->m_birth_date_hijri);
                                                $age = $current_year - $hijri_date[2];
...
print_r($_SESSION);*/
                    ...
                    <table class="table table-bordered table-striped" style="" id="table_attach_files">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="hidden"   name="<?php echo $out['input'] ?>" value="<?php echo $out['input'] ?>"/>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body ">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <select name="" class="form-control half selectpicker"
                                                    onchange="get_emp(this.value,'<?php echo $record->id; ?>');" required="required"
                                                    aria-required="true" data-show-subtext="true" data-live-search="true">
                                                <option value="">اختر</option>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select class="form-control half " name="process_procedure_id_fk" required="required" aria-required="true">
                                            <option value="">اختر</option>
                                            <?php if (isset($select_process_procedures) && !empty($select_process_procedures)) {
                        foreach ($select_process_procedures as $row_process_procedures) { ?>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <textarea class="form-control half input-style"  rows="3" name="reason"  required="required"  ></textarea>
                                    </div>
                                </div>
