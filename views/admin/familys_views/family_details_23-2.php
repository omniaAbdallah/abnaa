        ...
        <?php if(isset($members) && $members!=null){ ?>
            <table class="table table-bordered" style="width:100%">
                ...
                <tr>
                    ...
                    <td style="text-align: center!important;background-color: <?  ?>">
                          <?php  echo$record->halet_file_title;  ?></td>
                    <td style="text-align: center!important;"><?php  echo$record->procedure_title;  ?></td>
                </tr>
                <?php $x++; } ?>
                </tbody>
            </table>
