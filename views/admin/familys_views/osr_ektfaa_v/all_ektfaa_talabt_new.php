...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        dataTable = $('#all_data').DataTable({
            ...
            "order": [],
            "ajax": {
                url: "<?php echo base_url() . 'family_controllers/osr_ektfaa/Ektfaa_talab/fetch_all_data_new'; ?>",
                type: "POST"
            },
            "columnDefs": [
                {
...
<script>
    ...
    function get_reason(id) {
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>family_controllers/osr_ektfaa/Ektfaa_talab/get_reason',
            data: {id: id},
            dataType: 'html',
            cache: false,
            beforeSend: function () {
