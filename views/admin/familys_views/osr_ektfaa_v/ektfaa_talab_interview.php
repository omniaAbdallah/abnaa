        ...
        <div class="panel-body">
            ...
            <div class="col-md-12">
                <div class="form-group col-sm-4">
                    ...
                    <input type="date" class="form-control" placeholder="" data-validation="required"
                           name="determine_mo2bla_date"
                ...
                <div class="form-group padding-4 col-md-2 col-xs-12">
                    <label class="label "> نوع المقابلة</label>
                    <select type="text" name="mo2bla_type" id="mo2bla_type"
                            class="form-control  ">
                        <?php
                        $arr = array('1' => 'حضورى',
                            '2' =>
...
<script>
    function add_interview_date(id) {
        ...
        var mo2bla_type = $("#mo2bla_type").val();
        var id = id;
        if (determine_mo2bla_date != 0 && determine_mo2bla_date != '' && determine_mo2bla_time != 0 && determine_mo2bla_time != '') {
            ...
            $.ajax({
                ...
                data: {
                    mo2bla_type: mo2bla_type,
                    determine_mo2bla_date: determine_mo2bla_date,
                    determine_mo2bla_time: determine_mo2bla_time,
                    id: id
                },
                dataType: 'html',
                cache: false,
