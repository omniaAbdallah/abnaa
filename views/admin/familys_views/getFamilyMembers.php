...
<tr id="<?=$_POST['length']?>">
 ...
 <td style="width:15%;text-align: center!important;">
     <input type="text"  onfocusout="GetAge(this.value,<?echo$_POST['length'];?>)" class="form-control docs-date" id="member_birth_date_hijri<?=$_POST['length']?>" name="member_birth_date_hijri[]" data-validation="required" ></td>
 <td style="width:15%;text-align: center!important;">
