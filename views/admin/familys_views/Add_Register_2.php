...
<td><?php if($record->mother_name != ''){ echo $record->mother_name; }else{ 
    echo '<button type="button" class="btn btn-warning w-md m-b-5"> إستكمل بيانات الأم</button>'; }   ?> </td>
     ...
     <td>
         <div class="btn-group">
             ...
             <ul class="dropdown-menu">
                 ...
                 <li><a target="_blank" href="<?php echo base_url();?>family_controllers/Family/devices/<?php echo $record->mother_national_num;?>">الأجهزة المنزلية </a></li>
 <li><a target="_blank" href="<?php echo base_url();?>family_controllers/Family/home_needs/<?php echo $record->mother_national_num;?>"> ما يحتاجه المنزل </a></li>
  ...
  <li>
  <a target="_blank" href="<?php echo base_url();?>family_controllers/Family/money/<?php echo $record->mother_national_num;?>">البيانات المالية</a>
