...
<div class="col-sm-12 no-padding">
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
        ...
        <div class="panel-body">
            <?php
            if (!empty($result)) {
                echo form_open_multipart('family_controllers/talbat/Talb_service/update/' . $id, array('id' => 'myform'));
                ...
                echo form_open_multipart('family_controllers/talbat/Talb_service/insert', array('id' => 'myform'));
            ...
            <div class="col-sm-12 form-group">
                ...
                <div class="col-sm-6  col-md-6 padding-4 ">
                    <label class="label  "> الوصف </label>
                    <input type="text" name="wasf" id="wasf" value="<?php echo $wasf; ?>"
...
<?php if (isset($records) && $records != null) { ?>
    <div class="col-sm-12 no-padding">
        <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
            <div class="panel-heading">
                <h3 class="panel-title"> طلبات خدمة رعاية</h3>
            </div>
            <div class="panel-body">
                        ...
                        <tr>
                            ...
                            <td><?php
                                foreach ($service as $cat) {
                                    if ($value->service == $cat->id) echo $cat->khdma_name;
                                }
                                ?></td>
                         ...
                         <span style="font-size: 12px; color: white !important; font-weight: normal;width: 141px;"
                               class="badge badge-add"><?php echo $value->mokadem_name; ?></span>
                            </td>
                            <td>
                                <a type="button"
                                ...
                                <a onclick='swal({
                                        ...
                                        function(){
                                        window.location="<?= base_url() . 'family_controllers/talbat/Talb_service/edit/' . $value->id ?>";
                                        });'>
                                ...
                                <?php if ($_SESSION['role_id_fk'] == 1) { ?>
                                    ...
                                    <a onclick=' swal({
                                            ...
                                            setTimeout(function(){window.location="<?= base_url() . 'family_controllers/talbat/Talb_service/Delete/' . $value->id ?>";}, 500);
                                            });'>
                                ...
                                <?php } ?>
                                <a target="_blank"
                                   href="<?php echo base_url() . 'family_controllers/talbat/Talb_service/print/' . $value->id ?>"
                                   title="طباعه"><i class="fa fa-print"></i></a>

                                <!-- attached -->
                                <button type="button" onclick="get_attach_data(<?= $value->id ?>);"
                                        class="btn btn-sm btn-warning" data-toggle="modal"
                                        data-target="#myModal_attache">
                                    <span class="fa fa-cloud-upload"></span> أضافة مرفقات
                                </button>
                                <!-- attached -->
...
<script>
    function load_table() {
        ...
        var oTable_usergroup = $('#my_table').DataTable({
            dom: 'Bfrtip',
            "ajax": '<?php echo base_url(); ?>family_controllers/talbat/Talb_service/getFamilyTable',
            aoColumns: [
                {"bSortable": true},
                {"bSortable": true},
                {"bSortable": true},
...
<script>
    function GetNamozegDiv() {
        ...
        if (file_num != 0 && file_num != '') {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo base_url() ?>family_controllers/talbat/Talb_service/getDetails',
...
<script>
    function GetTransferPage(value) {
        if (value != 0 && value != '') {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo base_url() ?>family_controllers/talbat/Talb_service/GetTransferPage',
                data: dataString,
                dataType: 'html',
                cache: false,
                success: function (html) {
...
<script>
    function get_attach_data(id) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>family_controllers/talbat/Talb_service/add_picture',
            data: dataString,
            dataType: 'html',
            cache: false,
            success: function (html) {
