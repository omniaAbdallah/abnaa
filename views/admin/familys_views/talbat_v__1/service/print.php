            ...
            <div class="personality">
                ...
                <div class="col-xs-12 no-padding">
                    <div class="form-group col-sm-12 col-xs-12">
                             <h4>      نتقدم إليكم بطلب صرف مساعدة وذلك نظرا لحاجاتنا إليها ، لذا نأمل من سعادتكم التوجيه إلى من يلزمه الأمر بعمل اللازم</h4>
                    </div>
                    <div class="form-group col-sm-12 col-xs-12">
                ...
                <h4>نوع الخدمة  :</h4> <?php 
                            foreach ($service as $cat) {  if ($result['service'] == $cat->id) echo $cat->khdma_name ;} 
                            ?>
                    </div>
                    <div class="form-group col-sm-12 col-xs-12">
