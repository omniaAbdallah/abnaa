<div class="col-md-12 col-sm-12 padding-4">
    ...
    <div class="form-group col-md-2 padding-4 col-sm-4 col-xs-12">
        ...
        <input type="date" name="contract_end_date" id="contract_end_date" readonly
    ...
    <div class="form-group  col-md-3 padding-4">
        ...
        <select type="text" class="form-control " name="type_house_id_fk" data-validation="required">
            <option value=""> إختر</option>
            <?php
