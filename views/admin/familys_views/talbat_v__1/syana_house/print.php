            ...
            <div class="personality">
                ...
                <div class="col-xs-12 no-padding">
                    <div class="form-group col-sm-12 col-xs-12">
                             <h4>      نتقدم إليكم بطلب طلب سداد فواتير خدمات   وذلك نظرا لحاجاتنا إليها ، لذا نأمل من سعادتكم التوجيه إلى من يلزمه الأمر بعمل اللازم</h4>
                    </div>
                    <div class="form-group col-sm-12 col-xs-12">
...
<?php foreach ($type_fatora as $cat) { ?>
                                ...
                                <?php if ($result['type_id_fk'] == $cat->id) echo $cat->title ?>
                        <?php } ?>
...
<script>
      ...
      window .print();
      setTimeout(function () {
          window.location.href ="<?php echo base_url();?>family_controllers/talbat/Talb_sadad_fatora";
        }, 1000);
</script>