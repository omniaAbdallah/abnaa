  ...
  <h5>.............................................</h5>
                    ...
                    <?php } ?>
                       ...
                       <?php //}elseif($type ==1){
                        ...
                        ?>
  <div class="col-xs-12" style="margin-top: 13px; margin-bottom: 15px">
        <div class="container" style="padding: 0">
            <div class="col-xs-12">
                <div class="col-xs-12" style="padding: 0; margin-bottom:15px;">
    ...
    ?>
                    <h4 style=" font-size: 16px;  "><?php  switch ($dayOfWeek) {
                     ...
                     عقدت لجنة الرعاية الاجتماعية إجتماعها رقم ( <?php 
                  // echo $record[0]->lagna_member[0]->lagna_num;
                      echo 2019 .'/'. 15 ;
                    ?>)
                    لمناقشة التالي : 
                    ...
                    <h4 style="font-size: 17px !important; font-weight: bold !important; "> 1-  <?=$record['about'] ?> .</h4>
                    <h4 style="font-size: 17px !important;font-weight: bold !important; " class="text-center">بعد الإجتماع والمناقشة قررت اللجنة</h4>
                    <h4 style="font-size: 17px !important; font-weight: bold !important;">إعتماد <?=$record['about'] ?> وفقاَ للبيان التالى :- </h4>
   ...
   <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <th class="text-center" style="width: 20%">
                                <h5 style="margin: 2px;font-weight: bold;"> مبلغ المساعدة </h5>
                            </th>
                            <th class="text-center" style="width: 20%">
                        ...
                        <tr>
                            <td class="text-center">
                                <h5 style="font-weight: bold;" >450</h5>
                            </td>
                            <td class="text-center">
                                <h5 style="font-weight: bold;" >ايتام</h5>
                            </td>
                            <td class="text-center" >
                                <h5 style="font-weight: bold;" >1176</h5>
                            </td>
                            <td class="text-center">
   ...
   <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%" style="table-layout: fixed;">
                ...
                <span style="border-bottom: 1px solid; padding-bottom: 3px; font-weight: bold;">توجيه المدير العام</span>
                 ...
                 <div class="col-xs-12">
                <h5 style="position: relative;" >
    <input type="checkbox" style="width: 25px !important; height: 23px !important;" name="inlineRadioOptions" id="inlineRadio1" value="option1">
    <span style="position: absolute; top: 8px;margin-right: 8px; font-weight: bold; "> لا مانع </span>
     </h5>
      </div>  
      <div class="col-xs-12">
    <h5 style="position: relative;" >
     <input type="checkbox" style="width: 25px !important; height: 23px !important;" name="inlineRadioOptions" id="inlineRadio2" value="option2">  
     <span style="position: absolute; top: 8px;margin-right: 8px; color: #e0e0e0 !important;"> ..............</span>
    </h5>
      </div>  
         </div>         
            	...
            	<div class="col-xs-12">
					...
					<h6  style="font-weight: bold; font-size: 18px !important;" class="text-center">
                    <?php if(isset($modeer_3am) and $modeer_3am != null ){echo $modeer_3am;}else{
                        }
                    ?>
                    	</h6>
					</div>
