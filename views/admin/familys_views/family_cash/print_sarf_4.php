...
<h5>
بناءاَ على قرار لجنة الرعاية والمساعدات رقم (<?php  echo $sarf_data["presence_year"]."/".$sarf_data["presence_number"]  ?>)
 الرجاء الموافقة على 
    ...
    خلال شهر 
     ...
     /*   echo '<pre>';
        ...
        <?php  $total =0;
              ...
              $all_aytam=0;
              $all_ble3en=0;
              $x=1; foreach ($sarf_details as $row){
              $total += $row->value;
