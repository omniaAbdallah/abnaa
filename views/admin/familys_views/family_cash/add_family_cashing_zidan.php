...
<div class="form-group col-sm-6 col-xs-12">
                <label class="label label-green  half" style="    width: 32% !important;
    float: right !important;">عبارة عن </label>
           <input type="text" style="    width: 66% !important;
    float: right !important;"   id="about"  name="about" class=" no-padding form-control form-control half" />
            </div></div>
          <div class="col-xs-12">  
           <div class="form-group col-sm-4 col-xs-12">
                    <label class="label label-green  half"> مساعدة إلي </label>
