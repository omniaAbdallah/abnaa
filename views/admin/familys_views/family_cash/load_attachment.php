<div class="col-sm-12">
   ...
   <?php   echo form_open_multipart("family_controllers/FamilyCashing/SarfAttachments/".$sarf_num_fk_attach);?>
        ...
        <tbody class="text-center" id="body_attach">
         <?php if(isset($sarf_attachments) && !empty($sarf_attachments)){
               ...
               <tr>
                   ...
                   <td>
                       <a href="<?=base_url()."family_controllers/FamilyCashing/downloads/".$row->attachment?>">
    ...
    function delete_attach(this_value,id_attach) {
       ...
       // alert(out_confirm);
        if(out_confirm == true){
            ...
            $.ajax({
                type:'post',
                url: '<?php echo base_url() ?>family_controllers/FamilyCashing/DeleteAttachments',
                data:dataString,
                dataType: 'html',
                cache:false,
