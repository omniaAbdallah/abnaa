        ...
        <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
            ...
            <div class="panel-body">
                ...
                <?php if (isset($crm_data)) {
                    echo form_open_multipart("family_controllers/osr_crm/Osr_crm_c/Update/" . $crm_data["id"]);
                    ...
                    echo form_open_multipart("family_controllers/osr_crm/Osr_crm_c/add_crm");
                    $disp = "none";
                    $out["deisabled"] = "";
                      ...
                      <label class="label  " style=""> وقت الاتصال</label>
                       ...
                       id="contact_time"  name="contact_time" class=" form-control "  />
                        ...
                        <div class="form-group  col-md-3 padding-4 ">
                            ...
                            <input type="text" id="file_num" value="<?php if (isset($crm_data["file_num"])) {
                            ...
                            <tr class="">
                                ...
                                <td>
                                    ...
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <a href="<?= base_url() . 'family_controllers/osr_crm/Osr_crm_c/Update/' . $record->id ?>"
                                           class="btn btn-warning"><i class="fa fa-pencil"></i>تعديل</a>
                                        <a href="<?= base_url() . 'family_controllers/osr_crm/Osr_crm_c/delete/' . $record->id ?>"
