...
<div class="col-sm-12">
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            ...
            if ($mother_num == '') {
                echo form_open_multipart('family_controllers/osr_crm/Osr_crm_zyraat_c/start_zyraa/' . $id);
            } else {
                echo form_open_multipart('family_controllers/osr_crm/Osr_crm_zyraat_c/start_zyraa/' . $id . '/' . $mother_num);
            } ?>
            <div class="col-md-12">
                <table id="" class=" display table table-bordered  table-striped responsive nowrap" cellspacing="0"
                       width="100%">
                    <thead>
                    <tr>
                        <th class="text-center">
                            <?php if ($crm_data['visit_start'] == 'no') { ?>
                                <button type="button" onclick="start_time_zyraa(<?= $id ?>,'<?= date('H:i a'); ?>')"
...
"><input type="text" value="<?php echo $basic_data_family['father_name'] ?>" readonly="" class="form-control "></td>
                        ...
                        <td><input type="text" value="<?php echo $basic_data_family['father_national_num'] ?>"
                                   readonly="" class="form-control " data-validation="required"></td>
                    </tr>
                    <tr>
                        <th>هل الام متواجدة</th>
                        <td><select name="is_mother_present" class="form-control " data-validation="required"
                        ...
                        <td><select name="mother_impression_visit" class="form-control " data-validation="required"
                                    aria-required="true" tabindex="-1" aria-hidden="true">
                                <option value="">إختر</option>
                    ...
                    <tr>
                        ...
                        <td><select name="home_cleaning" class="form-control " data-validation="required"
                                    aria-required="true" tabindex="-1" aria-hidden="true">
                                <option value="">إختر</option>
                        ...
                        <td><select name="child_cleanliness" class="form-control " data-validation="required"
                                    aria-required="true" tabindex="-1" aria-hidden="true">
                                <option value="">إختر</option>
                                <?php for ($x = 1; $x < sizeof($arr_yes_no); $x++):
                                    $selected = '';
                    ...
                    <tr>
                        <th> فئة الاسرة</th>
                        <td><select name="family_type" class="form-control " data-validation="required"
                                    aria-required="true" tabindex="-1" aria-hidden="true"
                            >
                                <option value="">إختر</option>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <button type="submit" class="btn btn-danger" name="add" value="add"
                                    id="save"
                                    style="
    float: left;
"
                                ...
                                <?php } ?>
                            >
                                <span><i class="fa fa-clock-o" aria-hidden="true"></i></span> انهاء الزيارة
                            </button>
                        </td>
                    </tr>
                    </tfoot>
