...
<div class="col-xs-12 no-padding">
    <table class="table table-bordered">
        <thead>
        <tr>
            <th class="info_detailes">رقم الزيارة</th>
            <td><?= $crm_data['rkm_visit'] ?></td>
            <th class="info_detailes">تاريخ الزيارة</th>
            <td><?= $crm_data['visit_date'] ?></td>
            <th class="info_detailes"> (من)موعد الزيارة</th>
            <td><?php echo $crm_data['visit_time_from'] ?></td>
        </tr>


        <tr>
            <th class="info_detailes">(إلي)موعد الزيارة</th>
            <td><?php echo $crm_data['visit_time_to'] ?></td>

            <td class="info_detailes">أسم الباحث</td>
            <td><?= $crm_data['emp_name'] ?></td>
            <th class="info_detailes">رقم هوية الام</th>
            <td><?php echo $crm_data['mother_national_num'] ?></td>
        </tr>


        <tr>
            <td class="info_detailes">نوع البحث</td>
            <td> <?php
            ...
            <th class="info_detailes">الغرض من الزيارة</th>
        ...
        <tr>
            <th class="info_detailes"> متطلبات الزيارة</th>
    ...
    <?php if (isset($action_visit_history) and $action_visit_history != null) { ?>
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <th scope="col">وقت الاجراء</th>
                <th scope="col">تاريخ الاجراء</th>
