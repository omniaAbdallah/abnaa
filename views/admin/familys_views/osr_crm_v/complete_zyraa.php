...
"><input type="text" value="<?php echo $basic_data_family['father_name'] ?>" readonly="" class="form-control "></td>
                        ...
                        <tr>
                            ...
                            <td> <textarea class="editor1"
                                           data-validation="required"
                                           id="editor1" name="rai_baheth" rows="1"
                                           style=""> <?php if (!empty($zyraa_data['rai_baheth'])) {
                                        ...
                                        >
                                            ...
                                            if (isset($member) && !empty($member) && $member != null) {
                                                foreach ($member as $member_row) {
                                                    ...
                                                    ?>
                                                    <option <?= $selected ?>
                                                            value="<?= $member_row->member_full_name ?>">
                                                        <?= $member_row->member_full_name ?>
                                                    </option>
                                                <?php } ?>
                                            <?php } ?>
...
"
                                    ...
                                    <?php } ?>
                                >
                                    <span><i class="fa fa-clock-o" aria-hidden="true"></i></span> إستكمال بيانات الزيارة
                                </button>
                            </td>
                        </tr>
                        </tfoot>
