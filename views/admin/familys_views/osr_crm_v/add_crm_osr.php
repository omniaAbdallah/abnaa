            ...
            <div class="col-xs-12 text-center" style="margin-bottom: 10px;">
                ...
                <button type="submit" name="<?php echo $out['input'] ?>" value="<?php echo $out['input'] ?>"
                    ...
                    <span class="btn-label"><i class="fa fa-floppy-o"
                                               aria-hidden="true"></i></span> <?php echo $out['input_title'] ?></button>
            </div>
            <!---------------------------------------->
            <?php echo form_close() ?>
        </div>
                    ...
                    foreach ($all_data as $record) { ?>
                        <tr class="">
                            ...
                            <td>
                                ...
                                <a href="<?= base_url() . 'family_controllers/osr_crm/Osr_crm_c/Update_crm_osr/' . $record->id . '/' . $record->mother_national_num ?>"
                                   class="btn btn-warning"><i class="fa fa-pencil"></i>تعديل</a>
                                <a href="<?= base_url() . 'family_controllers/osr_crm/Osr_crm_c/delete_crm_osr/' . $record->id . '/' . $record->mother_national_num ?>"
