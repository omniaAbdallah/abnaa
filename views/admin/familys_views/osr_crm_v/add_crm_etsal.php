                ...
                <div class="col-md-12 no-padding">
                    <div class="col-xs-8 no-padding">
                        ...
                        <div class="form-group col-sm-2 col-xs-12 padding-4">
                            ...
                            <input type="date"
                                   readonly
                                   value="<?php if (isset($crm_data["contact_date"])) {
                                       if (!empty($crm_data["contact_date"])) {
                                           echo $crm_data["contact_date"];
                                       }
                                   } else {
                                       echo date('Y-m-d');
                                   } ?>"
                      ...
                      <label class="label  " style=""> وقت الاتصال</label>
                       <input type="time"
                       readonly
                       value="<?php if (isset($crm_data["contact_time"])) {
                            if (!empty($crm_data["contact_time"])) {
                                echo $crm_data["contact_time"];
                            }
                        } else {
                            echo date('H:i');
                        } ?>"
                       id="contact_time"  name="contact_time" class=" form-control "  />
                        ...
                        <div class="form-group  col-md-3 padding-4 ">
                            ...
                            <input type="text" id="file_num" value="<?php if (isset($zyraa_data["file_num"])) {
                                if (!empty($zyraa_data["file_num"])) {
                                    echo $zyraa_data["file_num"];
                                }
                            } else {
                                if (!empty($crm_data["file_num"])) {
                                    echo $crm_data["file_num"];
                                }
                            } ?>"
                            ...
                            <input type="hidden" name="mother_national_num" id="mother_national_num"
                                   value="<?php if (isset($zyraa_data["mother_national_num"])) {
                                       if (!empty($zyraa_data["mother_national_num"])) {
                                           echo $zyraa_data["mother_national_num"];
                                       }
                                   } else {
                            ...
                            <select name="wasela_etsal" id="wasela_etsal" data-validation="required "
                                ...
                                <?php foreach ($method_etsal as $row) {
                                    ...
                                    if (isset($crm_data)) {
                                        ...
                                        if ($crm_data['wasela_etsal'] == $row->conf_id) {
                                            $selected = "selected";
                                        }
                            ...
                            <select name="contact_result" id="contact_result" data-validation="required "
                                ...
                                <?php foreach ($natega_etsal as $row) {
                                    ...
                                    if (isset($crm_data)) {
                                        ...
                                        if ($crm_data['contact_result'] == $row->conf_id) {
                                            $selected = "selected";
                                        }
                        ...
                        <div class="form-group  col-sm-4 padding-4">
                            <label class="label "> الغرض من الاتصال </label>
                            <select name="purpose_etsal" id="purpose_etsal" data-validation="required "
                                ...
                                <?php foreach ($purpose_etsal as $row) {
                                    ...
                                    if (isset($crm_data)) {
                                        ...
                                        if ($crm_data['purpose_etsal'] == $row->conf_id) {
                                            $selected = "selected";
                                        }
                        ...
                        <div class="form-group  col-sm-12 padding-4">
                            ...
                            <textarea class="editor1"
                                      ...
                                      id="editor1" name="visit_result" rows="2"
                                      style=""><?php if (isset($crm_data["details"])) {
                                    if (!empty($crm_data["details"])) {
                                        echo $crm_data["details"];
                                    }
                                } ?></textarea>
...
//                    $data['file_num_data']=$file_num_data;
                            ...
                            <table class="table table-bordered ">
                                ...
                                <tr>
                                    <th class="info"><i class="fa fa-phone-square" aria-hidden="true"></i> جوال التواصل
                                    </th>
                                    <td class="infotd text-center">
                                ...
                                <tr>
                                    <th class="info"><i class="fa fa-calendar-o" aria-hidden="true"></i> تاريخ التسجيل
                                    </th>
                                    <td class="infotd text-center">
                                    </td>
                                </tr>
                                <tr>
                                    <th class="info"><i class="fa fa-users" aria-hidden="true"></i> عدد أفراد الأسرة
                                    </th>
                                    <td class="infotd text-center">
                                    </td>
                                </tr>
                ...
                <div class="panel-body">
                    <table id="example" class=" display table table-bordered  table-striped responsive nowrap"
                        ...
                        <tr class="greentd">
                            ...
                            <th class="text-center">الغرض من الاتصال</th>
                            ...
                            <tr class="">
                                ...
                                <td>
                                    ...
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <a href="<?= base_url() . 'family_controllers/osr_crm/Osr_crm_c/Update_crm_etsal/' . $record->id . '/' . $record->zyraa_id_fk ?>"
                                           class="btn btn-warning"><i class="fa fa-pencil"></i>تعديل</a>
                                        <a href="<?= base_url() . 'family_controllers/osr_crm/Osr_crm_c/delete_crm_etsal/' . $record->id . '/' . $record->zyraa_id_fk ?>"
                                           onclick="return confirm(\'Are You Sure To Delete? \')"
                                           class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> حذف </a>


                                        <a data-toggle="modal" data-target="#myModal_details"
                                           onclick="getDetails_crm(<?= $record->id ?>)" data-backdrop="static"
                                           data-keyboard="false" class="btn btn-purple"><i class="fa fa-list"></i>تفاصيل</a>
