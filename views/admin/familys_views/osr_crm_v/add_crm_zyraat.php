            ...
            <div class="panel-body">
                ...
                <div class="col-sm-8 form-group">
                    <div class="form-group col-md-4 col-xs-12 padding-4">
                        ...
                        <input type="text"
                               readonly
                               value="<?php if (isset($crm_data["emp_name"])) {
                                   if (!empty($crm_data["emp_name"])) {
                                       echo $crm_data["emp_name"];
                                   }
                               } else {
                    ...
                    <div class="form-group col-md-2 col-xs-12 padding-4">
                        ...
                        <input type="number"
                               readonly
                               value="<?php if (isset($crm_data["rkm_visit"])) {
                                   if (!empty($crm_data["rkm_visit"])) {
                                       echo $crm_data["rkm_visit"];
                                   }
                               } ?>"
                    ...
                    <div class="form-group  col-md-3 padding-4 ">
                        <label class="label  ">رقم هوية الام </label>
                        <input type="text" name="mother_national_num" id="mother_national_num"
                               value="<?php if (isset($crm_data["mother_national_num"])) {
                                   if (!empty($crm_data["mother_national_num"])) {
                                       echo $crm_data["mother_national_num"];
                                   }
                               } ?>"
                    ...
                    <div class="form-group col-md-2 col-xs-12 padding-4">
                        ...
                        <input type="time"
                               ...
                               onchange="check_date();" id="visit_time_from" name="visit_time_from"
                               class="  form-control "/>
                    </div>
                    <div class="form-group col-md-2 col-xs-12 padding-4">
                        ...
                        <input type="time"
                               ...
                               onchange="check_date();" id="visit_time_to" name="visit_time_to"
                               class="  form-control "/>
                    </div>
                    ...
                    <div class="form-group  col-md-2 padding-4">
                        ...
                        <select name="visit_reason" id="visit_reason" data-validation="required "
                            ...
                            <?php foreach ($purpose_visit as $row) {
                                $selected = "";
                                if (isset($crm_data)) {
                                    if ($crm_data['visit_reason'] == $row->conf_id) {
                                        $selected = "selected";
                                    }
                                } ?>
                    ...
                    <div class="form-group  col-md-4 padding-4">
                        ...
                        <input type="text" name="visit_result" id="visit_result" data-validation="required "
                               value="<?php if (isset($crm_data["visit_result"])) {
                        ...
                        <div class="m-t-small">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="lat" class="form-control"
                                       style="width: 110px;font-family: arial" id="loca-lat"
                                       value="<?php if (isset($crm_data["lat"])) {
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="lng" class="form-control"
                                       style="width: 110px;font-family: arial" id="loca-lon"
                                       value="<?php if (isset($crm_data["lng"])) {
...
//                    $data['file_num_data']=$file_num_data;
                ...
                <div class="col-xs-12 text-center" style="margin-bottom: 10px;">
                    <button type="submit" name="<?php echo $out['input'] ?>" value="<?php echo $out['input'] ?>"
                            class="btn btn-success  btn-labeled" id="submit_but">
                        <span class="btn-label"><i class="fa fa-floppy-o"
                                                   aria-hidden="true"></i></span> <?php echo $out['input_title'] ?>
                    </button>
                </div>
                <!---------------------------------------->
                <?php echo form_close() ?>
                ...
                <div class="panel-body">
                    <table id="example" class=" display table table-bordered  table-striped responsive nowrap"
                        ...
                        <tr class="greentd">
                            ...
                            <th class="text-center"> وقت الزيارة من</th>
                            <th class="text-center"> وقت الزيارة إالي</th>
                        ...
                        foreach ($all_data as $record) { ?>
                            <tr class="">
                                ...
                                <td><?php echo date('h:i A', strtotime($record->visit_time_from)); ?></td>
                                <td><?php echo date('h:i A', strtotime($record->visit_time_to)); ?></td>
                                <td><?php
                                    $search_type_arr = array(1 => 'زيارة تتبعية',
                                        2 => 'بحث تتبعي');
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a data-toggle="modal" data-target="#myModal_details"
                                                   onclick="change_time_zyraa(<?= $record->id ?>)">
        ...
        function check_new_date() {
            ...
            if (visit_date_new != "" && visit_time_from_new != "" && visit_time_to_new != "") {
                $.ajax({
                    ...
                    data: {
                        visit_date: visit_date_new,
                        visit_time_from: visit_time_from_new,
                        visit_time_to: visit_time_to_new
                    },
                    dataType: 'html',
                    cache: false,
    ...
    <script>
        function load_table() {
            ...
            html = '<div class="col-md-12"><table id="my_table" class="table table-striped table-bordered dt-responsive nowrap " >' +
                '<thead><tr><th style="width: 30px;">م</th><th style="width: 50px;"> رقم الطلب/ رقم الملف </th><th style="width: 80px;"> إسم رب الأسرة </th><th style="width: 50px;" >رقم الهوية</th>' +
                '<th style="width: 80px;"> إسم الأم </th><th style="width: 50px;"> رقم الهوية </th><th style="width: 50px;">  الفئة </th></tr></thead><table><div id="dataMember"></div></div>';
