        ...
        <div class="panel-body">
            ...
            <?php if(isset($crm_data)){
                ...
                if ($mother_num == '') {
                    ...
                    echo form_open_multipart("family_controllers/osr_crm/Osr_crm_zyraat_c/Update/" . $crm_data["id"] . "/" . $crm_data["mother_national_num"]);
                }
                // echo form_open_multipart("family_controllers/osr_crm/Osr_crm_zyraat_c/Update/".$crm_data["id"]."/".$crm_data["mother_national_num"]);
                ...
                if ($mother_num == '') {
                    ...
                    $data_load["employees"] = $employees;
                    $this->load->view('admin/familys_views/drop_down_button', $data_load);
                    echo form_open_multipart("family_controllers/osr_crm/Osr_crm_zyraat_c/add_crm/" . $mother_num);
                }
                  $disp="none";
                  $out["deisabled"]="";
         ...
         <div class="col-sm-8 form-group">
             ...
             <?php $mother_num = $this->uri->segment(5);
             if (isset($mother_national_num) && $mother_national_num != '') {
                 ?>
            ...
            <ul class="dropdown-menu">
                ...
                <?php } else {
                    ...
                    <li>
                        <a onclick='swal({
                                ...
                                function(){
                                window.location="<?= base_url() . 'family_controllers/osr_crm/Osr_crm_zyraat_c/Update/' . $record->id . '/' . $record->mother_national_num ?>";
                                });'>
                            <i class="fa fa-pencil"> </i> تعديل </a>
                    </li>
                    <li>
                    <a onclick=' swal({
                            ...
                            function(){
                            swal("تم الحذف!", "", "success");
                            setTimeout(function(){window.location="<?= base_url() . 'family_controllers/osr_crm/Osr_crm_zyraat_c/delete/' . $record->id . '/' . $record->mother_national_num ?>";}, 500);
                            });'>
                        <i class="fa fa-trash"> </i> حذف </a>
                    <?php if ($record->visit_ended == 'no') { ?>
                        <li>
                            <a onclick='swal({
                                    ...
                                    function(){
                                    window.location="<?= base_url() . 'family_controllers/osr_crm/Osr_crm_zyraat_c/start_zyraa/' . $record->id . '/' . $record->mother_national_num ?>";
                                    });'>
                                <i class="fa fa-archive"> </i> بدء الزيارة </a>
                        </li>
                    <?php }?>
                ...
                <li>
                    <a onclick='swal({
                            ...
                            function(){
                            window.location="<?= base_url() . 'family_controllers/osr_crm/Osr_crm_zyraat_c/complete_zyraa_data/' . $record->id . '/' . $record->mother_national_num ?>";
                            });'>
                        <i class="fa fa-upload"> </i> إستكمال بيانات الزيارة </a>
                </li>
                    <?php } ?>
