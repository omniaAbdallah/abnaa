        ...
        <div class="panel-body" style="height: 400px;">
            <div class="custom-tabs">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#main-detailsa" aria-controls="main-detailsa"
                                                              role="tab" data-toggle="tab">البيانات الأساسية</a></li>
                    <li role="presentation"><a href="#contact-details" aria-controls="contact-details" role="tab"
                                               data-toggle="tab">بيانات افراد الاسره</a></li>
                    <li role="presentation"><a href="#health-details" aria-controls="health-details" role="tab"
...
print_r($_SESSION);*/
                        ...
                        <?php echo $form ?>
                        <input type="hidden" name="continue_data" id="continue_data" value="0"/>
                        ...
                        <div class="col-sm-12 form-group">
                            ...
                            <div class="col-sm-6 col-md-2 padding-4">
                                ...
                                <select name="marital_status_id_fk" data-validation="required"
                                        class="selectpicker no-padding form-control choose-date form-control "
                        ...
                        <div class="col-sm-12 form-group">
                            ...
                            <div class=" col-sm-6  col-md-2 padding-4">
                                ...
                                <select name="register_place"
                                        class="selectpicker no-padding form-control choose-date form-control "
                                        data-validation="required" data-show-subtext="true" data-live-search="true"
                                        aria-required="true">
                                    <option value=""> اختر</option>
                                    <?php
               ...
               -->
                            ...
                            <div class=" col-sm-6  col-md-1 padding-4">
                                ...
                                <input type="text" name="male_number" id="male_number"
                                       onkeypress="validate_number(event)"
                                       data-validation="required" onkeyup="getFamilyNumber();"
                                       value="<?php if (isset($result)) {
                    ...
                    <?php if (isset($result) && $result != null) {
                            ...
                            <div class="col-sm-4 col-xs-12 text-center">
                                ...
                                <button type="button" id="button" class="btn btn-labeled btn-success "
                                        onclick="show_sweet_alert()">
...
-->
                                        ...
                                        foreach ($records as $record) { ?>
                                            ...
                                            <div class="col-xs-3">
                                                <h5 class="no-margin">التاريخ : <?= date('Y-m-d') ?></h5>
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-danger"
                                                                            data-dismiss="modal">إغلاق التفاصيل
                                                                    </button>
                                                                    <button type="submit" name="go_submit"
                                                                            value="go_submit" class="btn btn-warning">
                                                                        حفظ
                                                                    </button>
                                                                </div>
                                                            </div>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="contact-details">
                        ...
                        <?php if (isset($all) && $all->person_relationship == 41) {

                            ?>
                            <div class="col-sm-6  col-md-3 padding-4 ">
                                <label class="label label-green  ">الإسم </label>
                                <input type="text" class="form-control" name="member_full_name[]" id="member_full_name1"
                                       data-validation="required" value="<?php echo $all->full_name_order; ?>">
                            </div>
                            <div class="col-sm-6 col-md-2 padding-4">
                                <label class="label label-green  ">الصلة </label>
                                <select name="member_relationship[]" id="member_relationship1"
                                        data-validation="required" class=" form-control" onchange="gender_select(1)">
                            ...
                            <div class="col-sm-6  col-md-3 padding-4 ">
                                ...
                                <select name="member_gender[]" id="member_gender1" data-validation="required"
                                        class=" form-control">
                            ...
                            <div class="col-sm-6  col-md-3 padding-4 ">
                                ...
                                <input type="text" name="member_card_num[]" id="member_card_num1"
                                       data-validation="required" value="<?php echo $all->mother_national_num; ?>"
                        ...
                        <div class="col-sm-12 form-group">
                            <?php if (isset($all) && $all->person_relationship != 41) { ?>
                                <div class="col-sm-6  col-md-3 padding-4 ">
                                    ...
                                    <input type="text" class="form-control" name="member_full_name[]"
                                           id="member_full_name1" data-validation="required">
                                </div>
                            ...
                            <div class="col-sm-6  col-md-3 padding-4 ">
                                ...
                                <select name="member_card_source[]" id="m_card_source" data-validation="required"
                            ...
                            <!-- <div class="col-sm-6  col-md-3 padding-4 ">
                    <label class="label label-green  "> تاريخ الميلاد </label>
                <input type="text"  onfocusout="GetAge(this.value,1)" class="form-control docs-date" id="member_birth_date_hijri1" name="member_birth_date_hijri[]" data-validation="required" >
                </div>  -->
                            <!-- yara -->
                            <div class="form-group col-md-3  col-sm-6 padding-4">
                                ...
                                <div id="cal-1" style="width: 50%;float: left;">
                                    <input id="date-Miladi" name="birth_date_m" class="form-control bottom-input  "
                                           data-validation="required" onchange="GetAge($(this).val(),1);"
                            ...
                            <div class="col-sm-6  col-md-3 padding-4 ">
                                ...
                                <input class=" form-control  " type="text" name="age[]" id="myage1" readonly/>
                            </div>
                            <div class="col-sm-6  col-md-3 padding-4 ">
                        ...
                        <div class="col-sm-4 col-xs-12 text-center">
                            <button type="submit" id="button" class="btn btn-labeled btn-success "
                        ...
                        <table class="table table-striped table-bordered fixed-table " <?php if (empty($family_members) && empty($mother_data)) { ?>
                            ...
                            if (isset($mother_data) && !empty($mother_data)) {
                                ...
                                <tr id="<?= $s ?>">
                                    ...
                                    <td style="width:15%;text-align: center!important;">
                                        <?= $mother_data->birth_date_h ?>
                                    </td>
                                    <td style="width:10%;text-align: center!important;">
                                        <?php if (!empty($mother_data->birth_date_h)) {
                                            $hijri_date = explode('/', $mother_data->birth_date_h);
                                    ...
                                    <td style="text-align: center!important;">
                                        ...
                                        <a href="<?php echo base_url() . 'family_controllers/Family/DeleteMember/' . $mother_data->id . "/" . $result["mother_national_num"] ?>/mother"
                                           onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
                                    ...
                                    <tr id="<?= $s ?>">
                                        ...
                                        <td style=" width:15%;text-align: center!important;">
                                            ...
                                            ?>
                                                ...
                                                foreach ($members as $key => $value) { if ($row->member_relationship == $key) {
                                                    echo $value;
                                                        }  }
                                                ?>
                                           </td>
                                        <td style="width:15%;text-align: center!important;">
                                                ...
                                                <?php $gender_arr = array('', 'ذكر', 'أنثى');  for ($a = 1; $a < sizeof($gender_arr); $a++) {
                                                    $select = '';
                                        ...
                                        <td style="text-align: center!important;">
                                            ...
                                            <a href="<?php echo base_url() . 'family_controllers/Family/DeleteMember/' . $row->id . "/" . $result["mother_national_num"] ?>/f_members"
                                               onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
                                                <i class="fa fa-trash" aria-hidden="true" title="حذف"></i> </a></td>
                                    </tr>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tr id="">
                                                    ...
                                                    <td style="width:15%;text-align: center!important;">
                                                        ...
                                                        <!-- <input type="text"   value="<?= $member->birth_date_h ?>" onkeyup="GetAge(this.value,<?php echo $member->id; ?>)"  class="form-control docs-date" id="birth_date_h<?= $member->id . 'member' ?>" name="birth_date_h" data-validation="required" >-->
                                                    </td>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tr id="">
                                                ...
                                                <td style="width:15%;text-align: center!important;">
                                                    <input type="text" value="<?= $mother_data->m_birth_date_hijri ?>"
                                                           onfocusout="GetAge(this.value,<?php echo $mother_data->id; ?>)"
                                                           class="form-control docs-date"
                                                           id="birth_date_h<?= $mother_data->id . 'mother' ?>"
                                                           name="birth_date_h" data-validation="required"></td>
                                                <td style="width:15%;text-align: center!important;">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="health-details">
                        ...
                        <?php // echo '<pre>'; print_r($data_table_attached);?>
...
print_r($_SESSION);*/
                                    ...
                                    if (isset($result) && $result != null) {
                                        ...
                                        $out['input'] = 'ADD1';
                                        $out['input_title'] = 'حفظ ';
                                        $form = form_open_multipart("family_controllers/Family/InsertNewRegister_morfq");
                                    } ?>
                                    <?php echo $form ?>
                                ...
                                <td>
                                    <input type="file" data-validation="required" name="attach_files[]"
                                           class="form-control half needed"/>
...
<script>
    ...
    ?>
    $(document).ready(function () {
        $('a[href="#contact-details"]').tab('show');
    });
    <?php }?>
</script>

<script>
    function show_sweet_alert() {
        // var contioue_data = 0;
        swal({
                title: "هل تريد اضافة بيانات الافراد ؟",
                text: "",
                type: "warning",
            ...
            function (isConfirm) {
                ...
                /*   contioue_data = 1;
               if (contioue_data == 1) {
                   $('#continue_data').val(contioue_data);
                   $('#myform').submit();
               } else {
                   $('#myform').submit();
...
<script>
    function add_row_member() {
        ...
        var y = document.getElementById("person_relationship").value;
        var dataString = 'length=' + len + '&person=' + y;
        $.ajax({
            type: 'post',
        ...
        <script>
            ...
            function setDateFields1<?= $member->id ?>() {
                if (loop1<?= $member->id ?> === 0) {
                    <?php if (isset($member->birth_date_m) && !empty($member->birth_date_m)) {  ?>
                    loop1<?= $member->id ?>++;
                    date1<?= $member->id ?>.value = '<?=$member->birth_date_m?>';
                    date2<?= $member->id ?>.value = '<?=$member->birth_date_h?>';
