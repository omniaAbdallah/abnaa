...
<div class="col-xs-12 " >
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            ...
            <?php if(!empty($result)){ ?>
            <form action="<?php echo base_url();?>family_controllers/Family_letter/update_Insurance_letter/<?php echo $this->uri->segment(4); ?>/<?php echo $this->uri->segment(5); ?>/2" method="post">


                <?php }else{ ?>

                <form action="<?php echo base_url();?>family_controllers/Family_letter/Insurance_letter/<?php echo $this->uri->segment(4); ?>/2" method="post">
                    ...
                    <table id="example"  class="table table-bordered table-devices">
                        ...
                        <?php  foreach($letters as $row){  $link= $this->uri->segment(4);
                            ...
                            <tr >
                                ...
                                <td>
                                    <a href="<?php echo base_url().'family_controllers/Family_letter/update_Insurance_letter/'.$row->mother_national_num_fk.'/'.$row->letter_num.'/2'?>">
