...
<tr id="<?=$_POST['length']?>">
 ...
 <td style="width:15%;text-align: center!important;">
     <input type="text" onchange="GetAge(this.value)" onkeyup="GetAge(this.value)" class="form-control date_as_mask" id="member_birth_date_hijri<?=$_POST['length']?>" name="member_birth_date_hijri[]" data-validation="required" ></td>
 <td style="width:15%;text-align: center!important;">
     <input class=" form-control  " type="text" name="age[]" id="myage<?echo$_POST['length'];?>"  size="60"readonly/></td>
 <td style="width:15%;text-align: center!important;" id="categoriey_member_div<?=$_POST['length']?>"></td>
