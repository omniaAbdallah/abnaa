    ...
    jQuery(function($) {
        ...
        var calendar = $('#calendar').fullCalendar({
            ...
            eventRender: function(event, element) { 
                ...
                element.find('.fc-title').append("<br/>" + event.father_name + "<br/>رقم الملف: " + num); 
            }, 
            editable: true,
