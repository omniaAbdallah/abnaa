            ...
            <form id='' method='post'>\
                <div class='modal-body row'>\
                    <div class='col-sm-12 '><br>\
                        <div class='form-group col-sm-6'>\
                            <label class='label label-green half'>نوع البحث  <strong class='astric'></strong> </label>\
                            <select id='type' name='visit_search_type' class='form-control half input-style' data-validation='required' disabled>\
                                <option value=''>إختر</option>\
                                <?php
                                if(isset($types) && $types != null) {
                                    foreach($types as $type) { 
                        ...
                        <div class='form-group col-sm-6'>\
                            <label class='label label-green half'>الغرض من الزيارة  <strong class='astric'></strong> </label>\
                            <select id='purpose' name='visit_purpose_fk' class='form-control half input-style' data-validation='required' disabled>\
                                <option value=''>إختر</option>\
                                <?php
                                if(isset($purpose) && $purpose != null) {
                                    foreach($purpose as $type) { ?>
                        ...
                        <div class='form-group col-sm-6'>\
                            <label class='label label-green half'>الباحث<strong class='astric'></strong> </label>\
                            <select name='researcher_id_fk' id='researcher' class='form-control half input-style' data-validation='required' disabled>\
                                <option value=''>إختر</option>\
                                <?php
                                if(isset($emps) && $emps != null) {
                                    foreach($emps as $emp) { 
                        ...
                        <div class='form-group col-sm-6'>\
                            <label class='label label-green half'>ملاحظات<strong class='astric'></strong> </label>\
                            <input id='notes' name='manager_notes' type='text' class='form-control half input-style' data-validation='required' disabled>\
                        </div>\
                        <div class='form-group col-sm-6'>\
                        ...
                        <div class='form-group col-sm-6'>\
                            <label class='label label-green half'>حالة الزيارة<strong class='astric'>*</strong> </label>\
                            <select id='visit_status' name='visit_status' class='form-control confirmForm"+calEvent._id+" half input-style' data-validation='required'>\
                                <option value=''>إختر</option>\
                                <?php
                ...
                modal.find('#visit_status').val(calEvent.visit_status);
                ...
                modal.find('form').on('submit', function(ev){
                    ...
                    if(require == true){
                        ...
                        calEvent.visit_status = $(this).find("#visit_status").val();
                        calendar.fullCalendar('updateEvent', calEvent);
                        modal.modal("hide");
                        $.ajax({
                            url: '<?=base_url()?>family_controllers/FamilyCalender/updateResearcher',
                            data: 'end_time='+calEvent.end_time + '&id=' + calEvent._id + '&start_time=' + calEvent.start_time + '&visit_status=' + calEvent.visit_status,
                            type: "POST",
                            success: function(json) {
                                $('#'+calEvent._id).remove();
                                record = JSON.parse(json);
                                ...
                                $('#examplee tr:last').after('<tr id="'+render.id+'">\
                                    ...
                                    calendar.fullCalendar('renderEvent',
                                    {
                                        ...
                                        visit_status : render.visit_status,
                                        //allDay: allDay,
                                        className: render.className
                                    },);
                            }
