...
<div class="col-xs-12 " >
                        ...
                        <tr >
                          <!--  <td><?php echo $row->letter_num;?> / <?php echo$this->uri->segment(5);?></td> -->
                           ...
                           <td><?php echo $row->letter_num;?> / <?php echo $row->num;?> </td>
                            ...
                            <td>
                                <a style="line-height: 1.5; background-color: #009688;color: #fff; padding: 3px 2px; margin-left: 3px"  href="<?php echo base_url().'family_controllers/Family_letter/update_Civil_Status/'.$row->mother_national_num_fk.'/'.$row->letter_num.'/'.$this->uri->segment(5)?>">
    ...
    <td><button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#myModalfile<?php echo $row->letter_num;?>"> 
    
    <?php echo 'إرفاق خطاب الأحوال المدنية
'; ?></button>
    </td>
