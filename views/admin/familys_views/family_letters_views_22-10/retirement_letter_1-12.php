                    ...
                    <table  id="example"  class="table table-bordered table-devices">
                        ...
                        <?php  foreach($letters as $row){ 
                            ...
                            <tr >
                                ...
                                <td>
                                    <a  style="line-height: 1.5; background-color: #009688;color: #fff; padding: 3px 2px; margin-left: 3px" href="<?php echo base_url().'family_controllers/Family_letter/update_Retirement_letter/'.$row->mother_national_num_fk.'/'.$row->letter_num.'/'.$this->uri->segment(5)?>">
