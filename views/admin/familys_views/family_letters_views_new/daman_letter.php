    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            ...
            <form action="<?php echo base_url();?>family_controllers/Family_letter/update_daman_letter/<?php echo $this->uri->segment(4); ?>/<?php echo $this->uri->segment(5); ?>/4" method="post">
                ...
                <form action="<?php echo base_url();?>family_controllers/Family_letter/daman_letter/<?php echo $this->uri->segment(4); ?>/4" method="post">
                    ...
                    <table id="example"  class="table table-bordered table-devices">
                        ...
                        <?php  foreach($letters as $row){  $link= $this->uri->segment(4);
                            ...
                            <tr >
                                ...
                                <td>
                                    <a href="<?php echo base_url().'family_controllers/Family_letter/update_daman_letter/'.$row->mother_national_num_fk.'/'.$row->letter_num.'/2'?>">
                                        <i class="fa fa-pencil " aria-hidden="true"></i></a>
                                    <a    data-toggle="modal" data-target="#modal-delete<?php echo $row->letter_num;?>" ><i class="fa fa-trash"></i></a>

                                    <a  target="_blank" href="<?php echo base_url();?>family_controllers/Family_letter/print_letter/<?php echo $mother->mother_national_num_fk;?>/<?php echo $row->letter_type;?>/<?php echo $row->letter_num;?>/daman_letter"><i class="fa fa-print" aria - hidden = "true" ></i ></a>
                                </td>
