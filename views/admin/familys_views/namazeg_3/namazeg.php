...
.cke_toolbox span.cke_toolbar:nth-child(6),
...
*/
/*
#cke_21,#cke_28,#cke_36,#cke_41,#cke_51,#cke_74,#cke_78,#cke_88,#cke_91,#cke_94{
    display: none !important;
} 
*/
</style>
...
<div class="col-sm-12 no-padding">
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
        ...
        <div class="panel-body">
            <?php
            echo form_open_multipart('family_controllers/namazegs/Namazeg/insert');?>

            <div class="col-sm-12 form-group">
                <div class="col-sm-3  col-md-1 padding-4 ">
                    <label class="label label-green  ">رقم الخطاب 
 </label>
                    <input type="text" name="letter_rkm" class="form-control input-style" value="<?php echo $letter_number;?>"  readonly>
                </div>
                <div class="col-sm-3  col-md-2 padding-4 ">
                    <label class="label label-green  "> التاريخ </label>
                    <input type="text" name="letter_date" class="form-control input-style" value="<?php echo date('Y-m-d');?>"  readonly>
                </div>
                <div class="col-sm-2  col-md-2 padding-4 ">
                    <label class="label label-green  ">اللقب  </label>
                    <select  name="start_laqb"  id="start_laqb" data-validation="required" class="selectpicker no-padding form-control  form-control "
                ...
                <div class="col-sm-3  col-md-5 padding-4 ">
                    ...
                    <input type="text" name="geha_name" id="geha_name" class="form-control input-style">

                </div>
                <div class="col-sm-3  col-md-2 padding-4 ">
                    <label class="label label-green  ">نهاية اللقب  </label>
                    <select  name="end_laqb" id="end_laqb"  data-validation="required" class="selectpicker no-padding form-control  form-control "
                             data-show-subtext="true" data-live-search="true"   aria-required="true" >
                        <option  value="">اختر</option>
                        <?php if(!empty($greetings)){
                            foreach ($greetings as $greeting){ ?>
                            <option  data-title="<?=$greeting->title_setting?>"value="<?=$greeting->id_setting?>"
            ...
            <div class="col-sm-12 form-group">
             ...
             <div class="col-sm-3  col-md-1 padding-4 ">
                    ...
                    <input type="text" name="file_num" id="file_num"
                           ...
                           class="form-control input-style" value="" onkeyup="GetFamilyNum($(this).val());" >
                ...
                <div class="col-sm-3  col-md-2 padding-4 ">
                    ...
                    <select  name="namozeg_type_fk" id="namozeg_type_fk"  data-validation="required" class="selectpicker no-padding form-control  form-control "
                             data-show-subtext="true" data-live-search="true"   aria-required="true" >
                        <option value="">اختر</option>
                ...
                <div class="col-sm-3  col-md-2 padding-4 ">
                    ...
                    <input type="text" name="mawdo3" id="mawdo3" class="form-control input-style">
      ...
      <div class="col-sm-3  col-md-2 padding-4 ">
        <label class="label label-green  "><i class="fa fa-eye" aria-hidden="true"></i>
                ...
                <button type="button" onclick="GetNamozegDiv($('#namozeg_type_fk').val())"
                    ...
                    <span class="btn-label"><i class="glyphicon glyphicon-floppy-disk"></i></span>عرض الخطاب
                </button>
                    ...
                    foreach ($records  as  $value) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" title="تعديل"><i class="fa fa-pencil"></i></a>

                                <a onclick="/*$('#adele').attr('href', ''); #modal-delete*/" data-toggle="" data-target="" title="حذف"><i class="fa fa-trash"></i></a>
   ...
   var file_num =$('#file_num').val();
        if (value != 0 && value != '') {
            var dataString = 'id=' + value +'&start_laqb=' + start_laqb +'&header_tahia='+
                header_tahia +'&end_laqb='+ end_laqb +'&mawdo3='+ mawdo3 +'&geha_name=' + geha_name +'&file_num=' + file_num ;
            $.ajax({
                type: 'post',
