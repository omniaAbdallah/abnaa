<div class="col-sm-12 col-md-12 col-xs-12 ">
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
        ...
        <div class="panel-body">
            ...
            <form method="post" id="form" action="<?= base_url() ?><?php echo (isset($option))?'family_controllers/Setting/update_procedures_option_transform/'.$option->id :'family_controllers/Setting/procedures_option_transform'; ?>">
            ...
            <?php if (isset($options) && !empty($options) && $options!=null){?>
             ...
             <table id="example" class=" display table table-bordered   responsive nowrap" cellspacing="0" width="100%">
                 ...
                 <tr>
                     ...
                     <td >
                         <a href="<?php echo base_url().'family_controllers/Setting/edit_procedures_option_transform/'.$options[$record]->id ?>" title="تعديل">
                             <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
                         <span> </span>
                         <a href="<?=base_url()."family_controllers/Setting/delete_procedures_option_transform/".$options[$record]->id ?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
