<div class="col-sm-12 col-md-12 col-xs-12 ">
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
        ...
        <div class="panel-body">
           <?php  if(isset($record)){
                       $out['form']='family_controllers/Setting/update_files_member_status_setting/'.$record->id;
                    }else {
                       $out['form']='family_controllers/Setting/files_member_status_setting';
                    } ?>
                ...
                <table id="example" class=" display table table-bordered   responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <?php $x=1; foreach ($all as $record=>$value){?>
                        <tr>
                            ...
                            <td >
                                <a href="<?php echo base_url().'family_controllers/Setting/update_files_member_status_setting/'.$all[$record]->id ?>" title="تعديل">
                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
                                <span> </span>
                                <a href="<?=base_url()."family_controllers/Setting/delete_files_member_status_setting/".$all[$record]->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
