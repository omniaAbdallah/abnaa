                        ...
                        <div class="col-sm-12 col-xs-12">
                            ...
                            <div class="form-group col-md-2 padding-4  col-sm-4 col-xs-12">
                                ...
                                <input class="textbox form-control" type="text" name="CDay"
                                       ...
                                       onkeypress="return isNumberKey(event)"
                                       onkeyup="moveOnMax(this,document.getElementById('CMonth'))" placeholder="day"
                                       id="CDay"
                                ...
                                <input class="textbox4 form-control" type="text" name="CYear" id="CYear" pattern="\d*"
                                       ...
                                       placeholder="year" id="CYear" size="20" maxlength="4"
                        ...
                        <div class="col-sm-12 col-xs-12">
                            ...
                            <div class="col-xs-12 ">
                                ...
                                <div class="form-group col-md-2 padding-4 col-sm-4 col-xs-12">
                                    ...
                                    <select <?= $disabled_input ?> name="persons_status" id="halt_elmostafid_member"
                        ...
                        <div class="col-sm-12 col-xs-12">
                            ...
                            <div class="form-group col-md-2 padding-4  col-sm-4 col-xs-12">
                                ...
                                <input type="text" name="member_dis_date_ar" id="member_dis_date_ar"
                                       value="<?php echo $member_dis_date_ar ?>"
                            ...
                            <div class="col-sm-12 col-xs-12">
                                ...
                                <div class="form-group col-md-2 padding-4  col-sm-4 col-xs-12">
                                    <label class="label label-green  half">وضع الحالة المرض/الإعاقة <strong></strong>
                                    </label>
                            ...
                            <div class="form-group col-md-2 padding-4 col-sm-4 col-xs-12">
                                <label class="label label-green  half">مستفيد من التأهيل الشامل <strong></strong>
                                </label>
                            ...
                            <div class="form-group col-md-2 padding-4 col-sm-4 col-xs-12">
                                ...
                                <input type="text"
                                    <?php if (!empty($result['member_comprehensive_rehabilitation'])) {
                                       ...
                                       name="member_rehabilitation_value" id="member_rehabilitation_value"
                    ...
                    <div class="panel-body">
                        <div class="col-sm-12 col-xs-12 no-padding">
                            ...
                            <div class="form-group col-md-2 padding-4  col-sm-4" id="options_school">
                                ...
                                <input type="text" ondblclick="$('#myModal').modal('show'); get_school('myDiv_sanfe')"
                                       name="" id="school_id_fk"
                                       class="form-control half input-style"
                        ...
                        <div class="col-sm-12 col-xs-12 no-padding">
                            ...
                            <div class="form-group col-md-6 padding-4  col-sm-4 col-xs-12">
                                <button type="button" style="margin-bottom: 10px;"
                                        onclick="add_row_education_problems()" class="btn btn-success btn-next"/>
                                <i class="fa fa-plus"></i> اضافة المشكلات التعليمية </button><br>
