...
<!--                                    <td>حالة الطلب</td>-->
                                ...
                                foreach ($main_attach_files as $file_row) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $file_row->title_setting ?>
                                            <input type="hidden"  name="taslem[]" value="no" >
                                        </td>
                                        <!--<td>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <a class="btn btn-danger btn-sm" onclick=' swal({
                                            ...
                                            setTimeout(function(){window.location="<?php echo base_url() . 'family_controllers/Family/delete_talb_mostandat/' . $row['talb_mostand_id'] . '/' . $basic_family['mother_national_num'] . '/' . $from_page ?>";}, 500);
                                            });'>
