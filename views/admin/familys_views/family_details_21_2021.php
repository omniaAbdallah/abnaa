                                        ...
                                        <table class=" display table table-bordered table-striped table-hover">
                                            ...
                                            foreach ($all_actions_in_family as $family_act){
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $family_act->publisher_name; ?></td>
                                                    <td><?php echo date(" h:i:s A ",$family_act->date_s); ?></td>
                                                    <td>
                                                        <?php
                                                        if ($family_act->process==1 ||$family_act->process==2 ){
                                                            if(!empty($family_act->reason_name)){
                                                                echo $family_act->reason_name;
                                                            } else{
                                                                echo 'غير محدد'  ;
                                                            }

                                                        } else{
                                                            if(!empty($family_act->reason)){
                                                                echo $family_act->reason;
                                                            } else{
                                                                echo 'غير محدد'  ;
                                                            }
                                                        }
...
<div class="col-sm-6">
    ...
    <select class="form-control  " name="procedure_id_fk"  id="procedure_id_fk" data-validation="required"
...
<?php } elseif($value->id == 4 ) { ?>
                            <div class="col-md-3">
                                ...
                                <input  type="text" name="filenum" class="form-control  "  value="
  ...
  <?php }elseif($value->id == 6 ){ ?>
    ...
    <div class="col-md-3">
        <label class=" label ">طبيعة المحور </label>
    ...
    <div class="col-md-3">
        ...
        <select class="form-control  " name="condition" data-validation="required" aria-required="true" >
            ...
            <?php if (isset($file_status) && $file_status != null && !empty($file_status)){
                ...
                <div class="col-sm-3">
                    <label class="label  ">قرارات اللجنة </label>
                    <select class="form-control  txt2" name="lagna_descision_id_fk" id="option_lagna_desiton">
...
<!--
  ...
  -->                        
                        ...
                        <?php if($value->id == 1 || $value->id == 2 || $value->id == 4){
                            ...
                            ?>
                            <div class="col-sm-6">
                                <label class="label ">أسباب <?php echo $arr_names[$value->id];?> الطلب: </label>
                                <select class="form-control  " name="reason_id_fk"
                                        data-validation="required" aria-required="true">
                                    <option value="">اختر</option>
