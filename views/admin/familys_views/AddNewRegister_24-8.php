...
print_r($_SESSION);*/
            ...
            <div class="col-sm-12 form-group">
             <div class="col-sm-6  col-md-3 padding-4 ">
                ...
                <div class="col-sm-6 col-md-2 padding-4">
                    ...
                    <select  name="marital_status_id_fk"  data-validation="required" class="selectpicker no-padding form-control choose-date form-control "
            ...
            <div class="col-sm-12 form-group">
                ...
                <div class=" col-sm-6  col-md-2 padding-4">
                    ...
                    <select name="register_place" class="selectpicker no-padding form-control choose-date form-control "  data-validation="required"   data-show-subtext="true" data-live-search="true"   aria-required="true">
                        <option value=""> اختر</option>
                        <?php
                ...
                <div class=" col-sm-6  col-md-1 padding-4">
                    ...
                    <select name="person_relationship"  id="person_relationship" data-validation="required" aria-required="true" data-show-subtext="true" data-live-search="true"
                            onchange="get_num_fk(this.value);" class="selectpicker no-padding form-control choose-date form-control">
                        <option value="">إختر</option>
                ...
                -->  <select class="form-control  selectpicker"  name="center_id_fk" data-show-subtext="true" data-live-search="true"
            ...
            <div class="col-sm-12 form-group" >
                ...
                <div class=" col-sm-6  col-md-2 padding-4">
                    ...
                    <!--  <input type="text" name="full_name_order"  value="<?php // if(isset($result)){ echo $result["full_name_order"];} ?>" class="form-control two_three input-style" placeholder="أدخل البيانات" data-validation="required">
               -->
                    <select name="district_id_fk" class="form-control  " id="center_option" name="" data-show-subtext="true" data-live-search="true"
                ...
                <div class="form-group col-sm-3 padding-4">
                    ...
                    <input class="textbox form-control" type="text" name="retirement" value="<?php if(isset($result)){ echo $result["retirement"];} ?>" placeholder="تقاعد" style="width: 33.33%;float: right;" >
                    <input class="textbox form-control" type="text" name="insurance" value="<?php if(isset($result)){ echo $result["insurance"];} ?>" placeholder="تأمينات" style="width: 33.33%;float: right;" >
                    <input class="textbox4 form-control" type="text" name="guarantee" value="<?php if(isset($result)){ echo $result["guarantee"];} ?>" placeholder="ضمان" style="width: 33.33%;float: right;" >
                </div>
                ...
                <div class=" col-sm-6  col-md-2 padding-4">
                    ...
                    <input placeholder="إدخل البيانات " id="h_rent_amount" type="text"
                           onkeypress="validate_number(event);" class="  form-control  " data-validation="required"
...
<!--               
 <div class=" col_md_30  col-sm-6  col-md-3 padding-4">
   ...
   <div class=" col-md-3  col-sm-6  col-md-6 padding-4">
                    ...
                    <input placeholder="من" id="m13h" class="form-control  input-style " type="text" data-validation="required"  
                        ...
                        <?php   if(isset($result['right_time_from'])){ echo $result['right_time_to'];} else{echo "من";} ?>" style="width: 45%; float: right;margin-left: 10px;    text-align: center;" >
                        <input placeholder="إلى" id="m12h" type="text"
                     class="form-control  input-style  " data-validation="required"
                           name="right_time_from" value="
                        <?php if(isset($result['right_time_from'])) { echo $result['right_time_from']; }else{echo "إلى";} ?>" style="width: 45%; float: right;    text-align: center;" >
   </div>
...
-->
            ...
            <br />
                ...
                <button type="button" class="btn btn-labeled btn-success " onclick="add_row_member()"  style="border-top-left-radius: 14px;border-bottom-right-radius: 14px;">
                        <span class="btn-label"><i class="glyphicon glyphicon-plus"></i></span>إضافة أفراد الاسرة       </button>
                    ...
                    if(isset($mother_data) && !empty($mother_data)){
                        ...
                        <tr id="<?=$s?>">
                            ...
                            <td style=" width:15%;text-align: center!important;">
                                ...
                                <select name="" id="member_relationship"  disabled  class=" form-control" >
                                    <option value="">إختر</option>
                                    <?php
                                ...
                                <input type="hidden" name="" value="<?=$mother_data->m_relationship?>"></td>
                            <td style="width:15%;text-align: center!important;">
                            ...
                            <td style="width:15%;text-align: center!important;">
                                <select   id="m_card_source"  data-validation="required" class=" form-control " disabled >
                                    <option value="">إختر</option>
        ...
        <?php  } } ?>
            ...
            <div class="col-md-12">
             <div class="form-group col-xs-12">
                <input type="hidden" id="count_row" value="0" />
                     ...
                     <button type="button" class="btn btn-labeled btn-success add_attchments"  onclick="add_row_attach(<?php if(isset($all_attach_file) && !empty($all_attach_file)){ 
                                      echo count($all_attach_file)+1;}else{echo 0;}?>);" style="border-top-left-radius: 14px;border-bottom-right-radius: 14px;">
                        <span class="btn-label"><i class="fa fa-files-o" aria-hidden="true"></i></span>إضافة مرفقات  &nbsp&nbsp&nbsp&nbsp    </button>
                
                    <br><br>
              </div>

                <table class="table table-bordered table-striped"  <?php if(!isset($data_table_attached) && empty($data_table_attached)){ ?>  style="display: none"  <?php } ?> id="table_attach_files">
                    <thead >
                    <tr class="info">
                        <th>م</th>
            ...
            <div class="form-group col-sm-4">
               ...
               <!-- <input tabindex="11" type="radio" id="square-radio-1"
                    ...
                    else {echo  '';} ?> style="    width: 24px;height: 24px;" > -->
                    <div class="skin-square">
                         <div class="i-check">
                              <input tabindex="11" type="radio" id="square-radio-1" name="square-radio"   <?php if(isset($result) && $result!=null){ echo "checked";}
                        else {echo  '';} ?>>
...
<div class="col-xs-12 no-padding" >
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        <div class="panel-heading">
            <h3 class="panel-title">طلبات الأسر الجديدة </h3>
        </div>
        <div class="panel-body">
                    ...
                    <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                        ...
                        <?php  $x=1; foreach ($records as $record ):
                            ...
                            <tr>
                                ...
                                <button title="تفاصيل بيانات مقدم الطلب" class="btn btn-sm btn-add"
        data-toggle="modal" data-target="#exampleModal"
        onclick="order_details(<?php echo $record->id; ?>)" style="padding: 0 4px;"><i
                             ...
                             <!--   <td><?php echo $mother_name;?></td>-->
                              ...
                              <!--    <td><?php echo $record->sela_name; ?></td>-->
                                ...
                                <td>
                                   ...
                                   <a title="طباعة الإقرار" href = "<?php echo base_url('family_controllers/Family_details/printEqrar').'/'.$record->mother_national_num ?>" target = "_blank" > <i class="fa fa-print" aria-hidden = "true" ></i > </a>
  ...
  <td>
    ...
    <button type="button" class="btn btn-sm btn-add" data-toggle="modal"
     data-target="#modal-files-<?php echo $record->mother_national_num;?>"  style="padding: 0 4px;">المستندات
    </button>
...
<div class="btn-group">
    <button type="button" class="btn btn-sm btn-success"  style="padding: 0 4px;">خطابات</button>
...
<li><a target="_blank" href="<?php echo base_url();?>family_controllers/Family_letter/Passports/<?php echo  $record->mother_national_num;?>/<?php echo $record->file_num; ?>">خطاب الجوازات </a></li>
...
<li><a target="_blank" href="<?php echo base_url();?>family_controllers/Family_letter/daman_letter/<?php echo  $record->mother_national_num; ?>/<?php echo $record->file_num; ?>">خطاب الضمان</a></li>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-danger"  style="padding: 0 4px;">اضافه</button>
...
<td style="color: black;">
   ...
   -->
<td style="color: black;">
    <button data-toggle="modal" data-target="#modal-process-procedure-<?php echo $record->id;?>" 
      class="btn btn-sm btn-info"  style="padding: 0 4px;"><i
       ...
       <td>
                ...
                <?php  $x=1; foreach ($records as $record ):?>
                    ...
                    <div class="modal fade" id="modal-process-procedure-<?php echo $record->id;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-success" role="document"  style="width: 50%">
                            <div class="modal-content">
...
></textarea> -->
<input type="text"class="form-control half input-style" name="reason"   />
            </div>
        </div>
...
-->
    ...
    <div class="modal-footer" style="display: inline-block; width: 100%;">
         ...
         <button type="button"  class="btn btn-labeled btn-danger " data-dismiss="modal" >
                        <span class="btn-label"><i class="glyphicon glyphicon-remove"></i></span>إغلاق       </button>
                   
                   
        
        <button type="submit" id="button" class="btn btn-labeled btn-success " name="go" value="<?php echo $record->id;?>" style="float: right;">
                            ...
                            <tr id="">
                                ...
                                <td style="width:15%;text-align: center!important;">
                                    ...
                                    <small id="member_card_num_span" class="span-validation"></small>
                                       ...
                                       <td style="width:10%;text-align: center!important;">
                                    <select  name="member_card_source" id="m_card_source"  data-validation="required" class=" form-control " style="wi" >
                                        <option value="">إختر</option>
                                        <?php if(!empty($id_source)){ foreach ($id_source as $record_source){
                                ...
                                <td style="width:15%;text-align: center!important;">
                                    <input type="text"   value="<?= $member->member_birth_date_hijri ?>" onfocusout="GetAge(this.value,<?php echo $member->id;?>)" class="form-control docs-date" id="member_birth_date_hijri<?=$member->id.'member'?>" name="member_birth_date_hijri" data-validation="required" ></td>
                                <td style="width:15%;text-align: center!important;">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr id="">
                            ...
                            <td style="width:10%;text-align: center!important;">
                                <select  name="member_card_source" id="m_card_source"  data-validation="required" class=" form-control "  >
                                    <option value="">إختر</option>
                                    <?php if(!empty($id_source)){ foreach ($id_source as $record_source){
                                        $select='';if($record_source->id_setting == $mother_data->m_card_source){ $select='selected'; }
                                        ?>
                            ...
                            <td style="width:15%;text-align: center!important;">
                                <input type="text"   value="<?= $mother_data->m_birth_date_hijri ?>" onfocusout="GetAge(this.value,<?php echo $mother_data->id;?>)" class="form-control docs-date" id="member_birth_date_hijri<?=$mother_data->id.'mother'?>" name="member_birth_date_hijri" data-validation="required" ></td>
                            <td style="width:15%;text-align: center!important;">
                                <?php   if(!empty($mother_data->m_birth_date_hijri)){ $hijri_date=explode('/',$mother_data->m_birth_date_hijri);
                                    $age = $current_year - $hijri_date[2];} else {
                                    $age = '';
