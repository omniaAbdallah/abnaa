                   ...
                   <div class="form-group col-sm-12 col-xs-12">
                    ...
                    <div class="col-xs-11 col-xs-offset-1 ahwal_style">
                                        ...
                                        <input type="radio" name="radio_end" data-title=""
                                             ...
                                             <label style="font-weight:bold;     font-size: 24px;">            يستفيد
                                             </label>
                                       <input type="radio" name="radio_end" data-title=""
                                               ...
                                               <label style="font-weight:bold;     font-size: 24px;">    لا يستفيد
                                       </label>
...
<script >
      ...
      window .print();
      setTimeout(function () {
          window.location.href ="<?php echo base_url();?>family_controllers/namazegs_gamiaa/Namazeg_gamiaa";
        }, 1000);
</script >
