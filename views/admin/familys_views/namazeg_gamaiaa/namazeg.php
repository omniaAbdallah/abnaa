...
<div class="col-sm-12 no-padding">
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
        ...
        <div class="panel-body">
            ...
            if (!empty($result)) {
                echo form_open_multipart('family_controllers/namazegs_gamiaa/Namazeg_gamiaa/update', array('id' => 'myform'));
                ...
                $namozeg_type_fk = $result['namozeg_type_fk'];
                $mawdo3 = $result['mawdo3'];
                $responsable_name = $result['responsable_name'];//1-5-om

            } else {
                echo form_open_multipart('family_controllers/namazegs_gamiaa/Namazeg_gamiaa/insert', array('id' => 'myform'));
            ...
            <div class="col-sm-12 form-group">
                <div class="col-sm-3  col-md-1 padding-4 ">
                   ...
                   <!-- <input type="text" name="letter_rkm" class="form-control input-style"
                         id="letter_rkm"   value="<?php echo $letter_rkm; ?>" readonly /> -->
                                   ...
                                   <input type="text" name="letter_rkm_" class="form-control input-style"
                ...
                <div class="col-sm-3  col-md-2 padding-4 ">
                    ...
                    <input type="text" name="letter_date" class="form-control input-style"
                ...
                <div class="col-sm-3  col-md-5 padding-4 ">
                    ...
                    <input type="text" name="geha_name" id="geha_name" readonly value="<?php echo $geha_name; ?>"
                           class="form-control input-style" style="width: 92%;float: right">
            ...
            <div class="col-sm-12 form-group">
                ...
                <div class="col-sm-3  col-md-1 padding-4 ">
                    ...
                    <input type="text" name="file_num" id="file_num" value="<?php echo $file_num; ?>"
                           ...
                           class="form-control input-style" value="" onblur="GetFamilyNum($(this).val());">
                ...
                <div class="col-sm-3  col-md-3 padding-4 ">
                    ...
                    <input type="text" name="father_name" id="father_name" value="<?php echo $father_name; ?>"
                           class="form-control input-style" readonly>
                </div>


  <div class="col-sm-3  col-md-3 padding-4 ">
                    <label class="label label-green  ">اسم المسئول </label>
                    <input type="text" class="form-control input-style" name="responsable_name"
                           id="responsable_name" style="width: 86%;float: right" value="<?= $responsable_name ?>">
                    <button type="button" data-toggle="modal"
                            data-target="#myModalInfo_family"
                            onclick="get_family_mumber($('#file_num').val())"
                ...
                <div class="col-sm-3  col-md-2 padding-4 ">
                    ...
                    <select name="namozeg_type_fk" id="namozeg_type_fk" data-validation="required"
                            class="selectpicker no-padding form-control  form-control "
                            data-show-subtext="true" data-live-search="true" aria-required="true">
                        <option value="">اختر</option>
                        <?php foreach ($letters_type_arr as $value) { ?>
                            <option value="<?php echo $value->id; ?>"
                                ...
                                <?php if (!empty($namozeg_type_fk)) {
                                    if ($namozeg_type_fk == $value->id) {
                                        echo 'selected';
                                    }
                                } ?>
                        ...
                        <div class="col-xs-12">
                            <div class="personality">
                                ...
                                <div class="col-xs-7 ahwal_style">
                                    <h4 class=""
                                        style="font-weight: bold !important;font-size: 20px !important;"><?php if(!empty($titles_edit[$result['start_laqb']])){ echo $titles_edit[$result['start_laqb']]['title_setting']; } ?>/<?php echo $result['geha_name'];?>  </h4>
                                </div>
                                <div class="col-xs-3">
                                    <h4 class=""
                                        style="font-weight: bold !important;font-size: 20px !important;"><?php if(!empty($greetings_edit[$result['end_laqb']])){ echo $greetings_edit[$result['end_laqb']]['title_setting']; } ?> </h4>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                        <input type="text" class="form-control input-style"
                                                               ...
                                                               id="responsable_name" style="width: 80%;float: right"
                                                               value="<?= $result['responsable_name'] ?>">
                                                        <?php if (!empty($family_members)) { ?>
                                                            <select class="form-control input-style"
                                                                    onchange="$('#responsable_name').val($(this).val())">
                                                                <option></option>
                                                                <option value="<?= $family_members->full_name ?>"><?= $family_members->full_name . '(أم)' ?>
                                                                    "
                                                                </option>
                                                                <?php foreach ($family_members->sons as $family_member) { ?>
                                                                    <option value="<?= $family_member->member_full_name ?>"><?= $family_member->member_full_name . '(أبناء)' ?> </option>
                                                                <?php } ?>
                                                            </select>
                                                        <?php } ?>
                                                    </td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="AttachTable">
                    ...
                    <?php
                    echo form_open_multipart('family_controllers/namazegs_gamiaa/Namazeg_gamiaa/add_morfaq');
                    ?>
            ...
            <div class="modal-footer" style="display: inline-block;width: 100%">
                ...
                <button type="submit" class="btn btn-success btn-labeled" style="display: inline-block;float: right;" onclick="GetAttachTable()"
                        name="add_attach"     id="saves"  data-dismiss="modal"><span class="btn-label"><i class="glyphicon glyphicon-floppy-disk"></i></span>حفظ</button>
                <button type="button" class="btn btn-danger btn-labeled"
                        data-dismiss="modal"><span class="btn-label"><i class="glyphicon glyphicon-remove"></i> </span>إغلاق</button>
                ...
                <table id="" class="example table table-bordered table-striped" role="table">
                    ...
                    foreach ($records as $value) {
                        ...
                        <tr>
                            ...
                            <td><?php if(isset($value->mawdo3) and $value->mawdo3 != null){ echo $value->mawdo3; } ?></td>
                            <td>
                         <span style="font-size: 12px; color: white !important; font-weight: normal;width: 141px;"
                            ...
                            <td>
                                ...
                                <a href="<?php echo base_url() . 'family_controllers/namazegs_gamiaa/Namazeg_gamiaa/edit/' . $value->letter_rkm ?>"
...
<?php } ?>
                                   ...
                                   <a href="<?php echo base_url() . 'family_controllers/namazegs_gamiaa/Namazeg_gamiaa/printNamazeg/' . $value->letter_rkm ?>"
                                   title="طباعه"><i class="fa fa-print"></i></a>                  
                                            
                                            
                                          <button type="button" class="btn btm-sm btn-labeled btn-inverse " id="attach_button" onclick="put_value(<?php echo $value->id;?>,<?php echo $value->letter_rkm;?>)" data-toggle="modal" data-target="#myModal_attach">
                                    <span class="btn-label" style="padding: 1px 7px;"><i class="glyphicon glyphicon-cloud-upload"></i></span>
                                    اضافة مرفق
                                </button>         
...
<script>
    ...
    function load_table() {
        ...
        var oTable_usergroup = $('#my_table').DataTable({
            dom: 'Bfrtip',
            "ajax": '<?php echo base_url(); ?>family_controllers/namazegs_gamiaa/Namazeg_gamiaa/getFamilyTable',
    ...
    function GetNamozegDiv(value) {
        ...
        if (value != 0 && value != '') {
            var dataString = 'id=' + value + '&start_laqb=' + start_laqb + '&header_tahia=' +
                header_tahia + '&end_laqb=' + end_laqb + '&mawdo3=' + mawdo3 + '&geha_name=' + geha_name + '&file_num=' + file_num +'&letter_rkm='+letter_rkm + '&responsable_name=' + responsable_name;
            $.ajax({
                type: 'post',
                url: '<?php echo base_url() ?>family_controllers/namazegs_gamiaa/Namazeg_gamiaa/getNamozegDetails',
                data: dataString,
                dataType: 'html',
                cache: false,
...
<script>
   ...
   function GetFamilyNum(code) {
        ...
        if( code != '') {
            $.ajax({
                type: 'post',
                url: '<?=base_url()?>family_controllers/namazegs_gamiaa/Namazeg_gamiaa/getFamilyNum',
                data: dataString,
                cache: false,
    ...
    function GetFamilyNum(code) {
        ...
        $.ajax({
            ...
            success: function (json_data) {
                ...
                if( parseInt(JSONObject['final_suspend'])!== 4 && parseInt(JSONObject['final_suspend']) !==' '){
    ...
    function add_geha(value) {
      ...
      //  alert(value);
        ...
        if (value != 0 && value != '' && mob != ' ' && address != ' ') {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo base_url() ?>family_controllers/namazegs_gamiaa/Namazeg_gamiaa/insert_geha_ajax',
                data: dataString,
                dataType: 'html',
                cache: false,
                success: function (html) {
...
<script>
    function Delete_namozeg(value) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                window.location.href = "<?php echo base_url();?>family_controllers/namazegs_gamiaa/Namazeg_gamiaa/Delete_namozeg/" + value;
...
<script>
    ...
    function details(value) {
        ...
        if (value != 0 && value != '') {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo base_url() ?>family_controllers/namazegs_gamiaa/Namazeg_gamiaa/getDetailsDiv',
                data: dataString,
                dataType: 'html',
                cache: false,
                success: function (html) {
...
<script>
    ...
    function update_geha(id) {
        ...
        $.ajax({
            url :"<?php echo base_url() ?>family_controllers/namazegs_gamiaa/Namazeg_gamiaa/getById",
            type : "Post",
            dataType : "html",
            data: {id:id},
        ...
        $('#update').on('click',function() {
            ...
            $.ajax({
                url :"<?php echo base_url() ?>family_controllers/namazegs_gamiaa/Namazeg_gamiaa/update_geha",
                type : "Post",
                dataType : "html",
  ...
  /*  function update_geha(id) {
    ...
    //    return;
        ...
        $('#update').prop('onclick', null);
        // $('#update').removeAttr("type").attr("type", "submit");
        ...
        $('#update').on('click',function () {
            ...
            $.ajax({
                ...
                type : "Post",
                dataType : "html",
                data: {geha_title:geha_title,address:address,mob:mob,id:id},
                success: function (html) {
                  //  alert('hh');
                    $('#geha_title').val(' ');
                    $('#address').val(' ');
                  ...
                  setTimeout(function(){  window.location="<?= base_url()?>family_controllers/namazegs_gamiaa/Namazeg_gamiaa"; }, 4000);

                  //  $('#myModalInfo').modal('hide');
                 //   window.location="<?= base_url()?>family_controllers/namazegs_gamiaa/Namazeg_gamiaa";
...
<script>
    function put_value(id,rkm)
    {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>family_controllers/namazegs_gamiaa/Namazeg_gamiaa/get_attaches",
            data: {rkm:rkm},
    ...
    function delte_geha(id) {
      //  confirm('هل انت متأكد من عملية الحذف ؟');
        ...
        if (r == true) {
            $.ajax({
                type:'post',
                url: '<?php echo base_url() ?>family_controllers/namazegs_gamiaa/Namazeg_gamiaa/delete_geha',
                data:{ id:id},
                dataType: 'html',
                cache:false,
                success: function(html){
...
<script>
    function get_family_mumber(file_num) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>family_controllers/namazegs_gamiaa/Namazeg_gamiaa/family_member',
