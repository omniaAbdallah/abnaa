...
<div class="col-sm-12  " >
	<div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
		<div class="panel-heading">
			<h3 class="panel-title">الأجهزة المنزلية</h3>
		</div>
		...
		<div class="panel-body">
                ...
                <table class="table table-bordered" id="tab_logic">
                    ...
                    foreach($result as $row): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php  echo base_url()?>family_controllers/Family/delete_device/<?php   echo $row->id ;?>/<?php echo$mother_national_num;?>">
            ...
            <div class="col-md-12">
                <div class="form-group col-sm-8">
                    <label class="label label-green  half">عدد الأجهزة <strong class="astric">*</strong></label>
                ...
                <div class="col-lg-6 input-grup">
                    <div class="alert alert-success">
                        <strong>من فضلك</strong>  الرجاء إدخال عدد الأجهزة
                    </div>
                </div>
            </div>
...
<script>
	function lood(num){
		if(num>0 && num != '')
		{
			...
			$.ajax({
				type:'post',
				url: '<?php echo base_url() ?>family_controllers/Family/devices/<?php echo$mother_national_num;?>',
				data:dataString,
				dataType: 'html',
				cache:false,
