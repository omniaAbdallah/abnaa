        ...
        <div class="panel-body">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group col-sm-4 col-xs-12">
                    ...
                    <select  name="member_person_type" class="selectpicker no-padding form-control choose-date form-control half"  data-show-subtext="true" data-live-search="true"  data-validation="required"  aria-required="true">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group col-sm-4 col-xs-12">
                    ...
                    <input type="text" name="member_card_num"   id="member_card_num" data-validation="required" onkeyup="chek_length('member_card_num')" value="<?php echo $member_card_num?>" onkeypress="validate_number(event)" class="form-control half input-style" />
                ...
                <div class="form-group col-sm-4 col-xs-12">
                    ...
                    <select  name="member_card_source" id="member_card_source" class="selectpicker no-padding form-control choose-date form-control half"  data-show-subtext="true" data-live-search="true"  data-validation="required"  aria-required="true">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group col-sm-4 col-xs-12"  >
                    ...
                    <select  name="member_house_check" id="eldar" class=" no-padding form-control choose-date form-control half " data-validation="required" aria-required="true"  >
                        <option value="">اختر</option>
                        <?php
                ...
                <div class="form-group col-sm-4 col-xs-12">
                    ...
                    <select class=" no-padding form-control choose-date form-control half" name="member_house_id_fk"  id="member_house_id_fk" <?php if($result['m_female_house_id_fk']==""){?> disabled=""<?php }?>>
                        <option value="">اختر</option>
                        <?php
                ...
                <div class="form-group col-sm-4 col-xs-12">
                    ...
                    <select name="member_education_level" id="member_education_level" class="form-control half"  data-validation="required"  aria-required="true">
                        <option value="">إختر</option>
                ...
                <div class="form-group col-sm-4 col-xs-12">
                    ...
                    <select name="member_study_case" id="member_study_case" class="form-control half" data-validation="required"  aria-required="true" >
                        <option value="">إختر</option>
                ...
                <div class="form-group col-sm-4 col-xs-12">
                    ...
                    <select name="member_academic_achievement_level" id="member_academic_achievement_level" class="form-control half" >
                        <option value="">إختر</option>
                ...
                <div class="form-group col-sm-4">
                    ...
                    <input type="text" name="school_cost"  id="school_cost"  onkeypress="validate_number(event);" class="form-control half input-style" placeholder="تكاليف الدراسة"  data-validation="required"   value="<?php echo$school_cost; ?>" />
                </div>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="form-group col-sm-4">
                    ...
                    <input type="text" name="member_mob"  id="member_mob"   onkeyup="chek_length('member_mob');"  onkeypress="validate_number(event);" class="form-control half input-style" placeholder="رقم الجوال "  data-validation="required" value="<?php echo$member_mob; ?>"/>
            ...
            <div class="col-md-12">
                ...
                <div class="form-group col-sm-4">
                    <button type="submit" name="<?php echo $button;?>" value="<?php echo $button;?>"  class="btn btn-blue btn-previous" id="buttons">حفظ </button>
                </div>
            </div>
            ...
            <?php if(isset($member_data) && $member_data!=null): ?>
                <table class="table table-bordered" style="width:100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php $age='';
                            if($mothers_data[0]->m_birth_date_hijri_year !='' && $mothers_data[0]->m_birth_date_hijri_year !=0){

                            $age=$cuttent_higry_year-$mothers_data[0]->m_birth_date_hijri_year;
                            }
                            echo $age." عام";
                            ?>
                        </td>
