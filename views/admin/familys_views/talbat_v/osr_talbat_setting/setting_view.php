                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        if (isset($get_setting) && !empty($get_setting)) {
                                            ...
                                            echo form_open_multipart('family_controllers/talbat/Setting/UpdateSitting/'.$id . '/' . $key);
                                        } else {
                                            $title = '';
                                          
                                            echo form_open_multipart('family_controllers/talbat/Setting/AddSitting/' . $key . '/' . $key);
                                        }
                                        ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#" onclick='swal({
                                                                    ...
                                                                    function(){
                                                                    window.location="<?php echo base_url().'family_controllers/talbat/Setting/UpdateSitting/'.$value->id . "/" . $key ?>";
                                                                    });'>
                                                                ...
                                                                <a href="#" onclick='swal({
                                                                    ...
                                                                    window.location="<?= base_url()."family_controllers/talbat/Setting/DeleteSitting/" . $value->id . "/" . $key ?>";
                                                                    });'>
