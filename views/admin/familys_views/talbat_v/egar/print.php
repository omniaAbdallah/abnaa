            ...
            <div class="personality">
                ...
                <div class="col-xs-12 no-padding">
                    <div class="form-group col-sm-12 col-xs-12">
                             <h4>نتقدم إليكم بطلب صرف مساعدة إيجار منزل وذلك نظرا لحاجاتنا إليها ، لذا نأمل من سعادتكم التوجيه إلى من يلزمه الأمر بعمل اللازم.</h4>
                    </div>
                    <div class="form-group col-sm-12 col-xs-12">
...
<script>
      ...
      /*setTimeout(function () {
          window.location.href ="<?php echo base_url();?>family_controllers/talbat/Talb_egar";
        }, 1000);*/
</script>