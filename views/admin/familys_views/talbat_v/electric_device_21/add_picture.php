...
<script>
    ...
    closeOnConfirm: false
        ...
        if(error == '') {
            $.ajax({
                url:"<?php echo base_url(); ?>family_controllers/talbat/Talb_electric_device/upload_img", //base_url() return http://localhost/tutorial/codeigniter/
                method:"POST",
                data:form_data,
                contentType:false,
                cache:false,
...
<script>
    function val_id(val_id)
    {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>family_controllers/talbat/Talb_electric_device/get_fatora_attach",
            data: {
                val_id: val_id,
            },
            success: function (d) {
...
<script>
    function get_details_title(row_id) {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>family_controllers/talbat/Talb_electric_device/load_details",
            data: {row_id: row_id},
            beforeSend: function () {
