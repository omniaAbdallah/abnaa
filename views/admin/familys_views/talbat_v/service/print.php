            ...
            <div class="col-xs-12">
                <div class="personality">
                    ...
                    <div class="col-xs-7 ahwal_style">
                        <h4 class="" style="font-weight: bold !important;font-size: 20px !important;">السادة/الجمعية
                            الخيرية لرعاية الأيتام ببريدة-أبناء </h4>
                    </div>
                    <div class="col-xs-3">
                    ...
                    <div class="col-xs-12 no-padding">
                        <div class="form-group col-sm-12 col-xs-12">
                            <h4> نتقدم إليكم بطلب صرف مساعدة وذلك نظرا لحاجاتنا إليها ، لذا نأمل من سعادتكم التوجيه إلى
                                من يلزمه الأمر بعمل اللازم</h4>
                        </div>
                        <div class="form-group col-sm-12 col-xs-12">
                            <h4>مقدم الطلب :</h4> <?php echo $result['mokadem_name'] ?>
                            <h4>التوقيع:</h4>................................
                            <h4>التاريخ :</h4><?php echo $result['talab_date_ar'] ?>
                            <h4>نوع الخدمة :</h4> <?php
...
<script>
    ...
    document.body.innerHTML = "<html><head><title></title></head><body><div id='printdiv'>" +
    ...
    /*setTimeout(function () {
          window.location.href ="<?php echo base_url();?>family_controllers/talbat/Talb_service";
        }, 1000);*/
</script>