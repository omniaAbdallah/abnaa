                                ...
                                <div class="personality">
                                    ...
                                    <div class="col-xs-12 no-padding">
                                        ...
                                        <div class="form-group col-sm-12 col-xs-12">
                                            ...
                                            <input type="hidden" name="no_afrad"
                                                   value="<?php echo $family_members_num; ?>">
                                        </div>
                                        <!--                    31-1-om start-->
                                                ...
                                                <div class="form-group col-sm-12 col-xs-12">
                                                    <table class="table table-bordered ">
                                                        ...
                                                        <?php foreach ($family_members->sons as $row) {
                                                            ?>
                                                            <tr>
                                                                <td><input type="checkbox" name="member_id[]" id=""
                                                                           value="<?= $row->id ?>"
                                                                        <?php
                                                                        if (!empty($member_letter)){
                                                                        if (in_array($row->id,$member_letter)){
                                                                            echo 'checked';
                                                                        }}
                                                                        ?>
                                                                    ></td>
