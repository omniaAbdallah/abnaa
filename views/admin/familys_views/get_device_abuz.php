...
<table class="table table-bordered" id="tab_logic">
    ...
    <tr >
       ...
       $house_device_status=array('إختر','جيد','متوسط','غير جيد','يحتاج') ;
        ...
        ?>
        <td> <select class="no-padding form-control" style="width: 100%;" name="d_house_device_id_fk<? echo $i;?>" id="try<? echo $i;?>" data-validation="required" aria-required="true">
        ...
        <td> <select class="no-padding form-control" style="width: 100%;" name="d_count<? echo $i;?>" id="try<? echo $i;?>" data-validation="required" aria-required="true">
                <option value="">اختر</option>
                <? for ($d=1;$d<10;$d++):?>
                <option value="<? echo $d; ?>"><? echo $d;?></option>
                <? endfor;?>
            </select></td>
        <td> <select class="no-padding form-control" style="width: 100%;" name="d_house_device_status_id_fk<? echo $i;?>" id="try<? echo $i;?>" data-validation="required" aria-required="true">
                <option value="">اختر</option>
