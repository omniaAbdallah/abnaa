...
<div class="col-xs-12 " >
	<div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
		<div class="panel-heading">
            ...
            <?php echo form_open_multipart('family_controllers/Family/mother/'.$this->uri->segment(4). '/'.$this->uri->segment(5));?>
					...
					<div role="tabpanel" class="tab-pane fade in active" id="main-detailsa">
						...
						<div class="form-group col-md-1 col-sm-4 col-xs-12 padding-4">
							...
							<div class="form-group col-md-2  col-sm-4 col-xs-12 padding-4">
								...
								<input class="textbox form-control" type="number" name="HDay" pattern="\d*" 
								
								onchange="check_day_month()"
								
								 value="<?php if(!empty($hijri_date[0])){echo $hijri_date[0];}?>"  placeholder="day"  id="HDay" size="20" maxlength="2" style="width: 33.33%;float: right;"/>
								<input class="textbox form-control" type="number" name="HMonth" pattern="\d*"
								onchange="check_day_month()"  value="<?php if(!empty($hijri_date[1])){ echo $hijri_date[1];}?>"  placeholder="month"  id="Hmonth" size="20" maxlength="2" style="width: 33.33%;float: right;"/>
								<input class="textbox4 form-control" 
								onchange="check_year(<?=$my_current_hjri_year?>,2)"
								type="number" name="HYear" pattern="\d*"
							...
							<div class="form-group col-md-2  col-sm-4 col-xs-12 padding-4">
								...
								onchange="check_day_month()"
								data-validation="required" type="number" name="CDay" pattern="\d*"   placeholder="day"  id="CDay" size="20" maxlength="2" autofocus style="width: 33.33%;float: right;"  value="<?php if(!empty($gregorian_date[0])){ echo $gregorian_date[0]; }?>"/>
								<input class="textbox form-control"
								onchange="check_day_month()"
								 data-validation="required" type="number" name="CMonth" pattern="\d*"    placeholder="month" id="CMonth" size="20" maxlength="2"  style="width: 33.33%;float: right;" value="<?php if(!empty($gregorian_date[1])){ echo $gregorian_date[1];}?>"/>
								<input 
								onchange="check_year(<?=date('Y');?>,1)"
								class="textbox4 form-control" data-validation="required" type="text" name="CYear"  id="CYear" pattern="\d*" onkeypress="return isNumberKey(event)" onkeyup="chrToIsl(this.form);getAge();"   placeholder="year"  id="CYear" size="20" maxlength="4"  style="width: 33.33%;float: right;" value="<?php if(!empty($gregorian_date[2])){ echo $gregorian_date[2];}?>"/>
							</div>
							<div class="form-group col-md-1 col-sm-4 col-xs-12 padding-4">
					   ...
					   ?>
                       	<div class="form-group col-md-2 padding-4 col-sm-4 col-xs-12">
                       		...
                       		<select
							   <?=$disabled_input?>
							     name="person_type" class="selectpicker no-padding form-control choose-date form-control half"  data-show-subtext="true" data-live-search="true"  data-validation="required"  aria-required="true">
                       			<option value="">اختر</option>
                       			<?php
                       	...
                       	<div class="form-group col-md-2 padding-4 col-sm-4 col-xs-12">
                       		...
                       		<select name="halt_elmostafid_m"
							   <?=$disabled_input?>
							    id="halt_elmostafid_m"   class="form-control half">
                       			<option value=""> اختر </option>
                       	...
                       	<div class="form-group  col-md-2 padding-4 col-sm-4 col-xs-12">
							   ...
							   <?=$disabled_input?>
							   class="selectpicker no-padding form-control choose-date form-control half"  data-show-subtext="true" data-live-search="true"  data-validation="required"  aria-required="true">
