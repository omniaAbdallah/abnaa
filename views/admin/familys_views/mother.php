						...
						<div class="form-group col-md-1 col-sm-4 col-xs-12 padding-4">
                            ...
                            <div class="form-group col-md-2  col-sm-4 col-xs-12 padding-4">
                                ...
                                <input class="textbox form-control" type="number" name="HMonth" pattern="\d*"
                                       onchange="check_day_month()" value="<?php if (!empty($hijri_date[1])) {
                                    echo $hijri_date[1];
                            ...
                            <div class="form-group col-md-2  col-sm-4 col-xs-12 padding-4">
                                ...
                                <input class="textbox form-control"
                                       onchange="check_day_month()"
                                       data-validation="required" type="number" name="CDay" pattern="\d*"
                                ...
                                <input class="textbox form-control"
                                       onchange="check_day_month()"
                                       data-validation="required" type="number" name="CMonth" pattern="\d*"
                                ...
                                <input
                                        ...
                                        class="textbox4 form-control" data-validation="required" type="text"
                                        ...
                                        maxlength="4" style="width: 33.33%;float: right;"
