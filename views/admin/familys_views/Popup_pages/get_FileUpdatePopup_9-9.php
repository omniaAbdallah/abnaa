...
<form  method="post" action="<?php echo base_url();?>family_controllers/Family/update_file_status_data">
    <div class="col-md-12">
        ...
        <div class="form-group col-sm-6 col-xs-12" >
            <label class="label label-green  half"> تاريخ فتح  الملف  <strong class="astric">*</strong> </label>
            <input type="date" onchange="change_date($(this).val(),<?php echo $basic_data_family['id'];?>)" class="form-control half input-style " <?php if($basic_data_family['file_update_date']!=0){ ?>
    ...
    ?> 
     ...
     <!-- <td><?php echo $basic_data_family['file_open_update_date']; ?></td> -->
      ...
      <td><?php echo date("Y/m/d",$row_tracks->to_date); ?>
         ...
         <td><?php if(count($all_file_updates_tracks)==$a){ ?>
                 <div class="col-md-12">
                     <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseExample_update" aria-expanded="false" aria-controls="collapseExample">
...
if($basic_data_family['file_update_date'] != 0 ){ ?>
    ...
    <div class="collapse" id="collapseExample_update">
        <div class="well">
            <form  method="post" action="<?php echo base_url();?>family_controllers/Family/update_last_record">
                <div class="col-md-12">
                    <input type="hidden" name="mother_national" value="<?php echo $basic_data_family['mother_national_num'];?>">
                    <input type="hidden" name="row_id" value="<?php if(!empty($last_file_update)) echo($last_file_update->id) ;?>">
                    <?php
                    $file_num ?>
                    <div class="form-group col-sm-6 col-xs-12">
                        <label class="label label-green  half"> رقم الملف  <strong class="astric">*</strong> </label>
             ...
             if($basic_data_family['file_update_date']!=0){ ?>
                            readonly="readonly"  <?php   } ?>  name="from_date" value="
                            <?php
                            if($basic_data_family['file_open_update_date'] == 0 ){
                           echo  date("Y-m-d");
                            ...
                            echo end($all_file_updates_tracks)->from_date_ar;
                            }
                            ...
                            ?>"   id="date_suspend<?php echo $basic_data_family['id'];?>"   name="date_suspend"  <?=$validation?> />
                    </div>
                    <div class="form-group col-sm-6 col-xs-12">
                        <label class="label label-green  half"> فتره التحديث <strong class="astric">*</strong> </label>
                        <select id="peroid_update<?php echo $basic_data_family['id'];?>" name="peroid" class="form-control half input-style"
                                onchange="update_last_date($(this).val(),<?php echo $basic_data_family['id'];?>);">
                            <option value="0">اختر</option>
                            <?php
                            if(isset($all_options)&&!empty($all_options)) {
                                foreach ($all_options as $row) {
