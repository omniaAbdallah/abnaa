            ...
            <div class="col-xs-12 no-padding">
                ...
                <div class="form-group col-sm-4 col-xs-12 padding-4">
                    ...
                    <input type="text" style=""
                           value=" <?php if (isset($sarf_data)) {
                               if (!empty($sarf_data["group_name"])) {
                                   echo $sarf_data["group_name"];
                               }
                           } ?>"
                           id="group_name" name="group_name" class=" no-padding form-control form-control "
                ...
                <div class="col-xs-12 no-padding">
                    ...
                    <div id="display" style="display:<?= $disp ?>">
                        <div class="form-group  col-sm-1">
                            ...
                            <select name="member_cat" id="member_cat"
                                    class="form-control " data-show-subtext="true" data-live-search="true"
                                    aria-required="true" tabindex="-1" aria-hidden="true">
                                <option value="">إختر</option>
                                <?php $x = 1;
                                $member_category = array(1 => 'ارملة', 2 => 'يتيم', 3 => 'مستفيد');
                                foreach ($member_category as $id=>$title) {
                                    $selected = "";
                                    if (isset($sarf_data)) {
                                        if ($id == $sarf_data['member_cat']) {
                                            $selected = "selected";
                                        }
                                    } ?>
                        ...
                        <div class="form-group  col-sm-1">
                            ...
                            <select name="gender" id="gender"
                                ...
                                <option value="">إختر</option>
                                <?php $x = 1;
                                $member_gender = array(1 => 'ذكر', 2 => 'انثى');
                                foreach ($member_gender as $id=>$title) {
                                    $selected = "";
                                    if (isset($sarf_data)) {
                                        if ($id == $sarf_data['gender']) {
                                            $selected = "selected";
                                        }
                                    } ?>
                                    <option value="<?= $id ?>" <?= $selected ?>><?= $title ?></option>
                        ...
                        <div class="form-group  col-sm-2">
                            ...
                            <select name="family_cat[]" id="family_cat" multiple title="يمكنك إختيار أكثر من فئة"
                                ...
                                <option value="">إختر</option>
                                <?php $x = 1;
                                foreach ($family_category as $row) {
                                    $selected = "";
                                    if (isset($sarf_data)) {
                    ...
                    <div class="form-group col-sm-2 padding-4">
                        <button type="button" onclick="get_data()" class="btn btn-labeled btn-warning "
                                id="searcher_but" style="margin-top: 27px;">
                ...
                <div class="col-xs-12 text-center" style="margin-bottom: 10px;">
                    ...
                    <button type="submit" name="<?php echo $out['input'] ?>" value="<?php echo $out['input'] ?>"
                            class="btn btn-success  btn-labeled" id="submit_but" disabled="">
                        ...
                        <tr class="">
                            ...
                            <td>
                                ...
                                <a data-toggle="modal" data-target="#modal-sm-data"
                                   onclick="get_details(<?= $record->id ?>,<?= $record->f2a_search ?>);"
                                   class="btn btn-xs btn-primary" title="التفاصيل" style="padding: 1px 6px;"> <i
...
<script>
    function get_data() {
        ...
        var member_cat = $('#member_cat').val();
        var file_status = $('#file_status').val();
        var basicdataString = 'member_type=' + member_type + "&family_cat=" + family_cat +"&gender=" + gender +"&member_cat=" + member_cat + "&file_status=" + file_status;
