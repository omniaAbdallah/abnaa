<table class="table table-bordered" id="tab_logic" >
    ...
    for($i=0;$i<$num;$i++){
        ...
        <tr>
            <td><?php echo $i+1;?></td>
            <td> <input  type="text" class="member form-control" id="member_out<?php echo $i;?>" onfocusout="show_data($(this).val());"> </td>
            <td><input type="radio" name="<?php echo $i;?>" class="type_job4"  value="رئيس اللجنة">رئيس اللجنة
                <input type="radio" name="<?php echo $i;?>" class="type_job4"  value="نائب ">نائب
                <input type="radio" name="<?php echo $i;?>"  class="type_job4"  value="عضو ">عضو 
               </td>
