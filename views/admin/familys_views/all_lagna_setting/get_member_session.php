   ...
   <!-- <div class="header col-xs-12 no-padding">
    ...
    <div class="print_forma no-border col-xs-12 no-padding">
            <div class="personality">
                <h5>الحمد لله وحده وبعد :- </h5>
                <h5>فى هذا اليوم الموافق  <?php echo date("Y-m-d",$row->date);?>م وفى تمام الساعة الرابعة والنصف مساءاّ عقدت لجنة الرعاية الإجتماعية إجتماعها رقم (<?php echo $row->year;?>/<?php echo $row->session_number;?>) </h5>
               
                <?php  $x=1; foreach($records as $row){ ?>
                <h5><?php echo $x;?>- <?php echo $row->title;?> .</h5>
                <?php  $x++ ; }   ?>
            </div>
    </div> 
     <!--------------------------------------------------------->  
      ...
      <div class="piece-box">
       <div class="piece-header bordered-bottom">
        <h5 class="text-center"><strong><?php echo $indexs[$x];?> :</strong><?php echo $row->title; ?></h5>
        </div>
...
<div class="piece-box">
       <div class="piece-header bordered-bottom">
         <h5 class="text-center"><strong>أعضاء اللجنة</strong></h5>
        </div>
                <div class="piece-body">
                    <div class="col-xs-12  under-line   no-padding">
    ...
    if ($member->member_id = $_SESSION["emp_code"]) {
    ...
    <?php foreach ($options as $key => $value) { ?>
        <div class="radio-content">
            <input type="radio"
                   class="check<?php echo $member->session_number; ?>" <?= $is_disable ?>
            ...
            <label class="radio-label" for="sign<?= $key ?>"> <?= $value ?></label>
        </div>
    <?php } ?>
</td>
                </tr>
