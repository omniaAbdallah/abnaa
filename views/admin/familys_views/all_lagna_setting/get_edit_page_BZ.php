                    ...
                    <table class="table table-bordered" style="width:100%">
                        ...
                        if(isset($mothers_data) && $mothers_data!=null){ ?>
                            <tr>
                                <td><input type="checkbox" name="ids[]" onclick="empty_values(<?php echo $mothers_data[0]->mother_national_num_fk;?>)"
                                             <?php if(in_array($mothers_data[0]->mother_national_num_fk,$person_id_arr)){ echo'checked';}?>
                                           value="<?php echo $mothers_data[0]->mother_national_num_fk; ?>"></td>
                                <td><a href="#"><?php echo $mothers_data[0]->full_name;   ?></a></td>
                                <td style="text-align: center"><select class="form-control halet_file  <?php if(!empty($_POST['type'])){ ?> nonactive <?php }?>" name="halet_file[]" id="halet_file<?php echo $mothers_data[0]->mother_national_num_fk;?>">
                                        <option value="">اختر</option>
                                ...
                                <td style="text-align: center">
                                    <select class="form-control procedure   <?php if(!empty($_POST['type'])){ ?> nonactive <?php }?>" name="procedure[]" id="procedure<?php echo $mothers_data[0]->mother_national_num_fk;?>" >
                        ...
                        $x=2; foreach($member_data as $member_row){ ?>
                            <tr>
                                ...
                                <td style="text-align: center"><select class="form-control halet_file <?php if(!empty($_POST['type'])){ ?> nonactive <?php }?>" name="halet_file[]" id="halet_file<?php echo$member_row->id;?>">
                                        <option value="">اختر</option>
                                        <?php if (isset($file_status) && $file_status != null && !empty($file_status)){
                                            foreach ($file_status as $row){ ?>
                                                <option
                                ...
                                <td style="text-align: center">
                                    <select class="form-control procedure " name="procedure[]"  id="procedure<?php echo$member_row->id;?>">
                                        <option value="">إختر</option>
                                        <?php if(!empty($all_procedures)){  foreach ( $all_procedures  as $row){ ?>
                                            <option value="<?=$row->id?>-<?=$row->title?>"
