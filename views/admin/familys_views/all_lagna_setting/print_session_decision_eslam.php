                           ...
                           // die;
                            ...
                            <div class="col-xs-12 no-padding">
                                ...
                                <?php if($row->procedure_id_fk ==14){  ?>
                                    ...
                                    <table id="" class="table table-striped table-bordered dt-responsive nowrap res" cellspacing="0" width="100%">
  ...
  $ccolor = 'white';  
        ...
        <tr>
         ...
         <!--   <td class="countable1"></td> -->
            <td style="background-color: <?php echo $ccolor;  ?>;" class="countable2"></td>
            <td style="background-color: <?php echo $ccolor;  ?>;"  class="countable3"></td>
            <td style="background-color: <?php echo $ccolor;  ?>;"  class="countable4"></td>

   <!--<td colspan="4" class=""></td>-->

<td style="background-color: <?php echo $ccolor;  ?>;"></td>
                                                </tr>
                                                <?php
                                                $all_members1 =0;
                                                ...
                                                <tr>
                                                  ...
                                                  <!--  <td  class="countable1"><?=$members[0]->total_num?></td> -->
                                                    <td style="background-color: <?php echo $ccolor;  ?>;"  class="countable2"><?=$members[0]->armal?></td>
                                                    <td style="background-color: <?php echo $ccolor;  ?>;" class="countable3"><?=$members[0]->yatem?></td>
                                                    <td style="background-color: <?php echo $ccolor;  ?>;" class="countable4"><?=$members[0]->mostafed?></td>
                                                    <td style="background-color: <?php echo $ccolor;  ?>;" >سبب الإجراء</td>
                                                </tr>
                                                ...
                                                if(!empty($members)){ if( sizeof($members) >1){
                                                    for ($a=1;$a<sizeof($members);$a++){
                                                        ...
                                                        <!--    <td  class="countable1"><?=$members[$a]->total_num?></td>-->
                                                            <td style="background-color: <?php echo $ccolor;  ?>;"   class="countable2"><?=$members[$a]->armal?></td>
                                                            <td style="background-color: <?php echo $ccolor;  ?>;"  class="countable3"><?=$members[$a]->yatem?></td>
                                                            <td  style="background-color: <?php echo $ccolor;  ?>;" class="countable4"><?=$members[$a]->mostafed?></td>
                                                            <td style="background-color: <?php echo $ccolor;  ?>;" >سبب الإجراء</td>
                                                        </tr>
                                                    <?php } }  }
