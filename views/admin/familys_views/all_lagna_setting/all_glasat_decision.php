                                ...
                                <td>
                                    ...
                                    <?php foreach ($options as $key => $value) { ?>
                                        <div class="radio-content">
                                            ...
                                            <label class="radio-label" for="sign<?= $key . '-'.$row->session_number ?>"> <?= $value ?></label>
                                        </div>
                                    <?php } ?>
                                </td>
                                <td>
                                    <button class="btn btn-save btn-success"  onclick="get_member_decision(<?php echo $row->member_id; ?>,<?php echo $row->lagna_number; ?>,<?php echo $row->session_number; ?>);">حفظ </button>
                                </td>
                            </tr>
                            <?php
                            $x++;
