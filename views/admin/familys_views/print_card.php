            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="card profile-card-3 center-block">
                    ...
                    <div class="card-content col-xs-12">
                        <h3 class="text-center"> كارت تعريف لمستفيد</h3>
                        <div class="col-xs-12 no-padding card-define">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td>
                                        <h4> <?php if(isset($card_data->file_num)){ echo $card_data->file_num ;  } ?> </h4>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="border-left">
                                        <h4> إسم الاسره المستفيدة </h4>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h4> <?php if(isset($card_data->mother_national_num)){ echo $card_data->mother_national_num ;  } ?>  </h4>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="border-left">
                                    ...
                                    <td>
                                        <h4> <?php if(isset($card_data->date_suspend)){ echo $card_data->date_suspend ;  } ?>  </h4>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="border-left">
                                        <h4>تاريخ  تحديث الملف </h4>
                                    </td>
                                    <td>
                                        <h4> <?php if(isset($card_data->file_update_date)){ echo $card_data->file_update_date ;  } ?>  </h4>
                                    </td>
                                </tr>
                            </table>
                        </div>
...
<script >
    ...
    window .print();
    setTimeout(function () {
        window.location.href ="<?php echo base_url('family_controllers/Family/accepted_family_files') ?>";
    }, 1000);
</script >
