...
<div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
    ...
    <div class="panel-body">
        ...
        <div class="col-md-12">
            ...
            <div class="form-group col-sm-4 col-xs-12">
                <label class="label label-green  half">مسئول الحساب<strong class="astric">*</strong><strong></strong>
                </label>
            ...
            <div class="form-group col-sm-4 col-xs-12">
                ...
                <input type="text" name="person_name" disabled="disabled" id="person_name" data-validation="required"
                    ...
                    foreach ($records as $row) {
                        ...
                        <tr>
                            ...
                            <td><a data-toggle="modal" type="button" style="cursor: pointer"
                                   data-target="#modal-img" onclick="$('#my_image').attr('src','<?php echo base_url() . $img_url ?>');">
                                    <i class="fa fa-eye"></i>
                                </a>
                            </td> 
                            
                            <td>
                                <button class=" btn btn-success" value="<?php echo $row->active; ?>">نشط</button>
                    ...
                    if(!empty($row->responsible_operations)){
                        foreach ($row->responsible_operations as $record){?>
                            <tr>
                             ...
                             ?>
                                <td><a data-toggle="modal" type="button" style="cursor: pointer"
                                       data-target="#modal-img" onclick="$('#my_image').attr('src','<?php echo base_url() . $img ?>');">
                                        <i class="fa fa-eye"></i>
                                    </a>
                                   <a href = "<?php echo base_url('family_controllers/Family/print_eqrar').'/'.$record->operation_id ?>" target = "_blank" >
                    ...
                    <div class="modal-body row">
                        ...
                        <div class="col-md-12">
                                                ...
                                                value="<?php echo $row2->id . '-2'; ?>" <?php if ($row2->id == $row->person_id_fk && $row->type == 2) { ?> selected="" <?php } ?> >
                                                 <?php  $mem_type = "";
                                                      if($row2->member_gender == 1){
                                                       ...
                                                       ?></option>
                                        <?php } } ?>
                                    <option value="0-0" <?php if ($row->person_id_fk == 0) { ?> selected="" <?php } ?> > شخص اخر </option>
                                </select>

                                <input type="hidden" name="past_bank_id_fk" value="<?=$row->person_id_fk.'-'.$row->type;?>">
                            </div>
                            <div class="form-group col-sm-4 col-xs-12">
                                <label class="label label-green  half">اسم المسئول</label>
                            ...
                            <div class="form-group col-sm-4 col-xs-12 ">
                                ...
                                <input type="hidden" name="past_bank_relationship" value="<?=$row->person_relationship?>">
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group col-sm-4 col-xs-12">
                                ...
                                <input type="text" name="past_bank_national_card" maxlength="10"
                                       ...
                                       onkeypress="validate_number(event)" id="past_bank_national_card<?php echo $row->id; ?>"
                            ...
                            <div class="form-group col-sm-4 col-xs-12 ">
                                ...
                                <select name="past_bank_id" id="past_bank_id<?php echo $row->id; ?>"
                                        class="form-control half " disabled
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group col-sm-4 col-xs-12 ">
                                ...
                                <label class="label label-green  half">صوره الحساب<strong class="astric">*</strong>
                                </label>
                                <?php  if(!empty($row->bank_image)){ ?>
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel">بيانات مسئول الحساب البنكي التالى</h4>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group col-sm-4 col-xs-12">
                                <label class="label label-green  half">مسئول الحساب<strong
