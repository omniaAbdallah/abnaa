                            ...
                            <tr id="<?=$s?>">
                                ...
                                <td style="width:15%;text-align: center!important;">
                                    <?php   if(!empty($mother_data->m_birth_date_hijri)){ $hijri_date=explode('/',$mother_data->m_birth_date_hijri);
                                        $age = $hijri_date[2];} else {
                                        $age = '';
                                    } ?>
 <input class=" form-control  " type="text" id="myage<?echo $s;?>"  value="<?php echo ($current_year - $age) ; ?>"  size="60"readonly/></td>
                                ...
                                <td style="text-align: center!important;">
                                    ...
                                    <a href="<?php echo base_url().'family_controllers/Family/DeleteMember/'.$mother_data->id."/".$result["mother_national_num"] ?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');" >
...
<!--                             <td style=" width:15%;text-align: center!important;">
    ...
    <select  name="m_card_source[]" id="m_card_source"  data-validation="required" class=" form-control " disabled >
        ...
        <?php  } } ?>
                            ...
                            <a href="<?php echo base_url().'family_controllers/Family/DeleteMember/'.$row->id."/".$result["mother_national_num"] ?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');" >
                                    <i class="fa fa-trash" aria-hidden="true" title="حذف"></i> </a></td>
                        </tr>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr id="">
                                ...
                                <td style=" width:15%;text-align: center!important;">
                                    ...
                                    ?>
                                    <select name="member_relationship"  id="member_relationship<?=$member->id?>" data-validation="required" class=" form-control" onchange="gender_select(<?//=$_POST['length']?>)" >
                                        <option value="">إختر</option>
                                        <?php
                                        foreach ($members as $key=>$value){
                                            $select='';
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr id="">
                            ...
                            <td style=" width:15%;text-align: center!important;">
                                ...
                                ?>
                                <select name="member_relationship"  id="member_relationship<?=$mother_data->id?>" data-validation="required" class=" form-control" onchange="gender_select(<?//=$_POST['length']?>)" >
                                    <option value="">إختر</option>
                                    <?php
                                    foreach ($members as $key=>$value){
                                        $select='';
                            ...
                            <td style="width:10%;text-align: center!important;">
                                ...
                                <select name="member_gender" id="member_gender<?=$mother_data->id?>" data-validation="required" class=" form-control" >
                                    <option value="">إختر</option>
                                    <?php
                                    foreach ($member_gender as $key=>$value){
                                        $select='';
                            ...
                            <td style="width:15%;text-align: center!important;">
                                ...
                                <input class=" form-control  "  value="<?php echo($current_year - $age) ?>" type="text" name="age" id="myage<?php echo $mother_data->id;?>"  size="60"readonly/></td>
                            <td style="width:15%;text-align: center!important;" >
                                <div id="categoriey_member_div<?=$mother_data->id?>"> <?php if(isset($Classification[$mother_data->categoriey_m]) && !empty($Classification[$mother_data->categoriey_m])){echo $Classification[$mother_data->categoriey_m]; } ?> </div>

                                <input  type="hidden" name="categoriey_m"  value="<?= $mother_data->categoriey_m ?>" id="categoriey_member<?php echo $mother_data->id;?>"  />
                            </td>
                        </tr>
                        </tbody>
                    </table>
...
<script>
    function gender_select(len) {
        ...
        if (member =="41" || member =="43"){
            ...
            var x = document.getElementById("member_gender"+len).children[1];
            x.setAttribute("selected", "selected");
        }
