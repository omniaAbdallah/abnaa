            ...
            <div class="personality">
                ...
                <div class="col-xs-12 no-padding">
                    <div class="form-group col-sm-12 col-xs-12">
                             <h4>      نتقدم إليكم بطلب طلب الاجهزة الكهربائية وذلك نظرا لحاجاتنا إليها ، لذا نأمل من سعادتكم التوجيه إلى من يلزمه الأمر بعمل اللازم</h4>
                    </div>
                    <div class="form-group col-sm-12 col-xs-12">
...
<script>
      ...
      window .print();
      setTimeout(function () {
          window.location.href ="<?php echo base_url();?>family_controllers/talbat/Talb_electric_device";
        }, 1000);
</script>