            ...
            <div class="personality">
                ...
                <div class="col-xs-12 no-padding">
                    <div class="form-group col-sm-12 col-xs-12">
                             <h4>      نتقدم إليكم بطلب طلب   مساعدة زواج وذلك نظرا لحاجاتنا إليها ، لذا نأمل من سعادتكم التوجيه إلى من يلزمه الأمر بعمل اللازم</h4>
                    </div>
                    <div class="form-group col-sm-12 col-xs-12">
                    <h4>مقدم الطلب  :</h4>
                ...
                <h4> رقم الجوال:</th>
      <?php echo $result['jwal'] ?>
        <h4> مكان الزواج:</th>
     <?php echo $result['makan_zawaj'] ?>
        <h4> تاريخ الزواج :</th>
       <?php echo $result['date_zawaj'] ?>
        <h4> رقم العقد :</th>
       <?php echo $result['rkm_akd'] ?> 
       <h4 >تاريخ العقد:</h4>
    <?php echo $result['date_akd'] ?>
        <h4> قيمة المهر:</h4>
     <?php echo $result['mahr_value'] ?>
                    </div>
                    <div class="form-group col-sm-12 col-xs-12">
