               ...
               <!-- <div class="form-group col-sm-2 col-xs-12 padding-4">
                ...
                <div class="form-group col-sm-4 col-xs-12 padding-4">
                 ...
                 <div class="form-group col-sm-4 col-xs-12 padding-4">
                    ...
                    <input type="text" class="form-control " name="wasf"
                           value="<?= $wasf ?>" data-validation="required">
                </div>
...
<div id="show_details">
<?php if ((isset($all_fe2at)) && (!empty($all_fe2at))) { ?>
    <div class="col-xs-12  ">
        <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
            <div class="panel-heading">
            ...
            <div class="panel-body" >
                <table class="example table table-bordered">
                    ...
                    <tbody>
                    <?php foreach ($all_fe2at as $key => $value) { ?>
                        <tr>
                            <td><?= ++$key ?></td>
                            <td><?= $value->fe2a_title ?></td>
                            <td><?= $value->wasf ?></td>
                            <td>
                            <a onclick='swal({
...
<script>
    function save_f2a() {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>family_controllers/talbat/Serv_setting/f2a_service_setting',
            data: form_data,
            cache: false,
            contentType: false,
            processData: false,
...
<script>
    function update_f2a(id) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>family_controllers/talbat/Serv_setting/f2a_service_setting_uptate',
            data: form_data,
            cache: false,
            contentType: false,
            processData: false,
...
<script>
    function get_details() {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>family_controllers/talbat/Serv_setting/load_details_f2a",
            beforeSend: function () {
...
<script>
    function edit_f2a(id) {
        ...
        $.ajax({
            type: 'post',
            data: {id: id},
            url: "<?php echo base_url();?>family_controllers/talbat/Serv_setting/edite_f2a",
            beforeSend: function () {
...
<script>
    function get_add() {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>family_controllers/talbat/Serv_setting/get_add",
            success: function (d) {
                $('#show_edite').html(d);
            }
        });
        ...
        swal({
            ...
            function (isConfirm) {
                if (isConfirm) {
                    $.ajax({
                        type: 'post',
                        url: '<?php echo base_url() ?>family_controllers/talbat/Serv_setting/f2a_service_setting_delete',
                        data: {id: id},
                        dataType: 'html',
                        cache: false,
                        beforeSend: function () {
