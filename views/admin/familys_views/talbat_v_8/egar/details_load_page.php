    ...
    font-size: 15px !important;
        ...
        <table class="table table-bordered ">
                            ...
                            <tr >
                                ...
                                <td class="infotd text-center"><?php echo $file_num_data['father_full_name'] ?></td>
                                <th class="info">
                                <i class="fa fa-file-o" aria-hidden="true"></i> رقم الملف</th>
                                <td class="infotd text-center"><?php echo $_POST['file_num'] ?></td>
                                <th class="info"> الفئة</th>
                                <td class=" infotd text-center"><?php echo $file_num_data['family_cat_name'] ?></td>
                           
                              
                            </tr>
                            <tr>

                            <th class="info"> <i class="fa fa-map-marker" aria-hidden="true"></i>  الحي</th>
                            <td class=" infotd text-center"><?php echo $file_num_data['hai_name'] ?></td>

                            <th class="info"><i class="fa fa-calendar-o" aria-hidden="true"></i> تاريخ التسجيل</th>
                            <td class="infotd text-center"><?php echo $file_num_data['file_update_date'] ?></td>


                            <th class="info"> <i class="fa fa-users" aria-hidden="true"></i> عدد أفراد الأسرة</th>
                            <td class="infotd text-center"><?php echo $family_members_num; ?></td>
                            </tr>

                            <tr>

<th class="info"><i class="fa fa-phone-square" aria-hidden="true"></i>   جوال التواصل</th>
<td class="infotd text-center"><?php echo $file_num_data['contact_mob'] ?></td>
