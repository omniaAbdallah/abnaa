                            ...
                            <table id = "" class="table table-striped table-bordered dt-responsive nowrap" cellspacing = "0" width = "100%" >
                                ...
                                foreach($coming as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn btn-success  btn-xs "  title="إضافة إلي بنود اللجنة" onclick="getApproved(1,<?php echo $row->id;?>)"><i class="glyphicon glyphicon-ok"></i></button>
                                            <button type="button" class="btn btn-danger  btn-xs "  title="رفض من  بنود اللجنة"  onclick="getApproved(2,<?php echo $row->id;?>)"><i class="glyphicon glyphicon-remove"></i></button>
