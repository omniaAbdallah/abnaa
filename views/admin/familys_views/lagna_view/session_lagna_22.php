...
<?php
/*
$result=$all_orders[0]->mother;
$father=$all_orders[0]->father;
$member_data=$all_orders[0]->abnaa;
$devices=$all_orders[0]->devices;
$home_needs=$all_orders[0]->home_needs;
$financial_data_income=$all_orders[0]->financial_data_income;
$financial_data_duties=$all_orders[0]->financial_data_duties;
$sakn=$all_orders[0]->sakn;
*/
...
$devices='';
$home_needs='';
$financial_data_income='';
$financial_data_duties='';
$sakn='';
}
    ...
    <div class="panel panel-bd lobidrag" style="padding-top: 0;">
        ...
        <div class="panel-body">
                ...
                <table id="example" class=" display table table-bordered   responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <?php
                    $x=1;
                    $arr=array(1=>"تم قبول الطلب",0=>" رفض الطلب",2=>"لم يتم النظر ففي الطلب");
                    ...
                    foreach($all_orders as $row)
                        ...
                        <tr>
                            ...
                            <td style="color: red;"><?php echo $arr[$row->approved_lagna];?></td>
...
<div class="form-group col-sm-4 col-xs-12">
    ...
    <label class="label label-green  half">اسم الدار <strong
            class="astric">*</strong><strong></strong> </label>
    <input type="text" readonly name="m_female_house_id_fk"
           data-validation="required" <?php if ($result->m_female_house_id_fk == "") {
                    ?> disabled=""<?php } ?>
           value="<?php echo $result->m_female_house_id_fk ?>"
           id="m_female_house_id_fk" class="form-control half input-style"/>
</div>
                                            </div>
                                        <div class="col-md-12" >
                        ...
                        <hr width="100%" style="margin: 0; border-color: #000">
                         <div class="modal-footer" >
                                <div class="detail" <?php if($all_orders[0]->approved_lagna==1||$all_orders[0]->approved_lagna==0) {?> style="display: none;" <?php }?>>
                                ...
                                <button type="button" class="btn btn-success accept pull-left" value="1"  row="<?=$all_orders[0]->id?>"onclick="change_aproved($(this).val(),$(this).attr('row'));">الموافقه </button>
                               

                                <button type="button" class="btn btn-danger notaccept pull-left" value="0"  row="<?=$all_orders[0]->id?>"  onclick="change_aproved($(this).val(),$(this).attr('row'));">الرفض</button>
                            </div>
                                
                            </div>
                            <?php if(($all_orders[0]->approved_lagna==1)){?>
                            <div class="accept1">
                            ...
                            <?php } ?>
                             <?php if(($all_orders[0]->approved_lagna==0)){?>
                             <div class="accept2">
