                    ...
                    <div class="modal-dialog" role="document" style="width: 100%;height: 50%">
                        ...
                        <hr width="100%" style="margin: 0; border-color: #000">
                         <div class="modal-footer" >
                                <div class="detail" <?php if($all_orders[0]->approved_lagna==1||$all_orders[0]->approved_lagna==2) {?> style="display: none;" <?php }?>>
                                ...
                                <button type="button" class="btn btn-danger notaccept pull-left" value="2"  row="<?=$all_orders[0]->id?>"  onclick="change_aproved($(this).val(),$(this).attr('row'));">الرفض</button>
                            </div>
                            ...
                            <?php } ?>
                             <?php if(($all_orders[0]->approved_lagna==2)){?>
                             <div class="accept2">
