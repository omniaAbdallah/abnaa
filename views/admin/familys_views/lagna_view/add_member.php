                            ...
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text"   name="lagna_name"  id="lgna_name" value="" class="form-control half input-style error">

                                    </div>
                                <div class="form-group col-md-4">
                                    <label class="label label-green half">رقم اللجنه:</label>
                                    <input type="text"   name="lagna_num"  id="lgna_num" value="" class="form-control half input-style error">
                    ...
                    if(isset($records)&&!empty($records)) {
                        foreach ($records as $record) {
                            ...
                            <td style="border-bottom: 3px solid #ddd !important"
                                ...
                                <a href="<?php echo base_url(); ?>family_controllers/Lagna/delete_lgna/<?php echo $record->lagna_num;?>"onclick="return confirm('هل انت متاكد  من عمليه الحذف؟');"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            ...
                            if (isset($record->members) && !empty($record->members)){
                                ...
                                foreach ($record->members as $member) {
                                    ...
                                    <td <?php if ($x == 1) { ?> class="top" <?php } ?> <?php if ($x > 1) { ?> class="top2" <?php } ?>>
                                        <a href="<?php echo base_url(); ?>family_controllers/Lagna/delete_member/<?php echo $member->id;?>"onclick="return confirm('هل انت متاكد  من عمليه الحذف؟');"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                    </td>
                                    </tr>
...
<script>
    $(".add_lgna").click(function() {
        ...
        $.ajax({
            type:'post',
            url:"<?php echo base_url();?>family_controllers/Lagna/add_lagna_member",
...
<script>
    $('#num_member_out').keyup(function(){
        ...
        $.ajax({
            type:'post',
            url:"<?php echo base_url();?>family_controllers/Lagna/make_form",
            data:{num:num},
            success:function(d){
                $('#load_form').html(d);
