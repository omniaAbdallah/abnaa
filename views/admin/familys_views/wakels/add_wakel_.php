        ...
        <div class="panel-body">
            ...
            <div class="col-sm-12 col-xs-12">
                <div class="form-group col-sm-4 col-xs-12">
                    <label class="label label-green  half"> رقم السجل المدني للأم  </label>
                    <input type="text"
                           disabled class="form-control half input-style"
                           value="<?php if(!empty($mother_table[0]->mother_national_num_fk)){ echo $mother_table[0]->mother_national_num_fk; }  ?>" />
                </div>
                <div class="form-group col-sm-4 col-xs-12">
                    <label class="label label-green  half"> الاسم رباعي  </label>
                    <input type="text"
                           disabled class="form-control half input-style"
                           value="<?php if(!empty($mother_table[0]->full_name)){ echo $mother_table[0]->full_name; }  ?>" />
                </div>
            ...
            <div class="col-sm-12 col-xs-12">
                ...
                <div class="form-group col-sm-4 col-xs-12">
                    ...
                    <select id="job" name="job" class="selectpicker no-padding form-control choose-date form-control half"
                            onchange="checkJob(this.value)"
                            data-show-subtext="true" data-live-search="true"  data-validation="required"  aria-required="true" >
                        <?php $arr_job=array(0=>'يعمل',1=>'لا يعمل'); ?>
                        <option value="">اختر</option>
                ...
                <div class="form-group col-sm-4 col-xs-12">
                    <label class="label label-green  half"> إسم العمل  <strong class="astric">*</strong><strong></strong></label>
                    <input type="text" name="job_name" disabled id="job_name"
                ...
                <div class="form-group col-sm-4 col-xs-12">
                    ...
                    <input type="text" name="job_place" disabled id="job_place"
                ...
                <div class="form-group col-sm-4 col-xs-12">
                    ...
                    <input type="text" name="job_mob"  id="job_mob" disabled onkeypress="validate_number(event)"
                ...
                <div class="form-group col-sm-4 col-xs-12">
                    <label class="label label-green  half"> الراتب المستحق   <strong class="astric">*</strong><strong></strong></label>
                    <input type="text" name="salary"  id="salary" disabled onkeypress="validate_number(event)"
                ...
                <div class="form-group col-sm-4 col-xs-12">
                    ...
                    <select id="guaranted" name="guaranted" class="selectpicker no-padding form-control choose-date form-control half"
                            onchange="checkGuaranted(this.value)"
                            data-show-subtext="true" data-live-search="true"  data-validation="required"  aria-required="true" >
                        <?php $arr_guaranted=array(0=>'نعم',1=>'لا'); ?>
                        <option value="">اختر</option>
                ...
                <div class="form-group col-sm-4 col-xs-12">
                    ...
                    <input type="text" name="persons_num" id="persons_num"  onkeypress="validate_number(event)"
                           disabled value="<?php echo $persons_num;?>"  class="form-control half input-style" />
                </div>
