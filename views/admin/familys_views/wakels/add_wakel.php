...
<div class="col-xs-12 " >
    ...
    */ ?>
    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <?php echo form_open_multipart('family_controllers/Family/add_wakel/'.$this->uri->segment(4). '/'.$this->uri->segment(5));?>
        ...
        <div class="panel-body" style="height: 400px;">
            ...
            <div class="col-sm-12 col-xs-12">
                <div class="form-group col-md-2 col-sm-4 col-xs-12 padding-4">
                    ...
                    onchange="check_day_month()"
                    type="text" name="HMonth" pattern="\d*"
                    ...
                    class="textbox4 form-control" type="text" name="HYear" pattern="\d*"
                ...
                <div class="form-group col-md-2 col-sm-4 col-xs-12 padding-4">
                    ...
                    onchange="check_year(<?=date('Y');?>,1)"
                     type="text" name="CYear"  id="CYear" pattern="\d*"
