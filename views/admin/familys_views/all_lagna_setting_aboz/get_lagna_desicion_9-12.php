                ...
                <div class="modal-body ">
                    ...
                    <div class="detail">
                        <div class="form-group col-sm-3 col-xs-12 " >
                            ...
                            <textarea name="reason_lagna" class="form-control txt"> </textarea>
                        </div>
                        ...
                        <div class="form-group col-sm-4 col-xs-12" style="margin-top: 25px;">
                            <button type="button" class="btn btn-success accept pull-left" value="1" row="<?=$record->id?>" onclick="change_aproved($(this).val(),$(this).attr('row'));">الموافقه </button>
                            <button type="button" class="btn btn-danger notaccept pull-left" value="2" row="<?=$record->id?>" onclick="change_aproved($(this).val(),$(this).attr('row'));">الرفض</button>
                        </div>
                    </div>
        <?php } ?>
