...
<script>
    function save_member()
    {
     ...
     var data_post ={member_id:member_id,member_type:member_type,member_name:member_name,lagna_name:lagna_name,lagna_num:lagna_num,lagna_date:lagna_date,galsa_num:galsa_num};
