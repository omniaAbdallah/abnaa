                ...
                <?php if(isset($member_data) && $member_data!=null){ ?>
                    <table class="table table-bordered" style="width:100%">
                        ...
                        $x=2; foreach($member_data as $member_row){
                            ...
                            ?>
                            <tr>
                                <td><input  type="checkbox" name="ids[<?php echo $member_row->id;  ?>]" onclick="empty_values(<?php echo$member_row->id;?>)"
                                ...
                                <td style="text-align: center"><select
                                            ...
                                            class="form-control halet_file <?php if(!empty($_POST['type'])){ ?> nonactive <?php }?>" name="halet_file[<?php echo $member_row->id;  ?>]" id="halet_file<?php echo$member_row->id;?>">
                                        <option value="">اختر</option>
                                ...
                                <td style="text-align: center">
                                    <select
                                             ...
                                             class="form-control procedure " name="procedure[<?php echo $member_row->id;  ?>]"  id="procedure<?php echo$member_row->id;?>">
                                        <option value="">إختر</option>
                                        <?php if(!empty($reasons_arr)){  foreach ( $reasons_arr  as $row){ ?>
                          ...
                          <?php if(!empty($reasons_arr)){ ?>
                              ...
                              <?php foreach ( $reasons_arr  as $row){ ?>
                                  <option value="<?=$row->id?>"
                                      ...
                                      if(!empty($transformation_lagna_members)) {
                                          if ($transformation_lagna_members[$father->f_national_id]->reason_lagna_id_fk == $row->id) {
