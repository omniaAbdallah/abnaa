...
<div id="printdiv" data-spy="scroll" >
    ...
    <div class="col-xs-12 Title">
     ...
     <strong>محضر اجتماع لجنة الرعاية الإجتماعية رقم (<?php echo $row->year;?>/<?php echo 3;?>) </strong>
     </span>
        </h5><br>
    </div>
            ...
            <div class="print_forma no-border col-xs-12 no-padding">
                <div class="personality">
                    ...
                    <h4 style=" font-size: 16px; font-weight: bold; "><?php  switch ($dayOfWeek) {
                        ...
                        م عقدت لجنة الرعاية الإجتماعية إجتماعها رقم (<?php echo $row->year;?>/<?php echo 3;?>)
                           ...
                           // die;
                            ...
                            <div class="col-xs-12 no-padding">
                                ...
                                if(in_array($row->procedure_id_fk,$array)){  ?>
                                    ...
                                    <table id="example" class="table table-striped table-bordered dt-responsive nowrap res<?php echo$row->procedure_id_fk;?>" cellspacing="0" width="100%">

                                        <thead>
                                        <tr>
                                            <th class="gray_background"  style="width: 45px;">م</th>
                                            <th class="gray_background" style="width: 90px;">رقم الملف</th>
                                            <th colspan="2" class="gray_background" style="width: 30%;">إسم رب الاسرة</th>
                                          <!--  <th class="gray_background">عدد الأفراد</th> -->
                                            <th class="gray_background" style="width: 60px;">أرملة</th>
                                            <th class="gray_background" style="width: 60px;">يتيم</th>
                                            <th class="gray_background" style="width: 65px;">مستفيد</th>
...
if ($z % 2 == 0) {
 $ccolor = '#f1f1f1';
  ...
  $ccolor = 'white';  
        ...
        <tr>
            <td style="background-color: <?php echo $ccolor;  ?>; "  rowspan="<?php if(!empty($members)){  echo sizeof($members)+1; }?>"><?php echo $z; ?></td>
            <td style="background-color: <?php echo $ccolor;  ?>;"  rowspan="<?php if(!empty($members)){  echo sizeof($members)+1; }?>"><?php echo $record->file_num; ?></td>
            <td style="background-color: <?php echo $ccolor;  ?>;"   colspan="2" width="30%"><?php echo $record->father;?></td>
           <!-- <td style="color: white;" class="countable1<?php echo$row->procedure_id_fk;?>">0</td>-->
            <td style="background-color: <?php echo $ccolor;  ?>; color: <?php echo $ccolor; ?>;" class="countable2<?php echo$row->procedure_id_fk;?>">0</td>
            <td  style="background-color: <?php echo $ccolor;  ?>;color: <?php echo $ccolor; ?>;"class="countable3<?php echo$row->procedure_id_fk;?>">0</td>
            <td style="background-color: <?php echo $ccolor;  ?>;color: <?php echo $ccolor; ?>;"class="countable4<?php echo$row->procedure_id_fk;?>">0</td>
...
?>
<tr>
     <td  style="background-color: <?php echo $ccolor;  ?>;" rowspan="<?php if(!empty($members)){  echo sizeof($members); }?>">الأفراد</td>
  ...
  <!--  <td  class="countable1<?php echo$row->procedure_id_fk;?>"><?=$members[0]->total_num?></td> -->
     <td style="background-color: <?php echo $ccolor;  ?>; "   class="countable2<?php echo$row->procedure_id_fk;?>"><?=$members[0]->armal?></td>
     <td style="background-color: <?php echo $ccolor;  ?>;"  class="countable3<?php echo$row->procedure_id_fk;?>"><?=$members[0]->yatem?></td>
     <td style="background-color: <?php echo $ccolor;  ?>;"  class="countable4<?php echo$row->procedure_id_fk;?>"><?=$members[0]->mostafed?></td>
     <td style="background-color: <?php echo $ccolor;  ?>;"  ><?=$members[0]->procedure_title?></td>
</tr>
    ...
    if(!empty($members)){ if( sizeof($members) >1){
        for ($a=1;$a<sizeof($members);$a++){
          ...
          <!--     <td  class="countable1<?php echo$row->procedure_id_fk;?>"><?=$members[$a]->total_num?></td> -->
                 <td style="background-color: <?php echo $ccolor;  ?>;"   class="countable2<?php echo$row->procedure_id_fk;?>"><?=$members[$a]->armal?></td>
                 <td style="background-color: <?php echo $ccolor;  ?>;"  class="countable3<?php echo$row->procedure_id_fk;?>"><?=$members[$a]->yatem?></td>
                 <td style="background-color: <?php echo $ccolor;  ?>;"  class="countable4<?php echo$row->procedure_id_fk;?>"><?=$members[$a]->mostafed?></td>
                 <td style="background-color: <?php echo $ccolor;  ?>;"  ><?php echo $members[$a]->procedure_title;?></td>
            </tr>
        <?php } }  }
...
<tr>
<th class="gray_background text-center" colspan="4">الإجمــــــــــالـــى</th>
                                ...
                                <?php }else{ ?>
                                    ...
                                    <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%" style="table-layout: fixed;">
                                        ...
                                        <tr>
                                            <th class="gray_background"  style="width: 45px;">م</th>
                                            <th class="gray_background" style="width: 90px;">رقم الملف</th>
                                            <th class="gray_background" style="width: 29%;" >إسم رب الاسرة</th>
                                            <th class="gray_background" style="width: 90px;">عدد الأفراد</th>
                                            <th class="gray_background" style="width: 60px;" >أرملة</th>
                                            <th class="gray_background" style="width: 60px;">يتيم</th>
                                            <th class="gray_background" style="width: 65px;">مستفيد</th>
                                        ...
                                        <tr>
                                        <th class="gray_background text-center" colspan="3">الإجمــــــــــالـــى</th>
