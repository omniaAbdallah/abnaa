...
if(isset($all_member['magls_member'])&&!empty($all_member['magls_member'])) {
    foreach ($all_member['magls_member'] as $row) {
        ?>
        <td class="text-center"><input type="checkbox" name="checkbox" class="tmcheckbox"
                   value="<?php echo $row->id;?>"/></td>
        <td class="heading"><?php echo $row->member_name;?></td>
        <td ><input type="radio" id="<?php echo 'id'. $row->id;?>" name="<?php echo $row->id;?>" class="type_job"  value="رئيس اللجنة">رئيس اللجنة
            <input type="radio"id="<?php echo 'id2'. $row->id;?>" name="<?php echo $row->id;?>"  class="type_job"  value="نائب ">نائب  
        <input type="radio" id="<?php echo 'id3'. $row->id;?>" name="<?php echo $row->id;?>" class="type_job"  value="عضو ">عضو </td>
...
?>
    ...
    <tr>
        ...
        <td><input type="radio" id="<?php echo 'id'. $row2->id;?>" name="<?php echo $row2->id;?>" class="type_job2"  value=" رئيس اللجنة"> رئيس اللجنة
            <input type="radio"id="<?php echo 'id2'. $row2->id;?>" name="<?php echo $row2->id;?>"  class="type_job2"  value="  نائب "> نائب
        <input type="radio"id="<?php echo 'id3'. $row2->id;?>" name="<?php echo $row2->id;?>"  class="type_job2"  value=" عضو ">عضو </td>
...
<tr>
    ...
    <td><input type="radio" id="<?php echo 'id'. $row3->id;?>" name="<?php echo $row3->id;?>" class="type_job3"  value="رئيس اللجنة">رئيس اللجنة
        <input type="radio"id="<?php echo 'id2'. $row3->id;?>" name="<?php echo $row3->id;?>"  class="type_job3"  value="نائب ">نائب 
    <input type="radio"id="<?php echo 'id3'. $row3->id;?>" name="<?php echo $row3->id;?>"  class="type_job3"  value=" عضو "> عضو </td>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade " id="tab_forma4">
                                        <div class="form-group col-xs-8">
                                            ...
                                            <input type="text" onkeypress="validate_number(event)"   name="num_member_out"  id="num_member_out" value="" class="form-control half input-style error">
                                            <div id="load_form">
