...
echo 'asdsadsadsadasd';
        ...
        <div class="panel-body">
            <?php if (!empty($records) && isset($records)) { ?>
                ...
                <table id="example" class="table table-striped table-bordered dt-responsive nowrap dataTable"
                       cellspacing="0"
                       width="100%">
                    ...
                    <?php
                    /*
                                        echo 'total_armal = ' . $total_armal . '<br/>';
                                        echo 'total_yatem = ' . $total_yatem . '<br/>';
                                        echo 'total_mostafed = ' . $total_mostafed . '<br/>';
                    */
                    ?>
