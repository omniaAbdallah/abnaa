    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
            ...
            <div class="col-md-12">
           	<div class="form-group col-md-2 padding-4 col-sm-4" style="width: 13%;">
				 ...
				 <div  style="display: flex;">  
						...
						<button type="button" class="btn btn-warning btn-sm " style="width: 50%;" onclick="$('#file_num').val(' ')" >
		...
		<div class="form-group col-sm-1 col-xs-12 padding-4 ">
	   	...
	   	<div class="form-group col-md-2 padding-4 col-sm-4" style="width: 12%;">
           		...
           		<input type="number" onchange="check_age()" name="age_from" id="age_from" data-validation="required"  placeholder="من"
				   class="form-control  form-control " style="width: 50%;float: right;" aria-required="true" /> 
				<input type="number" onchange="check_age()"  name="age_to" id="age_to" data-validation="required"   placeholder="الى"
       ...
       <div class="form-group col-md-2 padding-4 col-sm-4 col-xs-12">
       	...
       	<select  name="disease_id_fk" id="disease_id_fk" multiple title="يمكنك إختيار أكثر من طريقه" data-show-subtext="true"
       	class=" no-padding form-control   selectpicker  "   data-live-search="true" data-actions-box="true"
       	aria-required="true"   >
       	<option value="">اختر</option>
       	<?php
