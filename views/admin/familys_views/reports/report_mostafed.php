            ...
            <form type="post" action="" id="search_form">
                <div class="col-md-12">
                    ...
                    <div class="form-group col-md-1 padding-4 col-sm-4">
                        ...
                        <select name="type_member" id="type_member" data-validation="required"
                                class=" no-padding form-control " aria-required="true">
                    ...
                    <div class="form-group col-sm-2 col-xs-12 padding-4 ">
                        ...
                        <select name="h_village[]" id="h_village" multiple title="يمكنك إختيار أكثر من طريقه"
                                data-show-subtext="true"
                                class=" no-padding form-control   selectpicker  " data-live-search="true"
                                data-actions-box="true">
                            <option value="all"> إختر</option>
...
<script>
    function make_search() {
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>family_controllers/reports/Family_reports_drasa/report_mostafed_search',
