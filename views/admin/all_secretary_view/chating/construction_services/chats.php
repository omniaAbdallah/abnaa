...
position: absolute;
"></span>
                    <p style="width: 215px;margin-right: 90px;text-align: right;color: black;font-weight: 600;" class="" href="#"><?= $v['user_name']; ?></p>
                    <img src="<?= $v['picture_url']; ?>" alt="<?= $v['user_name']; ?>" style="border-radius: 50%;height: 50px;width: 50px;margin-top: -70px;" title="<?= $v['user_name']; ?>"/>
