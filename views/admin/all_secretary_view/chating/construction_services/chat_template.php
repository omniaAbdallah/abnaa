...
<div class="col-xs-12 no-padding">
    ...
    font-weight: 600;">
                                ...
                                <div class="box-tools pull-right">
                                    <span data-toggle="" title="Clear Chat" onclick="ClearChat()" class="ClearChat"><i
                            ...
                            <div class="box-footer">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="message" placeholder="Type Message ..."
                                           class="form-control message"  onkeypress="check_send(event,this)">
                                    <span class="input-group-btn">
                             <button type="button" class="btn btn-success btn-flat btnSend" id="nav_down" onclick="sendTxtMessage(this.value)">ارسال</button>
                             <div class="fileDiv btn btn-info btn-flat"> <i class="fa fa-upload"></i>
                             <input type="file" name="file" class="upload_attachmentfile" onchange="upload_attachmentfile()"/></div>
                          </span>
                                </div>
                                <!--</form>-->
                            </div>
...
<script>
    // $(document).ready(function () {
    function make_search (input_elem) {
        // $('.search_text').keyup(function () {
        //     var search = $(this).val();
            var search = input_elem.value;
