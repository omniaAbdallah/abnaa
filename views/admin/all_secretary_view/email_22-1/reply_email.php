                ...
                <div class="panel-body " style="background-color: #fff;">
                    <div class="col-sm-8 padding-4">
                       <div class="form-group col-xs-12 no-padding">
                         ...
                         placeholder=" حدد المستخدم أو القسم" type="text" style="width: 93%;float: right;"
                                   ...
                                   value="<?= $message->email_from_n; ?>">
                                   <input type="hidden" name="to_user_fk[]" id="to_user_fk" value="<?= $message->email_from_id;?>">
                                   <input type="hidden"  data-validation="required" id="type" name="type[]" value="<?= $message->type_sender;?>"/>
                    ...
                    <div class="col-xs-12 padding-4">
                        ...
                        <label class="label">نص الرسالة</label>
                         <textarea class="form-control" placeholder="" id="editor" name="content"
