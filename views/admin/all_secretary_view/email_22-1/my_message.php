...
<div class="col-md-10 padding-4">
    ...
    ">
								...
								<a href="<?=base_url()."all_secretary/email/Emails/reply_message/".$row->id?>" class="btn btn-default" style="margin-top: 61px;"   <i class="fa fa-reply" aria-hidden="true">الرد </i></a>
                                <a href="<?=base_url()."all_secretary/email/Emails/forward_message/".$row->id?>" class="btn btn-default" style="margin-top: 61px;"   <i class="fa fa-share" aria-hidden="true" >المشاركه </i></a>
                                       </div>
		<?php	} }}?>
