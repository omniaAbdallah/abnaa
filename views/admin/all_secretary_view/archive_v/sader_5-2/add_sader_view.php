...
<div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            ...
            <div class="form-group col-md-1 col-sm-2 col-xs-12 padding-4">
                    ...
                    value="<?=date('TH:i:s');?>"
                           class="form-control  "   > -->
                           <input placeholder="من" id="m13h" class="form-control" type="text" data-validation="required"    value="<?=date('H:i');?>"
...
<!--                 
                <div class="form-group col-md-2 col-sm-4 padding-4">
                    ...
                    <input type="text" name="mawdo3_name" id="mawdo3_name" value="<?php echo $mawdo3_name ?>"
                           ...
                           ondblclick="$(this).attr('readonly','readonly'); $('#Modal_title').modal('show');"
                           onblur="$(this).attr('readonly','readonly')"
                           onkeypress="return isNumberKey(event);"
...
<!-- 
                    <input type="text" name="mawdo3_subject"
                           ...
                           class="form-control  "   > -->
                           <textarea class="form-control" placeholder="" id="editor" name="mawdo3_subject"
                         data-validation="required"
      ...
      //  var date_export=date;
       ...
       // var dataString = 'id=' + print_id + '&type=' + 2 +  "&num="+num_post+"&date="+date_export ;
        $.ajax({
            ...
            data:{id:id,date:date,num:num,morfaq_num:morfaq_num},
            dataType: 'html',
            cache:false,
            success: function(html){
                //   alert(html);
