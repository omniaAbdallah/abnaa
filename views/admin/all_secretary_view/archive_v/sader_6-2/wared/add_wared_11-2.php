...
?>
          ...
          <?php
            ...
            <div class="form-group padding-1 col-md-2 col-xs-12 padding-4">
    <label class="label "> نوع الوارد</label>
    <select name="wared_type" id="wared_type" data-validation="required" class="form-control">
        <option value="">إختر</option>
        <?php
        $arrxx = array(1 => 'داخلي', 2 => 'خارجي');
        foreach ($arrxx as $key => $value) {
    ...
    <input type="text" class="form-control  testButton inputclass" name="folder" id="folder"
           readonly="readonly" onclick="get_folders()" style="cursor:pointer;border: white;color: black;width: 84%;float: right;"
