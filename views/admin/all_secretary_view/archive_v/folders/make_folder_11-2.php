            ...
            <div class="col-md-9 padding-4">
                ...
                <div class="col-md-6" style="padding-top: 30px;">
                    <div class="radio-content">
                        <input type="radio" id="type_sarf1" <?php if ($type == 0) echo 'checked'; ?>
                               onclick="make_dis($(this).val());" name="sarf_type" class="sarf_types" value="0">
                        <label for="type_sarf1" class="radio-label"> رئيسي</label>
                    </div>

                    <div class="radio-content">
                        <input type="radio" id="type_sarf2" <?php if ($type == 1) echo 'checked'; ?>
                               onclick="make_dis($(this).val());" name="sarf_type" class="sarf_types" value="1">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-control" <?php if ($type != 1) echo 'disabled'; ?> name="from_id_fk"
                            id="from_id_fk">
                ...
                <div class="col-md-9 text-center" style="padding-top: 20px;">
                    ...
                    <button <?php if (isset($one_row) && !empty($one_row)) { ?> type="submit" <?php } else { ?> type="button"  onclick="save_data();"  <?php } ?>
                            style="font-size: 17px !important;" class="btn btn-labeled btn-success " name="save"
                            value="save">
...
<script>
    ...
    function save_data() {
        ...
        $.ajax({
            ...
            data: {
                ar_title: ar_title, en_title: en_title,
