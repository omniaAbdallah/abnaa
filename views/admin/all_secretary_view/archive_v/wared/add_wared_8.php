...
?>
          ...
          <?php
            ...
            <select name="wared_type" id="wared_type" data-validation="required" <?= $disabled ?> class="form-control">
            ...
            <div class="form-group col-md-2 col-sm-2 col-xs-12 padding-4">
               ...
               <input type="hidden"  id="m13h" name="tsgeel_time" class="form-control"  data-validation="required"    value="<?=$tsgeel_time?>"
                            style="width: 100%; float: right;margin-left: 10px;    text-align: center;" >
    ...
    <input type="text" class="form-control  testButton inputclass" name="folder" id="folder"
           readonly="readonly" onclick="get_folders()" <?= $disabled ?> style="cursor:pointer;border: white;color: black;width: 84%;float: right;"
    ...
    <button type="button" onclick="get_folders()" <?= $disabled ?>
       ...
       <div class="form-group col-md-2 col-sm-6 padding-4" 
                    ...
                    <input type="text" name="tarekt_estlam_name" id="tarekt_estlam_name" value="<?php if (!empty($tareket_estlam)) {
...
?>"
     ...
     <div class="col-xs-12 no-padding">
                    ...
                    <input type="hidden" name="geha_morsla_id_fk" id="geha_morsla_id_fk" value="<?= $geha_morsla_id_fk?>">
                    <button type="button"
                            onclick="$('#gehatModal').modal('show');get_details_geha_type();"
                            class="btn btn-success btn-next" >
                        <i class="fa fa-plus"></i></button>
          ...
          <div class="form-group padding-4 col-md-3 col-xs-12">
                    ...
                    <input type="text" name="morsel_name" id="morsel_name" value="<?php echo $morsel_name ?>"
                           ...
                           data-validation-has-keyup-event="true" readonly>
                    <button type="button"
                    onclick="get_details_geha_morsel()" data-toggle="modal" data-target="#Modal_geha_morsel" 
                            class="btn btn-success btn-next">
                        <i class="fa fa-plus"></i></button>
                </div>
<!--
...
<!-- end 12-2-2020 rehab.dev------------------------------------------>
           ...
           <?php if (isset($item) && !empty($item)){ ?>
                <button type="submit" <?=$disabled_action?> class="btn btn-labeled btn-success " name="add" value="اضافه"   >
                    <span class="btn-label"><i class="glyphicon glyphicon-floppy-disk"></i></span>حفظ
                </button> 
                <?=$sapn_action?>
           <?php }else{ ?>
         
                <button type="button" id="buttons" class="btn btn-labeled btn-success " onclick="save_wared()"
...
<div class="form-group col-md-4 col-sm-6 padding-4">
                         ...
                         placeholder=" حدد الموظف م" type="text" style="width: 78%;float: right;"
                                   ...
                                   readonly="readonly"
                                   onclick="$('#tahwelModal_mosalm').modal('show'); "
                                   value="">
                                ...
                                <div id="geha_ektsas_input" style="display: none">
                                    ...
                                    <div class="form-group col-md-4 padding-4">
                                        <div class="col-sm-3  col-md-2 padding-4" id="div_add_geha_ektsas"
                                             style="display: block;">
                                            <button type="button" onclick="add_geha_ektsas($('#geha_morsla_id_fk').val())"
                                                    style="    margin-top: 27px;"
                                                    class="btn btn-labeled btn-success" name="save" value="save">
                                            <span class="btn-label"><i
                                                        class="glyphicon glyphicon-floppy-disk"></i></span>حفظ
