                            ...
                            <table id="exampleeee" class=" example table table-bordered table-striped" role="table">
                                ...
                                foreach ($estlam as $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td><input style="width: 90px;height: 20px;" type="checkbox" name="<?= $value->id ?>" id="myCheck<?= $value->id ?>"  data-id="<?= $value->id ?>"

                                         class="checkbox  radio"  value="<?= $value->title?>"       onchange="GetestlamName(<?= $value->id ?>,'<?= $value->title?>')"></td>
                                        <td style="cursor: pointer"  data-title="<?= $value->id ?>" >
