...
?>
 م
        ...
        <p style="margin-top: 8px;" class="fhelvetic no-margin" >( <?php if (!empty($get_all->subject)) {
...
?>)</p>
    ...
    -->
        ...
        <div class="col-xs-3 text-center print_head" style="font-weight: 600;padding-left: 0; ">
        <p class="fhelvetic no-margin" style="margin-right: -40px;margin-top: 5px;"><?=$get_all->year.'/'. $get_all->emp_depart_code .'/'.$get_all->rkm?></p>
        <p class="fhelvetic no-margin" style="margin-right: -40px;">
...
?>
        ...
        <p style="margin-right: -40px;" class="fhelvetic no-margin ">0</p>
        <p style="margin-top: 0px;margin-right: -40px;" class="fhelvetic no-margin" >
