    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-12 no-padding">
                ...
                <!--/*31-8-20-om*/-->
                <div class="form-group padding-1 col-md-1 col-xs-12 padding-4">
                    <label class="label "> نوع الصادر</label>
                    <select type="text" name="sader_type" id="sader_type" data-validation="required" value="" onchange="get_type_div(this.value)"
                        ...
                        foreach ($sader_type_arr as $key => $value) { ?>
                            <option value="<?= $key ?>"
                                <?php if ($sader_type == $key) {
                                    echo 'selected';
                                } ?>><?= $value ?></option>
                        <?php } ?>
                    </select>
                    <?php if (!empty($disabled)) { ?>
                        <input type="hidden" name="sader_type" id="sader_type" value="<?= $sader_type ?>">
                    <?php } ?>
                </div>
                <div class="form-group padding-4 col-md-1 col-xs-12 padding-4">
                ...
                <div class="form-group col-md-2 col-sm-2 col-xs-12 padding-4">
                    ...
                    value="<?= date('TH:i:s'); ?>"
                           class="form-control  "   > -->
                    <input placeholder="من" id="m13h_" class="form-control" type="time" 
                           value="<?= date('H:i'); ?>"
                ...
                <div class="form-group col-md-2 col-sm-2 col-xs-12 padding-4">
                    ...
                    <!-- <input type="time-local" name="ersal_time"
                           value="<?= $ersal_time ?>"
                           class="form-control  "   > -->
                    <input name="ersal_time" id="m12h_" class="form-control" type="time" data-validation="required"
                           value="<?= $ersal_time ?>"
                           style="width: 100%; float: right;margin-left: 10px;    text-align: center;">
                </div>
            </div>
            <div class="col-xs-12 no-padding">
                ...
                <div class="form-group col-md-2 col-sm-6 padding-4">
                    ...
                    <input type="text" name="tarekt_ersal_n" id="tarekt_ersal_n"
            ...
            <div class="col-xs-12 no-padding">
                ...
                <div id="no3_out" style="display:<?=$no3_out?>;">
                   ...
                   <div class="form-group padding-4 col-md-3 col-xs-12">
                        ...
                        <input type="hidden" name="geha_ekhtsas_fk" id="geha_ekhtsas_fk"
                               value="<?= $geha_ekhtsas_fk ?>"/>
                  ...
                  <div id="no3_in" style="display: <?=$no3_in?>">
                    <div class="form-group padding-4 col-md-4 col-xs-12">
                        ...
                        <input type="text" class="form-control  testButton inputclass"
                               name="edara_n" id="edara_n"
                               readonly="readonly"
                               onclick="$('#modal_type').modal('show'); get_edara_type(1);"
                               style="cursor:pointer;border: white;color: black;width: 89%;float: right;"
                               value="<?= $geha_morsel_n ?>">
                        <input type="hidden" name="edara_id_fk" id="edara_id_fk" value="<?= $geha_morsel_fk ?>">
               ...
               <!-- <div id="no3_in" style="display: <?=$no3_in?>">
                    <div class="form-group padding-4 col-md-4 col-xs-12">
                        <label class="label "> الادارة </label>
                        <input type="text" class="form-control  testButton inputclass"
                               name="geha_morsel_n" id="edara_n" 
                               readonly="readonly"
                               onclick="$('#modal_type').modal('show'); get_edara_type(1);"
                               style="cursor:pointer;border: white;color: black;width: 89%;float: right;"
                               value="<?= $geha_morsel_n ?>">
                        <input type="hidden" name="geha_morsel_fk" id="edara_id_fk" value="<?= $geha_morsel_fk ?>">

                    </div>
                    <div class="form-group padding-4 col-md-3 col-xs-12">
                        <label class="label ">القسم</label>
                        <input type="text" class="form-control  testButton inputclass"
                               name="geha_ekhtsas_n" id="qsm_n"
                               readonly="readonly"
                               onclick="$('#modal_type').modal('show'); get_edara_type(2);"
                               style="cursor:pointer;border: white;color: black;width: 82%;float: right;"
                               value="<?= $geha_ekhtsas_n ?>">
                        <input type="hidden" name="geha_ekhtsas_fk" id="qsm_fk"
                               value="<?= $geha_ekhtsas_fk ?>">
                        <input type="hidden" id="geha" data-id="" data-title="">
                    ...
                    <div class="form-group padding-4 col-md-3 col-xs-12">
                        <label class="label "> الموظف</label>
                        <input type="text" class="form-control  testButton inputclass"
                               name="mostlem_name" id="emp_name" readonly="readonly"
                               onclick="$('#modal_type').modal('show'); get_edara_type(3);"
                               style="cursor:pointer;border: white;color: black;width: 82%;float: right;"
                               value="<?= $mostlem_name ?>">
                ...
                <div class="form-group col-md-1 col-sm-2 col-xs-12 padding-4">
                    <label class="label"> وقت الاستحقاق 
                    ...
                    <!-- <input type="time-local" name="esthkak_time"
                           value="<?= $esthkak_time ?>"
                           class="form-control  "   > -->
                    <input name="esthkak_time" id="m14h__" class="form-control" type="time" data-validation="required"
                           value="<?= $esthkak_time ?>"
                           style="width: 100%; float: right;margin-left: 10px;    text-align: center;">
                </div>
            ...
            <div class="  text-center col-xs-12">
                ...
                <?php if (isset($get_sader) && !empty($get_sader)) { ?>
                    <button type="submit" <?= $disabled_action ?> class="btn btn-labeled btn-success " name="add"
                    <?= $action ?> value="add">
                ...
                <?php } else { ?>
                    ...
                    <button type="button" id="buttons" class="btn btn-labeled btn-success " onclick="save_sader()"
                            name="add" value="add"><span class="btn-label"><i
          ...
          var request = $.ajax({
            success: function (html) {
                ...
                window.onafterprint = function(){
                    ...
                    location.href = '<?php echo base_url() ?>all_secretary/archive/sader/Add_sader/add_deal/'+id;
        ...
        request.done(function (msg) {
           ...
           /* WinPrint.focus();
            ...
            WinPrint.onafterprint = function(){
                WinPrint.close();
                console.log("Printing completed...");
                location.href = '<?php echo base_url() ?>all_secretary/archive/sader/Add_sader/add_deal/'+row_id;
            }
        });
...
<script>
    function get_type_div(value) {
        if (value == 1) {
            $('#no3_out').hide();
            $('#no3_in').show();
            $('#geha_morsel_n').removeAttr('data-validation');
            $('#geha_ekhtsas_n').removeAttr('data-validation');
            $('#mostlem_name').removeAttr('data-validation');
            ...
            $('#geha_morsel_n').attr('data-validation="required"');
            $('#geha_ekhtsas_n').attr('data-validation="required"');
            $('#mostlem_name').attr('data-validation="required"');
