...
<script>
 ...
 //$('#to_user_n').append("<input type='hidden' id='to_user_fk"+id+"'  name='to_user_fk' value='"+id+"'/><input type='hidden'  data-validation='required' id='to_user_fk_name"+id+"' name='to_user_fk_name' value='"+name+"'/>");
        //$('#to_user_id').val(id);
       // $('#to_user_n').val(name);
        $('#to_user_id'+sader_id).val(id);
        $('#to_user_n'+sader_id).val(name);
...
<script>
  function add_reason(id) {
    ...
    var num_end=$('#num_end').val();*/
         var id = id;
        var value = $('#reason_id_fk'+sader_id).val();
        var name = $('#reason_name'+sader_id).val();
        var to_user_n = $('#to_user_n'+sader_id).val();
        var to_user_id = $('#to_user_id'+sader_id).val();
        var from_user_n = $('#from_user_n'+sader_id).val();
        var date_end = $('#date_end'+sader_id).val();
        var num_end = $('#num_end'+sader_id).val();
...
<script>
   /* function getTitle_reason(id,value) {
     ...
     function getTitle_reason(id, value) {
        $('#reason_id_fk'+sader_id).val(id);
        $('#reason_name'+sader_id).val(value);
        $('#myModal_end').modal('hide');
    }
</script>
<script>
