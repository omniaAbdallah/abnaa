...
<span class="label"style="color: #940000;"><?=$get_all->year.'/'. $get_all->emp_depart_code .'/'.$get_all->sader_rkm?></span>
                        ...
                        <div class="col-sm-9 col-xs-12">
                            ...
                            <table class="table  table-striped table-bordered dt-responsive nowrap">
                                ...
                                <tr>
                                    ...
                                    <td><?=$get_all->year.'/'. $get_all->emp_depart_code .'/'.$get_all->sader_rkm?></td>
                                </tr>
                                <tr>
                                    <th>تاريخ التسجيل  </th>
                                ...
                                <tr>
                                    <th>المجلد</th>
                                    <td><?php if (!empty($get_all->folder_name)) {
...
<!-- </div>-->
                    ...
                    <table class="table example table-bordered table-striped table-hover">
                        ...
                        <i class="fa fa-eye" title=" قراءة"></i> </a>
                        <!-- modal view -->
                        <div class="modal fade" id="myModal-pdf-<?= $morfaq->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal"
                                    ...
                                    <div class="modal-body">  
                                             <iframe src="<?=base_url()."all_secretary/archive/sader/Add_sader/read_file/".$morfaq->morfaq?>" style="width: 100%; height:  640px;" frameborder="0"> </iframe>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-default" data-dismiss="modal">
                                            إغلاق
      ...
      <?php }?>
				...
				<div class="tab-pane" id="pag4" role="tabpanel">
                    <div class="col-xs-10 no-padding">
                        ...
                        <div class="form-group padding-4 col-md-3 col-xs-12">
                                <label class="label ">    اسم المهمه</label>
                            <input type="text" name="mohema_n" id="mohema_n" value=""
                    ...
                    <div class="col-xs-2 no-padding" style="height: 150px; overflow-y: scroll;">
...
<?php }
                        ...
                        <!-- yara4-5 -->
                                ...
                                <div class="col-md-2 form-group">
                                <?php if( $get_all->suspend!=4){ ?>
                                    <button class="btn btn-success btn-labeled"  style="    margin-top: 25px;" type="button" name="add" onclick="insert_comments(<?= $this->uri->segment(6)?>)" value="add"><span class="btn-label"><i class="fa fa-reply"></i></span>إرسال</button>
                                    <?php }else{?>
            <button class="btn btn-success btn-labeled"  style="    margin-top: 25px;" type="button" name="add" disabled value="add"><span class="btn-label"><i class="fa fa-reply"></i></span>إرسال</button>
    ...
    function insert_tahwel(sader_id) {
        ...
        if (mohema_n !='' && to_user_n !='' && tahwel_type !='' && esthkak_date !='' && awlawia_fk!=''){
            $.ajax({
                ...
                data: {row_id:row_id,sader_id:sader_id,mohema_n:mohema_n,mohema_fk:mohema_fk,to_user_n:to_user_n,to_user_id:to_user_id,tahwel_type:tahwel_type,awlawia_fk:awlawia_fk,esthkak_date:esthkak_date,subject:subject},
                dataType: 'html',
                cache: false,
                beforeSend:function()
            {
