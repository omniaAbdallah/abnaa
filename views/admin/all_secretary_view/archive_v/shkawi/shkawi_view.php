            ...
            <div class="col-xs-12 no-padding">
                ...
                <?php
                      ...
                      if (isset($get_shkwa)&& !empty($get_shkwa)){
                          echo form_open_multipart('all_secretary/archive/shkawi/Shkawi/update_shkwa/'.$get_shkwa->rkm);
                          $rkm = $get_shkwa->rkm ;
                          $type = $get_shkwa->type ;
                          ...
                          echo form_open_multipart('all_secretary/archive/shkawi/Shkawi/add_shkwa');
                      }
                     ?>
...
window.location="<?=base_url()?>all_secretary/archive/shkawi/Shkawi/delete_shakwa/<?= $row->id?>";
});'>
...
<script>
            function GetDiv_emps(div) {
                ...
                var oTable_usergroup = $('#js_table_members2').DataTable({
                    dom: 'Bfrtip',
                    "ajax": '<?php echo base_url(); ?>all_secretary/archive/shkawi/Shkawi/getConnection_emp/',
                    aoColumns: [
                        {"bSortable": true},
                        {"bSortable": true},
                        {"bSortable": true},
...
<script>
    function get_details_message_type() {
       // $('#pop_rkm').text(rkm);
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>all_secretary/archive/shkawi/Shkawi/load_message_type",
...
<script>
  ...
  function add_message_type(value) {
      ...
      if (value != 0 && value != '' ) {
          ...
          $.ajax({
              type: 'post',
              url: '<?php echo base_url() ?>all_secretary/archive/shkawi/Shkawi/add_message_type',
              data: dataString,
              dataType: 'html',
              cache: false,
...
<script>
    function update_message_type(id) {
        ...
        $.ajax({
            url: "<?php echo base_url() ?>all_secretary/archive/shkawi/Shkawi/getById_message_type",
            type: "Post",
            dataType: "html",
            data: {id: id},
        ...
        $('#update_message_type').on('click', function () {
            ...
            $.ajax({
                url: "<?php echo base_url() ?>all_secretary/archive/shkawi/Shkawi/update_message_type",
                type: "Post",
                dataType: "html",
...
function(isConfirm) {
  if (isConfirm) {
    $.ajax({
                type: 'post',
                url: '<?php echo base_url() ?>all_secretary/archive/shkawi/Shkawi/delete_message_type',
                data: {id: id},
                dataType: 'html',
                cache: false,
                beforeSend: function()
...
<script>
    function get_shkwa_type(type) {
       ...
       // $('#pop_rkm').text(rkm);
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>all_secretary/archive/shkawi/Shkawi/get_shkwa_type",
...
<script>
    function get_details_shkwa_type() {
       // $('#pop_rkm').text(rkm);
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>all_secretary/archive/shkawi/Shkawi/load_shkwa_type",
...
<script>
  ...
  function add_shkwa_type(value) {
      ...
      if (value != 0 && value != '' ) {
          ...
          $.ajax({
              type: 'post',
              url: '<?php echo base_url() ?>all_secretary/archive/shkawi/Shkawi/add_shkwa_type',
              data: dataString,
              dataType: 'html',
              cache: false,
              success: function (html) {
...
<script>
    function update_shkwa_type(id) {
        ...
        $.ajax({
            url: "<?php echo base_url() ?>all_secretary/archive/shkawi/Shkawi/getById_shkwa_type",
            type: "Post",
            dataType: "html",
            data: {id: id},
            success: function (data) {
        ...
        $('#update_shkwa_type').on('click', function () {
            ...
            $.ajax({
                url: "<?php echo base_url() ?>all_secretary/archive/shkawi/Shkawi/update_shkwa_type",
                type: "Post",
                dataType: "html",
...
<script>
    function load_details(row_id) {
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>all_secretary/archive/shkawi/Shkawi/load_details",
            data: {row_id:row_id},
            success: function (d) {
                $('#result').html(d);
            }
