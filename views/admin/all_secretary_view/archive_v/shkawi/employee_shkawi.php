...
<div class="panel panel-default ">
       ...
       aria-hidden="true"
         ...
         <?php if( $row->readed !=0){
                           ...
                           <?php }else{
           if(($_SESSION['role_id_fk']==3) && ($_SESSION['emp_code']==$row->reciver_id_fk)){              
                        ?>
...
window.location="<?=base_url()?>all_secretary/archive/shkawi/Shkawi/read_shakwa/<?= $row->id?>";
});' class="btn btn-warning">
<i class="fa fa-archive">استلام الشكوي </i></button>

<?php }else{ ?>
<span style="width: 50%;color: black !important;" class="label label-warning">لم يتم الاستلام</span>
<?php
}}?>
                    </td>
                    </tr>
