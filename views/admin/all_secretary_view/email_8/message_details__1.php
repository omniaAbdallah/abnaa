...
<div class="mailbox-body">
    <div class="inbox-avatar p-20 border-btm">
        <img src="https://abnaa-sa.org/uploads/human_resources/emp_photo/thumbs/ebdea1c2350df8ca89bf85387d8e8b61.jpg"
            ...
            <div class="col-xs-12">
                <div class="inbox-toolbar btn-toolbar">
                    ...
                    <div class="btn-group">
                        ...
                        <a href="#" class="hidden-xs hidden-sm btn btn-default"><span
                                    class="fa fa-reply-all"></span></a>
                        <a href="#" class="btn btn-default"><span class="fa fa-share"></span></a>
                    </div>
                    <div class="btn-group">
                        <button type="button" class="btn btn-default" onclick="myFunction()"><span
                                    class="fa fa-print"></span></button>
                    </div>
                    <div class="hidden-xs hidden-sm btn-group">
                        <button type="button" class="text-center btn btn-danger"><span class="fa fa-exclamation"></span>
                        </button>
          ...
          <a href="#" class="btn btn-default btn-xs pull-right"><i class="fa fa-cloud-download"></i></a>
                        ...
                        <li>
                            <span class="mailbox-attachment-icon has-img"><img
                                        src="https://abnaa-sa.org/asisst/admin_asset/img/avatar5.png" alt="Attachment"></span>
                            <div class="mailbox-attachment-info">
    ...
    font-weight: 600;">
                                <?= $chatTitle; ?></h6>
                            <img src="https://abnaa-sa.org/asisst/admin_asset/img/avatar5.png" alt="alatheer"
                                 title="alatheer"
                                 style="border-radius: 50%;height: 50px;width: 50px;margin-top: -70px;"/>
                            <div class="box-tools pull-right">
                                <span data-toggle="tooltip" title="Clear Chat" class="ClearChat"><i
...
<div class="col-xs-12 inbox-mail">
    <div class="panel panel-default">
      ...
      الموضوع  </span>
                    <span style="background-color: #462542; font-weight: normal;font-size: 13px;"
    ...
    font-weight: 600;">
                                            <?= $chatTitle; ?></h6>
                                        <img src="https://abnaa-sa.org/asisst/admin_asset/img/avatar5.png"
                                             alt="alatheer" title="alatheer"
                                             style="border-radius: 50%;height: 50px;width: 50px;margin-top: -70px;"/>
                                        <div class="box-tools pull-right">
                                            <span data-toggle="tooltip" title="Clear Chat" class="ClearChat"><i
                                                        class="fa fa-comments"></i></span>
                    ...
                    <div class="tab-pane fade  in active" id="morfaq<?= $message->email_rkm ?>" role="tabpanel"
                         aria-labelledby="morfaq-tab">
                        <div class="col-md-12 ">
                                    ...
                                    <div class="  col-sm-2 col-xs-4">
                                        <div class="card">
                                            ...
                                            if (!empty($files->file) || $files->file != 0) {
                                                ...
                                                if (in_array($ext, $img)) {
                                                    ?>
                                                    <img class="img-thumbnail img-responsive card-img-top"
                                                         alt="attachment"
...
<script>
    function make_replay() {
        ...
        if ((files != '')) {
            ...
            if (error == '') {
                $.ajax({
                    url: "<?php echo base_url(); ?>all_secretary/email/Requestes/make_replay/", //base_url() return http://localhost/tutorial/codeigniter/
                    method: "POST",
                    data: form_data,
                    contentType: false,
                    cache: false,
