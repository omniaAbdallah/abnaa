            ...
            <div class="col-xs-12">
                <div class="inbox-toolbar btn-toolbar">
                    <div class="btn-group">
                        ...
                        <a title="تحديد الرسالة كرسالة هامة" onclick="make_star(<?= $message->email_rkm ?>,<?=$message->starred?>)" class="btn btn-default"><i
                                    id="satr_<?= $message->email_rkm ?>"
                                    class="fa fa-star <?php if ($message->starred == 1) {
                                        echo 'inbox-started';
                                    } else {
                    ...
                    <div class="btn-group">
                        ...
                        <a title="إضافة مرفق" data-toggle="modal" data-target="#replay_Modal" class="btn btn-add">
                            <span class="fa fa-pencil-square-o"></span> </a>
                    </div>
                    <div class="btn-group">
                        <a title="تحويل إلي موظف"  data-toggle="modal" data-target="#add_emp_Modal"
                           onclick="get_emps(<?= $message->email_rkm ?>)" class="btn btn-default"><span
                                    class="fa fa-reply"></span></a>

                    </div>
                    <div class="btn-group">
                        <button title="طباعة الرسالة" type="button" class="btn btn-default" onclick="print_email(<?= $message->email_rkm ?>)"><span
                                    class="fa fa-print"></span></button>
                    </div>
                    <div class="hidden-xs hidden-sm btn-group">
                        <a title="تحويل الرسالة إلي سلة المحذوفات" class="btn btn-danger" onclick='swal({
                            ...
                            <li>
                                ...
                                <?php } elseif (in_array($ext, $file_exe)) {
                                    switch ($ext) {
                                        ...
                                        <span class="mailbox-attachment-icon"><i class="fa fa-file-<?= $extin ?>-o"></i></span>
                                        <div class="mailbox-attachment-info">
                                            <a href="<?= base_url() . "all_secretary/email/Emails/download_file/" . $files->email_rkm . '/' . $files->file ?>"
    ...
    <div class="modal-dialog" role="document" style="width: 80%">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"> تحويل إلي شخص</h5>
...
<div class="modal fade" id="replay_Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"> إضافة مرفق </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <div class="col-md-12">
                        <label class="label"> رفع مرفق</label>
                        <div>
