                ...
                ?>
                   ...
                   <?php     if (!empty($files->file) || $files->file != 0) {
                    ...
                    if (in_array($ext, $img)) {
                                ...
                                <?= $size?>
                                <a href="<?= base_url() . "all_secretary/email/Emails/download_file/" . $files->email_rkm . '/' . $files->file ?>" class="btn btn-default btn-xs pull-right" download><i class="fa fa-cloud-download"></i></a>
                    ...
                    <?php }elseif (in_array($ext, $file_exe)) {
                        ...
                        <span class="mailbox-attachment-icon"><i class="fa fa-file-pdf-o"></i></span>
                            <div class="mailbox-attachment-info">
                                <a href="<?= base_url() . "all_secretary/email/Emails/download_file/" . $files->email_rkm . '/' . $files->file ?>" class="mailbox-attachment-name"><i class="fa fa-paperclip"></i>
                                <!-- <?=$files->file?> -->
                                </a>
                                <span class="mailbox-attachment-size">
                                <?= $size?>
