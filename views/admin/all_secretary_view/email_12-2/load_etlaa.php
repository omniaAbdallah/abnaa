...
<table id="etlaa" class="etlaa display table  table-bordered table-striped" role="table">
    ...
    <th >
                                        ...
                                        <input type="checkbox" onclick="check_all(this,'etlaa')"  style="width: 90px;height: 20px;"/>
    ...
    foreach ($all as $row) {
        ...
        <!-- <input type="checkbox" id="myCheck"  onclick="myFunction()"> -->
            ...
            <td><input style="width: 90px;height: 20px;" type="checkbox" name="<?= $row->id ?>" id="myCheck<?= $row->id ?>3"  data-id="<?= $row->id ?>"

            class="checkbox  radio"  value="<?= $row_n?>"    data-type="3"     onchange="GettahwelName(<?= $row->id ?>,'<?= $row_n?>',3)"></td>
