...
<?php 
  $need_replay='' ;
  $important_degree='';
echo form_open_multipart('all_secretary/email/Emails/add_email');
?>
    ...
    <div class="modal-dialog" role="document" style="width: 80%;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                <div class="radio-content">
                    <input type="radio" id="esnad_motbaa3" name="esnad_motbaa_to"  class="sarf_types" value="3" onclick="load_motbaa()">
                ...
                <div class="panel-body " style="background-color: #fff;">
                    <div class="col-sm-8 padding-4">
                       ...
                       <label class="label ">  الي</label>
                         ...
                         placeholder=" حدد المستخدم أو القسم" type="text" style="width: 93%;float: right;"
                       ...
                       <!-- <div class="form-group col-sm-6 padding-4">
                         <label class="label"> نوع المرسل اليه</label>
                         <select  name="need_replay"
                             class="form-control  " data-validation="required" >
                             <option value="">إختر</option>
                        <?php
                             $arr = array('1'=>'موظف','2'=>'قسم');
                    ...
                    <select name="file_status[]" id="file_status"
                       ...
                       <div class="form-group col-xs-12 no-padding">
                         ...
                         <input class="form-control" placeholder="" type="text" name="title"  id="title"  data-validation="required"/>
                       </div>
                    </div>
...
<!-- input -->
                           ...
                           type="file" multiple="multiple"> -->
                            ...
                            <div class="col-xs-2">
                                <button type="button" onclick="upload_img()" style="height: 35px;width: 78px;" id="add"  name="add" class="btn btn-success m-t-20"><i class="fa fa-envelope-o"></i> إرسال</button>
                            </div>
                </div>
             </div>   
         </div>
...
$("input[name='type[]']").each(function(){
    ...
    console.warn('to_user_fk::'+to_user_fk);
       ...
       if((title !='') && (to_user_fk !='') && (to_user_fk_name !='') && (content !='') && (important_degree !='') && (need_replay !='') && (files.length !=0 ))
       {
