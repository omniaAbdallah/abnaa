                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 inner-side r-data">
                                ...
                                <div class="col-xs-12 ">
                                    ...
                                    <div class="col-xs-6 r-input ">
                                                ...
                                                <input type="text" class="form-control date_melady" name="from_date" placeholder="شهر / يوم / سنة " value="<? echo $result['from_date'];?>" >
                                    ...
                                    <div class="col-xs-12">
                                        <div class="col-xs-6">
                                            <h4 class="r-h4">سبب الأجازة  </h4>
                                        </div>
                                        <div class="col-xs-6 r-input">
                                            <textarea class="r-textarea"  name="vacation_reason"><? echo $result['vacation_reason'];?></textarea>
                                        </div>
                                    </div>
                            </div>
                            <div class="col-md-6 col-sm-12 col-xs-12 inner-side r-data">
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-6 r-input">
                                        <select name="vacation_id"  id="vacation_id" class="form-control" data-validation="required" >
                                            <option value="">--إختر--</option>
                                            <?php
                                ...
                                <div class="col-xs-12 ">
                                    ...
                                    <div class="col-xs-6 r-input ">
                                                ...
                                                <input type="text" class="form-control date_melady"   name="to_date" placeholder="شهر / يوم / سنة " 
                                                value="<? echo $result['to_date'];?>">
                ...
                <div class="details-resorce">
                    <div class="col-xs-12 r-inner-details">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 inner-side r-data">
                            ...
                            <div class="col-xs-12" id="optionearea5"></div>
                            <?php }elseif($_SESSION['role_id_fk'] ==3){ ?>
                            <div class="col-xs-12">
                                <div class="col-xs-6">
                                    <h4 class="r-h4"> الموظف </h4>
                                ...
                                <div class="col-xs-6 r-input">
                                    <?php if($_SESSION['head_dep_id_fk'] ==1):?>
                                        <select name="emp_id" id="emp_id"  class="selectpicker form-control" data-show-subtext="true" data-live-search="true" style="width:100%;" onchange="return back($('#emp_id').val() );" data-validation="required">
                                            <option value="">إختر</option>
                            ...
                            <div class="col-xs-12 ">
                                ...
                                <div class="col-xs-6 r-input ">
                                            ...
                                            <input type="text" data-validation="required" class="form-control date_melady" name="from_date" placeholder="شهر / يوم / سنة ">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-6 r-input">
                                    <textarea class="r-textarea" name="vacation_reason"    data-validation="required"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                            ...
                            <div class="col-xs-12 ">
                                ...
                                <div class="col-xs-6 r-input ">
                                            ...
                                            <input type="text" class="form-control date_melady" data-validation="required" name="to_date" placeholder="شهر / يوم / سنة ">
                        ...
                        <div class="form-group col-sm-12 col-xs-12">
                            <button type="submit" name="add" value="حفظ" class="btn btn-purple w-md m-b-5" onclick="return myFunction()"><span><i class="fa fa-floppy-o" aria-hidden="true"></i></span> حفظ </button>
                        </div>
                        <?php echo form_close()?>
                    </div>
                </div>
                              ...
                              foreach ($arr_dif as $row_1):
                                ...
                                <tr>
                                    ...
                                    <td> <button type="button" class="btn btn-info btn-xs " data-toggle="modal" data-target="#myModal<?php echo $record->id?>"><i class="fa fa-list"></i> التفاصيل </button>
                                        <?php
                                        $query2 =$this->db->query('SELECT vacations.*,employees.employee,prog_main_sitting.title FROM `vacations` LEFT JOIN `employees` on (`employees`.`id`=`vacations`.`emp_assigned_id`)
                                            LEFT JOIN `prog_main_sitting` ON (`vacations`.`vacation_id`=`prog_main_sitting`.`id`)
