                        ...
                        <div class="col-xs-12 r-inner-details">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 inner-side r-data">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-6 r-input">
                                        <select name="vacation_id"  id="vacation_id" class="form-control" data-validation="required"  onchange="getVacationEnd($('#from_date').val())">
                                            <option value="">--إختر--</option>
                                            <?php
                               ...
                               <div class="col-xs-12 ">
                                    ...
                                    <div class="col-xs-6 r-input ">
                                      ...
                                      <input type="number" class="form-control "   id="vacations_days" name="vacations_days"  placeholder="أدخل البيانات " value="<? echo $result['vacations_days'];?>" >
                                ...
                                <div class="col-xs-12 ">
                                  ...
                                  <div class="col-xs-12 ">
                                    ...
                                    <div class="col-xs-6 r-input ">
                                      ...
                                      <input type="number" class="form-control "   id="vacations_days" name="vacations_days" placeholder="أدخل البيانات " />
