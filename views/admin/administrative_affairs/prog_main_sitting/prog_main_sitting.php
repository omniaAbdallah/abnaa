      <div class="col-sm-12 col-md-12 col-xs-12">
        ...
        <div class="col-sm-2 col-md-2 col-xs-2">
          <button type="submit"  class="btn btn-purple w-md m-b-5" onclick="window.location.href = '<?=base_url()?>Administrative_affairs/new_sitting/7';"><i class="fa fa-plus"></i> إضافة المسميات الوظيفية </button>
        </div>

        <div class="col-sm-2 col-md-2 col-xs-2">
          <button type="submit"  class="btn btn-purple w-md m-b-5" onclick="window.location.href = '<?=base_url()?>Administrative_affairs/new_sitting/8';"><i class="fa fa-plus"></i> إضافة أسباب الأذونات </button>
        </div>
        
           <div class="col-sm-2 col-md-2 col-xs-2">
          <button type="submit"  class="btn btn-purple w-md m-b-5" onclick="window.location.href = '<?=base_url()?>Administrative_affairs/new_sitting/9';"><i class="fa fa-plus"></i> إضافة أنواع المطالبة  </button>
        </div>
      ...
      <div class="col-sm-12 col-md-12 col-xs-12">
        ...
        <div class="col-md-4 col-sm-6 fadeInUp wow">
          <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
            ...
            <div class="panel-body">
              <?php if(isset($job_titles) && $job_titles != null) { ?>
                <table id="" class="display table table-bordered responsive nowrap" cellspacing="0" width="100%">
                  <thead>
                  <tr class="info">
                    <th>م</th>
                  ...
                  foreach ($job_titles as $value)
                  {
                    ...
                    <tr>
                      ...
                      <td><?=$value->title?></td>
                      <td>
                        <a href="<?php echo base_url('Administrative_affairs/edit_sitting').'/7/'.$value->id ?>" title="تعديل"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
                        <span> </span>
                        <a onclick="$('#adele').attr('href', '<?=base_url()."Administrative_affairs/delete_sitting/7/".$value->id?>');" data-toggle="modal" data-target="#modal-delete" title="حذف"> <i class="fa fa-trash" aria-hidden="true"></i> </a>
                      </td>
                    </tr>
                  <?php } ?>
                  </tbody>
        ...
        <div class="col-md-4 col-sm-6 fadeInUp wow">
          <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
            <div class="panel-heading">
              <h3 class="panel-title">أسباب الأذونات</h3>
            </div>
            <div class="panel-body">
              <?php if(isset($permit_reasons) && $permit_reasons != null) { ?>
                <table id="" class="display table table-bordered responsive nowrap" cellspacing="0" width="100%">
                  <thead>
                  <tr class="info">
                    <th>م</th>
                  ...
                  <?php
                  $x = 1;
                  foreach ($permit_reasons as $value)
                  {
                    ?>
                    <tr>
                      <td><?=($x++)?></td>
                      <td><?=$value->title?></td>
                      <td>
                        <a href="<?php echo base_url('Administrative_affairs/edit_sitting').'/8/'.$value->id ?>" title="تعديل"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
                        <span> </span>
                        <a onclick="$('#adele').attr('href', '<?=base_url()."Administrative_affairs/delete_sitting/8/".$value->id?>');" data-toggle="modal" data-target="#modal-delete" title="حذف"> <i class="fa fa-trash" aria-hidden="true"></i> </a>
                      </td>
                    </tr>
                  <?php } ?>
                  </tbody>
      ...
      <div class="col-md-4 col-sm-6 fadeInUp wow">
        <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
          <div class="panel-heading">
            <h3 class="panel-title">نوع المطالبة</h3>
          </div>
          <div class="panel-body">
            <?php if(isset($type_of_claim) && $type_of_claim != null) { ?>
              <table id="" class="display table table-bordered responsive nowrap" cellspacing="0" width="100%">
                <thead>
                <tr class="info">
                  <th>م</th>
                ...
                <?php
                $x = 1;
                foreach ($type_of_claim as $value)
                {
                  ?>
                  <tr>
                    <td><?=($x++)?></td>
                    <td><?=$value->title?></td>
                    <td>
                      <a href="<?php echo base_url('Administrative_affairs/edit_sitting').'/9/'.$value->id ?>" title="تعديل"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
                      <span> </span>
                      <a onclick="$('#adele').attr('href', '<?=base_url()."Administrative_affairs/delete_sitting/9/".$value->id?>');" data-toggle="modal" data-target="#modal-delete" title="حذف"> <i class="fa fa-trash" aria-hidden="true"></i> </a>
                    </td>
                  </tr>
                <?php } ?>
                </tbody>
