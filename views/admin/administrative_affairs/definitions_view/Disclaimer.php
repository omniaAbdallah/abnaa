    ...
    ?>
        ...
        <div class="details-resorce">
          ...
          <div class="col-xs-12 ">
            ...
            <input type="text" name="job_name" value="<?php echo $result[0]->job_name; ?>" class="form-control" data-validation="required"  />
             ...
             <div class="col-md-4  col-sm-12 col-xs-12 inner-side r-data">
                          ...
                          <div class="col-xs-6 r-input">
                            ...
                            <input type="date" class="form-control" name="release_date"  value="<?php echo $result[0]->release_date; ?>" placeholder="شهر / يوم / سنة " data-validation="required" >
            ...
            <div class="col-xs-12">
            <div class="col-xs-6">
            <h4 class="r-h4"> الإفادة بأي متعلقات لدى المذكورة </h4>
            </div>
            ...
            <input type="text" name="finance_manage"  id="finance_manage" value="<?=$result[0]->finance_manage ?>" class="form-control"  data-validation="required" />    
              ...
              <div class="col-xs-12">
            <div class="col-xs-6">
            <h4 class="r-h4">مديرة الجمعية </h4>
            </div>
            <div class="col-xs-6 r-input" >
            ...
            <input type="number" name="job_name" step="any" class="form-control" data-validation="required"  />
             ...
             <div class="col-md-4  col-sm-12 col-xs-12 inner-side r-data">
                          ...
                          <div class="col-xs-6 r-input">
                            ...
                            <input type="date" class="form-control docs-date" name="release_date"  placeholder="شهر / يوم / سنة " data-validation="required" >
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content col-xs-12" style="width:150%">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="col-sm-12" >
                                    <div class="col-sm-6">
                                        <h5>الإفادة بأي متعلقات لدى المذكورة:</h5>
                                    </div>
                                    <div class="col-sm-12">
                                ...
                                <div class="col-sm-12" >
                                    ...
                                    <div class="col-sm-6">
                                      <h5><?=$record_total->release_date;?></h5>
                                    </div>
