    ...
    <div class="col-md-12 fadeInUp wow">
        <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open_multipart('Administrative_affairs/update_main_department/'.$results['id'],array('class'=>"",'role'=>"form" ))?>
                    ...
                    <div class="col-xs-12 r-inner-details">
                        <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                            ...
                            <div class="col-xs-6 r-input">
                                ...
                                data-validation="required"   placeholder="عنوان الإدارة
                ...
                <?php }else{ ?>
                <?php echo form_open_multipart('Administrative_affairs/add_main_department',array('class'=>"",'role'=>"form" ))?>
                <div class="details-resorce">
                    <div class="col-xs-12 r-inner-details">
                        <div class="col-md-6 col-sm-12 col-xs-12 inner-side r-data">
                            <div class="col-sm-6">
                                    ...
                                    foreach ($records as $record ){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php }else{?>
                                                <a href="<?php echo base_url('Administrative_affairs/update_main_department').'/'.$record->id ?>" title="تعديل"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
                                                <span> </span>
                                                <a onclick="$('#adele').attr('href', '<?=base_url()."Administrative_affairs/delete_main_department/".$record->id?>');" data-toggle="modal" data-target="#modal-delete" title="حذف"> <i class="fa fa-trash" aria-hidden="true"></i> </a> 
                                                <? } ?>
                                            </td>
                                        </tr>
                                        <?php
