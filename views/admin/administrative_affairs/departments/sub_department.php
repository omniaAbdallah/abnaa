        ...
        <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
            ...
            <div class="panel-body">
                <?php if(isset($results)):?>
                    <?php echo form_open_multipart('Administrative_affairs/update_sub_department/'.$results['id'],array('class'=>"",'role'=>"form" ))?>
                    <div class="details-resorce">
                        <div class="col-xs-12 r-inner-details">
                            ...
                            <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                                ...
                                <div class="col-xs-6 r-input">
                                    <input type="text" class="r-inner-h4 " data-validation="required" name="name" placeholder="القسم"
                ...
                <?php else: ?>
                    <?php echo form_open_multipart('Administrative_affairs/add_sub_department',array('class'=>"",'role'=>"form" ))?>
                    <div class="details-resorce">
                        <div class="col-xs-12 r-inner-details">
                            <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                                <div class="col-xs-6">
                        ...
                        <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                            ...
                            <div class="col-xs-6 r-input">
                                <input type="text" class="r-inner-h4 " name="name" data-validation="required" placeholder="القسم" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                                        ...
                                        <tr>
                                            ...
                                            <?php if(!empty($record->sub_departments)){foreach($record->sub_departments as  $sub){ ?>
                                                ...
                                                <td data-title="التحكم" class="text-center">
                                                    <a href="<?php echo base_url('Administrative_affairs/update_sub_department').'/'.$sub->id ?>" title="تعديل"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
                                                </td>
                                           </tr>
                                        <?php     }}else{ ?>
                                        <td> لايوجد أقسام </td>
