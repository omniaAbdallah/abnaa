...
<header class="col-xs-12">
    <a target="_blank"  class="btn btn-success" href="<?php echo base_url();?>Administrative_affairs/printEmployeeVacationsReport/<?php echo $employee->id;?>"  style="float:  left;"> طباعة التقرير</a>
