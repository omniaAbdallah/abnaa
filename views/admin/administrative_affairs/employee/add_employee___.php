    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-12 r-inner-details">
             ...
             <div class="col-xs-12">
                            <div class="col-xs-6">
                                <h4 class="r-h4">  موظف متعاون أم لا   </h4>
                            </div>
                            <div class="col-xs-6 r-input">
                                <select name="support_id" id=""    data-validation="required" aria-required="true">
                                    <?php 
                                   $array_type_support=array("اختر ","موظف","متعاون");
                                        foreach ($array_type_support as $key=>$value):
                                            $sect='';
                                            if( $result[0]->support_id ==$key ){
                                                $sect ='selected';
                                            }
                                            ?>
                                            <option value="<? echo $key;?>" <? echo $sect;?>><? echo $value;?></option>
