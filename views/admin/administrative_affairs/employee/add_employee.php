                            ...
                            <div class="col-xs-12 ">
                                ...
                                <div class="col-xs-6 r-input ">
                                            <input type="date" class="form-control form-control "
                                             id="" name="birth_date" value="<? echo date('Y-m-d',$result[0]->birth_date); ?>"  placeholder="شهر / يوم / سنة " data-validation="required" >
                                </div>
                            </div>
                        ...
                        <div class="col-xs-12 ">
                            ...
                            <div class="col-md-12  col-sm-12 col-xs-12 inner-side r-data">
                               ...
                               <div class="col-md-12  col-sm-12 col-xs-12 inner-side r-data">
                                ...
                                <div class="col-xs-12">
                                    <div class="col-xs-6">
                                        <h4 class="r-h4">بدل أخري</h4>
                                    </div>
                                    <div class="col-xs-6 r-input">
                                        <input type="number" name="b_other" class="r-inner-h4"  placeholder="بدل اخري" 
                                        data-validation="required"  value="<?php echo $result[0]->b_other;?>">
                                    </div>
                                </div>
                            </div> 
...
<!------------------------------------------------------------------------------------>
                                    ...
                                    <div class="col-xs-12 ">
                                        ...
                                        <div class="col-xs-6 r-input ">
                                         ...
                                         <input type="date" class="form-control " id=""
                                          name="birth_date" placeholder="شهر / يوم / سنة " data-validation="required" >
                            ...
                            <div class="col-xs-12 ">
                                ...
                                <div class="col-md-12  col-sm-12 col-xs-12 inner-side r-data">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-6 r-input">
                                            <input type="number" name="b_other" class="r-inner-h4"  placeholder="بدل أخري " 
                                        ...
                                        <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                            ...
                                            <tbody class="text-center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button data-toggle="modal" data-target="#modal-free<?=$record->id?>" class="btn btn-sm btn-info"><i class="fa fa-list btn-info"></i>  رصيد سابق للموظف </button>
                                                    </td>
                                                    ...
                                                    <span> </span>
                                                    <a onclick="$('#adele').attr('href', '<?=base_url()."Administrative_affairs/delete_employee/".$record->id?>');" data-toggle="modal" data-target="#modal-delete" title="حذف"> <i class="fa fa-trash" aria-hidden="true"></i> </a> 
                                                    </td>
                                                </tr>
                                                <?php
                                                $a++;
    ...
    <div class="modal" id="modal-info<?=$record->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-wow-duration="0.5s">
     ...
     <!-----    osama      ------->
                                <!-----    free_model      ------->
                                        <div class="modal" id="modal-free<?=$record->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-wow-duration="0.5s">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                        <h4 class="modal-title" id="myModalLabel">اٍعدادات أرصدة الاجازات</h4>
                                                    </div>
                                                    <form action="<?= base_url()?>Administrative_affairs/add_past_vacation" method="post">
                                                    <div class="modal-body">
                                                        <div class="panel-body">
                                                        ...
                                                        <?php $x=0; foreach ($free_days as $free){   ?>
                                                            <input type="hidden" name="data[<?= $x ?>][emp_id]" value="<?=$record->id?>">
                                                            <input type="hidden" name="data[<?= $x ?>][vacation_type]" value="<?= $free->id?>">

                                                            <tr><td colspan="3">
                                                            <div class="form-group col-sm-8 col-xs-12">
                                                                <label class="label label-green half"><?= $free->title ?></label>
                                                                <input type="text" name="data[<?= $x ?>][current_num]" value="<?php echo (isset($free_days_data[$record->id]->emp_data[$free->id]->current_num))? $free_days_data[$record->id]->emp_data[$free->id]->current_num : ''; ?>" class="form-control half input-style" autofocus="" onkeypress="validate_number(event)" data-validation="required">


                                                            </div>
                                                            <div class="form-group col-sm-4 col-xs-12">
                                                                <input type="text" name="data[<?= $x ?>][past_num]" value="<?php echo (isset($free_days_data[$record->id]->emp_data[$free->id]->past_num))? $free_days_data[$record->id]->emp_data[$free->id]->past_num : ''; ?>" class="form-control  " onkeypress="validate_number(event)" autofocus="" data-validation="required">
                                                            </div>
                                                                </td></tr>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit" value="free_days" name="free_days" class="btn btn-success">حفظ</button>
                ...
                <script>
                    ...
                    document.getElementById("salary").onkeyup = function () {
                        ...
                        for (i = 1; i <= 5; i++) {
                            ...
                            var after_count =(this.value * percent /100);
                            if( after_count   < mininum){
                                document.getElementById(i).value =   mininum ;
                            }else {
                                document.getElementById(i).value =   after_count ;
                            }
                        }
                        var bdl_sakn = document.getElementById(1).value;
                        var tamen =((parseInt(this.value) + parseInt(bdl_sakn))* 10 /100 ) ;
                        document.getElementById("k_tamen").value = tamen;
                    };
                    ...
                    function getTamen(){
                        ...
                        var bdl_sakn = document.getElementById(1).value;
                        var tamen =((parseInt(salary) + parseInt(bdl_sakn))* 10 /100 ) ;
