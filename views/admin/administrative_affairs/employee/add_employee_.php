                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-6 r-input">
                                    <input type="number" id="insurance_num" name="insurance_num" class="form-control text-left" value="<?=$result[0]->insurance_num?>" placeholder="رقم التأمين" data-validation="required"   /> 
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-6 r-input">
                                    <input type="number" class="r-inner-h4" name="phone_num" value="<?echo $result[0]->phone_num;?>" placeholder="رقم الهاتف" data-validation="required"  >
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-6 r-input">
                                    <input type="number" class="r-inner-h4" placeholder="رقم الجوال" data-validation="required"  name="mobile" value="<?echo $result[0]->mobile;?>" >
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-6 r-input">
                                <!--    <input type="text" name="degree_id" value="<?php echo $result[0]->degree_id ?>" placeholder="الدرجة الوظيفية" data-validation="required"  />
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-12">
                                            ...
                                            <div class="col-xs-6 r-input">
                                                <input type="number" step="any" id="salary" name="salary" class=r-inner-h4"  value="<?php echo $result[0]->salary;?>"  />
                                            </div>
                                        </div>                       
                        </div>
                        ...
                        <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-6 r-input">
                                    <input type="number" class="r-inner-h4" name="id_num" value="<?echo $result[0]->id_num;?>" data-validation="required"  placeholder="رقم الهوية" >
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-6 r-input">
                                    <input type="text" class="r-inner-h4" placeholder="رقم الحساب" name="bank_account" value="<?echo $result[0]->bank_account;?>">
                                </div>
                            </div>
                      ...
                      <!--  <div class="col-xs-6 r-inner-details">
                            ...
                            <div class="col-xs-12 ">
                                <div class="col-md-12  col-sm-12 col-xs-12 inner-side r-data">
                                   <?php foreach($allowances as $one_allowances){?>
                                    <div class="col-xs-12">
                                        <div class="col-xs-6">
                                            <h4 class="r-h4"><?=$one_allowances["defined_title"]?></h4>
                                        </div>
                                        <div class="col-xs-6 r-input">
                                            <input type="number" name="allowances[<?=$one_allowances["defined_id"]?>]" class="r-inner-h4" value="<?=$one_allowances["value"]?>"   data-validation="required" >
                                        </div>
                                    </div>
                                    <?php }?>
                        ...
                        <div class="col-xs-12 ">
                            <div class="col-md-12  col-sm-12 col-xs-12 inner-side r-data">
                                ...
                                <div class="col-xs-12">
                                    <div class="col-xs-6">
                                        <h4 class="r-h4">بدل سكن</h4>
                                    </div>
                                    <div class="col-xs-6 r-input">
                                        <input type="number" name="b_sakn" class="r-inner-h4"  placeholder="بدل سكن" data-validation="required"  value="<?php echo $result[0]->b_sakn;?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12  col-sm-12 col-xs-12 inner-side r-data">
                                ...
                                <div class="col-xs-12">
                                    <div class="col-xs-6">
                                        <h4 class="r-h4">بدل مواصلات</h4>
                                    </div>
                                    <div class="col-xs-6 r-input">
                                        <input type="number" name="b_mosalat" class="r-inner-h4"  placeholder="بدل مواصلات" data-validation="required"   value="<?php echo $result[0]->b_mosalat;?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12  col-sm-12 col-xs-12 inner-side r-data">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-6 r-input">
                                        <input type="number" name="b_amal" class="r-inner-h4"  placeholder="بدل طبيعة عمل" data-validation="required"  value="<?php echo $result[0]->b_amal;?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12  col-sm-12 col-xs-12 inner-side r-data">
                                ...
                                <div class="col-xs-12">
                                    <div class="col-xs-6">
                                        <h4 class="r-h4">بدل غلاء معيشة</h4>
                                    </div>
                                    <div class="col-xs-6 r-input">
                                        <input type="number" name="b_maesha" class="r-inner-h4"  placeholder="بدل غلاء معيشة" data-validation="required"  value="<?php echo $result[0]->b_maesha;?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 ">
                                <div class="col-md-12  col-sm-12 col-xs-12 inner-side r-data">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-6 r-input">
                                            <input type="number" name="k_tamen"  id="k_tamen" class="r-inner-h4"  placeholder="تأمينات" data-validation="required"  value="<?php echo $result[0]->k_tamen;?>">
                                        </div>
                                    </div>
                       ...
                       <!-- <div class="col-xs-6 r-inner-details">
                            ...
                            <div class="col-xs-12 ">
                                <div class="col-md-12  col-sm-12 col-xs-12 inner-side r-data">
                                     ...
                                     <?php foreach($deduction as $one_deduction){?>
                                    <div class="col-xs-12">
                                        <div class="col-xs-6">
                                            <h4 class="r-h4"><?=$one_deduction["defined_title"]?></h4>
                                            
                                        </div>
                                        <div class="col-xs-6 r-input">
                                            <input type="number" name="deduction[<?=$one_deduction["defined_id"]?>]" class="r-inner-h4" value="<?=$one_deduction["value"]?>"  data-validation="required" >
                                        </div>
                                    </div>
                                    <?php }?>
...
<!------------------------------------------------------------------------------------>
                            ...
                            <div class="col-xs-6 r-input">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-6 r-input">
                                            <input type="number" id="insurance_num" name="insurance_num" class="form-control text-left" placeholder="رقم التأمين" data-validation="required"  /> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-6 r-input">
                                            <input type="number" class="r-inner-h4" placeholder="رقم الهاتف" name="phone_num" data-validation="required" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-6 r-input">
                                            <input type="number" class="r-inner-h4" placeholder="رقم الجوال" name="mobile" data-validation="required" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-6 r-input">
                                        <!--    <input type="text" name="degree_id" placeholder="الدرجة الوظيفية" data-validation="required" /> -->
                                        <select name="degree_id" class="form-control" data-validation="required"  aria-required="true" >
                                           <?php foreach($job_role as $one_job_role){
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-6 r-input">
                                            ...
                                            <div class="col-xs-12">
                                                        ...
                                                        <div class="col-xs-6 r-input">
                                                                <input type="number" step="any" id="salary" name="salary" class=r-inner-h4"  data-validation="required"  />
                                                        </div>
                                                </div>                        
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12 inner-side r-data">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-6 r-input">
                                            <input type="number" class="r-inner-h4" name="id_num" placeholder="رقم الهوية" data-validation="required" >
                                        </div>
                                    </div>
    ...
    <div class="col-xs-12">
        ...
        <div class="col-xs-6 r-input">
            <input type="text" class="r-inner-h4" placeholder="رقم الحساب" name="bank_account">
        </div>
    </div>
                            ...
                            <div class="col-xs-12 ">
                                <div class="col-md-12  col-sm-12 col-xs-12 inner-side r-data">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-6 r-input">
                                            <input type="number" name="b_sakn" class="r-inner-h4"  placeholder="بدل سكن" data-validation="required" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12  col-sm-12 col-xs-12 inner-side r-data">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-6 r-input">
                                            <input type="number" name="b_mosalat" class="r-inner-h4"  placeholder="بدل مواصلات" data-validation="required" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12  col-sm-12 col-xs-12 inner-side r-data">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-6 r-input">
                                            <input type="number" name="b_amal" class="r-inner-h4"  placeholder="بدل طبيعة عمل" data-validation="required" >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12  col-sm-12 col-xs-12 inner-side r-data">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-6 r-input">
                                            <input type="number" name="b_maesha" class="r-inner-h4"  placeholder="بدل غلاء معيشة" data-validation="required" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12  col-sm-12 col-xs-12 inner-side r-data">
                                   <?php foreach($allowances as $one_allowances){?>
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-6 r-input">
                                            <input type="number" name="allowances[<?=$one_allowances->defined_id?>]" class="r-inner-h4"  placeholder="<?=$one_allowances->defined_title?>" data-validation="required" >
                                        </div>
                                    </div>
                                    <?php }?>
                            ...
                            <div class="col-xs-12 ">
                                <div class="col-md-12  col-sm-12 col-xs-12 inner-side r-data">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-6 r-input">
                                            <input type="number" name="deduction[<?=$one_deduction->defined_id?>]" class="r-inner-h4"  placeholder="<?=$one_deduction->defined_title?>" data-validation="required" >
                                        </div>
                                    </div>
                                    <?php }?>
                            ...
                            <div class="col-xs-12 ">
                                <div class="col-md-12  col-sm-12 col-xs-12 inner-side r-data">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-6 r-input">
                                            <input type="number" name="k_tamen"  id="k_tamen" class="r-inner-h4"  placeholder="تأمينات" data-validation="required" >
                                        </div>
                                    </div>
                                </div>
                            </div> 
...
<div class="modal" id="modal-delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-wow-duration="0.5s">
    ...
    document.getElementById("salary").onkeyup = function () {
        document.getElementById("k_tamen").value =(this.value * 10 /100);
    };
