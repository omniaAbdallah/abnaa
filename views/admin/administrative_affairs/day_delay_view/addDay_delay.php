        ...
        <div class="panel-body">
            ...
            <div id="optionearea2">
                ...
                <?php if (isset($emp_data) && $emp_data != null && !empty($emp_data)) {?>
                    ...
                    <button type="button" id="add_row_delay" onclick="check();"  class="add btn btn-info  w-md m-b-5">
                      <i class="fa fa-plus"></i> إضافة تأخير  </button>
                    <button type="button" name="add" value="add"  id="button"   class="save btn btn-success w-md m-b-5 " >
