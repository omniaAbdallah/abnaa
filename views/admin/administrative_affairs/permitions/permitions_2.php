                    ...
                    <div class="col-xs-12 r-inner-details">
                    	<div class="col-md-12 col-sm-12 col-xs-12 inner-side r-data no-padding">
                    		<div class="col-md-6 padd">
	                            ...
	                            <div class="col-xs-6 r-input">
									...
									if(isset($permit)) {echo ($permit['id']);} 
										...
										if(isset($permits) && $permits != null) {echo ($permits[0]->id+1);}
										else {echo 1;}
									} ?>" readonly>
								</div>
							</div>
	                            ...
	                            <div class="col-xs-6 r-input">
	                            	<div class="docs-datepicker">
	                                    <div class="input-group">
	                            			<input type="text" id="permit_date" name="permit_date" placeholder="تاريخ الإذن" value="<?php if(isset($permit)) {echo date("d-m-Y",$permit['permit_date']);} else {echo date("d-m-Y");} ?>" class="form-control date_melady" data-validation="required" >
	                            		</div>
	                            	</div>
								</div>
							</div>
							...
							<div class="col-md-6 padd">
	                            ...
	                            <div class="col-xs-6 r-input">
	                            	<select class="form-control selectpicker" data-live-search="true" name="emp_code" onchange="return loadData($(this).val())" data-validation="required" aria-required="true">
							...
							<div class="col-md-6 padd">
	                            ...
	                            <div class="col-xs-6 r-input">
	                            	<select class="form-control" name="permit_type" data-validation="required" aria-required="true">
										<option value="">إختر نوع الإذن</option>
										<?php
										foreach ($permit_type as $key => $value) {
											$select = '';
											if(isset($permit) && $permit['permit_type'] == $key) {
												$select = 'selected';
											}
										?>
							...
							<div class="col-md-6 padd">
	                            ...
	                            <div class="col-xs-6 r-input">
	                            	<div class="docs-datepicker">
	                                    <div class="input-group">
	                                    	<input type="text" id="time_out" name="time_out" placeholder="وقت الخروج" value="<?php if(isset($permit)) echo $permit['time_out'] ?>" class="form-control time" data-validation="required" >
	                            		</div>
	                            	</div>
								</div>
							</div>
							...
							<div class="col-md-6 padd">
	                            ...
	                            <div class="col-xs-6 r-input">
	                            	<div class="docs-datepicker">
	                                    <div class="input-group">
	                                    	<input type="text" id="time_return" name="time_return" placeholder="وقت الرجوع" value="<?php if(isset($permit)) echo $permit['time_return'] ?>" class="form-control time" data-validation="required" >
	                            		</div>
	                            	</div>
								</div>
							</div>
							...
							<div class="col-md-6 padd">
	                            ...
	                            <div class="col-xs-6 r-input">
	                                <textarea class="r-textarea" name="permit_reason" data-validation="required"><?php if(isset($permit)) echo $permit['permit_reason'] ?></textarea>
								</div>
							</div>
						</div>
						<div class="col-md-12">
							...
							?>
							<div class="alert alert-danger">لا يمكنك إضافة إذن حيث أنك وصلت للعدد المسموح به</div>
							<?php
								}
							} 
							?>
