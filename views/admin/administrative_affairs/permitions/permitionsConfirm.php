		            		...
		            		<div class="tab-pane fade in active" id="tab0default">
		            			...
		            			<table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
									...
									<tbody>
										...
										<!--	<td><?php if(!empty($permit_type[$permit->permit_type]))
                                                 { echo $permit_type[$permit->permit_type];}?>
                                                 </td> -->
		            		...
		            		<div class="tab-pane fade" id="tab1default">
		            			...
		            			<table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
									...
									<tbody>
                                        ...
                                        <!--	<td><?php if(!empty($permit_type[$permit->permit_type])){ echo $permit_type[$permit->permit_type];}?></td>
										-->
                                        	<td><?=date("Y-m-d",$permit->permit_date)?></td>
											<td><?=$permit->time_out?></td>
											<td><?=$permit->time_return?></td>
