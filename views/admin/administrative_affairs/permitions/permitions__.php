   ...
   <div class="col-xs-6 r-input">
      <div class="docs-datepicker">
         <div class="input-group">
            <input type="text" id="permit_date" name="permit_date" placeholder="تاريخ اليوم" value="<?php if(isset($permit)) {echo date("d-m-Y",$permit['day_date']);}?>" class="form-control date_melady" data-validation="required" >
         </div>
      </div>
   </div>
</div>
                            ...
                            <div class="col-md-6 padd">
                                ...
                                <div class="col-xs-6 r-input">
                                    <input type="text" id="ozon_time"   value="<?php echo$ozon->ozon_num_day;?>" class="r-inner-h4" readonly>
                                </div>
						...
						<div class="col-md-12">
							...
							<?php 
								...
								if($employeeData['total'] >= $ozon->ozon_num_month){
							?>
							<button type="submit" name="add" value="حفظ" class="btn btn-purple w-md m-b-5"><span><i class="fa fa-floppy-o" ></i></span> حفظ</button>
							<?php
								}
...
<script>
    ...
    function loadData2() {
        ...
        if (out_time) {
            var dataString = 'start_date=' + out_time;
            $.ajax({
                type:'post',
