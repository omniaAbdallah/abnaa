                    ...
                    <div class="col-xs-12 r-inner-details">
								...
								<div class="col-xs-6 r-input">
									<div class="docs-datepicker">
										<div class="input-groupP">
											<input type="date" id="day_date" name="day_date" placeholder="تاريخ اليوم"
                                             value="<?php echo date('Y-m-d');?>" class="form-control " readonly>
										</div>
									</div>
								</div>
							</div>
	                            	...
	                            	<div class="docs-datepicker">
	                                    <div class="input-groupp">
	                            			<input type="date" id="permit_date" name="permit_date"
                                             placeholder="تاريخ الإذن" 
                                             value="<?php if(isset($permit)) {echo date("Y-m-d",$permit['permit_date']);} ?>" 
						...
						<div class="col-md-12 col-sm-12 col-xs-12 inner-side r-data no-padding">
							...
							<div class="col-md-4 padd">
                                ...
                                <div class="col-xs-6 r-input">
                                    <input type="time" id="time_out" name="time_out" placeholder="وقت الخروج" value="<?php if(isset($permit)) echo $permit['time_out'] ?>" class="form-control without_ampm" data-validation="required" onchange="loadData2();"  >
                                </div>
							</div>
                            <div class="col-md-4 padd">
                                <div class="col-xs-6">
                                ...
                                <div class="col-xs-6 r-input">
									...
									if(isset($permit)&&!empty($permit)) {echo ($permit['ozon_time']);
									}else{
							...
							<div class="col-md-4 padd">
	                            ...
	                            <div class="col-xs-6 r-input">
                                        <input type="text" id="time_return" name="time_return" placeholder="وقت الرجوع"  value="<?php if(isset($permit)) echo $permit['time_return'] ?>"class="form-control time without_ampm" readonly >
								</div>
							</div>
							</div>
