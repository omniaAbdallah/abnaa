        ...
        <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
            ...
            <div class="panel-body">
                ...
                if ((isset($sherak_data)) && (!empty($sherak_data))) {
                    echo form_open_multipart(base_url() . 'shoraka/Shoraka/update_Shoraka/' . base64_encode($id));
                    ...
                    echo form_open_multipart(base_url() . 'shoraka/Shoraka/insert_shoraka');
                    $name = '';
                    $address = '';
                    $link = '';
                    $status = '';
                ...
                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                    ...
                    <input type="file" name="logo" class="form-control"
                           onchange=" load_image(this)" data-validation="required">
                </div>
                ...
                <div class="form-group col-md-4 col-sm-4 col-xs-12">
                    <label>الحالة</label>
                    <select name="status_name" class="form-control" <?php if ((isset($logo)) && (!empty($logo))) {
                    ...
                    <!--   <div class="col-xs-12">
                           <div class="col-xs-8">
                               <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                   ...
                                   <label id="name_shoraka"> </label>
                               </div>
                               <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                   <label>العنوان </label>
                                   <br>
                                   <label id="address_shoraka"> </label>
                               </div>
                               <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                   <label>الحالة </label>
                                   <br>
                                   <label id="status_shoraka"> </label>
                               </div>
                               <div class="form-group col-md-8 col-sm-8 col-xs-12">
                                   <label>اللينك </label><br>
                                   <label id="link_shoraka"> </label></div>
                           </div>
                           <div class="col-xs-4">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a onclick="alert('هل انت متأكد من حذف ؟!!')"
                                       href="<?php echo base_url() . 'shoraka/Shoraka/delete_shoraka/' . base64_encode($sharek->id) ?>">
                                        <i class="fa fa-trash"></i></a>
                                    <a href="<?php echo base_url() . 'shoraka/Shoraka/update_Shoraka/' . base64_encode($sharek->id) ?>">
...
<script>
    function load_image(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                ...
                // $('#image_shoraka').attr('src', e.target.result)
            };
    ...
    function set_data_intopop(id) {
        ...
        console.log(' id : ' + id);
        var request = $.ajax({
            url: "<?php echo base_url() . '/shoraka/Shoraka/select_data'?>",
            type: "POST",
            data: {id: id},
        });
