<div class="col-sm-12">
   ...
   <?php   echo form_open_multipart("FamilyCashing/SarfAttachments/".$sarf_num_fk_attach);?>
               ...
               <tr>
                   ...
                   <td>
                       ...
                       if (in_array($ext,$image)){
                           ?>
                           <img src="<?=base_url()."uploads/files/sarf_attaches/".$row->attachment?>" class="" width="100" height="100">
                           <?php
                       } else if (in_array($ext,$file)){
                           ?>
                           <a target="_blank" href="<?=base_url()."FamilyCashing/read_file/".$row->attachment?>">
    ...
    <button type="submit" name="Add_Attach" value="Add_Attach" id="Add_Attach" disabled="disabled"  class="btn btn-success" > حفظ </button>
    <?php  echo form_close()?>
</div>
<script>
    function dis() {
