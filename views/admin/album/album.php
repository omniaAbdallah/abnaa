...
?>
    ...
    <?php if(isset($result)):?>
        ...
        <?php echo form_open_multipart('dashboard/update_album/'.$result['id'])?>
    ...
    <?php else: ?>
        ...
        <?php echo form_open_multipart('dashboard/add_album')?>
    ...
    <a class="right carousel-control" href="#myCarouse<?php echo $record->id?>" role="button" data-slide="next">
      ...
      <span class="sr-only">Next</span>
                ...
                <td data-title="التحكم" class="text-center">
                    ...
                    <a href="<?php echo base_url().'dashboard/update_album/'.$record->id?>">
                        <i class="fa fa-pencil " aria-hidden="true"></i></a>
                    <a href="<?php echo base_url().'dashboard/delete_album/'.$record->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
