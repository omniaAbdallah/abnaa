            ...
            <div class="col-sm-8 padding-4">
                ...
                <div class="col-md-12 no-padding">
                    ...
                    <div class=" col_md_45 col-sm-6 padding-4">
                        ...
                        <div class="col-md-8 col-sm-6  no-padding">
                            <select id="esal_type" name="esal_type" class="form-control input_style_2 inputclass"
...
" data-validation="required" aria-required="true">
                ...
                <div class="col-md-12 no-padding ">
                    ...
                    <div class="col_md_10   no-padding" id="first_value">
                ...
                <div class="col-md-12 no-padding" id="ValuesDiv">
                    ...
                    <?php if (!empty($result->fe2a_type2) && !empty($result->bnd_type2)) { ?>
                        ...
                        <div class="col_md_10   no-padding"><input style="font-weight: 600 !important;"
            ...
            <div class="col-sm-4 no-padding">
                ...
                <div>
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#shakl-esal" aria-controls="shakl-esal"
                                                                  role="tab" data-toggle="tab">إيصال إستلام</a></li>
                        <li role="presentation"><a href="#nums-esalat" aria-controls="nums-esalat" role="tab"
                                                   data-toggle="tab">إحصائيات</a></li>
                    </ul>
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane fade in active" id="shakl-esal">
                            ...
                            <div class="bond-body">
                                ...
                                <div class="col-xs-12 no-padding">
                                    ...
                                    <?php if (!empty($result->esal_type_title)) {
                                        echo $result->esal_type_title;
                                    } ?>
                                </span></h6>
                                    </div>
                                ...
                                <div class="col-xs-12 no-padding">
                                    ...
                                    <div class="col-xs-4">
                                        <h6> الرقم :<span id="esal_num_span"> <?php if (!empty($last_id)) {
                                                    $last_id;
                                                } else {
                                                    if (!empty($result)) {
                                                        $result->esal_num;
                        ...
                        <?php if (!empty($result)) {
                            ...
                            <?php if (!empty($result->bank_account_title)) {
                                echo $result->bank_account_title;
                                    ...
                                    <div class="col-xs-4 no-padding">
                                        <h6> رقم الحساب البنكي :<span class="mostadem_num_span"
                            ...
                            <?php if (!empty($result->bank_account_num_title)) {
                                ...
                                <div class="col-xs-12 no-padding">
                                    ...
                                    <table class="table table-bordered table_style"
                                        ...
                                        <tr>
                                            <th style="width:50%;"
                                                id="band_tbro3_td"><?php if (!empty($result->band_title)) {
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="nums-esalat">
                            <div class="col-md-4 col-sm-6">
                                <div class="circle-ico">
                                    ...
                                    <div class="text-center" style="margin-top: -10px;">
                                        <div style="font-size: 20px;" class=" counter"
                                             data-count="<?php echo round($all_money_today['total_nakdy'], 2); ?>">0
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="circle-ico">
                                    ...
                                    <div class="circlechart" data-percentage="35">
                                        <p>شبكة</p>
                                    </div>
                                    <div class="text-center" style="margin-top: -10px;">
                                        <div class=" counter"
                                             data-count="<?php echo round($all_money_today['total_chabka'], 2); ?>">0
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="circle-ico">
                                    <i class="fa fa-money"></i>
                                    <div class="circlechart" data-percentage="10">
                                        <p>شيك</p>
                                    </div>
                                    <div class="text-center" style="margin-top: -10px;">
                                        <div class=" counter"
                                             data-count="<?php echo round($all_money_today['total_cheq'], 2); ?>">0
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="circle-ico">
                                    ...
                                    <div class="text-center" style="margin-top: -10px;">
                                        <div class=" counter"
                                             data-count="<?php echo round($all_money_today['total_eda3_nakdy'], 2); ?>">
                                            0
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="circle-ico">
                                    ...
                                    <div class="text-center" style="margin-top: -10px;">
                                        <div class=" counter"
                                             data-count="<?php echo round($all_money_today['total_eda3_cheq'], 2); ?>">0
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="circle-ico">
                                    ...
                                    <div class="text-center" style="margin-top: -10px;">
                                        <div class=" counter"
                                             data-count="<?php echo round($all_money_today['total_tahwel'], 2); ?>">0
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="circle-ico">
                                    ...
                                    <div class="text-center" style="margin-top: -10px;">
                                        <div class=" counter"
                                             data-count="<?php echo round($all_money_today['total_amr_mostdem'], 2); ?>">
                                            0
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-xs-12 no-padding" id="counter_section">
                    ...
                    <div class="col-md-9 col-xs-12">
                        ...
                        <div id="circle_counter" style="background: green;">
                            <div class=" counter" data-count="<?php echo round($all_money_today['total_nakdy'], 2); ?>">
                                0
                            </div>
                            <span>نقدي</span>&nbsp;&nbsp;
                        ...
                        <div id="circle_counter" style="background: #b31616;">
                            <div class=" counter"
                                 data-count="<?php echo round($all_money_today['total_chabka'], 2); ?>">0
                            </div>
                            <span>شبكة</span> &nbsp;&nbsp;
                        ...
                        <div id="circle_counter" style="background: #b77b09;">
                            <div class=" counter" data-count="<?php echo round($all_money_today['total_cheq'], 2); ?>">
                                0
                            </div>
                            <span>شيك</span>&nbsp;&nbsp;
                        ...
                        <div id="circle_counter" style="background: #41b711;">
                            <div class=" counter"
                                 data-count="<?php echo round($all_money_today['total_eda3_nakdy'], 2); ?>">0
                            </div>
                            <span>إيداع نقدي</span>&nbsp;&nbsp;


                        </div>
                        <div id="circle_counter" style="background: #79790d;">
                            <div class=" counter"
                                 data-count="<?php echo round($all_money_today['total_eda3_cheq'], 2); ?>">0
                            </div>
                            <span>إيداع شيك</span>&nbsp;&nbsp;
                        ...
                        <div id="circle_counter" style="background: #209a79;">
                            <div class=" counter"
                                 data-count="<?php echo round($all_money_today['total_tahwel'], 2); ?>">0
                            </div>
                            <span>تحويل</span>&nbsp;&nbsp;
                        ...
                        <div id="circle_counter" style="background: #6d2147;">
                            <div class=" counter"
                                 data-count="<?php echo round($all_money_today['total_amr_mostdem'], 2); ?>">0
                            </div>
                            <span>أمر مستديم</span>&nbsp;&nbsp;
    ...
    <script>
        ...
        function GetValues() {
            ...
            if ($('#myId').attr('data-click-state') == 1) {
                ...
                $("#ValuesDiv").append('<div class="col_md_45 col-sm-6 padding-4"> <div class="col-md-2 col-sm-6  no-padding "><h6 class="label_title_2 ">الفئة </h6></div><div class="col-md-10 col-sm-6  no-padding"><select  data-validation="required" onchange="GetBandType2(this.value)" class="form-control  input_style_2" id="fe2a_type2" name="fe2a_type2"  aria-required="true"><option value="">إختر  </option></select></div></div>');
                $("#ValuesDiv").append('<div class="col_md_45 col-sm-6 padding-4"> <div class="col-md-2 col-sm-6  no-padding "><h6 class="label_title_2 ">البند </h6></div><div class="col-md-10 col-sm-6  no-padding"><select  data-validation="required" class="form-control  input_style_2"  ' +
                ...
                $("#ValuesDiv").append('<div  class="col_md_10   no-padding" ><input style="font-weight: 600 !important;" data-validation="required" type="text" step="any" name="value2" class="form-control  input_style_2 value band2_value"  onkeyup="CheckValue(`band1_value`,$(this).val());  $(\'#value2\').html($(this).val());" ></div>');
            ...
            if (window.location.hash != '') {
                ...
                if (text != '') {
                    ...
                    $('#RedirectDiv').html('<div class="modal-header"><div class="icon-box"> <i class="material-icons">&#xE876;</i></div> <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button></div>' +
                        ...
                        '<a href="<?php echo base_url(); ?>st/esalat/Esalat_estlam/addesal"><button  type="button" class="btn btn-danger"><span>لا</span> <i class=""></i></button></a></div>');
                    $('#myRedirectModal').modal('show');
                }
            }
        });
