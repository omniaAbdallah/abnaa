            ...
            <div class="col-sm-9 no-padding ">
                ...
                <div class="form-group col-md-3 col-sm-6 padding-4">
                    ...
                    <select type="text" name="tasnef" id="tasnef" value=""
                            ...
                            data-validation="required"
                            data-validation-has-keyup-event="true">
                        <?php if (isset($tasnefat)) {
                            if (!empty($tasnefat)) {
                                echo '<option value="">--اختر--</option>
';
                                foreach ($tasnefat as $item) { ?>
                                    <option value="<?= $item->id ?>" <?php if (isset($get_sanf) && !empty($get_sanf)) {
                                        if ($get_sanf->tasnef == $item->id) {
                                            echo "selected";
                                        }
                ...
                <div class="col-xs-12 text-center">
                    ...
                    <!--                    <button type="-->
                    <? //= $submitEdit ?><!--" class="btn btn-labeled btn-warning"-->
