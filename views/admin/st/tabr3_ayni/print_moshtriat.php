...
<div class="bond-header">
    ...
    <div class="col-xs-4 pad-2">
        <div class="main-bond-title">
            <h3 class="text-center"><span class="">  كارتة   المشتريات العينية </span></h3>
        </div>
    </div>
    <div class="col-xs-4 pad-2">
        <div class="left-img">
        ...
        <div class="piece-box no-border">
            ...
            <div class="col-xs-12 no-padding under-line">
                <table class="table " style="table-layout: fixed">
                    <tbody>
                    <tr>
                        <td style="width: 230px;"><input type="hidden" id="moshtriat_id" value="<?=$get_all->id ?>">
                    ...
                    <tr>
                        ...
                        <td style="width: 10px;"><strong>:</strong></td>
                        <td><?=$get_all->pay_method ?></td>
                    </tr>
                    <tr>
                        <td style="width: 230px;">
                            <strong>   جهة التوريد </strong>
                        </td>
                        <td style="width: 10px;"><strong>:</strong></td>
                        <td><?=$get_all->supplier_name ?></td>
                    </tr>
                    <tr>
                        <td style="width: 230px;">
                        ...
                        <td style="width: 10px;"><strong>:</strong></td>
                        <td><?php
                            if (!empty($get_all->supplier_jwal)) {
                                echo  $get_all->supplier_jwal;
                            }  else{
                                echo "لا يوجد";
                            }
                            ?></td>
