...
<div class="bond-header">
    ...
    <div class="col-xs-4 pad-2">
        <div class="main-bond-title">
            <h3 class="text-center"><span class="">تفاصيل التبرع العيني</span></h3>
        </div>
    </div>
    <div class="col-xs-4 pad-2">
        <div class="left-img">
            <br>
            <p>تفاصيل التبرع العيني</p>
            <p>طبع فى <?= date("d/m/Y g:i ") . $time[date('a')]; ?></p>
        </div>
    </div>
</div>
            ...
            <div class="piece-body">
                <div class="col-xs-12">
                    <table class="table table-bordered" style="table-layout: fixed">
                        <tbody>
                        <tr>
                            <td class="open_green" style="width: 20%;">رقم الإذن </td>
                            <td><?= $one_data['tabr3']->ezn_rkm ?></td>
                            <!--                            -->
                            <td class="open_green" style="width: 20%;">تاريخ الإذن</td>
                            <td><?= $one_data['tabr3']->ezn_date_ar ?></td>
                        </tr>
                        <tr>
                            <td class="open_green" style="width: 20%;">المبلغ</td>
                            <td><?= $one_data['tabr3']->all_value ?></td>
                            <td class="open_green" style="width: 20%;">المستودع</td>
                            <td><?= $one_data['tabr3']->storage_name ?></td>
                        </tr>

                        <tr>
                            <td class="open_green" style="width: 20%;">اسم الحساب</td>
                            <td><?= $one_data['tabr3']->hesab_name ?></td>
                            <td class="open_green" style="width: 20%;">كود الحساب</td>
                            <td><?= $one_data['tabr3']->rkm_hesab ?></td>
                        </tr>
                        <tr>
                            <td class="open_green" style="width: 20%;">اسم المتبرع</td>
                            <td><?= $one_data['tabr3']->motbr3_name ?></td>
                            <td class="open_green" style="width: 20%;">رقم جوال</td>
                            <td><?= $one_data['tabr3']->motbr3_jwal ?></td>
                        </tr>
                        <tr>
                            <td class="open_green" style="width: 20%;">تاريخ اخر المتبرع</td>
                            <td><?= $one_data['tabr3']->last_tabro3_date_ar ?></td>
                            <td class="open_green" style="width: 20%;">نوع التبرع</td>
                            <td><?= $one_data['no3_tabro3_title'] ?></td>
                        </tr>
                        <tr>
                            <td class="open_green" style="width: 20%;">الفئة</td>
                            <td><?= $one_data['fe2a_title']?></td>
                            <td class="open_green " style="width: 20%;">البند</td>
                            <td ><?= $one_data['band_title'] ?></td>
                        </tr>
                        <tr>
                            <td class="open_green" style="width: 20%;">رقم السند</td>
                            <td colspan="3"><?= $one_data['tabr3']->mostand_rkm ?></td>

                        </tr>
                        <tr>
                            <td class="open_green" style="width: 20%;">اسم الجهة </td>
                        ...
                        <tr>
                            <td class="open_green" style="width: 20%;">تاريخ المستند  </td>
