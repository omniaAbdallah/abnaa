            ...
            <div class="col-md-12">
                <div class="form-group col-md-3 col-sm-6 padding-4">
                    <input type="radio"
                           ...
                           onchange="get_form($(this).val());" value="1" name="type_ezn"> تبرعات عينيه
                    <input type="radio"
                           data-validation="required" <?php if ($type_ezn == 2) echo 'checked'; ?>  <?php if ($type_ezn == 1) echo 'disabled'; ?>
                           onchange="get_form($(this).val());" value="2" name="type_ezn"> مشتريات عينيه
                    ...
                    foreach ($all_data as $datum) { ?>
                        ...
                        <button type="button"
                         ...
                         onclick=' swal({
                           ...
                           name="select5" id="select5" class=" btn btn-sm btn-warning">التحويل للشؤون الماليه</button>
