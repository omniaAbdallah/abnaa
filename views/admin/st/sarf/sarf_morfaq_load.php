...
<?php echo form_open_multipart(base_url() . 'st/sarf/Sarf_order/add_attach') ?>
        <input type="hidden" name="set"  id="set"  value="<?=$id?>"/>
                ...
                <div class="col-sm-3  col-md-4 padding-2 ">
                       ...
                       <input type="text" name="title" id="title_file"  class="form-control" data-validation="reuqired">
                </div>
                    ...
                    if (in_array($ext, $image)) {
                        ...
                        <!-- <a data-toggle="modal" data-target="#myModal-view-<?= $m->id ?>">
                            ...
                            <!-- <a data-toggle="modal"
                                ...
                                <?php if (!empty($m->file)) {
                                    $url = base_url() . 'uploads/st/sarf/' . $m->file;
                                } else {
                        ...
                        <!-- <a target="_blank" href="<?= base_url() . "st/sarf/Sarf_order/read_file/" . $m->file ?>">
                            ...
                            <?php if (!empty($m->file)) {
                                   // $url = base_url() . 'uploads/egtma3at/all_mehwr/' . $mehwar_morfaq;
                                    $url =base_url().'st/sarf/Sarf_order/read_file/'.$m->file;
                                } else {
                                    $url = base_url('asisst/fav/apple-icon-120x120.png');
                                } ?>
...
<script>
    ...
    closeOnConfirm: false
        ...
        if(error == '') {
            ...
            $.ajax({
                url:"<?php echo base_url(); ?>st/sarf/Sarf_order/add_morfq", //base_url() return http://localhost/tutorial/codeigniter/
                method:"POST",
                data:form_data,
