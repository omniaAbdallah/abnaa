...
<table class="table " style="table-layout: fixed">
    ...
    <tr>
       <input type="hidden" id="sarf_id" value="<?= $get_all->id?>"/>
        <td style="width: 105px; color: red;"><input type="hidden" 
               id="moshtriat_id" value="<?=$get_all->id ?>"  />
            <strong  style="color: red;"> رقم إذن الصرف </strong>
        </td>
        <td style="width: 10px; color: red;"><strong>:</strong></td>
        <td style="color: red;" ><?=$get_all->ezn_rkm ?></td>

        <td style="width: 135px;"><strong>   تاريخ الإذن</strong></td>
        <td style="width: 10px;"><strong>:</strong></td>
        <td><?=$get_all->ezn_date_ar ?></td>
        <td style="width: 150px; color: red;"><strong> المستودع</strong></td>
        <td style="width: 10px;  color: red;"><strong>:</strong></td>
        <td style="color: red;;"><?=$get_all->storage_name ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="color: red;"><strong>  رقم ملف الأسرة/الجهة </strong></td>
        <td style="color: red;" ><strong>:</strong></td>
        <td style="color: red;"><?= $get_all->sarf_to_fk?></td>
      <td style="color: red;"><strong> الإسم     </strong></td>
        <td style="color: red;"><strong>:</strong></td>
        <td style="color: red;"><?= $get_all->sarf_to_name?></td>

    </tr>
    <tr>
         <td style="color: red;"><strong>المستلم </strong></td>
         <td style="color: red;"><strong>:</strong></td>
        <td style="color: red;"><?= $get_all->responsable_name ?></td>
        <td style="color: red;"><strong> القائم بالصرف </strong></td>
        <td style="color: red;"><strong>:</strong></td>
        <td style="color: red;"><?= $get_all->publisher_name ?></td>
