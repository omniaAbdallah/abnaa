...
<div class="col-xs-12 no-padding" >
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        if(isset($all->qued_rkm_fk) and $all->qued_rkm_fk != null){
         
           $qued_rkm_hala =   'تم التنفيذ';  
           $qued_class = 'success';
           $deport_qued_publisher_name = $all->publisher_name;
        }else{
           $qued_rkm_hala =   'قيد التنفيذ ';  
           $qued_class = 'warning';
           $deport_qued_publisher_name =   'قيد التنفيذ ';   
        }
...
<td><span style="color: white !important;" class="label label-success"><?php echo $all->finance_deport_publisher_name ?></span>
</td>
<td><span style="color: white !important;" class="label label-success"><?php echo $all->finance_deport_date_ar ?></span>
</td>

<!--
<td>
 <span style="color: black !important;" class="label label-<?php echo $qued_class; ?>"><?php echo $deport_qued_publisher_name; ?></span>     
 </td>   
 -->
<td> 
<span style="color: black !important;" class="label label-<?php echo $qued_class; ?>"><?php echo $qued_rkm_hala; ?></span>
</td>                                                 
