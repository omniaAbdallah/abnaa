    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body" style="min-height: 300px;">
          ...
          <!--  <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation" class="<?php if (isset($get_sarf) && !empty($get_sarf)){ echo "active";} elseif (isset($active) && !empty($active)){ echo "active";}?>"><a href="#ezn_sarf" aria-controls="outdoor_orders" role="tab" data-toggle="tab"> تسجيل إذن صرف </a></li>
            </ul> -->
...
<!--                </div>-->
                            ...
                            if ((isset($get_sarf->details)) && (!empty($get_sarf->details)) && ($get_sarf->details != 0)) {
                                ...
                                <tr id="row_1">
                                    ...
                                    <td><input type="text" name="sanf_code[]" class="form-control testButton inputclass"
                                               ...
                                               readonly/></td>
                                    <td><input type="text" name="sanf_coade_br[]" class="form-control testButton inputclass"
                                               id="sanf_coade_br1" value=""   data-validation="required" readonly/></td>
                                    <td><input type="text" name="sanf_name[]" class="form-control testButton inputclass"
                                               id="sanf_name1"   data-validation="required" value="" readonly/></td>
                                    <td><input type="text"   data-validation="required" name="sanf_whda[]" class="form-control testButton inputclass"
                                               id="sanf_whda1" value="" readonly/></td>
                                    <td><input type="text"   data-validation="required" name="sanf_rased[]" class="form-control testButton inputclass"
                                               id="sanf_rased1" value="" readonly/></td>
                                    <td><input type="text"   data-validation="required" name="sanf_amount[]" oninput="get_total(this,1)"
                                               class="form-control testButton inputclass"
                                               id="sanf_amount1" value=""/></td>
                                    <td><input type="text"   data-validation="required" name="sanf_one_price[]" class="form-control testButton inputclass"
                                    ...
                                    <td><input type="text"   data-validation="required" name="lot[]" class="form-control testButton inputclass" id="lot1"
                                               value=""/></td>
                                    <td><input readonly type="text" name="rased_hali[]" class="form-control testButton inputclass"
   ...
   <button type="submit" class="btn btn-labeled btn-success " name="<?= $submitAdd ?>" value="<?= $submitAdd ?>"
...
<!--    <button type="button" class="btn  btn-labeled btn-inverse " id="attach_button" onclick="" data-toggle="modal" data-target="#myModal_attach">
    ...
    -->
    <!--<button type="button" class="btn  btn-labeled btn-inverse " id="attach_button" onclick="$('#set').val(<?php echo $all->id;?>)" data-toggle="modal" data-target="#myModal_attach">
		<span class="btn-label" style="padding: 1px 6px;"><i class="glyphicon glyphicon-cloud-upload"></i></span>
		اضافة مرفق
	</button>
    -->
...
onclick=' swal({
        ...
        change_status(<?php echo $all->id; ?>,this);
...
name="select5" id="select<?php echo $all->id; ?>" class=" btn  btn-warning btn-labeled"><span
    class="btn-label" style="padding: 1px 6px;"><i
        class="fa fa-share"></i></span>التحويل للشؤون
الماليه
</button>
...
<script>
    ...
    function add_row_sanfe() {
        ...
        var row = ' <tr id="row_1" >\n' +
            ...
            '                        <td> <input type="text"   data-validation="required" class="form-control testButton inputclass" name="sanf_coade_br[]" id="sanf_coade_br' + (len + 1) + '" value="" readonly/></td>\n' +
            ...
            '                        <td> <input type="text"    data-validation="required" class="form-control testButton inputclass" name="lot[]" id="lot' + (len + 1) + '" value="" /></td>\n' +
