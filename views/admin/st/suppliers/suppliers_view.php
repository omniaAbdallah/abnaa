        ...
        <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
            ...
            <div class="panel-body">
                ...
                <div class="col-md-12 no-padding">
                    ...
                    <div class="form-group col-md-2 col-sm-6 padding-4">
                        <label class="label"> رقم جوال المسئول</label>
                    ...
                    <div class="col-md-12 col-xs-12  no-padding">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab1" aria-controls="tab1" role="tab" data-toggle="tab"> مرفقات</a></li>
                            <li><a href="#tab2" aria-controls="tab2" role="tab" data-toggle="tab">   ارقام تواصل أخري</a>
                            </li>
                        </ul>
                    </div>
...
<tr>
                            ...
                            <tr>
                                <th colspan="2" class="text-center" style="background-color: #fff;"> <button type="button" onclick="apen('morfq_option','morfaq','file','');"
                                 class="btn-success btn" style="font-size: 16px; float: left;"><i class="fa fa-plus"></i> إضافة مرفق
                                        </button></th>
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <!-- <tbody >
                                ...
                                <tr>
                                    <td> <input class="form-control" onkeypress="validate_number(event)" maxlength="10" type="text" name="tele_other[]" onkeyup="chek_length(this,$(this).val(),10)"  ></td>
                                    <td><a href="#" onclick="remove(this)"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                                </tr>
                            ...
                            <?php
                            if(isset($tele_other) && !empty($tele_other)){ foreach ($tele_other as $tele_othere ){ ?>
                                <tr>
                                    <td> <input class="form-control" onkeypress="validate_number(event)" maxlength="10" type="text" name="tele_other[]" onkeyup="chek_length(this,$(this).val(),10)" value="<?=$tele_othere?>" ></td>
                                    <td><a href="#" onclick="remove(this)"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                                </tr>
                         <?php } }else{
                            ?>
                            ...
                            <tr>
                                <th colspan="2" class="text-center" style="background-color: #fff;"> <button type="button" onclick="apen('phone_option','tele_other','text','validate_number(event)');"
                                 class="btn-success btn" style="font-size: 16px; float: left;"><i class="fa fa-plus"></i> إضافة هاتف
                                        </button></th>
...
<table id="js_table_supplier"
    ...
    <tr class="greentd">
        ...
        <th style="width: 70px;">كود المورد </th>
        <th style=" ">إسم المورد</th>
        <th style="width: 75px;"> النشاط</th>
        <th style="width: 100px;">رقم التليفون</th>
        <th style="width: 100px;" > طريقة الشراء</th>
    ...
    <div class="modal-dialog" role="document" style="width: 70%;">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="display: inline-block;width: 100%;">
                ...
                ?>
                <button
                        type="button" onclick="print_supplier(document.getElementById('supplier_id').value)"
...
<script>
    function print_supplier(row_id) {
        var request = $.ajax({
            // print_resrv -- print_contract
            url: "<?=base_url().'st/suppliers/Suppliers/Print_supplier'?>",
            type: "POST",
            data: {row_id: row_id},
        });
