                ...
                <div class="col-xs-12 no-padding" id="counter_section">
                    ...
                    <div class="col-md-12 col-xs-12  no-padding">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active"><a href="#tab1" aria-controls="tab1" role="tab" data-toggle="tab">إستلام

                                    الإيصالات</a></li>

                            <li><a href="#tab2" aria-controls="tab2" role="tab" data-toggle="tab">الإيصالات المحولة</a>
...
?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a title="عرض المرفق"
                                                           ...
                                                           data-target="#modal-add_morfaq"> <i
...
<div class="i-check">
    ...
    <input tabindex="9" type="checkbox"
           ...
           id="square-checkbox-<?= $row->id ?>"

           value="<?= $row->id ?>" class="checkbox_esal">
    ...
    <label for="square-checkbox-<?= $row->id ?>"></label>
                                    ...
                                    <input type="radio" id="thwel<?= $row->id ?>" name="thwel"

                                    class="checkbox_esal"

                                    onclick="Get_thwel_type(<?= $row->id ?>)"	value="<?= $row->id ?>" >

                                    <label class="radio-label " for="thwel<?= $row->id ?>"></label>
                                ...
                                <div class="col-md-12" style="margin-top: 25px;" id="resultt">
                                    ...
                                    if (!empty($eslat_estlam_deport)) {
                                        ...
                                        <table id=""
                                            ...
                                            <tr class="greentd">
                                                ...
                                                <th style="text-align: center !important;">إلي</th>
...
if($row->brnamg_tabe3 == 1){
    ...
    $Tahwel_color = '#ff9b5d';
   $deport_name =  $row->store_deport_publisher_name;
   $deport_date =  $row->store_deport_date_ar;

}elseif($row->brnamg_tabe3 == 2 or $row->brnamg_tabe3 == 3){

    $Tahwel_to = 'المالية';

     $Tahwel_color = '#29e899';
     $deport_name =  $row->financi_deport_publisher_name;
     $deport_date =  $row->financi_deport_date_ar;
}else{
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span style="color: white !important;"
                                                              ...
                                                              class="label label-success"><?= $deport_name ?></span>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span style="color: white !important;"
                                                              ...
                                                              class="label label-success"><?= $deport_date ?></span>

                                                    </td>



<td style="background: <?=$Tahwel_color?>;"><?= $Tahwel_to;?></td>
...
<?php }elseif($row->tahwel_to_ezn_edafa == 1){
   ...
   <span style="color: white !important;" class="label label-danger">تم التحويل إلي إذن اضافة</span>
...
<?php }
 ...
 <?php }elseif($row->brnamg_tabe3 == 2 or $row->brnamg_tabe3 == 3){ ?>

 <span style="color: white !important;" class="label label-danger">تم التحويل إلى المالية</span>
...
<script>
    ...
    function Get_thwel_type(esal_num) {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url() ?>st/esalat/Esalat_estlam/Get_thwel_type',
...
<script>
    ...
    function sendajax_finance() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url();?>st/esalat/Esalat_estlam/update_finance_store_deport",
