...
$('#tawred_type_span').html($('#esal_type option:selected').text());" data-validation="required" aria-required="true">
    ...
    $('#pay_method_span').html($('#pay_method option:selected').text());"
                ...
                <div class="col-md-12 no-padding ">
                    ...
                    <div class="col_md_45 col-sm-6 padding-4">
                        ...
                        <div class="col-md-10 col-sm-6  no-padding">
                            ...
                            <select class="form-control inputclass input_style_2 " id="fe2a" name="fe2a_type[]"
                    ...
                    <div class="col_md_45 col-sm-6 padding-4">
                        ...
                        <div class="col-md-6 col-sm-6  no-padding">
                            ...
                            <select id="band" name="bnd_type[]" class="form-control inputclass input_style_2 "
                    ...
                    <div class="col-md-1   no-padding" id="first_value">
                        <?php if (!empty($result->value2)) { ?>
                            ...
                            <input style="font-weight: 600 !important;" type="text" step="any"
                                   ...
                                   class="form-control  input_style_2 inputclass value band1_value"
                ...
                <div class="col-md-12" id="ValuesDiv2">
                    ...
                    <?php if (!empty($result->fe2a_type2) && !empty($result->bnd_type2)) { ?>
                        ...
                        <div class="col_md_45 col-sm-6 padding-4">
                            ...
                            <div class="col-md-9 col-sm-6  no-padding">
                                <select data-validation="required" class="form-control inputclass input_style_2"
                                        onchange="
                    ...
                    input_style_2 value band2_value inputclass" value="<?= $result->value2 ?>"
                                                                  onkeyup="CheckValue(this)">
                        </div>
                ...
                <div class="col-md-12" id="ValuesDiv3">
                    ...
                    <?php if (!empty($result->fe2a_type3) && !empty($result->bnd_type3)) { ?>
                        <div class="col_md_45 col-sm-6 padding-4">
                            ...
                            <div class="col-md-9 col-sm-6  no-padding">
                                <select data-validation="required" onchange="GetBandType2(this.value,'3')"
                                        class="form-control inputclass input_style_2" id="fe2a_type3" name="fe2a_type[]"
                                        aria-required="true">
                                    <option value="">إختر</option>
                                    <?php if (!empty($fe2a_type_arr2)) {
                                        foreach ($fe2a_type_arr2 as $row) { ?>
                        ...
                        <div class="col-md-1   no-padding"><input style="font-weight: 600 !important;"
                                                                  data-validation="required" type="text" step="any"
                                                                  name="value[]" id="value2" class="form-control
                    input_style_2 value band2_value inputclass" value="<?= $result->value3 ?>"
                                                                  onkeyup="CheckValue(this)">
                        </div>
                ...
                <div class="col-md-12" id="ValuesDiv4">
                    ...
                    <?php if (!empty($result->fe2a_type4) && !empty($result->bnd_type4)) { ?>
                        ...
                        <div class="col_md_45 col-sm-6 padding-4">
                            ...
                            <div class="col-md-9 col-sm-6  no-padding">
                                <select data-validation="required" onchange="GetBandType2(this.value,'4')"
                                        class="form-control  input_style_2 inputclass" id="fe2a_type4" name="fe2a_type[]"
                                        aria-required="true">
                                    <option value="">إختر</option>
                                    <?php if (!empty($fe2a_type_arr2)) {
                                        foreach ($fe2a_type_arr2 as $row) { ?>
                        ...
                        <div class="col_md_45 col-sm-6 padding-4">
                            <div class="col-md-3 col-sm-6  no-padding ">
                                <h6 class="label_title_2 "> البند</h6></div>
                            <div class="col-md-9 col-sm-6  no-padding">
                                <select data-validation="required" class="form-control  input_style_2 inputclass "
                                        onchange="
                         $('#band_tbro3_td2').html($('#bnd_type2 option:selected').text());     "
                        ...
                        <div class="col-md-1   no-padding"><input style="font-weight: 600 !important;"
                                                                  data-validation="required" type="text" step="any"
                                                                  name="value[]" id="value2" class="form-control
                    input_style_2 value band2_value inputclass" value="<?= $result->value4 ?>"
                                                                  onkeyup="CheckValue(this)">
                        </div>
                                    ...
                                    <div class="col-sm-12 form-group">
                                        ...
                                        <div class="col-sm-12 no-padding form-group">
                                            ...
                                            <div id="geha_input" style="display: none">
                                                ...
                                                <div class="col-sm-3  col-md-2 padding-4" id="div_update" style="display: none;">
                                                    <button type="button"
        ...
        function GetValues() {
            ...
            if ($('#myId').attr('data-click-state') < 4) {
                ...
                $("#first_value").html('<input style="font-weight: 600 !important;" type="text" step="any" data-validation="required" ' +
                    'name="value[]" class="form-control inputclass input_style_2 value band1_value"  ' +
                    'onkeyup="CheckValue(this);  $(\'#value1\').html($(this).val());" >');

                $("#ValuesDiv" + click_state).append('<div class="col_md_45 col-sm-6 padding-4"> ' +
                    '<div class="col-md-3 col-sm-6  no-padding ">' +
                    '<h6 class="label_title_2 ">الفئة </h6></div>' +
                    '<div class="col-md-9 col-sm-6  no-padding">' +
                    '<select  data-validation="required" onchange="GetBandType2(this.value,' + click_state + ')" class="form-control inputclass input_style_2"' +
                    ' id="fe2a_type' + click_state + '" name="fe2a_type[]"  aria-required="true">' +
                    '<option value="">إختر  </option></select></div></div>');

                $("#ValuesDiv" + click_state).append('<div class="col_md_45 col-sm-6 padding-4">' +
                    ' <div class="col-md-3 col-sm-6  no-padding "><h6 class="label_title_2 ">البند </h6></div>' +
                    '<div class="col-md-9 col-sm-6  no-padding">' +
                    '<select  data-validation="required" class="form-control inputclass input_style_2"  ' +
                ...
                $("#ValuesDiv" + click_state).append('<div  class="col-md-1   no-padding" >' +
                    '<input style="font-weight: 600 !important;" data-validation="required" type="text" step="any"' +
                    ' name="value[]" class="form-control inputclass input_style_2 value band_value' + click_state + '" ' +
...
//26-5-om
            if (CheckValue() == 1) {
                ...
                alert(' القيمة أصغر من المبلغ المتاح');
                $(".value").val(' ');
            } else {
                $('#myRedirectModal').modal('show');
                var PersonType = $('#person_type').val();
