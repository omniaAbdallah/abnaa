...
//    9-4-om
    ...
    $brnamg_tabe3 = $result->brnamg_tabe3;
                        ...
                        <div class="col-md-12 no-padding">
                            <div class="col-sm-2 padding-4 ">
                                ...
                                <input type="text" style="font-size: 16px!important; font-weight: 600 !important;"
                                       readonly name="esal_numS" id="esal_num"
...
$('#tawred_type_span').html($('#esal_type option:selected').text());" data-validation="required" aria-required="true">
         ...
         <div class="col-sm-3 padding-4">
                    <label class="label "> البرنامج التابع</label>
                    <select type="text" name="brnamg_tabe3" id="brnamg_tabe3" data-validation="required" 
                    value=""  class="form-control  ">
                        <option value="">اختر</option>
                        <?php
                        $brnamg_tabe3_arr = array('1' => 'مساعدات عينية للأسر',
                                                  '2' => 'مصروفات عينية للبرامج والأنشطة',
                                                  '3' => ' مصروفات عينية أصول');
                        foreach ($brnamg_tabe3_arr as $keybrnamg => $valuebrnamg) { ?>
                            <option value="<?= $keybrnamg ?>"
                                <?php if ($brnamg_tabe3 == $keybrnamg) {
                                    echo 'selected';
                                } ?>><?= $valuebrnamg ?></option>
                        <?php } ?>
                    </select>
                            ...
                            <div class="col-sm-6 padding-4">
                                ...
                                <!--list="pepople_arr"-->
                                <input autocomplete="off" style="width:85%; float: right;" type="text"
                                       name="person_name"
                            ...
                            <div class="col-sm-2" id="first_value">
                                ...
                                <input style="font-weight: 600 !important;margin-top: 26px; display: <?= $display ?>"
                                       type="text" step="any"
                            ...
                            <div class="col-sm-1">
                                <div style="margin-top: 26px;">
                                    <button type="button" id="myId"
                                            ...
                                            class="btn btn-success btn-next" style="float: right; width: 45%;"
                        ...
                        <div class="col-md-12 no-padding" id="ValuesDiv2">
                            ...
                            <?php if (!empty($result->fe2a_type2) && !empty($result->bnd_type2)) { ?>
                                ...
                                <div class="col-sm-4 padding-4">
                                    ...
                                    <select data-validation="required" onchange="GetBandType2(this.value,'2')"
                                            class="form-control inputclass input_style_2" id="fe2a_type2"
                                            name="fe2a_type[]"
                                            aria-required="true">
                                        <option value="">إختر</option>
                         ...
                         $('#band_tbro3_td2').html($('#bnd_type2 option:selected').text());     "
                                ...
                                <div class="col-sm-2"><input style="font-weight: 600 !important;"
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            if ((isset($result)) && !empty($result)) {
                                ...
                                if ((isset($result->attaches)) && !empty($result->attaches)) {
                                    ...
                                    <tr id="row_<?= $z ?>">
                                        ...
                                        if (in_array($ext, $image)) {
                                                     ...
                                                     <div class="modal-dialog modal-lg" role="document">
                                                         <div class="modal-content">
                                                             ...
                                                             <div class="modal-body">
                                                                 <img src="<?= base_url() . "uploads/st/esalat_estlam/" . $attach->morfaq ?>"
                                                                      width="100%">
                                                             </div>
                                            ...
                                            ?>
                                                 <a target="_blank" href="<?= base_url() . "st/esalat/Esalat_estlam/read_file/" . $attach->morfaq ?>">
                                                     <i class="fa fa-eye" title=" قراءة"></i> </a>
                                            <?php
                                        }
                                        ?>
                                ...
                                <tr id="row_1">
                                    ...
                                    <td><input type="file" name="morfaq[]"  class="form-control testButton inputclass"
                                               id="morfaq1" value=""
                        ...
                        <div class="modal-dialog" role="document" style="width: 80%">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                        ...
                                        foreach ($k_type_arr as $key => $value) { ?>
                                            <div class="radio-content">
                                                ...
                                                <label class="radio-label"
                                                       for="square-<?= $key ?>"><?= $value ?></label>
                                            </div>
                                            <?php
                                        }
                                    }
                                    ?>
                                    <div id="myDiv" style="    margin-top: 52px;"></div>

                                    <!------------------------------------------------------>

                                    <div id="motbr3_show" style="display: none;">
                                        <div class="col-sm-12 form-group">
                                            <div class="col-sm-12 form-group">
                                                <div class="col-sm-3  col-md-3  ">

                                                    <button type="button" class="btn btn-labeled btn-success "
                                                            onclick="$('#motbr3_input').show(); show_add()"
                                                            style="border-top-left-radius: 14px;border-bottom-right-radius: 14px;     margin-top: -827px;">
                                                    <span class="btn-label"><i
                                                                class="glyphicon glyphicon-plus"></i></span>إضافة متبرع
                                                    </button>
                                            ...
                                            <div class="col-sm-12 no-padding form-group">
                                                ...
                                                <div id="motbr3_input" style="display: none ">

                                                    <div class="col-sm-3  col-md-5 padding-2 ">
                                                        <label class="label label-green  ">إسم المتبرع </label>
                                                        <input type="text" onfocus="$('.motbr3_title').hide();"
                                                               name="name"
                                                               id="motbr3_title"
                                                               value=""
                                                               class="form-control input-style">
                                                        <input type="hidden" class="form-control" id="s_id" value="">
                                                        <span class="motbr3_title" style="color: red; display: none;">هذا الحقل مطلوب</span>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-3  col-md-1 no-padding" id="div_add"
                                                         style="display: block;">
                                                        <button type="button"
                                                                onclick="add_motbr3($('#motbr3_title').val())"
                                                    ...
                                                    <div class="col-sm-3  col-md-2 " id="div_update"
                                                         style="display: none;">
                                                        <button type="button"
                                                                style="margin-top: 27px;"
                                                                class="btn btn-labeled btn-success " name="save"
                                    ...
                                    <div id="kfla_show" style="display: none;">
                                        <div class="col-sm-12 form-group">
                                            <div class="col-sm-12 form-group">
                                                <div class="col-sm-3  col-md-3  ">

                                                    <button type="button" class="btn btn-labeled btn-success "
                                                            onclick="$('#kfel_input').show(); show_add()"
                                                            style="border-top-left-radius: 14px;border-bottom-right-radius: 14px; margin-top: -1099px;">
                                                    <span class="btn-label"><i
                                                                class="glyphicon glyphicon-plus"></i></span>إضافة كفيل
                                                    </button>
                                            ...
                                            <div class="col-sm-12 no-padding form-group">
                                                ...
                                                <div id="kfel_input" style="display: none">

                                                    <div class="col-sm-3  col-md-5 padding-2 ">
                                                        <label class="label label-green  ">إسم الكفيل </label>
                                                        <input type="text" onfocus="$('.kfel_title').hide();"
                                                               name="name"
                                                               id="kfel_title"
                                                               value=""
                                                               class="form-control input-style">
                                                        <input type="hidden" class="form-control" id="s_id" value="">
                                                        <span class="kfel_title" style="color: red; display: none;">هذا الحقل مطلوب</span>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-3  col-md-1 no-padding" id="div_add"
                                                         style="display: block;">
                                                        <button type="button" onclick="add_kfel($('#kfel_title').val())"
                                                                style="    margin-top: 27px;"
                                                                class="btn btn-labeled btn-success" name="save"
                                                                value="save">
                                                        <span class="btn-label"><i
                                        ...
                                        <div class="col-sm-12 form-group">
                                            <div class="col-sm-12 form-group">
                                                <div class="col-sm-3  col-md-3  ">
                                                    ...
                                                    <span class="btn-label"><i
                                                                class="glyphicon glyphicon-plus"></i></span>إضافة جهة
                                                    </button>
                                            ...
                                            <div class="col-sm-12 no-padding form-group">
                                                ...
                                                <div id="geha_input" style="display: none">
                                                    ...
                                                    <div class="col-sm-3  col-md-5 padding-2 ">
                                                        ...
                                                        <input type="text" onfocus="$('.geha_title').hide();"
                                                               name="name"
                                                               id="geha_title"
                                                               value=""
                                                               class="form-control input-style">
                                                    ...
                                                    foreach ($gehat as $value) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="radio" name="radio"
                                                                       ...
                                                                       data-mob="<?= $value->mob ?>" data-type="5"
                                                                       data-id="<?= $value->id ?>"
                                                                       style="width: 20px;height: 20px;"
                                                                       id="member<?= $value->id ?>"
                                                                       ondblclick="GetMemberName(<?= $value->id ?>)">
                                                            </td>
                                                            <td><?= $value->name ?></td>
                                                            <td><?= $value->mob ?></td>
                                                            <td><?= $value->address ?></td>
...
<div class="col-sm-1 padding-4">
          ...
          <!--  <div class="col-sm-3 no-padding" style="background-color: white !important;">

                <table class="table table-ehsaiat">
                    <thead>
                    <th></th>
                    ...
                    <tbody>
                    <tr>
                        <td><img src="<?php echo base_url() ?>asisst/admin_asset/img/icons/st1.png"
                                 style="width: 45px;height: 45px;"/>
                            <h6>أيتام</h6>
                        </td>

                        <td>163</td>
                        <td style="color: green;font-size: 20px !important;">8</td>
                        <td style="color: green;font-size: 20px !important;">155</td>
                    </tr>
                    <tr>
                        <td><img src="<?php echo base_url() ?>asisst/admin_asset/img/icons/st2.png"
                                 style="width: 45px;height: 45px;"/>
                            <h6>أرامل</h6>
                        </td>

                        <td>70</td>
                        <td style="color: green;font-size: 20px !important;">4</td>
                        <td style="color: green;font-size: 20px !important;">66</td>
                    </tr>
                    <tr>
                        <td><img src="<?php echo base_url() ?>asisst/admin_asset/img/icons/st4.png"
                                 style="width: 45px;height: 45px;"/>
                            <h6>مستفيد بالغ</h6>
                        </td>

                        <td>186</td>
                        <td style="color: green;font-size: 20px !important;">5</td>
                        <td style="color: green;font-size: 20px !important;">181</td>
                    </tr>
...
//                                                }
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href='<?php echo base_url() . 'st/esalat/Esalat_estlam/Print_esal2/' . $row->id ?>'
...
target='_blank'><i class='fa fa-print' aria -
                  hidden='true'></i></a>
                  -->
                                                        <a onclick="print_esal_estlam(<?= $row->id ?>)" title="طباعه"><i
    ...
    <script>
        ...
        function GetValues() {
            ...
            if ($('#myId').attr('data-click-state') < 4) {
                ...
                $("#ValuesDiv" + click_state).append('<div  class="col-sm-2" >' +
        ...
        function CheckValue(elem) {
            ...
            var val = $("#value").val();
            console.log('-------------------------------- val : ' + val + "------------------------------ ");
            console.log('-------------------------------- input_ele : ' + input_ele.length + "------------------------------ ");
    ...
    <script>
        ...
        function add_row() {
            ...
            var row = ' <tr id="row_1" >\n' +
                ...
                '                        <td> <input type="file"  class="form-control testButton inputclass" name="morfaq[]" id="morfaq' + (len + 1) + '" value=""   /></td>\n' +
                '                        <td><a id="1" onclick=" $(this).closest(\'tr\').remove(); "><i class="fa fa-trash"></i></a></td>\n' +
                '                    </tr>';
        ...
        function load_add_morfaq(esal_num) {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo base_url() ?>st/esalat/Esalat_estlam/add_attach',
        ...
        function delete_my_morfaq(elem, attach) {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo base_url() ?>st/esalat/Esalat_estlam/delete_attach',
                data: {attach: attach},
                dataType: 'html',
                cache: false,
                success: function (html) {
...
//26-5-om
    ...
    <script>
        function print_esal_estlam(id) {
            var request = $.ajax({
                // print_resrv -- print_contract
                url: "<?=base_url() . 'st/esalat/Esalat_estlam/Printesal'?>",
                type: "POST",
                data: {id: id},
            });
    ...
    <script>
        function add_kfel(value) {

            var kfel_title = $('#kfel_title').val();
            if (kfel_title == '') {
                $('.kfel_title').show();
                return;
            }
            ...
            if (value != 0 && value != '') {
                ...
                $.ajax({
                    type: 'post',
                    url: '<?php echo base_url() ?>st/esalat/Esalat_estlam/add_kfel',
                    data: dataString,
                    dataType: 'html',
                    cache: false,
                    success: function (html) {
    ...
    <script>
        function add_motbr3(value) {

            var motbr3_title = $('#motbr3_title').val();
            if (motbr3_title == '') {
                $('.motbr3_title').show();
                return;
            }
            ...
            if (value != 0 && value != '') {
                ...
                $.ajax({
                    type: 'post',
                    url: '<?php echo base_url() ?>st/esalat/Esalat_estlam/add_motbr3',
                    data: dataString,
                    dataType: 'html',
                    cache: false,
                    success: function (html) {
