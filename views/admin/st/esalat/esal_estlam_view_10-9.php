           ...
           <div class="col-md-2   no-padding" id="first_value">
                ...
                <div class="col-md-12 no-padding" id="ValuesDiv2">
                    ...
                    <?php if (!empty($result->fe2a_type2) && !empty($result->bnd_type2)) { ?>
                        ...
                        <div class="col-md-2   no-padding"><input style="font-weight: 600 !important;"
                                    ...
                                    <div class="col-sm-12 form-group">
                                        <div class="col-sm-12 form-group">
                                            <div class="col-sm-3  col-md-3  ">
                                                ...
                                                <button type="button" class="btn btn-labeled btn-success " onclick="$('#motbr3_input').show(); show_add()"
                                                        style="border-top-left-radius: 14px;border-bottom-right-radius: 14px;     margin-top: -827px;">
                                                    <span class="btn-label"><i class="glyphicon glyphicon-plus"></i></span>إضافة متبرع
                                                </button>
                                        ...
                                        <div class="col-sm-12 no-padding form-group">
                                            ...
                                            <div id="motbr3_input" style="display: none " >
                                                ...
                                                <div class="col-sm-3  col-md-5 padding-2 ">
                                                    ...
                                                    <input type="text" onfocus="$('.motbr3_title').hide();" name="name" id="motbr3_title"
                                                           value=""
                                                ...
                                                <div class="col-sm-3  col-md-1 no-padding" id="div_add" style="display: block;">
                                                    <button type="button" onclick="add_motbr3($('#motbr3_title').val())" style="    margin-top: 27px;"
                                    ...
                                    <div class="col-sm-12 form-group">
                                        <div class="col-sm-12 form-group">
                                            <div class="col-sm-3  col-md-3  ">
                                                ...
                                                <button type="button" class="btn btn-labeled btn-success " onclick="$('#kfel_input').show(); show_add()"
                                                        style="border-top-left-radius: 14px;border-bottom-right-radius: 14px; margin-top: -1099px;" >
                                                    <span class="btn-label"><i class="glyphicon glyphicon-plus"></i></span>إضافة كفيل
                                                </button>
                                        ...
                                        <div class="col-sm-12 no-padding form-group">
                                            ...
                                            <div id="kfel_input" style="display: none">
                                                ...
                                                <div class="col-sm-3  col-md-5 padding-2 ">
                                                    ...
                                                    <input type="text" onfocus="$('.kfel_title').hide();" name="name" id="kfel_title"
                                                           value=""
                                                           class="form-control input-style">
                                                    <input type="hidden" class="form-control" id="s_id" value="">
                                                ...
                                                <div class="col-sm-3  col-md-1 no-padding" id="div_add" style="display: block;">
                                                    <button type="button" onclick="add_kfel($('#kfel_title').val())" style="    margin-top: 27px;"
                                                            class="btn btn-labeled btn-success" name="save" value="save">
                                                        <span class="btn-label"><i class="glyphicon glyphicon-floppy-disk"></i></span>حفظ
                                                    </button>
                                                </div>
