...
<div class="bond-header">
    ...
    <div class="col-xs-12">
        ...
        <div class="col-xs-4 text-center">
            <h4 class="green-border"><span>رقم الإذن : <?= $get_all->ezn_rkm  ?></span></h4>
        </div>
    </div>
            ...
            <div class="col-xs-12 no-padding under-line">
                ...
                <table class="table " style="table-layout: fixed">
                    ...
                    <tr>
                        ...
                        <td class="" style="width: 20%;">  طريقة الشراء</td>
                        <td><?php
                    ...
                    <tr>
                        <td class="" style="width: 20%;"> جهة التوريد </td>
                        <td><?= $get_all->person_name ?></td>
                        <td class="" style="width: 20%;">  رقم الجوال </td>
