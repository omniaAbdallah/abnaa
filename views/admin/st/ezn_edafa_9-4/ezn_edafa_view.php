        ...
        <div class="panel-body">
            ...
            <div class="col-md-12">
                <div class="form-group col-md-2 col-sm-6 padding-4">
                   <input type="radio"  data-validation="required" <?php if($type_ezn!=2) echo 'checked';?> 
                   onchange="get_form($(this).val());" value="1" name="type_ezn">تبرعات عينية
                    <input type="radio"  data-validation="required"  <?php if($type_ezn==2) echo 'checked';?>
                     onchange="get_form($(this).val());" value="2" name="type_ezn"> مشتريات عينية
            ...
            <div class="col-xs-12 text-center">
                ...
                <button type="button"
                        class="btn btn-labeled btn-inverse "  id="attach_button" onclick="checkInputs()" data-toggle="modal" >
                ...
                <a href="<?php echo base_url();?>st/ezn_edafa/Ezn_edafa/Print_ezn/<?= $id ?>"><button
                            type="button"
...
<script>
    function get_form(valu) {
     ...
     {
         $('#tabro3').fadeIn(1000);
         $('#moshtrat').fadeOut(1000);
     }else{
         $('#tabro3').fadeOut(1000);
         $('#moshtrat').fadeIn(1000);
...
<script>
    function add_row(){
        ...
        $(".attachTable").append('<tr class="'+ len +'">' +
            ...
            '<td>'+(len+1)+'</td><td><input type="input" name="title[]" id="title"  class="form-control" data-validation="reuqired"></td><td><input type="file" name="file[]" id="file"  class="form-control " data-validation="reuqired"></td><td><a href="#"  onclick="DeleteRowImg('+len+')"> <i class="fa fa-trash" ></i> </a></td></tr>');
    }
