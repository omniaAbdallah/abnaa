...
<div class="bond-header">
    ...
    <div class="col-xs-12 pad-2">
        <div class="main-bond-title">
            <h3 class="text-center"><span class=""> اعدادات الإضافة والصرف </span></h3>
        </div>
    </div>
    <div class="col-xs-4 pad-2">
        <div class="left-img">
    ...
    <div class="print_forma  col-xs-12 ">
        ...
        if (isset($get_sarf)&& !empty($get_sarf)){
            ...
            <table class="table " style="table-layout: fixed">
                ...
                <tr>
                    <td><strong> القســـــــم  </strong></td>
                    <td><strong>:</strong></td>
        ...
        <div class="col-xs-3">
            ...
            if (isset($get_sarf->emp_img) && !empty($get_sarf->emp_img)){
                ?>
                <div class="left-img">
                    <img src="<?= base_url()."uploads/images/".$get_sarf->emp_img?>" width="100%" alt="" >
                </div>
                <?php
            }
            ?>
