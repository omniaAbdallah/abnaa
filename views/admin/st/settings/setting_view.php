            ...
            <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
                ...
                <div class="panel-body">
                    <div class="col-sm-2 padding-4">
                        <ul class="nav nav-tabs tabs-left holiday-month" style="    border: 1px solid gray;">
                            ...
                            <li role="presentation" >
                                <a href="#tab_fe2at" aria-controls="tab_fe2at" role="tab" data-toggle="tab"><i
                                            class="fa fa-cog" aria-hidden="true"></i> الفئات </a>
                            </li>
                            <li role="presentation" >
                                <a href="#tab_wasf" aria-controls="tab_wasf" role="tab" data-toggle="tab"><i
                                            class="fa fa-cog" aria-hidden="true"></i> الوصف </a>
                            </li>
                    ...
                    <div class="tab-content col-sm-10">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <div class="form-group col-sm-12 col-xs-12 text-center">
                                                <button type="submit" name="add" value="حفظ"
                                                        class="btn btn-success btn-labeled "><span class="btn-label">
                        ...
                        <!--  Fe2at Tap -->
                        <div class="tab-pane fade in <?php if(isset($typee) && !empty($typee)&& $typee === "tab_fe2at") {echo  'active'; }  ?>" id="tab_fe2at">

                            <div class="panel-body">
                                <a href="#" class="btn btn-add btndate" data-toggle="modal" data-target="#addholiday"
                                   style="margin-bottom: 6px;"> <strong>
                                        <i class="fa fa-cog" aria-hidden="true"></i> الفئات</strong></a>


                                <div class="table-responsive">
                                    <div class=" col-xs-12">
                                        <fieldset class="col-sm-12 col-xs-12 no-padding" id="main_section" >
                                            <div>
                                                <?php
                                                if (!empty($products)) {
                                                    echo form_open_multipart("st/settings/Setting/UpdateSitting/".$products['id'].'/tab_fe2at');
                                                } else {
                                              ...
                                              <!--  <h5 class="title-top"> الفئة</h5> -->
                                                <div class="form-group col-sm-9 col-xs-12 no-padding">
                                                    ...
                                                    <input type="text" name="title"
                                                           value="<?php if (!empty($products['name']) ) {
                                                               echo $products['name'];
                                                           } ?>" class="form-control " placeholder="الفئة"
                                                           data-validation="required"
                                                           aria-required="true">
                                                </div>
                                                <input type="hidden" name="level"
                                                       value="<?php if (!empty($products['level'])) {
                                                           echo $products['level'];
                                                       } else {
                                                           echo 1;
                                                       } ?>">
                                                ...
                                                <div class="col-md-12 text-center">
                                                        ...
                                                        <button type="submit" name="add_main_product" value="add_main_device"
                                                        class="btn btn-success btn-labeled " ><span class="btn-label">
                                                        <i class="fa fa-floppy-o" aria-hidden="true"></i></span> حفظ
                                                            </button>
                                                </div>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <table id="" class="table table-striped table-bordered dt-responsive nowrap"
                                                ...
                                                <tr class="info">
                                                    ...
                                                    <!--  Nagwa 16-6   -->
                                                    <th class="text-center">ربط بالدليل(إيراد)</th>
                                                    <th class="text-center">ربط بالدليل(صرف)</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <?php if ($record->count == 0) { ?>
                                                            <a href="<?php echo base_url(); ?>st/settings/Setting/UpdateSitting/<?php echo $record->id; ?>/tab_fe2at"><i
                                                                        class="fa fa-pencil-square-o"
                                                                        aria-hidden="true"></i> </a>

                                                            <a onclick="$('#adele').attr('href', '<?= base_url()."st/settings/Setting/DeleteSitting/" . $record->id.'/tab_fe2at' ?>');"
                                                    ...
                                                    <td>
                                                        <?php
                                                        if (empty($record->rkm_hesab_erad)){
                                                            ?>
                                                            <input type="hidden" name="modalID" id="modalID">

                                                            <input type="hidden" class="form-control testButton inputclass" name="rkm_hesab_erad"
                                                                   id="rkm_hesab_erad<?= $record->id?>"
                                                                   readonly="readonly"
                                                            ...
                                                            <input type="text" class="form-control testButton inputclass" name="rkm_hesab_erad"
                                                                   id="rkm_hesab_erad<?= $record->id?>"
                                                                   readonly="readonly"
                                                                   onclick="$('#modalID').val(<?=$record->id ?>); "
                                                                   ondblclick="$('#myModal').modal('show');"
                                                                   style="cursor:pointer;border: white;color: black"
                                                                   value="<?= $record->rkm_hesab_erad?>">
                                                    ...
                                                    <td>
                                                        <?php
                                                        if (empty($record->rkm_hesab_sarf)){
                                                            ?>
                                                            <input type="hidden" name="modalIDSarf" id="modalIDSarf">

                                                            <input type="hidden" class="form-control testButton inputclass" name="rkm_hesab_sarf"
                                                                   id="rkm_hesab_sarf<?= $record->id?>"
                                                                   readonly="readonly"
                                                                   onclick="$('#modalIDSarf').val(<?=$record->id ?>); "
                                                                   ondblclick="$('#myModal_sarf').modal('show');"
                                                                   style="cursor:pointer;border: white;color: black"
                                                                   value="">
                                                            <button class="btn btn-warning"
                                                                    id="dalel_sarf<?= $record->id?>"
                                                                    onclick="$('#modalIDSarf').val(<?=$record->id ?>); "
                                                                    ondblclick="$('#myModal_sarf').modal('show');"
                                                            ...
                                                            <input type="text" class="form-control testButton inputclass" name="rkm_hesab_sarf"
                                                                   id="rkm_hesab_sarf<?= $record->id?>"
                                                                   readonly="readonly"
                                                                   onclick="$('#modalIDSarf').val(<?=$record->id ?>); "
                                                                   ondblclick="$('#myModal_sarf').modal('show');"
                                                                   style="cursor:pointer;border: white;color: black"
                                                                   value="<?= $record->rkm_hesab_sarf?>">
                        ...
                        <!--  Wasf Tap -->
                        <div class="tab-pane fade in <?php if(isset($typee) && !empty($typee)&& $typee === "tab_wasf") {echo  'active'; }  ?>" id="tab_wasf">

                            <div class="panel-body">
                                <a href="#" class="btn btn-add btndate" data-toggle="modal" data-target="#addholiday"
                                   style="margin-bottom: 6px;"> <strong>
                                        <i class="fa fa-cog" aria-hidden="true"></i> الوصف</strong></a>
                                <div class="table-responsive">
                                    <fieldset class="col-sm-6 col-xs-12" id="sub_section" >
                                        <?php
                                        if (!empty($products)) {
                                            echo form_open_multipart("st/settings/Setting/UpdateSitting/".$products['id'].'/tab_wasf');
                                        } else {
                                 ...
                                 <!--       <h5 class="title-top"> الوصف</h5> -->
                                        <div class="form-group ">
                                            ...
                                            <select id="from_id" name="from_id" data-validation="required"
                                                    class="form-control  selectpicker " aria-required="true"
                                        ...
                                        <div class="col-md-12 text-center">
                                            ...
                                            <button type="submit" name="add_sub_product" value="add_sub_device"
                                                class="btn btn-success btn-labeled " ><span class="btn-label">
                                                <i class="fa fa-floppy-o" aria-hidden="true"></i></span> حفظ
                                                    </button>
                                        </div>
                                    ...
                                    <div class="col-xs-6  fadeInUp wow" style="padding: 0;">
                                           ...
                                           <h6>شجرة الفئات</h6>
                                            ...
                                            <div class="panel-body" style="height: 212px; overflow-y: scroll;">
                                                ...
                                                <div class="form-group col-sm-12 col-xs-12">
                                                    ...
                                                    function buildTree($product_tree) {
                                                        ?>
                                                        <ul id="tree3">
                                                            <?php foreach ($product_tree as $record) { ?>
                                                                <li>

                                                                    <span style="background-color: ">
                                                                    </span> <?=' - '.$record->name?>
                                                                     <div class="pull-right">
                                                                        <?php if ( isset($record->from_id) && $record->from_id ==0 ) { ?>
                                                                        <?php } else{
                                                                            ?>
                                                                            <a href="<?php echo base_url(); ?>st/settings/Setting/UpdateSitting/<?php echo $record->id; ?>/tab_wasf"><i
                                                                                        class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                                            </a>

                                                                            <a onclick="$('#adele').attr('href', '<?= base_url()."st/settings/Setting/DeleteSitting/" . $record->id .'/tab_wasf'?>');"
                                                                               data-toggle="modal" data-target="#modal-delete"
                                                                               title="حذف"> <i class="fa fa-trash"
                                                                                               aria-hidden="true"></i> </a>
                                                                            <?php
                                                  ...
                                                  if (isset($product_tree) && $product_tree!=null) {
                                                      buildTree($product_tree);
                                                   }
                                                    ?>
                                                </div>
                    ...
                    function buildTreeTable($tree, $count = 1)
                    {
                        ...
                        foreach ($tree as $record) {
                            ...
                            <tr style="background-color: <?= $colorArray[$record->level] ?>; cursor: pointer;"
                                onclick="update_rkm_hesab_erad(<?= $record->hesab_no3?>,<?= $record->code?>)">
...
<div class="modal fade" id="myModal_sarf" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document" style="width: 70%">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            ...
            <div class="modal-body">
                ...
                <table id="" class="table table-bordered example" role="table">
                    ...
                    <?php
                    if (isset($tree) && $tree != null) {
                        buildTreeTable2($tree);
                    }
                    function buildTreeTable2($tree, $count = 1)
                    {
                        $types = array(1 => 'رئيسي', 2 => 'فرعي');
                        $nature = array('', 'مدين', 'دائن');
                        $follow = array(1 => 'ميزانية', 2 => 'قائمة الأنشطة');
                        ...
                        foreach ($tree as $record) {
                            ...
                            ?>
                            <tr style="background-color: <?= $colorArray[$record->level] ?>; cursor: pointer;"
                                onclick="update_rkm_hesab_sarf(<?= $record->hesab_no3?>,<?= $record->code?>)">
                                <td class="forTd"><?= $count++ ?></td>
                                <td class="forTd"><?= $record->code ?></td>
                                <td class="forTd"><?= $record->name ?></td>
                            </tr>
                            <?php
                            if (isset($record->subs)) {
                                $count = buildTreeTable2($record->subs, $count++);
                            }
                        }
                        return $count;
                    }
...
<!-- Nagwa 16-6 -->
<script>
    function update_rkm_hesab_erad(hesab_no3,rkm_hesab) {

        $('#rkm_hesab_erad'+$('#modalID').val()).val(rkm_hesab);
        var id = $('#modalID').val();
        var rkm_hesab_type = 'rkm_hesab_erad';

        if (hesab_no3 ==2){

        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>st/settings/Setting/update_rkm_hesab_erad',
            data: {id:id,rkm_hesab:rkm_hesab,rkm_hesab_type:rkm_hesab_type},
            dataType: 'html',
            cache: false,
            success: function () {

                $('#myModal').modal('hide');
                $('#rkm_hesab_erad'+$('#modalID').val()).attr('type', 'text');
...
<script>
    function update_rkm_hesab_sarf(hesab_no3,rkm_hesab) {

        $('#rkm_hesab_sarf'+$('#modalIDSarf').val()).val(rkm_hesab);
        var id = $('#modalIDSarf').val();
        var rkm_hesab_type = 'rkm_hesab_sarf';
        ...
        if (hesab_no3 ==2){
            ...
            $.ajax({
                ...
                success: function () {
                    ...
                    $('#myModal_sarf').modal('hide');
                    $('#rkm_hesab_sarf'+$('#modalIDSarf').val()).attr('type', 'text');
                    $('#dalel_sarf'+$('#modalIDSarf').val()).hide();
                    swal({
                        title:" تم الربط بالدليل" ,
                        confirmButtonText: "تم"
                    });
