    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            ...
            if ((isset($one_data)) && (!empty($one_data))) {
                ...
                echo form_open_multipart(base_url() . 'st/ezn_edafa/Ezn_edafa/add_esal_ezn/' . $result->id, array('id' => 'myform'));
                $submitSave = 'submit';
                $submitEdit = 'button';
                $disabled = 'disabled';
                $type_ezn = 1;
                    ...
                    <?php if (!isset($result)) { ?>
                        ...
                        <div class="form-group col-md-1 col-sm-6 padding-4">
                            ...
                            <div id="first_value" style="margin-top: 27px">
                                ...
                                <input style="font-weight: 600 !important;" type="number" step="any"
                         ...
                         $('#band_tbro3_td2').html($('#bnd_type2 option:selected').text());     "
                                    ...
                                    <div class="form-group col-md-1 col-sm-6 padding-4">
                                        <input style="font-weight: 600 !important;" data-validation="required"
                                               type="number" step="any" name="value[]" id="value2"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" onclick=' swal({
                                        ...
                                        name="select5" id="select<?php echo $datum->id; ?>"
...
<script>
    ...
    $(document).ready(function () {
        var count_input = document.getElementsByClassName('value');
        var all_value = document.getElementById('all_value').value;
        if (count_input.length == 1) {
            count_input[0].value = all_value;
        }
    });
</script>
...
<script>
    function get_form(valu) {
        if (valu == 2) {
            ...
            $('#all_value').attr('data-validation', '');
            $('#fe2a').attr('data-validation', '');
            $('#band').attr('data-validation', '');
            $('#value1').attr('data-validation', '');
            $('#no3_tabro3').attr('data-validation', '');
        } else {
            $('#tabro3').fadeOut(2000);
            $('#moshtrat').fadeIn(2000);
            $('#all_value').attr('data-validation', 'required');
            $('#fe2a').attr('data-validation', 'required');
            $('#band').attr('data-validation', 'required');
            $('#value1').attr('data-validation', 'required');
            $('#no3_tabro3').attr('data-validation', 'required');
...
<script>
    ...
    function GetValues() {
        ...
        if ($('#myId').attr('data-click-state') < 4) {
            ...
            $("#first_value").html('<input style="font-weight: 600 !important;" type="number" step="any" data-validation="required" ' +
...
<script>
    ...
    function CheckValue() {
        ...
        var type_ezn = $("input[name='type_ezn']:checked").val();
        if (type_ezn == 1) {
            ...
            if (radioValue) {
                if (sum > all_value) {
                    swal({
                        title: "انتبه ! ... الاجمالي البنود اكبر من المبلغ المدفوع",
                        confirmButtonText: "تم"
                    });

                } else if (sum < all_value) {
                    swal({
                        title: "انتبه ! ... الاجمالي البنود اصغر من المبلغ المدفوع",
                        confirmButtonText: "تم"
                    });

                } else if (total < all_value) {
                    swal({
                        title: "انتبه ! ... الاجمالي الاصناف اصغر من المبلغ المدفوع",
                        confirmButtonText: "تم"
                    });

                } else if (total > all_value) {
                    swal({
                        title: "انتبه ! ... الاجمالي الاصناف اكبر من المبلغ المدفوع",
                        confirmButtonText: "تم"
                    });
