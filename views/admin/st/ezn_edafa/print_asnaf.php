            ...
            <div class="piece-body">
                <div class="col-xs-12">
                    <table class="table " style="table-layout: fixed">
                        ...
                        <?php } ?> <?php if (!empty($one_data['fe2a_title2'])) { ?>
                            <tr>
                                <td class="" style="width: 20%;">الفئة</td>
                                <td><?= $one_data['fe2a_title2'] ?></td>
                                <td class=" " style="width: 20%;">البند</td>
                                <td><?= $one_data['band_title2'] ?></td>
                            </tr>
                        <?php } ?> <?php if (!empty($one_data['fe2a_title3'])) { ?>
                            <tr>
                                <td class="" style="width: 20%;">الفئة</td>
                                <td><?= $one_data['fe2a_title3'] ?></td>
                                <td class=" " style="width: 20%;">البند</td>
                                <td><?= $one_data['band_title3'] ?></td>
                            </tr>
                        <?php } ?> <?php if (!empty($one_data['fe2a_title4'])) { ?>
                            <tr>
                                <td class="" style="width: 20%;">الفئة</td>
                                <td><?= $one_data['fe2a_title4'] ?></td>
                                <td class=" " style="width: 20%;">البند</td>
                                <td><?= $one_data['band_title4'] ?></td>
                            </tr>
                        <?php } ?>
