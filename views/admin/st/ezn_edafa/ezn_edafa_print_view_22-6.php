    ...
    <style type="text/css">
        ...
        .table-bordered.double {
         ...
         .table-bordered.white-border{
          ...
          .table-bordered.table-asnaf > tbody > tr > th, .table-bordered.table-asnaf > tbody > tr > td {
            ...
            <div class="piece-body">
                <div class="col-xs-12">
                    <table class="table table-bordered hl white-border" style="table-layout: fixed;">
                        <tbody>
                        <tr>
                            <td class="rosasy-bg" style="width: 100px">نوع الإضافة</td>
                            <td><?php
                            ...
                            <td class="rosasy-bg" style="width: 80px">رقم الإذن</td>
                            <td style="width: 80px"><span class="badge" style="font-size: 20px;"><?= $get_all->ezn_rkm ?></span></td>
                            <td class="rosasy-bg" style="width: 100px">تاريخ الإضافة</td>
                ...
                <div class="col-xs-12">
                    <table class="table table-bordered hl white-border" style="table-layout: fixed;">
                        <tbody>
                        <tr>
                            <td class="rosasy-bg" style="width: 100px">المستودع</td>
                            <td><?= $get_all->storage_name ?></td>
                            <td class="rosasy-bg" style="width: 110px">أمين المستودع</td>
                ...
                <div class="col-xs-12">
                    <table class="table table-bordered hl white-border" style="table-layout: fixed;">
                        <tbody>
                        <tr>
                            <td class="rosasy-bg" style="width: 100px">المتبرع/الجهة</td>
                            <td><?= $get_all->person_name ?></td>
                            <td class="rosasy-bg" style="width: 80px">رقم الملف</td>
                            <td style="width: 80px"></td>
                            <td class="rosasy-bg" style="width: 80px">الجوال</td>
                            <td style="width: 100px"><?= $get_all->person_jwal ?></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="piece-body">
                ...
                <div class="col-xs-12">
                    <table class="table table-bordered double table-asnaf" style="table-layout: fixed">
                        ...
                        <tfoot>
                        <th colspan="4">الإجمـــــــــــــــــــــــــــــــــــــالي</th>
                        <th></th>
                ...
                <div class="col-xs-12 hl">
                    <div class="col-xs-4 text-center">
                        <h5 style="margin-bottom: 20px;">أمين المستودع   </h5>
                        <h5><?=$get_all->store_emp?></h5>
                    </div>
                    <div class="col-xs-4 text-center">
                        <h5 style="margin-bottom: 20px;">الختم  </h5>
                        <h5></h5>
                    </div>
                    <div class="col-xs-4 text-center">
                        <h5 style="margin-bottom: 20px;">مدير الإدارة/القسم</h5>
                        <h5></h5>
                    </div>
        ...
        <div class="col-xs-12 no-padding print-details-footer">
            <div class="col-xs-6">
                <p class=" text-center" style="margin-bottom: 0;">
                    <small>(اسم الموظف القائم بالإدخال أو الطباعة) / أحمد محمد إسماعيل بن عبد الله</small>
                </p>
            ...
            <div class="col-xs-4">
                ...
                <p class=" text-center" style="margin-bottom: 0;">
                    <small>تاريخ الطباعة : <?=date('Y-m-d H:m a')?></small>
                </p>
            </div>
