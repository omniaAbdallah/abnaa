...
<div class="col-xs-12 ">
            ...
            <div class="col-md-12">
                <div class="form-group col-md-3 col-sm-6 padding-4">
                    ...
                    <div class="radio-content">
                        <input type="radio"
                               data-validation="required" <?php if ($type_ezn != 2) echo 'checked'; ?> <?php if ($type_ezn == 2) echo 'disabled'; ?>
                ...
                <div id="moshtrat" <?php if ($type_ezn != 2) { ?> style="display: block;" <?php } else { ?> style="display: none;" <?php } ?>>
                    <div class="form-group col-md-1 col-sm-6 padding-4">
                        ...
                        <input type="number" onfocusout="get_diff_money();" name="all_value" id="all_value"
                               value="<?= $all_value ?>"
                               class="form-control "
                               data-validation-has-keyup-event="true">
                    </div>
                    ...
                    <div class="form-group col-md-2 col-sm-6 padding-4">
                        ...
                        <select class="form-control " data-validation-has-keyup-event="true" id="fe2a"
                                name="fe2a_type[]"
                    ...
                    <div class="form-group col-md-1 col-sm-6 padding-4">
                        <div style="margin-top: 21px">
                            <button type="button" id="myId"
                                    ...
                                    class=" form-group btn btn-success btn-next" style="float: right;"
                    ...
                    <div class="form-group col-md-1 col-sm-6 padding-4">
                        ...
                        <div id="first_value" style="margin-top: 21px">
                                ...
                                <div class="col_md_45 col-sm-6 padding-4">
                                    ...
                                    <div class="col-md-9 col-sm-6  no-padding">
                                        <select data-validation="required" onchange="GetBandType2(this.value,'3')"
                                                class="form-control inputclass input_style_2" id="fe2a_type3"
                                                name="fe2a_type[]"
                                                aria-required="true">
                                            <option value="">إختر</option>
                                            <?php if (!empty($fe2a_type_arr2)) {
                                ...
                                <div class="col_md_45 col-sm-6 padding-4">
                                    ...
                                    <div class="col-md-9 col-sm-6  no-padding">
                                        <select data-validation="required"
                                                class="form-control inputclass  input_style_2"
                                                onchange="
                         $('#band_tbro3_td2').html($('#bnd_type2 option:selected').text());     "
                        ...
                        <div id="ValuesDiv4">
                            ...
                            <?php if (!empty($result->fe2a_type4) && !empty($result->bnd_type4)) { ?>
                                ...
                                <div class="col_md_45 col-sm-6 padding-4">
                                    ...
                                    <div class="col-md-9 col-sm-6  no-padding">
                                        <select data-validation="required" onchange="GetBandType2(this.value,'4')"
                                                class="form-control  input_style_2 inputclass" id="fe2a_type4"
                                                name="fe2a_type[]"
                                                aria-required="true">
                                            <option value="">إختر</option>
                                            <?php if (!empty($fe2a_type_arr2)) {
                                ...
                                <div class="col_md_45 col-sm-6 padding-4">
                                    ...
                                    <div class="col-md-9 col-sm-6  no-padding">
                                        <select data-validation="required"
                                                class="form-control  input_style_2 inputclass "
                                                onchange="
                         $('#band_tbro3_td2').html($('#bnd_type2 option:selected').text());     "
    ...
    <div class="col-xs-12 text-center">
        ...
        <button type="submit" onclick="get_diff_money()" class="btn btn-labeled btn-success" name="save"
                value="save"
                id="myBtn">
            <span class="btn-label"><i class="glyphicon glyphicon-floppy-disk"></i></span>حفظ
        </button>

        <button type="<?= $submitEdit ?>" onclick="get_diff_money()" class="btn btn-labeled btn-warning"
                ...
                <table class="table-bordered table  example">
                    ...
                    foreach ($all_data as $datum) { ?>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                        data-target="#detailsModal" onclick="load_page(<?= $datum->id ?>);">التفاصيل
                                </button>
                            ...
                            <td>
                                ...
                                <button type="button"
                                        ...
                                        name="select5" id="select5" class=" btn btn-sm btn-warning">التحويل للشؤون
                                    الماليه
                                </button>
                ...
                <div class="AttachTable">
                    <table class="table table-striped table-bordered fixed-table mytable "
                        ...
                        <?php if (!empty($one_data['attaches'])) {
                            ...
                            ?>
                            <?php $x = 1;
                            foreach ($one_data['attaches'] as $row_img) {
                                ...
                                <tr class="<?= $x ?>">
                                    ...
                                    <td>
                                        ...
                                        if (in_array($ext, $image)) {
                                            ?>
                                            <img id="img_view<?= $x ?>"
                                                 src="<?php echo base_url() . 'uploads/st/ezn_edafa/' . $row_img->file ?>"
                                            ...
                                            ?>
                                            <a target="_blank"
                                               href="<?= base_url() . "st/ezn_edafa/Ezn_edafa/read_file/" . $row_img->file ?>">
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo base_url() . 'st/ezn_edafa/Ezn_edafa/Delete_attach/' . $row_img->id ?>">
            ...
            <div class="modal-body" id="div_search">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-3  no-padding input_search_id" style="display:none; margin-left: 0;">
                        ...
                        <input id="input_search_id" name="name" value="" class="form-control  input_style_2 "
                               aria-required="true">
...
<script>
    ...
    function GetValues() {
        ...
        if ($('#myId').attr('data-click-state') < 4) {
            ...
            $("#ValuesDiv" + click_state).append(' <div class="form-group col-md-2 col-sm-6 padding-4">' +
                ' <label class="label"> الفئة </label>' +
            ...
            $("#ValuesDiv" + click_state).append('<div  class=" form-group col-md-1  padding-4" >' +
                '<input style="font-weight: 600 !important;margin-top: 21px" data-validation="required" type="text" step="any"' +
