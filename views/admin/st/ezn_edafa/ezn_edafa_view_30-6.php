...
<div class="col-xs-12  no-padding">
                        ...
                        <div class="form-group col-md-1 col-sm-6 padding-4">
                            ...
                            <div id="first_value" style="margin-top: 27px">
                                ...
                                <input style="font-weight: 600 !important;" type="text" step="any"
                                       name="value[]" id="value1" value="<?= $value_input ?>"
                        ...
                        <div class="form-group col-md-3 col-sm-6 padding-4">
                            ...
                            <div class="radio-content">
                                <input type="radio"
                                       ...
                                       $('#mostand_rkm').attr('data-validation','required');
                                            $('#geha_name').attr('data-validation','required'); "
                                       value="1" name="tsaeer"
 ...
 $('#mostand_rkm').attr('data-validation','');
                                            $('#geha_name').attr('data-validation','');
"
