    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
                ...
                <div id="moshtrat" <?php if ($type_ezn != 2) { ?> style="display: block;" <?php } else { ?> style="display: none;" <?php } ?>>
                    ...
                    <?php if (!isset($result)) { ?>
                        ...
                        <div class="form-group col-md-3 col-sm-6 padding-4">
                            ...
                            <div class="radio-content">
                                <input type="radio"
                                       data-validation="required"  onchange="" value="1" name="type_ezn" id="tsaeer1">
                                <label class="radio-label" for="tsaeer1">  فاتورة</label>
        
                            </div>
                            <div class="radio-content">
                                <input type="radio" data-validation="required"  onchange="" value="2" name="type_ezn" id="tsaeer2">
                ...
                <table id="table_anf" class="table-bordered table table-responsive tb-table">
                    ...
                    if ((isset($one_data['asnaf'])) && (!empty($one_data['asnaf'])) && ($one_data['asnaf'] != 0)) {
                        ...
                        <tr id="row_1">
                            ...
                            <td><input type="text" name="sanf_one_price[]" class="form-control testButton "
                            ...
                            <td><input type="text" name="lot[]" class="form-control testButton " id="lot1"
                                       value=""/></td>
                            <td><input readonly type="text" name="rased_hali[]"
                                       class="form-control testButton "
            ...
            <div class="col-xs-12 text-center">
                ...
                <button type="<?= $submitSave ?>" onclick="get_diff_money()" class="btn btn-labeled btn-success"
                        name="save"
                        value="save"
                        id="myBtn">
                    ...
                    foreach ($all_data as $datum) { ?>
                        <tr>
                            ...
                            <td> <?= $datum->person_jwal ?></td>
                                ...
                                <td>
                            <?php if ($datum->type_ezn == 1){ ?>
                                    <a type="button" class="btn btn-primary btn-xs" data-toggle="modal" style="padding: 1px 5px;"
                            ...
                            <?php } else{ ?>
                                ...
                                <a type="button" class="btn btn-primary btn-xs" data-toggle="modal" style="padding: 1px 5px;"
                                        data-target="#detailsModal" onclick="load_page(<?= $datum->id ?>);"><i class="fa fa-list"></i>
                                </a>
                            ...
                            <a onclick='swal({
                                ...
                                <button type="button"
                                        ...
                                        name="select5" id="select5" class=" btn  btn-warning btn-labeled"><span class="btn-label" style="padding: 1px 6px;"><i class="fa fa-share"></i></span>التحويل للشؤون
                                    الماليه
                                </button>
...
<script>
    ...
    function add_row_sanfe() {
        ...
        var row = ' <tr id="row_1" >\n' +
            '                        <td>' + (len + 1) + '</td>\n' +
            '                        <td> <input type="text" class="form-control testButton " name="sanf_code[]" id="sanf_code' + (len + 1) + '" value=""  ondblclick="$(\'#myModal\').modal(\'show\'); GetDiv_sanfe(\'myDiv_sanfe\',' + (len + 1) + ')" readonly/></td>\n' +
