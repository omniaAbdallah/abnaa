            ...
            <div class="piece-body">
                ...
                <div class="col-xs-12">
                    <table class="table table-bordered hl white-border" style="table-layout: fixed;">
                        <tbody>
                        <tr>
                            <td  style="width: 100px" class="rosasy-bg">المتبرع/الجهة</td>
                            <td><?= $get_all->person_name ?></td>
                            <td style="width: 80px" class="rosasy-bg">رقم الملف</td>
                            <td style="width: 80px"></td>
                            <td style="width: 80px" class="rosasy-bg">الجوال</td>
                            <td style="width: 80px"><?= $get_all->person_jwal ?></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <div class="col-xs-12 no-padding print-details-footer">
            <div class="col-xs-6">
                <p class=" text-center" style="margin-bottom: 0;">
                    <small>(اسم الموظف القائم بالإدخال أو الطباعة) / <?php echo $UserName?></small>
                </p>
