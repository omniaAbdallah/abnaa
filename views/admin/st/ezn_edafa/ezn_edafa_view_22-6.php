    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
                ...
                <table id="table_anf" class="table-bordered table table-responsive tb-table">
                    ...
                    if ((isset($one_data['asnaf'])) && (!empty($one_data['asnaf'])) && ($one_data['asnaf'] != 0)) {
                        ...
                        <tr id="row_1">
                            ...
                            <td><input type="text"  data-validation="required" name="sanf_name[]" class="form-control testButton "
                                       id="sanf_name1" value="" readonly/></td>
                            <td><input type="text"  data-validation="required" name="sanf_whda[]" class="form-control testButton "
                                       id="sanf_whda1" value="" readonly/></td>
                            <td><input type="text"  data-validation="required" name="sanf_rased[]" class="form-control testButton "
                            ...
                            <td><input type="text"  data-validation="required" name="sanf_one_price[]" class="form-control testButton "
                            ...
                            <td><input type="text"  data-validation="required" name="lot[]" class="form-control testButton " id="lot1"
                                       value=""/></td>
                            <td><input readonly type="text" name="rased_hali[]"
                                       class="form-control testButton "
            ...
            <div class="col-xs-12 text-center">
                ...
                <button type="<?= $submitSave ?>" class="btn btn-labeled btn-success"
                        name="save"
                        value="save"
                        id="myBtn" onclick="get_diff_money();CheckValue();">
                    <span class="btn-label"><i class="glyphicon glyphicon-floppy-disk"></i></span>حفظ
                </button>

                <button type="<?= $submitEdit ?>"  class="btn btn-labeled btn-warning"
                        style="background-color: #FFB61E;border-color:#FFB61E"
                        onclick="get_diff_money();CheckValue();"
...
<script>
    ...
    function add_row_sanfe() {
        ...
        var row = ' <tr id="row_1" >\n' +
            ...
            '                        <td> <input type="text"  data-validation="required" class="form-control testButton " name="sanf_amount[]" onkeyup="get_diff_money()" oninput="get_total(this,' + (len + 1) + ')" id="sanf_amount' + (len + 1) + '" value="" /></td>\n' +
