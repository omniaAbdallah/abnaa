...
<script>
    ...
    function check_val(valu)
    {
        ...
        $('.result_search_modal').html('   <tr >\n' +
            ...
            '\n' +
            '                    </tr>');
        if(valu ==='ezn_rkm' || valu ==='storage_fk' ||valu ==='person_name'||valu ==='person_jwal' || valu ==='geha_name' || valu ==='geha_name')
        {
...
<script>
    ...
    function searchResults()
    {
        ...
        $.ajax({
            ...
            data: {select_search_id1:select_search_id1,select_search_id2:select_search_id2,array_search_id:array_search_id,input_search_id:input_search_id },
