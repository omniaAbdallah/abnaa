                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                                  ...
                                  $arrxx = array(1 => '>', 2 => '<', 3=>'=');
                                    if (!empty($arrxx)):
                                        ...
                                        foreach ($arrxx as $keyy=>$value):
                                            ?>
                                            <option
                                                value="<?php echo $keyy; ?>" <?php if ($keyy ==$department_id_fk) {
                                                echo 'selected';
                            ...
                            <div class="form-group col-sm-3 col-xs-12">
                                ...
                                <input type="color" name="goal" value="<?php if(isset($record)) echo $record['goal'] ?>" class="form-control" autofocus data-validation="required">
                            </div>
                                    ...
                                    if (isset($all[$key]) && !empty($all[$key]) && $all[$key] !=null){
                                       ...
                                       //     print_r($value);
                                            ...
                                            <tr>
                                                ...
                                                echo $arrxx[$value->department_id_fk];?></td>
                                                <td style="background-color:<?=$value->goal?>"></td>
                                                <td>
