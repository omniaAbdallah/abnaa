...
<div class="col-sm-12 no-padding ">
    ...
    height: 59px;" id="pln_wasf"><?php echo $pln_wasf;?></textarea>
                        </div>
                    </div>  
                    <div class="col-md-12 col-sm-12 col-xs-12 inner-side r-data">
                            <div class="col-sm-2">
    ...
    height: 59px;
    " 
                            name="pln_roya" id="pln_roya"><?php echo $pln_roya;?></textarea>
                            </div>
                    </div>  
                    <div class="col-md-12 col-sm-12 col-xs-12 inner-side r-data">
                            <div class="col-sm-2">
    ...
    height: 59px;"
                             name="pln_resala" id="pln_resala"><?php echo $pln_resala;?></textarea>
                            </div>
                    </div>  
                    <div class="col-md-12 col-sm-12 col-xs-12 inner-side r-data">
                            <div class="col-sm-2">
                            ...
                            style="margin: 0px 0px 0px -1.21528px;
    height: 59px;"
                             name="pln_qiam" id="pln_qiam"><?php echo $pln_qiam;?></textarea>
                            </div>
                    </div>  
                    <div class="col-md-12 col-sm-12 col-xs-12 inner-side r-data">
                            <div class="col-sm-2">
                                    <label class="">  تاريخ البداية </label>
                            </div>
                            <div class="col-xs-10 r-input">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 inner-side r-data">
                            <div class="col-sm-2">
                                    <label class="">  تاريخ النهاية </label>
                            </div>
                            <div class="col-xs-10 r-input">
                ...
                foreach ($all_Emps as $key) {
                    ...
                    ?>
                    <option value="<?php echo $key->employee;?>-<?php echo $key->emp_code;?>" <?= $select ?>> <?php echo $key->employee; ?></option>
                <?php }
                } ?>
                </select>
                            </div>
