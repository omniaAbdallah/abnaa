        ...
        <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
            ...
            <div class="panel-body">
                <div class="col-md-12 col-sm-12 col-xs-12 padding-4">            <?php //$id =;
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 inner-side r-data">
                        <div class="col-sm-4">
                            <label class=" ">فتره القياس</label>
                            </div>
                            <div class="col-xs-8 r-input">
                            <select name="ftra_qyas" id="ftra_qyas" data-validation="required"
                                    class="form-control">
                                <option value="">إختر</option>
                                <?php
                                $arr = array(3 => 'ربع سنوي', 2 => 'نصف سنوي', 1 => '  سنوي');
                                foreach ($arr as $key => $value) {
                                    $select = '';
                                    if(isset($details['ftra_qyas'])&&!empty($details['ftra_qyas'])&&$details['ftra_qyas']==$key)
                                    {
                                        $select = 'selected';
                                    }
                                     ?>
