...
<div class="col-sm-12 no-padding ">
    ...
    <div class="panel-heading">
        ...
        <div class="panel-body">
           ...
           <?php echo form_open_multipart('gwd/strategy/Strategy/add_wants', array('id' => 'MyForm_program'));?>
    <?php
    if(!empty($record)){
        $id = $record->id;
        ...
        echo "<input type='hidden' name='strategy_id_fk' class='form-control bottom-input' id='strategy_id_fk' value='".$strategy_id_fk."'  >";  
    ...
    //    $program_name= '';
     ...
     echo "<input type='hidden' name='strategy_id_fk' class='form-control bottom-input' id='strategy_id_fk' value='".$get_all->id."'  >";
     $all_wanted_values ='';
        $part1 = '';
    $part2='';
    $part3='';
...
<input type="button" id="buttons"  class="btn btn-success" style="display: inline-block;padding: 6px 12px;"
                        onclick="checkTotal();" <?php if(!empty($record)&&($record->total !=0)&&($record->total !='')){
echo "disabled";
                        }?>
    ...
    <script>
        function save_data() {
           // checkTotal();
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo base_url() ?>gwd/strategy/Strategy/add_wants',
