      ...
      function createTreeView($array) {
          ...
          foreach ($array as $row){
              if(sizeof($row->sub) > 0 ){
                   subLevels($row->sub,$row->page_title,$row->page_icon_code,$row->page_id);
              }else{
      ...
      function subLevels($array,$page_title ,$page_icon_code,$id)
      {
          echo '<li class="treeview" >
                   <a href=""  onclick="get_sub_pages('.$id.')">
                          <i class="'.$page_icon_code.'"></i>
                          
                          <span class="menu_title"  onclick="get_sub_pages('.$id.')">' . $page_title . ' </span>
      									<span class="pull-right-container">
