...
<?php if(isset($this->groups_top_menu) && $this->groups_top_menu!=null && !empty($this->groups_top_menu)){?>
                    ...
                    /* if($this->uri->segment(2) == "sub_sub_main" ){
                     ...
                     if($check_url_two == $row->page_link || $check_url_three == $row->page_link){
                        $actived='class="active"';
                          ...
                          if($this->router->fetch_method() == $method && $this->router->fetch_class()== '' ){
