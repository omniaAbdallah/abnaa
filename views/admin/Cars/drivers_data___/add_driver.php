...
if(isset($driver)&&!empty($driver)){
    ...
    $licence_type_fk='';
    $blood_fasila='';
    $action=base_url().'Cars/drivers/Driver';
}
?>
                ...
                <form action="<?php echo $action;?>" method="post">
                    <div class="col-md-12 ">
                        <div class=" form-group col-md-3 padding-4">
                            <label class="label top-label">مراكز التكلفه </label>
...
<script>
    ...
    function get_emps()
    {
      var valu= $('#edara_id_fk').val();
        ...
        $.ajax({
            type:'post',
            url:"<?php echo base_url();?>Cars/drivers/Driver/get_emps",
            data:{valu:valu},
            success:function(d) {
...
<script>
    function get_side_bar(valu)
    {
        $.ajax({
            type:'post',
            url:"<?php echo base_url();?>Cars/drivers/Driver/get_emp_siebar",
            data:{valu:valu},
            success:function(d) {
