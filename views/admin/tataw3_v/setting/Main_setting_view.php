                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            ...
                            if(isset($record) && !empty($record) && $record!=null){
                                echo form_open_multipart('tataw3/setting/Main_setting/UpdateSetting/'.$id.'/'. $key);
                            }
                            else{
                                echo form_open_multipart('tataw3/setting/Main_setting/AddSetting/'.$key);
                            }
                            ?>
                                    ...
                                    if (isset($all[$key]) && !empty($all[$key]) && $all[$key] !=null){
                                        foreach ($all[$key] as $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?=$value->title?></td>
                                                <td style="width: 30%">
                                                <span class="form-control" style="background: <?=$value->color?>;">
                                                </span>
                                                </td>

                                                <td>
                                                    <a href="<?php echo base_url().'tataw3/setting/Main_setting/UpdateSetting/'.$value->id."/".$key  ?>" title="تعديل">
                                                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
                                                    <span> </span>
                                                    <a href="<?=base_url()."tataw3/setting/Main_setting/DeleteSetting/".$value->id."/".$key?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
