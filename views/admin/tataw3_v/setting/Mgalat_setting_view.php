<div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
    ...
    <div class="panel-body">
        <div class="col-xs-12 col-sm-12 col-md-12 m-b-20">
            ...
            <ul class="nav nav-tabs">
                <li class="active" onclick="get_data_table(1)"><a href="#Mgalat" data-toggle="tab">المجالات </a></li>
                <li onclick="get_data_table(2)"><a href="#activety" data-toggle="tab">الأنشطة</a></li>
            </ul>
            <!-- Tab panels -->
            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="Mgalat">
                    <div class=" col-md-12 col-sm-12  col-xs-12 Mgalat_form ">
                        <?php echo form_open(base_url() . 'tataw3/setting/Mgalat_setting', array('id' => 'Mgalat_form')) ?>
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group col-sm-4 col-xs-12 padding-4">
                                <label class="label "> الإسم المجال :</label>
    ...
    margin-left: 323px;">
                                <label class="label">هل يوجد انشطة؟</label>
                                <div class="radio-content">
                                    <input type="radio" id="esnad1" name="has_active" checked value="1">
                                    <label for="esnad1" class="radio-label"> نعم</label>
                                </div>
                                <div class="radio-content">
                                    <input type="radio" id="esnad2" name="has_active" value="2">
                                    <label for="esnad2" class="radio-label"> لا</label>
                                </div>
                            </div>
                ...
                <div class="tab-pane fade " id="activety">
                    <div class=" col-md-12 col-sm-12  col-xs-12 active_form">
                        <?php echo form_open(base_url() . 'tataw3/setting/Mgalat_setting', array('id' => 'active_form')) ?>
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="form-group col-sm-4 col-xs-12 padding-4">
                                <label class="label "> الإسم النشاط :</label>
...
<script>
    ...
    function get_select_data() {
        ...
        $.ajax({
            type: 'get',
            url: '<?php echo base_url() ?>tataw3/setting/Mgalat_setting/get_select_data',
            data: {},
            cache: false,
    ...
    function get_data_table(type) {
        ...
        $.ajax({
            type: 'get',
            url: '<?php echo base_url() ?>tataw3/setting/Mgalat_setting/get_data_table/' + type,
            data: {},
            cache: false,
            beforeSend: function () {
...
<script>
    function save_form(select_div) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>tataw3/setting/Mgalat_setting',
...
<script>
    function delete_data_form(id, type) {
        $.ajax({
            type: 'get',
            url: '<?php echo base_url() ?>tataw3/setting/Mgalat_setting/delete_data/' + id,
            data: {},
            cache: false,
            beforeSend: function () {
                swal({
    ...
    function set_data_form(id, type) {
        $.ajax({
            type: 'get',
            url: '<?php echo base_url() ?>tataw3/setting/Mgalat_setting/set_data_form/' + id,
            data: {},
            cache: false,
            beforeSend: function () {
                swal({
