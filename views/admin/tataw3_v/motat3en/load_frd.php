	    ...
	    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
			...
			<div class="panel-body">
				<div class="form-group col-sm-12 col-xs-12">
                    ...
                    <input type="number" name="talb_num" readonly value="<?php if(isset($volunteer)&&!empty($volunteer['talb_num'])) {echo $volunteer['talb_num']; }else{ echo  $talb_num;} ?>" placeholder="رقم الطلب" class="form-control " data-validation="required" >
				    ...
				    <div class="form-group col-sm-2 col-xs-12 padding-4">
				      	...
				      	<input type="text" maxlength="10" name="id_card" value="<?php if(isset($volunteer)) echo $volunteer['id_card'] ?>" placeholder=" السجل المدني" class="form-control " data-validation="required" onkeyup="return checkUnique($(this).val())">
                ...
                <div class="form-group col-sm-12 col-xs-12">
                        ...
                        <label class=" label"> الجنسيه</label>
                            ...
                            <input type="text" class="form-control " id="nationality_name" name="nationality_name"
                                style="width: 77%;float: right;" readonly value="<?php if(isset($volunteer)) echo $volunteer['nationality_name']; ?>" />
                        ...
                        <label class=" label">الحالة الاجتماعية </label>
                            ...
                            <input type="text" class="form-control " id="social_status_name" name="social_status_name"
                                style="width: 77%;float: right;" readonly  value="<?php if(isset($volunteer)) echo $volunteer['social_status_name'];  ?>"/>
                    ...
                    <label class=" label">التخصص </label>
                        ...
                        <input type="text" id="specialize_name" name="specialize_name" class="form-control" style="width: 77%;float: right;" readonly value="<?php   if(isset($volunteer)) echo $volunteer['specialize_name'];  ?>" />
                ...
                <div class="form-group col-sm-2 padding-4 " style="">
                    ...
                    <select name="work_id_fk" class="form-control " id="work_id_fk" 
                        ...
                        <option value="<?php echo $key;?>" <?php if( isset($volunteer) && !empty($volunteer['work_id_fk'])){
                                            if($key==$volunteer['work_id_fk']){ echo 'selected'; }
                                        } ?>> <?php echo $value;?></option>
                        <?php
                                }
                                ?>
...
<label class=" label"> المهنة </label>
    ...
    <input type="text" class="form-control " id="job_name" name="job_name" style="width: 77%;float: right;" 
        readonly value="<?php if(isset($volunteer)) echo $volunteer['job_name'];?>" />
    <input type="hidden" name="job_fk" id="job_fk_input" value="<?php if(isset($volunteer)) echo $volunteer['job_fk']; ?>">
    <button class="btn btn-success" type="button" id="job_fk" onclick="$('#geha_input').hide(); $('#input_name').val('');
        ...
        <?php if(isset($volunteer) &&$volunteer['work_id_fk'] ==2){echo ' disabled="disabled"';} ?>><i
            class="fa fa-plus"></i></button>
...
<input type="text" name="job_place" <?php if(isset($volunteer) && $volunteer['work_id_fk'] ==2){echo ' disabled="disabled"';} ?>
    id="job_place" class="form-control " onchange="change_halet_kafel($(this).val())"
    value="<?php if(isset($volunteer)) echo $volunteer['job_place'];?>" data-validation-has-keyup-event="true">
