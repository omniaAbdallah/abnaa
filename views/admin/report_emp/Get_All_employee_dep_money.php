      ...
      -->
        ...
        <div class="details-resorce">
          ...
          <!-------------------- header -------------------------------------->
              ...
              <a class="hidden-print" href="<?php echo base_url('All_reports/All_employee_dep_money') ?>">
<button class=" btn btn-success  hidden-print"> رجوع للصفحة السابقة </button>
		...
		<div class="col-xs-12 r-head">
			<div class="col-xs-4" style="padding: 0;width: 35%;    display: inline-block;">
				...
				<h5 class="text-center"> <?php echo $dep_name; ?>  </h5>
			</div>
...
//	setTimeout(function () {location.replace("<?php echo base_url('All_reports/All_employee_dep_money')?>");}, 0);
</script>
