                ...
                <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        foreach ($all_vouchers as $voucher) {
                            if($x == 1){
                                $Link = '  
                                        <a href="'. base_url().'Storage/Client_vouchers/printClientVouchers/'.$voucher->id.'"><i class="fa fa-print"></i> </a>
...
<script type="text/javascript">
    function send(argument) {
        $('#adele').attr("href","<?=base_url().'Storage/Client_vouchers/deleteClients/'?>"+argument);
    }
</script>