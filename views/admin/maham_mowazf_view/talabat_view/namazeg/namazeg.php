    ...
    <div class="modal-dialog" role="document" style="width: 80%">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal_" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
...
-->
            ...
            <div class="modal-footer" style="display: inline-block;width: 100%">
                <button type="button" class="btn btn-danger" style="float: left;" data-dismiss="modal_">إغلاق</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    function printNamazeg(row_id) {
        var request = $.ajax({
            ...
            url: "<?=base_url() . 'maham_mowazf/talabat/namazegs/Namazeg/printNamazeg_2'?>",
            type: "POST",
            data: {row_id: row_id},
        });
