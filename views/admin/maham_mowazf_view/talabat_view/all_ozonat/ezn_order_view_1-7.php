            ...
            <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
                ...
                <div class="panel-body">
                    ...
                    if (isset($get_ezn) && !empty($get_ezn)) {
                        echo form_open_multipart('maham_mowazf/talabat/all_ozonat/Ezn_order/Upadte_ezn/' . $get_ezn->id);
                        ...
                        echo form_open_multipart('maham_mowazf/talabat/all_ozonat/Ezn_order');
                        $no3_ezn = '';
                        $emp_id_fk = '';
                        $ezn_date = date('Y-m-d');
                        $fatra_fk = '';
