        ...
        <div class="col-sm-12">
            <div class="col-sm-6">
                <div class="radio-content">
                    <input type="radio" name="suspend" id="radio_1" value="4" />
                    <label for="radio_1" class="radio-label" >قبول</label>
                </div>
            </div>
        </div>
        <div class="col-sm-12">
            <div class="col-sm-6">
                <div class="radio-content">
                    <input type="radio" name="suspend" id="radio_2" value="2" />
                    <label for="radio_2" class="radio-label" >رفض</label>
                </div>
            </div>
        </div>
