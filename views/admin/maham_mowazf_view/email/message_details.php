                    ...
                    <ul class="mailbox-attachments clearfix">
                        ...
                        <?php foreach ($files as $files) { ?>
                            ...
                            <li>
                                ...
                                <a href="<?= base_url() . "maham_mowazf/email/Emails/download_file/" . $files->email_rkm . '/' . $files->file ?>"
...
<script>
    ...
    function get_emps(email_rkm) {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url();?>maham_mowazf/email/Requestes/get_emps/" + email_rkm,
...
<script>
    ...
    function add_emps_email() {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url();?>maham_mowazf/email/Requestes/add_emps_email",
        ...
        if ((files != '')) {
            ...
            if (error == '') {
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url(); ?>maham_mowazf/email/Requestes/make_replay/",
...
<script>
    ...
    function archive_message(id, type) {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url()?>maham_mowazf/email/Requestes/archive_message',
...
<script>
    ...
    function get_email_morfq(email_rkm) {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url();?>maham_mowazf/email/Requestes/get_email_morfqat/" + email_rkm,
...
<script>
    ...
    function print_email(row_id) {
        ...
        var request = $.ajax({
            ...
            url: "<?=base_url() . 'maham_mowazf/email/Requestes/print_email'?>",
