    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body " style="background-color: #fff;">
            ...
            <?php
                ...
                echo form_open_multipart('maham_mowazf/email/Emails/add_email',array('id'=>'email_form'));
        ...
        if ((title != '') && (to_user_fk != '') && (to_user_fk_name != '') && (content != '') && (important_degree != '') && (need_replay != '') ) {
            ...
            // if (error == '') {
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url(); ?>maham_mowazf/email/Emails/add_email_ajax", //base_url() return http://localhost/tutorial/codeigniter/
                    ...
                    success: function (data) {
                        ...
                        if (page_load == 0) {
                            ...
                            window.location = "<?php echo base_url() ?>maham_mowazf/email/Emails/inbox/2";
