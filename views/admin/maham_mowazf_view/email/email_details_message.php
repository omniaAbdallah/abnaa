<div class="col-xs-12 col-sm-12 col-md-12 no-padding inbox-mail">
	 ...
	 if(isset($my_email)&&!empty($my_email)){
		...
		<a href="<?=base_url()."maham_mowazf/email/Emails/message_details/". $row->id?>" class="inbox_item <?= $unread?>">
    ...
    ">
								...
								<a href="<?=base_url()."maham_mowazf/email/Emails/reply_message/".$row->id?>" class="btn btn-default" style="margin-top: 61px;"   <i class="fa fa-reply">الرد </i></a>

                                <a href="<?=base_url()."maham_mowazf/email/Emails/forward_message/".$row->id?>" class="btn btn-default" style="margin-top: 61px;"   <i class="fa fa-share" >المشاركه </i></a>
