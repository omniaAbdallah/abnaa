        ...
        <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
            ...
            <table id="example" class=" display table table-bordered   responsive nowrap" cellspacing="0" width="100%">
             ...
             <div class="dropdown pull-left padding-4">
                            <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">طباعه النماذج
...
<li><a onclick="funnamozg_khasm(<?php echo $row->t_rkm; ?>)" title="طباعه"><i
     class="fa fa-print"></i>نموذج الخصم من الراتب</a></li>
                   ...
                   <div class="dropdown pull-right">
                            <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">إجراءات
                            <span class="caret"></span></button>
                <ul class="dropdown-menu">
  ...
  -->
                            ...
                            عذرا لا يمكنك التعديل والحذف
                                ...
                                <?php } ?>
                                 ...
                                 <a class="btn btn-sm btn-primary "  href="<?php echo base_url();?>/human_resources/employee_forms/solaf/Solaf/add_picture/<?php echo $row->id;?>">
