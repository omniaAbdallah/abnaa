                                        ...
                                        <div class="sidebar-shortcuts" id="sidebar-shortcuts">
                                            <div class="sidebar-shortcuts-large"
                                                ...
                                                <button class="btn btn-default"
                                                        style="background-color: #0088b1;color: #fff;"
                                                        title="اللوائح" data-toggle="tab" href="#job_data"
                                                        role="tab" aria-controls="job_data">
                                                    <i class="ace-icon fa fa-clipboard  faa-vertical animated"></i>
                                                    اللوائح
                                                </button>
                                                <button class="btn btn-default"
                                                        style="background-color: #da9300;color: #fff;"
                                                        title="السياسات" data-toggle="tab"
                                                        href="#contract_data" role="tab"
                                                        aria-controls="contract_data">
                                                    <i class="ace-icon fa fa-book faa-shake animated"></i>
                                                    السياسات
                                                </button>
                                                <button class="btn btn-default"
                                                        style="background-color: #E5343D;color: #fff;"
                                                        title=" الهيكل التنظيمى" data-toggle="tab"
                                                        href="#Finance_data" role="tab"
                                                        aria-controls="Finance_data">
                                                    <i class="ace-icon fa fa-sitemap faa-passing animated"></i>
                                                    الهيكل التنظيمى
                                                </button>
                                                <button class="btn btn-default"
                                                        style="background-color: #50ab20;color: #fff;"
                                                        title="   المهام الوظيفية" data-toggle="tab"
                                                        href="#work_data" role="tab"
                                                        aria-controls="work_data">
                                                    <i class="ace-icon fa fa-cogs  faa-burst animated"></i>
                                                    المهام الوظيفية
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="tab-content tab-content-vertical">
                                            <div class="tab-pane active" id="job_data" role="tabpanel">
                                                <div class="col-md-12">
                                                    <div id="regulationsContainer">
                                                        <?php if (isset($sysa) && !empty($sysa)) {
                                                            foreach ($sysa as $record) { ?>
                                            ...
                                            <div class="tab-pane " id="contract_data" role="tabpanel">
                                                <div class="col-md-12">
                                                    <div id="regulationsContainer">
                                                        <?php if (isset($system) && !empty($system)) {
                                                                    ...
                                                                    <div class="rules-reg-card regulations">
                                                                        <a class="rule-clickable-part">
                                                                            <p><span class="icon"><img
                                                                                        src="<?= base_url() ?>asisst/gam3ia_omomia_asset/img/requlations-icon.png"
                                                                                        alt="">
                                  </span><?= $record->title ?></p></a>
                                                                        <div class="row">
                                                                            <div class="col-sm-7">
                                            ...
                                            <div class="tab-pane" id="work_data" role="tabpanel">
                                                <div class="col-md-12 text-center"
                                                    ...
                                                    <?php if (isset($mahma_wazefya) && !empty($mahma_wazefya)) {
                                                        ...
                                                        <div class="col-md-3 ">
                                                            <div class="syst">
                                                                <p><i class="fa fa-file-pdf-o"
                                                                      style="color: #B1090A;font-size: 26px;"></i> <?php echo $mahma_wazefya[0]->title ?>
                                                                </p>
                                                                <!-- <a class="download" href="pdf/1.pdf" download=""><i class="fa fa-download"></i> تحميل  </a> -->
                                                                <a class="download"
                                                                   href="<?= base_url() . "maham_mowazf/basic_data/Maham/downloads_maham/" . $mahma_wazefya[0]->file ?>"
