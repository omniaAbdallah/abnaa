            ...
            <div class="col-sm-12 col-xs-12">
                        <table class="table  table-striped table-bordered dt-responsive nowrap">
                            ...
                            <tr>
                                ...
                                <td>
                                  <span class="label" style="background-color: #32e26b"> <?php if($employee_data != null){ echo $employee_data['emp_code'];  }else{}?></span>
                               </td>
                               <th>إسم الموظف </th>
                                <td><?php if($employee_data != null){ echo $employee_data['employee'];  }else{}?></td>

                                   <th>إسم جهاز البصمة </th>
                                <td> <?php
                        foreach($printer_machine as $machine){
                         
                            if ($machine->id_setting == $result['device_id_fk']) {
                               echo $machine->title_setting;
                            } ?>
                        ...
                        ?> </td>
                                       ...
                                       <th> رقم الموظف بجهاز البصمة</th>
                                <td>  <?php  if($result['num_in_device'] != 0){ echo $result['num_in_device'];}?> </td>
                            </tr>
