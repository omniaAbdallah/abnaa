...
if (isset($allData) && $allData != null) {
    echo form_open_multipart('maham_mowazf/basic_data/Maham/update_custody' );
} else {
    echo form_open_multipart('maham_mowazf/basic_data/Maham/custody' );
}
?>
<?php 
...
<div class="col-sm-12 col-md-12 col-xs-12 no-padding">
    <div class="panel panel-default">
        ...
        <div class="col-sm-12 col-xs-12">
            ...
            <div class="col-xs-12 no-padding">
                <?php if (isset($all_Data_tansfered) && $all_Data_tansfered != null) { ?>
                    <table class="display table table-bordered responsive nowrap tb_table" cellspacing="0" width="100%">
