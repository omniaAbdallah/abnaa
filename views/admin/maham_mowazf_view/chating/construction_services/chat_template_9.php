...
<div class="col-xs-12 no-padding">
    ...
    font-weight: 600;">
                                ...
                                <img src="https://abnaa-sa.org/asisst/admin_asset/img/avatar5.png" alt=""
                                     title="" id="Reciverpic" style="border-radius: 50%;height: 50px;width: 50px;margin-top: -70px;"/>
                    ...
                    <div class="col-md-4" style="overflow-y: scroll; height: 500px;">
                        ...
                        <div class="box-body no-padding" id="result">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li class="active"><a href="#details" onclick="get_chats()" data-toggle="tab">الدردشات</a></li>
                                <li><a href="#morfqat" data-toggle="tab" onclick="get_online()">الموظفين المتصلين </a></li>
