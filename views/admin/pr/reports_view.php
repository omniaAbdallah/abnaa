    ...
    <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            ...
            if(isset($get_report) && $get_report!=null){
                $form = form_open_multipart("admin/pr/Reports/Update/".$get_report->id);
            } else{
                $form =form_open_multipart("admin/pr/Reports/add_reports");
            }
            ?>
            <?php echo  $form;
            ?>
        ...
        <div class="panel-body">
            ...
            <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><?= $item->year?></td>
                    <td>
                        <a target="_blank" href="<?=base_url()."admin/pr/Reports/read_file/".$item->file?>">
                            <i class="fa fa-eye" title=" قراءة"></i> </a>
                    </td>
                    <td>
                        <a href="<?=base_url()."admin/pr/Reports/Delete/".$item->id?>"  onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
                            <i class="fa fa-trash" aria-hidden="true" title="حذف"></i> </a>
                        <a href="<?=base_url()."admin/pr/Reports/Update/".$item->id?>" title="تعديل" >
