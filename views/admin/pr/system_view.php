<div class="col-xs-12">
    <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        <div class="panel-heading">
            <h3 class="panel-title"> إدارة الأنظمة و اللوائح</h3>
        </div>
        <div class="panel-body">
            <?php
            if(isset($get_report) && $get_report!=null){
                $form = form_open_multipart("admin/pr/Systems/Update/".$get_report->id);
            } else{
                $form =form_open_multipart("admin/pr/Systems/add_reports");
            }
            ?>
            <?php echo  $form;
            ?>
            ...
            <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                ...
                foreach ($system as $item){
                    ...
                    <tr>
                        ...
                        <td>
                            <a target="_blank"  href="<?=base_url()."admin/pr/Systems/read_file/".$item->file?>">
                                <i class="fa fa-eye" title=" قراءة"></i> </a>
                        </td>
                        <td>
                            <a href="<?=base_url()."admin/pr/Systems/Delete/".$item->id?>"  onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
                                <i class="fa fa-trash" aria-hidden="true" title="حذف"></i> </a>
                            <a href="<?=base_url()."admin/pr/Systems/Update/".$item->id?>" title="تعديل" >
