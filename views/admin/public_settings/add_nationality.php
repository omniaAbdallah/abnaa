...
<div class="details-resorce col-xs-12 r-inner-details" >
    ...
    <?php echo form_open_multipart('Public_settings/update_nationality_settings/'.$result['id'])?>
    ...
    <?php echo form_close()?>
    <?php else: ?>
    <?php echo form_open_multipart('Public_settings/nationality_settings')?>
        ...
        <?php foreach($records as $record):?>
            <tr>
                ...
                <td data-title="التحكم" class="text-center">
                    <a href="<?php echo base_url().'Public_settings/update_nationality_settings/'.$record->id?>">
                        <i class="fa fa-pencil " aria-hidden="true"></i></a>
                    <a href="<?php echo base_url().'Public_settings/delete_nationality_settings/'.$record->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
