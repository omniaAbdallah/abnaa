 ...
 <div class="panel-heading">
    <ul class="nav nav-tabs">
        <li><a href="<?php echo  base_url()."admin/About_association/main_ways_donate";?>">  المقطع  الرئيسى </a></li>
        <li class="active"><a href="<?php echo  base_url()."admin/About_association/ways_donate";?>">طرق التبرع </a></li>
...
<!-------------------------------------------------------------------------------------------------------------------------->
 <?php if(isset($result) && $result!=null):?>  
  <?php echo form_open_multipart('admin/About_association/update_ways_donate/'.$result["id"]); 
    ...
    <?php else:?>
      <?php echo form_open_multipart('admin/About_association/ways_donate');
         $out['content']="";
...
<?php if(isset($record) && $record!=null):?>  
    ...
    <tr>
            ...
            <!-- <td>  </td> -->
             <td> <a href="<?php echo base_url().'admin/About_association/update_ways_donate/'.$row->id?>">
                      <i class="fa fa-pencil " aria-hidden="true"></i></a> 
                  <a href="<?php echo base_url().'admin/About_association/delete_about/ways_donate/'.$row->id?>">
