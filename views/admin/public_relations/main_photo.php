...
<div class="col-sm-12  wow" >
    <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            ...
            <?php    echo form_open_multipart('public_relation/main_photo/'.$id.'')?>
            <div class="col-xs-12">
...
<td>
<a href="'.base_url().'public_relation/main_photo/'.$record->id.'"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>

<a  href="'.base_url().'public_relation/delete_main_photo/'.$record->id.'" onclick="return confirm(\'هل انت متأكد من عملية الحذف ؟\');"><i class="fa fa-trash" aria-hidden="true"></i> </a>
</td>
</tr>';
                        }
                        ?>
