                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12 col-sm-12 col-xs-12 inner-side r-data">
                            ...
                            <div class="col-xs-3 r-input">
                                <input type="text" value="<?php if(isset($result)) echo $result['program_name'] ?>" class="r-inner-h4 " name="program_name" id="program_name" required>
                            </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 inner-side r-data">
                            ...
                            <div class="col-xs-3 r-input ">
				                <div class="docs-datepicker">
								    <div class="input-group">
								        <input type="date" value="<?php if(isset($result)) echo date("Y-m-d",$result['program_from']) ?>" class="form-control" id="program_from" name="program_from" placeholder="شهر / يوم / سنة " required>
								    </div>
								</div>
				            </div>
                            ...
                            <div class="col-xs-3 r-input ">
				                <div class="docs-datepicker">
								    <div class="input-group">
								        <input type="date" value="<?php if(isset($result)) echo date("Y-m-d",$result['program_to']) ?>" class="form-control" id="program_to" name="program_to" placeholder="شهر / يوم / سنة " required>
								    </div>
								</div>
				            </div>
                            ...
                            <div class="col-xs-3 r-input">
                                <input type="file" class="r-inner-h4 " name="icon" id="icon" <?php echo $require ?> >
                            </div>
                            <?php if ($result['icon'] != '' && $result['icon'] != null && !empty($result['icon'])) {
                            ?>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">الصورة الرمزية</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <img src="<?php echo base_url('uploads/images/'.$result['icon'].''); ?>" height="400px" width="400px">
