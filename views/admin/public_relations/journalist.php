...
<div class="col-sm-12  wow" >
    ...
    <?php if(isset($result)):?>
        ...
        <?php echo form_open_multipart('Public_relation/update_journalist/'.$result['id'])?>
            ...
            <div class="col-xs-12">
                <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-6 r-input">
                                    <input type="text" class="form-control date_melady" value="<?php echo $result['date']; ?>" name="news_date" placeholder="شهر / يوم / سنة " data-validation="required">
                        </div>
                    </div>
                    <div class="col-xs-12">
                        <div class="col-xs-6">
                      ...
                      <thead>';
                        for($x = 0 ; $x < count($photo) ; $x++){
                            if(count($photo) > 1)
                            {
                               ...
                               <a  href="'.base_url().'Public_relation/delete_photo_/'.$result['id'].'/'.$x.'"  class="btn btn-danger btn-xs col-lg-12">
                ...
                <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-6 r-input" >
                            <textarea name="details" id="details"  class="form-control" data-validation="required"><?php echo $result['content']; ?></textarea>
                        </div>
                    </div>
                    <div class="col-xs-12">
                        <div class="col-xs-6">
                        ...
                        <div class="col-xs-6 r-input">
                                    <input type="text" class="r-inner-h4"  value="<?php echo $result['newspaper_name']; ?>" id="newspaper_name" name="newspaper_name" data-validation="required">
                        </div>
                    </div>
                    <div class="col-xs-12">
                        <div class="col-xs-6">
        ...
        <?php echo form_close()?>
    <?php else: ?>
        <?php echo form_open_multipart('Public_relation/add_journalist')?>
            ...
            <div class="col-xs-12">
                <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-6 r-input">
                                    <input type="text" class="form-control date_melady" name="news_date" placeholder="شهر / يوم / سنة " data-validation="required">
                        </div>
                    </div>
                    <div class="col-xs-12">
                        <div class="col-xs-6">
                        ...
                        <div class="col-xs-6 r-input">
                                    <input type="text" class="r-inner-h4" name="news_name" data-validation="required">
                        </div>
                    </div>
                    <div class="col-xs-12">
                        <div class="col-xs-6">
            ...
            <div id="optionearea1"></div>
                ...
                <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-6 r-input" >
                            <textarea name="details" id="details"  class="form-control" data-validation="required"></textarea>
                        </div>
                    </div>
                    <div class="col-xs-12">
                        <div class="col-xs-6">
                        ...
                        <div class="col-xs-6 r-input">
                                    <input type="text" class="r-inner-h4" id="newspaper_name" name="newspaper_name" data-validation="required" >
                        </div>
                    </div>
                    <div class="col-xs-12">
                        <div class="col-xs-6">
                        ...
                        <div class="col-xs-6 r-input">
                            <input type="file" id="logo" name="logo"  class="form-control text-right" data-validation="required" />
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 r-inner-btn">
        ...
        ?>
            <tr>
                ...
                <td data-title="التحكم" class="text-center">
                    ...
                    <i class="fa fa-search-plus" aria-hidden="true" data-target="#myModal<?php echo $record->id?>"></i>
              
                    <a href="<?php echo base_url().'Public_relation/update_journalist/'.$record->id?>">
                        <i class="fa fa-pencil " aria-hidden="true"></i></a>
                    <a href="<?php echo base_url().'Public_relation/delete_journalist/'.$record->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
                        <i class="fa fa-trash" aria-hidden="true"></i>
                </td>
                <td data-title="" class="text-center">
                    <a href="<?php echo base_url().'Public_relation/suspend_journalist/'.$record->id.'/'.$class?>" class="btn btn-<?php echo $class ?> btn-xs"><?php echo $title ?> </a>
                </td>
                <td ><?php echo
