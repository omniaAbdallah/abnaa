    ...
    <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            ...
            $aria='';
                ...
                <?php    echo form_open_multipart('public_relations/sub_fields/'.$id.'')?>
                 <div class="col-xs-12">
                    ...
                    <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                        ...
                        for($x = 0 ; $x < count($table) ; $x++){
                            ...
                            for($z = 0 ; $z < count($table[key($table)]) ; $z++){
                                ...
                                echo'<div class=" modal fade firstModal'.$table[key($table)][$z]->id.'" tabindex="-1" id="firstModal'.$table[key($table)][$z]->id.'" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" >
