...
<div class="col-xs-12">
    <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        <div class="panel-heading">
            <h3 class="panel-title"> تقرير الأخبار</h3>
        </div>
            ...
            <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                ...
                foreach ($display_publisher_data as $row){
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?=base_url()."Public_relation/DeletePublisher/".$row->id?>"  onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
                                <i class="fa fa-trash" aria-hidden="true" title="حذف"></i> </a>
                            <a href="<?=base_url()."Public_relation/UpdateNews/".$row->id?>" title="تعديل" >
