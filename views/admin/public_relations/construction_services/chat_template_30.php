...
<div class="content-wrapper" > 
  ...
  <section class="" style="margin-top: -57px !important; ">
     <div class="row">
...
<p style="width: 215px;margin-right: 80px;text-align: right;color: black;
font-weight: 600;" class="" href="#"><?=$v['user_name'];?></p>



<img src="<?=base_url('uploads/human_resources/emp_photo/thumbs/user.png')?>" alt="<?=$v['user_name'];?>"
