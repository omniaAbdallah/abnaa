...
<div class="col-xs-12 " >
    ...
    if(isset($get_images) && $get_images!=null){
        $form = form_open_multipart("public_relations/website/library/Photos_library/Update/".$get_images["id"]);
    } else{
        $form =form_open_multipart("public_relations/website/library/Photos_library/photos");
    }
    ?>
    <?php echo  $form;
?>
                        ...
                        foreach ($result as $row){
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo base_url().'public_relations/website/library/Photos_library/downloads_new/'.$row->img ?>" download>
                                        <i class="fa fa-download" title="تحميل"></i> </a>
                                    <a  data-toggle="modal" data-target="#myModal-view-<?=$row->id?>" >
                                        <i class="fa fa-eye" title=" قراءة"></i> </a>
                                    <a id="delete_img" href="<?php echo base_url().'public_relations/website/library/Photos_library/DeletePhoto/'.$row->id."/".$row->library_id_fk?>" >
            ...
            <div class="panel-body">
                ...
                <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?=base_url()."public_relations/website/library/Photos_library/Delete/".$img->id?>"  onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
                                <i class="fa fa-trash" aria-hidden="true" title="حذف"></i> </a>
                            <a href="<?=base_url()."public_relations/website/library/Photos_library/Update/".$img->id?>" title="تعديل" >
...
<script>
    function add_row_member(){
        ...
        $.ajax({
            type:'post',
            url: '<?php echo base_url() ?>public_relations/website/library/Photos_library/get_library_photo',
            data:dataString,
            dataType: 'html',
