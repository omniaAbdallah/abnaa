            ...
            <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                ...
                foreach ($display_publisher_data as $row){
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?=base_url()."public_relations/website/mobadra/Mobdra/DeletePublisher/".$row->id?>"  onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
                                <i class="fa fa-trash" aria-hidden="true" title="حذف"></i> </a>
                            <a href="<?=base_url()."public_relations/website/mobadra/Mobdra/UpdateNews/".$row->id?>" title="تعديل" >
