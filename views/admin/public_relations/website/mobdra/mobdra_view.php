...
<div class="col-xs-12 " >
    ...
    if(isset($get_publisher) && $get_publisher!=null){
        $form = form_open_multipart("public_relations/website/mobadra/Mobdra/UpdateNews/".$get_publisher["id"]);
    } else{
        $form =form_open_multipart("public_relations/website/mobadra/Mobdra/news");
    }
    ?>
    <?php echo  $form;
                            ...
                            foreach ($result as $row){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo base_url() . 'public_relations/website/mobadra/Mobdra/downloads_new/'.$row->img ?>" download>
                                    ...
                                    <td>
                                        <a id="delete_img" href="<?php echo base_url().'public_relations/website/mobadra/Mobdra/DeletePhoto/'.$row->id."/".$row->mobdra_id_fk?>" onclick="deleteImg('<?= $row->img_status?>')">
                        ...
                        <table class="table table-bordered"   id="videotable">
                            ...
                            foreach ($video as $video){ ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url().'public_relations/website/mobadra/Mobdra/DeleteVideo/'.$video->id."/".$video->mobdra_id_fk?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
                                            <i class="fa fa-trash" aria-hidden="true" title="حذف"></i> </a>
                                    </td>
...
<script>
    function add_row_member(){
        ...
        $.ajax({
            type:'post',
            url: '<?php echo base_url() ?>public_relations/website/mobadra/Mobdra/get_publisher_photo',
            data:dataString,
            dataType: 'html',
...
<script>
    function add_row_video(){
        ...
        $.ajax({
            type:'post',
            url: '<?php echo base_url() ?>public_relations/website/mobadra/Mobdra/get_publisher_video',
            data:dataString,
            dataType: 'html',
...
<script>
    ...
    function change_img(row_id,news_id_fk) {
        ...
        $.ajax({
            type:'post',
            url: '<?php echo base_url() ?>public_relations/website/mobadra/Mobdra/Updateimage',
            data:dataString,
            dataType: 'html',
