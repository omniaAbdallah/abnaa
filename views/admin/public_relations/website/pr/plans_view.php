    ...
    <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            ...
            if(isset($get_report) && $get_report!=null){
                $form = form_open_multipart("public_relations/website/pr/Plans/Update/".$get_report->id);
            } else{
                $form =form_open_multipart("public_relations/website/pr/Plans/add_reports");
            }
            ?>
            <?php echo  $form;
            ?>
              <div class="form-group col-md-4">
                ...
                <select  name="type"  data-validation="required" 
                            ...
                            <?php
                           // $arrx = array(1 => 'خطط استراتيجية', 2 => ' خطط تشغيلية');
                            $arrx = array(1 => ' خطط تشغيلية', 2 => ' خطط استراتيجية  ');
            ...
            <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                ...
                foreach ($plans as $item){
                    ...
                    <tr>
                        ...
                        <td><?= $item->year?></td>
                        <td>
                            <a target="_blank" href="<?=base_url()."public_relations/website/pr/Plans/read_file/".$item->file?>">
                                <i class="fa fa-eye" title=" قراءة"></i> </a>
                        </td>
                        <td>
                            <a href="<?=base_url()."public_relations/website/pr/Plans/Delete/".$item->id?>"  onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
                                <i class="fa fa-trash" aria-hidden="true" title="حذف"></i> </a>
                            <a href="<?=base_url()."public_relations/website/pr/Plans/Update/".$item->id?>" title="تعديل" >
