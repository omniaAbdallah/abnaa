<div class="col-xs-12">
    <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        <div class="panel-heading">
            <h3 class="panel-title"> اضافة عضوية</h3>
        </div>
        <div class="panel-body">
            <?php
            if(isset($get_member) && $get_member!=null){
                $form = form_open_multipart("public_relations/website/pr_membering/Membering/Update/".$get_member->id);
            } else{
                $form =form_open_multipart("public_relations/website/pr_membering/Membering/add_member");
            }
            ?>
            <?php echo  $form;
            ?>
        ...
        <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            ...
            foreach ($membring as $row){
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?=base_url()."public_relations/website/pr_membering/Membering/Delete/".$row->id?>"  onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
                            <i class="fa fa-trash" aria-hidden="true" title="حذف"></i> </a>
                        <a href="<?=base_url()."public_relations/website/pr_membering/Membering/Update/".$row->id?>">
