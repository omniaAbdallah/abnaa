                ...
                <div class="col-xs-12 r-inner-details">
                    ...
                    if(empty($table) && $table == null){
                        if(isset($result))
                            ...
                            $form = 'add_main_data';
                    echo form_open_multipart('public_relation/'.$form.'')?>
                    <div class="col-xs-12">
                            ...
                            <div class="col-xs-3 r-input ">
				                <div class="docs-datepicker">
								    <div class="input-group">
								        <input type="date" value="<?php if(isset($result)) echo $result['date_construct'] ?>" class="form-control" id="date_construct" name="date_construct" placeholder="شهر / يوم / سنة " required="required" />
								    </div>
								</div>
				            </div>
                        ...
                        <?php
                      //  print_r($result);
                       // print_r($result['fax_info']);
                        
                        
                        if(isset($result['fax_info'])){
                            ...
                            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <?php
                                    echo '<tr>
                                            <td>'.$table[0]->name.'</td>
                                            <td>
                                                <a href="'.base_url().'public_relation/update_main_data/'.$table[0]->id.'"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> تعديل</a>
                                            </td>
                                            <td>
