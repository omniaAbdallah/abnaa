...
<body>
    ...
    <div class="col-xs-12 " >
                ...
                if(isset($get_publisher) && $get_publisher!=null){
                    $form = form_open_multipart("Public_relation/UpdateNews/".$get_publisher["id"]);
                } else{
                    $form =form_open_multipart("Public_relation/news");
                }
                ?>
                <?php echo  $form;
...
?>
                    ...
                    <div class="col-md-8">
                        <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
                            <div class="panel-heading">
                                <h3 class="panel-title"> إدارة الأخبار</h3>
                            </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea  name="details" id="editor"
                                ...
                                <div class="col-md-12">
                                    ...
                                    >     ألبوم صور الخبر  <i class="fa fa-plus" aria-hidden="true"></i></button><br><br>
                                    <button type="button" class="btn btn-success btn-next add_attchments"
                                            ...
                                            foreach ($result as $row){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="<?php echo base_url() . 'Public_relation/downloads_new/'.$row->img ?>" download>
                                                            <i class="fa fa-download" title="تحميل"></i> </a>
                                                        <a  data-toggle="modal" data-target="#myModal-view-<?=$row->id?>" >
                                                            <i class="fa fa-eye" title=" قراءة"></i> </a>
                                                    </td>
                                                    <td>
                                                        <input type="radio" name="img_status" onchange="change_img(<?=$row->id?>,<?=$row->news_id_fk?>);" value="<?php echo $x-1;?>" <?php if($row->img_status==1){ echo 'checked';}?>>
                                                    </td>
                                                    <td>
                                                        <a id="delete_img" href="<?php echo base_url().'Public_relation/DeletePhoto/'.$row->id."/".$row->news_id_fk?>" onclick="deleteImg('<?= $row->img_status?>')">
                                        ...
                                        <table class="table table-bordered"   id="videotable">
                                            ...
                                            foreach ($video as $video){ ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url().'Public_relation/DeleteVideo/'.$video->id."/".$video->news_id_fk?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
                                                            <i class="fa fa-trash" aria-hidden="true" title="حذف"></i> </a>
                                                    </td>
                                ...
                                <div class="col-xs-12">
                                    <input  type="submit" id="button" name="ADD"  value="حفظ الخبر">
    ...
    <script>
        function add_row_member(){
          ...
          //  alert('show');
            ...
            $.ajax({
                type:'post',
                url: '<?php echo base_url() ?>Public_relation/get_publisher_photo',
                data:dataString,
                dataType: 'html',
    ...
    <script>
        function add_row_video(){
            ...
            $.ajax({
                type:'post',
                url: '<?php echo base_url() ?>Public_relation/get_publisher_video',
                data:dataString,
                dataType: 'html',
...
<script>
    ...
    function change_img(row_id,news_id_fk) {
     ...
     //   if(option != 1){
        ...
        $.ajax({
            type:'post',
            url: '<?php echo base_url() ?>Public_relation/Updateimage',
            data:dataString,
            dataType: 'html',
            ...
            success: function(html){
              ...
              // $("input[name='img_status']:not(:checked)").val('0');
     ...
     //   }
     //   else{
        //    $("input[name='img_status']:checked").val(0);
       // }
