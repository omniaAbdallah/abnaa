                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        if (isset($get_setting) && !empty($get_setting)) {
                                            ...
                                            echo form_open_multipart('public_relations/gam3ia_contact/Settings/UpdateSitting/' . $id . '/' . $key);
                                        } else {
                                            $title = '';
                                            $color = '';
                                            echo form_open_multipart('public_relations/gam3ia_contact/Settings/AddSitting/' . $key . '/' . $key);
                                        }
                                        ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#" onclick='swal({
                                                                    ...
                                                                    window.location="<?php echo base_url().'public_relations/gam3ia_contact/Settings/UpdateSitting/'.$value->id . "/" . $key ?>";
                                                                    });'>
                                                                ...
                                                                <a href="#" onclick='swal({
                                                                    ...
                                                                    window.location="<?= base_url()."public_relations/gam3ia_contact/Settings/DeleteSitting/" . $value->id . "/" . $key ?>";
                                                                    });'>
