...
<style type="text/css">
    ...
    .table-striped.table-colored>tbody>tr:nth-child(odd)>td,
    .table-striped.table-colored>tbody>tr:nth-child(odd)>th {
        background-color: #09704e;
        color: #fff;
    }
    .table-bordered.table-colored > tbody > tr > th,
    .table-bordered.table-colored > tbody > tr > td{
...
<div class="col-sm-12 no-padding " >
    <?php
    //if (isset($qst_data) && !empty($qst_data)){
     //   $aqr_n = $qst_data->aqr_n;
    //}
    ?>
    ...
    <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body" style="min-height: 485px;">
            <div class="col-sm-8 padding-4" >
                <div  class="statusMsg">
                    <?php
                    if (isset($get_all) && !empty($get_all->aqr_n)){
                        ?>
                       <h5 style=" background-color: #09704e; color: #fff;">  ايصال استلام لعقار : <span><?= $get_all->aqr_n?></span> </h5>
                        <?php
                    }
                    ?>
                </div>
...
"	 data-validation="required" aria-required="true">
                    ...
                    <div class="col_md_80 col-sm-6 padding-4">
                    ...
                    <div class="col_md_40 col-sm-6 padding-4">
                        ...
                        <!--list="pepople_arr"-->
                        <input type="text" name="person_name" id="person_name" class="form-control  list inputclass"
                                 value="<?php
                                 if( isset($get_all) && isset($get_all->mostager->aname) && !empty($get_all->mostager->aname)){
                                     echo $get_all->mostager->aname;
                                 }  else{
                                     echo $person_name;
                                 }
                                 ?>"     readonly  />
                    ...
                    <div class="col_md_20 col-sm-6 padding-4">
                        ...
                        <input type="text" step="any" name="person_mob" id="person_mob"
                               value="<?php
                               if (isset($get_all) && !empty($get_all->mostager->jwal)){
                                   echo $get_all->mostager->jwal;
                ...
                <div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
                    ...
                    <div  class="col_md_20 no-padding" id="first_value" style="margin-top: 27px;">
                ...
                <div class="col-md-12 no-padding" id="ValuesDiv">
                    ...
                    <?php if( !empty($result->fe2a_type2) &&  !empty($result->bnd_type2 )){ ?>
                        ...
                        <div  class="col_md_20   no-padding" ><input style="font-weight: 600 !important;"
...
-->
                ...
                <div class="col-md-12 no-padding ">
                    ...
                    <div class="col-md-8 col-sm-6 padding-4">
           ...
           <div class="col-sm-4 no-padding">
               <?php
            //   $this->load->view('admin/aqr_view/contracts/load_qst_details');
               ...
               <table class="table table-striped table-bordered table-colored">
                   ...
                   <tr>
                       ...
                       <th ><strong>  اسم العقار</strong></th>
                   ...
                   <tr>
                       ...
                       <th ><strong> نوع الوحدة </strong></th>
                       <th><strong>  قيمة الايجار </strong></th>
                   </tr>
                   <tr>
                   ...
                   <tr>
                       ...
                       <th ><strong> بداية الايجار</strong></th>
                       <th ><strong>  نهاية الايجار</strong></th>
                   </tr>
                   <tr>
                   ...
                   <tr>
                       ...
                       <th ><strong>  عدد الأقساط</strong></th>
                   </tr>
                   <tr>
                   ...
                   <tr>
                       ...
                       <th ><strong> اسم المستأجر</strong></th>
                       <th ><strong>
                               التأمين </strong></th>
                   </tr>
                   <tr>
    ...
    /*    function searchResults()
        {
            ...
            $.ajax({
                ...
                data: {select_search_id:select_search_id,array_search_id:array_search_id,input_search_id:input_search_id },
    ...
    function GetDiv(div,valu) {
        ...
        if(valu ==1){
            /* html ='<div class="col-md-12"><table id="js_table_members" class="table table-striped table-bordered dt-responsive nowrap " >' +
               '<thead><tr><th style="width: 50px;">#</th><th style="width: 50px;"> ��� ������ </th><th style="width: 50px;"> ����� </th><th style="width: 170px;" >������</th><th style="width: 50px;" >��������</th><th style="width: 30px;" >����</th><th style="width: 30px;" >����</th><th style="width: 30px;" >������</th>' +
            ...
            /* html ='<div class="col-md-12"><table id="js_table_members" class="table table-striped table-bordered dt-responsive nowrap " >' +
                 '<thead><tr><th style="width: 50px;">#</th><th style="width: 50px;"> ����� </th><th style="width: 170px;" >������ </th><th style="width: 170px;" >������</th>' +
                 '</tr></thead><table><div id="dataMember"></div></div>';*/
            html ='<div class="col-md-12 no-padding"><table id="js_table_members" class="table table-striped table-bordered dt-responsive nowrap " >' +
            ...
            /*  html ='<div class="col-md-12"><table id="js_table_members" class="table table-striped table-bordered dt-responsive nowrap " >' +
                  '<thead><tr><th style="width: 50px;">#</th><th style="width: 50px;"> ��� ������� </th><th style="width: 50px;"> ����� </th><th style="width: 170px;" >������</th>' +
                  '</tr></thead><table><div id="dataMember"></div></div>';*/
            /*        html ='<div class="col-md-12 no-padding"><table id="js_table_members" class="table table-striped table-bordered dt-responsive nowrap " >' +
            ...
            $.ajax({
                ...
                success: function(json_data){
                    ...
                    if(type === 'getAccount'){
                        ...
                        $("#bank_account_code_"+ pay_type).html(html);
...
<script>
    ...
    function GetValues() {
        ...
        if($('#myId').attr('data-click-state')==1){
            ...
            $("#ValuesDiv").append('<div class="col_md_40 col-sm-6 padding-4"> <select  data-validation="required" onchange="GetBandType2(this.value)" class="form-control  input_style_2" id="fe2a_type2" name="fe2a_type2"  aria-required="true"><option value="">إختر  </option></select></div>');
            $("#ValuesDiv").append('<div class="col_md_40 col-sm-6 padding-4"> <select  data-validation="required" class="form-control  input_style_2"  ' +
            ...
            $("#ValuesDiv").append('<div  class="col_md_20   no-padding" ><input style="font-weight: 600 !important;" data-validation="required" type="text" step="any" name="value2" class="form-control  input_style_2 value band2_value"  onkeyup="CheckValue(`band1_value`,$(this).val());  $(\'#value2\').html($(this).val());" ></div>');
