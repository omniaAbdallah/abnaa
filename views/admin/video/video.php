...
?>
    ...
    <?php echo form_open_multipart('dashboard/update_video/'.$result['id'])?>
        ...
        <div class="col-xs-12">
            <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-6 r-input">
                                <input type="text" class="r-inner-h4" value="https://www.youtube.com/watch?v=<?php echo $result['vid']; ?>"  name="video_link" >
                    </div>
                </div>
            </div>
    ...
    <?php echo form_close()?>
    <?php else: ?>
    <?php echo form_open_multipart('dashboard/video')?>
        ...
        <div class="col-xs-12">
            <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-6 r-input">
                                <input type="text" class="r-inner-h4"  name="video_link" >
                    </div>
                </div>
            </div>
            <div class="col-xs-12 r-inner-btn">
        ...
        <?php foreach($records as $record):?>
            <tr>
                ...
                <td data-title="التحكم" class="text-center">
                    <a href="<?php echo base_url().'dashboard/update_video/'.$record->id?>">
                        <i class="fa fa-pencil " aria-hidden="true"></i></a>
                    <a href="<?php echo base_url().'dashboard/delete_video/'.$record->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
