...
<section class="print_forma">
		<div class="container-fluid">
			...
			<p class="lead">نفيدكم بأن / <?php echo $all_emp[$records['employees_id_fk']] ?>  سجل مدني رقـم (   <?=$records['national_num'] ?>  ) ,
             تعمل في جمعية بناء , بوظيفة  <?php echo $department_jobs[$employees['department']]; ?>          
			...
			<h5  class="text-center"><strong>مدير الجمعية</strong>  </h5>
