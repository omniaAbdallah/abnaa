...
<div class="col-xs-12">
    ...
    ?>
        ...
        <div class="details-resorce">
            <div class="col-xs-12 r-inner-details">
                <?php  echo form_open_multipart('Definitions/edit_definition_employee/'.$result[0]->id)?>
                        ...
                        <input type="text" class="form-control docs-date" value="<?php echo $result[0]->work_date;?>" name="work_date"  placeholder="شهر / يوم / سنة " data-validation="required" >
                        </div>
                        </div>
                        </div>
                        </div> 
            ...
            <input type="number" name="salary" value="<?php echo $result[0]->salary; ?>" step="any" class="form-control" data-validation="required"  />
            </div>
            </div>
            </div>
 ...
 <?php else: ?>
        <div class="details-resorce">
            <div class="col-xs-12 r-inner-details">
                <?php  echo form_open_multipart('Definitions/Definition_employee')?>
                ...
                <div class="col-xs-12 ">
                    <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                        <div class="col-xs-12 ">
                          ...
                          <div class="docs-datepicker">
                          <div class="input-group">
                            <input type="text" class="form-control docs-date" name="work_date"  placeholder="شهر / يوم / سنة " data-validation="required" >
                        </div>
                        </div>
                         </div>
                        </div> 
            ...
            <div class="col-xs-6 r-input" id="">
            <input type="number" name="salary" step="any" class="form-control" data-validation="required"  />
            </div>
            </div>
            </div>
                    ...
                    <div class="fade in active">
                        <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tr>
                                    ...
                                    <td>
                                    <button type="button" class="btn btn-sm btn-info " data-toggle="modal" data-target="#myModal<?=$record->id?>"><span class="glyphicon glyphicon-list"></span> تفاصيل الفاتورة</button>
                                    </td>
                                    <td>
                                     <a href="<?php echo base_url('Definitions/delete_definition_employee').'/'.$record->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');"> <i class="fa fa-trash" aria-hidden="true"></i> </a> <span> 
                                     </span> 
                                     <a href="<?php echo base_url('Definitions/edit_definition_employee').'/'.$record->id ?>" > <i class="fa fa-pencil" aria-hidden="true"></i> </a>
                                    </td>
                                    <td>
                                    <a href="<?php echo base_url('Definitions/printer_employee').'/'.$record->id ?>"> <i class="fa fa-print" aria-hidden="true"></i> </a>
                                    </td>
                            </tr>
                                <?php
                                $a++;
...
<script>
    function lood(num){
        if(num>0 && num != '')
        {
            ...
            $.ajax({
                type:'post',
                url: '<?php echo base_url() ?>/Definitions/Definition_employee',
                data:dataString,
                dataType: 'html',
                cache:false,
