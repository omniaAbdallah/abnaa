...
-->                              <td><a href="<?php echo base_url().'Finance_resource/edit_donors_guaranty/'.$record->id.'/view'?>"><i class="fa fa-search-plus" aria-hidden="true"></i></a></td>
                                        <td data-title="التحكم" class="text-center">
                                            ...
                                            <a href="<?php echo base_url().'Finance_resource/approve_employee_adver/'.$record->id?>" class="btn btn- btn-xs col-lg-5"><i class="fa fa-pencil"></i> قبول</a>

                                            <a  href="<?php echo base_url().'Finance_resource/refuse_employee_adver/'.$record->id?>" onclick="return confirm('هل انت متأكد من عملية الرفض ؟');" class="btn btn- btn-xs   col-lg-5"><i class="fa fa-trash"></i> رفض</a>
