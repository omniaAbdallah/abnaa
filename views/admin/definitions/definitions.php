            ...
            <?php echo form_open_multipart('dashboard/update_definitions_devides/'.$results['id'],array('class'=>"",'role'=>"form" ))?>
                    ...
                    <div class="col-xs-12 r-inner-details">
                        <div class="col-xs-12">
                            <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                                ...
                                <div class="col-xs-12">
                                    <div class="col-xs-6">
                                        <h4 class="r-h4">إسم الجهاز </h4>
                                    </div>
                                    <div class="col-xs-6 r-input">
                                        <input type="text" class="r-inner-h4 " name="title" value="<?php echo $results['title'] ?>" >
                                    </div>
                                </div>
            ...
            <?php echo form_open_multipart('dashboard/definitions_devides',array('class'=>"",'role'=>"form" ))?>
                                ...
                                <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">إسم الجهاز</th>
                                    ...
                                    foreach ($records as $record ):
                                        ...
                                        <tr>
                                            ...
                                            <td> <!-- <a href="<?php echo base_url('dashboard/delete_definitions_devides').'/'.$record->id ?>"> <i class="fa fa-trash" aria-hidden="true"></i> </a> <span> /
                                    </span> --> <a href="<?php echo base_url('dashboard/update_definitions_devides').'/'.$record->id ?>"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a></td>
