                                                                            ...
                                                                            <li>
                                                                                ...
                                                                                <?php if(isset($sub_row_4->sub)&& !empty($sub_row_4->sub)){
                                                                                               foreach($sub_row_4->sub as $sub_row_5){
                                                                                                   $sub_sub_checked_5="";  if(in_array($sub_row_5->page_id ,$user_per_in)) {
                                                                                                       $sub_sub_checked_5 = 'checked="checked"';
                                                                                                   }
                                                                                                   ?>
                                                                                                   <ul>
                                                                                                       <input type="checkbox"name="select-all[]" value="<?php echo $sub_row_5->page_id."-".$sub_row_5->level?>" <?php  echo  $sub_sub_checked_5?> >
                                                                                                       <label for="tall-2-1" class="custom-unchecked" ><?php echo  $sub_row_5->page_title?></label>
