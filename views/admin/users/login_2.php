...
-->
   ...
   <!-- <div class="btns-sidebar hidden-xs" dir="ltr">
        ...
        <ul>
            <li class="email">
                <a href="https://abna.sa:2096/webmaillogout.cgi" target="_blank">
                    <i class="fa fa-envelope-o"></i>
                    <span>الدخول إلى البريد الإلكتروني</span>
                </a>
            </li>    
          <!--   <li class="email">
                <a style="background: #04e0ea !important;" href="https://webmail1.hostinger.ae/?_task=mail&_mbox=INBOX" target="_blank">
                    <i class="fa fa-envelope-o"></i>
                    <span>أرشيف البريد الإلكتروني</span>
                </a>
            </li>  -->
        </ul>
    </div>
<div class="btns-sidebar1 hidden-xs" dir="ltr">
        <ul>
            <li class="email">
                <a style="background: #04e0ea !important;"  href="https://webmail1.hostinger.ae/?_task=mail&_mbox=INBOX" target="_blank">
                    <i class="fa fa-envelope-o"></i>
