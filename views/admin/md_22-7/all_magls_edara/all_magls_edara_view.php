            ...
            <div class="col-sm-9  no-padding">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="form-group col-md-3 col-xs-12 padding-4">
                        ...
                        <div id="cal-start-2">
                            <input id="start_data_h" name="ta3en_date_h" class="form-control  "
                                   ...
                                   style=" width: 50%;float: right"  data-validation="required" />
                    ...
                    <div class="form-group col-sm-3 padding-4">
                        ...
                        <input type="text" class="form-control " name="qrar_rkm" value="<?= $qrar_rkm ?>" data-validation="required"/>
                    </div>
                    ...
                    <div class="form-group col-sm-3 padding-4">
                        ...
                        <input type="file" class="form-control " name="qrar_mgls_morfaq"
                               onchange="set_img_magles(this);" value="<?= $qrar_mgls_morfaq ?>" data-validation="required" >
                    </div>
                </div>
