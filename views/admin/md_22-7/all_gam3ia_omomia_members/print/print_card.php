                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="card profile-card-3 center-block">
                        ...
                        <div class="profile-thumb-block">
                            <?php if(!empty($result->mem_img)){?>
                                <img src="<?php echo base_url();?>uploads/images/<?php echo$result->mem_img; ?>"alt="profile-image" class="profile" />
                            ...
                            <div class="col-xs-12 no-padding card-define">
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h4><?php if(!empty($result->name)){ echo $result->name ;  }else{  echo'غير محدد';} ?> </h4>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="border-left">
                                        ...
                                        <td>
                                            <h4> <?php if(!empty($result->odwiat->rkm_odwia_full)){ echo $result->odwiat->rkm_odwia_full ;  }else{  echo'غير محدد';} ?> </h4>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="border-left">
                                        ...
                                        <td>
                                            <h4><?php if(!empty($result->jwal)){ echo $result->jwal ;  }else{  echo'غير محدد';} ?> </h4>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="border-left">
                                        ...
                                        <td>
                                            <h4><?php if(!empty($result->card_num)){ echo $result->card_num ;  }else{  echo'غير محدد';} ?> </h4>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h4><?php if(!empty($result->odwiat->qrar_rkm)){ echo $result->odwiat->qrar_rkm ;  }else{  echo'غير محدد';} ?></h4>
