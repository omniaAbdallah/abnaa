                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="card profile-card-3 center-block">
                        ...
                        <div class="profile-thumb-block">
                            <?php if(!empty($personal_data->mem_img)){?>
                                <img src="<?php echo base_url();?>uploads/images/<?php echo$personal_data->mem_img; ?>"alt="profile-image" class="profile" />
                            ...
                            <div class="col-xs-12 no-padding card-define">
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h4><?php
                                                if(isset($get_odwiat) && !empty($get_odwiat)){ echo $get_odwiat->rkm_odwia ;  }
                                              else{  echo'غير محدد';} ?> </h4>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="border-left">
                                        ...
                                        <td>
                                            <h4><?php if(!empty($personal_data->jwal)){ echo $personal_data->jwal ;  }else{  echo'غير محدد';} ?> </h4>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="border-left">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h4><?php
                                                if(isset($get_odwiat) && !empty($get_odwiat)){ echo $get_odwiat->qrar_rkm ;  }
                                                else{  echo'غير محدد';}
                                            ?> </h4>
