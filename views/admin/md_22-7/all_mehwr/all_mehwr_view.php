        ...
        <div class="panel panel-bd lobidisable lobipanel  lobipanel-sortable ">
            ...
            <div class="panel-body">
                <?php if (!empty($last_galsa)) { ?>
                    <?php
$data_h=explode('/',$last_galsa->glsa_date_h);
$data_h=$data_h[2].'/'.$data_h[1].'/'.$data_h[0];
                    echo form_open_multipart(base_url() . 'md/all_mehwr/All_mehwr', array('id' => 'myform'));
                    ...
                    <div class="col-sm-12">
                        <table class="table table-bordered">
                            ...
                            <tr class="text-center">
                                <td><?= $last_galsa->mgls_code ?></td>
                                <td><?= $last_galsa->glsa_rkm ?></td>
                                <td><?php echo date('Y/m/d', strtotime($last_galsa->glsa_date_m)) . ' - ' . $data_h ?></td>
                                <td>
                ...
                <div class="col-xs-12">
                    <div class="panel-body">
                        <div class="fade in active">
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                foreach ($all_data as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo date('Y/m/d', strtotime($row->glsa_date_m)); ?></td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            if ($row->galsa_finish == 0) { ?>
                                                ...
                                                <button type="button" class="btn btn-success btn-xs"> إرسال المحاور
                                                    لرئيس المجلس
                                                </button>
                            ...
                            foreach ($all_data as $row) {
                                ?>
                                <div class="modal" id="firstModal<?php echo $row->glsa_rkm ?>" tabindex="-1"
                                     role="dialog"
                                     aria-labelledby="myModalLabel" data-wow-duration="0.5s">
                                    <div class="modal-dialog" role="document" style="width: 70%">
                                        <div class="modal-content">
