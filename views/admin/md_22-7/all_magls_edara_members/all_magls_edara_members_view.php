...
//                    7-3-om
                ...
                <div class="form-group col-sm-5 col-xs-12">
                    ...
                    <input style="width:86%; float: right;" type="text" name="mem_name" id="mem_name"
                           ...
                           value="<?= $mem_name ?>" data-validation-has-keyup-event="true" data-validation="required"/>
                ...
                <div class="form-group col-md-2 col-xs-12 padding-4" id="end_date_div_h"
                ...
                <div class="form-group col-md-2 col-xs-12 padding-4" id="end_date_div_m"
                     style="display: <?= $date_display ?>">
                ...
                <?php if (isset($one_data)) { ?>
                    <div class="form-group col-sm-12  ">
                        <div class="form-group col-sm-3 col-xs-12 padding-4">
                            ...
                            <label type="button" data-toggle="collapse"
                                   data-target="#collapseExample" aria-expanded="false"
                                   aria-controls="collapseExample">
                                <input type="checkbox" <?php if ($esteqala == 1) echo 'checked' ?> onclick="if(this.checked){
                                        document.getElementById('esteqala').value=1;
                                        document.getElementById('estqala_title').value=' مستقيل';
                                       var sel = document.getElementById('status_id');
                                       sel.selectedIndex = 2;
                                       get_status(sel);}else {
                                    document.getElementById('esteqala').value=0;
                                  document.getElementById('estqala_title').value='غير مستقيل';
                                       }">
                                استقالة
                            </label>
                            <input type="hidden" name="esteqala" id="esteqala" value="<?= $esteqala ?>">
                            <input type="hidden" name="estqala_title" id="estqala_title" value="<?= $estqala_title ?>">
                        </div>

                        <div class="collapse  <?php if ($esteqala == 1) echo 'in' ?>  " id="collapseExample">

                            <div class="form-group col-sm-5 col-xs-12 padding-4">
                                <label class="label"> السبب الاستقالة <strong></strong> </label>
                                <input type="text" class="form-control" value="<?= $estqala_reason ?>"
                                       name="estqala_reason"/>
                            </div>
                        ...
                        <div class="fade in active">
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                foreach ($all_data as $record) {
                                    $ta3en_date_h = explode('/', $record->ta3en_date_h);
                                    $ta3en_date_h = $ta3en_date_h[2] . '/' . $ta3en_date_h[1] . '/' . $ta3en_date_h[0];
                                    $end_date_h = explode('/', $record->end_date_h);
                                    $end_date_h = $end_date_h[2] . '/' . $end_date_h[1] . '/' . $end_date_h[0];
                                    ?>
                                    <tr>
                                        <td><?php echo $a ?> </td>
                                        ...
                                        . $record->end_date_m . ' م ' ?></td>
                                            -->
                                        <td onclick=" var arr_time=['<?= date('Y-m-d', strtotime($record->ta3en_date_m)) ?>','<?= $ta3en_date_h ?>'];
                                                change_time(this, arr_time)"><?= date('Y-m-d', strtotime($record->ta3en_date_m)) . ' م ' ?></td>
                                        <td onclick=" var arr_time=['<?= date('Y-m-d', strtotime($record->end_date_m)) ?>','<?= $end_date_h ?>'];
                                                change_time(this, arr_time)"><?= date('Y-m-d', strtotime($record->end_date_m)) . ' م ' ?></td>
                                        ...
                                        <td>
                                            <a class="btn btn-success" onclick='swal({
                                                    title: "هل انت متأكد من تقديم استقالة ؟",
                                                    text: "",
                                                    type: "warning",
                                                    showCancelButton: true,
                                                    confirmButtonClass: "btn-warning",
                                                    confirmButtonText: "استقالة",
                                                    cancelButtonText: "إلغاء",
                                                    closeOnConfirm: false
                                                    },
                                                    function(){
