                ...
                <form action="<?php echo base_url(); ?>md/all_glasat/All_glasat" method="post">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group col-sm-3">
                            ...
                            <input type="text" class="form-control" data-validation="required" readonly name="mgls_code"
                                   value="
                                ...
                                <div id="demo" class="collapse">
                                    <table class="table table-bordered">
                                        ...
                                        foreach ($members as $row) {
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" data-validation="required" name="member_id[]"
                                                           value="<?= $row->mem_id_fk ?>"
                                                        <?php
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <?php if ((isset($open_galesa)) && (!empty($open_galesa)) && ($open_galesa > 0)) {
                                            ...
                                            $span = '<span  class="label-danger"> لا يمكن فتح جاسة جديدة لا هناك جلسة نشطة </span>';
                                            $disabled = 'disabled';
                                        } else {
                                            $span = '';
                                            $disabled = '';
                                        ...
                                        <button type="submit" <?= $disabled ?>
                                                class="btn btn-labeled btn-success " name="add" value="ADD"
            ...
            <div class="panel-body">
                ...
                <div class="col-md-12">
                    <?php if (isset($records) && !empty($records)) { ?>
                        <table id="example" class=" display table table-bordered   responsive nowrap" cellspacing="0"
                            ...
                            foreach ($records as $row) {
                                ...
                                $data_h=explode('/',$row->glsa_date_h);
                                $data_h=$data_h[2].'/'.$data_h[1].'/'.$data_h[0];
                                ?>
                                <tr>
                                    <td><?= $x ?></td>
                                    ...
                                    <td><?= $data_h . ' هـ ' .
                                        ...
                                        . date('Y/m/d',strtotime($row->glsa_date_m)). ' م '  ?></td>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-sm btn-add" data-toggle="modal"
                                                data-target="#myModal<?= $row->glsa_rkm ?>"><span
                                                    class="fa fa-list"></span> التفاصيل
                                        </button>
                                    </td>
                                    <td>
                                        <!-- 25-4-om -->
                                        ...
                                        if ($row->glsa_finshed == 0) {
                                            ...
                                            if ($row->gadwal_a3mal > 0) {
                                                $url = '';
                                                $text = 'لا يمكن الحذف لان يوجد محاور للجلسة';
                                            } else {
                                                $url = base_url() . "md/all_glasat/All_glasat/delete_galsa" . '/' . $row->glsa_rkm . '/' . $row->mgls_code;
                                                $text = 'هل انت متأكد من الحذف ؟';
                                            }
                                            ?>
                                            <a href="<?php echo base_url('md/all_glasat/All_glasat/update_galsa') . '/' . $row->glsa_rkm . '/' . $row->mgls_code ?>"
                                               title="تعديل"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                            </a>
                                            <a onclick="$('#adele').attr('href', '<?= $url ?>');
                                                    $('#text').text('<?= $text ?>')"
                    ...
                    <?php if (isset($records) && !empty($records)) {
                        foreach ($records as $row) { ?>
                            <!----------------------------------------------------------------->
                            <div class="modal" id="myModal<?= $row->glsa_rkm ?>" tabindex="-1" role="dialog"
