                ...
                -->
                        ...
                        <div class="col-sm-2">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td class="text-center"><?php if (isset($last_galsa_date)) echo date('Y/m/d',strtotime($last_galsa_date->glsa_date_m)); ?></td>
                                </tr>
                                <tr class="left-headtr">
                                ...
                                <tr>
                                    <td class="text-center"> <?php if (isset($last_galsa_date)) {$data_h=explode('/',$last_galsa_date->glsa_date_h);
                                            $data_h=$data_h[2].'/'.$data_h[1].'/'.$data_h[0]; echo $data_h;} ?></td>
                                </tr>
                                <tr class="left-headtr">
