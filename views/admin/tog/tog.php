...
<!-- Mirrored from crm.thememinister.com/crmAdmin/notification.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Jun 2017 08:06:26 GMT -->
<head>
      ...
      <!-- Start page Label Plugins 
         =====================================================================-->
      <!-- Notification Styles -->
      <link href="<?php echo base_url() ?>/asisst/admin_asset/ali/plugins/NotificationStyles/css/demo.css" rel="stylesheet" type="text/css"/>
      <link href="<?php echo base_url() ?>/asisst/admin_asset/ali/plugins/NotificationStyles/css/ns-default.css" rel="stylesheet" type="text/css"/>
      <link href="<?php echo base_url() ?>/asisst/admin_asset/ali/plugins/NotificationStyles/css/ns-style-growl.css" rel="stylesheet" type="text/css"/>
      <link href="<?php echo base_url() ?>/asisst/admin_asset/ali/plugins/NotificationStyles/css/ns-style-attached.css" rel="stylesheet" type="text/css"/>
      <link href="<?php echo base_url() ?>/asisst/admin_asset/ali/plugins/NotificationStyles/css/ns-style-bar.css" rel="stylesheet" type="text/css"/>
      <link href="<?php echo base_url() ?>/asisst/admin_asset/ali/plugins/NotificationStyles/css/ns-style-other.css" rel="stylesheet" type="text/css"/>
      <link href="<?php echo base_url() ?>/asisst/admin_asset/ali/plugins/sweetalert/sweetalert.css" rel="stylesheet" type="text/css"/>
      <link href="<?php echo base_url() ?>/asisst/admin_asset/ali/plugins/toastr/toastr.html" rel="stylesheet" type="text/css"/>
   ...
   <!--preloader-->
                                 ...
                                 <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                       <tr>
                                          ...
                                          <td><button id="scale" class="btn btn-violet btn-sm progress-button ">
                                       ...
                                       <tr>
                                          <td>Jelly</td>
                                          <td><button id="jelly" class="btn btn-info btn-sm progress-button ">
                                             <span class="">Run example</span>
                                             </button>
                                          </td>
                                       </tr>
                                       <tr>
                                          <td>Slide in</td>
                                          <td><button id="slideIn" class="btn btn-primary btn-sm progress-button ">
                                             <span class="">Run example</span>
                                             </button>
                                          </td>
                                       </tr>
                                       <tr>
                                          <td>Genie</td>
                                          <td><button id="genie" class="btn btn-purple btn-sm progress-button ">
                                             <span class="">Run example</span>
                                             </button>
                                          </td>
                                       </tr>
                                       <tr>
                                          <td>Flip</td>
                                          <td><button id="flip" class="btn btn-inverse btn-sm progress-button">
                                             <span class="">Run example</span>
                                             </button>
                                          </td>
                                       </tr>
                                       <tr>
                                          <td>Bouncy Flip</td>
                                          <td><button id="bouncyFlip" class="btn btn-default btn-sm progress-button ">
                                             <span class="">Run example</span>
                                             </button>
                                          </td>
                                       </tr>
                              ...
                              <div class="col-sm-6">
                                 <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                       <tr>
                                          <td>Slide On Top</td>
                                          <td><button id="slidetop" class="btn btn-black btn-sm progress-button">
                                             <span class="">Run example</span>
                                             </button>
                                          </td>
                                       </tr>
                                       <tr>
                                          ...
                                          <td><button id="exploader" class="btn btn-default btn-sm progress-button ">
                                             <span class="">Run example</span>
                                             </button>
                                          </td>
                                       </tr>
                                       <tr>
                                          <td>Corner Expand</td>
                                          <td><button id="cornerExpand" class="btn btn-success btn-sm progress-button ">
                                             <span class="">Run example</span>
                                             </button>
                                          </td>
                                       </tr>
                                       <tr>
                                          ...
                                          <td><button id="loadingcircle" class="btn btn-pink btn-sm progress-button ">
                                             <span class="">Run example</span>
                                             </button>
                                          </td>
                                       </tr>
                                       <tr>
                                          <td>Box Spinner</td>
                                          <td><button id="boxspinner" class="btn btn-warning btn-sm progress-button ">
                                             <span class="">Run example</span>
                                             </button>
                                          </td>
                                       </tr>
                                       <tr>
                                          <td>Thumb Slider</td>
                                          <td><button id="thumbslider" class="btn btn-danger btn-sm progress-button ">
                                             <span class="">Run example</span>
                                             </button>
                                          </td>
                                       </tr>
                           ...
                           <table class="table table-hover table-striped">
                              ...
                              <tbody>
                                 <tr>
                                    ...
                                    <td><button class="btn btn-primary btn-sm demo1 ">Run example</button></td>
                                 </tr>
                                 <tr>
                                    <td>A success message!</td>
                                    <td><button class="btn btn-success btn-sm demo2 ">Run example</button></td>
                                 </tr>
                                 <tr>
                                    <td>A warning message, with a function attached to the "Confirm"-button</td>
                                    <td><button class="btn btn-warning btn-sm demo3 ">Run example</button></td>
                                 </tr>
                                 <tr>
                                    <td>... and by passing a parameter, you can execute something else for "Cancel".</td>
                                    <td><button class="btn btn-danger btn-sm demo4 ">Run example</button></td>
                                 </tr>
                              </tbody>
                           </table>
                           <div>
      ...
      <!-- Start Page Lavel Plugins
         =====================================================================-->
      <!-- Notification js -->
      <script src="<?php echo base_url() ?>/asisst/admin_asset/ali/plugins/NotificationStyles/js/modernizr.custom.js" type="text/javascript"></script>
      <script src="<?php echo base_url() ?>/asisst/admin_asset/ali/plugins/NotificationStyles/js/classie.js" type="text/javascript"></script>
      <script src="<?php echo base_url() ?>/asisst/admin_asset/ali/plugins/NotificationStyles/js/notificationFx.js" type="text/javascript"></script>
      <script src="<?php echo base_url() ?>/asisst/admin_asset/ali/plugins/NotificationStyles/js/snap.svg-min.js" type="text/javascript"></script>
      <script src="<?php echo base_url() ?>/asisst/admin_asset/ali/plugins/sweetalert/sweetalert.min.js" type="text/javascript"></script>
      <script src="<?php echo base_url() ?>/asisst/admin_asset/ali/plugins/toastr/toastr.min.html" type="text/javascript"></script>
...
<!-- Mirrored from crm.thememinister.com/crmAdmin/notification.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Jun 2017 08:06:35 GMT -->
</html>
