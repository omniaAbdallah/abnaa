...
<tbody class="report-content">
  ...
  <section class="main-body">
	<div class="print_forma  col-xs-12 ">
		...
		<div class="piece-box" >
			<div class="piece-body hl">
				<div class="col-xs-12">
					<p>الحمد لله رب العالمين والصلاة والسلام على نبينا محمد وعلى أهله وصحبه أجمعين , أما بعد : </p>
					<p>
   ...
   <?php
    ...
    ?>
   الموافق <?php echo $row->glsa_date_m ?> 
...
<!--<img src="<?php echo base_url();?>/asisst/admin_asset/img/pills/raoom_paper_header.png" width="100%"   />-->
	<div class="col-xs-12 no-padding">
				...
				<h4 class="green-border  text-center"><span>محضر إجتماع الجمعية العمومية العادية لعام 2020م   </span></h4>
