        ...
        <div class="panel panel-bd lobidisable lobipanel  lobipanel-sortable ">
            ...
            <div class="panel-body">
                <?php if(!empty($result)){ ?>
                    ...
                    echo form_open_multipart(base_url().'md/all_mehwr_gam3ia_omomia/All_mehwr_gam3ia_omomia/update/'.$result->glsa_rkm.'/'.$result->id);
                    ...
                    <div class="col-sm-12">
                        <table class="table table-bordered">
                            ...
                            <tr class="text-center">
                                ...
                                <?php
                                $result->glsa_date_h = explode('/', $result->glsa_date_h)[2] . '/' . explode('/', $result->glsa_date_h)[1] . '/' . explode('/', $result->glsa_date_h)[0];?>

                                <td><?=$result->glsa_rkm?></td>
                                <td><?php echo date('Y/m/d',strtotime($result->glsa_date_m)).' '.'م'?>  <i class="fa fa-arrows-h" aria-hidden="true"></i><?php echo ' '. $result->glsa_date_h .' '.'هـ';?></td>
                                    ...
                                    <tr id="<?php echo$s;?>">
                                         ...
                                         <input type="file" name="mehwar_morfaq[]"   class="form-control" >
                                            ...
                                            if (!empty($row->mehwar_morfaq) || $row->mehwar_morfaq!= 0 ) {
                                                ...
                                                if (in_array($ext,$image)){
                                                    ...
                                                    ?>
                                                    <a target="_blank" href="<?=base_url()."md/all_mehwr_gam3ia_omomia/All_mehwr_gam3ia_omomia/read_file/".$row->mehwar_morfaq?>">
                                                        <i class="fa fa-eye" title=" قراءة"></i> </a>
                                                    <?php
                                                }
                                                ?>

                                                <a href="<?=base_url()."md/all_mehwr_gam3ia_omomia/All_mehwr_gam3ia_omomia/download_file/".$row->mehwar_morfaq?>" download>
                                        ...
                                        <td>
                                            ...
                                            <a onclick=' swal({
                                                    ...
                                                    setTimeout(function(){window.location="<?= base_url().'md/all_mehwr_gam3ia_omomia/All_mehwr_gam3ia_omomia/delete_row/'.$row->id.'/'.$row->glsa_rkm ?>";}, 500);
                                                    });'>
