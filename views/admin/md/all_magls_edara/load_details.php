<?php if (isset($one_data) && (!empty($one_data))) { ?>
    <div class="col-md-12 no-padding">
        <div class="col-md-10 padding-4">
            <?php $one_data->ta3en_date_m = explode('/', $one_data->ta3en_date_m)[2] . '/' . explode('/', $one_data->ta3en_date_m)[0] . '/' . explode('/', $one_data->ta3en_date_m)[1];
            $one_data->ta3en_date_h = explode('/', $one_data->ta3en_date_h)[2] . '/' . explode('/', $one_data->ta3en_date_h)[1] . '/' . explode('/', $one_data->ta3en_date_h)[0];
            $one_data->end_date_m = explode('/', $one_data->end_date_m)[2] . '/' . explode('/', $one_data->end_date_m)[0] . '/' . explode('/', $one_data->end_date_m)[1];
