                ...
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="form-group col-sm-12 col-xs-12">
                        ...
                        <textarea class="editor1" id="editor1" name="cont_header"
                            ...
                            وإشارة إلى قرار مجلس الإدارة رقم <?=$glsa_data->magls_rkm?>،
                            وتاريخ <?=$glsa_data->glsa_date_ar?>
                            بشأن انعقاد الجمعية العمومية العادية يتشرف الأستاذ / عبدالرحمن بن محمد البليهي ،
                            رئيس مجلس الإدارة بدعوة السادة الأعضاء المؤسسين والعاملين بالجمعية لحضور اجتماع الجمعية العمومية العادية الذي تقرر عقده بمشيئة الله في يوم
                             <?=$glsa_data->glsa_day?> <?=$glsa_data->glsa_date_ar?>،وذلك في تمام الساعة
                            <?=$glsa_data->glsa_time?>
                            ب<?=$makn_en3qd_glsa?>

                            .للنظر في جدول الأعمال التالي :-</textarea>
                        <!--<textarea class="editor1" id="editor1" name="cont_header"-->
                        <!--                                  rows="2">-->
