             ...
             <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
                ...
                <div class="panel-body " style="background-color: #fff;">
                    ...
                    <div class="form-group col-xs-2 padding-4">
                         ...
                         <input type="text" name="galsa_place" class="form-control" value="<?=$galsa_place ?>" />
                         </div>
                         <div class="form-group col-xs-2 padding-4">
                         <label class="label"> الوقت</label>
                         <input type="time" name="galsa_time" class="form-control" value="<?=$galsa_time ?>" />
                         </div>
...
<input type='hidden'  data-validation='required' id="n<?=$row->id?>" name='to_user_fk_name[]' value="<?=$row->mem_name ?>"/>
                      ...
                      <?php }}?> -->
                       ...
                       <div class="form-group col-xs-8 no-padding">
                         ...
                         <input class="form-control" placeholder="" type="text" value="<?=$details ?>" name="details"  data-validation="required"/>
                    ...
                    <input id="person_img" onchange="readURL(this);" name="img" style="padding: 0;"
                           ...
                           <?php if(isset($mymeeting->file)&&!empty($mymeeting->file)){
                               ?>
                                 <a target="_blank" href="<?=base_url()."md/web/Meetings_gam3ia_omomia/read_file/".$mymeeting->file?>">
            <i class="fa fa-eye" title=" قراءة"></i> </a>
            <a href="<?=base_url()."md/web/Meetings_gam3ia_omomia/download_file/".$mymeeting->file?>" download>
                        ...
                        $a = 1;
                            ...
                            foreach ($my_meeting as $record) {
                                ...
                                <tr>
                                    ...
                                    <a href="<?=base_url()."md/web/Meetings_gam3ia_omomia/download_file/".$record->file?>" download>
        <i class="fa fa-download " aria-hidden="true"></i> </a>
                                    
                                    </td>
                                    <td>
                                    <a target="_blank" href="<?=base_url()."md/web/Meetings_gam3ia_omomia/read_file/".$record->file?>">
            <i class="fa fa-eye" title=" قراءة"></i> </a>
