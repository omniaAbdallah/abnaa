...
<div class="btn-group">
    ...
    <ul class="dropdown-menu">
     ...
     <li><a href="<?php echo base_url(); ?>md/all_gam3ia_omomia_members/Gam3ia_omomia_members/add_morfaqt/<?php echo $result->id; ?>">إضافة مرفقات</a></li>
      <li><a href="<?php echo base_url(); ?>md/all_gam3ia_omomia_odwiat/Gam3ia_omomia_odwiat/add_last_odwiat_data/<?php echo $result->id; ?>">بيانات إشتراك اخر عضوية</a></li>
     <li><a href="<?php echo base_url(); ?>md/all_gam3ia_omomia_members/Gam3ia_omomia_members/add_account_data/<?php echo $result->id; ?>">بيانات الحساب</a></li>
