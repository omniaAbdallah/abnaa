...
<div>
    ...
    if ($result != '' && $result != null && !empty($result)) { ?>
        <div class="header col-xs-12 no-padding">
            ...
            <div class="col-xs-4 text-center">
                <img src="<?php echo base_url() ?>asisst/admin_asset/card/back_card.png" alt="profile-sample1"/>
            </div>
            <div class="col-xs-4 text-center">
                <p>المملكة العربية السعودية</p>
                <p>الجمعية الخيرية لرعاية الأيتام ببريدة - أبناء </p>
                            ...
                            <table class="table table-bordered table-devices">
                                ...
                                <tr>
                                    ...
                                    <td><?php if (!empty($result->daraga_3elmia_title)) {
                                            echo $result->daraga_3elmia_title;
                                        } else {
                                            echo 'غيرمحدد';
                                        } ?></td>
                                    ...
                                    <td><?php if (!empty($result->moahel_3elmi_title)) {
                                            echo $result->moahel_3elmi_title;
                                        } else {
                                            echo 'غيرمحدد';
                                        } ?></td>
                                </tr>
                                ...
                                <?php if (!empty($result->odwiat)) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if (!empty($result->odwiat->update_date_m)) {
                                                echo $result->odwiat->update_date_m;
                                            } else {
                                                echo 'غيرمحدد';
                                            } ?></td>
                                    ...
                                    <?php if ($result->odwiat->pay_method_fk == 6) { ?>
                                        <tr>
                                            ...
                                            <td><?php if (!empty($result->odwiat->bank_title)) {
                                                    echo $result->odwiat->bank_title;
                                                } else {
                                                    echo 'غيرمحدد';
                                                } ?></td>
                                            <th class="gray_background">رقم الحساب</th>
                                            <td><?php if (!empty($result->odwiat->rkm_hesab)) {
                                                    echo $result->odwiat->rkm_hesab;
                                                } else {
                                                    echo 'غيرمحدد';
                                                } ?></td>
                                        </tr>
