                        ...
                        <li id="row_<?= $z ?>" >
                            ...
                            if (in_array($ext, $img)) {
                                ...
                                <span class="mailbox-attachment-icon has-img" data-toggle="modal" data-target="#myModal-view-<?= $row->id ?>">
                                    <img
                                            src="<?php if (file_exists('uploads/md/all_glasat_gam3ia_omomia_attaches/'.$row->file)) {
                                                echo base_url() .'uploads/md/all_glasat_gam3ia_omomia_attaches/'.$row->file;
                                            } ?> " alt="Attachment">
                                </span>
                                            ...
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <img src="<?= base_url().'uploads/md/all_glasat_gam3ia_omomia_attaches/'.$row->file?>"
                                                             width="100%" alt="">
                                                    </div>
                                            ...
                                            <div class="modal fade" id="myModal-pdf-<?= $row->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <iframe src="<?php echo base_url() . 'md/all_glasat_gam3ia_omomia/all_glasat_gam3ia_omomia/read_file/' . $row->id ?>" style="width: 100%; height:  640px;" frameborder="0"> </iframe>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                                                إغلاق
