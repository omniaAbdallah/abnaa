                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <table class="table table-bordered table-striped table-mehwer"
                                                                    ...
                                                                    if ($row->mehwar_morfaq !== 0) {
                                                                        ...
                                                                        if (in_array($ext, $image)) {
                                                                            ...
                                                                            <a target="_blank" data-toggle="modal"
                                                                                    data-target="#myModal-doc-<?= $row->id ?>"
                                                                             >
                                                                                <i class="fa fa-eye" title=" قراءة"></i>عرض
                                                                                المرفق </a>

                                                                                <div class="modal fade"
                                                                             id="myModal-doc-<?= $row->id ?>"
                                                                             tabindex="-1"
                                                                             role="dialog"
                                                                            ...
                                                                            <div class="modal-dialog modal-lg"
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <iframe src="<?= base_url() . "md/all_mehwr_gam3ia_omomia/All_mehwr_gam3ia_omomia/read_file/" . $row->mehwar_morfaq ?>"
                                                                                         width="100%">
                                                                                             </iframe>
                                                                                    </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <input class="check_large" type="checkbox" id="gridCheck<?php echo $row->id; ?>" value="1"  
                                                                    ...
                                                                    <td style="width: 160px">المحور
                                                                        ...
                                                                        if ($row->mehwar_morfaq !== 0) {
                                                                            ...
                                                                            if (in_array($ext, $image)) {
                                                                                ...
                                                                                <a target="_blank" data-toggle="modal"
                                                                                    data-target="#myModal-docc-<?= $row->id ?>"
                                                                             >
                                                                                <i class="fa fa-eye" title=" قراءة"></i>عرض
                                                                                المرفق </a>

                                                                                <div class="modal fade"
                                                                             id="myModal-docc-<?= $row->id ?>"
                                                                             tabindex="-1"
                                                                             role="dialog"
                                                                             aria-labelledby="myModalLabel">
                                                                            <div class="modal-dialog modal-lg"
                            ...
                            <table class="table table-bordered">
                              ...
                              <?php if (isset($last_galsa_date->glsa_rkm_full)) echo $last_galsa_date->glsa_rkm_full; ?>
                                        ...
                                        <input type="hidden" id="glsa_rkm" name="glsa_rkm" readonly
                                               value="<?php if (isset($last_galsa_date)) echo $last_galsa_date->glsa_rkm; ?>"/></td>
                                </tr>
                                <tr class="left-headtr">
                                ...
                                <tr>
                                    <td class="text-center">
                                        <!-- <button class="btn btn-primary" onclick="startgalsa();">بدء الجلسه</button> -->
                                ...
                                foreach ($members as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="radio" <?php if ($row->hdoor_satus == 1) echo 'checked'; ?>
                                                   class="attend" name="<?php echo $row->mem_id_fk; ?>" value="1">حضر
                                            <input type="radio" <?php if ($row->hdoor_satus == 0) echo 'checked'; ?>
                                                   class="attend" name="<?php echo $row->mem_id_fk; ?>" value="0">لم
                                            يحضر
                                        </td>
                                    </tr>
                                <?php } ?>
...
<script>
    function qrar_mehwar(valu) {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>md/all_glasat_gam3ia_omomia/Start_galsa_gam3ia_omomia/update_qrar",
...
<script>
    function attend_member(valu) {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>md/all_glasat_gam3ia_omomia/Start_galsa_gam3ia_omomia/update_member_hdoor",
...
<script>
    function startgalsa() {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>md/all_glasat_gam3ia_omomia/Start_galsa_gam3ia_omomia/start_galsa_time",
...
<!-- <script>
    function end_galsa3() {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>md/all_glasat_gam3ia_omomia/Start_galsa_gam3ia_omomia/end_galsa",
            data: {glsa_rkm: glsa_rkm},
            success: function (d) {
                // $('#tim').text(d);
                alert(d);
            ...
            confirmButtonText: confirm
                ...
                if (result.value) {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            // window.location.href = "<?php echo base_url();?>md/all_glasat_gam3ia_omomia/All_glasat_gam3ia_omomia/print_mahdr/<?php
                            //     if ($last_galsa_date == 0) {
                            //         echo $last_galsa_num = '';
                            //     } elseif ($last_galsa_date != 0) {
                            //         echo $last_galsa_num =  $last_galsa_date->glsa_rkm; 
                            //     } ?>";
                              window.location.href = "<?php echo base_url();?>md/all_glasat_gam3ia_omomia/All_glasat_gam3ia_omomia/print_mahdr/"+glsa_rkm;
                        } else {
                            window.location.href = "<?php echo base_url();?>md/all_glasat_gam3ia_omomia/Start_galsa_gam3ia_omomia/add_galsat_mon24a/"+glsa_rkm;
                        }
                    });
...
<script>
    ...
    function update_opened(id) {
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>md/all_glasat_gam3ia_omomia/Start_galsa_gam3ia_omomia/change_status",
            data: {id: id},
