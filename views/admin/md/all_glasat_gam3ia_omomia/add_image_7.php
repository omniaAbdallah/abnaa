                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 padding-10" id="row_<?= $z ?>">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-footer" >
                                ...
                                <a href="<?php echo base_url() . 'md/all_glasat_gam3ia_omomia/all_glasat_gam3ia_omomia/download_file/' . $row->id.'/1' ?>"
                                   target="_blank">
                        ...
                        <li id="row_<?= $z ?>" >
                            ...
                            if (in_array($ext, $img)) {
                                ...
                                <span class="mailbox-attachment-icon has-img" data-toggle="modal" data-target="#myModal-view-<?= $row->id ?>">
                                        <img
                                                src="<?php if (file_exists('uploads/md/all_glasat_gam3ia_omomia_morfaq/'.$row->file)) {
                                                    echo base_url() .'uploads/md/all_glasat_gam3ia_omomia_morfaq/'.$row->file;
                                                } ?> " alt="Attachment">
                                    </span>
...
<script>
    ...
    function add_morfaq(glsa_id_fk,type) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>md/all_glasat_gam3ia_omomia/all_glasat_gam3ia_omomia/add_image/'.glsa_id_fk,
            data: form_data,
