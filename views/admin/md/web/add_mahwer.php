...
$mahwer_krar=$mehwar->mahwer_krar;
    ...
    echo form_open_multipart('md/web/Meetings_gam3ia_omomia/update_mehwar/'. $mehwar->id.'/'.$mehwar->galsa_id_fk);
}
else
{
...
<div class="col-md-12 no-padding">
    ...
    <a onclick='swal({
        ...
        function(){
        window.location="<?= base_url() . 'md/web/Meetings_gam3ia_omomia/update_mehwar/' . $record->id .'/'.$record->galsa_id_fk ?>";
        });'>
    ...
    <a onclick=' swal({
        ...
        setTimeout(function(){window.location="<?= base_url() . 'md/web/Meetings_gam3ia_omomia/delete_mehwar/'  . $record->id .'/'. $record->galsa_id_fk ?>";}, 500);
        });'>
