                    ...
                    Swal.fire({
                        ...
                        $.ajax({
                            ...
                            success: function (d) {
                                ...
                                if (result.value) {
                                    window.location.href = "<?php echo base_url();?>md/all_glasat/All_glasat/print_mahdr/" + glsa_rkm;
                                } else {
                                    window.location.href = "<?php echo base_url();?>md/all_glasat/Start_galsa/add_galsat_mon24a/" + glsa_rkm;
                                }
                            }
                        });
