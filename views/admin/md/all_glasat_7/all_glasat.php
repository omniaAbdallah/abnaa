                            ...
                            <table class="table table-bordered">
                              ...
                              //  $types = array( 1 => "رئيس مجلس الإدارة ", 2 => "نائب رئيس مجلس الإدارة ", 3 => "عضو");
                                ...
                                foreach ($members as $row) {
                                    ...
                                    <tr>
                                        <td>
                                            <input type="checkbox"  name="member_id[]"value="<?=$row->mem_id_fk?>"
                                                <?php
...
foreach ($records as $row){
    ...
    ?>
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-sm btn-add" data-toggle="modal" data-target="#myModal<?=$row->glsa_rkm?>"><span class="fa fa-list"></span> التفاصيل</button>
                    </td>
                    ...
                    <td>
                        ...
                        <!--<div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?= base_url()?>md/all_glasat/All_glasat/add_image/<?=$row->id ?>">
                                        مكتبة الصور </a></li>
                            </ul>
                        </div>-->
                ...
                محاور الجلسه </a></li>
                <li><a target="_blank" href="<?= base_url()?>md/all_glasat/Start_galsa/add_galsat_mon24a/<?= $row->glsa_rkm ?>">
                مناقشة الجلسة </a></li>
...
<!--<a onclick="$('#adele').attr('href', '<?=base_url()."md/all_glasat/all_glasat/".$row->glsa_rkm?>');" data-toggle="modal" 
data-target="#modal-delete" title="حذف"> <i class="fa fa-trash" aria-hidden="true"></i> </a>
-->
<a  href="<?php echo base_url().'md/all_glasat/All_glasat/delete_galsa/'.$row->id.'/'.$row->glsa_rkm?>"
