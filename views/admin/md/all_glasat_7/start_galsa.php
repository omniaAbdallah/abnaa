        ...
        <div class="panel-body">
            ...
            <tr>
               ...
               <!--
                ...
                -->
                <td>
                <input onfocus="$('.mehar<?php echo $row->id;?>').hide();" id="mehar<?php echo $row->id;?>" class="form-control"  />
</td>
            ...
            confirmButtonText: confirm
                ...
                if (result.value) {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            window.location.href = "<?php echo base_url();?>md/all_glasat/all_glasat/print_mahdr/<?php 
if($last_galsa == 0){ echo $last_galsa_num = ''; }elseif($last_galsa != 0){ echo $last_galsa_num = ($last_galsa-1); } ?>";
                        } else {
