    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            ...
            if ((isset($page_data)) && (!empty($page_data))) {
                echo form_open_multipart(base_url() . 'about_us/About_us/update_page_data/' . base64_encode($id));
                ...
                echo form_open_multipart(base_url() . 'about_us/About_us/insert_page_data');
            } ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a onclick="alert('هل انت متأكد من حذف ؟!!')"
                                       href="<?php echo base_url() . 'about_us/About_us/delete_pages_data/' . base64_encode($page_data->id) ?>">
                                        <i class="fa fa-trash"></i></a>
                                    <a href="<?php echo base_url() . 'about_us/About_us/update_page_data/' . base64_encode($page_data->id) ?>">
