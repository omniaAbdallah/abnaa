    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            ...
            if ((isset($page)) && (!empty($page))) {
                echo form_open_multipart(base_url() . 'about_us/About_us/update_page/' . base64_encode($id));
                ...
                $page_status = '';
                $have_sub = '';
                echo form_open_multipart(base_url() . 'about_us/About_us/insert_pages');
            } ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a onclick="alert('هل انت متأكد من حذف ؟!!')"
                                       href="<?php echo base_url() . 'about_us/About_us/delete_pages/' . base64_encode($page->id) ?>">
                                        <i class="fa fa-trash"></i></a>
                                    <a href="<?php echo base_url() . 'about_us/About_us/update_page/' . base64_encode($page->id) ?>">
