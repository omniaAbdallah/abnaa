                ...
                <?php if(!empty($result)){ ?>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group col-sm-3">
                            ...
                            <input type="text" class="form-control " value="<?=$result->mgls_code?>" readonly/>
                        </div>


                        <div class="form-group col-sm-3">
                            <label class="label">رقم الجلسة </label>
                            <input type="text" class="form-control "  readonly name="qrar_rkm" value="<?=$result->glsa_rkm?>"/>
                        </div>

                        <div class="form-group col-md-3 ">
                            <label class="label">تاريخ الجلسة</label>
                            <input  name="end_date_m" class="form-control"
                                    type="text"  readonly value="<?=$result->glsa_date_m?>"/>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        ...
                        <table class="table table-striped table-bordered table-result"  <?php if(empty($result_details)){ ?>style="display: none" <?php } ?>  id="mytable">
                            <thead>
                            <tr class="info">
                                <th>رقم المحور</th>
                                <th>عبارة عن</th>
                            ...
                            <?php if(!empty($result_details)){
                                ...
                                <tr id="<?php echo$s;?>">
                                    ...
                                    <td><textarea name="mehwar_title[]"  class="form-control"  cols="30" rows="2" style="width: 100%"><?php echo$row->mehwar_title;?></textarea></td>
                                    <td> <a onclick=' swal({
