    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            ...
            if ((isset($img_data)) && (!empty($img_data))) {
                echo form_open_multipart(base_url() . 'main_data/Slide/update/' . base64_encode($id));
                ...
                echo form_open_multipart(base_url() . 'main_data/Slide/insert');
                $name = '';
                $text1 = '';
                $text2 = '';
                $text3 = '';
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a onclick="alert('هل انت متأكد من حذف ؟!!')"
                                           href="<?php echo base_url() . 'main_data/Slide/delete/' . base64_encode($img->id) ?>">
                                            <i class="fa fa-trash"></i></a>
                                        <a href="<?php echo base_url() . 'main_data/Slide/update/' . base64_encode($img->id) ?>">
...
<script>
    ...
    function set_data_intopop(id) {
        ...
        console.log(' id : ' + id);
        var request = $.ajax({
            url: "<?php echo base_url() . '/main_data/Slide/select_data'?>",
            type: "POST",
            data: {id: id},
        });
