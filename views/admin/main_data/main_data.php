...
<div class="form-group col-md-4 col-sm-6">
        <label class=""> الرقم الرجالي:</label>
        <input type="text" class="form-control" value="<?php if(isset($result)) echo $result['men_num'] ?>" onkeypress="validate_number(event)" name="men_num" id="men_num" <?php if(isset($result)) echo ''; else echo'data-validation="required"' ?> >
    </div>
    <div class="form-group col-md-4 col-sm-6">
        <label class=""> الرقم النسائي:</label>
        <input type="text" class="form-control" value="<?php if(isset($result)) echo $result['woman_num'] ?>" onkeypress="validate_number(event)" name="woman_num" id="woman_num" <?php if(isset($result)) echo ''; else echo'data-validation="required"' ?> >
    </div>
