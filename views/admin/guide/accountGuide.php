...
<div class="col-sm-12 col-md-8 col-xs-12 fadeInUp wow" style="padding-right: 0;">
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
        ...
        $required2 = '';
        if($id != "") {
            echo form_open_multipart('guide/Guide/update/'.$id);
            /*if(isset($details)) {
                $disabled = 'disabled';
                if($details['have_branch'] == 2) {
                    $readonly = '';
                    $required = 'required';
                }
                if($details['level'] == 1) {
        ...
        ?>
            <div class="form-group col-sm-12 col-xs-12 no-padding">
                ...
                <div class="col-xs-12">
                    ...
                    <button type="submit" name="add_code" value="add_code" class="btn btn-purple w-md m-b-5"><span><i class="fa fa-floppy-o" aria-hidden="true"></i></span> حفظ</button>
                </div>
            </div>
        <?php echo form_close()?>
        </div>
        ...
        <div class="panel-body">
            <div class="form-group col-sm-12 col-xs-12"> 
                ...
                <ul id="tree3">
                    ...
                    <li>
                        <a href="<?=base_url()."guide/Guide/editAccount/".$record->id?>"><?=$record->name?></a>
                        <?php
                        if (isset($record->subs)) {
                            ...
                            if($record->level != 1) {
                        ?>
                        <!--a title="تعديل" href="<?=base_url()."guide/Guide/editAccount/".$record->id?>" style="margin: 0 26px 0 7px;"><i class="fa fa-pencil"></i></a-->
