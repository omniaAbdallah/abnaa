...
<div class="col-sm-12 no-padding " >
        ...
        <div class="piece-body">
            <div class="col-md-12 no-padding">
                <div class="form-group col-md-2  col-sm-6 padding-4">
                    ...
                    <select name="tabro3_type" id="tabro3_type" class="form-control "
                            aria-required="true" >
                ...
                <div class="form-group col-md-2  col-sm-6 padding-4">
                    ...
                    <label class="label ">    مبلغ التبرع </label>
                    <input type="text" name="value" id="k_value" data-validation="required"
                           onkeypress="validate_number(event);" value="<?php echo $value;?>" class="form-control ">
                </div>
                ...
                <div class="form-group col-md-2  col-sm-6 padding-4">
                    ...
                    <label class="label ">    حالة التبرع </label>
                ...
                <div class="form-group col-md-2  col-sm-6 padding-4">
                    <label class="label ">   إسم بنك المتبرع </label>
                    <select name="d_bank_id_fk" id="pay_bank_id_fk" class="form-control" <?php if($pay_method!=7)echo 'disabled';?>
                            aria-required="true" >
                        <option value="">إختر</option>
                        <?php if (!empty($banks)) {
            ...
            <div class="col-md-12 no-padding">
                ...
                <div class="form-group col-md-4  col-sm-6 padding-4">
                    ...
                    <label class="label ">   رقم حساب المتبرع </label>
                    <input type="text" value="<?php echo $d_bank_account;?> " name="d_bank_account" id="pay_bank_account_num" maxlength="24"
                           ...
                           class="form-control " <?php if($pay_method!=7)echo 'disabled';?> data-validation-has-keyup-event="true">
                ...
                <div class="form-group col-md-2  col-sm-6 padding-4">
                    ...
                    <input type="file" name="mostdem_img" id="mostdem_img" class="form-control " <?php if($pay_method!=7 || $pay_method==5)echo 'disabled';?>>
                </div>
                ...
                <div class="form-group col-md-2  col-sm-6 padding-4">
                    ...
                    <select name="gamia_account" id="gamia_account" <?php if($pay_method!=7)echo 'disabled';?>
                            class="form-control    "   onchange="GetAccounts(this.value)"
                            aria-required="true">
                        <option value="">إختر</option>
                        <?php
                        if(!empty($banks_accounts)) {
            ...
            <div class="col-md-12 no-padding">
                ...
                <div class="form-group col-md-2  col-sm-6 padding-4" style="display: <?php echo $disp;?>">
                    ...
                    <select name="gamia_bank_id_fk" id="gamia_bank_id_fk" class="form-control " <?php if($pay_method!=7)echo 'disabled';?>
                ...
                <div class="form-group col-md-4  col-sm-6 padding-4" style="display: <?php echo $disp;?>">
                    ...
                    <select name="gamia_bank_account_num" id="bank_account_num"   onkeyup="get_length($(this).val(),'hint');" class="form-control " <?php if($pay_method!=7)echo 'disabled';?>
                            aria-required="true" >
                        <option value="">إختر</option>
        ...
        <button type="submit" id="save" name="save" value="حفظ"
