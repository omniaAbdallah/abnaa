    ...
    <div class="col-sm-9 " >
        <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
            ...
            <div class="panel-body">
             ...
             <div class="form-group col-md-2 col-sm-6 padding-4">
                        <label class="label top-label">فئة المتبرع</label>
                    ...
                    <div class="form-group col-md-4 col-sm-6 padding-4">
                        <label class="label top-label">إسم المتبرع</label>
                    ...
                    <div class="form-group col-md-2 col-sm-6 padding-4">
                        ...
                        <select id="d_nationality_fk" data-validation="required" class="form-control bottom-input"
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group col-md-2 col-sm-6 padding-4">
                        ...
                        <select id="d_national_type"  class="form-control bottom-input"
                    ...
                    <div class="form-group col-md-2 col-sm-6 padding-4">
                        <label class="label top-label""> جوال المتبرع <span class="span-allow"> (10ارقام) </span></label>
                    ...
                    <div class="form-group col-md-2 col-sm-6 padding-4">
                        ...
                        <select id="wakala_type" name="wakala_type" onchange="checd_wakel_type($(this).val())"
                                class="form-control bottom-input"  aria-required="true">
                            <option <?php if($wakala_type ==1){echo 'selected';} ?>  value="1">نعم </option>
                            <option <?php if($wakala_type ==2){echo 'selected';} ?> value="2">لا </option>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group col-md-4 col-sm-6 padding-4">
                        <label class="label top-label">إسم الوكيل   </label>
                    ...
                    <div class="form-group col-md-2 col-sm-6 padding-4">
                        <label class="label top-label">صفته</label>
...
-->
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group col-md-2 col-sm-6 padding-4 ">
                        ...
                        <select id="hai_id_fk" name="d_hai" disabled="disabled"  class="form-control bottom-input">
                            <option value="">إختر</option>
                    ...
                    <div class="form-group col-md-3 col-sm-6 padding-4">
                        ...
                        <input type="text" name="d_addres" id="d_addres"
                               data-validation="required" value=" <?php echo $d_addres;?>"
                               class="form-control bottom-input">
                    </div>
                    <div class="form-group col-md-3 col-sm-6 padding-4">
                        <label class="label top-label">التخصص </label>
                        <select name="d_specialize_fk" class="form-control bottom-input" id="d_specialize_fk" data-validation="required">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group col-md-3 col-sm-6  padding-4">
                        ...
                        <input type="text" name="d_job_place"
                            <?php if($work_id_fk ==0){echo ' disabled="disabled"';} ?>
                               id="d_job_place" class="form-control bottom-input" onchange="change_halet_donor($(this).val())"
                    ...
                    <div class="form-group col-md-2 col-sm-6 padding-4">
                        ...
                        <select name="d_activity_fk" class="form-control bottom-input" id="d_activity_fk"
                                disabled="disabled">
                            <option value="">اختر</option>
                            <?php
  ...
  <div class="form-group col-md-3 col-sm-6 padding-4">
         ...
         <div class="form-group col-md-2 col-sm-6 padding-4">
                        ...
                        <input type="text" name="d_barid_box"  id="d_barid_box" class="form-control bottom-input"
                               value="<?php echo $d_barid_box;?>"  data-validation-has-keyup-event="true" >
                    </div>

                    <div class="form-group col-md-2 col-sm-6 padding-4">
                        <label class="label top-label">رمز بريدي</label>
                        <input type="text" name="d_bardid_code"  id="d_bardid_code"   onkeypress="validate_number(event)" class="form-control bottom-input"
                    ...
                    <div class="form-group col-md-2 col-sm-6 padding-4">
                        <label class="label top-label">حالة المتبرع</label>
                        <select id="halat_donor_id"  class="form-control bottom-input" onchange="change_halet_donor($(this).val())"
                    ...
                    <div class="form-group col-md-6 col-sm-6 padding-4">
                        ...
                        <input type="text" name="d_notes" class="form-control bottom-input"  value="<?=$d_notes?>" />
                    </div>
                    ...
                    <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
                        ...
                        if (isset($records) && !empty($records)) {
                            foreach ($records as $record) {
                                ...
                                <tr>
                                    <td><?php echo $a ?></td>
                                    <td><? echo $record->d_num; ?></td>
                                    <td><? echo $record->d_name; ?></td>
                                    <td><? echo $record->d_national_num; ?></td>
                                    <td><? echo $record->d_mob; ?></td>
