                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="card profile-card-3 center-block">
                        ...
                        <div class="card-content col-xs-12">
                            <h3 class="text-center"> كارت تعريف لمتبرع</h3>
                            <div class="col-xs-12 no-padding card-define">
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h4><?php if(!empty($result->d_name)){ echo $result->d_name ;  }else{  echo'غير محدد';} ?> </h4>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="border-left">
                                        ...
                                        <td>
                                        <h4><?php if(!empty($result->d_num)){ echo $result->d_num ;  }else{  echo'غير محدد';} ?> </h4>
                                        </td>
                                    </tr>
