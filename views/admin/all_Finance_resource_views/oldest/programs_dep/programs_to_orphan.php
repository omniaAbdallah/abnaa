<div class="col-xs-12 fadeInUp wow" >
  ...
  <div class="panel-body">
      ...
      ?>
        ...
        <?php  echo form_open_multipart('all_Finance_resource/OrphanProgram/UpdateProgramsToOrphan/'.$result['member_id']) ?>
      ...
      <?php else:?>
          ...
          echo form_open_multipart('all_Finance_resource/OrphanProgram/ProgramsToOrphan',$uderFileData) ?>
                        <div class="col-md-12 col-sm-12 col-xs-12 inner-side r-data">
                            <div class="col-xs-3">
        ...
        foreach($member as $row){
            ...
            <optgroup label="<?php echo $row->mother_name?>" data-max-options="2">
                <?php foreach($row->sub_mem as $one_member){
                    ...
                    ?>
                    <option value="<?php echo $one_member->id."-".$one_member->mother_national_num_fk?>"><?php echo $one_member->member_full_name?></option>
                <?php }?>
            </optgroup>
        <?php }
    endif?>
                    ...
                    <div class="col-xs-12 r-inner-details">
                        <div class="panel-body">
                            <div class="fade in active">
                                <table id="" class="table table-bordered table-hover table-striped" cellspacing="0"  width="99%" style="margin-right: 6px; direction:rtl;">
                                    <thead>
                                    <tr>
                                        <th>#</th>
                                        <th >إسم اليتيم</th>
                                    ...
                                    <?php  foreach($records as  $key):?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url()."all_Finance_resource/OrphanProgram/UpdateProgramsToOrphan/".$key->member_id?> "><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
                                                <a  href="<?php echo base_url()."all_Finance_resource/OrphanProgram/DeleteProgramsToOrphan/".$key->member_id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');"><i class="fa fa-trash" aria-hidden="true"></i> </a>
                                            </td>
                                        </tr>
                                    <?php endforeach;?>
                                    </tbody>
