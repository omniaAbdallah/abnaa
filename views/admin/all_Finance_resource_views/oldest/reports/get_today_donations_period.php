                    ...
                    <?php $a=1;foreach ($records as $record ):?>
                        <tr>
                            ...
                            if ($record->donate_type_id_fk ==1){
                                ...
                                $phone=$get_name[$record->person_id]->mobile;
                                $card_id=$get_name[$record->person_id]->national_id;
                                ...
                                $phone=$get_name_sponsors[$record->person_id]->mobile;
                                $card_id=$get_name_sponsors[$record->person_id]->nationality_id_fk;
                            }
                            if(empty($card_id)){
                                $card_id ='لا يوجد';
                            }
