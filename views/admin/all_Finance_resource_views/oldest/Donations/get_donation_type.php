...
<?php endif;?>
                ...
                <div class="col-xs-6 r-input">
                <input type="number" class="r-inner-h4" name="value" data-validation="required">
                </div>
                </div>
                <div class="col-xs-12">
                <div class="col-xs-6">
                ...
                <div class="col-xs-6 r-input">
                <select name="payment_type"  id="payment_type" onchange="return load22($('#payment_type').val());" class="selectpicker no-padding form-control choose-date form-control " data-show-subtext="true" data-live-search="true" data-validation="required" aria-required="true">
                <option value="">إختر</option>
                ...
                <div class="col-xs-6 r-input">
                <input type="text" class="r-inner-h4" name="detail" data-validation="required">
                </div>
                </div>
<? }?>
 <!-- first if-->
