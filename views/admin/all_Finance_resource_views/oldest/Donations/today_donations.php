    ...
    <?php if(isset($result)):?>
        ...
        <div class="details-resorce">
            <div class="col-xs-12 r-inner-details">
                <?php  echo form_open_multipart('all_Finance_resource/Donations/edit_today_donations/'.$result[0]->id)?>
                <div class="col-xs-12 ">
                            ...
                            <div class="col-xs-6 r-input ">
                                <div class="docs-datepicker">
                                    <div class="input-group">
                                        <input type="date" name="birth_date" id="birth_date" readonly class="form-control text-left" value="<?php echo date('Y-m-d',time()); ?>"placeholder="تاريخ اليوم "  >
                                    </div>
                                </div>
                            </div>
                        </div>
                 <div class="col-xs-12">
                            ...
                            <div class="col-xs-6 r-input">
                                <select name="account_settings_id_fk" id="account_settings_id_fk"   onchange="return lood($('#account_settings_id_fk').val());" class="selectpicker no-padding form-control choose-date form-control " data-show-subtext="true" data-live-search="true" data-validation="required" aria-required="true">
                        ...
                        <div class="col-xs-12" id="optionearea1">
                            ...
                            <div class="col-xs-6 r-input">
                                <select  name="program_id_fk" class="selectpicker no-padding form-control choose-date form-control " data-show-subtext="true" data-live-search="true" data-validation="required" aria-required="true">
<?php 

if(!empty($program_settings)){
    foreach ($program_settings as $records){
        $select='';
        if($records->id == $result[0]->program_id_fk ){
            $select='selected';
        }
        ?>
        <option value="<? echo $records->id;?>" <? echo $select;?>><? echo $records->program_name;?></option>
    <?php 
     }
     ...
     ?>
                    ...
                    <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                        <div class="col-xs-12">
                            ...
                            <div class="col-xs-6 r-input">
                                <select name="type"  id="type" onchange="return load($('#type').val());" class="selectpicker no-padding form-control choose-date form-control " data-show-subtext="true" data-live-search="true" data-validation="required" aria-required="true">
                    ...
                    <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data" id="optionearea5">
                        ...
                        <?php if($result[0]->donate_type_id_fk ==1):?>
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-6 r-input">
                                    <select  name="person_id"  id="person_id" class="selectpicker no-padding form-control choose-date form-control " data-show-subtext="true" data-live-search="true" data-validation="required" aria-required="true">
                                        <option value="">إختر</option>
    ...
    <div class="col-xs-12">
        ...
        <div class="col-xs-6 r-input">
  <select name="payment_type"  id="payment_type" onchange="return load2($('#payment_type').val());" class="selectpicker no-padding form-control choose-date form-control " data-show-subtext="true" data-live-search="true" data-validation="required" aria-required="true">
                    <?php if($result[0]->paid_type ==1){
                        ...
                        <?php if($result[0]->paid_type ==6){
                         $select_network='selected="selected"';  
                        }else{
                           $select_network='';    
                        }?>
                                    ...
                                    <option value="6" <?php echo $select_network;?> >الشبكة </option>
...
<?php if($result[0]->paid_type == 1){
    ...
    echo '<div class="col-xs-12">
            ...
            <div class="col-xs-6 r-input">
                ...
                <select  name="box"  id="box" class="selectpicker no-padding form-control choose-date form-control " data-show-subtext="true" data-live-search="true" data-validation="required" aria-required="true">
                    ...
                    <option value="1" '.$box1.'>صندوق رجالي</option>
                    <option value="2" '.$box2.'>صندوق نسائي</option>
    ...
    echo '<div class="col-xs-12 ">
            ...
            <div class="col-xs-6 r-input ">
                <div class="docs-datepicker">
                    <div class="input-group">
                        <input type="date" name="worth_date" id="worth_date"  class="form-control text-left" value="'.date("Y-m-d",$result[0]->worth_date).'" required>
                    </div>
                </div>
            </div>
        </div>';
}
elseif($result[0]->paid_type == 6){
    $net1 = $net2 = 0;
    if($result[0]->network == 1)
        $net1 = 'selected';
    else
        $net2 = 'selected';
    echo '<div class="col-xs-12">
            ...
            <div class="col-xs-6 r-input">
                ...
                <select  name="network"  id="network" class="selectpicker no-padding form-control choose-date form-control " data-show-subtext="true" data-live-search="true" data-validation="required" aria-required="true">
                    ...
                    <option value="1" '.$net1.'>شبكة رجالي</option>
                    <option value="2" '.$net2.'>شبكة نسائي</option>
...
if($result[0]->paid_type == 5 || $result[0]->paid_type == 4 || $result[0]->paid_type == 3 || $result[0]->paid_type == 2){?>
             <div class="col-xs-12">
            <div class="col-xs-6">
        ...
        <div class="col-xs-12">
            ...
            <div class="col-xs-6 r-input">
                <input type="text" required class="r-inner-h4" name="account_num" value="<?php echo $result[0]->account_num ;?>" >
            </div>
        </div>
...
<div class="col-xs-12">
        ...
        <div class="col-xs-6 r-input">
            <input type="text" class="r-inner-h4" name="detail" value="<?php  echo $result[0]->detail ?>" required>
        </div>
    </div>
     </div>
     </div>
 ...
 <?php else: ?>
        <div class="details-resorce">
            <div class="col-xs-12 r-inner-details">
                <?php  echo form_open_multipart('all_Finance_resource/Donations/add_today_donations')?>
                    ...
                    <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                        ...
                        <div class="col-xs-12" id="optionearea1">
                            ...
                            <div class="col-xs-6 r-input">
                                <select  name="program_id_fk" class="selectpicker no-padding form-control choose-date form-control " data-show-subtext="true" data-live-search="true" data-validation="required" aria-required="true">
                                    <option value="">إختر</option>
                                    <?php if(isset($program_settings) && $program_settings != null):
                            ...
                            foreach ($records as $record ):?>
                                <tr>
                                    ...
                                    if ($record->donate_type_id_fk ==1){
                                       ...
                                       $name="";
                                       if(isset($get_name_sponsors[$record->person_id]->name)){
                                        $name = $get_name_sponsors[$record->person_id]->name;
                                       }
                                    }
                                    ?>
                                    <td> <?php echo $type; ?></td>
                                    ...
                                    <td> <a href="<?php echo base_url('all_Finance_resource/Donations/delete_today_donations').'/'.$record->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');"> <i class="fa fa-trash" aria-hidden="true"></i> </a> <span> 
                                    </span>  <a href="<?php echo base_url('all_Finance_resource/Donations/edit_today_donations').'/'.$record->id ?>" > <i class="fa fa-pencil" aria-hidden="true"></i> </a></td>
                                    <td>
                                    <a href="<?php echo base_url('all_Finance_resource/Donations/print_today_donations').'/'.$record->id ?>"> <i class="fa fa-print" aria-hidden="true"></i> </a>
                                    </td>
                                </tr>
                                <?php
                                $a++;
    ...
    function load(values)
    {
        ...
        if(values)
        {
            ...
            $.ajax({
                ...
                type:'post',
                url: '<?php echo base_url() ?>/all_Finance_resource/Donations/add_today_donations',
                data:dataString,
                dataType: 'html',
                cache:false,
