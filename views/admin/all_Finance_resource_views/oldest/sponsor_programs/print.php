...
<script language="javascript" type="text/javascript">
    function printDiv(divID) {
        ...
        window.location = "<?php  echo base_url('all_Finance_resource/Sponsor_programs/add_Payment_of_contributions'); ?>";
        ...
        <div class="container">
            <div class="col-xs-12">
                <div class="col-xs-4" style="padding-top: 30px">
                    <h3 class="text-center"><strong>  الجمعية الخيرية لرعاية الايتام </strong><br> </h3>
                </div>
                <div class="col-xs-4">
                    <img src="<?=base_url().'/asisst/fav/ms-icon-70x70.png'?>" alt="" width="100%" height="100px">
                </div>
                <div class="col-xs-4" style="padding-top: 30px">
            ...
            <div class="col-xs-12 r-content">
                ...
                <div class="col-xs-12" style="margin-top: 15px;">
                    ...
                    <div class="form-group" style="display: inline-block">
                        ...
                        <input class="text-center" value="<?=($all_records[0]->value) ?>" readonly style="width: 80px; border: 1px solid #000">
                    </div>
                </div>
                <div class="col-xs-12">
                ...
                <div class="col-xs-12">
                    <h4 class="pull-left"> مبلغ وقدره <span> <?php echo $all_records[0]->value."&nbsp; ".$tools->convert_number($all_records[0]->value)." ريال فقط لا غير  "?> </span></h4>
                ...
                <div class="col-xs-12">
                    <div class="col-xs-3" style="padding: 0;">
                        <h4 class="pull-left"> نقدا / شيك رقم: <span> <?=$pay_method[$all_records[0]->pay_method]?> </span></h4>
                    </div>
                    <div class="col-xs-3">
