            ...
            <div class="col-sm-9 no-padding">
                ...
                <div class="col-md-12 ">
                    ...
                    <div class="col-sm-3 padding-4">
                        ...
                        <h6 class="label_title_1 ">تاريخ الطلب  </h6>
...
//                                    for ($a = 4; $a < sizeof($pay_method_arr); $a++) {
                ...
                <div class="col-md-12 ">
                    ...
                    <div class="col-sm-6 padding-4">
                        ...
                        <h6 class="label_title_1">نوع الطلب </h6>
...
<!--
                    ...
                    <div class="col-md-12 " <?php if ($pay_method != 4 && $pay_method != 5 && $pay_method != 6) { ?> style="display: none" <?php } ?>
                        ...
                        <fieldset
                            ...
                            <div class="col_md_40 col-sm-6 padding-4">
                                    ...
                                    <h6 class="label_title_1" id="raqm_marga_lebal">رقم المرجع </h6>
                            ...
                            <div class="col_md_30 col-sm-6 padding-4">
                                    ...
                                    <h6 class="label_title_1">تاريخ العملية </h6>
                            ...
                            <div class="col_md_30 col-sm-6 padding-4">
                                    ...
                                    <h6 class="label_title_1  ">إسم البنك </h6>
                ...
                $('.eda3_bank_span').html(  $('#bank_id_fk_eda3 option:selected').text());
                            ...
                            <div class="col_md_30 col-sm-6 padding-4">
                                    ...
                                    <h6 class="label_title_1">إسم الحساب </h6>
                            ...
                            <div class="col_md_40 col-sm-6 padding-4">
                                    ...
                                    <h6 class="label_title_1"> رقم الحساب </h6>
                            ...
                            <div class="col_md_30 col-sm-6 padding-4">
                                    ...
                                    <h6 class="label_title_1 "> كود الحساب </h6>
                    ...
                    <div class="col-md-12 " <?php if ($pay_method != 3) { ?> style="display: none"  <?php } ?>
                        ...
                        <fieldset class="shabka" <?php if ($pay_method != 3) { ?> disabled="disabled" <?php } ?> >
                            <div class="col_md_30 col-sm-6 padding-4">
                                    ...
                                    <h6 class="label_title_1 ">رقم الجهاز </h6>
                            ...
                            <div class="col_md_35 col-sm-6 padding-4">
                                    ...
                                    <h6 class="label_title_1">رمز الموافقة </h6>
                            ...
                            <div class="col_md_50 col-sm-6 padding-4">
                                    ...
                                    <h6 class="label_title_1"> الحساب البنكي </h6>
                            ...
                            <div class="col_md_50 col-sm-6 padding-4">
                                    ...
                                    <h6 class="label_title_1">رقم الحساب البنكي </h6>
                ...
                <div class="col-md-12 " style="display: <?= $display ?>">
                    <div class=" col-sm-3 padding-4">
                            ...
                            <h6 class="label_title_1 "> اضافة مرفق </h6>


                            <input type="file" name="morfaq"
                                   class="form-control input_style_2 ؤ "
                                   data-validation-has-keyup-event="true">
                        </div>
                        <div class="col-sm-6">
                            <?php
...
<script>
    ...
    function GetValues() {
        ...
        if ($('#myId').attr('data-click-state') == 1) {
            ...
            $("#first_value").html('<input style="font-weight: 600 !important; margin-top: 22px;" type="text" step="any" data-validation="required" name="value1" class="form-control  input_style_2 value band1_value col-sm-1 value1"   onkeyup="CheckValue(\'band2_value\',$(this).val());  $(\'#value1\').html($(this).val());" >');
            $("#ValuesDiv").append('<div class="col_md_45 col-sm-6 padding-4"> <div class="col-md-9 col-sm-6  no-padding"><select  data-validation="required" onchange="GetBandType2(this.value)" class="form-control  input_style_2" id="fe2a_type2" name="fe2a_type2"  aria-required="true"><option value="">إختر  </option></select></div></div>');
            $("#ValuesDiv").append('<div class="col_md_45 col-sm-6 padding-4"><div class="col-md-9 col-sm-6  no-padding"><select  data-validation="required" class="form-control  input_style_2"  ' +
            ...
            $("#ValuesDiv").append('' +
                '<div  class="col-md-1   no-padding" ><input style="font-weight: 600 !important;" data-validation="required" type="text" step="any" name="value2" class="form-control  input_style_2 value band2_value"  onkeyup="CheckValue(\'band1_value\',$(this).val());  $(\'#value2\').html($(this).val());" ></div>');
