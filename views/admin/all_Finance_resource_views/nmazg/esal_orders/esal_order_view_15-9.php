                ...
                <div class="col-md-12 ">
                    ...
                    <div class=" col_md_30 col-sm-6 padding-4">
                        ...
                        <div class="col-md-4 col-sm-6  no-padding ">
                            <h6 class="label_title_2 ">تاريخ الطلب </h6>
                        </div>
...
//                                    for ($a = 4; $a < sizeof($pay_method_arr); $a++) {
                ...
                <div class="col-md-12 ">
                    <div class="col_md_100 col-sm-6 padding-4">
                        ...
                        <div class="col-md-2 col-sm-6  no-padding ">
                            <h6 class="label_title_2 ">المشروعات </h6>
                        </div>
                        <div class="col-md-3 col-sm-6  no-padding">
                ...
                <div class="col-md-12 ">
                    <div class="col_md_100 col-sm-6 padding-4">
                        ...
                        <div class="col-md-3 col-sm-6  no-padding ">
                            <h6 class="label_title_2 "> الجهة المحول إليها (الإدارة ) </h6>
                        </div>
                        <div class="col-md-3 col-sm-6  no-padding">
                        ...
                        <div class="col-md-2 col-sm-6  no-padding ">
                            <h6 class="label_title_2 ">الموظفين </h6>
                        </div>
                        <div class="col-md-4 col-sm-6  no-padding">
                                            ...
                                            foreach ($all_pills_today as $row) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php } else { ?>
                                                            <button type="button" onclick="make_esal(<?= $row->id ?>)"
