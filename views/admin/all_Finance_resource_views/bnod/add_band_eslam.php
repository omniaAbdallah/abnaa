<div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
    ...
    <div class="panel-body">
            ...
            <div class="form-group col-sm-12">
                ...
                <div class="col-sm-6">
                    ...
                    <select class="form-control half input-style" disabled id="select3"
                            onchange="get_options($(this).val(),4);">
                        <option value="">اختر</option>
                        <?php
                        if (isset($records) && !empty($records)) {
                ...
                <div class="col-sm-6">
                    ...
                    <select class="form-control half input-style"  id="select4" disabled>
                        <option value="">اختر</option>
                        <?php
                        if (isset($records) && !empty($records)) {
      ...
      echo "<pre>";
       ...
       if (isset($all_bnods) && !empty($all_bnods) && $all_bnods != null) { ?>
...
<?php
  $x = 0;
                foreach ($all_bnods as $record) {

                    $x++; ?>
                     <tr>
                    <td><?php echo $x;  ?></td>
                     <td><?php echo $record->no3_esal; ?></td>
                    <td><?php echo $record->no3_erad; ?></td> 
                     <td><?php echo $record->fe2aa; ?></td> 
        ...
        if (isset($rows) && !empty($rows) && $rows != null) {
            ...
            <table id="" class=" display table table-bordered   responsive nowrap" cellspacing="0" width="100%">
                ...
                foreach ($rows as $record) {
                    ...
                    $x++; ?>
                    <tr>
                    <td rowspan="<?php if (isset($record->fe2at[0]->bnod)&&!empty($record->fe2at[0]->bnod)) echo sizeof($record->fe2at[0]->bnod); ?>"><?php echo $x; ?></td>
                    <td rowspan="<?php if (isset($record->fe2at[0]->bnod)&&!empty($record->fe2at[0]->bnod)) echo sizeof($record->fe2at[0]->bnod); ?>"><?php echo $record->title; ?> </td>
                    <td rowspan="<?php if (isset($record->fe2at[0]->bnod)&&!empty($record->fe2at[0]->bnod)) echo sizeof($record->fe2at[0]->bnod); ?>"> <?php if (!empty($record->erad->title)) echo $record->erad->title; ?> </td>
                    <td rowspan="<?php if (isset($record->fe2at[0]->bnod)&&!empty($record->fe2at[0]->bnod)) echo sizeof($record->fe2at[0]->bnod); ?>"><?php if (!empty($record->fe2at[0]->title)) echo $record->fe2at[0]->title; ?> </td>
                                                ...
                                                <select class="form-control half input-style" disabled  name="erad"
                                                    ...
                                                    if (isset($records) && !empty($records)) {
                                                        ...
                                                        foreach ($records as $row) {
                                                            ...
                                                            <option value="<?php echo $row->id; ?>"
                                                             <?php if($row->id==$record->erad->from_id) echo 'selected' ;?>>
                                                             <?php echo $row->name; ?></option>
                                                        <?php }
                                                    } ?>
                                                </select>
