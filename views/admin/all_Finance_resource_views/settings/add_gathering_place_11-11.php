                ...
                <div class="col-md-12 no-padding">
                    ...
                    <div class="form-group col-md-4 col-sm-2 col-xs-12 padding-4">
                        ...
                        <input type="text" class="form-control  testButton inputclass"
                               ...
                               value="">
                        <input type="hidden" name="emp_id_fk" id="emp_id_fk" value="">
                        <input type="hidden" name="edara_id_fk" id="edara_id_fk" value="">
            ...
            <td style="text-align: center!important;" >
                        ...
                        <?php
                          ...
                          foreach ($mqr_thseel_setting as $roww) {
                              $select = '';
                              if ($record->mqr_thseel != '') {
                                  if ($roww->id_setting == $record->mqr_thseel) {
