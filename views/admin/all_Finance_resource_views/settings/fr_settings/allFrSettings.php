                    ...
                    <div class="col-sm-4">
                        <ul class="nav nav-tabs tabs-left holiday-month" style="    border: 1px solid gray;">
                                    ...
                                    <li class="<?php if (isset($typee) && !empty($typee) && $typee) {
                                        ...
                                        <a <?php if (isset($disabled)) {
                                            ...
                                            echo 'href="#tab' . $key . '"';
                                                ...
                                                data-toggle="tab"> <i class="fa fa-cog"
                                                                      aria-hidden="true"></i> <?= $value['title'] ?>
                                        </a></li>
                            ...
                            <li role="presentation" style="float: right; width: 50%;"
                                class="<?php if (isset($typee) && !empty($typee) && $typee === 'kafalat_type') {
                                    echo 'active';
                                } ?>">
                                <a <?php if (isset($disabled)) {
                                } else {
                                    echo 'href="#kafalat_type"';
                                } ?> aria-controls="tab_areas" role="tab" data-toggle="tab"><i class="fa fa-cog"
                                                                                               aria-hidden="true"></i>انواع
                                    الكفالات</a>
                            </li>
                            <li role="presentation" style="float: right; width: 50%;"
                                class="<?php if (isset($typee) && !empty($typee) && $typee === 'kafel_status_1') {
                                    echo 'active';
                                } ?>">
                                <a <?php if (isset($disabled)) {
                                } else {
                                    echo 'href="#kafel_status_1"';
                                } ?> aria-controls="kafel_status_1" role="tab" data-toggle="tab"><i class="fa fa-cog"
                                                                                                    aria-hidden="true"></i>حالات
                                    الكفالات</a>
                            </li>

                            <li role="presentation" style="float: right; width: 50%;"
                                class="<?php if (isset($typee) && !empty($typee) && $typee === 'kafel_status_2') {
                                    echo 'active';
                                } ?>">
                                <a <?php if (isset($disabled)) {
                                } else {
                                    echo 'href="#kafel_status_2"';
                                } ?> aria-controls="kafel_status_2" role="tab" data-toggle="tab"><i class="fa fa-cog"
                                                                                                    aria-hidden="true"></i>حالات
                                    الكافل</a>
                            </li>
                            ...
                            <li role="presentation" style="float: right; width: 50%;"
                                class="<?php if (isset($typee) && !empty($typee) && $typee === 'fr_sponser_donor') {
                                    echo 'active';
                                } ?>">
                                <a <?php if (isset($disabled)) {
                                } else {
                                    echo 'href="#fr_sponser_donor"';
                                } ?> aria-controls="fr_sponser_donor" role="tab" data-toggle="tab">
                            ...
                            <li role="presentation" style="float: right; width: 50%;"
                                class="<?php if (isset($typee) && !empty($typee) && $typee === 'halet_kafalaat_reasons') {
                                    echo 'active';
                                } ?>">
                                <a <?php if (isset($disabled)) {
                                } else {
                                    echo 'href="#halet_kafalaat_reasons"';
                                } ?> aria-controls="fr_sponser_donor" role="tab" data-toggle="tab">
                                    <i class="fa fa-cog" aria-hidden="true"></i>إعدادات أسباب حالات الكفالات </a>
                            </li>
...
<i class="fa fa-floppy-o" aria-hidden="true"></i></span> حفظ
                                                    ...
                                                    if (isset($all[$key]) && !empty($all[$key]) && $all[$key] != null) {
                                                        foreach ($all[$key] as $value) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="<?php echo base_url() . 'all_Finance_resource/settings/Finance_resource_settings/UpdateSitting/' . $value->id_setting . "/" . $key ?>"
                                                                       title="تعديل">
                                                                        <i class="fa fa-pencil-square-o"
                                                                           aria-hidden="true"></i> </a>
                                                                    <span> </span>
                                                                    <a href="<?= base_url() . "all_Finance_resource/settings/Finance_resource_settings/DeleteSitting/" . $value->id_setting . "/" . $key ?>"
                        ...
                        <div class="tab-pane fade in <?php if (isset($typee) && !empty($typee) && $typee === "kafalat_type") {
                            echo 'active';
                        } ?>" id="kafalat_type">
                            <div class="panel-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <div class="form-group col-sm-5 col-xs-12">
                                        ...
                                        <input type="text" name="title"
                                               value="<?php if (isset($kafala)) echo $kafala['title'] ?>"
                                               class="form-control half input-style" autofocus
                                               data-validation="required">
                                    </div>
                                    <?php
                                    ...
                                    <div class="form-group col-sm-4 col-xs-12">
                                        <label class="label label-green half"
                                               style="width: 50px !important;margin-left: 6px;"> الفئة</label>

                                        <?php foreach ($tasnfat as $row => $value) { ?>
                                            <input type="checkbox" name="tasnef[]" style="margin: 9px 0 0px;"
                                                   value="<?= $row ?>" <?php if (isset($kafala[$row])) {
                                                if ($kafala[$row] == 1) {
                                                    echo 'checked';
                                                }
                                            } ?> class=" " autofocus>&nbsp <?= $value ?>   &nbsp &nbsp
                                        <?php } ?>
                                    </div>
                                    <div class="form-group col-sm-3 col-xs-12">
                                        <label class="label label-green half">اللون المميز</label>
                                        <input type="color" name="color"
                                               value="<?php if (isset($kafala)) echo $kafala['color'] ?>"
                                               class="form-control half input-style" autofocus
                                               data-validation="required">
                                    </div>
                                    <!--
                                    <div class="form-group col-sm-3 col-xs-12">
                                        <label class="label label-green half">قيمة الكفالة الشهرية </label>
                                        <input type="number" step="any" name="kafala_value"
                                               value="<?php if (isset($kafala)) echo $kafala['kafala_value'] ?>"
                                               class="form-control half input-style" autofocus
                                               data-validation="required">
                                    </div> -->
        ...
        <div class="col-sm-6  col-md-3 padding-4 has-error">
        <label class="label label-green  ">قيمة الكفالة الشهرية   </label>
        <input type="number" step="any" name="kafala_value" class="form-control  input-style error" placeholder="أدخل البيانات" 
        
         value="<?php if (isset($kafala)) echo $kafala['kafala_value'] ?>"
        
         data-validation="required" data-validation-has-keyup-event="true" style="border-color: rgb(185, 74, 72);">
      </div>
                                    
                                    
                                    
                                    <div class="form-group col-sm-12 col-xs-12">
                                        <button type="submit" name="kafalat_type" value="kafalat_type"
                                                class="btn btn-purple w-md m-b-5"><span>
                                            <i class="fa fa-floppy-o" aria-hidden="true"></i></span> حفظ
                                        </button>
                                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php foreach ($tasnfat as $key => $value1) {
                                                        ...
                                                        <td>
                                                            ...
                                                            <i style="color:<?= $color ?>" class="fa fa-<?= $true ?>"
                                                               aria-hidden="true"></i>
                                                        </td>
                                                    <? } ?>
                                                    ...
                                                    <td>
                                                        <label class="label  "
                                                               style="background-color:<?= $value->color ?>;padding: 5px 28px;"> </label>

                                                    </td>
                                                  <td><?= $value->kafala_value ?></td>
                                                    <td>
                                                        <a href="<?php echo base_url() . 'all_Finance_resource/settings/Finance_resource_settings/UpdateSitting/' . $value->id . "/kafalat_type" ?>"
                                                           title="تعديل">
                                                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                        </a>
                                                        <a href="<?= base_url() . "all_Finance_resource/settings/Finance_resource_settings/DeleteSittingKafala/kafalat_type/" . $value->id ?>"
                                                           onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
                        ...
                        <div class="tab-pane fade in <?php if (isset($typee) && !empty($typee) && $typee === "kafel_status_1") {
                            echo 'active';
                        } ?>" id="kafel_status_1">
                            <div class="panel-body">
                                <a href="#" class="btn btn-add btndate" data-toggle="modal" data-target="#addholiday"
                                ...
                                <div class="table-responsive">
                                    ...
                                    <div class="form-group col-sm-6 col-xs-12">
                                        ...
                                        <input type="text" name="title"
                                               value="<?php if (isset($hakafala)) echo $hakafala['title'] ?>"
                                               class="form-control half input-style" autofocus
                                               data-validation="required">
                                    ...
                                    <div class="form-group col-sm-6 col-xs-12">
                                        <label class="label label-green half">اللون المميز</label>
                                        <input type="color" name="color"
                                               value="<?php if (isset($hakafala)) echo $hakafala['color'] ?>"
                                               class="form-control half input-style" autofocus
                                               data-validation="required">
                                    </div>
                                    <div class="form-group col-sm-12 col-xs-12">
                                        <button type="submit" name="kafel_status_1" value="kafel_status_1"
                                                class="btn btn-purple w-md m-b-5"><span>
                                            <i class="fa fa-floppy-o" aria-hidden="true"></i></span> حفظ
                                        </button>
                                    </div>
                                        ...
                                        <table class="table table-bordered table-striped table-hover">
                                            ...
                                            foreach ($halatkafala as $value) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url() . 'all_Finance_resource/settings/Finance_resource_settings/UpdateSitting/' . $value->id . "/kafel_status_1" ?>"
                                                           title="تعديل">
                                                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                        </a>
                                                        <a href="<?= base_url() . "all_Finance_resource/settings/Finance_resource_settings/DeleteSittingKafala/kafel_status_1/" . $value->id ?>"
                                                           onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
                                                            <i class="fa fa-trash" aria-hidden="true"></i></a>
                                                    </td>
                                                </tr>
                        ...
                        <div class="tab-pane fade in <?php if (isset($typee) && !empty($typee) && $typee === "kafel_status_2") {
                            echo 'active';
                        } ?>" id="kafel_status_2">
                            <div class="panel-body">
                                <a href="#" class="btn btn-add btndate" data-toggle="modal" data-target="#addholiday"
                                ...
                                <div class="table-responsive">
                                    ...
                                    <div class="form-group col-sm-6 col-xs-12">
                                        <label class="label label-green half">الاسم </label>
                                        <input type="text" name="title"
                                               value="<?php if (isset($hakafalel)) echo $hakafalel['title'] ?>"
                                               class="form-control half input-style" autofocus
                                               data-validation="required">
                                    ...
                                    <div class="form-group col-sm-6 col-xs-12">
                                        <label class="label label-green half">اللون المميز</label>
                                        <input type="color" name="color"
                                               value="<?php if (isset($hakafalel)) echo $hakafalel['color'] ?>"
                                               class="form-control half input-style" autofocus
                                               data-validation="required">
                                    </div>
                                    <div class="form-group col-sm-12 col-xs-12">
                                        <button type="submit" name="kafel_status_2" value="kafel_status_2"
                                                class="btn btn-purple w-md m-b-5"><span>
                                            <i class="fa fa-floppy-o" aria-hidden="true"></i></span> حفظ
                                        </button>
                                    </div>
...
<?php */ ?>
                        ...
                        <div class="tab-pane fade in <?php if (isset($typee) && !empty($typee) && $typee === "halet_kafalaat_reasons") {
                            echo 'active';
                        } ?>" id="halet_kafalaat_reasons">
                            <div class="panel-body">
                                <a href="#" class="btn btn-add btndate" data-toggle="modal" data-target="#addholiday"
                                   style="margin-bottom: 6px;"> <strong>
                                        <i class="fa fa-cog" aria-hidden="true"></i>إعدادات أسباب حالات الكفالات </strong></a>
                                <div class="table-responsive">
                                    <?php
                                    if (isset($halet_kafalaat_reasons_settings_result) && !empty($halet_kafalaat_reasons_settings_result) && $halet_kafalaat_reasons_settings_result != null) {
                                        echo form_open_multipart('all_Finance_resource/settings/Finance_resource_settings/UpdateSitting/' . $halet_kafalaat_reasons_settings_result['id'] . '/' . $typee);
                                    } else {
                                        echo form_open_multipart('all_Finance_resource/settings/Finance_resource_settings/AddSitting/halet_kafalaat_reasons');
                                    }

                                    ?>
                                    <input type="hidden" name="halet_kafalaat_reasons" value="halet_kafalaat_reasons">
                                    <table id="table_settings" class="table table-bordered table-striped table-hover ">
                                        <thead>
                                        <tr class="info">
                                            <th style="text-align: center"> السبب</th>
                                            <th style="text-align: center">يخص</th>
                                            <th style="text-align: center">الإجراء</th>
                                        </tr>
                                        </thead>
                                        <tbody id="tbody_insert" >
                                        <?php if(!empty($halet_kafalaat_reasons_settings_result)){ ?>
                                        <tr>
                                           <td><input type="input" name="reason" id="reason"
                                                      class="form-control" data-validation="reuqired" value="<?php echo$halet_kafalaat_reasons_settings_result['reason'] ?>"></td>
                                           <td>
                                              <input  type="radio" data-validation="reuqired" name="reason_type" value="1" <?php if($halet_kafalaat_reasons_settings_result['reason_type'] ==1 ){
                                                  echo 'checked';
                                              }?> >
                                              <label for="square-radio-1">الملف</label>
                                              <input  type="radio"  data-validation="reuqired" name="reason_type"

                                                  <?php if($halet_kafalaat_reasons_settings_result['reason_type'] ==2 ){
                                                      echo 'checked';
                                                  }?>
                                                      value="2">
                                              <label for="square-radio-1">الكافل</label>
                                        ...
                                        <tr id="notfound">
                                        <td colspan="3"
                                        style="text-align: center;color: red">لا توجد بيانات</td></tbody></tr>
                                        <?php if(empty($halet_kafalaat_reasons_settings_result)){ ?>
                                        <tfoot>
                                        <tr>
                                            <td colspan="3" >
                                 ...
                                 <?php echo form_close();?>
                                    <?php if (isset($halet_kafalaat_reasons_settings) && !empty($halet_kafalaat_reasons_settings) && $halet_kafalaat_reasons_settings != null) { ?>
                                        <table class="table table-bordered table-striped table-hover">
                                            <thead>
                                            <tr class="info">
                                             <!--   <th>م</th> -->
                                            ...
                                            <?php
                                            $x = 0;
                                            foreach ($halet_kafalaat_reasons_settings as $record) {
                                                $x++;
                                                 $reason_arr =array(1=>'الملف',2=>'الكافل');
                                                ?>
                                                   <tr>
                                                       <!-- <td><?php echo $x;?></td> -->
                                                       <td><?=$record->reason?></td>
                                                       <td><?php if( !empty($reason_arr[$record->reason_type])){ echo$reason_arr[$record->reason_type]; } ?></td>
                                                       <td>
                                                           <a href="<?php echo base_url() . 'all_Finance_resource/settings/Finance_resource_settings/UpdateSitting/' . $record->id . "/halet_kafalaat_reasons" ?>"
                                                              title="تعديل">
                                                               <i class="fa fa-pencil-square-o"
                                                                  aria-hidden="true"></i> </a>
                                                           <a href="<?= base_url() . "all_Finance_resource/settings/Finance_resource_settings/Deletehalet_kafalaat_reasons/" . $record->id ?>"
                                                              onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
                                                               <i class="fa fa-trash"
                                                                  aria-hidden="true"></i></a>
                                                       </td>
...
<script>
    ...
    function add_row(){
        ...
        $("#tbody_insert").append('<tr id="'+ len +'">'
            ...
            '                <input  type="radio" data-validation="reuqired" name="reason_type_'+ len + '" value="1" id="'+ len +'" >' +
            '                <label for="square-radio-1">الملف</label>\n' +
            '                <input  type="radio"  data-validation="reuqired" name="reason_type_'+ len + '" id="'+ len +'" value="2">' +
            '                <label for="square-radio-1">الكافل</label></td><td>' +
            '<a href="#"' +
    ...
    function DeleteRow(value) {
        ...
        var len = value-1 ;
        if( len == 0){
            $("#tbody_insert").html('<tr id="notfound"><td colspan="3" style="text-align: center;color: red">لا توجد بيانات</td></tr>');
        }
    }
</script>
