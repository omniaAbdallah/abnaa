            ...
            <div class="col-sm-12 " ><br>
                ...
                <table   class="table table-striped table-bordered "   >
                    ...
                    <?php $count=1; foreach($records as $record){ ?>
                        ...
                        <td style="text-align: center!important;"><?php echo $record->title; ?></td>
                        ...
                        <a href=" <?php echo  base_url('').'all_Finance_resource/settings/Finance_resource_settings/Delete_gathering_place/'.$record->id."" ?>"
