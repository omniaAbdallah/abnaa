        ...
        <div class="panel-body">
            <div class="col-md-12 no-padding">
                <div class="user-widget list-group">
                    ...
                    <td><?php if(isset($result)){ echo  $result->donor_num;}?></td>
                    </tr>
                    <tr>
                        <th><strong class="text-danger ">رقم بطاقه المتبرع </strong></th>
                        <td><?php if(isset($result)){ echo  $result->d_national_num;}?></td>
                    </tr>
                    </tbody>
                    </table>
                </div>
