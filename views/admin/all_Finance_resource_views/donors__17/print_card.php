            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="card profile-card-3 center-block">
                    ...
                    <div class="card-content col-xs-12">
                        <h3 class="text-center"> كارت تعريف المتبرع</h3>
                        <div class="col-xs-12 no-padding card-define">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td>
                                        <h4> <?php if(isset($item->donor_num)){ echo $item->donor_num;  }else{  echo'غير محدد';} ?> </h4>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="border-left">
                                    ...
                                    <td>
                                        <h4> <?php if(isset($item->d_name)){ echo $item->d_name;  }else{  echo'غير محدد';} ?> </h4>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="border-left">
                                    ...
                                    <td>
                                        <h4> <?php if(isset($item->mob)){ echo $item->mob;  }else{  echo'غير محدد';} ?> </h4>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="border-left">
                                    ...
                                    <td>
                                        <h4> <?php if(isset($item->d_national_num)){ echo $item->d_national_num;  }else{  echo'غير محدد';} ?> </h4>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="border-left">
                                    ...
                                    <td>
                                        <h4> <?php if(isset($item->mehna)){ echo $item->mehna;  }else{  echo'غير محدد';} ?> </h4>
