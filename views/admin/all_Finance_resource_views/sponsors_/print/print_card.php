                            ...
                            <div class="col-xs-12 no-padding card-define">
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h4><?php if(!empty($result->k_name)){ echo $result->k_name ;  }else{  echo'غير محدد';} ?> </h4>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="border-left">
                                        ...
                                        <td>
                                        <h4><?php if(!empty($result->k_num)){ echo $result->k_num ;  }else{  echo'غير محدد';} ?> </h4>
                                        </td>
                                    </tr>
...
<script >
    ...
    window .print();
    setTimeout(function () {
        window.location.href ="<?php echo base_url('all_Finance_resource/sponsors/Sponsor/addSponsor') ?>";
    }, 1000);
</script >
