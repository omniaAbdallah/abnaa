...
<div>
    ...
    if( $_POST['kafala_type_fk'] ==4) {
        ...
        $mother_national_num_fk = $armal['mother_national_num_fk'];
        $person_id_fk =$armal['id'];
        $gender = 'ذكر';
        if ( $armal['m_gender'] == 2) {
            $gender = 'أنثى';
        }
        ...
        if( $armal['m_birth_date_hijri_year'] !=''){
            ...
            $age = $cuttent_higry_year - $armal['m_birth_date_hijri_year'];
        ...
        $mother_national_num_fk =$members['mother_national_num_fk'];
        $person_id_fk =$_POST['person_id_fk'];
        $type = 'ذكر';
        ...
        if( $members['member_birth_date_hijri_year'] !=''){
            ...
            $age = $cuttent_higry_year - $members['member_birth_date_hijri_year'];
    ...
    ?>
    <input type="hidden" name="mother_national_num_fk" value="<?=$mother_national_num_fk?>">
    <input type="hidden" name="person_id_fk" value="<?=$person_id_fk?>">
