    ...
    <div class="col-md-12">
        ...
        if (isset($kfalat_types) && !empty($kfalat_types)) {
            foreach ($kfalat_types as $value) {
                ?>
                <input type="radio" name="kafala_type_fk" style="margin-right: 15px"
                       onclick="check_kafal(<?= $value->id ?>,<?php echo $result_Kfala_data['person_id_fk']; ?>)"
                       value="<?= $value->id ?>"
                    ...
                    <div class="form-group col-md-2  col-sm-6 padding-4">
                        ...
                        <div id="cal-1" style="width: 50%;float: left;">
                            <input id="date-Miladi" name="from_date" class="form-control bottom-input  "
                                   value="<?php echo $date_from; ?>" type="text" onfocus="showCal1();"
           ...
           onchange="checkYear($(this).val());">-->
                                ...
                                for ($a = 1; $a < sizeof($alert_type_arr); $a++) {
                                    ...
                                    <option value="<?php echo $a; ?>"
                                        <?php if (!empty($result_Kfala_data['alert_type'])) {
                                            if ($a == $result_Kfala_data['alert_type']) {
                                                echo 'selected';
                                            }
                    ...
                    <div class="form-group col-md-1  col-sm-6 padding-4">
                        ...
                        <input type="text" name="k_value" id="k_value" data-validation="required"
                               onkeypress="validate_number(event);" value="<?= $value ?>"
                               class="form-control bottom-input">
                    </div>
                    <div class="form-group col-md-1  col-sm-6 padding-4">
                    ...
                    <div class="form-group col-md-1  col-sm-6 padding-4">
                        ...
                        <select name="suspension_type" id="suspension_type" data-validation="required"
                            <?php if (!empty($status)) {
                                ...
                                onchange="getReasonsByType($(this).val())">
                            <option value="">إختر</option>
                            <?php
                ...
                <div class="col-md-12 no-padding">
                                ...
                                for ($a = 1; $a < sizeof($pay_method_arr); $a++) {
                                    ...
                                    <option value="<?php echo $a; ?>"
                                        <?php if (!empty($result_Kfala_data['pay_method'])) {
                                            if ($a == $result_Kfala_data['pay_method']) {
                                                echo 'selected';
                                            }
                    ...
                    <div class="form-group col-md-2  col-sm-6 padding-4">
                        ...
                        <select name="bank_id_fk" id="bank_id_fk" class="form-control bottom-input empty"
                            <?php if ($result_Kfala_data['pay_method'] != 5 && $result_Kfala_data['pay_method'] != 7) { ?>    disabled="disabled"  <?php } ?>
                                aria-required="true">
                            <option value="">إختر</option>
                            <?php if (!empty($banks)) {
                                foreach ($banks as $bank) { ?>
                                    <option value="<?php echo $bank->id; ?>"
                                        <?php if (!empty($result_Kfala_data['bank_id_fk'])) {
                                            if ($bank->id == $result_Kfala_data['bank_id_fk']) {
                                                echo 'selected';
                                            }
                    ...
                    <div class="form-group col-md-3  col-sm-6 padding-4">
                        <label class="label "> رقم حساب الكافل
                            <small style="color: red; font-size: 14px !important;">( رقم الحساب لابد أن يكون24رقم
                                )</small>
                        </label>
    ...
    -->
                ...
                <div class="col-md-12 no-padding">
                    <div class="form-group col-md-3  col-sm-6 padding-4">
                        ...
                        <input type="file" name="mostdem_img" id="mostdem_img"
                               class="form-control bottom-input" <?php if ($result_Kfala_data['pay_method'] != 7) { ?>    disabled="disabled"  <?php } ?> >
                    </div>
                    <div class="form-group col-md-2  col-sm-6 padding-4">
                                ...
                                foreach ($banks_accounts as $row) {
                                    ...
                                    <option value="<?= $row->id ?>"
                                        <?php if (!empty($result_Kfala_data['gamia_account'])) {
                                            if ($result_Kfala_data['gamia_account'] == $row->id) {
                                                echo 'selected';
                                            }
                                        } ?>><?= $row->title ?></option>
                                    <?php
                                ...
                                foreach ($gamia_banks as $bank) { ?>
                                    <option value="<?php echo $bank->id; ?>"
                                        <?php if (!empty($result_Kfala_data['gamia_bank_id_fk'])) {
                                            if ($bank->id == $result_Kfala_data['gamia_bank_id_fk']) {
                                                echo 'selected';
                                            }
                                ...
                                foreach ($gamia_account_numbers as $row) { ?>
                                    <option value="<?php echo $row->id; ?>"
                                        <?php if (!empty($result_Kfala_data['gamia_account_num'])) {
                                            if ($row->id == $result_Kfala_data['gamia_account_num']) {
                                                echo 'selected';
                                            }
