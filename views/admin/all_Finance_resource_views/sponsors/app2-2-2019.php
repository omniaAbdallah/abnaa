...
<button class="btn btn-add" onclick="window.location='<?php echo site_url("all_Finance_resource/sponsors/Sponsor/addSponsor_maindata");?>'">
    <i class="fa fa-plus"> </i> اضافه كافل </button>
