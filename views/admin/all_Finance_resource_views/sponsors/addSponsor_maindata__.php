    ...
    <div class="form-group col-md-3 col-sm-6 padding-4">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group col-md-3 col-sm-6 padding-4">
                        ...
                        <input type="file" name="person_img"  class="form-control" id="person_img">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a target="_blank"
                                                       href="<?php echo base_url(); ?>all_Finance_resource/sponsors/Sponsor/addKfala_data/<?php echo$record->id;?>">بيانات الكفالة </a></li>
                                            </ul>
                                        </div>
