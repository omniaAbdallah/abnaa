		...
		<div class="piece-body">
			<div class="col-md-12 no-padding">
				<table class="table table-bordered" style="table-layout: fixed;">
					...
					<tr>
						<td>تاريخ بداية الأمر</td>
						<td><input type="text" name="mostdem_from_date"  disabled="disabled"
								   id="mostdem_from_date"
								   class="form-control  date_as_mask"
								   data-validation-has-keyup-event="true"  onkeyup="checkYear($(this).val())"
								   onchange="checkYear($(this).val());">
						</td>
						<td>تاريخ نهاية الأمر</td>
						<td><input type="text" name="mostdem_to_date" disabled="disabled"
								   id="mostdem_to_date"
								   class="form-control  date_as_mask"
								   data-validation-has-keyup-event="true"  onkeyup="checkYear($(this).val())"
								   onchange="checkYear($(this).val());">
						...
						<td>صورة الأمر</td>
						<td><input type="file" name="mostdem_img" id="mostdem_img" class="form-control" disabled="disabled">
						</td>
					...
					<tr>
						...
						<td><select name="gamia_account" id="gamia_account" data-validation="required"
									class="form-control selectpicker "  data-show-subtext="true" data-live-search="true"   aria-required="true">
								<option value="">إختر</option>
								<?php
						...
						<td>إسم البنك</td>
						<td> <select name="gamia_bank_id_fk" id="gamia_bank_id_fk" class="form-control"
						...
						<td>رقم الحساب</td>
						<td colspan="1"><input type="text" name="bank_account_num" id="gamia_bank_account_num"
