                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php  if(!empty($gender_data[$result->k_gender_fk])){
                                            echo $gender_data[$result->k_gender_fk]->title_setting; }else{ echo'غيرمحدد';}?>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td><?php  if(!empty($nationality[$result->k_nationality_fk])){
                                            echo $nationality[$result->k_nationality_fk]->title_setting; }else{ echo'غيرمحدد';}?>
                                    </td>
                                    <th class="gray_background">نوع الهوية</th>
                                    <td><?php  if(!empty($type_card[$result->k_national_type])){
                                            echo $type_card[$result->k_national_type]->title_setting; }else{ echo'غيرمحدد';}?>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td><?php  if(!empty($dest_card[$result->k_national_place])){
                                            echo $dest_card[$result->k_national_place]->title_setting; }else{ echo'غيرمحدد';}?>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td><?php if(!empty($cities[$result->k_city])){
                                            echo $cities[$result->k_city]->title_setting; }else{ echo 'غير محدد';} ?>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td><?php  if(!empty($job_role[$result->k_job_fk])){
                                            echo $job_role[$result->k_job_fk]->title_setting; }else{ echo'غيرمحدد';}?>
                                    </td>
                                    <th class="gray_background">جهة العمل</th>
                                    <td><?php  if(!empty($employer[$result->k_job_place])){
                                            echo $employer[$result->k_job_place]->title_setting; }else{ echo'غيرمحدد';}?>
                                    </td>
                                </tr>
                                <tr>
                                    <th class="gray_background">نشاط المؤسسة</th>
                                    <td><?php  if(!empty($activity[$result->k_activity_fk])){
                                            echo $activity[$result->k_activity_fk]->title_setting; }else{ echo'غيرمحدد';}?>
                                    </td>
                                    <th class="gray_background">التخصص</th>
                                    <td><?php  if(!empty($specialize[$result->k_specialize_fk])){
                                            echo $specialize[$result->k_specialize_fk]->title_setting; }else{ echo'غيرمحدد';}?>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td><?php  if(!empty($k_message_mob_arr[$result->k_message_mob])){
                                            echo $k_message_mob_arr[$result->k_message_mob]; }else{ echo'غيرمحدد';}?>
                                    </td>
