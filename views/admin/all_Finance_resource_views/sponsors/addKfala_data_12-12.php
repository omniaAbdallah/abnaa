...
<div class="col-sm-12 no-padding " >
  ...
  أرامل <span style="background-color: white; color: #000;" class="badge badge-light"><?php echo  $all_kafalat[0]->armal_num; ?></span>
</button>
                  <button type="button" class="btn btn-sm btn-primary">
  أيتام <span style="background-color: white; color: #000;" class="badge badge-light"><?php echo  $all_kafalat[0]->aytam_num; ?></span>
</button>
             
                               <button type="button" class="btn btn-sm btn-add">
  مستفيدين <span style="background-color: white; color: #000;" class="badge badge-light"><?php echo  $all_kafalat[0]->mostafed_num; ?></span>
</button>
