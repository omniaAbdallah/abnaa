...
if(isset($result)&&!empty($result))
{
 $rkm_talab=$result->rkm_talab;
    ...
    $company_gawal= $result->company_gawal;
     ...
     $esalat_nums = $result->esalat_nums;
...
<input  type="hidden" name="k_num" id="k_num" <?php
     ...
     <label class=" label"> عدد الايصالات </label>
    
        <input type="num" name="esalat_nums" id="esalat_nums"
        value="<?php echo $esalat_nums;?>"
                    ...
                    <div class="col-xs-12 no-padding">
                        <table id="example" class="table table-striped table-bordered dt-responsive nowrap"
                            ...
                            foreach ($records as $record) {
                                ...
                                ?>
                                <tr <?php if ($record->esalat_nums == 3){ ?> class="orangetd"<?php } ?>>
                                    <td> <?= $x ?></td>
