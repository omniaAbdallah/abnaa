        ...
        <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
            ...
            <div class="panel-body">
                            ...
                            if (!empty($f2a) && isset($f2a)) {
                                foreach ($f2a as $value) {
                                    ...
                                    <option value="<?php echo $value->id; ?>"
                                            data-specialize="<?php echo $value->specialize_fk; ?>"
                                        <?php
                                        if (!empty($fe2a_type)) {
                            ...
                            foreach ($nationality as $row) {
                                ...
                                <option value="<?php echo $row->id_setting; ?>"
                                    <?php if (!empty($k_nationality_fk)) {
                                        if ($row->id_setting == $k_nationality_fk) {
                                            echo 'selected';
                                        }
                                    } ?>> <?php echo $row->title_setting; ?></option>
                                <?php
                ...
                <div class="col_md_25 col-sm-6 padding-4  company" style="display:block;">
                    ...
                    <div class="col-md-6 col-sm-6  no-padding">
                        <select id="social_status_id_fk" class="form-control input_style_2"
                                onchange="change_status($(this).val())"
                                name="social_status_id_fk">
                            <option value="">إختر</option>
                                ...
                                foreach ($social_status as $row) {
                                    ...
                                    <option value="<?php echo $row->id_setting; ?>"
                                        ...
                                        <?php if (!empty($social_status_id_fk)) {
                                            if ($row->id_setting == $social_status_id_fk) {
                                                echo 'selected';
                                            }
                                        } ?>> <?php echo $row->title_setting; ?></option>
                                    <?php
                                ...
                                foreach ($type_card as $row) {
                                    ...
                                    <option value="<?php echo $row->id_setting; ?>"
                                        ...
                                        <?php if (!empty($k_national_type)) {
                                            if ($row->id_setting == $k_national_type) {
                                                echo 'selected';
                                            }
                                        } ?>> <?php echo $row->title_setting; ?></option>
                                    <?php
                ...
                <div class="col_md_25 col-sm-6 padding-4 company" style="display:block;">
                    ...
                    <div class="col-md-7 col-sm-6  no-padding">
                        <input type="text" name="k_national_num" id="k_national_num"
                               ...
                               maxlength="10"
                            <?php if ($social_status_id_fk != '') {
                                if ($social_status_id_fk == 0) {
                                ...
                                foreach ($dest_card as $row) {
                                    ...
                                    <option value="<?php echo $row->id_setting; ?>"
                                        <?php if (!empty($k_national_place)) {
                                            if ($row->id_setting == $k_national_place) {
                                                echo 'selected';
                                            }
                                        } ?>> <?php echo $row->title_setting; ?></option>
                                    <?php
                ...
                <div class="col_md_25 col-sm-6 padding-4 company" style="display:block;">
                    ...
                    <div class="col-md-6 col-sm-6  no-padding">
                        <select id="wakala_type" name="wakala_type"
                                onchange="check_wakel_type($(this).val());" class="form-control input_style_2"
                                data-validation="required">
                            <option value="">إختر</option>
                        ...
                        <select name="wakel_relationship" id="wakel_relationship"
                            ...
                            <?php if (!empty($relationships)) {
                                foreach ($relationships as $record) {
                                    $select = '';
                                    if (isset($result)) {
                                        if ($wakel_relationship == $record->id_setting) {
                                            $select = 'selected';
                                        }
                                    } ?>
                        ...
                        <select id="city_id_fk" name="k_city"
                            ...
                            if (isset($cities) && !empty($cities)) {
                                foreach ($cities as $key => $value) {
                                    ?>
                                    <option value="<?php echo $key; ?>"<?php if ($key == $k_city) {
                                        echo 'selected';
                                ...
                                foreach ($specialize as $row) {
                                    ...
                                    <option value="<?php echo $row->id_setting; ?>"
                                        <?php if (!empty($k_specialize_fk)) {
                                            if ($row->id_setting == $k_specialize_fk) {
                                                echo 'selected';
                                            }
                                        } ?>> <?php echo $row->title_setting; ?></option>
                                    <?php
                ...
                <div class="col_md_20 col-sm-6 padding-4 company" style="display:block;">
                    ...
                    <div class="col-md-6 col-sm-6  no-padding">
                        <select name="work_id_fk" class="form-control input_style_2" id="work_id_fk"
                                onchange="change_work_status($(this).val())" data-validation="required">
                            <option value="">اختر</option>
                            <?php
                            $works = array('لا', 'نعم');
                    ...
                    <div class="col-md-9 col-sm-6  no-padding">
                        <input type="text" name="k_job_place"
                            <?php if ($work_id_fk == 0) {
                               ...
                               id="k_job_place" class="form-control input_style_2"
                               onchange="change_halet_kafel($(this).val())"
                                ...
                                foreach ($activity as $row) {
                                    ...
                                    <option value="<?php echo $row->id_setting; ?>"
                                        <?php if (!empty($k_activity_fk)) {
                                            if ($row->id_setting == $k_activity_fk) {
                                                echo 'selected';
                                            }
                                        } ?>> <?php echo $row->title_setting; ?></option>
                                    <?php
                ...
                <div class="col_md_20 col-sm-6 padding-4 member">
                    ...
                    <div class="col-md-8 col-sm-6  no-padding">
                        <input type="text" name="company_gawal" id="company_gawal" maxlength="10"
                               class="form-control input_style_2" onchange="" value="<?php echo $company_gawal; ?>"
                               data-validation-has-keyup-event="true">
                    </div>
                </div>
                ...
                <div class="col_md_20 col-sm-6 padding-4 member">
                    ...
                    <div class="col-md-8 col-sm-6  no-padding">
                        <input type="text" name="company_phone" id="company_phone" maxlength="10"
                               class="form-control input_style_2" onchange="" value="<?php echo $company_phone; ?>"
                               data-validation-has-keyup-event="true">
                    </div>
                </div>
                ...
                <div class="col_md_25 col-sm-6 padding-4 member">
                    ...
                    <div class="col-md-8 col-sm-6  no-padding">
                        <input type="text" name="company_fax" id="company_fax" maxlength="10"
                               class="form-control input_style_2" onchange="" value="<?php echo $company_fax; ?>"
                               data-validation-has-keyup-event="true">
                    </div>
                </div>
                <!------------------------------------------------------------------------------------------------->
                ...
                <div class="col_md_50 col-sm-6 padding-4 ">
                    ...
                    <div class="col-md-8 col-sm-6  no-padding">
                        <select id="k_message_method" name="k_message_method"
                                onchange="change_method_kafel($(this).val())"
                ...
                if (isset($reasons_stop) && !empty($reasons_stop)) {
                    foreach ($reasons_stop as $row) {
                        ?>
                            ...
                            if ($row->id_setting == $reasons_stop_id_fk) {
                                echo 'selected';
                            }
                        } ?>> <?php echo $row->title_setting; ?></option >
                                        <?php
...
-->
                ...
                <div class="col-md-12">
                    <button type="button" value="" id="add_pluse_kafala_table_rows" onclick="add_kafala_row()"
                            class="btn btn-warning btn-next btn-labeled" style="border-top-left-radius: 14px;border-bottom-right-radius: 14px;    box-shadow: 1px 2px 3px 2px #09704e;">
                       <span class="btn-label"> <i class="fa fa-plus"> </i> </span> إضافة تفاصيل الكفالة
                    </button>
                    <!--                    <button type="button" value="" id="add_pluse_result_Table" onclick="add_kafala_row()" class="btn btn-success btn-next">-->
                    ...
                    <table class="table table-striped table-bordered fixed-table " <?php if (empty($result->details)) { ?>
                            ...
                            foreach ($result->details as $row_detail) {
                                ...
                                <tr>
                                    <td style=" width:12%;text-align: center!important;">
                                        ...
                                        <select name="" id="" data-validation="required" class=" form-control"
                                                disabled="disabled">
                                            <option value="">إختر</option>
                                            <?php
                                    ...
                                    <td style="width:7%;text-align: center!important;">
                                        <input type="text" value="<?= $row_detail->member_num ?>" class="form-control"
                                    ...
                                    <td style="width:10%;text-align: center!important;">
                                        <input type="text" value="<?= $row_detail->kafala_value ?>" class="form-control"
                                               disabled="disabled" data-validation="required">
                                    </td>

                                    <td style="width:21%;text-align: center!important;">
                                        <input type="text" value="<?= $row_detail->all_kafala_value ?>"
                                               readonly="readonly" class="form-control" data-validation="required">
                                    ...
                                    <td style="text-align: center!important;">
                                        ...
                                        <a type="button" class="" data-toggle="modal"
                                           data-target="#myModal<?= $row_detail->id ?>">
                        ...
                        <tr>
                            <td colspan="6"></td>
                            <td>
                                <button type="button" value="" id="add_pluse_kafala_table_rows"
                                        onclick="add_kafala_row()"
                ...
                <div class="col-md-12"><br>
                    ...
                    <div class="form-group col-md-4 col-sm-6 padding-4">
                        ...
                        <button type="submit" id="save" class="btn btn-labeled btn-success " name="add"
            ...
            <div class="col-sm-3 padding-4">
                    <div class="user-widget list-group">
                        <div class="list-group-item heading">
                                                    <img style="width: 100px;" id="blah" class="media-object center-block" src="<?php echo base_url(); ?>/uploads/images/"
