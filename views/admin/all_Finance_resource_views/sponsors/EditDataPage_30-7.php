                ...
                <div id="">
                    ...
                    <?php $date_from='';  $date_to=''; $value=''; $status=''; $reason = ''; if(!empty($result_Kfala_data)){
                        ...
                        if( $result_Kfala_data['person_type'] ==2){
                            if( empty( $result_Kfala_data['second_date_from_ar']) &&
                                ...
                                $reason =$result_Kfala_data['second_kafala_reason'];
                            }
            ...
            <div class="form-group col-md-2  col-sm-6 padding-4">
                ...
                <select id="alert_type"  class="form-control bottom-input "data-validation="required"
                    ...
                    ?>
                                    ...
                                    <div class="form-group col-md-2  col-sm-6 padding-4">
                                        <label class="label top-label">   مده الكفاله  </label>
...
<div class="col-md-12 no-padding">
    <div class="form-group col-md-2  col-sm-6 padding-4">
        ...
        <label class="label top-label">   الأسباب </label>
    ...
    <div class="form-group col-md-2  col-sm-6 padding-4">
        ...
        <small style="color: red;;">رقم الحساب لابد أن يكون24رقم</small>
    </div>
