...
&nbsp;&nbsp;
<button style="margin-right: 3px;" id="cornerExpand" class="btn btn-info   btn-sm progress-button ">
    <span class=""> إسم الكافل </span></button>
<button style="margin-right: 3px;" id="cornerExpand" class="btn btn-info   btn-sm progress-button ">
    <span class=""> <?php echo$result->k_name;?> </span></button>
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu">
     <li><a href="<?php echo base_url(); ?>all_Finance_resource/sponsors/Sponsor/addSponsor_maindata/<?php  echo $result->id; ?>">البيانات
                الاساسية </a></li>
        <li><a href="<?php echo base_url(); ?>all_Finance_resource/sponsors/Sponsor/addKfala_data/<?php  echo $result->id; ?>"> بيانات  الكفالة</a></li>
