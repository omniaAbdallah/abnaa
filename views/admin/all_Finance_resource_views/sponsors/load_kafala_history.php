            ...
            <tr>
                ...
                <td>
                    <?php if (!empty($row->person_name)) {
                        ?>
                        <span style="font-size: 12px; color: #001dad  !important;" title="<?= $row->person_name ?>"><?php echo character_limiter($row->person_name, 15) ?></span>
                        <?php
                    } else {
                        echo 'غير محدد';
                    }
                ...
                <td style="background-color:<?php echo $kafala_color_row; ?>;">
                    ...
                    if ($row->first_status == 1) { ?>
                        <button style="padding: 0px 10px ;" type="button"
                                class="btn btn-sm btn-<?php echo $class_days_left; ?> btn-rounded">
                ...
                <td>
                    <span style="font-size: 12px; color: #001dad " title="<?= $row->publisher_name ?>"><?php echo character_limiter($row->publisher_name, 15) ?></span>
                </td>
                <td>
                     <span style="font-size: 12px; color: #001dad !important ;"
                           title="<?= $row->date_ar . ' ' . $row->time ?>"><?php echo $row->date_ar ?></span>
                </td>
            </tr>
            <?php
        }
