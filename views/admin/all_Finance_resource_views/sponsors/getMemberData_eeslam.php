 ...
 <div class="form-group col-md-2  col-sm-6 padding-4">
        	  ...
        	  <div id="cal-22" style="width: 50%;float: right;">
					  <input id="mostadem-date-Hijri" name="mostdem_from_date_h"
                       class="form-control bottom-input" disabled="disabled"  
                          type="text"  onfocus="showCal22();" value="" 
                             style=" width: 100%;float: right"/>
			...
			<div id="cal-end-22"  style="width: 50%;float: right;">
					 <input id="mostadem-date-Hijri-end"  name="mostdem_to_date_h"
                       class="form-control bottom-input " type="text" disabled="disabled"  
                     onfocus="showCalEnd22();" value="" style=" width: 100%;float: right"/>
