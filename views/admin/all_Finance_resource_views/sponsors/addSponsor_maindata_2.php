...
<div class="col-sm-12 no-padding " >
    <div class="col-sm-9 " >
        <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
            <div class="panel-heading">
                ...
                <div class="pull-left">
                    <?php if(isset($result) && !empty($result)){
                        ...
                        $data_load['k_status_data'] = $k_status_data;
            ...
            <div class="panel-body">
             ...
             <div class="form-group col-md-2 col-sm-6 padding-4">
                        <label class="label top-label""> جوال الكافل <span class="span-allow"> (10ارقام) </span></label>
                        <input type="text" name="k_mob" maxlength="10" onkeyup="get_length($(this).val(),'tel');"
                            <?php if($social_status_id_fk !=''){ if($social_status_id_fk == 0){ echo 'disabled="disabled"'; }}?>
                               data-validation="required" id="k_mob" value="<?php echo $k_mob;?>"
                               class="form-control bottom-input"
                               data-validation-has-keyup-event="true"  onkeypress="validate_number(event);">
        ...
        <div class="form-group col-md-2 col-sm-6 padding-4">
           ...
           <select name="wakel_relationship"  id="wakel_relationship" data-validation="required" aria-required="true" data-show-subtext="true" data-live-search="true" 
                    ...
                    <div class="form-group col-md-2 col-sm-6 padding-4">
                        ...
                        <input type="text" name="w_mob" id="w_mob"
                          ...
                          <div class="form-group col-md-2 col-sm-6 padding-4">
                             ...
                             <select id="city_id_fk" name="k_city" onchange="getAhai($(this).val());"  class="form-control bottom-input" data-validation="required">
                                 <option value="">إختر</option>
                                 <?php
    ...
    <div class="form-group col-md-3 col-sm-6 padding-4">
                        <label class="label top-label">هل ترغب المراسلة عن طريق رسائل الجوال</label>
                            ...
                            foreach ($records as $record) {
                                ...
                                <tr>
                                    ...
                                    <td><?php if (!empty($fe2a_type_arr[$record->k_status])) {
                                            echo $fe2a_type_arr[$record->k_status];
                                        } else {
                                            echo 'غير محدد';
                                        } ?></td>
                                    <td>
