...
if(isset($result)&&!empty($result))
{
    ...
    $out['form']='all_Finance_resource/sponsors/Sponsor/addSponsor_maindata_orders/'.$this->uri->segment(5);
}else{
    ...
    $out['form']='all_Finance_resource/sponsors/Sponsor/addSponsor_maindata_orders';
        ...
        <div class="modal fade" id="myModal<?=$row2->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document" style="width: 90%">
                <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('all_Finance_resource/sponsors/Sponsor/updateSponsorOrdersDetails/'.$row2->id.'/'.$result->id); ?>
...
<td>
    <a href="<?=base_url()?>all_Finance_resource/sponsors/Sponsor/addSponsor_maindata_orders/<?=$record->id ?> "><i
          title="تعديل الطلب"  class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
    <a data-toggle="modal" <?= $link ?> data-target="#modal-delete"
       title="حذف"> <i class="fa fa-trash"
                       aria-hidden="true"></i> </a>
</td>
...
<script>
    ...
    {
        var link='<?= base_url()?>all_Finance_resource/sponsors/Sponsor/delete_sponsor_orders/'+id;
        $('#adele').attr('href', link);
    }

    function modalLlink(id,kafel_id)
    {
        var link='<?= base_url()?>all_Finance_resource/sponsors/Sponsor/deleteOrdersDetails/'+id+'/'+kafel_id;
        $('#adele').attr('href', link);
    }
...
//         $("#resultTable").append(x);
        ...
        $.ajax({
            type:'post',
            url: '<?php echo base_url() ?>all_Finance_resource/sponsors/Sponsor/getkafalaRow',
            data:dataString,
            dataType: 'html',
            cache:false,
