...
<?php
if($row_kafala->first_status == 1){ ?>
<button style="padding: 0px 10px !important;" type="button" id="period_days_td<?php echo $row_kafala->id; ?>" class="btn btn-sm btn-<?php echo $class_days_left; ?> btn-rounded">
    ...
    <div class="modal-dialog " role="document" style="width: 95%">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="myModalLabel">تجديد بيانات كفالة</h5>
            </div>
    ...
    function updateKfala_data_dete() {
        ...
        $.ajax({
            ...
            success: function (html) {
                ...
                const diffTime = Math.abs(to_date - current_date);
                ...
                if (diffDays > 0){
                    $('#period_days_td' + id).text(diffDays + "أيام");
                    $('#period_days_td' + id).addClass("btn btn-sm btn-success");

                }else {
                    $('#period_days_td' + id).text("0 أيام");
                    $('#period_days_td' + id).addClass(" btn btn-sm btn-danger");
