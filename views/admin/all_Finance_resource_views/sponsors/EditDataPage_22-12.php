...
<div class="col-md-12 no-padding">
    ...
    <div class="form-group col-md-2  col-sm-6 padding-4">
        ...
        <input type="date" name="mostdem_from_date"
               id="mostdem_from_date"  <?php if( $result_Kfala_data['pay_method'] !=7 ){ ?>    disabled="disabled"  <?php } ?>
    ...
    <div class="form-group col-md-2  col-sm-6 padding-4">
        ...
        <input type="date" name="mostdem_to_date"
               id="mostdem_to_date"  <?php if( $result_Kfala_data['pay_method'] !=7 ){ ?>    disabled="disabled"  <?php } ?>
