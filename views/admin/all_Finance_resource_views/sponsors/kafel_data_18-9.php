 ...
 <div class="col-sm-12 no-padding " >
        <div class="col-sm-9 " >
            <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
              ...
              <option value="0" <?php //if($social_status_id_fk==0) echo 'selected' ; ?>>(متوفي)</option>
                    ...
                    <div class="col_md_20 col-sm-6 padding-4 " >
                        ...
                        <div class="col-md-8 col-sm-6  no-padding">
                            <select id="hai_id_fk" name="k_hai" 
                    ...
                    <div class="col_md_30 col-sm-6 padding-4 ">
                        ...
                        <div class="col-md-7 col-sm-6  no-padding">
                            <input type="email" name="k_email" id="k_email"
                             data-validation="email" value="<?php echo $k_email;?>"
                                   class="form-control input_style_2"
                                            <?php if($k_message_method !=1){  
                                          echo ' disabled="disabled"';
                                           } ?>
                                   data-validation-has-keyup-event="true">
                        </div>
                    ...
                    <div class="col_md_20 col-sm-6 padding-4 ">
                        ...
                        <div class="col-md-6 col-sm-6  no-padding">
                            <input type="text" name="k_barid_box"  id="k_barid_box"
                             class="form-control input_style_2"
                                   <?php if($k_message_method !=2){   
                                     echo ' disabled="disabled"';
                                      } ?>
                    ...
                    <div class="col_md_30 col-sm-6 padding-4 ">
                        ...
                        <div class="col-md-8 col-sm-6  no-padding">
                            <select id="reasons_stop_id_fk"  class="form-control input_style_2"
                                <?php if($halat_kafel_id !=''){ if($halat_kafel_id != 10 ){ 
                                    echo 'disabled="disabled"'; }}?>
                    ...
                    <div class="col-md-12" ><br>
                        ...
                        <div class="form-group col-md-4 col-sm-6 padding-4">
                            ...
                            <button type="submit" id="save" name="add" value="addSponsor_maindata"
                                ...
                                <span><i class="fa fa-floppy-o"></i></span> حفظ وإستمرار
                            </button>
                        </div>
...
<div class="form-group col-md-5 col-sm-6 padding-4">
<button type="button"   data-toggle="modal" onclick="GetDiv('myDiv',1)" data-target="#myModalInfo" 
...
<i class="fa fa-plus"></i>  </button>
 ...
 <!-------------------------------------->                   
   ...
   <br>
                    ...
                    <button type="submit" class="btn btn-labeled btn-add" 
                                 id="save" name="add" value="save_data">
                        <span class="btn-label"><i class="glyphicon glyphicon-floppy-disk"></i></span>حفظ 
                    </button>

                    <button type="submit" class="btn btn-labeled btn-success" 
                                 id="save" name="add" value="addSponsor_maindata">
                        <span class="btn-label"><i class="glyphicon glyphicon-floppy-disk"></i></span>حفظ وإستمرار
                    </button>

                    <button type="submit" class="btn btn-labeled btn-warning" style="color: #002342;"
                          id="save" name="add" value="xyz" >
                        <span class="btn-label"><i class="glyphicon  glyphicon-floppy-disk"></i></span>حفظ وذهاب إلي الكفلاء
                    </button>

       

                    <button type="button" class="btn btn-labeled btn-inverse"
                               data-toggle="modal" onclick="GetDiv('myDiv',1)" data-target="#myModalInfo" >
...
<!--------------------------------------->                    
     ...
     <script>
         ...
         function info(valu)
         {
             window.location.href = "<?php echo base_url();?>all_Finance_resource/sponsors/Sponsor/addSponsor_maindata/"+valu;
         }
