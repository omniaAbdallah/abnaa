...
<div style="height: 100px;"></div>
	...
	<div class="bond-body" style="height: 440px;">
		...
		<div class="col-xs-12 no-padding" style="height: 40px; line-height: 40px;">
			...
			<div class="col-xs-4">
				<h5 style="margin-right: 90px;  "><?=$result->pill_num?></h5>
			</div>
			<div class="col-xs-3">
				<h5 style="float:right;  ">
                <?=$result->pill_date?> م </h5>
			</div>
		</div>
...
<!----------------------------------------->
	...
	<div class="bond-body"  style="position: relative; height: 400px;">
		...
		<div class="col-xs-12 no-padding" style="height: 40px; line-height: 40px;">
			...
			<div class="col-xs-3">
				<h5 style="float:right; "><?=$result->pill_date?> م </h5>
			</div>
		</div>
		<!-- ahmed -->
...
?>
       ...
       setTimeout(function () {
           if(kafel_id !=''){
               ...
               window.location.href ="<?php echo base_url(); ?>all_Finance_resource/all_pills/AllPills/pills_trahel?#Modal&id="+kafel_id;
           }else{
               window.location.href ="<?php echo base_url('all_Finance_resource/all_pills/AllPills/pills_trahel') ?>";
           }
       //window.location.href ="<?php echo base_url('all_Finance_resource/all_pills/AllPills/pills_trahel') ?>";
