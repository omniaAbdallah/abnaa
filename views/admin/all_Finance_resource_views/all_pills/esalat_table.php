...
if (isset($records2) && !empty($records2)) {
    ...
    foreach ($records as $record) { ?>
            ...
            <div class="modal-dialog" style="width: 100%">
                ...
                <div class="modal-content">
                                ...
                                <div class="piece-box" style="margin-bottom: 0;">
                                    ...
                                    <table class="table table-bordered" style="margin-top:4px">
                                        ...
                                        <tr class="open_green">
                                            ...
                                            <td class="text-center"><?php if ($record->fe2a_type == 1) echo "افراد"; else {
                                                    echo "مؤسسات";
                                                } ?></td>
                                        ...
                                        <table class="table table-bordered" style="margin-top:4px">
                                            ...
                                            <tr class="open_green">
                                                ...
                                                <td class="text-center"><?php if (!empty($gender_data[$record->k_gender_fk])) {
                                                        echo $gender_data[$record->k_gender_fk]->title_setting;
                                                    } else {
                                                        echo 'غيرمحدد';
                                                    } ?></td>

                                                <td class="text-center"><?php if (!empty($nationality[$record->k_nationality_fk])) {
                                                        echo $nationality[$record->k_nationality_fk]->title_setting;
                                                    } else {
                                                        echo 'غيرمحدد';
                                                    } ?></td>
                                                <td class="text-center"> <?php if (!empty($type_card[$record->k_national_type])) {
                                                        echo $type_card[$record->k_national_type]->title_setting;
                                                    } else {
                                                        echo 'غيرمحدد';
                                                    } ?></td>
                                        ...
                                        <table class="table table-bordered" style="margin-top:4px">
                                            ...
                                            <tr class="open_green">
                                                <td class="text-center"><?php if (!empty($record->k_national_num)) {
                                                        echo $record->k_national_num;
                                                    } else {
                                                        echo 'غيرمحدد';
                                                    } ?></td>
                                                <td class="text-center"><?php if (!empty($dest_card[$record->k_national_place])) {
                                                        echo $dest_card[$record->k_national_place]->title_setting;
                                                    } else {
                                                        echo 'غيرمحدد';
                                                    } ?></td>
                                    ...
                                    <table class="table table-bordered" style="margin-top:4px">
                                        ...
                                        <tr class="open_green">
                                            ...
                                            <td class="text-center"><?php if (!empty($record->right_time_from)) {
                                                    echo $record->right_time_from;
                                                } else {
                                                    echo 'غيرمحدد';
                                                } ?> : <?php if (!empty($record->right_time_to)) {
                                                    echo $record->right_time_to;
                                                } else {
                                                    echo 'غيرمحدد';
                                                } ?></td>
                                    ...
                                    <table class="table table-bordered" style="margin-top:10px">
                                        ...
                                        echo $record->banks_settings_title;
                                    } else {
                                        echo 'غيرمحدد';
                                    } ?></td>
                                    ...
                                    <table class="table table-bordered" style="margin-top:4px">
                                        <tr class="closed_green">
                                            ...
                                            <td class="text-center" style="width: 45%">هل ترغب المراسلة عن طريق رسائل
                                                الجوال
                                            </td>
                                        ...
                                        <tr class="open_green">
                                            ...
                                            <td class="text-center"><?php if (!empty($k_message_mob_arr[$record->k_message_mob])) {
                                                    echo $k_message_mob_arr[$record->k_message_mob];
                                                } else {
                                                    echo 'غيرمحدد';
                                                } ?></td>
                            ...
                            <div class="col-sm-3">
                                <div class="piece-box">
                                    <?php if (!empty($record->person_img)) { ?>
                                        <img src="<?php echo base_url(); ?>uploads/images/<?php echo $record->person_img; ?>"
                                             class="center-ييblock" style="width: 150px; padding: 10px">
                                    <?php } ?>
                    ...
                    <div class="modal-footer" style="border: 0;">
                        <button type="button" class="btn btn-default btn-close-model" data-dismiss="modal">إغلاق
                        </button>
                    </div>
                </div>
        ...
        <div class="modal fade" id="myModal_attach<?php echo $record->id; ?>" tabindex="-1" role="dialog"
...
<div class="col-sm-12 no-padding ">
    <div class="col-sm-2 padding-4">
        <h6 class="label_title_1 ">من تاريخ </h6>
        <input type="date" onchange="get_date_esalat_tarhil()"
               id="from_date" value="<?= date('Y-m-01') ?>"
               class="form-control  ">
    </div>
    <div class="col-sm-2 padding-4">
        <h6 class="label_title_1 "> إلى تاريخ </h6>
        <input type="date" onchange="get_date_esalat_tarhil()"
               id="to_date" value="<?= date('Y-m-d') ?>"
               class="form-control  ">
    </div>
    <div class="col-md-3 col-sm-6 padding-4">
        <h6 class="label_title_1 ">إسم المحصل
        </h6>
        ...
        $_SESSION['user_id'] == 69 ||
          ...
          $_SESSION['user_id'] == 65 || 
          $_SESSION['user_id'] == 94 || 
          $_SESSION['user_id'] == 107 ||  $_SESSION['user_id'] == 111 ||  $_SESSION['user_id'] == 116 ) { ?>
            <select name="user_id" id="user_id" data-validation="required" class="form-control  "
                    onchange="get_date_esalat_tarhil()">
                <option value="all">الكل</option>
                <?php if (isset($all_emps) && (!empty($all_emps))) {
                    foreach ($all_emps as $eeemp) {
                        ?>
                        <option value="<?= $eeemp->emp_user_id . '-' . $eeemp->emp_name; ?>"><?= $eeemp->emp_name ?></option>
                        <?php
                    }
                } ?>
            </select>
