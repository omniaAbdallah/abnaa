                    ...
                    <table id="" class=" example display table table-bordered  table-striped  responsive nowrap" cellspacing="0" width="100%">
                        ...
                        foreach ($all_pills_warda as $row){
                            ...
                            <tr>
                                ...
                                <td><?=$row->pill_num?></td>
                                <td><?=$row->pill_date?></td>
                                <td> <span style="font-size: 12px; color: white !important;
                                  background-color: #298fa9; "
                             class="badge badge-add"><?php echo date('H:i:sa',$row->date_s) ;?> </span></td>
...
<script>
    function update_kafala_option(row_id) {
        ...
        // var motb3a_option_fk= $("input[name='motb3a_option_fk[]']:checked").val();
        // console.log("motb3a_option_fk :: " + motb3a_option_fk);
        ...
        if (motb3a_option_fk.length != 0){
          ...
          swal({
                  title: 'من فضلك حدد الاختيار اولا !',
                  text: "",
                  type: "warning",
                  confirmButtonClass: "btn-warning",
