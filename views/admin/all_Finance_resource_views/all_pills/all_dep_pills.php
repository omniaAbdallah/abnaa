  ...
  <!--  <div class="panel-heading">
        ...
        <div class="col-md-8 text-center">
         <div id="circle_counter" style="background: green;">
            <div class=" counter" data-count="<?php echo round($all_money_today['total_nakdy'],2); ?>">0</div> 
            <span>نقدي</span>&nbsp;&nbsp;
            
            
            </div>
            <div id="circle_counter"  style="background: #b31616;">
            <div class=" counter" data-count="<?php echo round($all_money_today['total_chabka'],2); ?>">0</div> 
            <span>شبكة</span> &nbsp;&nbsp;
            
            
            </div>
            <div id="circle_counter"  style="background: #b77b09;">
            <div class=" counter" data-count="<?php echo round($all_money_today['total_cheq'],2); ?>">0</div> 
            <span>شيك</span>&nbsp;&nbsp;
            ...
            <div class=" counter" data-count="<?php echo round($all_money_today['total_eda3_nakdy'],2); ?>">0</div> 
            <span>إيداع نقدي</span>&nbsp;&nbsp;
            
            
            </div>
                  <div id="circle_counter" style="background: #79790d;">
            <div class=" counter" data-count="<?php echo round($all_money_today['total_eda3_cheq'],2); ?>">0</div> 
            <span>إيداع شيك</span>&nbsp;&nbsp;
            ...
            <div class=" counter" data-count="<?php echo round($all_money_today['total_tahwel'],2); ?>">0</div> 
            <span>تحويل</span>&nbsp;&nbsp;
           ...
           <div id="circle_counter" style="background: #6d2147;">
            <div class=" counter" data-count="<?php echo round($all_money_today['total_amr_mostdem'],2); ?>">0</div> 
    ...
    <div class="panel-body">
        ...
        <div class="col-xs-12 text-center" >
            ...
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tab1" data-toggle="tab">الإيصالات  مرحلة</a></li>
                            ...
                            if(!empty($all_pills_inbox)){?>
                                ...
                                foreach($all_pills_inbox as $row){
                                    ...
                                    <tr>
                                        ...
                                        </a><?php }else{ echo'<i class="fa fa-paperclip red" aria-hidden="true"></i>';} ?>
