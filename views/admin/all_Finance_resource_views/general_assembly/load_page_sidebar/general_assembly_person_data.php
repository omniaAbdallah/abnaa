        ...
        <div class="panel-body">
            <div class="col-md-12 no-padding">
                <div class="user-widget list-group">
                    ...
                    <td><?php if(!empty($result)){  echo $result->name;}?></td>
                    </tr>
                    
                    
                     <tr>
                    <th><strong class="text-danger ">رقم العضوية </strong></th>
                    <td><?php if(!empty($result->membership_num)){ echo $result->membership_num;}?></td>
                    </tr>
                    
                     <tr>
                    <th><strong class="text-danger ">رقم الجوال</strong></th>
                    <td><?php if(!empty($result)){ echo $result->mob;}?></td>
                    </tr>
                    
                     <tr>
                    <th><strong class="text-danger ">رقم الهوية</strong></th>
                    <td> <?php if(!empty($result)){ echo  $result->card_num;}?></td>
                    </tr>
                    
                     <tr>
                    <th><strong class="text-danger ">رقم قرار المجلس</strong></th>
                    <td><?php if(!empty($result)){ /*echo  $personal_data[0]->manger_name;*/}?></td>
                    </tr>
                    </tbody>
                    </table>
                </div>
