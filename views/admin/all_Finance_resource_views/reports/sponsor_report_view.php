        ...
        <div class="panel-body">
            ...
            <div class="col-sm-12">
                ...
                <div class="form-group col-md-2 col-sm-6 col-xs-12 padding-4">
                    ...
                    <select class="form-control selectpicker" data-validation="required" multiple
                      ...
                      $pay_method_arr =array('الكل','نقدي','شيك','إيداع نقدي','إيداع شيك','تحويل','شبكة','أمر مستديم');
                        if(isset($pay_method_arr)&&!empty($pay_method_arr)) {
                            for($a=0;$a<sizeof($pay_method_arr);$a++){
                                ?>
...
<script>
    ...
    function GetDiv(div,valu) {
        ...
        var oTable_usergroup = $('#js_table_members').DataTable({
            dom: 'Bfrtip',
            "ajax": '<?php echo base_url(); ?>all_Finance_resource/reports/Reports/get_khafel_code',
