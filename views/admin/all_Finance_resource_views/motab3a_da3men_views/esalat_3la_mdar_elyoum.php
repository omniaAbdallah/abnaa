...
<script type="text/javascript">
    $(document).ready(function() {
        var oTable_usergroup = $('#js_table_customer').DataTable({
            dom: 'Bfrtip',
            "ajax": '<?php echo base_url(); ?>all_Finance_resource/motab3a_da3men/Motab3a_da3men/all_esalat_json/1',
            aoColumns:[
...
<div class="modal fade" id="modal-mota3a" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url();?>all_Finance_resource/motab3a_da3men/Motab3a_da3men/insert_motab3a" method="post">
            <div class="modal-body">
                ...
                <div class="col-md-12 no-padding">
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" readonly value="<?php echo date('Y-m-d');?>" name="day_date_ar" id="day_date_ar"  placeholder="">
                    </div>
                    <div class="col-md-3">
                        <label for="">وقت الإتصال</label>
                        <input type="time"  class="form-control"  readonly value="<?php echo date('H:i:s');?>" name="waqt_etsal" id="waqt_etsal"  placeholder="">
                    </div>
                    <div class="col-md-3">
                        <label for="">نتيجة الإتصال</label>
                        <input type="text" class="form-control"   data-validation="required"  value=" " name="natega_etsal" id="natega_etsal">
                    </div>
                    <div class="col-md-3">
                        <label for="">إنطباعه عن الجمعية</label>
                        <input type="text"  class="form-control"   data-validation="required"  value=" " name="entba3_for_gam3ia" id="entba3_for_gam3ia"  >
                    </div>


                    <div class="col-md-4">
                        <label for="">رأيه بالخدمة المقدمة له من الجمعية</label>
                        <input type="text"  class="form-control"   data-validation="required"  name="opinion_khedma" id="opinion_khedma"  >
                    </div>
                    <div class="col-md-3">
                        <label for="">تقييم الموظف</label>
                        <input class="rating" type="hidden" class="hidden" value="4" name="emp_taqeem_fk" >
<!--                      <input type="number" name="emp_taqeem_fk" id="emp_taqeem_fk"  class="form-control" data-validation="required"/>
-->                    </div>
                    <div class="col-md-4">
                        <label for="">ملاحظات</label>
                        <input type="text"  class="form-control"   data-validation="required"   name="notes" id="notes"  >
                    </div>
