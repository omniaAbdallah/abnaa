    ...
    function Popup(data) 
    {
     ...
     document.body.innerHTML = originalContents;
        ...
        <?php if(isset($records)&&$records!=null): ?>
               ...
               <div class="col-md-12" >
               <button class="btn btn-xs-avatar-title hidden-print" style="margin-right: 95%;" onclick="PrintElem('#mydiv')" >
               <i class="fa fa-print" aria-hidden="true"></i> طباعة</button> 
                 
               <h5 class=" pop-title-text"><?=$txt?> :<span> <?=sizeof($records); ?></span></h5>
               </div>
                <div class="col-xs-12">
                                ...
                                <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center hidden-print">تفاصيل</th>
                                        </tr>
                                    </thead>
