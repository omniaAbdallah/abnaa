...
<i class="fa fa-print" aria-hidden="true"></i></a>
    ...
    <a href="<?php echo base_url()?>disability_managers/Reasercher/Add_researcher_opinion/<?=$record->id?>" > 
    <button class="btn btn-success  btn-xs" style="">إضافة راي الباحث</button></a>
    <a  target="_blank" href="<?php echo base_url()?>disability_managers/Reasercher/print_me/<?=$record->id?>" > 
