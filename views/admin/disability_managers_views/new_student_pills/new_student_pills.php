...
<?php echo form_open_multipart('disability_managers/New_member_pill/new_member_pills'); ?>
<div class="col-sm-12">
                <div class="form-group col-sm-12 col-xs-12">
                    <label class="label label-green  half">الطلاب </label>
                     <select name="student_code" id="student_code" class="selectpicker form-control half"  data-show-subtext="true" data-live-search="true" data-validation="required" onchange="return ajaxSearch($(this).val());" >
                            <option value="">--قم بإختيار إسم الطالب--</option>
                            <?php 
        ...
        <div class="col-sm-12">
                ...
                <div class="form-group col-sm-4 col-xs-12">
                    <label class="label label-green  half">إسم الطالب</label>
...
<script type="text/javascript">
    function ajaxSearch(student_code)
    {
        var inputs = $('.dt');
        ...
        if(student_code){
            var dataString = 'student_code=' + student_code;
            $.ajax({
                type:'post',
                url: '<?php echo base_url() ?>disability_managers/New_member_pill/get_student_other',
                data:dataString,
                cache:false,
          ...
          $.ajax({
                type:'post',
                url: '<?php echo base_url() ?>disability_managers/New_member_pill/get_member_remain',
                data:dataString,
                cache:false,
                success: function(d){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>disability_managers/New_member_pill/getTable",
                data: dataString,
                dataType: 'html',
                cache:false,
