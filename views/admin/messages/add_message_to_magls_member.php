<div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
    ...
    <div class="panel-body">
        ...
        <?php  echo form_open_multipart('Sending/add_messageTo_magls_members')?>
        <div class="col-xs-12">
            <div class="col-md-12  col-sm-12 col-xs-12 inner-side r-data">
                <div class="col-xs-12">
                    <div class="col-xs-3">
                        <h4 class="r-h4"> اسم العضو </h4>
                    </div>
                        ...
                        <select name="phone_num[]" class="selectpicker form-control" id="id_label_multiple" multiple="multiple" data-validation="required"  aria-required="true" >
                            ...
                            <?php if(!empty($members)):
                                foreach ($members as $record):?>
                                    <option value="<?php echo $record->id;?>"><?php echo $record->member_name;?></option>
                    ...
                    <div class="modal fade" id="myModal<?php echo $record->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="col-sm-3" style="font-size: 16px;">كود العضو</div>
                    ...
                    <div class="modal fade" id="d<?= $record->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form action="<?php echo base_url('Sending/delete_FromMagls_members_Messages').'/'.$record->id ?>">
