<div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
    ...
    <div class="panel-body">
            ...
            <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-6 r-input">
                        <select name="emp_depart[]" class="selectpicker  form-control  " multiple="multiple" data-validation="required" aria-required="true">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-6 r-input">
                        <input type="number" name="phone_num" data-validation="required">
                    </div>
                </div>
            </div>
            <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-6 r-input">
                        <input type="text" id="num"  data-validation="required">
        ...
        <div class="col-xs-12 ">
            ...
            <div class="col-xs-12">
                <div class="col-xs-3">
                    <h4 class="r-h4">   <div style="font-size: small">محتوي الرسالة</div> </h4>
                </div>
        ...
        <div class="col-xs-12 r-inner-btn">
            ...
            <div class="col-xs-3">
                <input type="submit" style="float:left;" role="button" name="save" value="ارسال" class="btn-success form-control">

            </div>
            <?php echo form_close()?>
            <div class="col-xs-1" style="">
                <button style="float: right;" class="btn-success form-control" > عودة </button>
            </div>
