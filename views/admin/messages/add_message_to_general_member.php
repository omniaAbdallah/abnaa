<div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
    ...
    <div class="panel-body">
        ...
        <?php  echo form_open_multipart('Sending/add_messageTo_general_members')?>
        <div class="col-xs-12">
            ...
            <table id="example" class=" display table table-bordered   responsive nowrap" cellspacing="0" width="100%">
                ...
                foreach($records as $record):
                    ...
                    <tr>
                        ...
                        <td><?php echo $record->general_member_mob;?></td>
                    ...
                    <div class="modal fade" id="d<?= $record->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form action="<?php echo base_url('Sending/delete_From_general_members_Messages').'/'.$record->id ?>">
