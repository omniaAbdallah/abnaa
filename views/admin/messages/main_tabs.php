<div class="col-xs-12 r-side-table">
                    <div class="col-sm-9">
                        <h4> <span> <i class="fa fa-male" aria-hidden="true"></i></span> التراسل</h4>
                    </div>
                   <div class="col-sm-3">
                 ...
                 <?php $arr=array('add_message'=>"إضافة رسالة لموظف",
                                  'add_message_dep'=>" إضافة رسالة لقسم"); ?>
                      <?php foreach($arr as $key=>$value):
                          ...
                          if(isset($update_link) && $update_link !=null){
                           ...
                           ?>
                              <li <?php echo $active;?>  ><a  href="<?php echo base_url()."Sending/".$key?>">
