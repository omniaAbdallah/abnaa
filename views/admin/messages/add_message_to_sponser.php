<div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
    ...
    <div class="panel-body">
        ...
        <?php  echo form_open_multipart('Sending/add_messageToSponsor')?>
        <div class="col-xs-12">
            <div class="col-md-12  col-sm-12 col-xs-12 inner-side r-data">
                <div class="col-xs-12">
                    <div class="col-xs-3">
                        <h4 class="r-h4"> الكفيل </h4>
                    </div>
            ...
            <table id="example" class=" display table table-bordered   responsive nowrap" cellspacing="0" width="100%">
                ...
                foreach($records as $record):
                    ...
                    <tr>
                        ...
                        <td><?php echo $record->sponser_mob;?></td>
                    ...
                    <div class="modal fade" id="myModal<?php echo $record->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="col-sm-3" style="font-size: 16px;">كود الكفيل</div>
                                <div class="col-sm-9"  style="font-size: 16px;">
                                    <?php echo $record->id?>
                                </div>
                                <br />
                                <div class="col-sm-3" style="font-size: 16px;">إسم الكفيل</div>
                                <div class="col-sm-9"  style="font-size: 16px;">
                    ...
                    <div class="modal fade" id="d<?= $record->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form action="<?php echo base_url('Sending/delete_messageFromSponser').'/'.$record->id ?>">
