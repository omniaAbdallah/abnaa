    ...
    <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            ...
            if(isset($get_nabza) && $get_nabza!=null){
                $form = form_open_multipart("admin/nbza/Nbza/Update/".$get_nabza->id);
            } else{
                $form =form_open_multipart("admin/nbza/Nbza/add_nabza");
            }
            ?>
            <?php echo  $form;
            ?>
...
<div class="col-xs-12">
    ...
    if (isset($nabza)&& !empty($nabza)){
        ...
        <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
            ...
            <div class="panel-heading">
                <h3 class="panel-title">  النبذة</h3>
            </div>
            <div class="panel-body">
                <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    foreach ($nabza as $row){
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?=base_url()."admin/nbza/Nbza/Delete/".$row->id?>"  onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
                                    <i class="fa fa-trash" aria-hidden="true" title="حذف"></i> </a>
                                <a href="<?=base_url()."admin/nbza/Nbza/Update/".$row->id?>">
