<div class="col-xs-12 r-side-table">
    <div class="col-sm-9">
        <h4> <span> <i class="fa fa-briefcase" aria-hidden="true"></i></span>إدارة التركيبات </h4>
    </div>
    <div class="col-sm-3">
...
<div class="col-xs-12 r-bottom">
    <div class="panel-heading">
        ...
        <li class="<?php if(isset($standard)) echo $standard; ?>"><a href="<?php echo base_url()?>Products/standard/0">إضافة معايير لتركيبات الأصناف</a></li>
          ...
          <!--li class="<?php if(isset($index)) echo $index; ?>"><a href="<?php echo base_url()?>"> المعايير</a></li-->
