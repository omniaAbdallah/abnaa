<div class="panel-heading">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="<?php echo  base_url()."Family/update_mother/".$mother_national_num_fk;?>">البيانات الزوجة </a></li>
        ...
        <li><a href="<?php echo  base_url()."Family/update_attach_files/".$mother_national_num_fk;?>"> إرفاق الوثائق</a></li>
        <li><a href="<?php echo  base_url()."Family/researcher_opinion/".$mother_national_num_fk;?>"> رأى الباحث الاجتماعى</a></li>S
    </ul>
</div>