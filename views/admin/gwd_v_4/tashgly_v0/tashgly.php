    ...
    <div class="col-xs-12 no-padding">
        ...
        <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
            ...
            <div class="panel-heading">
                ...
                <h3 class="panel-title">الخطط التشغليه </h3>
                        ...
                        <tr>
                            ...
                            <th class="text-center" style="width: 53px;">
                                <button type="button" data-toggle="modal" data-target="#Modal_strategy"
                                    ...
                                    <i class="fa fa-plus"></i>أنشاء خطط تشغيليه</button></th>


                            <th>رقم الخطه</th>
                            <th class="text-center"> الخطه التشغليه</th>
    ...
    <div class="modal-dialog" role="document" style="width: 60%">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modal_header"> أنشاء خطط تشغيليه</h4>
            </div>
...
<script>
    ...
    function load_add_tashgly() {
        $('#modal_header').text(' أنشاء خطط تشغيليه');
    ...
    function get_tashgly(id) {
        ...
        $('#modal_header').text(' تعديل الخطط التشغيليه');
