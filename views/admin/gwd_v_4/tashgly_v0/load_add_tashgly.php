    ...
    ?>
                    ...
                    <div class="col-md-12 no-padding">
                        ...
                        <div class="form-group col-md-12 col-sm-6 padding-4">
                            <label class="label ">رقم الخطه</label>
                            <input type="text" name="pln_rkm" id="pln_rkm" value="<?php echo $pln_rkm; ?>"
                                   class="form-control "
                                <?php if (!empty($pln_rkm)) {
                                    echo 'readonly';
                                } else {
                        ...
                        <div class="form-group col-md-12 col-sm-6 col-xs-6 padding-4">
                            <label class="label ">أسم الخطه</label>
                            <input type="text" name="pln_name" id="pln_name"
                                   value="<?= $pln_name ?>"
                                   class="form-control bottom-input" data-validation="required">
                        </div>
                        <div class="form-group col-md-12 col-sm-6 col-xs-6 padding-4">
                            <label class="label ">وصف الخطه</label>
                        ...
                        <div class="form-group col-md-12 col-sm-6 col-xs-6 padding-4">
                            <label class="label "> الخطه الاستراتيجه</label>
                        ...
                        <div class="form-group col-md-12 col-sm-6 col-xs-6 padding-4">
                            <label class="label ">مراجع الخطه</label>
                            <input type="hidden" name="pln_reviser_emp_code" id="pln_reviser_emp_code" value="<?=$pln_reviser_emp_code?>">
                            <input name="pln_reviser_name" id="pln_reviser_name" data-validation="required"  class="form-control" style="width:84%; float: right;"
                        ...
                        <div class="form-group col-md-12 col-sm-6 col-xs-6 padding-4">
                            <label class="label ">معتمد الخطه</label>
                            <input type="hidden" name="pln_suspender_emp_code" id="pln_suspender_emp_code" value="<?=$pln_reviser_emp_code?>">
                            <input name="pln_suspender_name" id="pln_suspender_name" data-validation="required" class="form-control" style="width:84%; float: right;"
...
<script>
        ...
        function Get_strategy_Name(obj) {
            ...
            document.getElementById(input_id+'_name').value = name;
            document.getElementById(input_id+'_fk').value = emp_code;

            // $("#myModal_emps")modal.('hide');
            $("#myModal_strategy .close").click();
