    ...
    <div class="col-xs-12 no-padding">
        ...
        <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
            ...
            <div class="panel-heading">
                ...
                <h3 class="panel-title">برامج الخطط التشغليه </h3>
                        ...
                        <tr class="info">
                            ...
                            <th class="text-center" style="width: 53px;">
                                <button type="button" data-toggle="modal" data-target="#Modal_strategy"
                                    ...
                                    <i class="fa fa-plus"></i>اضافه برنامج للخطه التشغليه</button></th>
    ...
    <div class="modal-dialog" role="document" style="width: 60%">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modal_header"> أنشاء برنامج   </h4>
            </div>
...
<script>
    ...
    function load_add_tashgly_program(pln_id) {
        $('#modal_header').text(' أنشاء  برنامج');
    ...
    function get_tashgly_program(id,pln_id) {
        ...
        $('#modal_header').text(' تعديل  برنامج');
