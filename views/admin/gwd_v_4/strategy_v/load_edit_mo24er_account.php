...
<div class="col-xs-8 r-input">
    ...
    height: 59px;"id="name" name="name" placeholder="المؤشر" data-validation="required">
                        <?php if (isset($details)) echo $details['name'] ?>     
                        </textarea>
     ...
     <div class="col-xs-8 r-input">           
                            ...
                            <div class="radio-content"><input type="radio" id="rsd<?= $key ?>" name="no3_wehda_quas"
                               ...
                               <div class="col-md-12 col-sm-12 col-xs-12 inner-side r-data">
                    <div class="col-sm-4">
           <label class="">    القيمه السابقه  </label>
     </div>  <div class="col-xs-8 r-input">
                            <input
                                type="text" id="last_value" name="last_value"  onkeypress="validate_number(event)"
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 inner-side r-data">
                    <div class="col-sm-4">
           <label class="">   القيمه المستهدفه  </label>
     </div>  <div class="col-xs-8 r-input">

                               <input
                                type="text" id="want_value" name="want_value"  onkeypress="validate_number(event)"
                                ...
                                data-validation="required">
                                 ...
                                 <div class="col-md-12 col-sm-12 col-xs-12 inner-side r-data">
                    <div class="col-sm-4">
           <label class="">     طريقه الاحتساب  </label>
     </div>  <div class="col-xs-8 r-input">
