    ...
    <div class="modal-dialog" role="document" style="width: 55%;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modal_header">   اضافه خطة استراتيجية</h4>
            </div>
            ...
            <div class="modal-footer" style="display: inline-block;width: 100%">
                ...
                <button type="button" class="btn btn-success" style="    margin-right: 498px; display: inline-block;padding: 6px 12px;"
                        onclick="save_strategy('load_strategy');"
                        id="saves"  data-dismiss="modal">اضافه</button>
