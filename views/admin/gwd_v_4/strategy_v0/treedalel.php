                ...
                <div class="col-sm-12 col-xs-12 no-padding">                    <?php function buildTree($tree)
                    {
                        ...
                        <ul id="tree3">  
                                                  ...
                                                  <div>
                                <li><a data-toggle="modal" data-target="#add_editAccounDalel"
...
">
                    ...
                    <div class="col-sm-12 form-group">
                                ...
                                <div class="col-sm-4  col-md-6 padding-2 ">
                                    <label class="label   ">الهدف الاستراتيجي </label>
                                    <input type="text" name="name" id="hdaf_name" 
                                           value=""
                                           class="form-control ">
                    ...
                    <div class="col-sm-4  col-md-6 padding-2 ">
                                    ...
                                    <input type="number" name="code" id="hdaf_code"
                                           value=""
                                           class="form-control ">
