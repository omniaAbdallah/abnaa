                ...
                <div class="panel-body">
                    <div class="col-sm-2">
                        <ul class="nav nav-tabs tabs-left holiday-month" style="    border: 1px solid gray;">
                            ...
                            <li  role="presentation" >
                                <a <?php if(isset($disabled)){}else{echo 'href="#tab_talb"';} ?>  aria-controls="tab_device" role="tab" data-toggle="tab"  ><i class="fa fa-cog" aria-hidden="true"></i>نوع الطلب</a>
                            </li>
                    ...
                    <div class="tab-pane fade in <?php if(isset($typee) && !empty($typee)&& $typee === "tab_device") {echo  'active'; }else if(isset($typee) && empty($typee)&& $typee !== "tab_modals" && $typee !== "tab_brands"){echo  'active';}  ?>" id="tab_device">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a onclick='swal({
                                                            ...
                                                            function(){
                                                            window.location="<?php echo base_url().'technical_support/device_card/Settings/UpdateSittingbrands/'.$value->id.'/tab_brands' ?>";
                                                            });'>
                                                        ...
                                                        <a onclick=' swal({
                                                            ...
                                                            setTimeout(function(){window.location="<?=base_url()."technical_support/device_card/Settings/DeleteSittingbrands/tab_brands/".$value->id?>";}, 500);
                                                            });'>
                         ...
                         <div class="tab-pane fade in <?php if(isset($typee) && !empty($typee)&& $typee === "tab_talb") {echo  'active'; } ?>" id="tab_talb">
                            <div class="panel-body">
                                <a href="#" class="btn btn-add btndate" data-toggle="modal" data-target="#addholiday" style="margin-bottom: 6px;"> <strong>
                                        <i class="fa fa-cog" aria-hidden="true"></i>نوع الطلب</strong></a>
                                <div class="table-responsive">
                                    <?php
                                    if(isset($brand) && !empty($brand) && $brand!=null){
                                        echo form_open_multipart('technical_support/device_card/Settings/UpdateSittingbrands/'.$brand['id'].'/tab_talb');
                                    }
                                    else{
                                        echo form_open_multipart('technical_support/device_card/Settings/AddSittingbrands/'.'tab_talb/'. 0);
                                    }
                                    ?>
                                    <div class="form-group col-sm-6 col-xs-12">
                                    ...
                                    <?php if (isset($talb) && !empty($talb) && $talb !=null){ ?>
                                        <table class="table table-bordered table-striped table-hover">
                                            <thead>
                                            <tr class="info">
                                                <th>م</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a onclick='swal({
                                                            ...
                                                            function(){
                                                            window.location="<?php echo base_url().'technical_support/device_card/Settings/UpdateSittingbrands/'.$value->id.'/tab_talb' ?>";
                                                            });'>
                                                            <i class="fa fa-pencil"> </i></a>
                                                        <a onclick=' swal({
                                                            title: "هل انت متأكد من الحذف ؟",
                                                            ...
                                                            function(){
                                                            swal("تم الحذف!", "", "success");
                                                            setTimeout(function(){window.location="<?=base_url()."technical_support/device_card/Settings/DeleteSittingbrands/tab_talb/".$value->id?>";}, 500);
                                                            });'>
                                                            <i class="fa fa-trash"> </i></a>
                                                    </td>
                                                </tr>
