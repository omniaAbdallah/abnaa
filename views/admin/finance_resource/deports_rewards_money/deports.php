                ...
                <div class="panel-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade in active"  id="tab1default">
                            <?php if(isset($all_rewards) && $all_rewards!=null && !empty($all_rewards) ){?>
                                <form id="form_cach">
                                    <table id="no-more-tables" class="table table-bordered" role="table">
                                        <thead>
                                        <tr>
                                            <th class="">
                                                <input type="checkbox" name=""  onclick="checkAll(this,'all_rewards')">
                                            </th>
                                            <th class="">إسم الموظف</th>
                                            <th class="">قيمة المكافأة</th>
                                            <th class="">الشهر  </th>
                                            <th class="">السنة </th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php     $count=1; foreach ($all_rewards as $row){
                                            $total_value=0;
                                            $all=0;
                                           ...
                                           $all +=$total_value;
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" name="select-all[]" value="<?php echo $all."-".$row->id;  ?>" class="all_rewards"></td>
                           ...
                           <?php }else{?>
                                <div class="alert alert-danger alert-dismissable">
                                    ...
                                    <strong>لا يوجد !</strong> مكافأت للترحيل .
                                </div>
                            <?php } ?>
                        </div>
...
<script>
    function deport(name_form,div_name){
        ...
        $.ajax({
            type:'post',
            url: '<?php echo base_url() ?>Finance_resource/DeportrewardsMoney',
            data:dataString,
            dataType: 'html',
            cache:false,
