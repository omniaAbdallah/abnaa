...
if($result[0]->paid_type == 5 || $result[0]->paid_type == 4 || $result[0]->paid_type == 3 || $result[0]->paid_type == 2){?>
            ...
            <div class="col-xs-6 r-input">
                  ...
                  <select class=" form-control" name="bank_id_fk"  id="bank_id_fk" required >
...
<div class="col-xs-12">
                            ...
                            <div class="col-xs-6 r-input">
                                <select name="account_settings_id_fk" id="account_settings_id_fk"   onchange="return lood($('#account_settings_id_fk').val());" required>
                                    <option value="">إختر</option>
                        ...
                        <div class="col-xs-12" id="optionearea1">
                            ...
                            <div class="col-xs-6 r-input">
                                <select  name="program_id_fk" required>
                                    <option value="">إختر</option>
