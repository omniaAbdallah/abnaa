...
<?php if($type ==1):?>
        <div class="col-xs-12">
            ...
            <div class="col-xs-6 r-input">
                <select class=" form-control" name="person_id"  id="person_id"  data-show-subtext="true" data-live-search="true" required>
 ...
 <?php elseif ($type ==2):?>
  ...
  <?php endif;?>
    <div class="col-xs-12">
        ...
        <div class="col-xs-6 r-input">
            <input type="number" class="r-inner-h4" name="value" required>
        </div>
    </div>
        ...
        <div class="col-xs-6 r-input">
                                      <select name="payment_type"  id="payment_type" onchange="return load22($('#payment_type').val());" required>
                                    <option value="">إختر</option>
...
<div  id="optionearea6">
        ...
        <div class="col-xs-6 r-input">
            <input type="text" class="r-inner-h4" name="detail" required>
        </div>
    </div>
