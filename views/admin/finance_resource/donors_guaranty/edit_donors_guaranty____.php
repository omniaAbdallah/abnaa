                        ...
                        <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                            ...
                            <?php if($results[0]->type==2){?>
                                ...
                                <div class="col-xs-12" id="contract_id_c " style="display: none">
                                    ...
                                    <div class="col-xs-6 r-input">
                                        <input type="text" class="r-inner-h4" onkeypress="return isNumberKey(event)" value="<?php if(!empty($results[0]->num_payments)){echo $results[0]->num_payments;}  ?>" name="num_payments" required />
                                    </div>
                                </div>
                            <?php }else{?>
