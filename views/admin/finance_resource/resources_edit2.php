			...
			<div class="details-resorce">
				...
				<div class="col-xs-12 r-inner-details">
					<table style="width:100%">
						...
						<? $arrayz =array('','national_id_img'=>'صور الهوية الوطنية','bank_card_img'=>'بطاقة المصرف','bank_deduction_voucher_img'=>'وصل إستقطاع البنك','other_img'=>'أخري');?>

						<?
						$f=1;
						foreach($arrayz as  $k=>$v):
						?>
						...
						<tr>
							...
							<td>
								<img id="myImg" src="<?php echo base_url()?>uploads/files/<? echo $results[0]->national_id_img;?>"  width="50" height="50">
