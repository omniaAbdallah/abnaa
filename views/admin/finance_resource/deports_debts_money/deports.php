                ...
                <div class="panel-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade in active"  id="tab1default">
                            <?php if(isset($all_debts) && $all_debts!=null && !empty($all_debts) ){?>
                                <form id="form_cach">
                                    <table id="no-more-tables" class="table table-bordered" role="table">
                                        <thead>
                                        <tr>
                                            <th class="">
                                                <input type="checkbox" name=""  onclick="checkAll(this,'all_debts')">
                                            </th>
                                            <th class="">إسم الموظف</th>
                                            <th class="">قيمة السلف</th>
                                            <th class="">الشهر  </th>
                                            <th class="">السنة </th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php     $count=1; foreach ($all_debts as $row){
                                            $total_value=0;
                                            $all=0;
                                           ...
                                           $all +=$total_value;
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" name="select-all[]" value="<?php echo $all."-".$row->debt_id;  ?>" class="all_debts"></td>
                           ...
                           <?php }else{?>
                                <div class="alert alert-danger alert-dismissable">
                                    ...
                                    <strong>لا يوجد !</strong> طلبات سلف  .
                                </div>
                            <?php } ?>
                        </div>
