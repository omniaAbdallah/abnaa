						...
						<div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
							<div class="col-xs-12">
								...
								<div class="col-xs-6 r-input">
									<select id="r-moasasa"  name="donor_type" onchange="as($('#r-moasasa').val());">
									   <option>إختر </option>
					...
					<div class="col-xs-12 r-farde">
						<div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
							...
							<div class="col-xs-12 r-input">
								...
								<div class="col-xs-6 r-input">
									<input type="text" class="r-inner-h4 " name="character_person">
								</div>
							</div>
							<div class="col-xs-12">
								<div class="col-xs-6">
									...
									<div class="panel panel-default">
										...
										<div id="collapseOne" class="panel-collapse collapse ">
											<div class="panel-body">
												...
												<input type="text" class="r-inner-h4 r-inside" name="donor_mediator_name">
												<h4 class="r-h4">  العلاقة   </h4>
												<input type="text" class="r-inner-h4 r-inside" name="donor_mediator_status">
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-xs-12">
								...
								<div class="col-xs-6 r-input">
									<input type="text" class="r-inner-h4 " name="guaranty_name">
								</div>
							</div>
							<div class="col-xs-12">
								<div class="col-xs-6">
								...
								<div class="col-xs-6 r-input">
									<input type="text" class="r-inner-h4 " name="grand_father_name">
								</div>
							</div>
							<div class="col-xs-12">
								<div class="col-xs-6">
							...
							<div class="col-xs-12 r-resourse">
								...
								<div class="col-xs-6 r-input">
									<input type="number" class="r-inner-h4 " name="bank_account_another_number">
								</div>
							</div>
							<div class="col-xs-12 r-resourse">
								<div class="col-xs-6">
						...
						<div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
							...
							<div class="col-xs-12">
								...
								<div class="col-xs-6 r-input">
									<input type="text" class="r-inner-h4 " name="family_name">
								</div>
							</div>
							<div class="col-xs-12">
								<div class="col-xs-6">
