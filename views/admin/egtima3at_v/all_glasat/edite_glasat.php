...
<?php echo form_open_multipart('md/all_glasat/All_glasat/update_galsa/'.$last_magls_update->id.'', array( 'class' => 'galsa_form')); ?>
            ...
            <div class="col-sm-12">
                ...
                <div class="form-group col-md-2 col-sm-6 col-xs-12 padding-4">
                        ...
                        <input  type="date"  class="form-control" data-validation="required" name="galsa_date" id="galsa_date" 
                        onchange="check_day();"  value="<?php if(isset($last_magls_update->galsa_date)&&!empty($last_magls_update->galsa_date)){echo $last_magls_update->galsa_date;}else{echo date('Y-m-d');}?> "   />
              ...
              if(isset($last_magls_update->galsa_day)&&!empty($last_magls_update->galsa_day)){echo $last_magls_update->galsa_day;}else{
...
echo $ar_day;
           ...
           <div class="form-group col-md-1 col-sm-6 col-xs-12 padding-4">
                   ...
                   value="<?php 
                    if(isset($last_magls_update)){echo $last_magls_update->galsa_time;}else{
