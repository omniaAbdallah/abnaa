...
<?php  if ($sanfe->wazifa_in_galsa==2) {
           ...
           <?php  if ($sanfe->wazifa_in_galsa==3) {
                        ...
                        <td>
                        <input type="hidden" class="mem_id_fk" value="<?php echo $sanfe->emp_code; ?> "/>
                        <input type="radio" <?php if ($sanfe->hdoor_satus == 1) echo 'checked'; ?>
                                                   class="attend" name="<?php echo $sanfe->emp_code; ?>" value="1">حضر
                                            <input type="radio" <?php if ($sanfe->hdoor_satus == 0) echo 'checked'; ?>
                                                   class="attend" name="<?php echo $sanfe->emp_code; ?>" value="0">لم
                                            يحضر
                                        </td>
