                                                                ...
                                                                <td style="width: 160px">المحور
                                                                    ...
                                                                    if ($row->mehwar_morfaq !== 0) {
                                                                        ...
                                                                        if (in_array($ext, $image)) {
                                                                            ...
                                                                            ?>
                                                                            <!-- <a target="_blank"
                                                                               href="<?= base_url() . "egtima3at/all_mehwr/All_mehwr_galsa/read_file/" . $row->mehwar_morfaq ?>">
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                             ...
                                                             <iframe src="<?php echo base_url(); ?>egtima3at/all_mehwr/All_mehwr_galsa/read_file/<?=$row->mehwar_morfaq;?>" style="width: 100%; height:  640px;" frameborder="0">
        </iframe>
                                            </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td class="text-center">
                                        ...
                                        <input type="hidden" id="galsa_rkm" name="galsa_rkm" readonly
                                               value="<?php echo $last_galsa - 1; ?>"/></td>
                                </tr>
                                <tr class="left-headtr">
                                    <th><label class="label"> تاريخ بدء الجلسه </label></th>
                                </tr>
                                <tr>
                                    <td class="text-center"><?php if (isset($last_galsa_date)) echo $last_galsa_date->galsa_date; ?></td>
                                </tr>
                                ...
                                <tr>
                                    <td class="text-center">
                                        <button class="btn btn-add"  onclick="get_memebers(<?=$last_galsa_date->galsa_rkm?>)" >تسجيل
                                            حضور الاعضاء
                                        </button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="text-center">
                                        ...
                                        <button class="btn btn-primary"
                                                onclick="startgalsa();" <?php if (isset($last_galsa_date->start_at) && (!empty($last_galsa_date->start_at))) {
                                            echo 'disabled';
                                        } ?> >بدء الجلسه
                                        </button>
                                ...
                                <tr>
                                    <td id="tim"><?php if (isset($last_galsa_date->start_at) && (!empty($last_galsa_date->start_at))) {
                                            echo $last_galsa_date->start_at;
                                        } ?></td>
                                </tr>
                                <tr class="left-headtr">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-sm-12">
                                        <?php if($last_galsa_date->suspender_emp_n==$_SESSION['emp_name']){?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer" style="border-top: 0;">
                        <button type="button" class="btn btn-success" data-dismiss="modal"
                                onclick="attend_member(<?php echo $last_galsa; ?>);">حفظ
                        </button>
...
<script>
    function qrar_mehwar(valu) {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>egtima3at/Start_galsa/Start_galsat/update_qrar",
...
<script>
    function attend_member(valu) {
        ...
        if (mem_id_fk.length !== attend.length) {
            ...
            swal("من فضلك ادخل البيانات كامله", "", "error");
            return;
        }
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>egtima3at/Start_galsa/Start_galsat/update_member_hdoor",
...
<script>
    function startgalsa() {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>egtima3at/Start_galsa/Start_galsat/start_galsa_time",
...
<script>
    function end_galsa3() {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>egtima3at/Start_galsa/Start_galsat/end_galsa",
            data: {galsa_rkm: galsa_rkm},
            success: function (d) {
                // $('#tim').text(d);
                alert(d);
                ...
                if (result.value) {
                    var galsa_rkm = $('#galsa_rkm').val();
                        ...
                        $.ajax({
                            ...
                            window.location.href = "<?php echo base_url();?>egtima3at/Start_galsa/Start_galsat";
...
<script>
 function get_memebers(id){
    $('#myModal').modal('show');
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>egtima3at/Start_galsa/Start_galsat/load_mem_details",
            data:{id:id},
            beforeSend: function () {
