          ...
          $type = array(1=>'دواء', 2=>'أجهزة طبية');
				...
				<table id="example" class="display table table-bordered responsive nowrap" cellspacing="0" width="100%">
					...
					<tbody>
						<?php 
						$x = 1;
            $service_name = 'خدمات عامة / تأمين الأدوية والأجهزة الطبية';
            $mainServices=$service_id_fk;
                ...
                <td><a target="_blank" href="<?php echo base_url();?>services_orders/Print_orders/medicine/<?php echo $value->id;?>"><i class="fa fa-print" aria-hidden="true"></a></td>
