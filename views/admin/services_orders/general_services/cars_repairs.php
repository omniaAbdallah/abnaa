...
<div class="form-group col-sm-12 col-xs-12 no-padding no-margin">
 ...
 <div class="form-group col-sm-6 col-xs-12 padd">
	...
	<small class="small">من فضلك أرفق ملف pdf</small>
    ...
    <?php
    if($repair_law_file !=''){ ?>
    <div style="margin-top: -16px;margin-right: 280px;">
    ...
    <?php
    if($img_form !=''){ ?>
       <a href="<?=base_url().'services_orders/Services_orders/download/'.$img_form?>">
