...
if(isset($record) && $record !=null){
          ...
          $notes=$record['notes'];
          $img=$record['img'];//
          $button_name ='edit_electrical_devices';
          $button_title='تعديل';
          $validation= '';
          ...
          $notes='';//
          $img='';
          $button_name ='add_electrical_devices';
          $button_title='حفظ';
...
<div class="form-group col-sm-12 col-xs-12 no-padding no-margin">
	...
	<div class="form-group col-sm-6 col-xs-12 padd">
        ...
        <textarea name="notes" id="" class="form-control half"  data-validation="required"><?php echo $notes?></textarea>
