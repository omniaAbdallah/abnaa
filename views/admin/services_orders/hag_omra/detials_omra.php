                ...
                <div class="form-group col-sm-12 col-xs-12 no-padding">
                    ...
                    <table id="example" class="display table table-bordered responsive nowrap" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td>خدمات العمرة </td>
                            <td><button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#myModal-<?=$value->order_num?>">
                                    <span class="fa fa-list"></span> التفاصيل</button></td>
                            <td>
                                <a href="<?php echo base_url('').'services_orders/Services_orders/editServicesOrders/12/'.$value->id ?>" title="تعديل">
                              ...
                              <td><a href = "<?php echo base_url('services_orders/Print_orders/print_omra').'/'.$value->id ?>" target = "_blank" > <i class="fa fa-print" aria - hidden = "true" ></i > </a ></td>
