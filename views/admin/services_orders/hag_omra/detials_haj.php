...
<div class="col-sm-12 col-md-12 col-xs-12 ">
    ...
    <tr>
        ...
        <td>خدمات الحج </td>
        <td><button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#myModal-<?=$value->order_num?>"><span class="fa fa-list"></span> التفاصيل</button></td>
        <td>
            <a href="<?php echo base_url('').'services_orders/Services_orders/editServicesOrders/11/'.$value->id ?>" title="تعديل">
                <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
            <a onclick="$('#adele').attr('href', '<?php echo base_url('').'services_orders/Services_orders/DeleteHajOmra/'.$value->order_num ?>');" data-toggle="modal" data-target="#modal-delete" title="حذف">
                     <i class="fa fa-trash" aria-hidden="true"></i> </a>
        </td>
        
        		  <td><a href = "<?php echo base_url('services_orders/Print_orders/print_haj').'/'.$value->id ?>" target = "_blank" > <i class="fa fa-print" aria - hidden = "true" ></i > </a ></td>
    ...
    <?php $x=1;foreach ($records as $value){?>
        <div class="modal" id="myModal-<?=$value->order_num?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-wow-duration="0.5s">
                            ...
                            <div class="col-xs-12">
                                <table class="table table-bordered table-devices">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if(!empty($value->sub))
                                                    foreach ($value->sub as $names){
                                                       if($names->person_id != 0){
                                                           echo $names->member_full_name."  <br/>";
                                                       }else{
                                    ...
                                    <tr>
                                        <th class="gray_background" style="width: 25%;">الحج لاول مرة</th>
