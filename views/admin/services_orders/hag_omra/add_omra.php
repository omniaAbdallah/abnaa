<div class="form-group col-sm-12 col-xs-12">
    ...
    <table id="" class="display table table-bordered responsive nowrap" cellspacing="0" width="100%">
        ...
        <?php  if(isset($mother) && !empty($mother) && $mother!=null) {
            ...
            <tr>
                <td> <input type="checkbox" onclick="valid();" name="mother_id" class="persons"  value="<?=$mother['mother_national_num_fk']?>"     <?php echo  $mother_click?> /></td>
        ...
        <?php  if(isset($members) && !empty($members) && $members!=null) {
            foreach ($members as $key) {
                ...
                ?>
                <tr>
                    <td> <input type="checkbox" onclick="valid();" name="member_id[]" class="persons" value="<?=$key->id?>" <?=$member_click?>  /></td>
