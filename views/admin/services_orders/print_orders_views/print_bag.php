            ...
            <div class="personality">
                ...
                <div class="col-xs-12">
                    <table class="table th-no-border">
                        ...
                        <tr>
                            <th>إسم المستفيد :</th>
                            <td><?php echo $row[0]->member_name;?></td>
                            <th>رقم الهوية :</th>
                            <td><?php echo $row[0]->num;?></td>
                        </tr>
                        <tr>
                            <th>  الحقيبه والمستلزمات الطبيه:</th>
                            <td> المستلزمات  </td>
                            <th>رقم الجوال :</th>
                ...
                <div class="col-xs-12">
                    <table class="table table-bordered table-devices">
                        ...
                        <tr>
                            <th class="gray_background" style="width: 25%;"> نوع الخدمه</th>
                            <td>الحقيبه والمستلزمات الطبيه </td>
                        </tr>
                        <tr>
                            <th class="gray_background" style="width: 25%;">اسم المستلزمات المدرسيه </th>
                            <td><?php echo $row[0]->support_name;?></td>
                        </tr>
