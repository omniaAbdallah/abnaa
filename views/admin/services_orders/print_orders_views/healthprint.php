            ...
            <div class="personality">
                ...
                <div class="col-xs-12">
                    <table class="table th-no-border">
                        <tbody>
                        <tr>
                            <th>اسماء المستفيدين :</th>
                            <td>
                                <?php
                                $i=1;
                                foreach ($row[0]->allchildrenWithMother as $x)
                                {
                                    echo $i."-".$x->memberName."</br>";
                                    $i++;
                                }
                                ?>
                            </td>
                ...
                <div class="col-xs-12">
                    <table class="table table-bordered table-devices">
                        ...
                        <tr>
                            ...
                            <td>خدمات عامة / دفع تكاليف السفر والرعاية الصحية</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td> <?php echo $row[0]->travel_date;?></td>
                        </tr>
                        <tr>
                            <th class="gray_background" style="width: 25%;">جهه العلاج  </th>
