                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            ...
                            if(isset($record) && !empty($record) && $record!=null){
                                echo form_open_multipart('services_orders/setting/Egar_setting/UpdateSetting/'.$id.'/'. $key  , array('id' => 'object_form_'.$key, 'class' => 'object_form_'.$key));
                            }
                            else{
                                echo form_open_multipart('services_orders/setting/Egar_setting/AddSetting/'.$key , array('id' => 'object_form_'.$key, 'class' => 'object_form_'.$key));
                            }
                            ?>
                            ...
                            <?php if ($key == 501){?>
                                ...
                                <div class="form-group col-sm-3 col-xs-12">
                                    ...
                                    <input type="number" name="num_days" id="num_days_<?=$key?>" value="<?php if(isset($record)) echo $record['num_days'] ?>"
                            ...
                            <div class="form-group col-sm-3 col-xs-12">
                                ...
                                <input type="color" id="color_<?=$key?>" name="color" id="color" value="<?php if(isset($record)) echo $record['color'] ?>"
                                       data-validation="required" class="form-control "
...
<script>
    function load_table(from_code) {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>services_orders/setting/Egar_setting/load_table",
...
<script>
    ...
    function add_setting(from_code) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>services_orders/setting/Egar_setting/add_setting',
            data: form_data,
            cache: false,
            contentType: false,
            processData: false,
    ...
    function update_setting(row_id, from_code,num_row) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>services_orders/setting/Egar_setting/update_setting',
            data: form_data,
            cache: false,
            contentType: false,
            processData: false,
