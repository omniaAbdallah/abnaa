                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            ...
                            if(isset($record) && !empty($record) && $record!=null){
                                echo form_open_multipart('services_orders/setting/Main_setting/UpdateSetting/'.$id.'/'. $key  , array('id' => 'object_form_'.$key, 'class' => 'object_form_'.$key));
                            }
                            else{
                                echo form_open_multipart('services_orders/setting/Main_setting/AddSetting/'.$key , array('id' => 'object_form_'.$key, 'class' => 'object_form_'.$key));
                            }
                            ?>
...
<script>
    function load_table(from_code) {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>services_orders/setting/Main_setting/load_table",
...
<script>
    ...
    function add_setting(from_code) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>services_orders/setting/Main_setting/add_setting',
            data: form_data,
            cache: false,
            contentType: false,
            processData: false,
    ...
    function update_setting(row_id, from_code,num_row) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>services_orders/setting/Main_setting/update_setting',
            data: form_data,
            cache: false,
            contentType: false,
            processData: false,
