                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            ...
                            if(isset($record) && !empty($record) && $record!=null){
                                echo form_open_multipart('services_orders/setting/Main_setting/UpdateSetting/'.$id.'/'. $key);
                            }
                            else{
                                echo form_open_multipart('services_orders/setting/Main_setting/AddSetting/'.$key);
                            }
                            ?>
