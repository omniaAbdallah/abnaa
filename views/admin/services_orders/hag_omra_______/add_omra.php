<div class="form-group col-sm-12 col-xs-12">
    ...
    <table id="" class="display table table-bordered responsive nowrap" cellspacing="0" width="100%">
        ...
        <?php  if(isset($mother) && !empty($mother) && $mother!=null) {
            ...
            <tr>
                <td> <input type="checkbox" name="mother_id"  value="<?=$mother['mother_national_num_fk']?>" <?php echo  $mother_click?> /></td>
        ...
        <?php  if(isset($members) && !empty($members) && $members!=null) {
            foreach ($members as $key) {
                ...
                ?>
                <tr>
                    <td> <input type="checkbox" name="member_id[]" value="<?=$key->id?>" <?=$member_click?> /></td>
    ...
    <div class="form-group col-sm-12">
        ...
        <div class="form-group col-sm-6">
            <label class="label label-green  half">العمرة لاول مرة</label>
            <?php
    ...
    <div class="form-group col-sm-12 col-xs-12">
        <button type="submit" name="add_omra" value="حفظ" class="btn btn-purple w-md m-b-5">
