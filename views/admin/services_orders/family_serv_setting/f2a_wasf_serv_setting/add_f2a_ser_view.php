    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            ...
            if ((isset($f2at)) && (!empty($f2at))) {
                echo form_open_multipart(base_url() . 'services_orders/family_serv_setting/Serv_setting/f2a_service_setting_uptate/' . base64_encode($f2at->id));
                $wasf_fe2a_title = $f2at->wasf_fe2a_title;
                $ser = $f2at->no3_khdma_id_fk;
            } else {
                $wasf_fe2a_title = '';
                $ser ='';
                echo form_open_multipart(base_url() . 'services_orders/family_serv_setting/Serv_setting/f2a_service_setting');
            } ?> -->

<?php
            if (isset($f2at) && !empty($f2at)) {
                echo form_open_multipart('services_orders/family_serv_setting/Serv_setting/f2a_service_setting_uptate/' .$f2at->id . '', array('class' => 'f2a_form'));
                $wasf_fe2a_title = $f2at->wasf_fe2a_title;
                $ser = $f2at->no3_khdma_id_fk;
                $button = 'update';
                $action = " تعديل    ";
                ...
                $button = 'add';
                $onclick = "save_f2a();";
                echo form_open_multipart('services_orders/family_serv_setting/Serv_setting/f2a_service_setting', array('class' => 'f2a_form'));
...
<script>
    function save_f2a() {
        ...
        var serializedData = $('.f2a_form').serializeArray();
        $.each(serializedData, function (key, item) {
            form_data.append(item.name, item.value);
        });
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>services_orders/family_serv_setting/Serv_setting/f2a_service_setting',
            data: form_data,
            cache: false,
            contentType: false,
            processData: false,
            ...
            success: function (html) {
                ...
                var all_inputs_set = $('.f2a_form .form-control');
...
<script>
    ...
    function update_f2a(id) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>services_orders/family_serv_setting/Serv_setting/f2a_service_setting_uptate',
            data: form_data,
            cache: false,
            contentType: false,
            processData: false,
...
<script>
    function get_details() {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>services_orders/family_serv_setting/Serv_setting/load_details_f2a",
            beforeSend: function () {
...
<script>
    function edit_f2a(id) {
        // $('#pop_rkm').text(rkm);
        $.ajax({
            type: 'post',
            data: {id: id},
            url: "<?php echo base_url();?>services_orders/family_serv_setting/Serv_setting/edite_f2a",
...
<script>
    function get_add() {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>services_orders/family_serv_setting/Serv_setting/get_add",
