        ...
        <div class="panel-body">
            ...
            <table class="display table table-bordered responsive nowrap tb_table" cellspacing="0"  width="100%">
                ...
                <option value="">إختر</option>
                    ...
                    <td>
                            ...
                            <input type="text" class="form-control bottom-input" value="<?php if(!empty($names[$value->custody_title])){ echo$names[$value->custody_title]; } ?>"  <?=$disabled?>/>
                ...
                <tfoot>
                     <th colspan="6"> 
                         <button type="button" class="btn btn-success btn-labeled" value="1" onclick="getBanks($(this).val(),<?php if(isset($allData) && $allData != null) echo count($allData); else echo 0; ?>);" ><span class="btn-label"><i class="fa fa-plus"></i></span> إضافة عهد جديد</button>
            ...
            <?php } ?>
                  <div class="col-xs-12 text-center">
                      ...
                      <button type="submit" id="buttons" name="add" class="btn btn-success btn-labeled" value="حفظ"><span class="btn-label"><i class="fa fa-plus"></i></span>حفظ</button>
                  </div>
            </div>
