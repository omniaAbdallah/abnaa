  ...
  <div class="col-sm-4">
    <ul class="nav nav-tabs tabs-left holiday-month" style="    border: 1px solid gray;">
            ...
            foreach ($this->myarray as $key=>$value){
                ...
                {echo $active; }else {echo ($x == 0)? 'active':''; } ?>" 
                     style="float: right; width: 50%;">
                      <a  <?php if(isset($record) || isset($area)){}else{echo 'href="#tab'.$key.'"';} ?>
        ...
        <li  role="presentation"style="float: right; width: 50%;">
            <a <?php if(isset($record) || isset($area)){}else{echo 'href="#tab_areas"';} ?> aria-controls="tab_areas" role="tab" data-toggle="tab"  ><i class="fa fa-cog" aria-hidden="true"></i>المدن</a>
        </li>
        <li  role="presentation" style="float: right; width: 50%;">
            <a <?php if(isset($record) || isset($area)){}else{echo 'href="#tab_residential"';} ?>  aria-controls="tab_residential" role="tab" data-toggle="tab"  ><i class="fa fa-cog" aria-hidden="true"></i>الأحياء</a>
        </li>
        <!-------------Osama 8-9---------------->
    </ul>
</div>
