...
<!-- 
...

       {
        ...
        $this->load->view('admin/Human_resources/add_employee_tamouh/sidebar_person_data', $data_load);}else{

            $data_load["personal_data"] ='';

            $this->load->view('admin/Human_resources/add_employee_tamouh/sidebar_person_data');
