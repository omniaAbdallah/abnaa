...
//echo date("Y-m-d");
    ...
    $twiter=$emp->twiter;
    $out['form']='human_resources/tamouh_emp/Tamouh/edit_emp/'.$this->uri->segment(5);
}else{
    $name="";
    ...
    $status_name="";
    $dest_card_name='';
    $out['form']='human_resources/tamouh_emp/Tamouh/add_personal_data';
}
?>
<?php
?>
        ...
        <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
            <div class="panel-heading">
                ...
                <?php if(isset($personal_data) && !empty($personal_data)){
                        ...
                        $data_load["id"]=$emp->id ;
                        $this->load->view('admin/Human_resources/add_employee_tamouh/drop_down_menu_tamouh', $data_load);
                        }?>
            </div>
            </div>
...
<!--                
                    ...
                    <div class="form-group col-md-2 col-sm-6 padding-4">
                        ...
                        <input type="text"  id="city_name"   data-validation="required"  value="<?php  if (isset($city_name)){echo $city_name;}?>"  class="form-control " data-validation-has-keyup-event="true" style="width:84%;float: right;" readonly>
    ...
    margin-top: -33px;" onclick="GetDiv('myDiv')">
        ...
        <input type="hidden" name="motbr3_id_fk" id="motbr3_id_fk" >
                    <div class="form-group col-md-2 col-sm-6 padding-4">
                        ...
                        <input type="text"  id="hai_name"   data-validation="required"  value="<?php   if (isset($hai_name)){ echo $hai_name;}?>"  class="form-control "  data-validation-has-keyup-event="true" readonly>
    					...
    					<div class="imgchange-1">
    						<div class="person-card effect-shadow">
    							...
    							<div class="card-inner">
    								<div class="square">
    									<div class="pic">
    										<img src="<?php if(isset($personal_photo)){ echo base_url().'uploads/images/'.$personal_photo;}else{
                        echo 'https://via.placeholder.com/350x150';
                    } ?>">
    									</div>
    								</div>
    								...
    								<div class="card-name">
    									<h5>إسم الموظف: <?php if (isset($personal_data)) {
                                                    echo $personal_data[0]->employee;
                                                } ?></h5>
    									<h5 class="career">المسمى الوظيفي: <?php if (isset($personal_data)) {
    								...
    								<div class="card-details">
    									<h5><span class="spnline">الإدارة</span><strong>:</strong>  <?php if (isset($personal_data)) {
                                                    echo $personal_data[0]->admin_name;
                                                } ?></h5>
    									<h5><span class="spnline">القسم</span><strong>:</strong><?php if (isset($personal_data)) {
                                                    echo $personal_data[0]->depart_name;
                                                } ?></h5>
    									<h5><span class="spnline">المدير المباشر</span><strong>:</strong> <?php if (isset($personal_data)) {
    						...
    						<div class="person-card back-card effect-shadow">
    							<div class="back-body">
    								<article class="paragraph">
    									<h5>لوريم ايبسوم دولار سيت أميت ,كونسيكتيتور أدايبا يسكينج أليايت,سيت دو أيوسمود تيمبور أنكايديديونتيوت لابوري ات دولار ماجنا أليكيوا . يوت انيم أد مينيم فينايم,كيواس نوستريد أكسير سيتاشن يللأمكو لابورأس نيسي يت أليكيوب أكس أيا كوممودو كونسيكيوات .</h5>
    
    								</article>
    								<div class="card-details">
    									<h5><span class="spnline">تاريخ الإنضمام</span><strong>:</strong> 20/05/2018</h5>
    									<h5><span class="spnline">تاريخ الإنتهاء</span><strong>:</strong> 19/05/2019</h5>
    								</div>
    							</div>
    							<div class="barcode">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($record->employee_type == 1) {
                                                $class = "success";
                                            } elseif ($record->employee_type == 2) {
                                                $class = "danger";
                                            } elseif ($record->employee_type == 0) {
                                                $class = "warning";
                                            } ?>
                                            <span class="label label-pill label-<?= $class ?> m-r-15"
                                                  style="font-size: 12px;"><?= $emp_type[$record->employee_type] ?></span>
                                        </td>
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                 <li><a target="_blank"
                                                           href="<?php echo base_url(); ?>human_resources/tamouh_emp/Tamouh/edit_emp/<?php echo $record->emp_code; ?>">البيانات
                                                            الأساسية </a></li>
                                                    <li><a target="_blank"
                                                           href="<?php echo base_url(); ?>human_resources/tamouh_emp/Tamouh/add_job_data/<?php echo $record->id; ?>">البيانات
                                                            الوظيفيه </a></li>
                                                            <li><a href="<?php echo base_url(); ?>human_resources/human_resources/financeEmployee/<?php echo $record->id; ?>">البيانات
                المالية </a></li>
        <li><a href="<?php echo base_url(); ?>human_resources/human_resources/contractEmployee/<?php echo $record->id; ?>">بيانات
                التعاقد </a></li>
        <li><a href="<?php echo base_url(); ?>human_resources/human_resources/printer_machin_Employee/<?php echo $record->id; ?>">بيانات
                الدوام </a></li>
        <li><a href="<?php echo base_url(); ?>human_resources/human_resources/employee_files/<?php echo $record->id; ?>">
                المستندات والبطاقات والمهارات </a></li>
        <li><a href="<?php echo base_url(); ?>human_resources/human_resources/custody/<?php echo $record->id; ?>">
                شاشة العهد </a></li>
                                                   
                                                </ul>
                                            </div>
                                       
                                            <a href="<?php echo base_url(); ?>human_resources/tamouh_emp/Tamouh/edit_emp/<?php echo $record->emp_code; ?>"><i
                                                    class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
                                            <a onclick="$('#adele').attr('href', '<?= base_url() . "human_resources/tamouh_emp/Tamouh/DeleteEmpAll/" . $record->id ?>');"
                                     ...
                                     <!-- <a href = "<?php echo base_url('human_resources/tamouh_emp/Tamouh/print_employee_details').'/'.$record->id ?>" target = "_blank" >
                                                <i class="fa fa-print" aria-hidden = "true" ></i > </a> -->
                                                <a onclick="print_employee_details(<?= $record->id ?>)" title="طباعه"><i
                                            class="fa fa-print"></i></a>

                                            <!-- <a  href = "<?php echo base_url('human_resources/tamouh_emp/Tamouh/print_card').'/'.$record->id ?>" target = "_blank" >
                                                <i   style="background-color: #0a568c" class="fa fa-print" aria-hidden = "true" ></i > </a> -->
                                                <a onclick="print_card(<?= $record->id ?>)" title="طباعه"><i style="background-color: #0a568c"
                                            class="fa fa-print"></i></a>
...
<ul class="dropdown-menu">
<li><a target="_blank"  href="<?php echo base_url();?>human_resources/rawda/Rawda/add_job_data/<?php echo $record->id ;?>">البيانات الوظيفيه  </a></li>
<li><a target="_blank"  href="<?php echo base_url();?>human_resources/Tamouh/financeEmployee/<?php echo $record->id ;?>">البيانات  المالية   </a></li>
<li><a target="_blank"  href="<?php echo base_url();?>human_resources/Tamouh/contractEmployee/<?php echo $record->id ;?>">بيانات التعاقد   </a></li>
<li><a target="_blank"  href="<?php echo base_url();?>human_resources/Tamouh/printer_machin_Employee/<?php echo $record->id ;?>">بيانات الدوام   </a></li>
<li><a target="_blank"  href="<?php echo base_url();?>human_resources/Tamouh/employee_files/<?php echo $record->id ;?>"> المستندات والبطاقات والمهارات     </a></li>
<li><a target="_blank"  href="<?php echo base_url();?>human_resources/Tamouh/custody/<?php echo $record->id ;?>"> شاشة العهد    </a></li>
</ul>
                    </div>
                </td>
                <td>
                    <a href="<?php echo base_url();?>human_resources/Tamouh/edit_emp/<?php echo $record->emp_code;?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
                    <a onclick="$('#adele').attr('href', '<?= base_url() . "human_resources/Tamouh/DeleteEmpAll/" . $record->id ?>');"
                       data-toggle="modal" data-target="#modal-delete"
                       title="حذف"> <i class="fa fa-trash"
