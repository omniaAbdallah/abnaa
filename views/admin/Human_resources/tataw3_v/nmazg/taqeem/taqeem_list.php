    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body" >
            <div class="col-xs-8 col-md-offset-2 no-padding" style="margin-bottom:15px;">
                <button class="btn btn-labeled btn-warning adder" onclick="window.location='<?php echo site_url("human_resources/tataw3/nmazg/taqeem/Taqeem/add_taqeem");?>'" style="margin-left: 25px;font-size: 16px;">
                    <span class="btn-label"><i class="fa fa-plus"> </i></span> اضافه تقييم </button>
            ...
            <div class="col-xs-12 no-padding" >
                <table id="js_table"
                    ...
                    <tr class="greentd">
                        <th>م </th>
                        <th> اسم المتطوع </th>
                        <th> عنوان الفرصه التطوعيه </th>
                        <th> تاريخ التسجيل </th>
                        <th> مجموع الدرجات العظمي </th>
                        <th> مجموع الدرجات المستحقه </th>
                        <th>اجراءات </th>
                    </tr>
                    </thead>
                </table>
...
<script>
    function load_details(row_id) {
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>human_resources/tataw3/nmazg/taqeem/Taqeem/load_details",
            data: {row_id:row_id},
            beforeSend: function () {
    ...
    <script>
        function print_card(row_id) {
            var request = $.ajax({
                ...
                url: "<?=base_url() . 'human_resources/tataw3/nmazg/taqeem/Taqeem/print_card'?>",
                type: "POST",
                data: {row_id: row_id},
            });
