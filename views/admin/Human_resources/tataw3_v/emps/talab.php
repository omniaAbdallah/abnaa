    ...
    <input type="text" name="mokdm_talab" value="<?= $mokdm_talab ?>"class="form-control"  data-validation="required" readonly />
     ...
     -->
                                ...
                                <div class="form-group col-md-3 col-sm-6 col-xs-6 padding-4">
                                    ...
                                    <input type="hidden" name="moshrf_name" id="moshrf_name"
                                           value="<?= $moshrf_name ?>">
                                    ...
                                    <select name="moshrf_emp_id" id="responsible_load" class="form-control  "
                                            onchange="get_ms2ol_data()" data-validation="required" aria-required="true">
                                        <option value="">إختر</option>
                                        <?php
