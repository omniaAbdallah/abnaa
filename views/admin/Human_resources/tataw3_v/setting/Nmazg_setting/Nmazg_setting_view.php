                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            ...
                            if(isset($record) && !empty($record) && $record!=null){
                                echo form_open_multipart('human_resources/tataw3/setting/Nmazg_setting/UpdateSetting/'.$id.'/'. $key  , array('id' => 'object_form_'.$key, 'class' => 'object_form_'.$key));
                            }
                            else{
                                echo form_open_multipart('human_resources/tataw3/setting/Nmazg_setting/AddSetting/'.$key , array('id' => 'object_form_'.$key, 'class' => 'object_form_'.$key));
                            }
                            ?>
                            ...
                            <div class="form-group col-sm-3 col-xs-12">
                                ...
                                <input type="color" id="color_<?=$key?>" name="color" value="<?php if(isset($record)) echo $record['color'] ?>" class="form-control" autofocus data-validation="required">
                            </div>
...
<script>
    function load_table(from_code) {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>human_resources/tataw3/setting/Nmazg_setting/load_table",
...
<script>
    ...
    function add_setting(from_code) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>human_resources/tataw3/setting/Nmazg_setting/add_setting',
            data: form_data,
            cache: false,
            contentType: false,
            processData: false,
    ...
    function update_setting(row_id, from_code,num_row) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>human_resources/tataw3/setting/Nmazg_setting/update_setting',
            data: form_data,
            cache: false,
            contentType: false,
            processData: false,
