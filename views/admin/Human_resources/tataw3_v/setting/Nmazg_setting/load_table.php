            ...
            foreach ($results as $value) {
                ...
                <tr id="<?=$value->id?>" data-from_code="<?=$value->from_code?>">
                    ...
                    <td>
                        ...
                        <!--<a href="<?php echo base_url().'human_resources/tataw3/setting/Nmazg_setting/UpdateSetting/'.$value->id."/".$value->from_code  ?>" title="تعديل">
                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
                        <span> </span>
                        <a href="<?=base_url()."human_resources/tataw3/setting/Nmazg_setting/DeleteSetting/".$value->id."/".$value->from_code?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
    ...
    <script>
        function load_edit(row_id,title,color,from_code,num_row) {
    ...
    <script>
        function delete_setting(row_id,from_code) {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo base_url()?>human_resources/tataw3/setting/Nmazg_setting/delete_setting',
