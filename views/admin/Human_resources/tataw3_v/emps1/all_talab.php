                ...
                <table id="example" class=" display table table-bordered   responsive nowrap" cellspacing="0"
                    ...
                    foreach ($records as $row) {
                        ...
                        <tr>
                            ...
                            <td>
                            <a data-toggle="modal" data-target="#details_Modal" 
                                   style="padding:1px 5px;" onclick="load_page_emps(<?= $row->id ?>);">
                                    <i class="fa fa-list "  aria-hidden="true"></i>الموظفين </a>
                            <a  
                                    class="btn btn-labeled btn-danger"
                                    id="publish<?= $row->id ?>"
                                   style="padding:1px 5px;" onclick="close_tata(<?= $row->id ?>);">
                                
                                    <i class=" "  aria-hidden="true"></i>اغلاق التطوع </a>
                            <div class="btn-group">
