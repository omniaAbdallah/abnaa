    ...
    <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            ...
            if($this->uri->segment(6)){
             echo form_open_multipart('human_resources/employee_forms/mandate_setting/Gehat/update_main/'.$this->uri->segment(6).'');
            }else{
                 echo form_open_multipart('human_resources/employee_forms/mandate_setting/Gehat/add');
            }
                     ?>
                ...
                <div class="form-group col-md-3 col-sm-6 padding-4" 
                     >
                    <label class="label"> فئه الجهات  </label>
                    <input type="text" name="f2a_n" id="f2a_n" value="<?php echo $f2a_n ?>"
                           ...
                           readonly>
                           <input type="hidden" name="f2a_id_fk" id="f2a_id_fk" value="<?php echo $f2a_id_fk ?>"
                           class="form-control "
            ...
            <div class="form-group col-sm-3 padding-4">
                <label class="label ">إسم الجهه </label>
                    ...
                    <tr>
                      ...
                      <td><?php echo $row->gwal;?></td> 
                        ...
                        <td>
                                            ...
                                            <a href="<?php echo base_url();?>/human_resources/employee_forms/mandate_setting/Gehat/update_main/<?php echo $row->id;?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>

                                            <a  href="<?php echo base_url();?>/human_resources/employee_forms/mandate_setting/Gehat/delete/<?php echo $row->id;?>" onclick="return confirm('هل انت متاكد  من عمليه الحذف؟');"><i class="fa fa-trash" aria-hidden="true"></i> </a>
    ...
    <div class="modal-dialog" role="document" style="width: 80%">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title ">    فئه الجهات   </h4>
            </div>
            <div class="modal-body">
                        ...
                        <div class="col-sm-12 form-group">
                            <div class="col-sm-3  col-md-3 padding-4 ">
                                ...
                                <button type="button" class="btn btn-labeled btn-success "
                                    ...
                                    <span class="btn-label"><i class="glyphicon glyphicon-plus"></i></span> اضافه فئه الجهات
                        ...
                        <div class="col-sm-12 no-padding form-group">
                            ...
                            <div id="geha_input1111" style="display: none">
                                <div class="col-sm-3  col-md-5 padding-2 ">
                                    <label class="label   "> فئه الجهه </label>
...
<script>
    function get_details(row_id) {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>human_resources/employee_forms/mandate_setting/Gehat/load_details",
            data: {row_id: row_id},
            beforeSend: function () {
...
<script>
    function get_details_geha_type() {
       // $('#pop_rkm').text(rkm);
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>human_resources/employee_forms/mandate_setting/Gehat/load_geha_type",
...
<script>
  ...
  function add_geha_type(value) {
      ...
      if (value != 0 && value != '' ) {
          ...
          $.ajax({
              type: 'post',
              url: '<?php echo base_url() ?>human_resources/employee_forms/mandate_setting/Gehat/add_geha_type',
              data: dataString,
              dataType: 'html',
              cache: false,
...
<script>
    function update_geha_type(id) {
        ...
        $.ajax({
            url: "<?php echo base_url() ?>human_resources/employee_forms/mandate_setting/Gehat/getById_geha_type",
            type: "Post",
            dataType: "html",
            data: {id: id},
        ...
        $('#update_geha_type').on('click', function () {
            ...
            $.ajax({
                url: "<?php echo base_url() ?>human_resources/employee_forms/mandate_setting/Gehat/update_geha_type",
                type: "Post",
                dataType: "html",
...
<script>
        ...
        if (r == true) {
            $.ajax({
                type: 'post',
                url: '<?php echo base_url() ?>human_resources/employee_forms/mandate_setting/Gehat/delete_travel_type',
                data: {id: id},
                dataType: 'html',
                cache: false,
                success: function (html) {
...
<script>
    function get_details_ms2ol(row_id) {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>human_resources/employee_forms/mandate_setting/Gehat/add_ms2ol_gehat",
            data: {row_id: row_id},
            beforeSend: function () {
...
<script>
    function get_details_gehat_ektsas(row_id) {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>human_resources/employee_forms/mandate_setting/Gehat/add_gehat_ektsas",
            data: {row_id: row_id},
            beforeSend: function () {
