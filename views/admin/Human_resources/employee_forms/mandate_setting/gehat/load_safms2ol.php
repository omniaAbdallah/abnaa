...
<script>
    ...
    function add_safms2ol(value) {
        ...
        if (value != 0 && value != '' ) {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo base_url() ?>human_resources/employee_forms/mandate_setting/Gehat/add_safms2ol',
                data: dataString,
                dataType: 'html',
                cache: false,
...
<script>
    function update_safms2ol(id) {
        ...
        $.ajax({
            url: "<?php echo base_url() ?>human_resources/employee_forms/mandate_setting/Gehat/getById_safms2ol",
            type: "Post",
            dataType: "html",
            data: {id: id},
        ...
        $('#update_safms2ol').on('click', function () {
            ...
            $.ajax({
                url: "<?php echo base_url() ?>human_resources/employee_forms/mandate_setting/Gehat/update_safms2ol",
                type: "Post",
                dataType: "html",
...
<script>
    ...
    function delete_safms2ol(id) {
        ...
        if (r == true) {
            $.ajax({
                type: 'post',
                url: '<?php echo base_url() ?>human_resources/employee_forms/mandate_setting/Gehat/delete_safms2ol',
                data: {id: id},
                dataType: 'html',
                cache: false,
                success: function (html) {
