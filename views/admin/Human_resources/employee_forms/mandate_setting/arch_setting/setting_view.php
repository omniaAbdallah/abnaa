                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        if (isset($get_setting) && !empty($get_setting)) {
                                            ...
                                            echo form_open_multipart('human_resources/employee_forms/mandate_setting/Setting/UpdateSitting/'.$id . '/' . $key);
                                        } else {
                                            $title = '';
                                            $color = '';

                                            echo form_open_multipart('human_resources/employee_forms/mandate_setting/Setting/AddSitting/' . $key . '/' . $key);
                                        }
                                        ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#" onclick='swal({
                                                                    ...
                                                                    window.location="<?php echo base_url().'human_resources/employee_forms/mandate_setting/Setting/UpdateSitting/'.$value->id . "/" . $key ?>";
                                                                    });'>
                                                                ...
                                                                <a href="#" onclick='swal({
                                                                    ...
                                                                    window.location="<?= base_url()."human_resources/employee_forms/mandate_setting/Setting/DeleteSitting/" . $value->id . "/" . $key ?>";
                                                                    });'>
