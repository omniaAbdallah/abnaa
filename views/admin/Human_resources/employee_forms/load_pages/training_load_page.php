<tr>
    ...
    <td> <input type="date" name="date_from[]" data-validation="required"  id=""  data-validation="required" value=""
                class="form-control bottom-input "
                data-validation-has-keyup-event="true">
        الي <input type="date" data-validation="required" name="date_to[]"  id=""  data-validation="required" value=""
                       class="form-control bottom-input "
                       data-validation-has-keyup-event="true">
        </td>
