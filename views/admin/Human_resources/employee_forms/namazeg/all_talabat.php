<style type="text/css">
  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation" class="active"><a href="#wared" aria-controls="wared" role="tab" data-toggle="tab">الطلبات قيد التنفيذ</a></li>

    <li role="presentation"><a href="#done" aria-controls="done" role="tab" data-toggle="tab">الطلبات المنتهية</a></li>
  ...
  <div class="tab-content">
    ...
    <div role="tabpanel" class="tab-pane active" id="wared">

    

   <?php if (isset($all_talabat_comming) && $all_talabat_comming != null) { ?>
        ...
        <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
            ...
            <div class="panel-body">
                ...
                <table id="" class="example table table-bordered table-striped" role="table">
                    ...
                    foreach ($all_talabat_comming as $talab_com) {
                        ...
                        <tr>
                            ...
                            <td><?= $talab_com->letter_rkm_full ?></td>

                            <td><?= $talab_com->letter_date_ar ?></td>

                             <td><?= $talab_com->letter_name ?></td>

                            

                            <td><?= $talab_com->geha_name ?></td>

                            <td><?= $talab_com->emp_code ?></td>

                            <td><?= $talab_com->emp_name ?></td>

                            <td><?php if (isset($talab_com->mawdo3) and $talab_com->mawdo3 != null) {

                                    echo $talab_com->mawdo3;
                         ...
                         <span style="font-size: 12px; color: white !important; font-weight: normal;width: 141px;"
                               ...
                               class="badge badge-add"><?php echo $talab_com->publisher_name; ?></span>

                            </td>

                <td id="td_<?= $x ?>">

                         <a href="<?php echo base_url() . 'human_resources/employee_forms/namazegs/Namazeg/edit/' . $talab_com->letter_rkm ?>"

                                   title="تعديل"><i class="fa fa-pencil"></i></a>

                            

                                    <a onclick="Delete_namozeg(<?= $talab_com->letter_rkm ?>)" title="حذف"><i
...
<?php
if($talab_com->namozag_type_fk == 3){ ?>
 
 <a href="#modal_details" data-toggle="modal" onclick="get_days_details(<?php echo $talab_com->letter_rkm; ?>)" class="btn btn-warning btn-sm">   تحديد الأيام</a>
...
?>
                                   ...
                                   <a onclick="printNamazeg(<?=$talab_com->letter_rkm ?>)" title="طباعة النموذج"><i
...
<!--<a href="<?=base_url() . 'human_resources/employee_forms/namazegs/Namazeg/printNamazeg_2'?>">ddddd</a>
-->
                                

                                

                                  <button type="button" class="btn btm-sm btn-labeled btn-inverse "

            id="attach_button"

            onclick="put_value(<?php echo $talab_com->id; ?>,<?php echo $talab_com->letter_rkm; ?>)"
     ...
     <button type="button" class="btn btm-sm btn-labeled btn-warning "

            onclick="make_suspend(<?php echo $talab_com->letter_rkm; ?>,'td_<?= $x ?>')">

                                            <span class="btn-label" style="padding: 1px 7px;"><i

                                                    class="glyphicon glyphicon-check"></i></span>تنفيذ
...
<?php }else{  ?>
  ...
  <strong>عذرا!</strong> لا يوجد طلبات
 ...
 /*  echo'<pre>';
   ...
   print_r($all_talabat_done);*/

   

    if (isset($all_talabat_done) && $all_talabat_done != null) { ?>
        ...
        <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
            ...
            <div class="panel-body">
                ...
                <table id="" class="example table table-bordered table-striped" role="table">
                    ...
                    foreach ($all_talabat_done as $talab_done) {
                        ...
                        <tr>
                            ...
                            <td><?= $talab_done->letter_rkm_full ?></td>

                            <td><?= $talab_done->letter_date_ar ?></td>

                             <td><?= $talab_done->letter_name ?></td>

                            

                            <td><?= $talab_done->geha_name ?></td>

                            <td><?= $talab_done->emp_code ?></td>

                            <td><?= $talab_done->emp_name ?></td>

                            <td><?php if (isset($talab_done->mawdo3) and $talab_done->mawdo3 != null) {

                                    echo $talab_done->mawdo3;
                         ...
                         <span style="font-size: 12px; color: white !important; font-weight: normal;width: 141px;"
                               ...
                               class="badge badge-add"><?php echo $talab_done->publisher_name; ?></span>

                            </td>

                            <td>

                         <a href="<?php echo base_url() . 'human_resources/employee_forms/namazegs/Namazeg/edit/' . $talab_done->letter_rkm ?>"

                                   title="تعديل"><i class="fa fa-pencil"></i></a>

                            

                                    <a onclick="Delete_namozeg(<?= $talab_done->letter_rkm ?>)" title="حذف"><i
                                   ...
                                   <a onclick="printNamazeg(<?=$talab_done->letter_rkm ?>)" title="طباعة النموذج"><i
...
<?php
 ...
 }elseif($talab_done->morfqat_num > 0){
...
?>
                                ...
                                <button type="button" class="btn btm-sm btn-labeled btn-<?=$cclass?> " id="attach_button"

                                        onclick="put_value(<?php echo $talab_done->id; ?>,<?php echo $talab_done->letter_rkm; ?>)"
                                    ...
                                    <span style="background: #fcb632;color: black;" class="badge badge-light">

                                    <?=$talab_done->morfqat_num?></span>
...
<?php }else{  ?>
  ...
  <?php } ?>
        ...
        <div class="modal-dialog modal_details">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">تحديد المدة</h4>
    ...
    function add_geha(value) {
        ...
        if (value != 0 && value != '' && mob != ' ' && address != ' ') {
            ...
            $.ajax({
                ...
                url: '<?php echo base_url() ?>human_resources/employee_forms/namazegs/Namazeg/insert_geha_ajax',
    ...
    function Delete_namozeg(value) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                window.location.href = "<?php echo base_url();?>human_resources/employee_forms/namazegs/Namazeg/Delete_namozeg/" + value;
    ...
    function details(value) {
        ...
        if (value != 0 && value != '') {
            ...
            $.ajax({
                ...
                url: '<?php echo base_url() ?>human_resources/employee_forms/namazegs/Namazeg/getDetailsDiv',
...
<script>
    ...
    function update_geha(id) {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url() ?>human_resources/employee_forms/namazegs/Namazeg/getById",
        ...
        $('#update').on('click', function () {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url() ?>human_resources/employee_forms/namazegs/Namazeg/update_geha",
    ...
    function delte_geha(id) {
        ...
        if (r == true) {
            ...
            $.ajax({
                ...
                url: '<?php echo base_url() ?>human_resources/employee_forms/namazegs/Namazeg/delete_geha',
...
<script>
            ...
            function GetDiv_emps(div) {
                ...
                var oTable_usergroup = $('#js_table_members2').DataTable({
                    ...
                    "ajax": '<?php echo base_url(); ?>human_resources/employee_forms/namazegs/Namazeg/getConnection_emp/',
...
function GetNamozegDiv(value) {
    ...
    if (value != 0 && value != '') {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url() ?>human_resources/employee_forms/namazegs/Namazeg/getNamozegDetails',
...
<script>
    ...
    function printNamazeg(row_id) {

        var request = $.ajax({

            // print_resrv -- print_contract

            url: "<?=base_url() . 'human_resources/employee_forms/namazegs/Namazeg/printNamazeg_2'?>",
...
<script>
    ...
    function make_suspend(rkm, td_id) {

        var title = "هل تريد  تنفيذ الطلب ؟";
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url();?>human_resources/employee_forms/namazegs/Namazeg/make_suspend",
    ...
    function put_value(id, rkm) {
        ...
        $.ajax({
            ...
            beforeSend: function () {
                ...
                $('.tbody').html('<div class=\'loader-img\'><div class=\'bar1\'></div><div class=\'bar2\'></div><div class=\'bar3\'></div><div class=\'bar4\'></div><div class=\'bar5\'></div><div class=\'bar6\'></div></div>');
    ...
    function get_days_details(valu) {
    
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>human_resources/employee_forms/namazegs/Namazeg/add_days",
            data: {
                rkm_id: valu
            },
            success: function(d) {
