...
<div class="col-sm-12 no-padding">
    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
        ...
        <div class="panel-body">
            ...
            if (!empty($result)) {
                ...
                echo form_open_multipart('human_resources/employee_forms/namazegs/Namazeg/update', array('id' => 'myform'));
    ...
    $mosma_wazefy_n = $result['mosma_wazefy_n'];
               ...
               // $responsable_name = $result['responsable_name'];//1-5-om
                ...
                echo form_open_multipart('human_resources/employee_forms/namazegs/Namazeg/insert', array('id' => 'myform'));
            ...
            <div class="col-sm-2  col-md-2 padding-4 ">
                ...
                <div class="col-sm-3  col-md-5 padding-4 ">
                    ...
                    <button type="button" data-toggle="modal"
                            ...
                            data-target="#myModalInfo20" class="btn btn-success btn-next"
                ...
                <div class="col-sm-3  col-md-7 padding-4 ">
                        ...
                        <tr>
                         ...
                         <span style="font-size: 12px; color: white !important; font-weight: normal;width: 141px;"
                            ...
                            <td>
                                ...
                                <a href="<?php echo base_url() . 'human_resources/employee_forms/namazegs/Namazeg/edit/' . $value->letter_rkm ?>"
                                ...
                                <!-- <a href="<?php echo base_url() . 'human_resources/employee_forms/namazegs/Namazeg/printNamazeg/' . $value->letter_rkm ?>"
                                   ...
                                   <a onclick="printNamazeg(<?=$value->letter_rkm ?>)" title="طباعه"><i
...
<div class="modal fade" id="myModalInfo20" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
