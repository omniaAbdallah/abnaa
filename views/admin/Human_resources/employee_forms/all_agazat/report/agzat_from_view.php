    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            <div class="col-md-12">
                ...
                <div class="col-md-2 padding-4">
                    <button type="button" onclick=" make_search();" class="btn btn-labeled btn-success  " id="reg" name="add" value="بحث">
...
<script type="text/javascript">
    function make_search() {
      ...
      if (emp_id_fk !="none") {
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>human_resources/employee_forms/all_agazat/report/Reportes/get_vacation_search',
