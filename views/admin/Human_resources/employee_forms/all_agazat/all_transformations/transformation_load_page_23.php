...
<div class="modal-body">
    <div class="col-sm-9 padding-4">
        ...
        <form enctype="multipart/form-data" method="post" id="form1" action="<?php echo base_url() ?>human_resources/employee_forms/all_agazat/all_transformations_f/All_transformations/saveTransformBadel">
                        ...
                        <tr>
                            <td colspan="3" style="background-color:#ffb3b7; border-color:#73b300">
                                ...
                                <div class="radio-content">
                                    ...
                                    $('#current_to_id_DirectManger').removeAttr('data-validation');" id="tahod-2" data-validation="required" value="2">
    ...
    <form enctype="multipart/form-data" method="post" id="form2" action="<?php echo base_url() ?>human_resources/employee_forms/all_agazat/all_transformations_f/All_transformations/saveTransformDirectManger">
      <?php if (isset($_POST['from_profile'])&&($_POST['from_profile'] == 1)) { ?>
      <input type="hidden" name="from_profile" id="from_profile" value="1">
      <?php } ?>
...
<form enctype="multipart/form-data" method="post" id="form3" action="<?php echo base_url() ?>human_resources/employee_forms/all_agazat/all_transformations_f/All_transformations/saveTransformDirectManger">
        ...
        <tbody>
            ...
            <tr>
                <td colspan="4" style="background-color:#ffb3b7; border-color:#73b300">
                    ...
                    <div class="radio-content">
                        <input type="radio" name="action" data-validation="required" id="accept-2"
                        onclick="change_photo_DirectMange2r(2);$('#reason_action3').removeAttr('disabled');$('#current_to_id_formDirectManger').removeAttr('data-validation'); " value="2">
...
<form enctype="multipart/form-data" method="post" id="form4" action="<?php echo base_url() ?>human_resources/employee_forms/all_agazat/all_transformations_f/All_transformations/saveTransformToManger">
  <?php if (isset($_POST['from_profile'])&&($_POST['from_profile'] == 1)) { ?>
  <input type="hidden" name="from_profile" id="from_profile" value="1">
  <?php } ?>
...
<form enctype="multipart/form-data" method="post" id="form5" action="<?php echo base_url() ?>human_resources/employee_forms/all_agazat/all_transformations_f/All_transformations/saveTransformManger">
    ...
    <div class="col-sm-12 no-padding">
        ...
        <div class="form-group col-md-6 col-sm-6 padding-4">
            ...
            <select data-validation="required" name="current_to_id" id="current_to_id" class="form-control bottom-input  nonactive current_to_id" data-validation="required" aria-required="true" onchange="">
                ...
                <option value="<?= $agaza_data->emp_id_fk ?>" data-img="<?= $agaza_data->personal_photo ?>" data-name="<?= $agaza_data->employee ?>" data-job="<?= $agaza_data->job_title ?>"><?= $agaza_data->employee ?></option>
                <?php } ?>
            </select>
...
<div class="col-sm-3 padding-4">
    <table class="table table-bordered s" style="">
        <thead>
            <tr>
                <td colspan="2">
                    <img id="empImg" src="<?php echo base_url(); ?>/asisst/fav/apple-icon-120x120.png" class="center-block img-responsive" style="width: 180px; height: 150px" />
                </td>
            </tr>
        </thead>
        <tbody>
