...
<div class="modal-body">
    <div class="col-sm-9 padding-4">
        ...
        <form enctype="multipart/form-data" method="post" id="form1"
            ...
            <!--</pre>-->
            <input type="hidden" name="link_mobasher" id="link_mobasher"
                   value="<?php echo $modeer_mobasher->personal_photo; ?>">
            <input type="hidden" name="name_mobasher" id="name_mobasher"
                   value="<?php echo $modeer_mobasher->employee; ?>">
            <input type="hidden" name="job_mobasher" id="job_mobasher"
                   value="<?php echo $modeer_mobasher->job_title; ?>">
                ...
                <table class="table table-bordered" border="1" cellpadding="3" cellspacing="0" style="width:100%">
                    ...
                    <tr>
                        <td colspan="3" style="background-color:#e6eed5; border-color:#73b300">
                            <div class="radio-content">
                                <input type="radio" onclick="change_photo(1);
                                    $('#reason_action1').attr('disabled','TRUE');
                                    $('#current_to_id_DirectManger').attr('data-validation','required');
                            $('#reason_action1').val('................');" id="tahod-1" data-validation="required"
                                       name="action" value="1">
                    ...
                    <tr>
                        <td colspan="3" style="background-color:#ffb3b7; border-color:#73b300">
                            ...
                            <div class="radio-content">
                                <input type="radio" name="action" onclick="change_photo(2);
                                    $('#reason_action1').removeAttr('disabled');
                                    $('#current_to_id_DirectManger').removeAttr('data-validation');" id="tahod-2"
    ...
    <div class="col-sm-3">
        <table class="table table-bordered" style="">
            ...
            <tr>
                <td colspan="2">
                    <img id="empImg_1" src="<?php echo base_url(); ?>/asisst/fav/apple-icon-120x120.png"
    ...
    <form enctype="multipart/form-data" method="post" id="form2"
                ...
                <td colspan="3" style="background-color:#e6eed5; border-color:#73b300">
                  ...
                  $('#current_to_id_DirectManger').attr('data-validation','required');
                     $('#reason_action2').attr('disabled',true);" value="1">
                        ...
                        <label class="radio-label" for="accept-1"> أوافق على أجازة الموظف المذكور أعلاه وسيتم تسليم
                            أعماله
                            للموظف البديل </label>
                ...
                <td colspan="3" style="background-color:#ffb3b7; border-color:#73b300">
                    ...
                    <div class="radio-content">
                        <input type="radio" name="action" data-validation="required" id="accept-2"
                               onclick="change_photo_DirectManger(2);
                            $('#current_to_id_DirectManger').removeAttr('data-validation');
                            $('#reason_action2').removeAttr('disabled'); " value="2">
        ...
        <div class="col-sm-12 no-padding" id="DirectMangerDiv">
            <div class="form-group col-md-6 col-sm-6 padding-4">
                ...
                <select data-validation="required" aria-required="true" aria-required="true" name="admins" id="admins"
                        onchange="getDepartmentMembersDirectManger($(this).val())" class="form-control">
                    <?php if (!empty($department_jobs_all)) {
                        foreach ($department_jobs_all as $row) { ?>
            ...
            <div class="form-group col-md-6 col-sm-6 padding-4">
                ...
                <select data-validation="required" name="current_to_id" id="current_to_id_DirectManger"
                    ...
                    <?php if (!empty($department_emps)) {
                        foreach ($department_emps as $row) { ?>
                            <option value="<?= $row->id ?>" data-img="<?= $row->personal_photo ?>"
                                    data-name="<?= $row->employee ?>"
                                    data-job="<?= $row->job_title ?>"><?= $row->employee ?></option>
                        <?php }
                    } ?>
                </select>
    ...
    <form enctype="multipart/form-data" method="post" id="form3"
        ...
        <table class="table table-bordered" border="1" cellpadding="3" cellspacing="0" style="width:100%">
            ...
            <tr>
                <td colspan="4" style="background-color:#e6eed5; border-color:#73b300">
                    ...
                    $('#reason_action3').val('...........');
                     ...
                     $('#current_to_id_formDirectManger').attr('data-validation','required');" value="1">
            ...
            <tr>
                <td colspan="4" style="background-color:#ffb3b7; border-color:#73b300">
                    ...
                    <div class="radio-content">
                        <input type="radio" name="action" data-validation="required" id="accept-2"
                               onclick="change_photo_DirectMange2r(2);$('#reason_action3').removeAttr('disabled');$('#current_to_id_formDirectManger').removeAttr('data-validation'); "
                               value="2">
        ...
        <div class="col-sm-12 no-padding" id="DirectMangerDiv2">
            ...
            <div class="form-group col-md-6 col-sm-6 padding-4">
                <label class="label">الإدارة</label>
                <select data-validation="required" aria-required="true" aria-required="true" name="admins" id="admins"
                        onchange="getDepartmentMembersformDirectManger($(this).val())" class="form-control">
                    <?php if (!empty($department_jobs_all)) {
                        foreach ($department_jobs_all as $row) { ?>
                            <option value="<?php echo $row->id; ?>"> <?php echo $row->name; ?></option>
            ...
            <div class="form-group col-md-6 col-sm-6 padding-4">
                <label class="label">الموظف</label>
                <select data-validation="required" name="current_to_id" id="current_to_id_formDirectManger"
                        class="form-control" data-validation="required" aria-required="true" onchange="
...
<?php if ($_POST['toUser'] == $_SESSION['user_id'] && $_POST['level'] == 4) { ?>
    ...
    <form enctype="multipart/form-data" method="post" id="form4"
                ...
                <td colspan="4" style="background-color:#e6eed5; border-color:#73b300">
                    <div class="radio-content">
                      ...
                      $('#reason_action4').val('...........');
                       ...
                       $('#current_to_id_ToManger').attr('data-validation','required');" value="1">
            ...
            <tr>
                <td colspan="4" style="background-color:#ffb3b7; border-color:#73b300">
                    ...
                    <div class="radio-content">
                       ...
                       $('#current_to_id_ToManger').removeAttr('data-validation');"> لا أوافق بسبب </label>
                    </div>
        ...
        <div class="col-sm-12 no-padding" id="DirectMangerDiv3">
            ...
            <div class="form-group col-md-6 col-sm-6 padding-4">
                <label class="label">الإدارة</label>
                <select data-validation="required" aria-required="true" name="admins" id="admins"
                        onchange="getDepartmentMembersToManger($(this).val())" class="form-control">
                    <?php if (!empty($department_jobs_all)) {
                        foreach ($department_jobs_all as $row) { ?>
                            <option value="<?php echo $row->id; ?>"> <?php echo $row->name; ?></option>
            ...
            <div class="form-group col-md-6 col-sm-6 padding-4">
                <label class="label">الموظف</label>
                <select data-validation="required" name="current_to_id" id="current_to_id_ToManger" class="form-control"
    ...
    <form enctype="multipart/form-data" method="post" id="form5"
                ...
                <td colspan="4" style="background-color:#e6eed5; border-color:#73b300">
                    <div class="radio-content">
                        <input type="radio" id="accept-1" data-validation="required" name="action" onclick="$('#reason_action5').val('...........'); $('#approved').val(1);
                                     ...
                                     $('#current_to_id').attr('data-validation','required');" value="1">
                        <label class="radio-label" for="accept-1">أوافق</label>
            ...
            <tr>
                <td colspan="4" style="background-color:#ffb3b7; border-color:#73b300">
                    ...
                    <div class="radio-content">
                        ...
                        <label class="radio-label" for="accept-2" onclick="$('#reason_action5').removeAttr('disabled');
                        $('#current_to_id').removeAttr('data-validation')"> لا أوافق بسبب </label>
                    </div>
        ...
        <div class="col-sm-12 no-padding">
            ...
            <div class="form-group col-md-6 col-sm-6 padding-4">
                ...
                <label class="label">الإدارة</label>
                <select data-validation="required" aria-required="true" name="admins" id="admins" disabled
                        class="form-control">
                    <?php if (!empty($department_jobs_all)) {
                        foreach ($department_jobs_all as $row) { ?>
                            <option value="<?php echo $row->id; ?>"> <?php echo $row->name; ?></option>
            ...
            <div class="form-group col-md-6 col-sm-6 padding-4">
                ...
                <select data-validation="required" name="current_to_id" id="current_to_id"
                    ...
                    <?php if (!empty($agaza_data->emp_id_fk)) { ?>
                        <option value="<?= $agaza_data->emp_id_fk ?>" data-img="<?= $agaza_data->personal_photo ?>"
                                data-name="<?= $agaza_data->employee ?>"
                                data-job="<?= $agaza_data->job_title ?>"><?= $agaza_data->employee ?></option>
                    <?php } ?>
                </select>
...
<div class="modal-footer" style="display: inline-block;width: 100%;">
    <?php if ($_POST['toUser'] == $_SESSION['user_id'] && $_POST['level'] == 1) { ?>
        ...
        $('#approved').val(status);$('#form1').submit();" class="btn btn-success btn-labeled"><span class="btn-label"><i
    ...
    <?php if ($_POST['toUser'] == $_SESSION['user_id'] && $_POST['level'] == 4) { ?>
        ...
        $('#approved').val(status);$('#form4').submit();" class="btn btn-success btn-labeled"><span class="btn-label"><i
                        class="glyphicon glyphicon-floppy-disk"></i></span>حفظ
        </button>
    ...
    <?php if ($_POST['toUser'] == $_SESSION['user_id'] && $_POST['level'] == 5) { ?>
        ...
        $('#approved').val(status);$('#form5').submit();" class="btn btn-success btn-labeled"><span class="btn-label"><i
                        class="glyphicon glyphicon-floppy-disk"></i></span>حفظ
        </button>
