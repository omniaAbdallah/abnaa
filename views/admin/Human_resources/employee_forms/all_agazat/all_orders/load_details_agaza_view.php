...
<div class="col-xs-9 padding-4">
    ...
    if (isset($item) && !empty($item)) {
        ...
        <table class="table table-bordered" style="table-layout: fixed">
            ...
            <tbody>
            <?php
  /*          $item->agaza_from_date_m = explode('/', $item->agaza_from_date_m)[2] . '/' . explode('/', $item->agaza_from_date_m)[0] . '/' . explode('/', $item->agaza_from_date_m)[1];
...
<div class="col-xs-3 padding-4" width="100%">
    ...
    if (isset($item) && !empty($item)) { ?>
        ...
        <span class="profile-picture">
             <img id="empImg_1"
                  src="<?php echo base_url() ?>uploads/human_resources/emp_photo/thumbs/<?php echo $item->personal_photo ?>"
