...
<div class="col-xs-2 padding-4" width="100%">
        ...
        <span class="profile-picture">
            ...
            <img id="empImg_1" src="<?php echo base_url()?>uploads/human_resources/emp_photo/thumbs/<?php echo $personal_data[0]->personal_photo?>"
                                        ...
                                        <tr>
                                          ...
                                          <td><?php echo $record['year']; ?></td>
                                            ...
                                            <?php if($record['paid']=='no'){ ?>
                                                <a href="#" class="btn btn-primary" onclick="quest_paid(<?=$record['id']?>,<?=$record['t_rkm_fk']?>)">غير مسدد <i class="fa fa-edit"> </i>
                                                </a>
                                            <?php }else{?>
