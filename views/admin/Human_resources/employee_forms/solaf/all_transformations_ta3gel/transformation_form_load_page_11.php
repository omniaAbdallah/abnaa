...
<div class="modal-body">
    <div class="col-sm-10 padding-4">
        <form enctype="multipart/form-data" method="post" id="form1"
              action="<?php echo base_url() ?>human_resources/employee_forms/solaf/All_transformations_ta3gel/save_Transform">
            <?php if (isset($_POST['from_profile']) && ($_POST['from_profile'] == 1)) { ?>
                <input type="hidden" name="from_profile" id="from_profile" value="1">
            <?php } ?>
            <input type="hidden" name="ta3gel_rkm_fk" id="ta3gel_rkm_fk" value="<?= $talab_data->t_rkm ?>">
            <input type="hidden" name="ta3gel_id_fk" id="ta3gel_id_fk" value="<?= $talab_data->id ?>">
                ...
                foreach ($quests as $key) {
                    ...
                    ?>
                        ...
                        <table class="table table-bordered hl white-border" style="table-layout: fixed;">
                            <tbody>
                            <tr class="rosasy-bg">
                                <td style="width: 130px"> سبب التعجيل</td>
                        ...
                        <tr>
                            <td colspan="8" style="background-color:#e6eed5; border-color:#73b300">
                                <div class="radio-content">
                                    ...
                                    <label class="radio-label" for="tahod-1">تم التأكد من صحة البيانات</label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="8" style="background-color:#ffb3b7; border-color:#73b300">
                                <div class="radio-content">
                                    <input type="radio" name="action_moder_fr"
                                           ...
                                           id="tahod-2" value="2">
                                    <label class="radio-label" for="tahod-2">لم يتم التأكد من صحة البيانات لسبب 
