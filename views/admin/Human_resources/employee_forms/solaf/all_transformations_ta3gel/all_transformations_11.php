...
<script>
    ...
    function print_(value) {
        ...
        var request = $.ajax({
            ...
            url: "<?=base_url() . 'human_resources/employee_forms/solaf/All_transformations_ta3gel/print_transformation/'?>",
            type: "POST",
            data: {
                t_rkm: t_rkm
            },
...
<script type="text/javascript">
    function transformRequest(level, t_rkm, fromUser, toUser) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>human_resources/employee_forms/solaf/All_transformations_ta3gel/Get_load_page',
            data: {
    ...
    function make_transformRequest(t_rkm) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>human_resources/employee_forms/solaf/All_transformations_ta3gel/Get_transformation_form',
            data: {
                <?php if ((isset($tab_id)) && (!empty($tab_id)) ) {?>
                from_profile:1,
                <?php }?>
...
<script type="text/javascript">
    function transformDetails(value,solfa_rkm) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>human_resources/employee_forms/solaf/All_transformations_ta3gel/Get_transformDetails',
            data: {
                t_rkm: value,
                solfa_rkm:solfa_rkm
            },
...
<script type="text/javascript">
    function motab3a_details(value) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>human_resources/employee_forms/solaf/All_transformations_ta3gel/motab3a_details',
            data: {
                t_rkm: value
            },
            dataType: 'html',
