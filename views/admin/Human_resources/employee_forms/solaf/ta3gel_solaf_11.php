...
$ta3gel_reason='';
        ...
        data-validation="required"
                ...
                onchange="get_value_sadad(<?php echo $item->qemt_solaf / $item->qst_num; ?>);"
            ...
            if (isset($quests) && (!empty($quests))) {
                foreach ($quests as $key) {
                    ...
                    ?>
                    <option value="<?php echo $key['month']; ?>" <?= $select ?>> <?php echo $key['month']; ?></option>
                <?php }
            } ?>
        </select>
    </div>
                                ...
                                <div class="form-group col-md-5  col-sm-6 col-xs-6  padding-4">
                                    ...
                                    <input type="text" id="ta3gel_reason" name="ta3gel_reason"  data-validation="required"
