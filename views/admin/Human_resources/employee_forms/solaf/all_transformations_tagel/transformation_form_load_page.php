...
<div class="modal-body">
    <div class="col-sm-10 padding-4">
        <form enctype="multipart/form-data" method="post" id="form1"
              action="<?php echo base_url() ?>human_resources/employee_forms/solaf/All_transformations_tagel/save_Transform">
            <?php if (isset($_POST['from_profile']) && ($_POST['from_profile'] == 1)) { ?>
                <input type="hidden" name="from_profile" id="from_profile" value="1">
            <?php } ?>
            <input type="hidden" name="tagel_rkm_fk" id="tagel_rkm_fk" value="<?= $talab_data->t_rkm ?>">
            <input type="hidden" name="tagel_id_fk" id="tagel_id_fk" value="<?= $talab_data->id ?>">
            <input type="hidden" name="from_user" id="from_user" value="<?= $talab_data->current_to_user_id ?>">
            <input type="hidden" name="emp_id_fk" id="emp_id_fk" value="<?= $talab_data->emp_id_fk ?>">
                    ...
                    <div class="piece-body">
                        ...
                        <table class="table table-bordered hl white-border" style="table-layout: fixed;">
                            ...
                            <tr class="rosasy-bg">
                                ...
                                <td class="white-bg"><?php echo $talab_data->for_month; ?></td>
                                <td style="width: 110px"> فئه التأجيل</td>
                                <td class="white-bg"><?php if ($talab_data->fe2a_tagel == 1) {
                                        echo ' أضافة للشهر القادم ';
                                    } elseif ($talab_data->fe2a_tagel == 2) {
                                        echo '  أضافة لاخر شهر';
                                    } elseif ($talab_data->fe2a_tagel == 3) {
                                        echo 'اعادة الجدوله علي الاشهر المتبقية';
                                    } elseif ($talab_data->fe2a_tagel == 4) {
                                        echo 'زيادة شهر جديد';
                                    }
                                    ?></td>
                            </tr>
                        ...
                        <table class="table table-bordered hl white-border" style="table-layout: fixed;">
                            ...
                            <tr class="rosasy-bg">
                                ...
                                <td class="white-bg"><?php echo $talab_data->tagel_reason; ?></td>
                            </tr>
                            </tbody>
                        </table>
                        <!-- </div> -->
...
<div class="col-sm-2 padding-4">
    <table class="table table-bordered" style="">
        ...
        <tr>
            <td id="name-emp" class="text-center"> <?php echo $talab_data->emp_name ?></td>
        </tr>
        <tr class="greentd">
            <td class="text-center">الوظيفة</td>
        </tr>
        <tr>
            <td id="job-title" class="text-center"><?php echo $talab_data->job_title ?></td>
        </tr>
        </tbody>
    </table>
</div>
...
<div class="modal-footer" style="display: inline-block;width: 100%;">
    <?php if ($talab_data->current_to_user_id == $_SESSION['user_id'] && (in_array($talab_data->level, array(1, 2)))) { ?>
