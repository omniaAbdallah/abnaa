                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php } else {
                                                ?>
                                    <a type="button" class="btn btn-primary btn-xs" style="padding: 1px 6px;" data-toggle="modal" data-target="#transform_details" onclick="transformDetails(<?php echo $row->t_rkm; ?>,<?php echo $row->solfa_rkm; ?>)"><i class="fa fa-list"></i>
                                    </a>
...
<script>
    ...
    function print_(value) {
        ...
        var request = $.ajax({
            ...
            url: "<?=base_url() . 'human_resources/employee_forms/solaf/All_transformations_tagel/print_transformation/'?>",
            type: "POST",
            data: {
                t_rkm: t_rkm
            },
...
<script type="text/javascript">
    function transformRequest(level, t_rkm, fromUser, toUser) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>human_resources/employee_forms/solaf/All_transformations_tagel/Get_load_page',
            data: {
    ...
    function make_transformRequest(t_rkm) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>human_resources/employee_forms/solaf/All_transformations_tagel/Get_transformation_form',
            data: {
                <?php if ((isset($tab_id)) && (!empty($tab_id)) ) {?>
                from_profile:1,
                <?php }?>
...
<script type="text/javascript">
    function transformDetails(value,solfa_rkm) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>human_resources/employee_forms/solaf/All_transformations_tagel/Get_transformDetails',
            data: {
                t_rkm: value,
                solfa_rkm:solfa_rkm
            },
...
<script type="text/javascript">
    function motab3a_details(value) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>human_resources/employee_forms/solaf/All_transformations_tagel/motab3a_details',
            data: {
                t_rkm: value
            },
            dataType: 'html',
