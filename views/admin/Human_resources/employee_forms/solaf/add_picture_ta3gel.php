...
<div class="col-md-12 no-padding">
    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
            <div class="panel-heading">
                <h3 class="panel-title">تفاصيل السلفة</h3>
            </div>
            <?php
if(!empty($get_all->t_rkm))
{
$data['rows'] = $this->Solaf_requests_model->get_by_t_rkm_details($get_all->solfa_rkm);
$this->load->view('admin/Human_resources/employee_forms/solaf/solaf_load_tabel', $data);
}
            ?>
</div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php
                                        ...
                                        ?>
                                        <!-- <a target="_blank" href="<?=base_url()."human_resources/employee_forms/solaf/Solaf/read_file_ta3gel/".$morfaq->file?>">
                        ...
                        <div class="modal fade" id="myModal-pdf-<?= $morfaq->id ?>" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                             <iframe src="<?=base_url()."human_resources/employee_forms/solaf/Solaf/read_file_ta3gel/".$morfaq->file?>" style="width: 100%; height:  640px;" frameborder="0">
                                               </iframe>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-default" data-dismiss="modal">
...
?>
                                ...
                                <td>
                                    ...
                                    <i class="fa fa-trash" style="cursor: pointer"
                                       onclick="delete_morfq(<?= $morfaq->id ?>,<?= $morfaq->ta3gel_id_fk ?>)"></i>
                                </td>
                            </tr>
                        <?php
                        }
...
<script>
    ...
    closeOnConfirm: false
        ...
        if(error == '') {
            $.ajax({
                url:"<?php echo base_url(); ?>human_resources/employee_forms/solaf/Solaf/upload_img_ta3gel", //base_url() return http://localhost/tutorial/codeigniter/
                method:"POST",
                data:form_data,
                contentType:false,
                cache:false,
...
function(isConfirm) {
  if (isConfirm) {
      $.ajax({
          type: 'post',
          url: '<?php echo base_url() ?>human_resources/employee_forms/solaf/Solaf/delete_morfq_ta3gel',
          data: {id: id},
          dataType: 'html',
          cache: false,
    ...
    function get_details(id) {
       // $('#pop_rkm').text(rkm);
        $.ajax({
            type: 'post',
            data: {id: id},
            url: "<?php echo base_url();?>human_resources/employee_forms/solaf/Solaf/load_ta3gel",
            beforeSend: function () {
...
<script>
    function val_id(val_id)
    {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>human_resources/employee_forms/solaf/Solaf/get_fatora_attach",
            data: {
                val_id: val_id,
            },
            success: function (d) {
...
<script>
    function get_details_title(row_id) {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>human_resources/employee_forms/solaf/Solaf/load_details",
            data: {row_id: row_id},
            beforeSend: function () {
