...
<div class="col-md-12 no-padding">
    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
            <div class="panel-heading">
                <h3 class="panel-title">تفاصيل تكليف</h3>
            </div>
            <?php
if(!empty($this->uri->segment(5)))
{
    $data['one_data'] = $this->Taklef_order_model->get_one_data($this->uri->segment(5));
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php
                                        ...
                                        ?>
                                        <!-- <a target="_blank" href="<?=base_url()."human_resources/employee_forms/taklef/Taklef_order/read_file/".$morfaq->file?>">
                        ...
                        <div class="modal fade" id="myModal-pdf-<?= $morfaq->id ?>" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                             <iframe src="<?=base_url()."human_resources/employee_forms/taklef/Taklef_order/read_file/".$morfaq->file?>" style="width: 100%; height:  640px;" frameborder="0">
                                               </iframe>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-default" data-dismiss="modal">
...
?>
                                ...
                                <a href="<?= base_url().$folder.'/'.$morfaq->file?>" download>  <i class="fa fa-download fa-2x" aria-hidden="true" ></i> </a>
                                    <i class="fa fa-trash" style="cursor: pointer"
                                       onclick="delete_morfq(<?= $morfaq->id ?>,<?= $morfaq->taklef_id_fk ?>)"></i>
                                </td>
                            </tr>
                        <?php
                        }
...
<script>
    ...
    closeOnConfirm: false
        ...
        if(error == '') {
            $.ajax({
                url:"<?php echo base_url(); ?>human_resources/employee_forms/taklef/Taklef_order/upload_img", //base_url() return http://localhost/tutorial/codeigniter/
                method:"POST",
                data:form_data,
                contentType:false,
                cache:false,
...
function(isConfirm) {
  if (isConfirm) {
      $.ajax({
          type: 'post',
          url: '<?php echo base_url() ?>human_resources/employee_forms/taklef/Taklef_order/delete_morfq',
          data: {id: id},
          dataType: 'html',
          cache: false,
    ...
    function get_details(id) {
       // $('#pop_rkm').text(rkm);
        $.ajax({
            type: 'post',
            data: {id: id},
            url: "<?php echo base_url();?>human_resources/employee_forms/taklef/Taklef_order/load",
            beforeSend: function () {
...
<script>
    function val_id(val_id)
    {
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>human_resources/employee_forms/taklef/Taklef_order/get_fatora_attach",
            data: {
                val_id: val_id,
            },
            success: function (d) {
