...
<?php if (isset($_SESSION['user_login_name']) && $_SESSION['user_login_name'] != null) {
    ...
    echo $_SESSION['user_name'];
                    ...
                    <?php } else { ?>
                        <button style="float: left; margin-left: 4px;" id="add_cart"
                                onclick="get_details(<?= $current_month_mosayer ?>);" type="button"
                                class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModal">
                            <i class="fa fa-cogs" aria-hidden="true"></i>
