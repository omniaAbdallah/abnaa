...
$mosayer_rkm_fk = $this->uri->segment(5);
...
<input type="hidden" name="mosayer_rkm" id="mosayer_rkm" value="<?=$mosayer_rkm_fk?>" />
<input type="hidden" name="mosayer_rkm_fk" id="mosayer_rkm_fk" value="<?=$mosayer_rkm_fk?>" />
...
<script>
 ...
 var mosayer_rkm = $('#mosayer_rkm').val();
        ...
        $.ajax({
            ...
            url: '<?php echo base_url() ?>human_resources/employee_forms/Employee_salaries/make_search_in_mosayer',
...
<script>
    ...
    function print_card() {
        ...
        var request = $.ajax({
            ...
            url: "<?=base_url() . 'human_resources/employee_forms/Employee_salaries/print_card_in_mosayer'?>",
