<?php
if (isset($mosayer_attechment) && !empty($mosayer_attechment)){
    $x=1;
    ...
    <table id="example" class="table  table-bordered table-striped table-hover">
        ...
        <tbody >
        <?php
        foreach ($mosayer_attechment as $morfaq){
            ...
            <tr>
                ...
                <td>
                    ...
                    if (in_array($ext,$image)){
                        ...
                        <a data-toggle="modal" data-target="#myModal-view" onclick="$('#img_view').attr('src','<?= base_url().$folder ."/".$morfaq->attechment?>')">
                        ...
                        ?>
                        <a data-toggle="modal" data-target="#myModal-pdf" onclick="$('#pdf_iframe').attr('src','<?=base_url()."human_resources/employee_forms/Employee_salaries/read_file_attechment/".$morfaq->attechment?>')">
                            <i class="fa fa-eye" title=" قراءة"></i> </a>
                        <!-- modal view -->
                        <?php
                    }
