             ...
             if (isset($all_data) && !empty($all_data)) { ?>
                ...
                <table id="" class="example display table table-bordered   responsive nowrap" cellspacing="0">
                    ...
                    <tr class="info">
                        ...
                        <th class="text-center">رقم المسير</th>
                  
                        <th class="text-center">تاريخ المسير</th>
                       
                        <th class="text-center">رواتب الموظفين خلال شهر</th>
                        <th class="text-center"> إجمالي الموظفين</th>
                        <th class="text-center"> إجمالي المسير</th>
                       <th class="text-center">كشف التأمينات الاجتماعية</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php  
                        ...
                        <tr class="">
                         ...
                         <?php if (isset($months[$month])) {
                            ...
                            <?php }?>
                             ...
                             <td><?=($record->num_all_sheeks+$record->num_all_tahwel)?></td>
                            <td><?=($record->sum_all_sheeks+$record->sum_all_tahwel)?></td>
                            <td>   
                                <a href="<?=base_url()?>human_resources/employee_forms/Employee_salaries/show_insurance_emps/<?=$record->mosayer_rkm?>"  title="كشف التأمينات الاجتماعية"
...
<script>
       function get_details(mosayer_rkm,f2a) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>human_resources/employee_forms/Employee_salaries/LoadPage_social_insurance',
