    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
        ...
        <div class="panel-body">
            <div class="col-sm-11 padding-4">
                ...
                $pay_method = 4;
                $type_paid = 1;
                $about = 'رواتب الموظفين شهر ';;
                if (!empty($all_mosayer_egmali)) {
                    if (!empty($all_mosayer_egmali->mosayer_date_ar)) {
                        $months = array("01" => "يناير", "02" => "فبراير", "03" => "مارس", "04" => "أبريل", "05" => "مايو",
                    "06" => "يونيو", "07" => "يوليو", "08" => "أغسطس", "09" => "سبتمبر", "10" => "أكتوبر",
                    "11" => "نوفمبر", "12" => "ديسمبر");
                        
                    
                        $orderdate = explode('-', $all_mosayer_egmali->mosayer_date_ar);
                        $month = $orderdate[1];
                        $day = $orderdate[2];
                        $year = $orderdate[0];
                        if (isset($months[$month])) {
                            $about .= $months[11].''.$months[11];
                        }
                        if (isset($year)) {
                            $about .= $year;
                        }
