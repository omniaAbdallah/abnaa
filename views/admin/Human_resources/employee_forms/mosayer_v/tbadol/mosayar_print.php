            ...
            <div class="col-xs-12" style="padding: 0; margin-bottom:25px;">
                <h4 style="font-weight: 600;" class="text-center"> <span style="border-bottom: 1px solid; padding-bottom: 5px;" > نموذج إرسال ملف
                 ...
                 <?php $months = array("01" => "يناير", "02" => "فبراير", "03" => "مارس", "04" => "أبريل", "05" => "مايو",
                    ...
                    "11" => "نوفمبر", "12" => "ديسمبر"); ?>
                 <?php
                            if(!empty($sarf_data->mosayer_date_ar))
                            {
                            $orderdate = explode('-', $sarf_data->mosayer_date_ar);
$month = $orderdate[1];
$day   = $orderdate[2];
$year  = $orderdate[0];
?>
                            
                            رواتب الموظفين لشهر <?php if (isset($months[$month])) {
                                    echo $months[$month];
                                } ?>
            ...
            <div class="col-xs-12 no-padding">
                ...
                <div class="col-xs-4">
                    ...
                    <h5 class="text-center box_input" ><strong><?php if(isset($egmali)){ echo $egmali;}  ?></strong></h5>
                </div>
            </div>

            <div class="col-xs-12 no-padding" style="margin-top: 10px;">
                <div class="col-xs-2 no-padding">
                    <h5>إجمالي عدد الموظفين</h5>
                </div>
                <div class="col-xs-3">
                    <h5 class="text-center box_input" ><strong><?=$emps_num;  ?></strong></h5>
                </div>
