...
1=>'المدير المباشر',
2=>'المحاسب',
3=>'مدير الشئون الماليةو الإدارية',
4=>'مدير العام'); ?>


	<div class="exchanges">
<?php    if (!empty($mosayer_data_history)) {   ?>

		<?php
		$x = 1;
		// echo $solaf_data->suspend .'<br>';
		foreach ($mosayer_data_history as $row) {
	...
	<div class="panel panel-card">
		...
		<div class="panel-body">
			<div class="card-image">
				<img src="<?php echo base_url();?>uploads/human_resources/emp_photo/thumbs/<?php echo $row->emp_photo?>">
			</div>
