        ...
        <div class="panel-body">
            ...
            <div class="col-md-12 no-padding">
                <div class="form-group col-md-1 col-sm-2 col-xs-12 padding-4">
                    ...
                    <input type="text" id="rkm_talab" name="rkm_talab" value="<?=$rkm_talab?>"
                ...
                <div class="form-group col-md-2 col-sm-2 col-xs-12 padding-4">
                    ...
                    <input type="date" id="date_talab" name="date_talab" value="<?= $date_talab_ar?>"
                ...
                <div class="form-group col-md-3  padding-4 ">
                    ...
                    <input type="text" name="sub_dept" id="sub_dept" value="<?= $dept_name ?>"
                           ...
                           onblur="$(this).attr('readonly','readonly')"
                           readonly>
                    <input type="hidden" name="dep_id_fk" id="dep_id_fk" value="<?= $dep_id_fk ?>">
                    <input type="hidden" name="sub_dep_id_fk" id="sub_dep_id_fk" value="<?= $sub_dep_id_fk ?>">
...
<table id="js_table"
    ...
    <tr class="greentd">
        ...
        <th class="text-center">الإدارة-القسم</th>
        <th class="text-center">مسمي الوظيفة</th>
        <th class="text-center">العدد</th>
        <th class="text-center">نوع الوظيفة</th>
        <th class="text-center">طبيعة العمل بالوظيفة</th>
