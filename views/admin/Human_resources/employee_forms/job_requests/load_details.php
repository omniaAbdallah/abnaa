...
<div class="col-xs-12 padding-4">
    ...
    <table class="table " style="table-layout: fixed">
        <tbody>
        <tr>
            <td style="width: 105px;"><strong>  رقم الطلب </strong></td>
            <td style="width: 10px;"><strong>:</strong></td>
            <td><?= $get_requset->rkm_talab?></td>


            <td style="width: 105px;"><strong>  تاريخ الطلب </strong></td>
            <td style="width: 10px;"><strong>:</strong></td>
            <td><?= $get_requset->date_talab_ar?></td>


            <td style="width: 200px;"><strong>  الإدارة-القسم </strong></td>
            <td style="width: 10px;"><strong>:</strong></td>
            <td colspan="2"><?= $get_requset->dept_name?></td>

            <td style="width: 120px;"><strong>  مسمي الوظيفة </strong></td>
            <td style="width: 10px;"><strong>:</strong></td>
            <td><?= $get_requset->job_title?></td>
        ...
        <tr>
            ...
            <td style="width: 105px;"><strong>     نوع الوظيفة </strong></td>
            <td style="width: 10px;"><strong>:</strong></td>
            <td>  <?= $get_requset->type_name?></td>

            <td style="width: 105px;"><strong>     طبيعة العمل بالوظيفة </strong></td>
            <td style="width: 10px;"><strong>:</strong></td>
