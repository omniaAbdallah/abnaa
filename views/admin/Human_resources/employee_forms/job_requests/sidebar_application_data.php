...
<div class="user-profile">
 ...
 if(isset($personal_data)){
     $user_img=  $personal_data['personal_photo'] ;
        ...
        <img style="width: 100px;" id="profile-img-tag" class="editable img-responsive" src="<?=base_url()?>/uploads/human_resource/job_request/<?php echo $user_img ?>"
    ...
    <div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
        <div class="inline position-relative">
            <a href="#" class="user-title-label dropdown-toggle" data-toggle="dropdown">
                ...
                &nbsp;
                <span class="white"><?php if(isset($personal_data)){ echo  $personal_data['name'];}?></span>
            </a>
            ...
            <table class="table-bordered table table-details" style="table-layout: fixed;">
                                <tbody>
                                    <tr>
                                         ...
                                         <td><strong class="text-danger ">  رقم الطلب: </strong><?php if(isset($personal_data)){  echo $personal_data['id'];}?></td>
                                    </tr>
                                    
                                    
                                     <tr>
                                         
                                         <td><strong class="text-danger "> رقم الهوية :</strong>  <?php if(isset($personal_data)){ echo $personal_data['national_num'];}?></td>
                                    </tr>
