    ...
    function delete_setting(id) {
        ...
        swal({
            ...
            $.ajax({
                ...
                url: '<?php echo base_url()?>human_resources/employee_forms/Volunteer_hours/delete_setting',
...
<script>
    ...
    function get_by_id(row_id) {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url()?>human_resources/employee_forms/Volunteer_hours/get_setting_by_id',
