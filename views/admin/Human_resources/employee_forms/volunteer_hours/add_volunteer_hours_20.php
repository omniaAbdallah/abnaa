                        ...
                        <div class="form-group col-md-2 col-sm-6 col-xs-6 padding-4">
                            ...
                            <label class="label ">الجهة/الإدارة</label>
                                ...
                                <?php } elseif ($mostafed_type_fk == 1) { ?>
                                    ...
                                    <button type="button" id="button_append" class="btn btn-success  "
                                            title="إضافة جهه أخرى" data-toggle="modal" data-target="#myModal"><i
                                                class="fa fa-plus"> </i> إضافة جهه أخرى
                                    </button>
                            ...
                            <select name="responsible" id="responsible_load"
                                        ...
                                        if (!empty($responsibles)):
                                            foreach ($responsibles as $record):
                                                $select = '';
                                                if ($responsible == $record->employee) {
                                                    $select = 'selected';
                                                } ?>
                                                <option
...
<div class="col-xs-12 no-padding">
                        ...
                        <div class="col-md-2 form-group padding-4">
                            ...
                            <input type="text" id="tele" name="tele" maxlength="10" onkeyup="check_len($(this).val());"
                               value="<?= $tele ?>" onkeypress="validate_number(event)"
                                   class="form-control">
                        ...
                        <div class="col-md-2 form-group padding-4">
                            ...
                            <input type="text" id="mob" name="mob" maxlength="10" onkeyup="check_len($(this).val());"
                                value="<?= $mob ?>" onkeypress="validate_number(event)"
                                   class="form-control">
                        </div>
                        <div class="col-md-2 form-group padding-4">
                        ...
                        <!-- <div class="col-md-3 form-group padding-4">
                            ...
                            <textarea name="volunteer_description" class=" form-control" data-validation="required"
        ...
        ?>
                           ...
                           <div class="col-md-3 form-group padding-4">
                            ...
                            <input type="text" class="form-control" value=""
                                               name="forsa_tatw3" id="forsa_tatw3" data-validation="required">
                        </div>
                        
                        
                            <div class="col-md-6 form-group padding-4">
                            <label class="label ">وصف الفرصة التطوعية  </label>
                            <input type="text" class="form-control" value=""
                                               name="wasf_forsa_tatw3" id="wasf_forsa_tatw3" data-validation="required">
                        </div>
    ...
    <div class="col-xs-12 no-padding">                    
                        ...
                        <!-- <div class="col-md-2 form-group padding-4">
                            ...
                            <input type="text" class="form-control" value="<?= $place ?>"
                                               data-validation="required" name="place">
                        </div> -->
				...
				<input type="text" class="form-control  "
					...
					<input type="hidden" name="place_id_fk" id="place_id_fk" value="
                        ...
                        <div class="form-group col-sm-12 col-xs-12">
                            <label class="label ">الأنشطة </label>
                        ...
                        <!-- <div class="col-xs-12  no-padding ">
                            ...
                            <table class="table table-bordered tb_table">
                                ...
                                <tbody>
                                <tr>
                                    <td><input type="date" class="form-control" value="<?= $volunteer_date ?>"
                                               name="volunteer_date" id="volunteer_date" data-validation="required">
                                    </td>
                                    <td><input type="time" class="form-control" data-validation="required"
                                               name="from_time" id="from_time"
                                               value="<?= $from_time ?>" onchange="count($('#volunteer_date').val())">
                                    </td>
                                    <td><input type="time" data-validation="required" name="to_time" id="to_time"
                                               class="form-control"
                                               value="<?= $to_time ?>" onchange="count($('#volunteer_date').val())">
                                    </td>
                                    <td><input type="text" class="form-control" value="<?= $num_hours ?>"
                                               name="num_hours" id="num_hours" readonly></td>
                                    <td><input type="text" class="form-control" value="<?= $place ?>"
                                               data-validation="required" name="place"></td>
                                    <td>
                                        <textarea data-validation="required" class="form-control" name="activities"
                                                  cols="30" rows="1"><?= $place ?></textarea></td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a onclick='swal({
                                        ...
                                        window.location="<?php echo base_url(); ?>human_resources/employee_forms/Volunteer_hours/delete_volunteer_hours/<?php echo $row->id . '/' . $link_delete; ?>";
                                        });'><i class="fa fa-trash"
...
<script>
    function get_responsible() {
       ...
       console.log(row_id);
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>human_resources/employee_forms/Volunteer_hours/load_responsible",
            data: {row_id: row_id},
            success: function (d) {
...
<script>
    function get_ms2ol_data() {
        ...
        $.ajax({
            url: "<?php echo base_url() ?>human_resources/employee_forms/Volunteer_hours/get_ms2ol_data",
            type: "Post",
            dataType: "html",
            data: {id: id},
