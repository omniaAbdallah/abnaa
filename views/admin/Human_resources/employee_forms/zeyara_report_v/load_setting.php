    ...
    foreach ($result as $row) {
        ...
        <tr>
            ...
            <td>
                ...
                </a> <a href="#" onclick="get_by_id(<?= $row->id ?>)">
...
<script>
    function delete_setting(id) {
        ...
        var edara_id_fk = $('#type_setting').data("edara_id_fk");
        var edara_n = $('#type_setting').data("edara_n");
        swal({
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo base_url()?>human_resources/employee_forms/zeyara_report/Zeyara_report/delete_setting',
                data: {id: id, type: type, type_name: type_name, edara_id_fk: edara_id_fk, edara_n: edara_n},
                dataType: 'html',
                cache: false,
...
<script>
    function get_by_id(row_id) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url()?>human_resources/employee_forms/zeyara_report/Zeyara_report/get_setting_by_id',
            data: {row_id: row_id},
            dataType: 'html',
            cache: false,
            success: function (html) {
