                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr class="open_green">
                                        <td><label class="radio-inline">
                                                <input type="radio" disabled name="inlineRadioOptions" <?php if($row->delay_num_days==0){echo 'checked';}?> id="inlineRadio<?php echo $row->id;?>" value="0"> لم يتأخر عن مباشرته للعمل .  </label>
                                        </td>
                                        <td><label class="radio-inline">
                                                <input type="radio" disabled name="inlineRadioOptions"<?php if($row->delay_num_days>0){echo 'checked';}?> id="inlineRadio2<?php echo $row->id;?>" value="1"> تأخر عن مباشرته  للعمل لمدة  </label>
                                        </td>
