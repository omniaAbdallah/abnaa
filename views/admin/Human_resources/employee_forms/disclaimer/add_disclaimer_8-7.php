            ...
            <div class="col-md-12 no-padding ">
                <div class="form-group col-md-4  col-sm-6 padding-4">
                    ...
                    <select name="emp_id" id="emp_id"
                            data-validation="required" onchange="get_emp_data($(this).val());"   class="form-control selectpicker" data-show-subtext="true" data-live-search="true"
                            aria-required="true">
                        ...
                        <td>
                            <?php if($key== 3){ ?>
                                <div class="check-style">
                                    <input  <?php if(isset($disclaimer[$key][0]->resignation) && $disclaimer[$key][0]->resignation ==1) { echo 'checked'; } ?> type="checkbox" name="resignation" class="form-check-input" value="1" id="1">
                                    <label  class="form-check-label" for="1">الاستقالة / طي القيد .</label>
                                </div>
                                <div class="check-style">
                                    <input <?php if(isset($disclaimer[$key][0]->employee_card) && $disclaimer[$key][0]->employee_card ==1) { echo 'checked'; } ?> type="checkbox" name="employee_card" class="form-check-input" value="1" id="2">
                                    <label class="form-check-label" for="2">استرداد بطاقة الموظف.</label>
                                </div>
                                <div class="check-style">
                                    <input <?php if(isset($disclaimer[$key][0]->medical_card) && $disclaimer[$key][0]->medical_card ==1) { echo 'checked'; } ?> type="checkbox" name="medical_card" class="form-check-input" value="1" id="3">
                                    <label class="form-check-label" for="3">استرداد بطاقة التأمين الطبي.</label>
                                </div>
                                <div class="check-style">
                                    <input <?php if(isset($disclaimer[$key][0]->social_insurance) && $disclaimer[$key][0]->social_insurance ==1) { echo 'checked'; } ?>  type="checkbox" name="social_insurance" class="form-check-input" value="1" id="4">
                                    <label class="form-check-label" for="4">إيقاف التأمينات الاجتماعية .</label>
                                </div>
                            <?php }?>
               ...
               <?php } ?>
                ...
                <div class="col-md-12 text-center">
                    <button type="submit" id="register" name="add" value="save_main_data"
                            class="btn btn-success btn-labeled"><span class="btn-label"><i class="fa fa-floppy-o"></i></span> حفظ
                    </button>
                    </div>
