               ...
               <div >
                            <div class="panel-body">
                                    ...
                                    if(isset($mainDepartment) && !empty($mainDepartment) && $mainDepartment!=null){
                                        echo form_open_multipart('human_resources/egraat_settings/Mosayar_month/UpdateMainDepartmentSitting/'.$mainDepartment['id']);
                                    }
                                    else{
                                        echo form_open_multipart('human_resources/egraat_settings/Mosayar_month/AddMainDepartmentSitting');
                                    }
                                    ?>
...
<option <?=$selected?> value="<?=$key?>"><?=$key?></option>
        ...
        <select id="month" name="month" data-validation="required"
                class="form-control " onchange="Checkcode();"
               >
               <option  value="">اختر</option>
            <?php
        ...
        function(){
        window.location="<?php echo base_url().'human_resources/egraat_settings/Mosayar_month/UpdateMainDepartmentSitting/'.$value->id.""  ?>";
        });'>
    <i class="fa fa-pencil"> </i></a>
        ...
        setTimeout(function(){window.location="<?=base_url()."human_resources/egraat_settings/Mosayar_month/DeleteMainDepartmenSitting/".$value->id?>";}, 500);
        });'>
...
<script>
    function Checkcode() {
      ...
      if(year !='')
      {
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>human_resources/egraat_settings/Mosayar_month/Checkcode',
