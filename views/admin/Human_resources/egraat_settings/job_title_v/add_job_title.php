<div class="col-sm-12 no-padding " >
    <div  class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
         <div class="panel-heading">
            <h3 class="panel-title"> إضافة المسميات الوظيفيه  </h3>
         </div> 
...
<i class="fa fa-trash"> </i>حذف</a>
                    ...
                    <form action="<?php echo base_url() . 'human_resources/egraat_settings/Jobtitle/update/' . $item->id; ?>"
...
<select name="qsm" id="qsm" data-validation="required"  class="form-control">
                <option value="">إختر</option>
                <?php
...
<div class="col-xs-12 no-padding">
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
            <div class="panel-heading">
                <h3 class="panel-title"> المسميات الوظيفيه  </h3>
            </div>
        <div class="panel-body">
...
?></td> 
                ...
                foreach ($sub_department as $key) {
                  ...
                  <ul class="dropdown-menu">
                  <li><a  href="<?php echo base_url();?>/human_resources/egraat_settings/Jobtitle/add_edara_qsm/<?php echo $row->id;?>"><i class="fa fa-archive" aria-hidden="true"></i>     ربط المسمي الوظيفي الاداره والقسم</a></li>
                    <li><a  href="<?php echo base_url();?>/human_resources/egraat_settings/Jobtitle/add_picture/<?php echo $row->id;?>"><i class="fa fa-commenting-o" aria-hidden="true"></i>   إضافة مهام وظيفية</a></li>
                    <li><a onclick="get_details(<?= $row->id ?>)"
 aria-hidden="true"
data-toggle="modal"
data-target="#myModal_det"><i class="fa fa-search" aria-hidden="true"></i>التفاصيل</a></li>
<li>
...
function(){
window.location="<?= base_url() . 'human_resources/egraat_settings/Jobtitle/update/' .$row->id  ?>";
});'>
<i class="fa fa-pencil"> </i>تعديل</a>
</li>
<li>
...
function(){
swal("تم الحذف!", "", "success");
setTimeout(function(){window.location="<?= base_url() . 'human_resources/egraat_settings/Jobtitle/delete/' . $row->id ?>";}, 500);
});'>
<i class="fa fa-trash"> </i>حذف</a>
</li>
                  </ul>
