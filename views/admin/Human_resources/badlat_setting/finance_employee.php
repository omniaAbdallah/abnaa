...
if($personal_data[0]->markz_id != null  ){
                    ...
                    <div class="panel-body">
                        <div class="col-sm-12 col-md-12 col-xs-12 no-padding">
                            <div class="form-group col-md-2 col-sm-4 padding-4">
                                <input type="hidden" name="emp_code" id="emp_code11" 
                                       value="<?= $employee['emp_code'] ?>">
                                <input type="hidden" name="emp_id" id="emp_code11" 
                                       value="<?= $employee['id'] ?>">
                                <input type="hidden" name="markz_name" id="markz_name" 
                                       value="<?= $employee['markz_name']  ?>">
                                <input type="hidden" name="markz_id" id="markz_id" 
                                       value="<?= $employee['markz_id']  ?>">
                                       <input type="hidden" name="having_all_value" 
                                       value="<?php if (isset($allData->get_having_value) && !empty($allData->get_having_value)) {
                                           echo $allData->get_having_value;
                                       } else {
                                           echo 0;
                                       } ?> " id="all_value1">
									   <input type="hidden"  name="having_tamin_value" 
                                       value="<?php if (isset($allData->tamin_value) && !empty($allData->tamin_value)) {
                                           echo $allData->tamin_value;
                                       } else {
                                           echo 0;
                                       } ?>" id="checked_value1">
									   <input type="hidden"   name="discut_all_value"
                                ...
                                <div id="result">
                                    <select class="form-control "name="badl_discount_id_fk" id="badl_discount_id_fk" onchange="get_rkm_hesab(1,this.value);$('#dalel_name1').val($('option:selected',this).data('hesab_name'));$('#dalel_code1').val($('option:selected',this).data('rkm_hesab'))" data-validation="required">
            ...
            <div class="tab-pane fade " id="estkta3">
                ...
                <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
                    ...
                    <div class="panel-body">
                        <div class="col-sm-12 col-md-12 col-xs-12 no-padding">
                            <div class="form-group col-md-2 col-sm-4 padding-4">
                                <input type="hidden" name="emp_code" id="emp_code21" 
                                       value="<?= $employee['emp_code'] ?>">
                                <input type="hidden" name="emp_id" id="emp_code21" 
                                       value="<?= $employee['id'] ?>">
                                       <input type="hidden" name="markz_name" id="markz_name" 
                                     value="<?= $employee['markz_name']  ?>">
                                 <input type="hidden" name="markz_id" id="markz_id" 
    ...
    if(isset($records_disc)&&!empty($records_disc)){
      foreach ($records_disc as $row){
        ...
        <?php } } ?>
                            ...
                            <div class="col-xs-12 text-center" style="margin-bottom: 10px;">
                                <button type="button" onclick="save_estktat3(<?= $employee['id'] ?>)" id=""
                                        name="add" class="btn btn-success btn-labeled"
                ...
                <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
                    ...
                    <div class="panel-body">
                        <div class="col-sm-12 col-md-12 col-xs-12 no-padding">
                            ...
                            <input type="text" class="form-control" name="emp_bank_name" value="<?= $employee['employee'] ?>" />
                            </div>
 ...
 قم بإضافة مركز التكلفة الخاص بالموظف لكي تتمكن من إستكمال البيانات المالية 
</div> 
