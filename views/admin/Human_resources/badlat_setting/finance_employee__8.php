    ...
    <div class="panel-body">
        <div class="col-sm-12 col-md-12 col-xs-12 no-padding">
            ...
            <div class="col-md-4 col-sm-4 col-xs-6">
                ...
                <input id="markez_name" name="markz_name" data-validation="required" aria-required="true"
                       readonly="readonly"
                       style="float: right;width: 80%;cursor: pointer;"
                       class="form-control"
                       value="<?= $employee['markz_name'] ?>"
                       onclick="load_mrakz()"
                       data-toggle="modal" style="cursor: pointer"
                       data-target="#myModal_markz_taklfaa"
                >
                <button type="button" onclick="load_mrakz()"
                        data-toggle="modal" style="cursor: pointer"
                        data-target="#myModal_markz_taklfaa"
                        class="btn btn-success btn-next"><i class="fa fa-plus"></i></button>
                <input type="hidden" value="<?= $employee['markz_id'] ?>" id="markz" name="markz">
            </div>
            <div class="col-md-3 col-sm-3 col-xs-6" style="    margin-top: 26px;">
                <div id="div_add_hesab" style="display: block;">
                    <button type="button" onclick="add_hesab(<?= $this->uri->segment(4) ?>)"
        ...
        <div class="tab-content">
            <div class="tab-pane fade in active" id="est7kak">
                ...
                <?php
                echo form_open_multipart('human_resources/Human_resources/financeEmployee/' . $this->uri->segment(4), array('class' => 'esthkak', 'id' => 'esthkak'));
                echo '<input type="hidden"  name="add"  id="add" value="add">';
                ?>
                <!-- yara20-7-2020 -->
                <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
                    <div class="panel-heading">
                        <h3 class="panel-title">بيانات الاستحقاقات</h3>
                    </div>
                    <div class="panel-body">
                        <div class="col-sm-12 col-md-12 col-xs-12 no-padding">
                            <div class="form-group col-md-2 col-sm-4 padding-4">
                                <input type="hidden" name="emp_code" id="emp_code11" class="form-control half"
                                       data-validation="required"
                                       value="<?= $employee['emp_code'] ?>">
                                <input type="hidden" name="emp_id" id="emp_code11" class="form-control half"
                                       data-validation="required"
                                       value="<?= $this->uri->segment(4) ?>">
                                <input type="hidden" name="markz_name" id="markz_name" class="form-control half"
                                     
                                       value="<?= $employee['markz_name']  ?>">
                                <input type="hidden" name="markz_id" id="markz_id" class="form-control half"
                                      
                                       value="<?= $employee['markz_id']  ?>">

                                       <input type="hidden" name="having_all_value" class="form-control"
									   ...
									   <input type="hidden"  name="having_tamin_value" class="form-control"
									   ...
									   <input type="hidden"  class="form-control" name="discut_all_value"
                                       value="<?php if (isset($allData->get_discut_value) && !empty($allData->get_discut_value)) {
                                           echo $allData->get_discut_value;
                                       } else {
                                           echo 0;
                                       } ?> " id="all_value2">
                                <label class="label">إسم البند</label>
                                <div id="result">
                                    <select class="form-control " class="form-control" name="badl_discount_id_fk" id="badl_discount_id_fk" onchange="get_rkm_hesab(1,this.value);$('#dalel_name1').val($('option:selected',this).data('hesab_name'));$('#dalel_code1').val($('option:selected',this).data('rkm_hesab'))" data-validation="required">
                                       

                                    <option value="0">اختر</option>
    <?php
    if(isset($records_have)&&!empty($records_have)){
      foreach ($records_have as $row){
        ?>
        ...
        <?php } } ?>
                            ...
                            <div class="form-group col-md-2 col-sm-4 padding-4">
                                ...
                                <!-- Nagwa 20-6 -->
                                <select name="method_to_count" id="pay_paid11" class="form-control"
                                        data-validation="required">
                            ...
                            <div class="form-group col-md-2 col-sm-4 padding-4">
                                ...
                                <input type="text" onkeyup="put_value(11);" id="value11" data-validation="required"
                                       value="" class="form-control valu1" name="value">
                            </div>
                            <div class="form-group col-md-2 col-sm-4 padding-4">
                                <label class="label">محدد المده</label>
                                <select class="form-control" onchange="get_peroid(1,1);" id="peroid11" value=""
                                        class="form-control" name="specific_period" data-validation="required">
                                    <option value="">اختر</option>
                                    <?php
                            ...
                            <div class="form-group col-md-2 col-sm-4 padding-4">
                                ...
                                <input type="date" disabled="disabled" id="date_from11" value="" class="form-control"
                                       name="date_from">
                            </div>
                            <div class="form-group col-md-2 col-sm-4 padding-4">
                                <label class="label">الي تاريخ</label>
                                <input type="date" disabled="disabled" id="date_to11" value="" class="form-control"
                                       name="date_to">
                            </div>
                            <div class="form-group col-md-2 col-sm-4 padding-4">
                                <label class="label">يخضع للتأمينات</label>
                                <div class="skin-square">
                                    <div class="i-check">
                                        <input type="checkbox" money="0" class="check_value1" class="form-control"
                                               onchange="get_checked_value(1);" id="check11" value="1"
                                               name="insurance_affect">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-md-4 col-sm-4 padding-4">
                                <label class="label" style="">الدليل</label>
                                <input name="dalel_code" id="dalel_code1" class="form-control half"
                                       data-validation="required"
                                       value="" readonly>
                                <input name="dalel_name" id="dalel_name1" class="form-control half"
                                       data-validation="required"
                                       value="" readonly>
                            </div>
                            <div class="col-xs-12 text-center" style="margin-bottom: 10px;">
                                <button type="button" onclick="save_esthkak(<?= $this->uri->segment(4) ?>)" id=""
                                        name="add" class="btn btn-success btn-labeled"
            ...
            <div class="tab-pane fade " id="estkta3">
                <?php
                echo form_open_multipart('human_resources/Human_resources/financeEmployee/' . $this->uri->segment(4), array('class' => 'estktat3', 'id' => 'estktat3'));
                echo '<input type="hidden"  name="add"  id="add" value="add">';
                ...
                <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable">
                    <div class="panel-heading">
                        <h3 class="panel-title">بيانات الاستقطاعات</h3>
                    </div>
                    <div class="panel-body">
                        <div class="col-sm-12 col-md-12 col-xs-12 no-padding">
                            <div class="form-group col-md-2 col-sm-4 padding-4">
                                <input type="hidden" name="emp_code" id="emp_code21" class="form-control half"
                                       data-validation="required"
                                       value="<?= $employee['emp_code'] ?>">
                                <input type="hidden" name="emp_id" id="emp_code21" class="form-control half"
                                       data-validation="required"
                                       value="<?= $this->uri->segment(4) ?>">
                                       <input type="hidden" name="markz_name" id="markz_name" class="form-control half"
                                ...
                                <label class="label">إسم البند</label>
                                <div id="result2">
                                    <select class="form-control " data-validation="required" name="badl_discount_id_fk" id="badl_discount_id_fk" onchange="get_rkm_hesab(2,this.value);">
                                    
                                   
                                    <option value="0">اختر</option>
    <?php
    if(isset($records_disc)&&!empty($records_disc)){
      foreach ($records_disc as $row){
        ?>
        <option value="<?php echo $row->id;?>"><?php echo $row->title;?></option>
        <?php } } ?>
      </select>
                            ...
                            <div class="form-group col-md-2 col-sm-4 padding-4">
                                <label class="label"> طريقه الحساب</label>
                                <select name="method_to_count" id="pay_paid21" class="form-control"
                                        onchange="get_tamin_value($(this).val(),1);"
                                        data-validation="required">
                                    <option value="">اختر</option>
                                    <option value="1">قيمه</option>
                                    <option value="2">نسبه</option>
                            ...
                            <div class="form-group col-md-2 col-sm-4 padding-4">
                                <label class="label">القيمه</label>
                                <input type="text" onkeyup="put_value(1,2);" id="value21" data-validation="required"
                                       value="" class="form-control valu2" name="value">
                            </div>
                            <div class="form-group col-md-2 col-sm-4 padding-4">
                                <label class="label">محدد المده</label>
                                <select class="form-control" onchange="get_peroid(2,1);" id="peroid21" value=""
                                        class="form-control" name="specific_period" data-validation="required">
                                    <option value="">اختر</option>
                                    <?php
                                    foreach ($yes_no as $key => $value) {
                            ...
                            <div class="form-group col-md-2 col-sm-4 padding-4">
                                <label class="label">من تاريخ</label>
                                <input type="date" disabled="disabled" id="date_from21" value="" class="form-control"
                                       name="date_from">
                            </div>
                            <div class="form-group col-md-2 col-sm-4 padding-4">
                                <label class="label">الي تاريخ</label>
                                <input type="date" disabled="disabled" id="date_to21" value="" class="form-control"
                                       name="date_to">
                            </div>
                            <div class="form-group col-md-4 col-sm-4 padding-4">
                                <label class="label" style="">الدليل</label>
                                <input name="dalel_code" id="dalel_code2" class="form-control half"
                                       data-validation="required"
                                       value="" readonly>
                                <input name="dalel_name" id="dalel_name2" class="form-control half"
                                       data-validation="required"
                                       value="" readonly>
                            </div>
                            <div class="col-xs-12 text-center" style="margin-bottom: 10px;">
                                <button type="button" onclick="save_estktat3(<?= $this->uri->segment(4) ?>)" id=""
                                        name="add" class="btn btn-success btn-labeled"
            ...
            <div class="tab-pane fade " id="banks">
                <?php
                echo form_open_multipart('human_resources/Human_resources/financeEmployee/' . $this->uri->segment(4), array('class' => 'banks', 'id' => 'banks'));
                    ...
                    <div class="panel-body">
                        <div class="col-sm-12 col-md-12 col-xs-12 no-padding">
                            <div class="form-group col-md-4 col-sm-4 padding-4">
                                ...
                                <select name="bank_id_fk" class="form-control " data-validation="required"
                            ...
                            <div class="form-group col-md-2 col-sm-4 padding-4">
                                ...
                                <input type="text" class="form-control " name="bank_code" data-validation="required"
                            ...
                            <div class="form-group col-md-4 col-sm-4 padding-4">
                                ...
                                <input type="text" maxlength="24" minlength="24" class="form-control "
                                       name="bank_account_num" id="bank_account_num1" data-validation="required"
                            ...
                            <div class="col-xs-12 text-center">
                                <button type="button" onclick="add_banks(<?= $this->uri->segment(4) ?>)" id="buttons"
