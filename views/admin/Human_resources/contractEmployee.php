        ...
        <div class="panel-body">
            ...
            <div class="col-sm-12 col-xs-12 no-padding">
                ...
                <!--<div class="form-group col-sm-2 col-xs-12 padding-4">
                    ...
                    <input type="number" name="casual_vacation_num" id="casual_vacation_num"
                      onchange="if (this.value > parseInt($('#casual_vacation_max').val())){ this.value=$('#casual_vacation_max').val();}
...
// To calculate the no. of days between two dates
        ...
        var month_diff=parseInt(diff_days/30);
        console.log(month_diff + "  **  month_diff");

        /* var current_vacation = Math.round((parseFloat(month_vacation) * parseInt(diff)) + parseInt(vacation_previous_balance));*/
        var current_vacation = Math.round((parseFloat(month_vacation) * parseInt(month_diff)) + parseInt(vacation_previous_balance));
        console.log(current_vacation + "  **  current_vacation");
        $('#current_vacation').val(parseFloat(current_vacation));
    }
