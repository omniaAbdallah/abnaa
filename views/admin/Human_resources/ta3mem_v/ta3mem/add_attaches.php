    ...
    <script>
        function upload_img(row) {
            ...
            if (files.length == 0) {
                ...
                if (error == '') {
                    $.ajax({
                        url: "<?php echo base_url(); ?>human_resources/ta3mem/Ta3mem_c_request/add_morfaq", //base_url() return http://localhost/tutorial/codeigniter/
                        method: "POST",
                        data: form_data,
                        contentType: false,
                        cache: false,
    ...
    <script>
        function put_value(rkm) {
            ...
            $.ajax({
                type: 'post',
                data: {rkm: rkm},
                url: "<?php echo base_url();?>human_resources/ta3mem/Ta3mem_c_request/get_attaches",
                beforeSend: function () {
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        $.ajax({
                            type: 'post',
                            url: '<?php echo base_url() ?>human_resources/ta3mem/Ta3mem_c_request/Delete_attach',
                            data: {id: id},
                            dataType: 'html',
                            cache: false,
                            beforeSend: function () {
