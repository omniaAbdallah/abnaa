...
تعميم داخلي</h6>
    ...
    <div class="col-xs-12">
          ...
          <?php if(isset($da3wat->subject)&&!empty($da3wat->subject))
          {
            echo $da3wat->subject;
          }
          ?>
...
<a onclick="confirm(<?=$da3wat->id?>,'wait')" class="btn btn-warning btn-block"><b> النظر  لاحقا</b></a>
 ...
 <br /> <br />
       ...
       <div class=" col-xs-12 ">
			<iframe src="<?=base_url()?>human_resources/ta3mem/Ta3mem_c/read_file/<?php if(isset($da3wat->file)&&!empty($da3wat->file))
          {echo $da3wat->file;}?>" style="width: 100%; height:  400px;" frameborder="0">
			</iframe>
            </div>
                    </div>
            </div>
