...
">
 ...
 رسالة جديدة</h6>
    ...
    <div class="col-xs-12">
      ...
      <div class="col-xs-8">
                    <h6 class="" style="font-weight: bold !important;font-size: 20px; !important; color: #a70000;">
                      ...
                      <h6 style="font-weight: bold !important;font-size: 20px; color: #09704e;text-align: center;">السلام عليكم ورحمة الله وبركاتة ، وبعد :</h6>
                    <div class="form-group col-sm-12 col-xs-12">
                        <h6 style="line-height: 25px; color: black; font-weight: bold; font-size: 20px; ">
                        <i style="color: red;" class="fa fa-quote-right" aria-hidden="true"></i>
          <?php if(isset($da3wat_msg[0]->msg_data)&&!empty($da3wat_msg[0]->msg_data))
          {
            echo $da3wat_msg[0]->msg_data;
          }
          ?> 
                        </h6>
   ...
   <div class="col-xs-4">
    ...
    <?php if(isset($da3wat_msg[0]->msg_img)&&!empty($da3wat_msg[0]->msg_img))
          { ?>
            
              <img src="<?=base_url()?>uploads/human_resources/ta3mem/<?=$da3wat_msg[0]->msg_img?>" style="width: 100%; height:  100%;">
        <?php   }
          ?> 
...
<div class="col-md-2">
<a  onclick="confirm(<?=$da3wat_msg[0]->id?>,'accept')" class="btn btn-success btn-block"><b>تحديد كمقروء</b></a>
</div>
 <div class="col-md-2">
...
<a onclick="confirm(<?=$da3wat_msg[0]->id?>,'wait')" class="btn btn-warning btn-block"><b> النظر  لاحقا</b></a>
 ...
 <br /> <br />
    ...
    <div class=" col-xs-12 ">
                    ...
                    <?php
                    if (isset($da3wat_msg->attaches) && !empty($da3wat_msg->attaches)) {
                    $z = 1;
                    foreach ($da3wat_msg->attaches as $row) { ?>
                        <li id="row_<?= $z ?>" >
                            <?php
...
$.ajax({
      type: 'post',
      url: '<?php echo base_url() ?>human_resources/ta3mem/Ta3mem_msg_c/reply_dawa',
