...
<div class="modal modal-startup fade" id="dawa" tabindex="-1" data-backdrop="static" data-keyboard="false" role="dialog"
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                                            ...
                                            <div class="form-group col-sm-12 col-xs-12">
                                                <h6 style="line-height: 25px; color: black; font-weight: bold; ">
                                                    <i style="color: red;" class="fa fa-quote-right"
                                                       aria-hidden="true"></i>
                                                    <?php if (isset($data->basic_data->subject) && !empty($data->basic_data->subject)) {
                                                        echo $data->basic_data->subject;
                                                    }
                                                    ?>
                                                </h6>
                                            ...
                                            <div>
                                                <div class="col-xs-12">
                                                    <div class="col-md-12" id="actionn">
                                                        <div class="col-md-4">
                                                            <a onclick="confirm_t3mem(<?= $data->id ?>,'accept')"
                                                               class="btn btn-success btn-block"><b> موافقة</b></a>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <a onclick="confirm_t3mem(<?= $data->id ?>,'refuse')"
                                                               class="btn btn-danger btn-block"><b> رفض</b></a>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <a onclick="confirm_t3mem(<?= $data->id ?>,'wait')"
                                                ...
                                                <div class=" col-xs-12 ">
                                                    <ul class="mailbox-attachments clearfix">
                                                        <?php
                                                        if (isset($data->attach_data) && !empty($data->attach_data)) {
                                                            $z = 1;
                                                            foreach ($data->attach_data as $row) { ?>
                                                                <li id="row_<?= $z ?>">
                                                                    <?php
                                           ...
                                           class="btn btn-default btn-xs pull-right" download>
                                            <i class=" fa fa-download"></i></a>
                                                                    ...
                                                                    <?php } elseif (in_array($ext, $file_exe)) {
                                                                        ...
                                                                        <span class="mailbox-attachment-icon icone-cus">
                        ...
                        if (isset($da3wat_adv) && !empty($da3wat_adv)) {
                            foreach ($da3wat_adv as $data) {
                                ?>

                                <div class="col-xs-6">
                                    <div class="panel panel-default" style="border: solid 1px #f0f0f0">
                                        <div class="panel-heading"> الاعلانات</div>
                                        <div class="panel-body">
                                            <h6 class=""
                                                style="font-weight: bold !important;font-size: 15px !important; color: #a70000;">
                                            ...
                                            <div>
                                                <div class="col-xs-12">
                                                    <div class="col-md-12" id="actionn">
                                                        <div class="col-md-4">
                                                            <a onclick="confirm_adv(<?= $data->id ?>,'accept')"
                                                               class="btn btn-success btn-block"><b> موافقة</b></a>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <a onclick="confirm_adv(<?= $data->id ?>,'refuse')"
                                                               class="btn btn-danger btn-block"><b> رفض</b></a>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <a onclick="confirm_adv(<?= $data->id ?>,'wait')"
                                                               class="btn btn-warning btn-block"><b> النظر لاحقا</b></a>
                                                        </div>
                                                    </div>
                                                    <br/> <br/>
                        ...
                        if (isset($da3wat_msg) && !empty($da3wat_msg)) {
                            foreach ($da3wat_msg as $data) {
                                ?>

                                <div class="col-xs-6">
                                    <div class="panel panel-default" style="border: solid 1px #f0f0f0">
                                        <div class="panel-heading"> الرسائل</div>
                                        <div class="panel-body">
                                            <h6 class=""
                                                style="font-weight: bold !important;font-size: 15px !important; color: #a70000;">
                                                الاستاذ/<?= $data->emp_name; ?>
                                            ...
                                            <div class="">
                                                <div class="col-xs-12">
                                                    <div class="col-md-12" id="actionn">
                                                        <div class="col-md-4">
                                                            <a onclick="confirm_msg(<?= $data->id ?>,'accept')"
                                                               class="btn btn-success btn-block"><b> موافقة</b></a>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <a onclick="confirm_msg(<?= $data->id ?>,'refuse')"
                                                               class="btn btn-danger btn-block"><b> رفض</b></a>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <a onclick="confirm_msg(<?= $data->id ?>,'wait')"
                                                               class="btn btn-warning btn-block"><b> النظر لاحقا</b></a>
                                                        </div>
                                                    </div>
                                                    <br/> <br/>
...
<script>
    function confirm_adv(id, action) {
        if (action == 'refuse') {
            //  $('#refuse_d3wa').show();
            swal({
                    title: "هل انت متاكد من العملية?",
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        $.ajax({
                            type: 'post',
                            url: '<?php echo base_url() ?>human_resources/ta3mem/Ta3mem_adv_c_request/reply_dawa',
                            data: {id: id, action: action},
                            dataType: 'html',
                            cache: false,
                            beforeSend: function () {
...
<script>
    function confirm_t3mem(id, action) {
        if (action == 'refuse') {
            //  $('#refuse_d3wa').show();
            swal({
                    title: "هل انت متاكد من العملية?",
