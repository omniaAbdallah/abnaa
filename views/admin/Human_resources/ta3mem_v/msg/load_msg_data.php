...
<?php
if (isset($msg_data) && !empty($msg_data)) {
    ?>
    <div class="panel panel-default" style="border: solid 1px #f0f0f0">
        ...
        <div class="panel-body">
            ...
            <div class="form-group col-sm-12 col-xs-12">
                <h6 style="line-height: 25px; color: black; font-weight: bold; ">
                    <i style="color: red;" class="fa fa-quote-right"
                       aria-hidden="true"></i>
                    <?php if (isset($msg_data->basic_data->subject) && !empty($msg_data->basic_data->subject)) {
                        echo $msg_data->basic_data->subject;
                    }
                    ?>
                </h6>
            ...
            <div class="">
                <?php if ($msg_data->seen == 0){  ?>
                <div class="col-xs-12">
                    <div class="col-md-12" id="actionn">
                        <div class="col-md-4">
                            <a onclick="confirm_msg(<?= $msg_data->id ?>,'accept')"
                               class="btn btn-success btn-block"><b> موافقة</b></a>
                        </div>
                        <div class="col-md-4">
                            <a onclick="confirm_msg(<?= $msg_data->id ?>,'refuse')"
                               class="btn btn-danger btn-block"><b> رفض</b></a>
                        </div>
                        <div class="col-md-4">
                            <a onclick="confirm_msg(<?= $msg_data->id ?>,'wait')"
                ...
                <div class=" col-xs-12 ">
                    <ul class="mailbox-attachments clearfix">
                        <?php
                        if (isset($msg_data->attach_data) && !empty($msg_data->attach_data)) {
                            $z = 1;
                            foreach ($msg_data->attach_data as $row) { ?>
                                <li id="row_<?= $z ?>">
                                    <?php
