                           ...
                           foreach ($one_data as $morfaq){
                              ...
                              //  $Destination = 'uploads/archive/deals/1bec9894697603bd9a45630d73230be5.jpg';
                               ...
                               <tr>
                                   ...
                                   <!-- <a href="<?php echo base_url() . 'human_resources/ta3mem/Ta3mem_adv_c/read_file/' . $mehwar_morfaq ?>"
                                      ...
                                      $url = base_url() .'human_resources/ta3mem/Ta3mem_adv_c/read_file/'. $morfaq->file;
                           ...
                           ?>
                                   ...
                                   <!-- <a href="<?= base_url().$folder.'/'.$morfaq->file?>" download>  <i class="fa fa-download fa-2x" aria-hidden="true" ></i> </a> -->
                                       ...
                                       <i class="fa fa-trash" style="cursor: pointer"
                                          ...
                                          onclick="delete_morfq(<?= $morfaq->id ?>,<?= $morfaq->ta3mem_id_fk ?>)"></i>
