            ...
            if (files.length == 0) {
                ...
                if (error == '') {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo base_url(); ?>human_resources/ta3mem/Ta3mem_adv_c_request/add_morfaq", //base_url() return http://localhost/tutorial/codeigniter/
    ...
    <script>
        ...
        function put_value(rkm) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url();?>human_resources/ta3mem/Ta3mem_adv_c_request/get_attaches",
                ...
                function (isConfirm) {
                    ...
                    if (isConfirm) {
                        ...
                        $.ajax({
                            ...
                            url: '<?php echo base_url() ?>human_resources/ta3mem/Ta3mem_adv_c_request/Delete_attach',
