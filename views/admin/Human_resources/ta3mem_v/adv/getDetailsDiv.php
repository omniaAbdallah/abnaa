...
<table class="table  " style="table-layout: fixed">
    ...
    <tr>
        ...
        <td> <?php
        if (!empty($get_all->ta3mem_title)):
            echo   $get_all->ta3mem_title;
        endif;
        ?></td>
        <td style="width: 135px;"><strong> تاريخ الاعلان</strong></td>
        <td style="width: 10px;"><strong>:</strong></td>
        <td><?php if (!empty($get_all->ta3mem_date)) {
                echo  $get_all->ta3mem_date;
            } else{
                echo 'غير محدد' ;
            }
            ?>
...
<td style="width: 105px;">
        ...
        <td style="width: 10px;"><strong>:</strong></td>
        <td> <?php
        if (!empty($get_all->adv_time)):
            echo   $get_all->adv_time;
        endif;
        ?>
        </td>
    </tr>
    ...
    <tr>
        <td style="width: 105px;">
            <strong>بدايه عرض الاعلان</strong>
        </td>
        <td style="width: 10px;"><strong>:</strong></td>
        <td> <?php
        if (!empty($get_all->adv_from_date)):
            echo   $get_all->adv_from_date;
        endif;
        ?></td>
        <td style="width: 135px;"><strong> نهاية عرض الاعلان</strong></td>
        <td style="width: 10px;"><strong>:</strong></td>
        <td><?php if (!empty($get_all->adv_to_date)) {
                echo  $get_all->adv_to_date;
            } else{
                echo 'غير محدد' ;
            }
            ?>
        <td style="width: 105px;">
            <strong>   مكان التنفيذ</strong>
        </td>
        <td style="width: 10px;"><strong>:</strong></td>
        <td><?php if (!empty($get_all->adv_place)) {
                echo  $get_all->adv_place;
            } else{
                echo 'غير محدد' ;
            }
            ?></td>
