                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            ...
                            <div class=" col-xs-12 ">
                                <?php
                                $ext = pathinfo($da3wat->basic_data->file, PATHINFO_EXTENSION);
                                $image = array('gif', 'Gif', 'ico', 'ICO', 'jpg', 'JPG', 'jpeg', 'JPEG', 'BNG', 'png', 'PNG', 'bmp', 'BMP');
                                $file = array('pdf', 'PDF', 'xls', 'xlsx', ',doc', 'docx', 'txt');
                                if (in_array($ext, $image)) {
                                    ?>
                                    <img src="<?= base_url() ?>uploads/human_resources/ta3mem/<?php if (isset($da3wat->basic_data->file) && !empty($da3wat->basic_data->file)) {
                                        echo $da3wat->basic_data->file;
                                    } ?>" style="width: 100%; height:  400px;"/>
                                <?php } else if (in_array($ext, $file)) { ?>
                                    <iframe src="<?= base_url() ?>human_resources/ta3mem/Ta3mem_adv_c/read_file/<?php if (isset($da3wat->basic_data->file) && !empty($da3wat->basic_data->file)) {
                                        echo $da3wat->basic_data->file;
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        $.ajax({
                            type: 'post',
                            url: '<?php echo base_url() ?>human_resources/ta3mem/Ta3mem_adv_c/reply_dawa',
