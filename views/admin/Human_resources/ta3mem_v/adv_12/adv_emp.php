        ...
        <div class="panel-body">
            ...
            <div class="col-sm-12 form-group">
                <div class="col-sm-2  col-md-2 padding-4 ">
                    ...
                    <input type="date" value="<?php echo date('Y-m-d'); ?>" name="adv_from_date" id="adv_from_date"
                           data-validation="required"
                           class="form-control ">
                </div>
                <div class="col-sm-2  col-md-2 padding-4 ">
                    <label class="label  "> نهاية عرض الاعلان </label>
                    <input type="date" value="<?php echo date('Y-m-d'); ?>" name="adv_to_date" id="adv_to_date"
                           data-validation="required"
                           class="form-control ">
                </div>
                <div class="col-sm-2  col-md-4 padding-4 ">
                    <label class="label  "> مكان التنفيذ </label>
                    <input type="text" value="" name="adv_place" id="adv_place"
                           data-validation="required"
                           class="form-control ">
                </div>
                <div class="col-sm-2  col-md-2 padding-4 ">
                    <label class="label  "> وقت التنفيذ </label>
                    <input type="time" value="<?php echo date('H:i:s'); ?>" name="adv_time" id="adv_time"
                           data-validation="required"
                           class="form-control ">
                </div>
...
<script>
    function load_tahwel(type) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url()?>human_resources/ta3mem/Ta3mem_adv_c/load_tahwel',
            data: {type: type},
            dataType: 'html',
            cache: false,
            beforeSend: function () {
...
<script>
    function GetDiv_emps(div) {
        ...
        var oTable_usergroup = $('#tahwel').DataTable({
            dom: 'Bfrtip',
            "ajax": '<?php echo base_url(); ?>human_resources/ta3mem/Ta3mem_adv_c/getConnection_emp/',
            aoColumns: [
                {"bSortable": false},
                {"bSortable": true},
            ],
...
<script>
    function change_status(valu, id) {
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>human_resources/ta3mem/Ta3mem_adv_c/change_status",
...
<script>
    function get_all_data(id) {
        $.ajax({
            type: 'post',
            url: "<?php echo base_url();?>human_resources/ta3mem/Ta3mem_adv_c/get_all_data",
            data: {id: id},
            beforeSend: function () {
