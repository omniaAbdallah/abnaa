    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body" style="min-height: 300px;">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <!--<li role="presentation" class="<?php if (isset($get_cost) && !empty($get_cost)) {
                    echo "active";
                } elseif (isset($active) && !empty($active)) {
                    echo "active";
                } ?>"><a href="#add_cost" aria-controls="reservation_orders" role="tab" data-toggle="tab">اضافة مراكز
                        التكلفة</a></li>
                <li role="presentation" class="<?php if (isset($get_markz) && !empty($get_markz)) {
                    echo "active";
                } // elseif (isset($active) && !empty($active)){ echo "active";}?>"><a href="#tab_mrakz"
                                                                                       aria-controls="tab_mrakz"
                                                                                       role="tab" data-toggle="tab">
                        مراكز التكلفة </a></li>-->
                        
                <li role="presentation" class="active"><a href="#tab_mrakz"
                                                                                       aria-controls="tab_mrakz"
                                                                                       role="tab" data-toggle="tab">
                     ربط بنود الإستحقاقات والإستقطاعات بمراكز التكلفة </a></li>        
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade  <?php if (isset($get_cost) && !empty($get_cost)) {
                    echo "in active";
                } elseif (isset($active) && !empty($active)) {
                    echo "in active";
                } ?>" id="add_cost">
                        ...
                        <table class="table example table-bordered table-striped table-hover">
                            ...
                            foreach ($mralkz_tklfa as $record) {
                                ...
                                <tr>
                                    ...
                                    <td><i class="fa fa-square " aria-hidden="true"
                                           style="color: <?= $record->color ?>"></i></td>
                                    <td>
                                        <a href="#" onclick='swal({
...
-->
                    ...
                    <div class="col-sm-12 col-xs-12">
                        <div class="col-md-3 col-sm-3 col-xs-6">
                            ...
                            <input id="markez_name" data-validation="required" aria-required="true" readonly="readonly"
                                   value="<?php if (isset($get_markz->markz_id_fk) && !empty($get_markz->markz_id_fk)) {
                                       echo $get_markz->markz_name; ?>
                            <?php } ?>"
                                   class="form-control" onclick="$('#myModal_markz_taklfaa').modal('show');load_mrakz()"
                            ...
                            <input type="hidden" name="markz_id_fk" id="markez"  value="<?php if (isset($get_markz->markz_id_fk) && !empty($get_markz->markz_id_fk)) {
                                echo $get_markz->markz_id_fk; ?>
                            <?php } ?>">
                        ...
                        <div class="form-group col-sm-3 ">
                            ...
                            <select class="form-control" id="band_id_fk" name="band_id_fk" data-validation="required">
                                ...
                                if (isset($get_markz->band_id_fk) && !empty($get_markz->band_id_fk)) {
                                    ?>
                                    <option value="<?= $get_markz->band_id_fk ?>"
                                            selected><?= $get_markz->band_name ?></option>
                                    <?php
                                }
                                ?>
                        ...
                        <div class="form-group col-sm-3 ">
                            ...
                            <input type="text" class="form-control  testButton inputclass" name="rkm_hesab"
                                   ...
                                   style="cursor:pointer;float: right;width: 84%"
                ...
                <div role="tabpanel" class="tab-pane fade <?php if (isset($get_markz) && !empty($get_markz)) {
                    echo "in active";
                } ?> " id="tab_mrakz">
////////
                    <?php
...
<script>
    ...
    function load_mrakz() {
        $.ajax({
            type: 'get',
            url: "<?php echo base_url();?>human_resources/cost_center_setting/Setting/load_mrakz",
            beforeSend: function () {
