            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="card profile-card-3 center-block">
                    ...
                    <div class="card-content col-xs-12">
                        <h3 class="text-center"> كارت تعريف لموظف</h3>
                        <div class="col-xs-12 no-padding card-define">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td>
                                        <h4> <?php if(isset($personal_data[0]->emp_code)){ echo $personal_data[0]->emp_code ;  }else{  echo'غير محدد';} ?> </h4>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="border-left">
                                    ...
                                    <td>
                                        <h4><?php if(isset($personal_data[0]->employee)){ echo $personal_data[0]->employee ;  }else{  echo'غير محدد';} ?> </h4>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="border-left">
                                    ...
                                    <td>
                                        <h4><?php if(isset($personal_data[0]->phone)){ echo $personal_data[0]->phone ;  }else{  echo'غير محدد';} ?> </h4>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="border-left">
                                    ...
                                    <td>
                                        <h4><?php if(isset($personal_data[0]->card_num)){ echo $personal_data[0]->card_num ;  }else{  echo'غير محدد';} ?> </h4>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="border-left">
                                    ...
                                    <td>
                                        <h4><?php if(isset($personal_data[0]->degree_name)){ echo $personal_data[0]->degree_name ;  }else{  echo'غير محدد';} ?> </h4>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h4><?php if(isset($personal_data[0]->admin_name)){ echo $personal_data[0]->admin_name ;  }else{  echo'غير محدد';} ?> </h4>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h4><?php if(isset($personal_data[0]->depart_name)){ echo $personal_data[0]->depart_name ;  }else{  echo'غير محدد';} ?> </h4>
