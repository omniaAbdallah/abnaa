                            ...
                            <div class="col-xs-12 no-padding">
                                <table class="table table-bordered table-devices">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php  if(!empty($tables['employees']->birth_date)){ echo $tables['employees']->birth_date; }else{ echo'غيرمحدد';}?></td>

                                        <?php $age =$tables['employees']->birth_date;
                                        $age =explode('/',$age);
                                        ?>
                               ...
                               echo $type_card[$tables['employees']->type_card]; }else{ echo'غيرمحدد'; }?> </td>
                                   ...
                                   echo $dest_card[$tables['employees']->dest_card]; }else{ echo 'غير محدد';} ?></td>
                                        ...
                                        <td><?php  if(!empty($tables['employees']->esdar_date)){ echo $tables['employees']->esdar_date; }else{ echo'غيرمحدد';}?></td>
                                    </tr>
                                    <tr>
                                        <th class="gray_background" >تاريخ الانتهاء</th>
                                        <td><?php  if(!empty($tables['employees']->end_date)){ echo $tables['employees']->end_date; }else{ echo'غيرمحدد';}?></td>
