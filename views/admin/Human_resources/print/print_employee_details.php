                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            foreach($printer_machine as $machine){
                                                if(isset ($tables['period_emp_details']->device_id_fk) &&!empty($tables['period_emp_details']->device_id_fk))
                                                {
                                                    $x=$tables['period_emp_details']->device_id_fk;
                                                }else
                                            {
                                                $x='';
                                            }
                                                if ($machine->id_setting == $x) {
                             ...
                             if(!empty($sub->period_num)){ foreach ($sub->period_num as $row){
                                 ...
                                 <table class="table table-striped table-bordered" width="100%" id="">
                                     ...
                                     <tr class="">
                                         ...
                                         <td><?php if(isset($arr_time[$row->id])&&!empty($arr_time[$row->id]))  echo $arr_time[$row->id]?></td>
