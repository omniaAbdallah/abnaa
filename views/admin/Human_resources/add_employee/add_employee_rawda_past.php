...
//echo date("Y-m-d");
    ...
    $twiter=$emp->twiter;
    $out['form']='human_resources/Rawda/edit_emp/'.$this->uri->segment(4);
}else{
    $name="";
    ...
    $snap_chat="";
    $twiter="";
    $out['form']='human_resources/Rawda/add_personal_data';
}
?>
<?php
?>
                            ...
                            if(isset($records)&&!empty($records)) {
                                foreach ($records as $record) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                 <li><a target="_blank"
                                                           href="<?php echo base_url(); ?>human_resources/Rawda/edit_emp/<?php echo $record->emp_code; ?>">البيانات
                                                            الأساسية </a></li>
                                                    <li><a target="_blank"
                                                           href="<?php echo base_url(); ?>human_resources/Rawda/add_job_data/<?php echo $record->id; ?>">البيانات
                                                            الوظيفيه </a></li>
                                                    <li><a target="_blank"
                                                           href="<?php echo base_url(); ?>human_resources/Rawda/financeEmployee/<?php echo $record->id; ?>">البيانات
                                                            المالية </a></li>
                                                    <li><a target="_blank"
                                                           href="<?php echo base_url(); ?>human_resources/Rawda/contractEmployee/<?php echo $record->id; ?>">بيانات
                                                            التعاقد </a></li>
                                                    <li><a target="_blank"
                                                           href="<?php echo base_url(); ?>human_resources/Rawda/printer_machin_Employee/<?php echo $record->id; ?>">بيانات
                                                            الدوام </a></li>
                                                    <li><a target="_blank"
                                                           href="<?php echo base_url(); ?>human_resources/Rawda/employee_files/<?php echo $record->id; ?>">
                                                            المستندات والبطاقات والمهارات </a></li>
                                                    <li><a target="_blank"
                                                           href="<?php echo base_url(); ?>human_resources/Rawda/custody/<?php echo $record->id; ?>">
                                                            شاشة العهد </a></li>
                                                </ul>
                                            </div>
                                       
                                            <a href="<?php echo base_url(); ?>human_resources/Rawda/edit_emp/<?php echo $record->emp_code; ?>"><i
                                                    class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
                                            <a onclick="$('#adele').attr('href', '<?= base_url() . "human_resources/Rawda/DeleteEmpAll/" . $record->id ?>');"
                                     ...
                                     <a href = "<?php echo base_url('human_resources/Rawda/print_employee_details').'/'.$record->id ?>" target = "_blank" >
                                                <i class="fa fa-print" aria-hidden = "true" ></i > </a>

                                            <a  href = "<?php echo base_url('human_resources/Rawda/print_card').'/'.$record->id ?>" target = "_blank" >
                                                <i   style="background-color: #0a568c" class="fa fa-print" aria-hidden = "true" ></i > </a>
