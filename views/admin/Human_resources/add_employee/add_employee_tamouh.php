...
<li><a target="_blank"
       href="<?php echo base_url(); ?>human_resources/human_resources/edit_emp/<?php echo $record->emp_code; ?>">البيانات
        الأساسية </a></li>
<li><a target="_blank"
       href="<?php echo base_url(); ?>human_resources/human_resources/add_job_data/<?php echo $record->id; ?>">البيانات
        الوظيفيه </a></li>
<li><a target="_blank"
       href="<?php echo base_url(); ?>human_resources/human_resources/financeEmployee/<?php echo $record->id; ?>">البيانات
        المالية </a></li>
<li><a target="_blank"
       href="<?php echo base_url(); ?>human_resources/human_resources/contractEmployee/<?php echo $record->id; ?>">بيانات
        التعاقد </a></li>
<li><a target="_blank"
       href="<?php echo base_url(); ?>human_resources/human_resources/printer_machin_Employee/<?php echo $record->id; ?>">بيانات
        الدوام </a></li>
<li><a target="_blank"
       href="<?php echo base_url(); ?>human_resources/human_resources/employee_files/<?php echo $record->id; ?>">
        المستندات والبطاقات والمهارات </a></li>
<li><a target="_blank"
       href="<?php echo base_url(); ?>human_resources/human_resources/custody/<?php echo $record->id; ?>">
        شاشة العهد </a></li>
</ul>
</div>
