...
//echo date("Y-m-d");
    ...
    $twiter=$emp->twiter;
    $out['form']='human_resources/Tamouh/edit_emp/'.$this->uri->segment(4);
}else{
    $name="";
    ...
    $snap_chat="";
    $twiter="";
    $out['form']='human_resources/Tamouh/add_personal_data';
}
?>
<?php
?>
...
<!--                
                    ...
                    <div class="form-group col-md-3 col-sm-6 padding-4">
                        ...
                        <input type="text"  id="city_name"   value="<?php echo $city_name?>"  class="form-control " data-validation-has-keyup-event="true" readonly>
                ...
                class="btn btn-success btn-next" style="float: right;     margin-top: 20px;
    margin-right: -4px;" onclick="GetDiv('myDiv')">
...
<!-- 
               ...
               -->
                        <input type="text" name="adress_other" id="adress_other"  data-validation="required" value=" <?php echo $adress_other;?>"  class="form-control ">
                    </div>
                    <div class="form-group col-md-3 col-sm-6 padding-4">
                  ...
                  <div class="form-group col-md-3 col-sm-6 padding-4">
                    ...
                    <div class="col-md-12" style="padding-right: 0">
                        ...
                        <button type="submit" id="save" name="add" value="save"
                                onclick="insertData();" class="btn btn-labeled btn-success "  style="background-color: #3c990b;border-color: #12891b;padding-top: 0;padding-bottom: 0;border-radius:2px; ">
                            ...
                            if(isset($records)&&!empty($records)) {
                                foreach ($records as $record) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                 <li><a target="_blank"
                                                           href="<?php echo base_url(); ?>human_resources/Tamouh/edit_emp/<?php echo $record->emp_code; ?>">البيانات
                                                            الأساسية </a></li>
                                                    <li><a target="_blank"
                                                           href="<?php echo base_url(); ?>human_resources/Tamouh/add_job_data/<?php echo $record->id; ?>">البيانات
                                                            الوظيفيه </a></li>
                                                    <li><a target="_blank"
                                                           href="<?php echo base_url(); ?>human_resources/Tamouh/financeEmployee/<?php echo $record->id; ?>">البيانات
                                                            المالية </a></li>
                                                    <li><a target="_blank"
                                                           href="<?php echo base_url(); ?>human_resources/Tamouh/contractEmployee/<?php echo $record->id; ?>">بيانات
                                                            التعاقد </a></li>
                                                    <li><a target="_blank"
                                                           href="<?php echo base_url(); ?>human_resources/Tamouh/printer_machin_Employee/<?php echo $record->id; ?>">بيانات
                                                            الدوام </a></li>
                                                    <li><a target="_blank"
                                                           href="<?php echo base_url(); ?>human_resources/Tamouh/employee_files/<?php echo $record->id; ?>">
                                                            المستندات والبطاقات والمهارات </a></li>
                                                    <li><a target="_blank"
                                                           href="<?php echo base_url(); ?>human_resources/Tamouh/custody/<?php echo $record->id; ?>">
                                                            شاشة العهد </a></li>
                                                </ul>
                                            </div>
                                       
                                            <a href="<?php echo base_url(); ?>human_resources/Tamouh/edit_emp/<?php echo $record->emp_code; ?>"><i
                                     ...
                                     <a href = "<?php echo base_url('human_resources/Tamouh/print_employee_details').'/'.$record->id ?>" target = "_blank" >
                                                <i class="fa fa-print" aria-hidden = "true" ></i > </a>

                                            <a  href = "<?php echo base_url('human_resources/Tamouh/print_card').'/'.$record->id ?>" target = "_blank" >
                                                <i   style="background-color: #0a568c" class="fa fa-print" aria-hidden = "true" ></i > </a>
...
<ul class="dropdown-menu">
<li><a target="_blank"  href="<?php echo base_url();?>human_resources/Tamouh/add_job_data/<?php echo $record->id ;?>">البيانات الوظيفيه  </a></li>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                foreach($record->attach_files as $row){?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url() . 'human_resources/Tamouh/downloads/'.$row->emp_file ?>" download> <i class="fa fa-download" title="تحميل"></i> </a>
                                                            <a target="_blank" href="<?php echo base_url() . 'human_resources/Tamouh/read_file/'.$row->emp_file ?>" > <i class="fa fa-eye" title=" قراءة"></i> </a>
                                                        </td>
...
$("#myModalInfo .close").click();
    ...
    function GetDiv(div) {
        ...
        var oTable_usergroup = $('#js_table_members').DataTable({
            dom: 'Bfrtip',
            "ajax": '<?php echo base_url(); ?>human_resources/Tamouh/getConnection',
