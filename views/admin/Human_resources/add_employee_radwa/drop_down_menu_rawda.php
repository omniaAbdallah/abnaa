...
<div class="btn-group">
    ...
    <ul class="dropdown-menu">
     <li><a href="<?php echo base_url(); ?>human_resources/radwa/Rawda/edit_emp/<?php echo $emp_code; ?>">البيانات
                الاساسية </a></li>
        <li><a href="<?php echo base_url(); ?>human_resources/radwa/Rawda/add_job_data/<?php echo $id; ?>">البيانات
                الوظيفيه </a></li>
