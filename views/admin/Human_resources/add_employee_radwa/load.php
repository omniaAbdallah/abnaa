                                ...
                                foreach ($nationality as $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          ...
                                          <a href="#" onclick="delete_nationality(<?= $value->id_setting ?>);"> <i class="fa fa-trash"> </i></a>

                                        <a href="#" onclick="update_nationality(<?= $value->id_setting ?>);"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
