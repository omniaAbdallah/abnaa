    ...
    <div class="col-xs-12 no-padding">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                 <li><a target="_blank"
                                                           href="<?php echo base_url(); ?>human_resources/radwa/Rawda/edit_emp/<?php echo $record->emp_code; ?>">البيانات
                                                            الأساسية </a></li>
                                                    <li><a target="_blank"
                                                           href="<?php echo base_url(); ?>human_resources/radwa/Rawda/add_job_data/<?php echo $record->id; ?>">البيانات
                                                            الوظيفيه </a></li>
        ...
        <li><a href="<?php echo base_url(); ?>human_resources/human_resources/custody/<?php echo $record->id; ?>">
                شاشة العهد </a></li>
                                            ...
                                            <a href="<?php echo base_url(); ?>human_resources/radwa/Rawda/edit_emp/<?php echo $record->emp_code; ?>"><i
                                                    class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
                                            <a onclick="$('#adele').attr('href', '<?= base_url() . "human_resources/radwa/Rawda/DeleteEmpAll/" . $record->id ?>');"
                                     ...
                                     <!-- <a href = "<?php echo base_url('human_resources/radwa/Rawda/print_employee_details').'/'.$record->id ?>" target = "_blank" >
                                                <i class="fa fa-print" aria-hidden = "true" ></i > </a> -->
                                                <a onclick="print_employee_details(<?= $record->id ?>)" title="طباعه"><i
                                            class="fa fa-print"></i></a>

                                            <!-- <a  href = "<?php echo base_url('human_resources/radwa/Rawda/print_card').'/'.$record->id ?>" target = "_blank" >
                                                <i   style="background-color: #0a568c" class="fa fa-print" aria-hidden = "true" ></i > </a> -->
