...
?>
<?php
$out['form'] = 'human_resources/radwa/Rawda/add_job_data/' . $this->uri->segment(5);
?>
    ...
    <div class=" panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            ...
            <div class="form-group col-md-4 col-sm-6 padding-4" 
                     >
                    <label class="label  ">اسباب حالات الموظفين</label>
                    <input type="text" name="reason_name" id="reason_name" value="<?php 
                    if(isset($reason_name) and $reason_name !=null){
                       echo $reason_name; 
                    }else{
