                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <img src="<?= base_url() . "uploads/human_resources/glasat_emp/all_mehwr_glasat/" . $row->mehwar_morfaq ?>"
                                                         width="100%">
                                                </div>
                                    ...
                                    <div class="modal fade" id="myModal-view-pdf-<?= $row->id ?>" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <iframe src="<?= base_url() . "uploads/human_resources/glasat_emp/all_mehwr_glasat/" . $row->mehwar_morfaq ?>"
