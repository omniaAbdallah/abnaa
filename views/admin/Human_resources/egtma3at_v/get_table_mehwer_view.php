                ...
                <tr>
                    ...
                    <td>
                        ...
                        if (!empty($mehwar_morfaq)) {
                            ...
                            <!-- <a   href="<?= base_url()."human_resources/egtma3at/Egtma3at_c/download_file/".$mehwar_morfaq?>"
                            ...
                            if (in_array($type, $arry_images)) {
                                ...
                                <?php if (!empty($mehwar_morfaq)) {
                                    ...
                                    $url = base_url() . 'uploads/human_resources/glasat_emp/all_mehwr_glasat/' . $mehwar_morfaq;
                                ...
                                <a target="_blank"
                                   ...
                                   href="<?= base_url() . 'uploads/md/all_mehwr_magles_edara/download_file/' . $mehwar_morfaq ?>" download>
...
<script>
    ...
    function delete_mehwr_galsa(id) {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url() ?>human_resources/egtma3at/Egtma3at_c/delete_mehwr_galsa',
