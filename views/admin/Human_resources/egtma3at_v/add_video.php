...
<div class="col-xs-12 fadeInUp wow">
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        <div class="panel-heading">
            ...
            <?php $data['last_galsa']=$last_galsa;
            ...
            <div class="col-sm-12 load_morfaq" style="padding-bottom: 27px;">
                <div class="form-group col-sm-3 padding-4">
                    ...
                    <input type="text" class="form-control" id="glsa_rkm_full" name="glsa_rkm_full"
                           readonly value="<?php echo date("Y"); ?>/<?php echo $galsa->glsa_rkm_full; ?>"/>
                </div>
                <div class="form-group col-sm-3 padding-4">
                ...
                <div class="form-group col-sm-3 padding-4">
                    <label class="label">  لينك الفيديو </label>
                    <input type="text" class="form-control" name="myvideo" id="myvideo"
                           data-validation="required"  value=""/>
                </div>
            </div>
            <div class="col-xs-12 no-padding" style="padding: 10px;">
                <div class="text-center">
                    <button type="button" id="buttons"  onclick="add_morfaq(<?= $galsa->id ?>,'video');"
        ...
        <div class="panel-body">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 padding-10" id="row_<?= $z ?>">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-footer" >
                                    <a data-toggle="modal" data-target="#myModal-view_video-<?= $row_video->id ?>">
                                    ...
                                    <a href="#" onclick='swal({
                                            ...
                                            function(){
                                            delete_my_morfaq($("#row_<?= $z ?>"),<?= $row_video->id ?>);
                                            //delete_my_morfaq(<?= $row_video->id ?>);
                                            });'>
            ...
            <div class="box-footer">
                <ul class="mailbox-attachments clearfix">
                    ...
                    foreach ($records as $row_video) { ?>
                        <li id="row_<?= $z ?>" >
                                <span class="mailbox-attachment-icon has-img" data-toggle="modal" data-target="#myModal-view_video-<?= $row_video->id ?>">
                                    <iframe   src="https://www.youtube.com/embed/<?=$row_video->file?>"
                                              frameborder="0" allow="autoplay; encrypted-media" allowfullscreen
                            ...
                            <div class="mailbox-attachment-info">
                                ...
                                <span class="mailbox-attachment-size">
                                        <!-- modal view -->
                                            <a data-toggle="modal" data-target="#myModal-view_video-<?= $row_video->id ?>" class="btn btn-default btn-xs pull-right">
                                                ...
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <h4 class="modal-title" id="myModalLabel"><?=$row_video->title?></h4>
                                                        </div>
                                                        <div class="modal-body">
                                                            <iframe width="100%" height="100%" src="https://www.youtube.com/embed/<?= $row_video->file?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                                                إغلاق
...
<script>
    function add_morfaq(glsa_id_fk,type) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>human_resources/egtma3at/Egtma3at_c/add_video/'.glsa_id_fk,
            data: form_data,
    ...
    function delete_my_morfaq(elem,attach) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>human_resources/egtma3at/Egtma3at_c/delete_attach',
            data: {attach: attach,type:2},
            dataType: 'html',
            cache: false,
            success: function (html) {
