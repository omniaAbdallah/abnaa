                    ...
                    if (isset($records) && !empty($records)) {
                        ...
                        foreach ($records as $row) {
                            ...
                            <tr id="row_<?= $z ?>">
                                ...
                                <td style="width: 10%">
                                    <a href="<?php echo base_url() . 'human_resources/egtma3at/Egtma3at_c/read_file/' . $row->id ?>"
                                       target="_blank">
                        ...
                        <li id="row_<?= $z ?>">
                            ...
                            if (in_array($ext, $img)) {
                                ...
                                <span class="mailbox-attachment-icon has-img" data-toggle="modal" data-target="#myModal-view-<?= $row->id ?>">
                                    <img src="<?php if (file_exists('uploads/human_resources/hr_all_glasat_emp_attaches/'.$row->file)) {
                                                echo base_url() .'uploads/human_resources/hr_all_glasat_emp_attaches/'.$row->file;
                                            } ?> " alt="Attachment">
                                </span>
                                            ...
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <img src="<?= base_url().'uploads/human_resources/hr_all_glasat_emp_attaches/'.$row->file?>"
                                                             width="100%" alt="">
                                                    </div>
                                            ...
                                            <div class="modal fade" id="myModal-pdf-<?= $row->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <iframe src="<?php echo base_url() . 'human_resources/egtma3at/Egtma3at_c/read_file/' . $row->id ?>" style="width: 100%; height:  640px;" frameborder="0"> </iframe>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                                                إغلاق
...
<script>
    function add_morfaq(glsa_id_fk,type) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>human_resources/egtma3at/Egtma3at_c/add_attach/'.glsa_id_fk,
            data: form_data,
