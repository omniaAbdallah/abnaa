...
<div class="btn-group">
    ...
    <ul class="dropdown-menu">
        <!-- <?php if ($row->glsa_finshed == 0) { ?>
                                                    <li><a target="_blank"
                                                           href="<?= base_url() . 'human_resources/egtma3at/Egtma3at_c/update_galsa' . '/' . $row->glsa_rkm . '/' . $row->mgls_code ?>">
                                                            تعديل بيانات الجلسة </a></li>
                                                <?php } ?> -->
        <li><a target="_blank"
               href="<?= base_url() ?>human_resources/egtma3at/Egtma3at_c/a3da_glsa/<?= $last_galsa ?>">
                أعضاء الجلسه </a></li>
        <li><a target="_blank"
               href="<?= base_url() ?>human_resources/egtma3at/Egtma3at_c/mehwr_glsa/<?= $last_galsa ?>">
                محاور الجلسه </a></li>
        <li><a target="_blank"
               href="<?= base_url() ?>md/all_glasat/Start_galsa/add_galsat_mon24a/<?= $last_galsa ?>">
                مناقشة الجلسة </a></li>
        <li><a target="_blank"
               href="<?= base_url() ?>human_resources/egtma3at/Egtma3at_c/add_attach/<?= $last_galsa ?>">
                إضافة مرفقات </a></li>
        <li><a target="_blank"
               href="<?= base_url() ?>human_resources/egtma3at/Egtma3at_c/add_video/<?= $last_galsa ?>">
                مكتبة الفيديوهات </a></li>
        <li>
            <a href="<?= base_url() ?>human_resources/egtma3at/Egtma3at_c/add_image/<?= $last_galsa ?>">
                مكتبة الصور </a></li>
    </ul>
    <!--  -->
</div>