...
<style type="text/css">
    ...
    *:after {
    ...
    <?php echo base_url();?>       /asisst/admin_asset/img/pills/raoom_paper.png);*/
                            ...
                            <div class="main">
                                <div class="bond-qabd">
                                    <div class="container-fluid">
                                        <div class="bond-body">
                                            <div class=" col-xs-12 ">
                                                <p>الحمد لله رب العالمين والصلاة والسلام على من لا نبي بعده ,,
                                                    وبعد</p>
                                                <p>
                                                    تقرير إجتماع   موظفين الجمعيه الخيريه لرعايه الايتام
                                                    ابناء
                                                    <?php
                                                    ...
                                                    ?>
                                                    الموافق <?php echo $row->glsa_date_ar ?> م
                                                    في تمام الساعة <?php echo $row->time_start ?>
                                                    فى مقر الجمعية وذلك لمناقشة القرارات والموضوعات المدرجة فى
                                                    جدول
                                                    الإجتماع التالي :
                                                </p>
                                                <br>
                                                <!-- <table class="table  main-table"
                                                               style="table-layout: fixed;margin-bottom: 0;">                                                    <tbody>
                                                    <?php
                                                if (isset($row->all_bnod) && !empty($row->all_bnod)) {
                                                    foreach ($row->all_bnod as $key => $mehwar) { ?>
                                                            <tr><td><?php echo ++$key . '-' . $mehwar->mehwar_title ?></td></tr>
                                                        <?php }
                                                } ?>
                                                    </tbody>
                                                </table>-->
                                                ...
                                                <h5 class="text-center">وعليه فقد قرر  مايلي : </h5>
                                                <ol>
                                                    <?php
                                                    if (isset($row->all_bnod) && !empty($row->all_bnod)) {
                                                        foreach ($row->all_bnod as $mehwar) { ?>
                                                ...
                                                <br>
                                                <div class="clearfix"></div>
                                                <h5 class="text-center">توقيع    الموظفين
                                                    رقم <?php echo '(' . $row->glsa_rkm . ')'; ?>  </h5>
                                                <table class="table no-border-td">
                                                    ...
                                                    if (isset($row->members) && !empty($row->members)) {
                                                        ...
                                                        foreach ($row->members as $member) {
                                                            ...
                                                            <tr>
                                                                <td><?php echo $xx . ' - ' ?></td>
                                                                <td><?php echo $member->emp_name ?></td>
        ...
        <div class="bond-header">
            <div class="col-xs-12">
                ...
                <div class="col-xs-4 pad-2">
                    <div class="left-img">
                        <img style="width: 85%;"
                             src="<?php echo base_url() ?>asisst/admin_asset/img/pills/sympol1.png">
                    </div>
                </div>
                <div class="col-xs-4 pad-2">
                    <h4>الرقم <span>  :-.......................</span></h4>
                    <h4>التاريخ <span>:-......................</span></h4>
                    <h4>الموضوع <span>:-....................</span></h4>
                </div>
            </div>
            <div class="col-xs-12 text-center">
                <h1 class="title-fe span_font">
                    <span>محضر إجتماع  رقم ( <?php echo $row->glsa_rkm ?>)     </span></h1>
            </div>
    ...
    <div class="footer-info">
        <div class="col-xs-12 no-padding print-details-footer">
            <div class="col-xs-12 no-padding ">
                <!--                <hr>-->
                <img src="<?php echo base_url(); ?>/asisst/admin_asset/img/pills/page-footer.png" width="100%"/>
            </div>
        </div>
    </div>
</div>
