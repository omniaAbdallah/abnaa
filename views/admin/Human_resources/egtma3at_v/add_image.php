    ...
    <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
        ...
        <div class="panel-body">
            <div class="col-sm-12 load_morfaq" style="padding-bottom: 27px;">
                ...
                <div class="form-group col-sm-3 padding-4">
                    <label class="label"> اسم الصوره </label>
                ...
                <div class="form-group col-sm-3 padding-4">
                    <label class="label"> الصوره </label>
                    <input type="file" class="form-control" name="file" id="myfile"
                           data-validation="required"  accept="image/*" value=""/>
                </div>
            </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 padding-10" id="row_<?= $z ?>">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body" style=" height: 200px;overflow: hidden;">
                                <img src="<?= base_url().'uploads/human_resources/hr_all_glasat_emp_morfaq/'. $row->file?>"
                            ...
                            <div class="panel-footer" >
                                ...
                                <a href="<?php echo base_url() . 'human_resources/egtma3at/Egtma3at_c/download_file/' . $row->id.'/1' ?>"
                                   target="_blank">
                        ...
                        <li id="row_<?= $z ?>">
                            ...
                            if (in_array($ext, $img)) {
                                ...
                                <span class="mailbox-attachment-icon has-img" data-toggle="modal" data-target="#myModal-view-<?= $row->id ?>">
                                        <img
                                                src="<?php if (file_exists('uploads/human_resources/hr_all_glasat_emp_morfaq/'.$row->file)) {
                                                    echo base_url() .'uploads/human_resources/hr_all_glasat_emp_morfaq/'.$row->file;
                                                } ?> " alt="Attachment">
                                    </span>
                                <div class="mailbox-attachment-info">
                                    ...
                                    <span class="mailbox-attachment-size">
                                            <!--<a href="<?php echo base_url() . 'human_resources/egtma3at/Egtma3at_c/download_file/'.$row->id.'/3'?>"
...
<script>
    function add_morfaq(glsa_id_fk,type) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url() ?>human_resources/egtma3at/Egtma3at_c/add_image/'.glsa_id_fk,
            data: form_data,
