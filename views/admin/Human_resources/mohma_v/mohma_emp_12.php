<?php if($_SESSION['role_id_fk']==1 || ($_SESSION['role_id_fk']==3 && $emp_data_sesstion->cat_manager_id_fk !=5))
{
    ?>
...
$another_mohma='';
   ...
   <?php if (isset($_POST['from_profile']) && (!empty($_POST['from_profile']))) { ?>
           ...
           <div class="form-group padding-4 col-md-3 col-xs-12">
                ...
                <div class="col-sm-4  col-md-6 padding-4 ">
                ...
                <div class="form-group col-md-2  col-sm-6 padding-4">
                        ...
                        <div class="form-group col-md-1  col-sm-6 padding-4">
                            <div id="cal-end-4">
                                <label class="label "> الوقت المقدر - أيام</label>
...
<a onclick=' swal({
                                        ...
                                        function(){
                                        swal("تم انهاء!", "", "success");
                                        setTimeout(function(){window.location="<?= base_url() . 'human_resources/mohma/Mohma_c/end_mohma/' . $value->id ?>";}, 500);
                                        });'>
                                    <i class="fa fa-archive"> </i> انهاء المهمة </a></li>
                                    <?php }?>
...
<div class="alert alert-danger">    نظرا لانك  موظف من الفئة التنفيذيه.. لا يمكنك إضافة مهمة </div>
<?php }?>
