                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <?php if ($value->suspend != 4) {
                                            ...
                                            <li><a onclick=' swal({
                                                        title: "هل انت متأكد من استلام المهمة ؟",
                                                        text: "",
                                                        type: "warning",
                                                        ...
                                                        function(){
                                                        swal("تم استلام!", "", "success");
                                                        setTimeout(function(){window.location="<?= base_url() . 'human_resources/mohma/Mohma_c/estlam_mohma/' . $value->id ?>";}, 500);
                                                        });'>
                                                    <i class="fa fa-archive"> </i> استلام المهمة </a></li>
                                        <?php } ?>
                                        ...
                                        <li><a onclick='<?php echo $add_attaches ?>'><i class="fa fa-commenting-o"
                                                                                        aria-hidden="true"></i>إضافة
                                                مرفقات</a></li>
                                        <li><a onclick='<?= $add_comment ?>'><i class="fa fa-comments-o"
                                                                                aria-hidden="true"></i> اضافة رد </a>
                                        </li>
