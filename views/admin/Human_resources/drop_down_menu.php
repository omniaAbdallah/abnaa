...
<div class="btn-group">
    ...
    <ul class="dropdown-menu">
     <li><a href="<?php echo base_url(); ?>human_resources/human_resources/edit_emp/<?php echo $emp_code; ?>">البيانات
                الاساسية </a></li>
        <li><a href="<?php echo base_url(); ?>human_resources/human_resources/add_job_data/<?php echo $id; ?>">البيانات
                الوظيفيه </a></li>
        ...
        <li><a href="<?php echo base_url(); ?>human_resources/human_resources/contractEmployee/<?php echo $id; ?>">بيانات
                التعاقد </a></li>
        <li><a href="<?php echo base_url(); ?>human_resources/Dwam_settings/add_dwam/<?php echo $id; ?>">بيانات
                الدوام </a></li>
