    ...
    <div class="r-head col-xs-12" >
        <div class="col-xs-12">
            <div class="col-xs-4 no-padding" style="padding-top: 30px">
                <h4 class="text-center" style="font-size: 22px;"><strong> الجمعية الخيرية لرعاية المعاقين بحائل - هدكا
 </strong><br></h4>
            </div>
            
            <div class="col-xs-4">
                <img src="<?php echo base_url(); ?>asisst/fav/ms-icon-70x70.png" alt="" width="100%" height="100px">
            </div>
...
<script>
    ...
    window.print();
    setTimeout(function () {location.replace("<?php echo base_url('assembley_members/New_member_pill/new_member_pills')?>");}, 500);
</script>
