...
<table id="example" class="display table table-bordered   responsive nowrap" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                foreach ($all_student as $student) {
                    if($x == 1){
                        $Link = '  
                                 <a href="'. base_url().'assembley_members/New_member_pill/print_data/'.$student->member_id_fk.'" class="btn btn-info btn-xs   ">
                                 <i class="fa fa-print"></i> طباعة</a>

                                 <a href="'. base_url().'assembley_members/New_member_pill/delete/'.$student->id.'" onclick="return confirm(\'هل انت متأكد من عملية الحذف ؟\');" class="btn btn-danger btn-xs   ">
