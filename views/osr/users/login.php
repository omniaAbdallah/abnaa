...
<head>
    ...
    <link rel="stylesheet"
          href="<?php echo base_url() ?>asisst/osr_asset/css/responsive.css?<?php echo date('l jS \of F Y h:i:s A'); ?>">
                ...
                <div class="login-area  ">
                    <div class="panel panel-bd panel-custom">
                        <div class="panel-body">
                            <img src="<?php echo base_url() ?>asisst/osr_asset/img/logo-abnaa.png" width="100%">
                            <h5 class="text-green text-center">تسجيل دخول الموظفين</h5>
                            <?php echo form_open('Login_osr/check_login', array('role' => 'form')) ?>
                            ...
                            <div class="form-group ">
                                <div class="input-stylish ">
                                    ...
                                    <input type="password" title="برجاء إدخال كلمة المرور الخاص بك "
                                           ...
                                           name="user_pass" id="password" class="">
                                    <div class="stylish"></div>
                                </div>
                            </div>
                            <div class="text-center">
                                <button class="btn btn-add" name="login" type="submit" value="login"> الدخول &nbsp <i
