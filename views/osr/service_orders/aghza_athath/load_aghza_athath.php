...
if (!empty($talabt_data)) {
    foreach ($talabt_data as $row) { ?>
        <tr>
            ...
            <td> <?= $fe2a_talab_array[$row->fe2a_talab] ?> </td>
            <td> <?= $sub_fe2a_talab_array[$row->no3] ?> </td>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <img src="<?= base_url() . 'uploads/osr/service_orders/aghza_athath/' . $row->img ?>"
                                     width="100%" alt="">
                            </div>
