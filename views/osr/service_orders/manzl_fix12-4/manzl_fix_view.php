...
<div class="col-sm-12 col-md-12 col-xs-12 fadeInUp wow ">
    <div class="panel panel-info">
        <div class="panel-heading panel-title">
            إصلاح و ترميم المنزل

        </div>
        <div class="panel-body" id="show_edite">
            <!-- <?php
            if (isset($record)) {
                echo form_open_multipart('osr/service_orders/Manzl_fix/editManzl_fixOrders/' . $record['id'], array('class' => 'manzel_form'));
            } else {
                ...
                <div class="form-group col-sm-2 col-xs-12 ">
                    ...
                    <select name="fe2a_type" id="fe2a_type" class="form-control " onchange="GetF2a(this)"
                        ...
                        foreach ($type as $key => $value) {
                            ...
                            ?>
                            <option value="<?= $key ?>"
                                    data-specialize="<?= $key ?>" <?= $select ?>><?= $value ?></option>
                            <?
                        }
                        ?>
                    </select>
