...
<div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
    ...
    <div class="panel-heading">
        ...
        <h3 class="panel-title">  الدردشه المباشره </h3>
...
<div  > 
  ...
  <section  style="">
     ...
     <div class="row">
            ...
            <div class="col-md-8" id="chatSection" style="
 float: left;
...
<img src="<?=base_url('uploads/human_resources/emp_photo/thumbs/unknow.png')?>" alt="alatheer" title="alatheer" 

style="border-radius: 50%;height: 50px;width: 50px;    margin-top: -52px;"/>

                  <div class="box-tools pull-right">

                    <span data-toggle="" title="حذف الدردشه " class="ClearChat"><i class="fa fa-comments"></i></span>
                  ...
                  <!--<form action="#" method="post">-->
                    ...
                    <div class="input-group">
 					...
 					?>
                        ...
                        <input type="text" name="message" placeholder="اكتب رسالتك  ..." class="form-control message">
    ...
    ">
              ...
              <div class="box box-danger">
                ...
                <div class="box-header with-border" style="height: 65px;">

                  <h6 class="box-title" style="color: black;"><?=$strTitle;?></h6>
...
<ul style="list-style: none; MARGIN-TOP: 13PX;" class="users-list clearfix" id="ul_names">
...
<script src="<?=base_url('asisst/osr_asset/chat/chat.js');?>"></script> 
