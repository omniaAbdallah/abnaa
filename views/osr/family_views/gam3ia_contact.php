 ...
 <div class="col-xs-12 no-padding">
        ...
        <div class="panel panel-bd lobidisable lobipanel lobipanel-sortable ">
            ...
            <div class="panel-body" >
                        ...
                        <?php echo form_open_multipart(base_url() . 'osr/Family/gam3ia_contact') ?>
                        <div class="bs-callout bs-callout-danger">
                            <div class="clearfix"></div>
                            <br>
                            <div class="col-xs-12 col-sm-6">
                                <ul class="list-group">
                                    <li class="list-group-item"><strong> اسم الأب
                                            : </strong> <?= $data[0]->father_name ?>
                                    </li>
                                    <li class="list-group-item"><strong>رقم سجل الأب
                                            : </strong> <?= $data[0]->f_national_id ?></li>
                                </ul>
                            </div>
<div class="col-xs-12 col-sm-6">
    <ul class="list-group">
        <li class="list-group-item"><strong> اسم الأم
