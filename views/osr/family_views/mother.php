        ...
        <div class="custom-tabs">
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade in <?= $class ?>" id="main-detailsa">
                    <?php echo form_open_multipart('osr/Family/mother', array('id' => 'main-detailsa', 'class' => 'mother_form')); ?>
                    ...
                    <div class="col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-md-2 col-sm-4 col-xs-12 padding-4">
                            ...
                            <input type="text" name="mother_national_card_new" maxlength="10" readonly
                ...
                <div role="tabpanel" class="tab-pane fade in <?= $class1 ?>" id="contact-details">
                    <?php echo form_open_multipart('osr/Family/mother', array('id' => 'contact-details', 'class' => 'mother_form')); ?>
                    <input type="hidden" name="add" value="حفظ">
                    <div class="form-group col-md-2 padding-4 col-sm-4 col-xs-12">
                ...
                <div role="tabpanel" class="tab-pane fade in <?= $class2 ?>" id="health-details">
                    <?php echo form_open_multipart('osr/Family/mother', array('id' => 'health-details', 'class' => 'mother_form')); ?>
                    <input type="hidden" name="add" value="حفظ">
                ...
                <div role="tabpanel" class="tab-pane fade in <?= $class3 ?>" id="education-details">
                    <?php echo form_open_multipart('osr/Family/mother', array('id' => 'education-details', 'class' => 'mother_form')); ?>
                    <input type="hidden" name="add" value="حفظ">
                    <div class="form-group col-md-2 padding-4 col-sm-4 col-xs-12">
                ...
                <div role="tabpanel" class="tab-pane fade in <?= $class4 ?>" id="skills-details">
                    <?php echo form_open_multipart('osr/Family/mother', array('id' => 'skills-details', 'class' => 'mother_form')); ?>
                    <input type="hidden" name="add" value="حفظ">
                        ...
                        <div class="panel-footer">
                            <div class="text-center">
                                <?php if (isset($mother) && $mother != null):$input_name1 = 'update';
                                    ...
                                    $input_name2 = 'add_save'; endif; ?>
                                <button type="button" onclick="save_mother('skills-details') "
                ...
                <div role="tabpanel" class="tab-pane fade in <?= $class5 ?>" id="other">
                    <?php echo form_open_multipart('osr/Family/mother', array('id' => 'other', 'class' => 'mother_form')); ?>
                    <input type="hidden" name="add" value="حفظ">
