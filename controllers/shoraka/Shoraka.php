...
//        C:\laragon\www\lastAbnaa_30\application\models\shoraka_models\Shoraka_model.php
        $this->load->model('shoraka_models/Shoraka_model', 'model');
    }
...
//    selet_allshoraka
        ...
        $data['subview'] = 'admin/shoraka_views/shoraka_view';
    ...
    public function insert_shoraka()
    {
        ...
        redirect('shoraka/Shoraka', 'refresh');
    }
