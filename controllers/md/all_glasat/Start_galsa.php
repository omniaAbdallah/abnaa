...
class Start_galsa extends MY_Controller
{
    ...
    {
        $galsa_rkm = $this->input->post('glsa_rkm');
        $data['mahawer_end'] = $this->Glasat_model->get_all_mahawer($galsa_rkm, 1);
        $data['galsa_rkm'] = $galsa_rkm;
        $this->load->view('admin/md/all_glasat/load_end_mhawer', $data);
    }
    public function load_add_mehwar()
    {
        $galsa_rkm = $this->input->post('glsa_rkm');
        $data['galsa_rkm'] = $galsa_rkm;
        $this->load->view('admin/md/all_glasat/load_add_mehwar', $data);
    }
    public function insert_mehwor_qrar()
    {
        $galsa_rkm = $this->input->post('galsa_rkm');
        $files = $this->upload_all_file("mehwar_morfaq");
        $this->Glasat_model->insert_mehwor_qrar($files, $galsa_rkm);
        $data['mahawer_end'] = $this->Glasat_model->get_all_mahawer($galsa_rkm, 1);
        /*
                echo '<pre>';
                print_r($data);*/
    ...
    public function print_mahdr($galsa_id_fk = false)
    {
        ...
        $this->load->view('admin/md/all_glasat/print_mahdr_view', $data);
    }
}