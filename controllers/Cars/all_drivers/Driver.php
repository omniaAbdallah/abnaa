...
public function index() //Cars/drivers/Driver
{
    ...
    $data['jobtitles'] = $this->Difined_model->select_search_key('all_defined_setting', 'defined_type', '4');
     ...
     if($this->input->post('add'))
{
   ...
   redirect('Cars/all_drivers/Driver','refresh');
}
 ...
 /*       echo "<pre>";
        ...
        if($this->input->post('add'))
        {
            $this->Driver_model->insert_data($id);
            $this->message('success','تعديل  سائق');
            redirect('Cars/all_drivers/Driver','refresh');
        }
    ...
    public function car_relation_driver()
    {
        ...
        if($this->input->post('add'))
        {
           ...
           $this->Driver_model->insert_car_relation($img);
            redirect('Cars/all_drivers/Driver/car_relation_driver','refresh');
    ...
    {
        $id= $this->input->post('valu');
        $data["personal_data"]=$this->Employee_model->get_one_employee($id)[0];
