...
class Plans extends MY_Controller{
    public function __construct()
    {
        ...
        $this->load->model('pr/Plans_model');
    ...
    public function read_file($file_name) // admin/pr/Plans/read_file
    {
    ...
    public function add_reports(){ // admin/pr/Plans/add_reports
        ...
        if ($this->input->post('ADD')){
          ...
          //  die;
            ...
            redirect('admin/pr/Plans/add_reports','refresh');

        }
        $data['subview'] = 'admin/pr/plans_view';
    ...
    public function Delete($id){ // admin/pr/Plans/Delete

        $this->Plans_model->delete($id);
        redirect('admin/pr/Plans/add_reports','refresh');

    }
    public function Update($id){ // admin/pr/Plans/Update
