...
class Videos_library extends MY_Controller{
    public function __construct()
    {
        ...
        $this->load->model('library/Videos_model');
    ...
    public function get_videos(){ // admin/library/Videos_library/get_videos
        $data['lenght']= $_POST['length'];

        $this->load->view('admin/familys_views/get_videos');
    }
    public function Delete($id){  // admin/library/Videos_library/Delete
