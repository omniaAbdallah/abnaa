...
class Project extends MY_Controller
{
    ...
    public function add_project(){ // admin/projects/Project/add_project
        ...
        if ($this->input->post('ADD')){
            ...
            redirect('admin/projects/Project/add_project','refresh');
        }


        $data['subview'] = 'admin/projects/project_view';
        $this->load->view('admin_index', $data);

    }
    public function get_project_details(){ // admin/projects/Project/get_project_details
        $data['lenght']= $_POST['length'];

        $this->load->view('admin/projects/load_items');
    }

    public function get_mostafed(){ // admin/projects/Project/get_mostafed
        $data['lenght']= $_POST['length'];

        $this->load->view('admin/projects/load_mostafed');
    }
    public function Update($id){ // admin/projects/Project/Update
        $data['get_project'] = $this->Project_model->get_by_id($id);
        $data['get_items'] = $this->Project_model->get_details_by_id('projects_items',$id);
        $data['get_mostafed'] = $this->Project_model->get_details_by_id('projects_mostafed',$id);
    ...
    public function Delete($id){ // admin/projects/Project/Delete
    ...
    public function DeleteDetails($id,$project_num){ // admin/projects/Project/DeleteDetails

        $this->Project_model->delete_details($id);
        redirect('admin/projects/Project/Update/'.$project_num,'refresh');
    }

    public function DeleteMostafed($id,$project_num){ // admin/projects/Project/DeleteMostafed
    ...
    public function get_photos(){ // admin/projects/Project/get_photos
        $data['lenght']= $_POST['length'];

        $this->load->view('admin/projects/load_photos');
    }

    public function get_videos(){ // admin/projects/Project/get_videos
        $data['lenght']= $_POST['length'];

        $this->load->view('admin/projects/load_videos');
    }

    public function DeletePhoto($id,$project_num){ // admin/projects/Project/DeletePhoto
    ...
    public function DeleteVideo($id,$project_num){ // admin/projects/Project/DeleteVideo
