 ...
 */
   ...
   public function TransformationOfDetailsSarf($process,$band_id,$surf_num){  //   TransformationProcess/TransformationOfDetailsSarf
        $this->load->model('Model_transformation_process');

        if($process  ==5){
            $this->Model_transformation_process->insert_transformation_lagna2Sarf($process,$band_id,$surf_num);
        }
