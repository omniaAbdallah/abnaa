...
//-----------------------------------------
    ...
    {    // family_controllers/Family_reports
    ...
    public function f_member_report()
    {    // family_controllers/reports/Family_reports/f_member_report
    ...
    public function familys_request()
    {    // family_controllers/reports/Family_reports/familys_request
        $this->load->model("familys_models/reports/Reports_model");
     ...
     *  ================================================================================================================
     */
    public function familys_request_period()
    { // family_controllers/Family_reports/familys_request_period
        $this->load->model("familys_models/reports/Reports_model");
    ...
    public function f_memberYearAgesReport()
    {    // family_controllers/reports/Family_reports/f_memberYearAgesReport
        $this->load->model("familys_models/reports/Reports_model");
  ...
  '
    ...
    public function R_all_members()
    {    // family_controllers/reports/Family_reports/R_all_members
        $this->load->model("familys_models/reports/Reports_model");
...
//    ******************* 31-12-om ***************************
    ...
    { // family_controllers/reports/Family_reports/category_report
    ...
    public function association_report()
    { // family_controllers/reports/Family_reports/association_report
