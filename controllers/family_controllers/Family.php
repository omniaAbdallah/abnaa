...
$data['employees'] = $this->Register->select_all_employee();
 ...
 //=============================================
    public function  house($mother_national_num,$from_page=false){  ///Family/house
        $this->load->model('familys_models/House');
        $this->load->model('Department');
        $this->load->model('Difined_model');
        $this->load->model('familys_models/Mother');
...
public function  home_needs($mother_national_num,$from_page=false){ //family_controllers/Family/home_needs
    $this->load->model('familys_models/Home_needs_model');
    $this->load->model('Difined_model');
    $this->load->model('familys_models/Mother');
       $this->load->model("familys_models/Family_members");
...
*/
public function add_wakel($mother_num,$from_page=false){ //family_controllers/Family/add_wakel/1042645620
