    ...
    if (!empty($file)) {
     ...
     <a target="_blank" href="' . base_url() . 'family_controllers/Family_details/details/' . $row['mother_national_num'] . '" class="btn btn-sm btn-success"> <i class="hvr-buzz-out fa fa-recycle" aria-hidden="true">
              ...
              <div class="btn-group ">
                ...
                <li><a 
                target="_blank"
                           href="' . base_url() .'family_controllers/Family/talb_mostandat/' .$row['mother_national_num'] .'"
               > اضافه المستندات
                    </a></li>
                <li><a onclick="print_prime_houe(' . $row['mother_national_num'] . ');">
                        طباعة كروكي المنزل
...
/*public function data()
{
    ...
    if (!empty($file)) {
        ...
        foreach ($file as $row) {
            ...
            if ($row['mother_new_card'] != '' and $row['mother_new_card'] != null) {
                $mother_new_card = $row['mother_national_num'];//mother_national_num_asasy
            } elseif ($row['mother_new_card'] == '' and $row['id'] >= 852) {
                $mother_new_card = $row['mother_national_num'];
            } else {
                $mother_new_card = '<span class="label label-pill label-danger m-r-15">إستكمل البيانات</span>';
            ...
            $sub_array[] = $x;
            if ( in_array($_SESSION['role_id_fk'],array(1,3)) && (in_array($_SESSION['user_id'], array(14,19,136)))) {
...
public function data()
{
    ...
    if (!empty($file)) {
        ...
        foreach ($file as $row) {
            ...
            $sub_array[] = $x;
            if (in_array($_SESSION['role_id_fk'], array(1, 3)) && (in_array($_SESSION['user_id'], array(19, 108)))) {
