<?php
class Emails_family extends MY_Controller
{
    public $email_count;
...
return  $this->session->set_flashdata('message', '<div class="alert alert-danger alert-dismissable">
  ...
  //-----------------------------------------      
    public function inbox($type, $id){
        ...
        $data['type'] = $type;
        $data['users'] = $this->Email_family->select_users2();
        $data['family'] = $this->Email_family->select_users();
        ...
        $data['deleted'] = $this->Email_family->select_deleted_emails2();            
    ...
    public function inbox_table($status){
        ...
        $data['users2'] = $this->Email_family->select_users2();
        $data['emails_sent'] = $this->Email_family->select_emails('','','from',1);
        $data['emails_to_me'] = $this->Email_family->select_emails('','','to','');
        $data['starred'] = $this->Email_family->select_emails(1,'','to',''); 
        $data['deleted'] = $this->Email_family->select_deleted_emails2();
