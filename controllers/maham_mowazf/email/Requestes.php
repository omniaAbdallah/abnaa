...
class Requestes extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->load->model('maham_mowazf_model/email/Email');
        $this->load->model('maham_mowazf_model/email/ReplayModel');
        $this->load->library("pagination");
    }
...
/*5-5-om*/
    ...
    function get_data_pagination()
    {
        ...
        if (!empty($data['my_email'])) {
            $this->load->view('admin/maham_mowazf_view/email/load_data_pagination', $data);
        }
    }
/*5-5-om*/
    ...
    public function print_email()
    {
        ...
        $data['message'] = $this->Email->get_email_by_id($id);
        $data['files'] = $this->Email->get_files_by_id($data['message']->email_rkm);
        $this->load->view('admin/maham_mowazf_view/email/print_email', $data);
    }
