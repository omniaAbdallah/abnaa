...
{ //maham_mowazf/person_profile/Personal_profile/estalmat
    ...
    $data['coming_records'] = $this->Hr_all_transformation_setting_model->select_from_hr_all_agzat_orders(array('current_to_user_id' => $_SESSION['user_id']));
    ...
    $data['user_orders'] = $this->Hr_all_transformation_setting_model->select_from_hr_all_agzat_orders(array('emp_id_fk' => $_SESSION['emp_code']));
    ...
    $this->load->model('human_resources_model/employee_forms/mandate_orders/Transformation_model');

   // $data['mandate_records'] = $this->Transformation_model->my_orders('hr_mandate_orders', array('current_from_user_id' => $_SESSION['user_id']));
   ...
   // $data['mandate_coming'] = $this->Transformation_model->my_orders('hr_mandate_orders', array('current_to_user_id' => $_SESSION['user_id']));
    ...
    $data['coming_mosayer_records'] = $this->Employee_salaries_model->select_from_hr_mosayer_orders(array('current_to_user_id' => $_SESSION['user_id']));



    $data['user_mosayer_orders'] = $this->Employee_salaries_model->select_from_hr_mosayer_orders(array('emp_id_fk' => $_SESSION['emp_code']));
    ...
    $data['coming_accounts_records'] =$this->Transformation_accounts_model->select_from_hr_all_transformation_orders(array('current_to_user_id'=>$_SESSION['user_id']));

    $data['user_accounts_orders'] = $this->Transformation_accounts_model->select_from_hr_all_transformation_orders(array('employees.id'=>$_SESSION['emp_code']));
...
//$data['mandate_records'] = $this->Transformation_mandate_model->my_orders('hr_entdab', array('current_from_user_id' => $_SESSION['user_id']));

//$data['mandate_coming'] = $this->Transformation_mandate_model->my_orders('hr_entdab', array('current_to_user_id' => $_SESSION['user_id']));
    ...
    $data['subview'] = 'admin/maham_mowazf_view/basic_data/estalmat';
    ...
    // $this->load->view('admin/design/pprofile_view');
     ...
     public function moaz() { //maham_mowazf/person_profile/Personal_profile/estalmat
