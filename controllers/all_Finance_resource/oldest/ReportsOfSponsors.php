<?php 
class ReportsOfSponsors extends MY_Controller
{
    public function __construct(){
        ...
        $this->load->model('all_Finance_resource_models/reports_of_sponsors/Model_reports_sponsors'); 
   ...
   *    =======================================================================================================
   *  */
 public function R_current_donors(){ //    all_Finance_resource/ReportsOfSponsors/R_current_donors
        $data['donors'] = $this->Model_reports_sponsors->R_current_donors(0);
        $data['status'] = 0;
        $data['subview'] = 'admin/all_Finance_resource_views/reports_of_sponsors/R_current_donors';
