<?php 
class KafelPayment extends MY_Controller
{
    public function __construct(){
        ...
        $this->load->model('all_Finance_resource_models/kafel_payment/Programs_dep'); 
 ...
 public function payment_kafel(){
      ...
      $this->Programs_dep->insert_Payment_for_orphan();
       $this->message('success','إضافة صرف ');
         redirect('all_Finance_resource/KafelPayment/payment_kafel', 'refresh');
        }
        ...
        $data['programs'] = $this->Programs_dep->select();
        $data["title"]="صرف الإشتراكات";
        $data['subview'] = 'admin/all_Finance_resource_views/programs_dep/payment_kafel';
