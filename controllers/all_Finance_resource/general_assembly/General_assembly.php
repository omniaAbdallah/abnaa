 ...
 */
        ...
        public function  add_member_maindata(){//Directors/General_assembly/add_member_maindata
         ...
         if($this->input->post('save')){
            ...
            redirect('all_Finance_resource/general_assembly/General_assembly/add_member_maindata', 'refresh');
          }else {
    ...
    public function add_membership_data($id){
        if($this->input->post('save')){
            ...
            redirect('Directors/General_assembly/add_membership_data/'.$id, 'refresh');
        }else {
            $data["current_hijry_year"] = $this->current_hjri_year();
...
public function print_card($id){
    ...
    $this->load->view('admin/directors/general_assembly/print/print_card',$data);
}
    ...
    public function print_member_details($id){
        ...
        $data['banks'] = $this->Difined_model->select_all('banks_settings','','',"id","asc");
        $data['membership_arr'] = $this->General_assembly_model->GetFromGeneral_assembly_settings(2);
        $this->load->view('admin/directors/general_assembly/print/print_member_details', $data);
    }
