...
class  Sponsor extends MY_Controller
{
    ...
    public function addSponsor_maindata()	// all_Finance_resource/sponsors/Sponsor/addSponsor_maindata
    {
        ...
        if($this->input->post('add')){
            ...
            redirect('all_Finance_resource/sponsors/Sponsor/addSponsor_maindata','refresh');
        }
...
/*        echo "<pre>";
    ...
    public function getConnection($KafalaType)
    {
       ...
       $members = $this->Sponsors_model->getMembers(array('f_members.id!='=>0,'f_members.categoriey_member'=>$type));
        $arr = array();
        $arr['data'] = array();
...
public function GetAccounts(){
    ...
    public function GetSidebarData(){
        $result = $this->Sponsors_model->getMembers(array('f_members.id'=>$this->input->post('id')))[0];
