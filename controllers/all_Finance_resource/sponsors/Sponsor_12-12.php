...
/*        echo "<pre>";
   ...
   $data['all_kafalat']= $this->Sponsors_model->select_sponsors_kafalat($id);
    ...
    public function getConnection($KafalaType,$result_id)
    {

         //$KafalaType,$kafala_id
        if(!empty( $result_id)){
            $result_Kfala_data= $this->Sponsors_model->getById_main_kafalat_detai($result_id); 
	...
	public function form()
{
    ...
    $this->load->view('admin/all_Finance_resource_views/sponsors/form',$data);
      ...
      //   $data['subview'] = 'admin/all_Finance_resource_views/sponsors/form';
       // $this->load->view('admin_index', $data);
