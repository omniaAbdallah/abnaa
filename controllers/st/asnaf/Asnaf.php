 ...
 class Asnaf extends MY_Controller{
     ...
     private function thumb($data){
        ...
        // $config['new_image'] = 'uploads/thumbs/'.$data['file_name'];
          $config['new_image'] = 'uploads/st/asnaf/thumbs/'.$data['file_name'];
     ...
     public function buildTree2($elements, $parent )
     {
         $branch = array();
         foreach ($elements as $element) {
            // if ($element->from_id == $parent) {
...
public function add_asnaf(){ // st/asnaf/Asnaf/add_asnaf
    ...
    $records = $this->Asnaf_model->buildTree(array('id!='=>0));
  //  $this->test($records);
   // die;
    ...
    $this->load->view('admin/st/asnaf/asnaf_data', $data);
     ...
     public function update_asnaf($id){
      ...
      //   die;
         ...
         $records = $this->Asnaf_model->buildTree(array('id!='=>0));
         $data['tree'] = $this->buildTree($records);
         $data["tasnefat"] = $this->Asnaf_model->get_fe2a($data['get_sanf']->fe2a);
