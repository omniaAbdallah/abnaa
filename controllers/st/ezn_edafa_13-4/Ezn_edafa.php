...
//     $this->test($data['one_data']);
    ...
    {
        $all_Asnafs = $this->Ezn_edafa_model->get_asnaf();
...
//        application/views/admin/st/tabr3_ayni/print_asnaf.php
    ...
    { // st/ezn_edafa/Ezn_edafa/get_search_result
        ...
        if($field=='ezn_rkm' || $field=='ezn_date_ar' || $field=='person_jwal' || $field=='storage_fk' || $field=='person_name' || $field=='mostand_rkm' || $field=='geha_name' )
        {
            $valu=$this->input->post('input_search_id');

        } elseif ($field=='no3_tabro3'){
