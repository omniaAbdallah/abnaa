<?php class Folder extends MY_Controller {
 ...
 public function create_folder(){
    ...
    $data['type_moamla'] = $this->input->post('type_moamla');
    $data['tabe2a_moamla'] = $this->input->post('tabe2a_moamla');
    // $this->test($_POST);
 ...
 public function update_data() {
    $data['ar_title'] = $this->input->post('ar_title_update');
    $id_update = $this->input->post('id_update');
    $this->Folder_model->update_data($data,$id_update);
    $data['records'] = $this->Folder_model->get_all_records_ar();
    $data['title'] = "عرض المجلدات";
    $this->load->view('admin/all_secretary_view/archive_v/folders/load_folders', $data);
}
 ...
 public function update_archeive($id)  {
    $id = base64_decode($id);
 ...
 public function fill_select() {
    ...
    $data['folders'] = $this->Folder_model->get_main_folders($from);
