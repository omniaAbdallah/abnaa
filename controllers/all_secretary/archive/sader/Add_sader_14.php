...
<li><a  href="'.base_url().'/all_secretary/archive/sader/Add_sader/add_deal/'.$row->id.'"><i class="fa fa-commenting-o" aria-hidden="true"></i> استكمال وتعديل المعاملة</a></li>
...
/*function get_edara_type()
{
    ...
    switch ($type) {
        case 1:
            $data['all_data'] = $this->Sader_model->get_table('hr_administrative_structure', array('main_type' => 2));
            break;
        case 2:
            $data['all_data'] = $this->Sader_model->get_table('hr_administrative_structure', array('main_type' => 3,'from_id'=>$edara_id));
            break;
        case 3:
            $data['all_data'] = $this->Sader_model->get_table('employees', array('qsm_id' =>$qsm_id ));
