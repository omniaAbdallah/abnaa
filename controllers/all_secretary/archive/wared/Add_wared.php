            ...
            $class_suspend='warning';
                   ...
                   $min دقيقة ";
                    ...
                    /*  if($row['file_update_date'] == 0 ){
                          ...
                          $x,
                          $wared_rkm,
                          '<span  style="width: 100%;color: black !important;" class="label label-'.$class_type.'">'.$wared_type.'</span>', 
                          $row->tsgeel_date,  
                         $row->tsgeel_time,
                    ...
                    font-family: cursive !important;" id="session-name">
                                            ...
                                            <i  style="color: orange;" class="fa fa-clock-o" aria-hidden="true"></i> '. $since.'    </span></div>'
                        ...
                        <li>
                                             <a    aria-hidden="true"
                                                        ...
                                                        <a onclick="get_details('.$row->id.');"
                                                             aria-hidden="true"
                                                                data-toggle="modal"
                                                                data-target="#myModal_det"><i     class="fa fa-search-plus" aria-hidden="true"></i>تفاصيل المعاملة</a>
...
//        $result['msg_wared'] = $msg;
 ...
 public function add_ms2ol()
    ...
    public function time_go(){
        $wared_id=$this->input->post('wared_id');
        $data['get_all'] = $this->Wared_model->get_wared_by_id($wared_id);
        $this->load->view('admin/all_secretary_view/archive_v/wared/time_go', $data);
    }
    //</yara13-9-2020>
