...
class Main extends MY_Controller
{
 ...
 public function archive() { //all_secretary/archive/main/Main/archive
    ...
    $data['customer_js'] = $this->load->view('admin/all_secretary_view/archive_v/main/app_js', '', TRUE);
    ///
  ...
  //  $this->test($data);
    ...
    $data['estlam_js']=$this->load->view('admin/all_secretary_view/archive_v/main/app_estlam_js', '', TRUE);
    $data['end_js']=$this->load->view('admin/all_secretary_view/archive_v/main/app_end_js', '', TRUE);
  // $this->test($data);
 //nagwa
...
$data['title']=$this->Wared_model->select_setting(601);
//$this->test($data['arr']);
...
public function load_end()
{
  $data['wared_end']=$this->Main_model->select_end_wared();
  $data['sader_end']=$this->Main_model->select_end_sader();
  $this->load->view('admin/all_secretary_view/archive_v/main/end_thwelat', $data);
}
/////yara27-2-2020/////////////
// تنبيهات جديده
