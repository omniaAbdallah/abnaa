...
class  Shkawi extends  MY_Controller{
   ...
   // F:\laragon\www\ABNAAv1\application\controllers\all_secretary/archive\shkawi\Shkawi.php
    ...
    public function load_details(){
        ...
        $this->load->view('admin/all_secretary_view/archive_v/shkawi/load_details', $data);
}
    ...
    public function all_shkwa(){ // all_secretary/archive/shkawi/Shkawi/all_shkwa
      $data['records']=$this->Shkawi_model->get_all_shkwa();
     // $this->test($data['records']);
         $data['title'] = "      الشكاوي والمقترحات ";
         $data['subview'] = 'admin/all_secretary_view/archive_v/shkawi/employee_shkawi';
         $this->load->view('admin_index', $data);
     }
...
public function load_message_type()
{
   $data["message"]=$this->Shkawi_model->select_search_key('arch_setting','from_code',111);
    $this->load->view('admin/all_secretary_view/archive_v/shkawi/load_message_type', $data);
}
...
{
    $this->load->view('admin/all_secretary_view/archive_v/shkawi/load_shkwa');
}
public function load_shkwa_type()
{
   $data["message"]=$this->Shkawi_model->select_search_key('arch_setting','from_code',112);
    $this->load->view('admin/all_secretary_view/archive_v/shkawi/load_shkwa_type', $data);
}
