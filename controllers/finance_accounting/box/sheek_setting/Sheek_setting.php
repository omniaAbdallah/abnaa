...
class Sheek_setting extends MY_Controller {
	...
	public function add()
	{
		$file = upload_image('fileupload','uploads/images/sheek');
	...
	public function print_sheek($id)
	{

	$data['recordSheek'] = $this->Sheek_setting_model->getSettingById($id);
		$data['banks'] = $this->Sheek_setting_model->getBanks();

    //    $data['subview'] = 'admin/finance_accounting/box/sheek_setting/print_sheek';
        $this->load->view('admin/finance_accounting/box/sheek_setting/print_sheek',$data);
	}
