	...
	public function add_tahwel()
	{
	  ...
	  /*echo '<pre>';
       ...
       die;*/
        ...
        $this->Vouch_sarf_model->update_transform_accounts($process_rkm,$inserted_id);
    ...
    /*	public function printSanedSarf($id){ // finance_accounting/box/vouch_sarf/Vouch_sarf/printSanedSarf
        ...
        $this->load->view('admin/finance_accounting/box/vouch_sarf/print_saned_sarf', $data);
     	...
     	public function printSanedSarf(){ // finance_accounting/box/vouch_sarf/Vouch_sarf/printSanedSarf
          ...
          //   $id = 919;
            // $sarf_date=$this->input->post('sarf_date'); 
            $unixtime = $this->input->post('sarf_date');
 $sarf_date = date("Y-m-d",$unixtime);
       ...
       $data["mohaseb"]=$this->Vouch_sarf_model->get_current_signs($sarf_date,502);
       $data["modeer_mali"]=$this->Vouch_sarf_model->get_current_signs($sarf_date,501);  
...
{
    $this->Vouch_sarf_model->cancel_sheek();
