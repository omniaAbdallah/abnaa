...
class Sheek_tracks extends MY_Controller
{
    ...
    {//finance_accounting/box/sheek_tracks/Sheek_tracks
       ...
       // $data['records'] = $this->Sheek_tracks_model->getSand_Qabd(24,265);
        ...
        $data['sheeks_sarf'] = $this->Sheek_tracks_model->select_sheeks_sarf(array('sheek_status'=>0));

        $data['sheeks_sarf_approved'] = $this->Sheek_tracks_model->select_sheeks_sarf(array('taslem_sheek >'=>0,'sheek_status >'=>0));

        //$this->test($data['sheeks_sarf']);


        $data['sheeks_qabd'] = $this->Sheek_tracks_model->select_sheeks_qabd(array('sheek_type'=>0,'sheek_status'=>0,'twaged_sheek'=>0));

        $data['sheeks_qabd_approved'] = $this->Sheek_tracks_model->select_sheeks_qabd(array('sheek_type >'=>0,'sheek_status >'=>0,'twaged_sheek >'=>0));
