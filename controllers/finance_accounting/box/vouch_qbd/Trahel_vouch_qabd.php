...
public function index($id=false) // finance_accounting/box/vouch_qbd/Trahel_vouch_qabd
{
    ...
    $data['cheque_data']=$this->Vouch_qbd_model->get_all_cheque();
    ...
    public function updateView($id) // finance_accounting/box/vouch_qbd/Vouch_qbd/updateView
    {
        ...
        $data['cheque_data_update']=$this->Vouch_qbd_model->get_all_cheque_update($id);
...
//$this->test($data['result']);
    ...
    public function add($id=0)
    {
       ...
       // $this->Vouch_qbd_model->insert_sheek_details($last_rqm_sanad);
        $ppay_method =  $this->input->post('ppay_method');
        if($ppay_method == 2 || $ppay_method == 5){
          $this->Vouch_qbd_model->insert_sheek_details($last_rqm_sanad);
      }
...
/*
  $sand_pay_method = $this->Vouch_qbd_model->get_pay_method_qabd($id);

echo $sand_pay_method;*/
