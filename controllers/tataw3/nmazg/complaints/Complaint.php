...
class Complaint extends CI_Controller {
	...
	public function __construct()
	{
        ...
        $this->load->model('tataw3/nmazg/complaint/Complaint_model');
               /**********************************************************/ 
	...
	public function index()///tataw3/nmazg/complaints/Complaint
	{
        ...
        $data['subview'] = 'tataw3/tataw3_views/nmazg/complaint_v/complaints';
...
public function data()
{
   ...
   // $this->test($volunteers);
    ...
    $type='تظلم';
            ...
            if($value->approved==4)
            {
                $span="<span style='    background: red;'>لايمكن التعديل او الحذف</span>";
                $status="تم الاستلام";
            }
            else{
                $status="جاري ";
                $span="<a href='#' onclick=\'swal({
                    ...
                    function(){
                    window.location=''.base_url().'tataw3/nmazg/complaints/Complaint/edit_complaint/'. $value->id.''
                    });\'>
                ...
                <a href='#' onclick=\'swal({
                    ...
                    function(){
                    window.location=''. base_url().'tataw3/nmazg/complaints/Complaint/delete/'. $value->id .' '
                    });\'>
...
//yara_json
	...
	public function new_complaint()//tataw3/nmazg/complaints/Complaint/new_complaint
    {
        if($this->input->post('add')){
           // $this->test($_POST);
            $this->Complaint_model->add();
            $this->messages('success','إضافة   شكوي والتظلم تطوع');
            redirect('tataw3/nmazg/complaints/Complaint','refresh');
        }
        $data['last_record'] = $this->Complaint_model->get_last_record();
        $data['mot3en']=$this->Complaint_model->get_table('tat_motat3en', array('id'=>$_SESSION['id']));
       ...
       $data['employees']= $this->Complaint_model->get_table('employees', array('emp_type'=>1,'status'=>'96'));
        ...
        $data['subview'] = 'tataw3/tataw3_views/nmazg/complaint_v/new_complaint';
        $this->load->view('tataw3/tataw3_index', $data);
    ...
    public function print_complaint()
    {
       ...
       // $data['subview'] = 'admin/Human_resources/tataw3_v/nmazg/complaint_v/new_complaint';
        $this->load->view('tataw3/tataw3_views/nmazg/complaint_v/print_complaint', $data);
  ...
  // $this->test($data['mot3en']);
        ...
        $this->load->view('tataw3/tataw3_views/nmazg/complaint_v/load_mot3en', $data);
