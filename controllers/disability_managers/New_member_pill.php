...
class New_member_pill extends MY_Controller {
    ...
    public function new_member_pills(){  //
    	...
    	$data['title'] = 'الرسوم الدراسية';
        $data['subview'] = 'admin/disability_managers_views/new_member_pills/new_member_pills';
   ...
   public function get_student_other() //  New_student_pills/get_student_other
	     ...
	     public function getTable()
    {
   	...
   	$this->load->view('admin/disability_managers_views/new_member_pills/getTable', $data);
    }
 public function delete($id) // New_student_pills/delete
    ...
    public function make_report() //disability_managers/New_member_pill/make_report
    {
        	$data['sutdent'] = $this->New_pill_model->getAll_student();
    ...
    {
       $data['title']="تقرير بسداد العضوية";
