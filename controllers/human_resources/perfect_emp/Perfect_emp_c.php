<?php
class Perfect_emp_c extends MY_Controller
{
    public function __construct()
    {
        ...
        $this->load->model("human_resources_model/perfect_emp_models/Perfect_emp_model");
    }
//--------------------------------------------------
...
//-----------------------------------------
    ...
    public function index(){     // human_resources/perfect_emp/Perfect_emp_c
        $data['records'] =$this->Perfect_emp_model->select_all();
        $data['title']='   الموظف المثالي';
        //$data['emp_data'] = $this->Perfect_emp_model->select_depart();
         $data['emp_data'] = $this->Perfect_emp_model->select_all_emp();
        
        $data['subview'] = 'admin/Human_resources/perfect_emp_v/perfect_emp';
        $this->load->view('admin_index', $data);
    }
    public function getConnection_emp()
    {
        
         $all_Emps = $this->Perfect_emp_model->get_all_emp();
    ...
    public function insert(){
        if( $this->input->post('save') ==='save'){
            $this->Perfect_emp_model->insert();
        }
        $this->message('success','تمت الاضافة ');
        redirect('human_resources/perfect_emp/Perfect_emp_c','refresh');
    }
    public function Delete_namozeg($rkm){
        $this->Perfect_emp_model->Delete($rkm);
        redirect('human_resources/perfect_emp/Perfect_emp_c','refresh');
    ...
    public function change_status()
    {
     ...
     $data['status'] = $this->Perfect_emp_model->change_status($valu, $id);
     echo json_encode($data);
    
    }
    public function get_all_data(){ 
        $data['records'] =$this->Perfect_emp_model->select_all();
        $this->load->view('admin/Human_resources/perfect_emp_v/getDetailsDiv',$data);
