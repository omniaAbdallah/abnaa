 ...
 private function upload_muli_file($input_name){
   //  $this->test($_FILES[$input_name]['name']);
    ...
    public function end_mohma($id)
    {
        ...
        redirect('human_resources/mohma/Mohma_c/all_end_mohma', 'refresh');
    ...
    {
        $this->Mohma_model->estlam_mohma($id);
        redirect('human_resources/mohma/Mohma_c/all_current_mohma', 'refresh');
        $this->message('success', 'تمت استلام ');
    }
} // END CLASS