<?php
class Ta3mem_msg_c   extends MY_Controller
{
...
//-----------------------------------------
    ...
    public function index(){     // human_resources/ta3mem/Ta3mem_msg_c  
   ...
   else if($type==2)
   {
    ...
    public function insert(){
        if( $this->input->post('save') ==='save'){
          ...
          {
            $this->Ta3mem_msg_model->insert($img_file,$img);
          }else if($this->input->post('type')==2)
          {
            $this->Ta3mem_msg_model->insert_emp($img_file,$img);
          }
        }
