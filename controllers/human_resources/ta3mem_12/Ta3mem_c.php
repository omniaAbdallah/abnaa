...
//            $this->test($_POST);
            ...
            if ($this->input->post('type') == 1) {
                $this->Ta3mem_model->insert($img_file, $img);
            } else if ($this->input->post('type') == 2) {
                $this->Ta3mem_model->insert_emp($img_file, $img);
            }
        }
    ...
    if($da3wat['t3mem']->id == ''){
       $data['da3wat'] = '';
    }elseif($da3wat['t3mem']->id != ''){
   $data['da3wat'] = $this->Ta3mem_model->get_unseen_ta3mem();  
    }
   // $this->test($da3wat);  
   /* if(isset($data['da3wat']) and $data['da3wat'] != null){
