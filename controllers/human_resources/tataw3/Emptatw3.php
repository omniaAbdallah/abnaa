...
class Emptatw3 extends MY_Controller
{
    ...
    public function add_talab()
    { ///human_resources/tataw3/Emptatw3/add_talab
//$this->test($_SESSION);
    ...
    public function load_details_emps()
    {
        ...
        if ($this->input->post('finish')) {
            ...
            $data['records'] = $this->Emptatw3_model->get_all_emps_accpet($row_id);
    ...
    public function all_talab_moder_tatw3()
    ...
    { ///human_resources/tataw3/Emptatw3/all_talab_finished
        $data['records'] = $this->Emptatw3_model->all_talab_finished();
        $data['title'] = "  طلبات احتياج فرصة تطوعية المنشورة ";
        $data['subview'] = 'admin/Human_resources/tataw3_v/emps/all_talab_finished';
        $this->load->view('admin_index', $data);
    }
}
?>
