...
public function edit_overtime_hours_orders_deatils($id = false){
    if($this->input->post('add'))
    {
        ...
        if ($this->input->post('from_profile')) {
            ...
            redirect('human_resources/employee_forms/overtime_hours/Overtime_hours_orders/compelete_details/'.$id, 'refresh');
        }
    }
...
public function add_edit_overtime_hours_orders($id,$row_id){
    if($this->input->post('add'))
    {
        ...
        if ($this->input->post('from_profile')) {
            ...
            redirect('human_resources/employee_forms/overtime_hours/Overtime_hours_orders/compelete_details/'.$row_id, 'refresh');
        }
    }
    $data['data']=$this->Overtime_hours_orders_model->get_all_details($id);
    $data['result'] = $this->Overtime_hours_orders_model->get_all_edite($row_id)[0];
...
public function delete_item($id, $order_id, $from = false)
{
    ...
    if (!empty($from) && ($from == 1)) {
        ...
        redirect('human_resources/employee_forms/overtime_hours/Overtime_hours_orders/compelete_details/' . $order_id, 'refresh');
    }
}
