...
class Gehat extends MY_Controller
{
    public function __construct(){
        ...
        $this->load->model('human_resources_model/employee_forms/mandate_setting/Geha_model');
    ...
    public function index() {     // human_resources/employee_forms/mandate_setting/Gehat
          
        $data['title']="اضافه جهه انتداب";
      $data['result']= $this->Geha_model->select_all_gehat();
       //$this->test(  $data['result']);

       $data['subview'] = 'admin/Human_resources/employee_forms/mandate_setting/gehat/add_geha';
    ...
    {   
       ...
       redirect('human_resources/employee_forms/mandate_setting/Gehat','refresh');
    }
    ...
    public function  update_main($id){   
       if($this->input->post('add')){
          ...
          redirect('human_resources/employee_forms/mandate_setting/Gehat/update_main/'.$id,'refresh');
       }
    ...
    public function load_details()
    {
        ...
        $this->load->view('admin/Human_resources/employee_forms/mandate_setting/gehat/load_details', $data);
    ...
    public function add_ms2ol()
    {
      ...
      // $this->test($_POST);
        ...
        //$this->messages('success', ' تمت الاضافه  بنجاح');
        //redirect('human_resources/employee_forms/mandate_setting/Gehat/add_ms2ol_gehat/'.$id,'refresh');
    ...
    public function add_ms2ol_gehat()
    {
        ...
        // $data['result']=$this->Geha_model->get_by_id_ms2olen($id);
     //  $data['subview'] = 'admin/Human_resources/employee_forms/mandate_setting/gehat/add_ms2ol_gehat';
      $this->load->view('admin/Human_resources/employee_forms/mandate_setting/gehat/add_ms2ol_gehat', $data);
         //$this->load->view('admin/Human_resources/employee_forms/mandate_setting/gehat/add_ms2ol_gehat', $data);
    ...
    public function delete_ms2ol() {
        ...
        redirect('human_resources/employee_forms/mandate_setting/Gehat/add_ms2ol_gehat/'. $data['record']->geha_id_fk,'refresh');
    ...
    public function update_ms2ol($id)
    {
       ...
       // $this->test($data['record']);
        ...
        $this->messages('success', ' تمت التعديل  بنجاح');
        redirect('human_resources/employee_forms/mandate_setting/Gehat/update_ms2ol/'. $data['record']->geha_id_fk,'refresh');
     }
   ...
   public function load_geha_type()
   {
    ...
    $this->load->view('admin/Human_resources/employee_forms/mandate_setting/gehat/load', $data);
   ...
   public function add_geha_type()
     ...
     public function load_m2sol_geha()
     {
        ...
        $data['result']=$this->Geha_model->get_by_id_ms2olen($id);
         ...
         $this->load->view('admin/Human_resources/employee_forms/mandate_setting/gehat/load_ms2olen', $data);
     }
 ...
 public function load_safms2ol()
    {
        $data["safms2ol"]=$this->Geha_model->select_search_key('hr_mandate_setting','from_code',301);

        $this->load->view('admin/Human_resources/employee_forms/mandate_setting/gehat/load_safms2ol', $data);
    }
