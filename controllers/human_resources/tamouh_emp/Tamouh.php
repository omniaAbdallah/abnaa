...
return $HYear;
     ...
     /*   public function index()//human_resources/tamouh_emp/Tamouh
    {
       ...
       //add
       //yara
       $data['all_emps'] = $this->Employe_model_tamouh->select_allEmployee();
         $data['customer_js'] = $this->load->view('admin/Human_resources/add_employee_tamouh/app_js', '', TRUE);
  ...
  /*     public function add_job_data($code)
    {
      ...
      //  $data['direct_all_emps'] = $this->Employee_model->select_all_except('employees', 'id',$code , 'id', 'desc');
        ...
        $data["direct_all_emps"] = $this->Employe_model_tamouh->select_allEmployee();
        $data['nationality'] =$this->Difined_model->select_search_key('employees_settings', 'type', '2');
        $data['deyana'] =$this->Difined_model->select_search_key('employees_settings', 'type', '3');
        $data['type_card'] =$this->Difined_model->select_search_key('employees_settings', 'type', '5');
        $data['dest_card'] =$this->Difined_model->select_search_key('employees_settings', 'type', '6');
...
public function load_status()
    ...
    public function data()
    {
        ...
        $customer =  $this->Employe_model_tamouh->select_allEmployee_new();
                   ...
                   $row->phone,
                    ...
                    $row->nationality,
                     ...
                     <ul class="dropdown-menu">
                      ...
                      <li><a target="_blank"
                                href="'. base_url() .'human_resources/tamouh_emp/Tamouh/edit_emp/'.$row->emp_code.'">البيانات
                                 الأساسية </a></li>
                         <li><a target="_blank"
                                href="'. base_url() .'human_resources/tamouh_emp/Tamouh/add_job_data/'.$row->id.'">البيانات
                                 الوظيفيه </a></li>
...
شاشة العهد </a></li>
  ...
  '
    ...
    public function employees_tamouh()//human_resources/tamouh_emp/Tamouh/employees_tamouh
    {
        $data['customer_js'] = $this->load->view('admin/Human_resources/add_employee_tamouh/app_js', '', TRUE);
        $data['subview'] = 'admin/Human_resources/add_employee_tamouh/employees_tamouh';
        $this->load->view('admin_index', $data);
