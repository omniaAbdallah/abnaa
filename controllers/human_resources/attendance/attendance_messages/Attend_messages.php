   ...
   public function send_privte_message(){
    ...
    public function add_private_message()
    {
        ...
        public function load_tahwel(){
                ...
                $data['edara']=$this->Attend_messages_model->get_all_edara();
               //$this->test( $data['all']);
...
public function edite_message($id)
{
    $data['message']=$this->Attend_messages_model->get_message_by_id($id);
    //$this->test( $data['message']->id);
    
    if($data['message']->to_user_id !=NULL)
    {
    $data['to_user_name']=$this->Attend_messages_model->get_id("employees",'id',$data['message']->to_user_id,"employee");
    }
//$this->test( $data['to_user_name']);
...
public function filter_table()
    {
        ...
        $data['all'] = $this->Attend_messages_model->get_all_edara_by_id();
        $this->load->view('admin/Human_resources/attendance/attendance_messages/load_filter_page', $data);
    }
    public function get_qsm() 
    {
        ...
        $data['qsm']=$this->Attend_messages_model->get_all_qsm();
  
        $this->load->view('admin/Human_resources/attendance/attendance_messages/get_qsm',$data);
    }
    public function get_emp() 
    {
    
        $data['emp']=$this->Attend_messages_model->get_all_emp_edara_qsm();
        $this->load->view('admin/Human_resources/attendance/attendance_messages/get_emp',$data);
    }
    //notification

    public function get_tot()
    {
        $tot=$this->Attend_messages_model->total_rows();
        $result['tot']=$tot;
        $msg=$this->Attend_messages_model->get_new_messages();
        $result['msg']=$msg;
...
{
    $this->Attend_messages_model->update_seen_messages();
}
...
{
   // $id=$this->input->post("id");
    $this->Attend_messages_model->update_read_messages($id);
}
