...
class Personal_profile extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('person_profile_m/Person_profile_model');
    ...
    {//person_profile/Personal_profile

        $data['person_data'] = $this->Person_profile_model->get_person_data();
//        $this->test($data['person_data']);
        $data['title'] = 'بروفايلى';
        $data['subview'] = 'admin/person_profile_v/personal_profile.php';
    ...
    public function update_users($id)
    {
        if ($this->input->post('ADD') == 'ADD') {
            ...
            redirect('person_profile/Personal_profile', 'refresh');
        }
