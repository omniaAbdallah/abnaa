...
class ChatController extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model(['osr/family_chat/ChatModel', 'osr/family_chat/OuthModel', 'osr/family_chat/UserModel']);
    ...
    public function index()
    {
        ...
        if (isset($_SESSION['mother_national_num'])) {
           ...
           $data['subview'] = 'osr/chating/construction_services/chat_template';
    ...
    public function send_text_message()/*//osr/ChatController*/
    {
        ...
        foreach ($history as $chat):
            ...
            if ($message == 'NULL') {/* //fetach media objects like images,pdf,documents etc*/
                ...
                if ($mime_type[0] == 'image') {
                    ...
                    $messageBody .= '';
                    $messageBody .= '';
                    $messageBody .= '<a target="_blank" Download  href="' . base_url() . "osr/ChatController/donwload/" . $attachment_name . '"> <i class="fa fa-eye" id="' . $message_id . '" ></i> </a>';
