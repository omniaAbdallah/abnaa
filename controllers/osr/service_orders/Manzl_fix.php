...
class Manzl_fix extends CI_Controller
{
    ...
    function get_last_talab()
    {
        ...
        $data['last_talb'] = $this->Manzl_fix_model->get_last_talab($fe2a_talab, $_SESSION['mother_national_num']);
        $data['current_talbat'] = $this->Manzl_fix_model->check_talab($fe2a_talab, $_SESSION['mother_national_num']);
