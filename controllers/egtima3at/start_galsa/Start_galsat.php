<?php
class Start_galsat extends MY_Controller
{
    public function __construct()
    {
        ...
        $this->load->model('egtima3at_m/start_galsa/Start_galsa_model');
    ...
    { 
        //egtima3at/Start_galsa/Start_galsat
       ...
       // die;
        ...
        $data['subview'] = 'admin/egtima3at_v/start_galsa/start_galsa';
    ...
    public function load_mem_details()
    {
        ...
        $this->load->view('admin/egtima3at_v/start_galsa/load_member', $data);
    }
