...
class Photos_library extends MY_Controller{
    ...
    public function photos(){ // public_relations/website/library/Photos_library/photos
      ...
      if ($this->input->post('ADD')){
        ...
        //  die();
          ...
          redirect('public_relations/website/library/Photos_library/photos','refresh');
        ...
        $data['subview'] = 'admin/public_relations/website/library/photos_library_view';
        $this->load->view('admin_index', $data);
    }

    public function get_library_photo(){ // public_relations/website/library/Photos_library/get_library_photo
        $data['lenght']= $_POST['length'];

        $this->load->view('admin/public_relations/website/library/get_library_photos');
    }

    public function Update($id){ // public_relations/website/library/Photos_library/Update
        ...
        if ($this->input->post('ADD')){
            ...
            if($_FILES['img'] && !empty($_FILES['img'])){
                $all_img= $this->upload_muli_image("img","images");
                $this->Photos_model->insert_library_imgs($all_img,$id);
            }
    ...
    public function Delete($id){ // public_relations/website/library/Photos_library/Delete
    ...
    public function DeletePhoto($id,$publish_num){ // public_relations/website/library/Photos_library/DeletePhoto

        $this->Photos_model->delete_photos($id);
        redirect('public_relations/website/library/Photos_library/Update/'.$publish_num,'refresh');
