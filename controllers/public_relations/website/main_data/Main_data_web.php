...
class Main_data_web extends MY_Controller
{
    public function __construct(){
        ...
        $this->load->model('Public_relations/website/main_data/Model_data_web');
    }
    ...
    {//main_data/Main_data_web
        ...
        $data['subview'] = 'admin/public_relations/website/main_data/main_data_web_view';
        $this->load->view('admin_index', $data);
    }

    public function insert(){
        $this->Model_data_web->insert();
        redirect('public_relations/website/main_data/Main_data_web', 'refresh');
