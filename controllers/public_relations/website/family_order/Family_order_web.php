...
//C:\laragon\www\lastAbnaa_30\application\controllers\public_relations\website\family_order\Family_order_web.php
    public function index()
    {//public_relations/website/family_order/Family_order_web
...
//        $this->test($data['orders']);
        ...
        $data['subview'] = 'admin/public_relations/website/family_order_web/family_order_web_view';
...
//        echo json_encode($data['orders']);
        $this->load->view('admin/public_relations/website/family_order_web/family_order_web/details_order_view_pop', $data);
    }
}