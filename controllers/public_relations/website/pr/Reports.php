...
class Reports extends MY_Controller{
    ...
    public function read_file($file_name) // public_relations/website/pr/Reports/read_file
    {
    ...
    public function add_reports(){ // public_relations/website/pr/Reports/add_reports
        ...
        if ($this->input->post('ADD')){
           ...
           // $this->Report_model->insert_report($file);
            $this->Report_model->insert_report($file,$_FILES['file']['name']);
            $this->message('success','تم الاضافة بنجاح');
            redirect('public_relations/website/pr/Reports/add_reports','refresh');

        }
        $data['subview'] = 'admin/public_relations/website/pr/reports_view';
    ...
    public function Delete($id){ // public_relations/website/pr/Reports/Delete
     ...
     $data['get_report'] = $this->Report_model->get_by_id($id);
        ...
        if ($this->input->post('ADD')){
          ...
          //  $this->Report_model->update($id,$file);
              $this->Report_model->update($id,$file,$_FILES['file']['name']);
