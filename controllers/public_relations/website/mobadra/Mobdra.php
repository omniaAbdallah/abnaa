...
class Mobdra extends MY_Controller{
    ...
    { // public_relations/website/mobadra/Mobdra/downloads_new
    ...
    public function news(){ // public_relations/website/mobadra/Mobdra/news
        ...
        if($this->input->post('ADD')){
            ...
            redirect('public_relations/website/mobadra/Mobdra/news','refresh');
        }


        $data['subview'] = 'admin/public_relations/website/mobdra/mobdra_view';
        $this->load->view('admin_index', $data);

    }
    public function display_news(){ // public_relations/website/mobadra/Mobdra/display_news
        ...
        $data['subview'] = 'admin/public_relations/website/mobdra/display_mobdra';
        $this->load->view('admin_index', $data);

    }
    public function UpdateNews($id){ // public_relations/website/mobadra/Mobdra/UpdateNews
        ...
        if($this->input->post('ADD')){
            ...
            redirect('public_relations/website/mobadra/Mobdra/display_news','refresh');
        }
    ...
    public function DeletePublisher($id){ // public_relations/website/mobadra/Mobdra/DeletePublisher
    ...
    public function DeletePhoto($id,$publish_num){ // public_relations/website/mobadra/Mobdra/DeletePhoto

        $this->Mobdra_model->delete_img($id);
        redirect('public_relations/website/mobadra/Mobdra/UpdateNews/'.$publish_num,'refresh');

    }
    // __________DeletePhoto___________
    public function DeleteVideo($id,$publish_num){ // public_relations/website/mobadra/Mobdra/DeleteVideo
    ...
    public function get_publisher_photo(){ // mobadra/Mobdra/get_publisher_photo
        ...
        $this->load->view('admin/public_relations/website/mobdra/get_publisher_photos');
    }
    ...
    public function  get_publisher_video(){ // mobadra/Mobdra/get_publisher_video
        ...
        $this->load->view('admin/public_relations/website/mobdra/get_videos');
    }
