...
class ChatController extends MY_Controller {
		public function __construct(){
			...
			$this->load->model(['Public_relations/family_chat/ChatModel','Public_relations/family_chat/OuthModel','Public_relations/family_chat/UserModel']);
		...
		public function index(){
			...
			$list=[];
				...
				$data['strTitle']='الاسر المتصلين';

				$data['strsubTitle']='اسر';

				$data['chatTitle']=' اختر اسره للتواصل';
			...
			foreach($list as $u){
				...
				[
					...
					'user_id' => $this->OuthModel->Encryptor('encrypt', $u['mother_national_num']),

					'user_id_notifiy'=>$u['mother_national_num'],

					'online'=>$u['online'],

					'user_name'=>$this->UserModel->NameById($u['mother_national_num']),

					'picture_url' => "f99b0dd6f845fc13acc362f876f97212.jpg",
			...
			$data['subview'] = 'admin/public_relations/construction_services/chat_template';
	...
	public function send_text_message()//public_relations/family_chat/ChatController
...
/*	public function get_chat_history_by_vendor(){
    ...
    */
		...
		foreach($history as $chat):
			...
			$userPic = base_url('uploads/human_resources/emp_photo/thumbs/unknow.png');
