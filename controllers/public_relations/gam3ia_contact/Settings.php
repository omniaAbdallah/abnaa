...
class Settings extends MY_Controller{
    ...
    public function __construct()
    {
        ...
        $this->load->model('Public_relations/gam3ia_contact/Settings_model');
    ...
    public function index($type=0){ // public_relations/gam3ia_contact/Settings

        $data['typee']= $type;
        $data['all'] = $this->Settings_model->get_all_data($this->myarray);
        $data['title'] = "الاعدادات ";
        $data['subview'] = 'admin/public_relations/gam3ia_contact/settings_view';
    ...
    public function AddSitting($type=0)
    {
        if ($this->input->post('add')) {
            ...
            redirect('public_relations/gam3ia_contact/Settings/index/' . $type, 'refresh');
        }
