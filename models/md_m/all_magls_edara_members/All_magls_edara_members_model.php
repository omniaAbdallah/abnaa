...
//        $this->test($members);
        ...
        md_all_gam3ia_omomia_members.*')->join('md_all_gam3ia_omomia_odwiat', 'md_all_gam3ia_omomia_odwiat.member_id_fk = md_all_gam3ia_omomia_members.id')
...
//7-3-om
    ...
    {
        $q = $this->db->get('md_all_magls_edara_members')->result();
        if (!empty($q)) {
            return $q;
        }
    }
