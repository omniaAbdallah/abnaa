<?php
class Penalty_model_2 extends CI_Model
{
    ...
    public function insert()
    {
        ...
        $data['discount_id_fk'] = $this->chek_Null($this->input->post('penalty_type'));
      ...
      //  $data['content'] = $this->chek_Null($this->input->post('content'));
        ...
        $this->db->insert('discount_salary_operations', $data);
    }
    ...
    public function update($id)
    {
       ...
       // $data['content'] = $this->chek_Null($this->input->post('content'));
        $data['date_s'] = time();
        $this->db->where('id', $id);
        $this->db->update('discount_salary_operations', $data);
    }
