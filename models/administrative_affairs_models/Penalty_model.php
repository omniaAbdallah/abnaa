...
public function insert()
{
    ...
    $data['num_of_lateness_hour'] = $this->chek_Null($this->input->post('num_of_lateness_hour'));
    $data['num_of_absent_day'] = $this->chek_Null($this->input->post('num_of_absent_day'));
    $data['warning_type'] = $this->chek_Null($this->input->post('warning_type'));
    ...
    $data['penalty_date'] = $this->input->post('penalty_date');
