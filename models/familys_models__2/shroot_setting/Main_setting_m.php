<?php
/**
 * application/models/familys_models/shroot_setting/Main_setting_m.php
 */
...
class Main_setting_m extends CI_Model
{
    ...
    {
        $this->db->select('*');
        $this->db->from('family_shroot_tasgel_setting');
    ...
    public function add($from_code)
    {
        ...
        $this->db->insert('family_shroot_tasgel_setting',$data);
    ...
    public function update($id,$from_code)
    {
        ...
        $this->db->where('id',$id);
        $this->db->update('family_shroot_tasgel_setting',$data);
    }
    ...
    function delete($id)
    {
        $this->db->where('id', $id)->delete('family_shroot_tasgel_setting');
    }

    public function getById($id)
    {
        return $this->db->get_where('family_shroot_tasgel_setting', array('id'=>$id))->row_array();
    }
