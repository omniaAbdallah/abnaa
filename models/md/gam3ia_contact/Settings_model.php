...
class Settings_model  extends CI_Model{
    ...
    public function insert_setting($type)
    {
        ...
        $this->db->insert('md_gam3ia_contact_setting',$data);
    }
    ...
    public function update_setting($id)
    {
        ...
        $data['color']= $this->input->post('color');
        $this->db->where('id',$id);
        $this->db->update('md_gam3ia_contact_setting',$data);
    }
    public function getById($id)
    {
        return $this->db->get_where('md_gam3ia_contact_setting', array('id'=>$id))->row();
    }
    public function delete_setting($id)
    {
        $this->db->where('id', $id)->delete('md_gam3ia_contact_setting');
    }
