<?php
class Start_galsa_gam3ia_omomia_model extends CI_Model
{
    ...
    public function get_all_mahawer($rkm,$val)
    {
        ...
        public function get_all_mahawer_new($rkm)
    {
        $this->db->where('glsa_rkm',$rkm);
    ...
    public function update_qrar()
    {
        ...
        $data['elqrar_date_add_time']=date("h:i A");;
        ...
        $query=$this->db->get('md_gadwal_a3mal_gam3ia_omomia');
        $this->db->where('id',$id);
        $this->db->update('md_gadwal_a3mal_gam3ia_omomia',$data);
    ...
    public function update_table_hoddor()
    {
        ...
        if(!empty($attend)&&!empty($id))
        {
            for($x=0;$x<count($attend);$x++)
            {
                ...
                $this->db->update('md_all_glasat_hdoor_gam3ia_omomia',$data);
            }
        }
    }
