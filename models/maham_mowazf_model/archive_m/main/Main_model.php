...
class Main_model extends CI_Model
{
    ...
    public function select_new_wared_count()
    {
        $this->db->select('*');
        $this->db->from('arch_wared_history');
        // $this->db->where('seen',1);
    ...
    public function select_new_sader_count()
    {
        $this->db->select('*');
    ...
    public function select_end_wared_count()
    {
        $this->db->select('*');
        $this->db->from('arch_wared_history');
        if ($_SESSION['role_id_fk'] == 3) {
    ...
    public function select_end_sader_count()
    {
        $this->db->select('*');
        $this->db->from('arch_sader_history');
        if ($_SESSION['role_id_fk'] == 3) {
    ...
    public function select_wared_mostalm_count()
    {
        $this->db->select('*');
        $this->db->from('arch_wared_history');
        if ($_SESSION['role_id_fk'] == 3) {
    ...
    public function select_sader_mostalm_count()
    {
        $this->db->select('*');
        $this->db->from('arch_sader_history');
        if ($_SESSION['role_id_fk'] == 3) {
...
/*2-9-20-om*/
    public function update_mo3mla_sader($id)
    {
        $data['readed'] = 1;
        $data['seen'] = 1;
        $data['readed_date_ar'] = date('Y-m-d H:i:s');
