...
class Absent_emp_model extends CI_Model
{
    ...
    public function insert()
    {
        ...
        $data['absent_value'] = $this->input->post('absent_value');
        $data['start_absent_date']=$this->input->post('start_absent_date');
        $data['end_absent_date']=$this->input->post('end_absent_date');
        $data['remove_absent_value']=$this->input->post('remove_absent_value');
    ...
    function get_month($date = false)
{
    ...
    public function update($id)
    {
        ...
        $this->db->where('id',$id)->update("hr_absent", $data);
    }
  
    public function Delete($id)
    {
        $this->db->where("id", $id);
        $this->db->delete("hr_absent");
    }
