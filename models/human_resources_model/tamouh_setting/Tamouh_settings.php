...
class Tamouh_settings extends CI_Model
{
    ...
    public function insert()
    {
        ...
        $this->db->insert('hr_tamouh_department_jobs', $data);
    }
    ...
    public function update($id)
    {
        ...
        $data['in_order'] = $this->input->post('in_order');
        $this->db->where('id', $id);
        $this->db->update('hr_tamouh_department_jobs', $data);
    }

    public function get_sub($f_id)
    {
        $h = $this->db->get_where('hr_tamouh_department_jobs', array('from_id_fk' => $f_id));
        return $h->num_rows();
    }
    ...
    public function delete($Conditions_arr)
    {
        ...
        $this->db->delete('hr_tamouh_department_jobs');
    }
