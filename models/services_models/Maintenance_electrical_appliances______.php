...
public function getById_Electrical_devices($id)
	{
		return $this->db->select('maintenance_electrical_device_order.*, mother.m_first_name, mother.m_father_name, mother.m_family_name, mother.m_birth_date_hijri, mother.m_mob')
