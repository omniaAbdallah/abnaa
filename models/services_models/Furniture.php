...
public function selectElectrical_devices($mother_national_id_fk){
   	return $this->db->select('furniture_order.*, mother.full_name, mother.m_birth_date_hijri, mother.m_mob , device.title_setting AS device_name')
						...
						->where('furniture_order.mother_national_id_fk',$mother_national_id_fk)
						->get('furniture_order')
						->result();
...
public function getById_Furniture($id)
	{
		return $this->db->select('furniture_order.*, mother.full_name, mother.m_birth_date_hijri, mother.m_mob')
						->join('mother','furniture_order.mother_national_id_fk=mother.mother_national_num_fk','LEFT')
