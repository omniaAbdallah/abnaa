...
class Marriage_help_model extends CI_Model {
	...
	{
		return $this->db->select('marriage_help.*, mother.full_name, mother.m_birth_date_hijri, mother.m_mob, area.title_setting AS area, f_members.member_full_name, nationality.title_setting AS nationality')
	...
	{
		return $this->db->select('marriage_help.*, mother.full_name, mother.m_birth_date_hijri, mother.m_mob')
						->join('mother','marriage_help.mother_national_id_fk=mother.mother_national_num_fk','LEFT')
