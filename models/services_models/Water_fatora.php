...
public function selectElectrical_devices($mother_national_id_fk){
   	return $this->db->select('water_fatora_order.*, mother.full_name, mother.m_birth_date_hijri, mother.m_mob')
						->join('mother','water_fatora_order.mother_national_id_fk=mother.mother_national_num_fk','LEFT')
						->where('water_fatora_order.mother_national_id_fk',$mother_national_id_fk)
