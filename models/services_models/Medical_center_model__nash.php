...
class Medical_center_model extends CI_Model {
	...
	{
		return $this->db->select('medical_center.*, mother.m_first_name, mother.m_father_name, mother.m_family_name, mother.m_birth_date_hijri, mother.m_mob, f_members.member_name')
	...
	{
		return $this->db->select('medical_center.*, mother.m_first_name, mother.m_father_name, mother.m_family_name, mother.m_birth_date_hijri, mother.m_mob')
						->join('mother','medical_center.mother_national_id_fk=mother.mother_national_num_fk','LEFT')
