...
public function selectCars_repairs($mother_national_id_fk){
   	return $this->db->select('cars_repairs_order.*, mother.full_name, mother.m_birth_date_hijri, mother.m_mob')
						->join('mother','cars_repairs_order.mother_national_id_fk=mother.mother_national_num_fk','LEFT')
						->where('cars_repairs_order.mother_national_id_fk',$mother_national_id_fk)
...
public function getById_Cars_repairs($id)
	{
		return $this->db->select('cars_repairs_order.*, mother.m_birth_date_hijri, mother.m_mob ,mother.full_name')
						->join('mother','cars_repairs_order.mother_national_id_fk=mother.mother_national_num_fk','LEFT')
