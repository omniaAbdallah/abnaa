...
class Insurance_model extends CI_Model {
	...
	{
		$query = $this->db->select('insurance_medical_device_orders.*, mother.m_first_name, mother.m_father_name, mother.m_family_name, mother.m_birth_date_hijri, mother.m_mob, concat(mother.m_first_name," ",mother.m_father_name," ",mother.m_family_name) AS member_name, family_setting.title_setting')
	...
	{
		return $this->db->select('insurance_medical_device_orders.*, mother.m_first_name, mother.m_father_name, mother.m_family_name, mother.m_birth_date_hijri, mother.m_mob, concat(mother.m_first_name," ",mother.m_father_name," ",mother.m_family_name) AS member_name')
						->join('mother','insurance_medical_device_orders.mother_national_id_fk=mother.mother_national_num_fk','LEFT')
						->group_by('insurance_medical_device_orders.order_num')
				 		->where($where)
				 		->get('insurance_medical_device_orders')
