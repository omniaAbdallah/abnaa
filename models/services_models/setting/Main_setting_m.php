<?php
/**
 * application/models/services_models/shroot_setting/Main_setting_m.php
 */
...
class Main_setting_m extends CI_Model
{
    ...
    {
        $this->db->select('*');
        $this->db->from('family_serv_setting');
    ...
    public function add($from_code)
    {
        ...
        $this->db->insert('family_serv_setting',$data);
    ...
    public function update($id,$from_code)
    {
        ...
        $this->db->where('id',$id);
        $this->db->update('family_serv_setting',$data);
    }
    ...
    function delete($id)
    {
        $this->db->where('id', $id)->delete('family_serv_setting');
    }

    public function getById($id)
    {
        return $this->db->get_where('family_serv_setting', array('id'=>$id))->row_array();
    }
