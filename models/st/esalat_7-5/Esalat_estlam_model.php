...
class Esalat_estlam_model extends CI_Model
{
    ...
    public function insert($id = false)
    {
        ...
        $data['bnd_type1_name'] = $this->GetTitleFromst_bnod_settingByCode($this->input->post('bnd_type1'));
        $data['bnd_type2_name'] = $this->GetTitleFromst_bnod_settingByCode($this->input->post('bnd_type2'));
