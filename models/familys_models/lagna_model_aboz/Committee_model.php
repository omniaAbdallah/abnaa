...
/******************************************************************************************/
  ...
  /*public function get_session_procedure($session_num)
    ...
    public  function get_decision($procedure,$session){
        ...
        $data[$x]->members_details = $this->get_members(
     array('file_num'=>$row->file_num,'session_num_fk'=>$row->session_num_fk,'procedure_id_fk'=>$row->procedure_id_fk)
,$row->mother_national_num);      
...
public function get_members($arr,$mother_num)
{
    $this->db->where($arr);
