...
class Namazeg_gamiaa_model extends CI_Model
{
    ...
    {
        $this->db->select('*');
        $this->db->from("family_gamiaa_namazeg_letters");
...
$var = time() + 5;
        ...
        //   $data['letter_rkm'] =$this->input->post('letter_rkm');
           ...
           $this->db->insert("family_gamiaa_namazeg_letters", $data);
    ...
    public function update(){
     ...
     //   $data['file_num'] =$this->input->post('file_num');
      ...
      //  $data['no_afrad'] =$this->input->post('no_afrad');
        ...
        $this->db->update("family_gamiaa_namazeg_letters", $data);
    ...
    public function Delete($rkm){
        ...
        $this->db->delete("family_gamiaa_namazeg_letters");
    }
...
public function getUserName($user_id)
    ...
    public function select_family_letter_setting(){
        ...
        public function getAllDetails($arr){
            ...
            $this->db->select('family_gamiaa_namazeg_letters.*,family_nmazg_letter_setting.id,family_nmazg_letter_setting.letter_name');
            $this->db->from("family_gamiaa_namazeg_letters");
            $this->db->where($arr);
            $this->db->join('family_nmazg_letter_setting','family_gamiaa_namazeg_letters.namozeg_type_fk =family_nmazg_letter_setting.id','left');
            $query = $this->db->get();
            if ($query->num_rows() > 0) {
                return $query->row_array();
            } else {
