...
class Home_needs_web extends CI_Model
{
...
//=========================================================
    ...
    //    $this->db->select('*');
           $this->db->select('* , home_needs.id as home_needs_id');
        $this->db->from('home_needs');
        $this->db->join('products',"products.id=home_needs.h_home_device_id_fk","left");
