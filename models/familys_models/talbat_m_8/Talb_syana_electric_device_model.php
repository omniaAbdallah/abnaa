...
class Talb_syana_electric_device_model extends CI_Model
{
    ...
    {
        $this->db->select('osr_talbat_syana_electric_device.*,osr_talbat_main.*')
            ->from("osr_talbat_syana_electric_device")
            ->join('osr_talbat_main', 'osr_talbat_main.id=osr_talbat_syana_electric_device.main_id_fk')
...
*/
 ...
 $query['type_sevice_name'] = $this->get_by('osr_serv_khdmat_settings', array('id' => $query['type_sevice']), 'khdma_name');
                ...
                $query['device_status_name'] = $this->get_by('osr_talbat_setting', array('id' => $query['device_status_id_fk']), 'title');
