    ...
    public  function  insert($national_id_file,$bank_card_file,$bank_deduction_voucher_file,$other_img_file){
       ...
       $data['donor_type']=$this->chek_Null( $this->input->post('donor_type'));
        if($data['donor_type'] ==1){
            ...
            $data['password']=$this->chek_Null( $this->input->post('person_password'));
        }elseif ($data['donor_type'] ==2){
            $data['user_name']=$this->chek_Null( $this->input->post('corporation_name'));
            $data['password']=$this->chek_Null( $this->input->post('corporation_password'));
        }
        ...
        $data['father_name']=$this->chek_Null( $this->input->post('father_name'));
        ...
        $data['guaranty_city']=$this->chek_Null( $this->input->post('guaranty_city'));
        $data['guaranty_mob']=$this->chek_Null( $this->input->post('guaranty_mob'));
        $data['guaranty_another_mob']=$this->chek_Null( $this->input->post('guaranty_another_mob'));
