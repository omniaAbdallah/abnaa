...
class Council extends CI_Model
{
    ...
    /*    public function insert($file){
        $data['appointment_decison_number'] = $this->chek_Null($this->input->post('appointment_decison_number'));
        $data['decison_img'] = $file;
        $data['appointment_date'] =  $this->chek_Null($this->input->post('appointment_date'));
        $data['expiration_date'] = $this->chek_Null($this->input->post('expiration_date'));
        $data['status'] = 1;
        $this->db->insert('council_admin_table',$data);
    }*/
...
/*
    public function update($id,$file){
        ...
        $data['decison_img'] = $file;
            ...
            $data['appointment_date_m'] =  $this->chek_Null($this->input->post('appointment_date_m'));
            $data['appointment_date_h'] =  $this->chek_Null($this->input->post('appointment_date_h'));
            $data['expiration_date'] = $this->chek_Null(strtotime($this->input->post('expiration_date_m')));
            $data['expiration_date_m'] = $this->chek_Null($this->input->post('expiration_date_m'));
            $data['expiration_date_h'] = $this->chek_Null($this->input->post('expiration_date_h'));
            $data['appointment_date'] =  $this->chek_Null(strtotime($this->input->post('appointment_date_m')));;
       // $data['expiration_date'] = $this->chek_Null($this->input->post('expiration_date'));
        $data['status'] = 1;
        $this->db->insert('council_admin_table',$data);
    }
