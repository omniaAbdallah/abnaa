<?php
class General_assembly_setting extends CI_Model
{
...
//        $data['in_order']= $this->input->post('in_order');
        ...
        $this->db->insert('general_assembly_settings',$data);
    }
...
//        $data['in_order']= $this->input->post('in_order');
        ...
        $this->db->update('general_assembly_settings',$data);
    }
    public function getById_member_settings($id)
    {
        return $this->db->get_where('general_assembly_settings', array('id_setting'=>$id))->row_array();
    }
    public function delete_member_settings($id)
    {
        $this->db->where('id_setting', $id)->delete('general_assembly_settings');
    }
