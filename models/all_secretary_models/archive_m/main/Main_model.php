...
function update_seen(){
    ...
    $this->db->where('seen',0)->where('to_user_id', $_SESSION['emp_code'])->update('arch_sader_history', $data);
    $this->db->where('seen',0)->where('to_user_id', $_SESSION['emp_code'])->update('arch_wared_history', $data);
}
