...
class Google_maps {
	...
	var $apiKey						= 'AIzaSyC4l5QxL27z4w0uuD_5X3g0IRhaUdvb0Q4'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
